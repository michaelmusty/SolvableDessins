$(function(){ // on dom ready
  ...
  cy.$('#16T6_2').qtip({
    content: {
      ...
      text: 'sigma0 = (1 8 11 10 9 16 3 2)(4 15 14 5 12 7 6 13)<br>sigma1 = (1 14 3 4 9 6 11 12)(2 7 16 5 10 15 8 13)<br>sigmaoo = (1 13 9 5)(2 14 10 6)(3 7 11 15)(4 8 12 16)<br><br>G = Z/8Z : Z/2Z'
    },
    style: {
      classes: 'qtip-tipsy',
    }
