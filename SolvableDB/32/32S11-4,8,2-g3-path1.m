...
s`SolvableDBParents := [ Strings() | "64S6-8,8,2-g9-path1", "64S20-4,8,4-g13-path2", "64S7-8,8,4-g17-path13", "64S10-8,8,2-g9-path1", "64S9-4,8,4-g13-path14", "64S11-8,8,4-g17-path1", "64S8-4,8,2-g5-path1" ];
