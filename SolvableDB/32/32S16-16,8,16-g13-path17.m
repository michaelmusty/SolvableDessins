...
s`SolvableDBName := "32S16-16,8,16-g13-path17";
s`SolvableDBFilename := "32S16-16,8,16-g13-path17.m";
...
{ IntegerRing() | 25, 31 }
@};
s`SolvableDBBelyiMapTiming := 1.860p15;
s`SolvableDBSanityCheckTiming := 190.810p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,4,8-g5-path7", "32S16-16,8,16-g13-path17" ];
s`SolvableDBParents := [ Strings() | "64S50-32,16,32-g29-path25", "64S51-32,16,32-g29-path17", "64S50-32,16,32-g29-path26", "64S51-32,16,32-g29-path18", "64S44-16,8,16-g25-path55", "64S26-16,8,16-g25-path9", "64S29-16,8,16-g25-path9" ];
