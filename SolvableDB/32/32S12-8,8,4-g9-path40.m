...
s`SolvableDBName := "32S12-8,8,4-g9-path40";
s`SolvableDBFilename := "32S12-8,8,4-g9-path40.m";
...
\[ 6, 1, 12, 15, 17, 23, 4, 24, 2, 3, 5, 7, 8, 31, 30, 18, 9, 22, 26, 28, 10, 20, 11, 16, 19, 32, 29, 13, 14, 21, 25, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path28", "32S12-8,8,4-g9-path40" ];
s`SolvableDBParents := [ Strings() | "64S44-16,16,8-g25-path17", "64S44-16,16,8-g25-path18", "64S45-16,16,4-g21-path17", "64S16-8,8,8-g21-path110", "64S45-16,16,4-g21-path18", "64S15-8,8,8-g21-path110", "64S17-8,8,4-g17-path18" ];
s`SolvableDBChild := "16T8-4,4,4-g3-path28";
