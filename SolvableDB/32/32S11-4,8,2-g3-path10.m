...
phi := KX!((64*x[1]^14 + 896*x[1]^12 + 4032*x[1]^10 + 6400*x[1]^8 + 4032*x[1]^6 + 896*x[1]^4 + 64*x[1]^2)/(x[1]^16 + 56*x[1]^14 + 924*x[1]^12 + 3976*x[1]^10 + 6470*x[1]^8 + 3976*x[1]^6 + 924*x[1]^4 + 56*x[1]^2 + 1));
/* assign to object */
...
\[ 6, 1, 21, 22, 19, 8, 4, 2, 3, 5, 7, 31, 12, 23, 20, 28, 29, 32, 26, 17, 25, 11, 16, 18, 9, 10, 13, 14, 15, 24, 27, 30 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S11-4,8,2-g3-path10" ];
