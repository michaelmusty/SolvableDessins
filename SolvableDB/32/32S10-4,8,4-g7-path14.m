...
I<[x]> := ideal< P | [
x[1]^3*x[3]^2 + (-nu^2 + 1)*x[1]^2*x[3]^2 + 2*nu^3*x[1]*x[2]*x[3]^2 - nu^2*x[2]^2*x[3]^2 + nu^3*x[1]^2*x[2] - x[1]*x[3]^2 + (-nu^2 + 1)*x[1]^2 + (-nu^3 + nu)*x[1]*x[2] + nu^2*x[2]^2 - nu^2*x[3]^2 + (-nu^2 - 1)*x[1] + (-2*nu^3 - nu)*x[2] - 1,
x[1]^2*x[2]*x[3]^2 - nu^3*x[1]^2*x[3]^2 + nu^2*x[1]*x[2]*x[3]^2 - nu*x[2]^2*x[3]^2 + nu^3*x[1]*x[3]^2 + x[1]*x[2] + nu*x[2]^2 - nu*x[3]^2 - nu*x[1] - nu^2*x[2],
x[1]*x[2]^2*x[3]^2 + (-nu^2 - 1)*x[1]^2*x[3]^2 + 2*nu*x[1]*x[2]*x[3]^2 - x[2]^2*x[3]^2 - x[1]*x[2]^2 + nu^2*x[1]*x[3]^2 + (-nu^3 + nu)*x[1]*x[2] + x[2]^2 - x[3]^2 - x[1] + (nu^3 - nu)*x[2] + 1,
x[2]^3*x[3]^2 - 2*nu*x[1]^2*x[3]^2 + (nu^2 + 1)*x[1]*x[2]*x[3]^2 + nu^3*x[2]^2*x[3]^2 + (nu^3 - nu)*x[1]*x[2]^2 - x[2]^3 + (nu^3 + nu)*x[1]*x[3]^2 + x[2]*x[3]^2 + 2*x[1]*x[2] + (-nu^3 + 2*nu)*x[2]^2 + nu^3*x[3]^2 + (nu^3 - nu)*x[1] + (-nu^2 - 2)*x[2] + nu,
...
{ IntegerRing() | 31, 32 }
@};
s`SolvableDBBelyiMapTiming := 3.060p15;
s`SolvableDBLocalSanityCheckTiming := 3.430p15;
