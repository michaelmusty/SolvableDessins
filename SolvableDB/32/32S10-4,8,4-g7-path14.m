...
s`SolvableDBSanityCheckTiming := 9.470p15;
...
x2*x4^4 + 1/2*(-nu^3 - 5*nu)*x4^4 + x2^3 + 1/2*(nu^3 + 5*nu)*x2^2,
x2^2*x3 + 1/2*(nu^3 + 5*nu)*x2*x4^2 + 1/2*(nu^3 + 5*nu)*x2*x3 + x4^2,
x2*x3^2 + 1/2*(nu^3 + 5*nu)*x3^2 - x2 + 1/2*(nu^3 + 5*nu),
x3*x4^2 + 1/2*(-nu^3 - 5*nu)*x2,
x1^2 - x2^2 + 1
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S10-4,8,4-g7-path14" ];
s`SolvableDBParents := [ Strings() | "64S7-8,8,4-g17-path5", "64S13-8,8,4-g17-path3", "64S7-8,8,4-g17-path6", "64S14-8,8,4-g17-path3", "64S9-4,8,4-g13-path11", "64S21-4,8,4-g13-path6", "64S9-4,8,4-g13-path12" ];
