...
{ IntegerRing() | 30, 31 }
@};
s`SolvableDBBelyiMapTiming := 4.030p15;
s`SolvableDBSanityCheckTiming := 113.740p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-2,8,8-g3-path6", "32S12-4,8,8-g9-path6" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path43", "64S44-4,16,16-g21-path43", "64S45-8,16,16-g25-path43", "64S44-4,16,16-g21-path44", "64S45-8,16,16-g25-path44", "64S15-8,8,8-g21-path43", "64S17-4,8,8-g17-path43" ];
s`SolvableDBChildren := [ Strings() | "16T5-2,8,8-g3-path6" ];
