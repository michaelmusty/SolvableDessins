...
x[2]^2*x[4]^2 - x[1]*x[2]*x[3] - 2*x[1]*x[4]^2,
x[1]^3 - x[2]^2 + x[1],
x[2]*x[3]^2 - x[1]^2 + 1,
x[3]*x[4]^2 - 1
] >;
...
s`SolvableDBName := "32S17-16,16,8-g13-path7";
s`SolvableDBFilename := "32S17-16,16,8-g13-path7.m";
...
{ IntegerRing() | 30, 32 }
@};
s`SolvableDBBelyiMapTiming := 3.270p15;
s`SolvableDBLocalSanityCheckTiming := 3.930p15;
...
\[ 6, 1, 12, 23, 14, 24, 4, 15, 2, 3, 5, 7, 8, 31, 16, 18, 9, 20, 17, 21, 32, 28, 30, 22, 19, 10, 29, 27, 11, 13, 25, 26 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path3", "32S17-16,16,8-g13-path7" ];
s`SolvableDBParents := [ Strings() | "64S27-16,16,8-g25-path4", "64S44-16,16,8-g25-path68", "64S29-16,16,8-g25-path22" ];
