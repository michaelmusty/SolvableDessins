...
phi := KX!(-16*x[1]^8/(x[1]^16 + 4*x[1]^12 - 10*x[1]^8 + 4*x[1]^4 + 1));
/* assign to object */
...
s`SolvableDBName := "32S11-8,4,2-g3-path6";
s`SolvableDBFilename := "32S11-8,4,2-g3-path6.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 18, 29, 24, 20, 9, 25, 27, 8, 17, 32, 15, 10, 16, 11, 12, 13, 14, 30, 31, 26, 28 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path7", "32S11-8,4,2-g3-path6" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,2-g9-path19", "64S20-8,4,4-g13-path19", "64S7-8,8,4-g17-path98", "64S10-8,8,2-g9-path19", "64S9-8,4,4-g13-path87", "64S11-8,8,4-g17-path30", "64S8-8,4,2-g5-path8" ];
