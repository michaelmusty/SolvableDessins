...
phi := KX!((-x[1]^8 + 1)/(4*x[1]^4)*x[3]^4 + x[1]^2/2*x[3]^2 + (x[1]^8 + 1)/4);
/* assign to object */
...
s`SolvableDBName := "32S15-8,8,8-g11-path61";
s`SolvableDBFilename := "32S15-8,8,8-g11-path61.m";
...
\[ 10, 13, 18, 21, 2, 5, 23, 27, 6, 9, 3, 16, 20, 26, 4, 28, 30, 7, 22, 1, 11, 12, 15, 19, 32, 25, 24, 8, 14, 29, 17, 31 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path18", "32S15-8,8,8-g11-path61" ];
s`SolvableDBParents := [ Strings() | "64S22-8,8,8-g21-path41", "64S16-8,8,8-g21-path281", "64S15-8,8,8-g21-path281" ];
