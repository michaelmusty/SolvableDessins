...
I<[x]> := ideal< P | [
x[3]*x[4]^4 - 1/4*x[1]*x[3]^3 + 1/16*x[1]^2*x[4]^2 - 1/2*x[3]^3 + 1/8*x[1]*x[4]^2 - 1/16*x[2]*x[3] + 1/2*x[4]^2,
x[1]^2*x[3]^2 - 4*x[3]^2 - x[2],
x[1]*x[2]*x[3]^2 + 2*x[2]*x[3]^2 - 16*x[3]*x[4]^2 - x[1]^2 - 2*x[1] - 8,
x[2]^2*x[3]^2 - 8*x[1]*x[3]^2 - x[1]*x[2],
x[1]*x[3]*x[4]^2 - 2*x[3]*x[4]^2 - 1,
x[1]^3 - x[2]^2 + 4*x[1],
x[2]*x[4]^2 - x[1]*x[3] - 2*x[3]
] >;
...
s`SolvableDBName := "32S16-16,16,8-g13-path7";
s`SolvableDBFilename := "32S16-16,16,8-g13-path7.m";
...
\[ 6, 1, 11, 17, 19, 22, 4, 3, 2, 5, 7, 8, 26, 9, 29, 30, 31, 15, 32, 16, 13, 18, 14, 10, 12, 20, 21, 23, 24, 25, 27, 28 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,4-g5-path7", "32S16-16,16,8-g13-path7" ];
s`SolvableDBParents := [ Strings() | "64S50-32,32,16-g29-path43", "64S51-32,32,16-g29-path35", "64S50-32,32,16-g29-path44", "64S51-32,32,16-g29-path36", "64S44-16,16,8-g25-path64", "64S26-16,16,8-g25-path18", "64S29-16,16,8-g25-path18" ];
