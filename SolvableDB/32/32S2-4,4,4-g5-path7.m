...
I<[x]> := ideal< P | [
x[1]^2*x[3]^2 - x[1]^2 + 2*x[1]*x[3]^2 + 2*x[1] - x[3]^2 + 1,
4*x[1]^2 - 4*x[1]*x[3]^2 - 4*x[1] + x[2]^2*x[3]^2 - x[2]^2 + 2*x[3]^2 - 2,
x[1]^3 - x[1] - x[2]^2
] >;
...
s`SolvableDBLocalSanityCheckTiming := 0.190000000000000p15;
...
s`SolvableDBParents := [ Strings() | "64S20-8,4,4-g13-path9", "64S21-4,8,4-g13-path15", "64S25-8,8,4-g17-path5", "64S21-4,4,8-g13-path15", "64S17-8,4,8-g17-path9", "64S24-4,8,8-g17-path3", "64S22-8,8,8-g21-path13", "64S21-8,4,4-g13-path15", "64S18-4,8,4-g13-path3", "64S24-8,8,4-g17-path3", "64S20-4,4,8-g13-path9", "64S24-8,4,8-g17-path3", "64S25-4,8,8-g17-path5", "64S19-8,8,8-g21-path3", "64S20-8,4,4-g13-path10", "64S20-4,8,4-g13-path9", "64S17-8,8,4-g17-path9", "64S20-4,4,8-g13-path10", "64S25-8,4,8-g17-path5", "64S17-4,8,8-g17-path9", "64S22-8,8,8-g21-path14", "64S18-8,4,4-g13-path3", "64S20-4,8,4-g13-path10", "64S25-8,8,4-g17-path6", "64S18-4,4,8-g13-path3", "64S25-8,4,8-g17-path6", "64S25-4,8,8-g17-path6", "64S22-8,8,8-g21-path15", "64S23-4,4,4-g9-path7", "64S23-4,4,4-g9-path8", "64S23-4,4,4-g9-path9" ];
