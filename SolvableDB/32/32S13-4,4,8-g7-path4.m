...
\[ 11, 30, 12, 7, 2, 5, 10, 21, 18, 26, 9, 22, 16, 13, 29, 23, 8, 1, 24, 3, 25, 20, 14, 31, 17, 4, 19, 32, 28, 6, 27, 15 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T12-4,2,8-g2-path3", "32S13-4,4,8-g7-path4" ];
s`SolvableDBParents := [ Strings() | "64S46-8,4,16-g19-path15", "64S46-4,8,16-g19-path15", "64S15-8,8,8-g21-path153", "64S46-8,4,16-g19-path16", "64S46-4,8,16-g19-path16", "64S15-8,8,8-g21-path154", "64S21-4,4,8-g13-path42" ];
s`SolvableDBChild := "16T12-4,2,8-g2-path3";
