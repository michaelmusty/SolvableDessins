...
s`SolvableDBName := "32S16-16,8,16-g13-path10";
s`SolvableDBFilename := "32S16-16,8,16-g13-path10.m";
...
{ IntegerRing() | 28, 32 }
@};
s`SolvableDBBelyiMapTiming := 2.210p15;
s`SolvableDBSanityCheckTiming := 1.240p15;
s`SolvableDBLocalSanityCheckTiming := 1.170p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,4,8-g5-path3", "32S16-16,8,16-g13-path10" ];
s`SolvableDBParents := [ Strings() | "64S50-32,16,32-g29-path11", "64S51-32,16,32-g29-path3", "64S50-32,16,32-g29-path12", "64S51-32,16,32-g29-path4", "64S29-16,8,16-g25-path2", "64S26-16,8,16-g25-path2", "64S44-16,8,16-g25-path48" ];
