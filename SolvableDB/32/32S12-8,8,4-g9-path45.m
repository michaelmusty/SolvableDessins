...
s`SolvableDBName := "32S12-8,8,4-g9-path45";
s`SolvableDBFilename := "32S12-8,8,4-g9-path45.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path31", "32S12-8,8,4-g9-path45" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path132", "64S15-8,8,8-g21-path132", "64S44-16,16,4-g21-path39", "64S45-16,16,8-g25-path39", "64S44-16,16,4-g21-path40", "64S45-16,16,8-g25-path40", "64S17-8,8,4-g17-path40" ];
