...
s`SolvableDBName := "32S4-8,8,4-g9-path14";
s`SolvableDBFilename := "32S4-8,8,4-g9-path14.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T4-4,4,4-g3-path8", "32S4-8,8,4-g9-path14" ];
s`SolvableDBParents := [ Strings() | "64S3-8,8,8-g21-path198", "64S28-16,16,4-g21-path11", "64S28-16,16,8-g25-path11", "64S3-8,8,8-g21-path199", "64S28-16,16,4-g21-path12", "64S28-16,16,8-g25-path12", "64S17-8,8,4-g17-path162" ];
