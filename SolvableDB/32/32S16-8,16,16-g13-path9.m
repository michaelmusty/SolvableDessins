...
s`SolvableDBName := "32S16-8,16,16-g13-path9";
s`SolvableDBFilename := "32S16-8,16,16-g13-path9.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-4,8,8-g5-path3", "32S16-8,16,16-g13-path9" ];
s`SolvableDBParents := [ Strings() | "64S50-16,32,32-g29-path43", "64S51-16,32,32-g29-path35", "64S50-16,32,32-g29-path44", "64S51-16,32,32-g29-path36", "64S44-8,16,16-g25-path64", "64S26-8,16,16-g25-path18", "64S29-8,16,16-g25-path18" ];
