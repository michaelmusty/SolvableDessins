...
s`SolvableDBSanityCheckTiming := 84.710p15;
s`SolvableDBLocalSanityCheckTiming := 8.180p15;
...
x2^2*x5^4 - x5^4 - x2*x4^2,
x1*x5^4 - x2*x3,
x1*x4^3 - x1*x2*x5^2 + x3*x4,
x2*x4^3 - x2^2*x5^2 + x5^2,
x4^4 + x3^2 - x2,
x3^2*x5^2 + x4^3 - x2*x5^2,
x2^2*x3 - x1*x4^2 - x3,
x2*x3^2 - 1,
x2*x3*x4 - x1*x5^2,
x4*x5^2 - 1,
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,4,8-g5-path6", "32S17-16,8,16-g13-path12" ];
