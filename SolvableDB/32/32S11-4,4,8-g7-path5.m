...
s`SolvableDBName := "32S11-4,4,8-g7-path5";
s`SolvableDBFilename := "32S11-4,4,8-g7-path5.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S11-4,4,8-g7-path5" ];
s`SolvableDBParents := [ Strings() | "64S6-4,8,8-g17-path7", "64S11-4,8,8-g17-path29", "64S10-4,8,8-g17-path7", "64S7-4,8,8-g17-path97", "64S9-4,4,8-g13-path108", "64S8-4,4,8-g13-path18", "64S20-4,4,8-g13-path40" ];
