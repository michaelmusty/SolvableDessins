...
\[ 2, 5, 9, 10, 6, 1, 4, 11, 15, 19, 12, 22, 16, 28, 21, 29, 25, 30, 7, 23, 3, 8, 17, 18, 20, 31, 24, 26, 32, 27, 14, 13 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path3", "32S11-4,4,8-g7-path5" ];
s`SolvableDBParents := [ Strings() | "64S6-4,8,8-g17-path7", "64S11-4,8,8-g17-path29", "64S10-4,8,8-g17-path7", "64S7-4,8,8-g17-path97", "64S9-4,4,8-g13-path103", "64S8-4,4,8-g13-path13", "64S20-4,4,8-g13-path35" ];
