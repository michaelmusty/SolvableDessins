...
I<[x]> := ideal< P | [
x[3]*x[4]^4 + 2/9*x[1]*x[3]^3 - 4/3*x[3]^2*x[4]^2 + 4/9*x[3]^3 + 2/3*x[2]*x[4]^2 - 2/9*x[2]*x[3],
x[1]^2*x[3]^2 + x[1]*x[3]^2 - 3*x[3]*x[4]^2 - x[1]*x[2] + 2*x[3]^2 - x[2],
x[2]^2*x[4]^2 + 2/3*x[1]^2*x[3] + 2/3*x[1]*x[3] - 2*x[4]^2 + 4/3*x[3],
x[2]*x[3]*x[4]^2 + 2/3*x[1] + 2/3,
x[1]^3 - x[2]^2 + x[1],
x[2]*x[3]^2 - x[1]^2 + 1,
x[1]*x[4]^2 - x[4]^2 + 2/3*x[3]
] >;
...
s`SolvableDBName := "32S16-16,16,8-g13-path11";
s`SolvableDBFilename := "32S16-16,16,8-g13-path11.m";
...
{ IntegerRing() | 25, 31 }
@};
s`SolvableDBBelyiMapTiming := 1.020p15;
...
\[ 6, 1, 11, 17, 19, 22, 4, 3, 2, 5, 7, 8, 26, 9, 29, 30, 31, 15, 32, 16, 13, 18, 14, 10, 12, 20, 21, 23, 24, 25, 27, 28 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path3", "32S16-16,16,8-g13-path11" ];
s`SolvableDBParents := [ Strings() | "64S50-32,32,16-g29-path13", "64S51-32,32,16-g29-path5", "64S50-32,32,16-g29-path14", "64S51-32,32,16-g29-path6", "64S44-16,16,8-g25-path49", "64S26-16,16,8-g25-path3", "64S29-16,16,8-g25-path3" ];
s`SolvableDBChild := "16T5-8,8,4-g5-path3";
