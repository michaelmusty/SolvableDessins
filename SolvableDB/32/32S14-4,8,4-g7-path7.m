...
[-16, 0, 0, 0, 0, 0, 0, 0, 24, 0, 0, 0, 0, 0, 0, 0, -1],
[]
]);
X<x1,x2,x3> := HyperellipticCurve([f, g]);
s`SolvableDBBelyiCurve := X;
KX<x1, x2> := FunctionField(X);
s`SolvableDBBelyiMap := KX!((-32*x1^16 - 128*x1^8)/(x1^32 - 16*x1^24 + 96*x1^16 - 256*x1^8 + 256)*x2 + (x1^32 - 16*x1^24 - 416*x1^16 - 256*x1^8 + 256)/(x1^32 - 16*x1^24 + 96*x1^16 - 256*x1^8 + 256));

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T8-4,4,4-g3-path10", "32S14-4,8,4-g7-path7" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path201", "64S48-4,16,4-g15-path15", "64S49-8,16,8-g23-path29", "64S47-4,16,4-g15-path15", "64S49-8,16,8-g23-path30", "64S16-8,8,8-g21-path202", "64S21-4,8,4-g13-path66" ];
