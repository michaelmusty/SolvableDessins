...
s`SolvableDBName := "32S15-8,8,8-g11-path15";
s`SolvableDBFilename := "32S15-8,8,8-g11-path15.m";
...
{ IntegerRing() | 29, 32 }
@};
s`SolvableDBBelyiMapTiming := 1.930p15;
s`SolvableDBSanityCheckTiming := 59.940p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T8-4,4,4-g3-path16", "32S15-8,8,8-g11-path15" ];
s`SolvableDBParents := [ Strings() | "64S22-8,8,8-g21-path7", "64S16-8,8,8-g21-path247", "64S15-8,8,8-g21-path247" ];
