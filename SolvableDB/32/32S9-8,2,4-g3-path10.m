...
s`SolvableDBBelyiMap := KX!((-x1^16 + 8*x1^14 - 28*x1^12 + 56*x1^10 - 70*x1^8 + 56*x1^6 - 28*x1^4 + 8*x1^2 - 1)/(64*x1^14 + 896*x1^12 + 4032*x1^10 + 6400*x1^8 + 4032*x1^6 + 896*x1^4 + 64*x1^2));
