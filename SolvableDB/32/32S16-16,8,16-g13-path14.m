...
{ IntegerRing() | 28, 32 }
@};
s`SolvableDBBelyiMapTiming := 1.220p15;
s`SolvableDBSanityCheckTiming := 1.760p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,4,8-g5-path5", "32S16-16,8,16-g13-path14" ];
s`SolvableDBParents := [ Strings() | "64S50-32,16,32-g29-path19", "64S51-32,16,32-g29-path11", "64S50-32,16,32-g29-path20", "64S51-32,16,32-g29-path12", "64S29-16,8,16-g25-path6", "64S26-16,8,16-g25-path6", "64S44-16,8,16-g25-path52" ];
