...
s`SolvableDBName := "32S12-8,4,8-g9-path28";
s`SolvableDBFilename := "32S12-8,4,8-g9-path28.m";
...
s`SolvableDBSanityCheckTiming := 6.240p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T8-4,4,4-g3-path19", "32S12-8,4,8-g9-path28" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path67", "64S15-8,8,8-g21-path67", "64S45-16,4,16-g21-path23", "64S44-16,8,16-g25-path23", "64S45-16,4,16-g21-path24", "64S44-16,8,16-g25-path24", "64S17-8,4,8-g17-path21" ];
