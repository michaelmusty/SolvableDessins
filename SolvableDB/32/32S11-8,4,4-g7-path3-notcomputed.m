...
s`SolvableDBName := "32S11-8,4,4-g7-path3-notcomputed";
s`SolvableDBFilename := "32S11-8,4,4-g7-path3-notcomputed.m";
...
\[ 6, 1, 4, 21, 18, 22, 20, 23, 2, 3, 5, 7, 8, 17, 19, 13, 16, 9, 26, 28, 12, 11, 25, 32, 29, 31, 30, 10, 14, 15, 24, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T10-4,2,4-g1-path4-notcomputed", "32S11-8,4,4-g7-path3-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S6-8,4,8-g17-path2-notcomputed", "64S11-8,4,8-g17-path4-notcomputed", "64S10-8,4,8-g17-path2-notcomputed", "64S7-8,4,8-g17-path12-notcomputed", "64S9-8,4,4-g13-path14-notcomputed", "64S8-8,4,4-g13-path2-notcomputed", "64S20-8,4,4-g13-path4-notcomputed" ];
