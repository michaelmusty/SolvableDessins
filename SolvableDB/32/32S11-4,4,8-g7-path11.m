...
s`SolvableDBName := "32S11-4,4,8-g7-path11";
s`SolvableDBFilename := "32S11-4,4,8-g7-path11.m";
...
s`SolvableDBSanityCheckTiming := 2.980p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path9", "32S11-4,4,8-g7-path11" ];
s`SolvableDBParents := [ Strings() | "64S6-4,8,8-g17-path3", "64S11-4,8,8-g17-path25", "64S10-4,8,8-g17-path3", "64S7-4,8,8-g17-path93", "64S9-4,4,8-g13-path93", "64S8-4,4,8-g13-path3", "64S20-4,4,8-g13-path25" ];
