...
s`SolvableDBName := "32S10-4,4,8-g7-path8-notcomputed";
s`SolvableDBFilename := "32S10-4,4,8-g7-path8-notcomputed.m";
...
\[ 6, 1, 18, 22, 20, 9, 4, 23, 2, 3, 5, 7, 8, 32, 13, 25, 27, 26, 21, 30, 16, 12, 15, 17, 19, 10, 29, 31, 24, 11, 14, 28 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T12-4,2,8-g2-path1-notcomputed", "32S10-4,4,8-g7-path8-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S13-4,8,8-g17-path2-notcomputed", "64S7-4,8,8-g17-path3-notcomputed", "64S14-4,8,8-g17-path2-notcomputed", "64S7-4,8,8-g17-path4-notcomputed", "64S9-4,4,8-g13-path3-notcomputed", "64S21-4,4,8-g13-path2-notcomputed", "64S9-4,4,8-g13-path4-notcomputed" ];
