...
s`SolvableDBName := "32S8-4,8,8-g9-path7";
s`SolvableDBFilename := "32S8-4,8,8-g9-path7.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path5", "32S8-4,8,8-g9-path7" ];
s`SolvableDBParents := [ Strings() | "64S11-4,8,8-g17-path61", "64S5-4,8,8-g17-path85", "64S13-4,8,8-g17-path51", "64S13-4,8,8-g17-path52", "64S5-4,8,8-g17-path86", "64S11-4,8,8-g17-path62", "64S24-4,8,8-g17-path101" ];
