...
s`SolvableDBName := "32S11-4,8,4-g7-path11";
s`SolvableDBFilename := "32S11-4,8,4-g7-path11.m";
...
s`SolvableDBSanityCheckTiming := 1.150p15;
...
I<x1, x2, x3> := ideal< PX | [
x1*x2^2*x3^2 + 2*nu*x1*x2*x3^2 - x1^2*x2 + x1*x3^2 + nu*x1^2 - x2^2 - nu*x2,
x1^2*x3^2 + 1/2*nu*x2^2*x3^2 - 1/2*x1*x2^2 + x2*x3^2 + nu*x1*x2 - 1/2*nu*x3^2 - 1/2*x1,
x2^3 - 2*x1^2 + x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path9", "32S11-4,8,4-g7-path11" ];
s`SolvableDBParents := [ Strings() | "64S6-4,8,8-g17-path14", "64S7-4,8,8-g17-path104", "64S10-4,8,8-g17-path14", "64S11-4,8,8-g17-path36", "64S20-4,8,4-g13-path25", "64S8-4,8,4-g13-path3", "64S9-4,8,4-g13-path93" ];
