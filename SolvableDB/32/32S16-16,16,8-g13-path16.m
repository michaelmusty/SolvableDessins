...
{ IntegerRing() | 28, 31 }
@};
s`SolvableDBBelyiMapTiming := 0.660p15;
s`SolvableDBSanityCheckTiming := 15.080p15;
s`SolvableDBLocalSanityCheckTiming := 5.430p15;
...
x1^2*x4^2 - 2*x2*x3 - x4^2,
x2^2*x4^2 - x1*x2*x3 - x1*x4^2,
x1^3 - 2*x2^2 + x1,
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path6", "32S16-16,16,8-g13-path16" ];
s`SolvableDBParents := [ Strings() | "64S50-32,32,16-g29-path23", "64S51-32,32,16-g29-path15", "64S50-32,32,16-g29-path24", "64S51-32,32,16-g29-path16", "64S29-16,16,8-g25-path8", "64S26-16,16,8-g25-path8", "64S44-16,16,8-g25-path54" ];
s`SolvableDBChildren := [ Strings() | "16T5-8,8,4-g5-path6" ];
