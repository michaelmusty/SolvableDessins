...
s`SolvableDBName := "32S11-8,4,2-g3-path11";
s`SolvableDBFilename := "32S11-8,4,2-g3-path11.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S11-8,4,2-g3-path11" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,2-g9-path14", "64S20-8,4,4-g13-path14", "64S7-8,8,4-g17-path93", "64S10-8,8,2-g9-path14", "64S9-8,4,4-g13-path82", "64S11-8,8,4-g17-path25", "64S8-8,4,2-g5-path3" ];
