...
s`SolvableDBName := "32S7-8,8,2-g5-path7";
s`SolvableDBFilename := "32S7-8,8,2-g5-path7.m";
...
{ IntegerRing() | 27, 31 }
@};
s`SolvableDBBelyiMapTiming := 1.15000000000000p15;
s`SolvableDBSanityCheckTiming := 0.650000000000000p15;
...
\[ 6, 1, 20, 21, 18, 22, 4, 2, 3, 5, 7, 32, 23, 30, 28, 25, 31, 8, 16, 15, 29, 10, 17, 9, 11, 12, 13, 14, 19, 24, 26, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S7-8,8,2-g5-path7" ];
s`SolvableDBParents := [ Strings() | "64S4-8,8,4-g17-path42", "64S24-8,8,4-g17-path89", "64S10-8,8,4-g17-path30", "64S14-8,8,4-g17-path42", "64S4-8,8,2-g9-path42", "64S12-8,8,2-g9-path8", "64S10-8,8,2-g9-path30" ];
