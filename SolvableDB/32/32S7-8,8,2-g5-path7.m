...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path5", "32S7-8,8,2-g5-path7" ];
s`SolvableDBParents := [ Strings() | "64S4-8,8,4-g17-path43", "64S24-8,8,4-g17-path90", "64S10-8,8,4-g17-path31", "64S14-8,8,4-g17-path43", "64S4-8,8,2-g9-path43", "64S12-8,8,2-g9-path9", "64S10-8,8,2-g9-path31" ];
