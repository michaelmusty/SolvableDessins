...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-2,8,8-g3-path7", "32S12-4,8,8-g9-path7" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path44", "64S44-4,16,16-g21-path45", "64S45-8,16,16-g25-path45", "64S44-4,16,16-g21-path46", "64S45-8,16,16-g25-path46", "64S15-8,8,8-g21-path44", "64S17-4,8,8-g17-path44" ];
