...
s`SolvableDBName := "32S3-8,8,4-g9-path6";
s`SolvableDBFilename := "32S3-8,8,4-g9-path6.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T4-4,4,4-g3-path14", "32S3-8,8,4-g9-path6" ];
s`SolvableDBParents := [ Strings() | "64S2-8,8,8-g21-path84", "64S3-8,8,8-g21-path84", "64S26-16,16,4-g21-path44", "64S26-16,16,8-g25-path44", "64S27-16,16,4-g21-path40", "64S27-16,16,8-g25-path40", "64S17-8,8,4-g17-path153" ];
