...
s`SolvableDBParents := [ Strings() | "64S6-8,2,8-g9-path1", "64S20-4,4,8-g13-path2", "64S7-8,4,8-g17-path13", "64S10-8,2,8-g9-path1", "64S9-4,4,8-g13-path14", "64S11-8,4,8-g17-path1", "64S8-4,2,8-g5-path1" ];
