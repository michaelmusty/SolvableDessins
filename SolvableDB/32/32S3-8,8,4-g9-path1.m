...
s`SolvableDBName := "32S3-8,8,4-g9-path1";
s`SolvableDBFilename := "32S3-8,8,4-g9-path1.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 31, 27, 29, 13, 16, 26, 28, 17, 9, 18, 14, 10, 20, 11, 12, 22, 23, 25, 32, 30 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T4-4,4,4-g3-path4", "32S3-8,8,4-g9-path1" ];
