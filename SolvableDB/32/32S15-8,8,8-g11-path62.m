...
s`SolvableDBName := "32S15-8,8,8-g11-path62";
s`SolvableDBFilename := "32S15-8,8,8-g11-path62.m";
...
\[ 6, 1, 12, 15, 17, 23, 4, 24, 2, 3, 5, 7, 8, 31, 30, 18, 9, 22, 26, 29, 10, 20, 11, 16, 19, 32, 28, 14, 13, 21, 25, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path18", "32S15-8,8,8-g11-path62" ];
s`SolvableDBParents := [ Strings() | "64S15-8,8,8-g21-path270", "64S16-8,8,8-g21-path270", "64S22-8,8,8-g21-path30" ];
