...
s`SolvableDBName := "32S16-16,8,16-g13-path9";
s`SolvableDBFilename := "32S16-16,8,16-g13-path9.m";
...
{ IntegerRing() | 25, 31 }
@};
s`SolvableDBBelyiMapTiming := 1.960p15;
s`SolvableDBSanityCheckTiming := 1.220p15;
s`SolvableDBLocalSanityCheckTiming := 1.030p15;
...
x3*x4^4 - 1/2*x3^2*x4^2 - 1/2*x1*x4^2 + 1/2*x2*x4^2 - 1/4*x1*x3 + x4^2 - 1/4*x3,
x2^2*x3^2 - 2*x3*x4^2 - x1*x2 + x3^2 - 1,
x1^2*x4^2 + 1/2*x1^2*x3 + 1/2*x1*x2*x3 - x2*x4^2,
x1*x2*x4^2 + 1/2*x1*x2*x3 + 1/2*x2^2*x3 + x1*x4^2 - x2*x4^2 + 1/2*x1*x3 - x4^2 + 1/2*x3,
x2^2*x4^2 + 1/2*x2^2*x3 + x1*x3 - x4^2 + 1/2*x3,
x1*x3*x4^2 + 1/4*x2^2 + 1/2*x1 + 1/4,
x2*x3*x4^2 + 1/2*x1 + 1/2*x2,
x2^3 - 2*x1^2 + x2,
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,4,8-g5-path3", "32S16-16,8,16-g13-path9" ];
s`SolvableDBParents := [ Strings() | "64S50-32,16,32-g29-path43", "64S51-32,16,32-g29-path35", "64S50-32,16,32-g29-path44", "64S51-32,16,32-g29-path36", "64S44-16,8,16-g25-path64", "64S26-16,8,16-g25-path18", "64S29-16,8,16-g25-path18" ];
s`SolvableDBChildren := [ Strings() | "16T5-8,4,8-g5-path3" ];
