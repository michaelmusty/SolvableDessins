...
\[ 6, 1, 15, 12, 19, 22, 4, 3, 2, 5, 7, 8, 29, 30, 31, 13, 27, 9, 32, 17, 14, 16, 18, 10, 11, 20, 21, 23, 24, 25, 26, 28 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,4,8-g5-path6", "32S16-16,8,16-g13-path9" ];
s`SolvableDBParents := [ Strings() | "64S50-32,16,32-g29-path29", "64S51-32,16,32-g29-path21", "64S50-32,16,32-g29-path30", "64S51-32,16,32-g29-path22", "64S44-16,8,16-g25-path57", "64S26-16,8,16-g25-path11", "64S29-16,8,16-g25-path11" ];
