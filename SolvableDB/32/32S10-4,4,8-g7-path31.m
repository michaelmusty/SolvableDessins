...
s`SolvableDBName := "32S10-4,4,8-g7-path31";
s`SolvableDBFilename := "32S10-4,4,8-g7-path31.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T14-4,4,8-g4-path2", "32S10-4,4,8-g7-path31" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path31", "64S13-8,4,8-g17-path16", "64S7-8,4,8-g17-path32", "64S14-8,4,8-g17-path16", "64S9-4,4,8-g13-path49", "64S21-4,4,8-g13-path25", "64S9-4,4,8-g13-path50" ];
