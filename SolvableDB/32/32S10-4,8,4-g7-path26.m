...
I<[x]> := ideal< P | [
x[2]^2*x[3]^4 - 28*x[1]*x[3]^4 - 2*x[2]^2*x[3]^2 + 12*x[3]^4 - 16*x[1]^3 - 120*x[1]*x[3]^2 + 64*x[1]^2 + x[2]^2 + 32*x[3]^2 - 76*x[1] - 44,
x[1]*x[2]^2*x[3]^2 + 2*x[2]^2*x[3]^2 + 4*x[1]^3 - x[1]*x[2]^2 + 12*x[1]*x[3]^2 - 8*x[1]^2 + 2*x[2]^2 - 4*x[3]^2 + 8*x[1] + 4,
x[1]^4 + 1/4*x[2]^2*x[3]^2 - 2*x[1]^3 - 7*x[1]*x[3]^2 + 5*x[1]^2 - 1/4*x[2]^2 + 3*x[3]^2 - 5*x[1] - 3,
...
s`SolvableDBName := "32S10-4,8,4-g7-path26";
s`SolvableDBFilename := "32S10-4,8,4-g7-path26.m";
...
\[ 6, 1, 22, 23, 21, 9, 4, 24, 2, 3, 5, 7, 8, 18, 32, 25, 13, 27, 26, 14, 30, 28, 12, 17, 19, 16, 20, 10, 31, 11, 15, 29 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T12-4,8,2-g2-path2", "32S10-4,8,4-g7-path26" ];
s`SolvableDBParents := [ Strings() | "64S7-4,8,8-g17-path45", "64S13-4,8,8-g17-path23", "64S7-4,8,8-g17-path46", "64S14-4,8,8-g17-path23", "64S9-4,8,4-g13-path41", "64S21-4,8,4-g13-path21", "64S9-4,8,4-g13-path42" ];
