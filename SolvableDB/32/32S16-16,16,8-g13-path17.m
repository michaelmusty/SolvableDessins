...
s`SolvableDBName := "32S16-16,16,8-g13-path17";
s`SolvableDBFilename := "32S16-16,16,8-g13-path17.m";
...
s`SolvableDBSanityCheckTiming := 0.620p15;
...
s`SolvableDBBelyiMap := KX!(1/4*x2^3 - x4^8/2*x2^2 - 3/4*x2 + (-x4^8 + 2)/4);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T5-8,8,4-g5-path7", "32S16-16,16,8-g13-path17" ];
s`SolvableDBParents := [ Strings() | "64S50-32,32,16-g29-path25", "64S51-32,32,16-g29-path17", "64S50-32,32,16-g29-path26", "64S51-32,32,16-g29-path18", "64S44-16,16,8-g25-path55", "64S26-16,16,8-g25-path9", "64S29-16,16,8-g25-path9" ];
