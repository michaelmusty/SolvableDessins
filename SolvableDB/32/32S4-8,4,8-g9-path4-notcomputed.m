...
s`SolvableDBName := "32S4-8,4,8-g9-path4-notcomputed";
s`SolvableDBFilename := "32S4-8,4,8-g9-path4-notcomputed.m";
...
\[ 15, 31, 26, 27, 25, 19, 16, 3, 29, 24, 32, 17, 10, 7, 23, 13, 20, 9, 28, 21, 8, 12, 11, 4, 30, 22, 14, 5, 1, 2, 6, 18 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T2-2,2,2-g0-path3-notcomputed", "8T2-4,2,4-g1-path5-notcomputed", "16T6-8,2,8-g3-path1-notcomputed", "32S4-8,4,8-g9-path4-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S28-16,8,16-g25-path1-notcomputed", "64S28-16,4,16-g21-path1-notcomputed", "64S3-8,8,8-g21-path16-notcomputed", "64S28-16,8,16-g25-path2-notcomputed", "64S28-16,4,16-g21-path2-notcomputed", "64S3-8,8,8-g21-path17-notcomputed", "64S17-8,4,8-g17-path14-notcomputed" ];
