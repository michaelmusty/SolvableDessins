...
\[ 6, 1, 21, 7, 2, 5, 19, 22, 3, 4, 8, 11, 16, 31, 9, 26, 23, 24, 10, 25, 15, 12, 20, 32, 17, 28, 29, 13, 14, 18, 27, 30 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path5", "32S11-4,8,4-g7-path2" ];
s`SolvableDBParents := [ Strings() | "64S6-4,8,8-g17-path16", "64S7-4,8,8-g17-path106", "64S10-4,8,8-g17-path16", "64S11-4,8,8-g17-path38", "64S20-4,8,4-g13-path30", "64S8-4,8,4-g13-path8", "64S9-4,8,4-g13-path98" ];
