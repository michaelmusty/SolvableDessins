...
s`SolvableDBName := "32S2-4,4,4-g5-path59";
s`SolvableDBFilename := "32S2-4,4,4-g5-path59.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T8-4,4,4-g3-path19", "32S2-4,4,4-g5-path59" ];
