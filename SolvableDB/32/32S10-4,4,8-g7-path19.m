...
s`SolvableDBName := "32S10-4,4,8-g7-path19";
s`SolvableDBFilename := "32S10-4,4,8-g7-path19.m";
...
s`SolvableDBSanityCheckTiming := 1.920p15;
...
I<x1, x2, x3> := ideal< PX | [
x1*x2^2*x3^2 - 2*x1*x2*x3^2 - x1^2*x2 - x1*x3^2 - 2*x1^2 + 1/2*x2^2 - 1/2,
x1^2*x3^2 - x2^2*x3^2 - 1/2*x1*x2^2 - x1*x2 + 1/2*x1,
x2^3 - 2*x1^2 - x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S10-4,4,8-g7-path19" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path15", "64S13-8,4,8-g17-path8", "64S7-8,4,8-g17-path16", "64S14-8,4,8-g17-path8", "64S9-4,4,8-g13-path21", "64S21-4,4,8-g13-path11", "64S9-4,4,8-g13-path22" ];
