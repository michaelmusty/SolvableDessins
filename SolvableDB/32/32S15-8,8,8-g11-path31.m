...
{ IntegerRing() | 30, 32 }
@};
s`SolvableDBBelyiMapTiming := 1.970p15;
s`SolvableDBSanityCheckTiming := 69.660p15;
s`SolvableDBLocalSanityCheckTiming := 5.670p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T8-4,4,4-g3-path23", "32S15-8,8,8-g11-path31" ];
s`SolvableDBParents := [ Strings() | "64S22-8,8,8-g21-path25", "64S16-8,8,8-g21-path265", "64S15-8,8,8-g21-path265" ];
