...
s`SolvableDBName := "32S4-8,8,4-g9-path20";
s`SolvableDBFilename := "32S4-8,8,4-g9-path20.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T6-8,8,2-g3-path5", "32S4-8,8,4-g9-path20" ];
s`SolvableDBParents := [ Strings() | "64S3-8,8,8-g21-path212", "64S28-16,16,4-g21-path25", "64S28-16,16,8-g25-path25", "64S3-8,8,8-g21-path213", "64S28-16,16,4-g21-path26", "64S28-16,16,8-g25-path26", "64S17-8,8,4-g17-path169" ];
