...
I<[x]> := ideal< P | [
x[2]^4*x[3]^2 - x[1]*x[2]^3 + x[1]*x[2] + x[3]^2,
x[1]^2*x[2]^2 - x[1]^2 + x[2]^2 + 1,
x[1]^2*x[3]^2 - x[2]^2*x[3]^2 + x[1]*x[2]
] >;
...
phi := KX!(-1/(4*x[3]^4)*x[2]^6 - 1/(4*x[3]^8)*x[2]^4 - 3/(4*x[3]^4)*x[2]^2 + 1/(4*x[3]^8));
/* assign to object */
...
s`SolvableDBParents := [ Strings() | "64S29-8,16,16-g25-path7", "64S31-8,16,16-g25-path1", "64S31-8,16,16-g25-path2", "64S30-8,16,16-g25-path1", "64S31-8,16,16-g25-path3", "64S29-8,16,16-g25-path8", "64S30-8,16,16-g25-path2", "64S31-8,16,16-g25-path4", "64S7-4,8,8-g17-path23", "64S6-4,8,8-g17-path3", "64S5-4,8,8-g17-path4", "64S6-4,8,8-g17-path4", "64S17-4,8,8-g17-path21", "64S4-4,8,8-g17-path1", "64S7-4,8,8-g17-path24" ];
