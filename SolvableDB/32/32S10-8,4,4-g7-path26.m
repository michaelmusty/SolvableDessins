...
s`SolvableDBName := "32S10-8,4,4-g7-path26";
s`SolvableDBFilename := "32S10-8,4,4-g7-path26.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T12-8,4,2-g2-path1", "32S10-8,4,4-g7-path26" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path43", "64S13-8,4,8-g17-path22", "64S7-8,4,8-g17-path44", "64S14-8,4,8-g17-path22", "64S9-8,4,4-g13-path37", "64S21-8,4,4-g13-path19", "64S9-8,4,4-g13-path38" ];
