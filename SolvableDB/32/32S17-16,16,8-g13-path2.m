...
phi := KX!(-x[4]^4/2048*x[2]^3 + (x[4]^16 + 262144)/8388608*x[2]^2 + x[4]^12/32768*x[2] + (7*x[4]^8 + 2048)/4096);
/* assign to object */
...
s`SolvableDBName := "32S17-16,16,8-g13-path2";
s`SolvableDBFilename := "32S17-16,16,8-g13-path2.m";
...
\[ 6, 1, 23, 24, 15, 25, 4, 16, 2, 3, 5, 7, 8, 11, 27, 12, 14, 20, 17, 21, 31, 30, 18, 32, 26, 19, 22, 10, 9, 29, 13, 28 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,4-g5-path5", "32S17-16,16,8-g13-path2" ];
s`SolvableDBParents := [ Strings() | "64S27-16,16,8-g25-path1", "64S29-16,16,8-g25-path5", "64S44-16,16,8-g25-path11" ];
