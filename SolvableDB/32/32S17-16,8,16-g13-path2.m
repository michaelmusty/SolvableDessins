...
s`SolvableDBName := "32S17-16,8,16-g13-path2";
s`SolvableDBFilename := "32S17-16,8,16-g13-path2.m";
...
\[ 6, 1, 23, 24, 15, 25, 4, 16, 2, 3, 5, 7, 8, 27, 30, 17, 31, 14, 21, 11, 13, 9, 32, 10, 18, 19, 20, 22, 28, 29, 12, 26 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,4,8-g5-path3", "32S17-16,8,16-g13-path2" ];
s`SolvableDBParents := [ Strings() | "64S27-16,8,16-g25-path2", "64S29-16,8,16-g25-path6", "64S44-16,8,16-g25-path12" ];
