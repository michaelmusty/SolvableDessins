...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T8-4,4,4-g3-path20", "32S12-8,4,8-g9-path29" ];
s`SolvableDBParents := [ Strings() | "64S45-16,8,16-g25-path19", "64S45-16,8,16-g25-path20", "64S44-16,4,16-g21-path19", "64S16-8,8,8-g21-path68", "64S44-16,4,16-g21-path20", "64S15-8,8,8-g21-path68", "64S17-8,4,8-g17-path22" ];
