...
s`SolvableDBName := "32S16-16,8,16-g13-path6-notcomputed";
s`SolvableDBFilename := "32S16-16,8,16-g13-path6-notcomputed.m";
...
\[ 27, 13, 18, 28, 20, 9, 15, 22, 16, 25, 3, 29, 21, 4, 12, 5, 30, 32, 11, 24, 17, 31, 7, 2, 6, 10, 26, 8, 14, 1, 19, 23 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,2,4-g1-path1-notcomputed", "8T1-8,4,8-g3-path1-notcomputed", "16T5-8,4,8-g5-path1-notcomputed", "32S16-16,8,16-g13-path6-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S50-32,16,32-g29-path5-notcomputed", "64S51-32,16,32-g29-path3-notcomputed", "64S50-32,16,32-g29-path6-notcomputed", "64S51-32,16,32-g29-path4-notcomputed", "64S29-16,8,16-g25-path2-notcomputed", "64S26-16,8,16-g25-path2-notcomputed", "64S44-16,8,16-g25-path6-notcomputed" ];
