...
s`SolvableDBName := "32S3-8,4,8-g9-path17";
s`SolvableDBFilename := "32S3-8,4,8-g9-path17.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,2,8-g2-path1", "16T5-8,2,8-g3-path2", "32S3-8,4,8-g9-path17" ];
s`SolvableDBParents := [ Strings() | "64S2-8,8,8-g21-path38", "64S3-8,8,8-g21-path38", "64S26-16,4,16-g21-path27", "64S26-16,8,16-g25-path27", "64S27-16,4,16-g21-path23", "64S27-16,8,16-g25-path23", "64S17-8,4,8-g17-path136" ];
