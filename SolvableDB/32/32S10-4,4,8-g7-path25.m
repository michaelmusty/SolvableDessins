...
{ IntegerRing() | 29, 30 }
@};
s`SolvableDBBelyiMapTiming := 2.420p15;
...
\[ 2, 5, 9, 7, 6, 1, 10, 11, 14, 21, 15, 16, 30, 22, 23, 31, 24, 25, 26, 12, 4, 3, 8, 19, 32, 17, 18, 29, 13, 28, 20, 27 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T12-2,4,8-g2-path3", "32S10-4,4,8-g7-path25" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path7", "64S13-8,4,8-g17-path4", "64S7-8,4,8-g17-path8", "64S14-8,4,8-g17-path4", "64S9-4,4,8-g13-path9", "64S21-4,4,8-g13-path5", "64S9-4,4,8-g13-path10" ];
