...
s`SolvableDBName := "32S10-4,4,8-g7-path25";
s`SolvableDBFilename := "32S10-4,4,8-g7-path25.m";
...
{ IntegerRing() | 29, 30 }
@};
s`SolvableDBBelyiMapTiming := 0.930p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T12-2,4,8-g2-path3", "32S10-4,4,8-g7-path25" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path27", "64S13-8,4,8-g17-path14", "64S7-8,4,8-g17-path28", "64S14-8,4,8-g17-path14", "64S9-4,4,8-g13-path35", "64S21-4,4,8-g13-path18", "64S9-4,4,8-g13-path36" ];
