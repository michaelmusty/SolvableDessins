...
s`SolvableDBName := "32S7-8,2,8-g5-path7";
s`SolvableDBFilename := "32S7-8,2,8-g5-path7.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S7-8,2,8-g5-path7" ];
