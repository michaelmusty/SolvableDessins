...
s`SolvableDBName := "32S17-16,16,8-g13-path12";
s`SolvableDBFilename := "32S17-16,16,8-g13-path12.m";
...
{ IntegerRing() | 31, 32 }
@};
s`SolvableDBBelyiMapTiming := 1.690p15;
s`SolvableDBSanityCheckTiming := 18.190p15;
s`SolvableDBLocalSanityCheckTiming := 7.420p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path6", "32S17-16,16,8-g13-path12" ];
s`SolvableDBParents := [ Strings() | "64S27-16,16,8-g25-path4", "64S29-16,16,8-g25-path22", "64S44-16,16,8-g25-path68" ];
