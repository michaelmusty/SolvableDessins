...
phi := KX!((x[1]^24 + x[1]^16 - x[1]^8 - 1)/(4*x[1]^16)*x[2] + (x[1]^24 + 3*x[1]^16 + 3*x[1]^8 + 1)/(4*x[1]^8));
/* assign to object */
...
\[ 2, 1, 7, 6, 8, 4, 3, 5, 11, 16, 9, 14, 15, 12, 13, 10, 19, 20, 17, 18, 23, 24, 21, 22, 27, 28, 25, 26, 31, 32, 29, 30 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-2,8,8-g3-path4", "32S16-2,16,16-g7-path3" ];
