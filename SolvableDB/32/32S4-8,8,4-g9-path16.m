...
s`SolvableDBName := "32S4-8,8,4-g9-path16";
s`SolvableDBFilename := "32S4-8,8,4-g9-path16.m";
...
s`SolvableDBSanityCheckTiming := 12.920p15;
s`SolvableDBLocalSanityCheckTiming := 1.740p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T6-8,8,2-g3-path1", "32S4-8,8,4-g9-path16" ];
s`SolvableDBParents := [ Strings() | "64S3-8,8,8-g21-path202", "64S28-16,16,4-g21-path15", "64S28-16,16,8-g25-path15", "64S3-8,8,8-g21-path203", "64S28-16,16,4-g21-path16", "64S28-16,16,8-g25-path16", "64S17-8,8,4-g17-path164" ];
