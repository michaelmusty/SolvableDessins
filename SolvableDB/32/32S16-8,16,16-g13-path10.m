...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 31, 28, 30, 13, 32, 27, 29, 17, 9, 18, 14, 10, 20, 16, 11, 12, 22, 23, 25, 26 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path1", "32S16-8,16,16-g13-path10" ];
s`SolvableDBParents := [ Strings() | "64S50-16,32,32-g29-path13", "64S51-16,32,32-g29-path5", "64S50-16,32,32-g29-path14", "64S51-16,32,32-g29-path6", "64S29-8,16,16-g25-path3", "64S26-8,16,16-g25-path3", "64S44-8,16,16-g25-path49" ];
