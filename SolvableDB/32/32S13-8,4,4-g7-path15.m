...
s`SolvableDBName := "32S13-8,4,4-g7-path15";
s`SolvableDBFilename := "32S13-8,4,4-g7-path15.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path32", "32S13-8,4,4-g7-path15" ];
s`SolvableDBParents := [ Strings() | "64S46-16,8,4-g19-path13", "64S46-16,4,8-g19-path13", "64S15-8,8,8-g21-path219", "64S46-16,8,4-g19-path14", "64S46-16,4,8-g19-path14", "64S15-8,8,8-g21-path220", "64S21-8,4,4-g13-path41" ];
