...
s`SolvableDBName := "32S10-8,4,4-g7-path7";
s`SolvableDBFilename := "32S10-8,4,4-g7-path7.m";
...
{ IntegerRing() | 28, 29 }
@};
s`SolvableDBBelyiMapTiming := 1.22000000000000p15;
...
s`SolvableDBParents := [ Strings() | "64S13-8,8,4-g17-path6", "64S7-8,8,4-g17-path11", "64S14-8,8,4-g17-path6", "64S7-8,8,4-g17-path12", "64S9-8,4,4-g13-path11", "64S21-8,4,4-g13-path6", "64S9-8,4,4-g13-path12" ];
