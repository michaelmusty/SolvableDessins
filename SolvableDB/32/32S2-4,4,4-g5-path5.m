...
I<[x]> := ideal< P | [
-2*x[1]*x[2]^2 - x[1]*x[3]^2 + x[1] + x[2]^3*x[3]^2 + x[2]^3 + 2*x[2],
x[1]^2*x[2]^2 - x[1]^2 - x[2]^2 - 1,
x[1]^2*x[3]^2 + x[1]^2 - 2*x[1]*x[2] + x[2]^2*x[3]^2 + x[2]^2 + 2,
...
phi := KX!((-8*x[3]^8 - 8*x[3]^4)/(x[3]^12 - 2*x[3]^10 - x[3]^8 + 4*x[3]^6 - x[3]^4 - 2*x[3]^2 + 1)*x[2]^2 + (x[3]^12 - 2*x[3]^10 - x[3]^8 - 12*x[3]^6 - x[3]^4 - 2*x[3]^2 + 1)/(x[3]^12 - 2*x[3]^10 - x[3]^8 + 4*x[3]^6 - x[3]^4 - 2*x[3]^2 + 1));
/* assign to object */
...
s`SolvableDBName := "32S2-4,4,4-g5-path5";
s`SolvableDBFilename := "32S2-4,4,4-g5-path5.m";
...
\[ 11, 29, 12, 7, 2, 5, 10, 21, 18, 26, 9, 22, 16, 13, 31, 23, 8, 1, 24, 3, 25, 20, 14, 30, 17, 4, 19, 32, 6, 27, 28, 15 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path5", "32S2-4,4,4-g5-path5" ];
s`SolvableDBParents := [ Strings() | "64S20-8,4,4-g13-path13", "64S21-4,8,4-g13-path17", "64S25-8,8,4-g17-path9", "64S21-4,4,8-g13-path17", "64S17-8,4,8-g17-path11", "64S24-4,8,8-g17-path5", "64S22-8,8,8-g21-path19", "64S21-8,4,4-g13-path17", "64S18-4,8,4-g13-path5", "64S24-8,8,4-g17-path5", "64S20-4,4,8-g13-path13", "64S24-8,4,8-g17-path5", "64S25-4,8,8-g17-path9", "64S19-8,8,8-g21-path5", "64S20-8,4,4-g13-path14", "64S20-4,8,4-g13-path13", "64S17-8,8,4-g17-path11", "64S20-4,4,8-g13-path14", "64S25-8,4,8-g17-path9", "64S17-4,8,8-g17-path11", "64S22-8,8,8-g21-path20", "64S18-8,4,4-g13-path5", "64S20-4,8,4-g13-path14", "64S25-8,8,4-g17-path10", "64S18-4,4,8-g13-path5", "64S25-8,4,8-g17-path10", "64S25-4,8,8-g17-path10", "64S22-8,8,8-g21-path21", "64S23-4,4,4-g9-path13", "64S23-4,4,4-g9-path14", "64S23-4,4,4-g9-path15" ];
