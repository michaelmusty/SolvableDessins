...
s`SolvableDBName := "32S16-16,16,4-g11-path5";
s`SolvableDBFilename := "32S16-16,16,4-g11-path5.m";
...
s`SolvableDBSanityCheckTiming := 0.640p15;
...
I<x1, x2, x3> := ideal< PX | [
x1^4*x3^2 - 1/2*x1^5 - x1*x2 + 4*x3^2,
x1^4*x2 + x2^2 + 4,
x2*x3^2 + 1/2*x1*x2 - 2*x3^2 + x1
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,2-g3-path3", "32S16-16,16,4-g11-path5" ];
