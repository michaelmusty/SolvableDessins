...
s`SolvableDBName := "32S12-8,4,8-g9-path32";
s`SolvableDBFilename := "32S12-8,4,8-g9-path32.m";
...
I<x1, x2, x3> := ideal< PX | [
x2*x3^4 + (16*nu + 16)*x1^2*x3^2 + 2*nu*x2,
x1^4 - 1/2*nu*x2*x3^2 + (-4*nu + 4)*x1^2 - 16*nu
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T8-4,4,4-g3-path21", "32S12-8,4,8-g9-path32" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path72", "64S15-8,8,8-g21-path72", "64S45-16,4,16-g21-path27", "64S44-16,8,16-g25-path27", "64S45-16,4,16-g21-path28", "64S44-16,8,16-g25-path28", "64S17-8,4,8-g17-path26" ];
