...
\[ 6, 1, 23, 13, 21, 24, 4, 22, 2, 3, 5, 7, 8, 20, 30, 26, 28, 14, 10, 32, 9, 17, 31, 11, 16, 19, 29, 12, 15, 18, 25, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path7", "32S12-8,4,8-g9-path32" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path54", "64S15-8,8,8-g21-path54", "64S45-16,4,16-g21-path9", "64S44-16,8,16-g25-path9", "64S45-16,4,16-g21-path10", "64S44-16,8,16-g25-path10", "64S17-8,4,8-g17-path8" ];
