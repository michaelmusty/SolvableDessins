...
{ IntegerRing() | 31, 32 }
@};
s`SolvableDBBelyiMapTiming := 1.150p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-4,8,8-g5-path5", "32S17-8,16,16-g13-path10" ];
s`SolvableDBParents := [ Strings() | "64S27-8,16,16-g25-path2", "64S29-8,16,16-g25-path20", "64S44-8,16,16-g25-path66" ];
