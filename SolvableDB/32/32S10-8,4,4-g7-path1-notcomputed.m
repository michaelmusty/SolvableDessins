...
s`SolvableDBName := "32S10-8,4,4-g7-path1-notcomputed";
s`SolvableDBFilename := "32S10-8,4,4-g7-path1-notcomputed.m";
...
\[ 6, 1, 4, 22, 18, 23, 20, 24, 2, 3, 5, 7, 8, 17, 19, 21, 26, 9, 29, 27, 14, 12, 11, 16, 32, 13, 10, 30, 31, 15, 25, 28 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,2,4-g1-path1-notcomputed", "8T2-4,2,4-g1-path2-notcomputed", "16T10-4,2,4-g1-path3-notcomputed", "32S10-8,4,4-g7-path1-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path5-notcomputed", "64S13-8,4,8-g17-path3-notcomputed", "64S7-8,4,8-g17-path6-notcomputed", "64S14-8,4,8-g17-path3-notcomputed", "64S9-8,4,4-g13-path3-notcomputed", "64S21-8,4,4-g13-path2-notcomputed", "64S9-8,4,4-g13-path4-notcomputed" ];
