...
s`SolvableDBName := "32S17-16,16,4-g11-path1";
s`SolvableDBFilename := "32S17-16,16,4-g11-path1.m";
...
s`SolvableDBBelyiMap := KX!(1/(4*x1^4)*x3^4 + (-x1^8 - 1)/(4*x1^6)*x3^2 + 3/4);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,1-g0-path1", "16T5-8,8,2-g3-path1", "32S17-16,16,4-g11-path1" ];
s`SolvableDBParents := [ Strings() | "64S29-16,16,4-g21-path10", "64S44-16,16,4-g21-path72", "64S27-16,16,4-g21-path8" ];
