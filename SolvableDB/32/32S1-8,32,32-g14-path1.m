...
{ IntegerRing() | 24, 32 }
@};
s`SolvableDBBelyiMapTiming := 6.360p15;
s`SolvableDBSanityCheckTiming := 43.490p15;
...
s`SolvableDBBelyiMap := KX!(x4^8*x2^2 - 2*nu^2*x4^4*x2);
...
s`SolvableDBChildren := [ Strings() | "16T1-4,16,16-g6-path1" ];
