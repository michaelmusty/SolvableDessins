...
s`SolvableDBName := "32S17-2,16,16-g7-path1-notcomputed";
s`SolvableDBFilename := "32S17-2,16,16-g7-path1-notcomputed.m";
...
\[ 9, 5, 11, 6, 2, 4, 13, 10, 1, 8, 3, 14, 7, 12, 17, 18, 15, 16, 20, 19, 23, 24, 21, 22, 26, 25, 28, 27, 30, 29, 32, 31 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T1-1,4,4-g0-path1-notcomputed", "8T1-1,8,8-g0-path1-notcomputed", "16T5-2,8,8-g3-path1-notcomputed", "32S17-2,16,16-g7-path1-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S44-4,16,16-g21-path10-notcomputed", "64S27-4,16,16-g21-path1-notcomputed", "64S29-2,16,16-g13-path4-notcomputed" ];
