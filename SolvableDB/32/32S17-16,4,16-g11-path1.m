...
I<[x]> := ideal< P | [
x[2]^3*x[3]^4 + 1/4*x[1]^3*x[2]^3 - 3*x[1]^2*x[2]^2*x[3]^2 - 1/4*x[2]^4*x[3]^2 + 1/2*x[1]^2*x[2]^3 + 8*x[1]^3*x[3]^2 + 4*x[1]*x[2]^2*x[3]^2 - 16*x[2]*x[3]^4 + 4*x[1]^3*x[2] + 3/4*x[1]*x[2]^3 + 24*x[1]^2*x[3]^2 - 15*x[2]^2*x[3]^2 + 12*x[1]^2*x[2] + x[2]^3 - 8*x[1]*x[3]^2 + 8*x[1]*x[2] + 8*x[3]^2 + 8*x[2],
x[1]^3*x[2]*x[3]^2 + 1/4*x[1]^3*x[2]^2 - x[1]^2*x[2]*x[3]^2 - 1/4*x[2]^3*x[3]^2 + 1/2*x[1]^2*x[2]^2 + 7*x[1]*x[2]*x[3]^2 - 4*x[1]^3 + 3/4*x[1]*x[2]^2 - 3*x[2]*x[3]^2 + x[2]^2 - 4*x[1],
x[1]*x[2]*x[3]^4 - x[1]^3*x[3]^2 - x[2]*x[3]^4 + 1/2*x[1]^3*x[2] + 5*x[1]^2*x[3]^2 - 1/2*x[2]^2*x[3]^2 + x[1]^2*x[2] - x[1]*x[3]^2 + 3/2*x[1]*x[2] + x[3]^2 + x[2],
x[1]^4 - x[1]*x[2]*x[3]^2 + x[1]^3 + x[2]*x[3]^2 + x[1]^2 + x[1]
] >;
...
s`SolvableDBName := "32S17-16,4,16-g11-path1";
s`SolvableDBFilename := "32S17-16,4,16-g11-path1.m";
...
s`SolvableDBLocalSanityCheckTiming := 2.520p15;
...
\[ 6, 1, 4, 17, 14, 15, 13, 3, 2, 5, 7, 8, 16, 23, 25, 27, 24, 11, 9, 10, 12, 18, 26, 31, 32, 29, 30, 20, 19, 21, 22, 28 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,2,8-g3-path4", "32S17-16,4,16-g11-path1" ];
s`SolvableDBParents := [ Strings() | "64S29-16,4,16-g21-path3", "64S44-16,4,16-g21-path13", "64S27-16,4,16-g21-path2" ];
