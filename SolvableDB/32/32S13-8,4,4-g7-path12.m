...
s`SolvableDBName := "32S13-8,4,4-g7-path12";
s`SolvableDBFilename := "32S13-8,4,4-g7-path12.m";
...
\[ 6, 1, 8, 24, 20, 25, 22, 26, 2, 3, 4, 5, 7, 29, 30, 14, 16, 21, 28, 9, 23, 19, 32, 13, 12, 17, 15, 11, 10, 31, 18, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T8-4,4,4-g3-path3", "32S13-8,4,4-g7-path12" ];
s`SolvableDBParents := [ Strings() | "64S46-16,8,4-g19-path23", "64S46-16,4,8-g19-path23", "64S15-8,8,8-g21-path229", "64S46-16,8,4-g19-path24", "64S46-16,4,8-g19-path24", "64S15-8,8,8-g21-path230", "64S21-8,4,4-g13-path46" ];
