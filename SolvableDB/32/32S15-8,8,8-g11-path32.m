...
\[ 6, 1, 8, 23, 20, 24, 21, 25, 2, 3, 4, 5, 7, 28, 22, 14, 16, 27, 26, 9, 19, 30, 13, 12, 17, 11, 31, 10, 15, 18, 32, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T8-4,4,4-g3-path4", "32S15-8,8,8-g11-path32" ];
s`SolvableDBParents := [ Strings() | "64S15-8,8,8-g21-path272", "64S16-8,8,8-g21-path272", "64S22-8,8,8-g21-path32" ];
