...
s`SolvableDBName := "32S15-8,8,8-g11-path32";
s`SolvableDBFilename := "32S15-8,8,8-g11-path32.m";
...
{ IntegerRing() | 30, 32 }
@};
s`SolvableDBBelyiMapTiming := 2.070p15;
s`SolvableDBSanityCheckTiming := 66.670p15;
s`SolvableDBLocalSanityCheckTiming := 5.410p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T8-4,4,4-g3-path23", "32S15-8,8,8-g11-path32" ];
s`SolvableDBParents := [ Strings() | "64S15-8,8,8-g21-path266", "64S16-8,8,8-g21-path266", "64S22-8,8,8-g21-path26" ];
