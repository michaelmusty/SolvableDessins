...
s`SolvableDBName := "32S16-16,2,16-g7-path9";
s`SolvableDBFilename := "32S16-16,2,16-g7-path9.m";
...
s`SolvableDBBelyiMap := KX!(-x1^16/4);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,2,8-g3-path7", "32S16-16,2,16-g7-path9" ];
s`SolvableDBParents := [ Strings() | "64S26-16,4,16-g21-path9", "64S44-16,4,16-g21-path55", "64S50-32,2,32-g15-path11", "64S50-32,4,32-g23-path11", "64S51-32,2,32-g15-path9", "64S51-32,4,32-g23-path9", "64S29-16,2,16-g13-path9" ];
