...
s`SolvableDBName := "32S17-16,16,8-g13-path13";
s`SolvableDBFilename := "32S17-16,16,8-g13-path13.m";
...
s`SolvableDBSanityCheckTiming := 1.410p15;
s`SolvableDBLocalSanityCheckTiming := 1.690p15;
...
s`SolvableDBBelyiMap := KX!(-x3^2/2*x4^4 - x3*x4^2 - x3^4/4);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T5-8,8,4-g5-path7", "32S17-16,16,8-g13-path13" ];
