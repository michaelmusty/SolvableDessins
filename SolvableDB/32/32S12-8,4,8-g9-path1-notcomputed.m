...
s`SolvableDBName := "32S12-8,4,8-g9-path1-notcomputed";
s`SolvableDBFilename := "32S12-8,4,8-g9-path1-notcomputed.m";
...
\[ 26, 23, 27, 31, 25, 32, 24, 16, 14, 15, 17, 13, 30, 29, 28, 21, 22, 4, 5, 6, 7, 3, 19, 18, 20, 9, 12, 1, 10, 11, 8, 2 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,2,4-g1-path1-notcomputed", "8T2-4,2,4-g1-path2-notcomputed", "16T5-8,2,8-g3-path5-notcomputed", "32S12-8,4,8-g9-path1-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S45-16,8,16-g25-path5-notcomputed", "64S45-16,8,16-g25-path6-notcomputed", "64S44-16,4,16-g21-path5-notcomputed", "64S16-8,8,8-g21-path10-notcomputed", "64S44-16,4,16-g21-path6-notcomputed", "64S15-8,8,8-g21-path10-notcomputed", "64S17-8,4,8-g17-path5-notcomputed" ];
