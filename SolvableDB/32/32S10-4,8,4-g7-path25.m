...
{ IntegerRing() | 27, 31 }
@};
s`SolvableDBBelyiMapTiming := 2.410p15;
...
s`SolvableDBParents := [ Strings() | "64S7-8,8,4-g17-path29", "64S13-8,8,4-g17-path15", "64S7-8,8,4-g17-path30", "64S14-8,8,4-g17-path15", "64S9-4,8,4-g13-path39", "64S21-4,8,4-g13-path20", "64S9-4,8,4-g13-path40" ];
