...
s`SolvableDBName := "32S10-4,8,4-g7-path25";
s`SolvableDBFilename := "32S10-4,8,4-g7-path25.m";
...
s`SolvableDBSanityCheckTiming := 2.350p15;
...
I<x1, x2, x3> := ideal< PX | [
x2^2*x3^4 - 252*x1*x3^4 - 2*x2^2*x3^2 - 108*x3^4 - 144*x1^3 - 1080*x1*x3^2 - 576*x1^2 + x2^2 - 288*x3^2 - 684*x1 + 396,
x1*x2^2*x3^2 - 2*x2^2*x3^2 - 36*x1^3 - x1*x2^2 - 108*x1*x3^2 - 72*x1^2 - 2*x2^2 - 36*x3^2 - 72*x1 + 36,
x1^4 - 1/36*x2^2*x3^2 + 2*x1^3 + 7*x1*x3^2 + 5*x1^2 + 1/36*x2^2 + 3*x3^2 + 5*x1 - 3,
x1^2*x3^2 - 2*x1*x3^2 - x1^2 - x3^2 - 2*x1 + 1
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T12-2,8,4-g2-path3", "32S10-4,8,4-g7-path25" ];
s`SolvableDBParents := [ Strings() | "64S7-8,8,4-g17-path27", "64S13-8,8,4-g17-path14", "64S7-8,8,4-g17-path28", "64S14-8,8,4-g17-path14", "64S9-4,8,4-g13-path35", "64S21-4,8,4-g13-path18", "64S9-4,8,4-g13-path36" ];
s`SolvableDBChildren := [ Strings() | "16T12-2,8,4-g2-path3" ];
