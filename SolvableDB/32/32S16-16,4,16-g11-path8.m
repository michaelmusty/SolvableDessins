...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,2,8-g3-path6", "32S16-16,4,16-g11-path8" ];
s`SolvableDBParents := [ Strings() | "64S50-32,8,32-g27-path19", "64S51-32,8,32-g27-path15", "64S50-32,8,32-g27-path20", "64S51-32,8,32-g27-path16", "64S44-16,4,16-g21-path63", "64S26-16,4,16-g21-path17", "64S29-16,4,16-g21-path8" ];
