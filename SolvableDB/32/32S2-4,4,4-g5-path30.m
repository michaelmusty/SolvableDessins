...
s`SolvableDBName := "32S2-4,4,4-g5-path30";
s`SolvableDBFilename := "32S2-4,4,4-g5-path30.m";
...
s`SolvableDBSanityCheckTiming := 1.250p15;
s`SolvableDBLocalSanityCheckTiming := 0.540p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S2-4,4,4-g5-path30" ];
