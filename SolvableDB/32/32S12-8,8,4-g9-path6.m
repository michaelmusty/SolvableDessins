...
s`SolvableDBSanityCheckTiming := 15.510p15;
...
s`SolvableDBBelyiMap := KX!((x2^4 + 8*x2^2 + 16)/(x2^4 - 8*x2^2 + 16));

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,2-g3-path6", "32S12-8,8,4-g9-path6" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path135", "64S15-8,8,8-g21-path135", "64S44-16,16,4-g21-path43", "64S45-16,16,8-g25-path43", "64S44-16,16,4-g21-path44", "64S45-16,16,8-g25-path44", "64S17-8,8,4-g17-path43" ];
