...
s`SolvableDBName := "32S12-8,4,8-g9-path36";
s`SolvableDBFilename := "32S12-8,4,8-g9-path36.m";
...
\[ 6, 1, 23, 13, 21, 24, 4, 22, 2, 3, 5, 7, 8, 20, 30, 26, 28, 14, 10, 32, 9, 17, 31, 11, 16, 19, 29, 12, 15, 18, 25, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path27", "32S12-8,4,8-g9-path36" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path71", "64S15-8,8,8-g21-path71", "64S45-16,4,16-g21-path23", "64S44-16,8,16-g25-path23", "64S45-16,4,16-g21-path24", "64S44-16,8,16-g25-path24", "64S17-8,4,8-g17-path25" ];
s`SolvableDBChild := "16T8-4,4,4-g3-path27";
