...
{ IntegerRing() | 28, 29 }
@};
s`SolvableDBBelyiMapTiming := 2.17000000000000p15;
s`SolvableDBSanityCheckTiming := 1.58000000000000p15;
...
s`SolvableDBParents := [ Strings() | "64S13-8,8,4-g17-path28", "64S7-8,8,4-g17-path55", "64S14-8,8,4-g17-path28", "64S7-8,8,4-g17-path56", "64S9-8,4,4-g13-path43", "64S21-8,4,4-g13-path22", "64S9-8,4,4-g13-path44" ];
