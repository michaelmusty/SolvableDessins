...
s`SolvableDBName := "32S11-4,2,8-g3-path2";
s`SolvableDBFilename := "32S11-4,2,8-g3-path2.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S11-4,2,8-g3-path2" ];
s`SolvableDBParents := [ Strings() | "64S6-8,2,8-g9-path4", "64S20-4,4,8-g13-path15", "64S7-8,4,8-g17-path72", "64S10-8,2,8-g9-path4", "64S9-4,4,8-g13-path83", "64S11-8,4,8-g17-path4", "64S8-4,2,8-g5-path4" ];
