...
s`SolvableDBName := "32S12-4,8,8-g9-path30";
s`SolvableDBFilename := "32S12-4,8,8-g9-path30.m";
...
s`SolvableDBSanityCheckTiming := 5.520p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T8-4,4,4-g3-path22", "32S12-4,8,8-g9-path30" ];
s`SolvableDBParents := [ Strings() | "64S44-8,16,16-g25-path25", "64S44-8,16,16-g25-path26", "64S45-4,16,16-g21-path25", "64S16-8,8,8-g21-path24", "64S45-4,16,16-g21-path26", "64S15-8,8,8-g21-path24", "64S17-4,8,8-g17-path24" ];
