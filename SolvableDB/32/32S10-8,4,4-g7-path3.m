...
s`SolvableDBLocalSanityCheckTiming := 3.660p15;
...
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path9", "64S13-8,4,8-g17-path5", "64S7-8,4,8-g17-path10", "64S14-8,4,8-g17-path5", "64S9-8,4,4-g13-path3", "64S21-8,4,4-g13-path2", "64S9-8,4,4-g13-path4" ];
