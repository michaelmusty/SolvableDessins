...
s`SolvableDBName := "32S10-8,4,4-g7-path3";
s`SolvableDBFilename := "32S10-8,4,4-g7-path3.m";
...
s`SolvableDBSanityCheckTiming := 1.360p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S10-8,4,4-g7-path3" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path51", "64S13-8,4,8-g17-path26", "64S7-8,4,8-g17-path52", "64S14-8,4,8-g17-path26", "64S9-8,4,4-g13-path45", "64S21-8,4,4-g13-path23", "64S9-8,4,4-g13-path46" ];
