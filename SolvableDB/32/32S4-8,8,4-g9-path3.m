...
s`SolvableDBName := "32S4-8,8,4-g9-path3";
s`SolvableDBFilename := "32S4-8,8,4-g9-path3.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T4-4,4,4-g3-path11", "32S4-8,8,4-g9-path3" ];
s`SolvableDBParents := [ Strings() | "64S3-8,8,8-g21-path224", "64S28-16,16,4-g21-path37", "64S28-16,16,8-g25-path37", "64S3-8,8,8-g21-path225", "64S28-16,16,4-g21-path38", "64S28-16,16,8-g25-path38", "64S17-8,8,4-g17-path175" ];
s`SolvableDBChildren := [ Strings() | "16T4-4,4,4-g3-path11" ];
