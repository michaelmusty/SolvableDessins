...
I<[x]> := ideal< P | [
x[1]^4*x[3]^2 - x[1]^5 - x[1]*x[2] - 4*x[3]^2 + 2*x[1],
x[1]^4*x[2] + x[2]^2 + 4,
x[2]*x[3]^2 + 2*x[3]^2 - 2*x[1]
] >;
...
s`SolvableDBParents := [ Strings() | "64S3-8,8,8-g21-path26", "64S28-16,16,4-g21-path5", "64S28-16,16,8-g25-path5", "64S3-8,8,8-g21-path27", "64S28-16,16,4-g21-path6", "64S28-16,16,8-g25-path6", "64S17-8,8,4-g17-path17" ];
