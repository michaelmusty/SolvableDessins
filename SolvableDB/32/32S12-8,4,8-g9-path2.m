...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,2,8-g2-path1", "16T5-8,2,8-g3-path2", "32S12-8,4,8-g9-path2" ];
s`SolvableDBParents := [ Strings() | "64S45-16,8,16-g25-path3", "64S45-16,8,16-g25-path4", "64S44-16,4,16-g21-path3", "64S16-8,8,8-g21-path58", "64S44-16,4,16-g21-path4", "64S15-8,8,8-g21-path58", "64S17-8,4,8-g17-path12" ];
s`SolvableDBChildren := [ Strings() | "16T5-8,2,8-g3-path2" ];
