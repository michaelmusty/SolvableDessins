...
s`SolvableDBName := "32S12-4,8,8-g9-path32";
s`SolvableDBFilename := "32S12-4,8,8-g9-path32.m";
...
{ IntegerRing() | 30, 32 }
@};
s`SolvableDBBelyiMapTiming := 1.010p15;
s`SolvableDBSanityCheckTiming := 5.420p15;
...
[ 17, 27, 22, 28, 10, 16, 6, 32, 14, 15, 20, 24, 1, 30, 13, 31, 26, 23, 2, 3, 9, 7, 12, 29, 5, 25, 18, 8, 19, 4, 11, 21 ],
[ 18, 30, 4, 27, 29, 26, 8, 23, 31, 11, 14, 32, 3, 19, 2, 21, 7, 28, 10, 15, 24, 1, 17, 25, 16, 12, 13, 22, 9, 20, 5, 6 ]
],
[ PermutationGroup<32 |  
\[ 12, 28, 8, 23, 2, 5, 21, 24, 20, 3, 4, 9, 7, 27, 18, 14, 16, 32, 13, 1, 19, 26, 25, 10, 11, 29, 17, 6, 30, 22, 15, 31 ],
\[ 3, 10, 15, 20, 16, 8, 1, 22, 24, 29, 5, 17, 2, 31, 11, 26, 18, 13, 9, 14, 6, 4, 28, 32, 12, 7, 30, 27, 25, 19, 21, 23 ],
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T8-4,4,4-g3-path23", "32S12-4,8,8-g9-path32" ];
s`SolvableDBParents := [ Strings() | "64S44-8,16,16-g25-path27", "64S44-8,16,16-g25-path28", "64S45-4,16,16-g21-path27", "64S16-8,8,8-g21-path26", "64S45-4,16,16-g21-path28", "64S15-8,8,8-g21-path26", "64S17-4,8,8-g17-path26" ];
