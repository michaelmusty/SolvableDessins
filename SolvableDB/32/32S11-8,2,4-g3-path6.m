...
s`SolvableDBName := "32S11-8,2,4-g3-path6";
s`SolvableDBFilename := "32S11-8,2,4-g3-path6.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 14, 32, 23, 20, 8, 31, 27, 10, 9, 26, 11, 12, 13, 24, 30, 28, 25, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S11-8,2,4-g3-path6" ];
