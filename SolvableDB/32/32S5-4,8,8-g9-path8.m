...
s`SolvableDBName := "32S5-4,8,8-g9-path8";
s`SolvableDBFilename := "32S5-4,8,8-g9-path8.m";
...
s`SolvableDBSanityCheckTiming := 2.460p15;
...
I<x1, x2, x3> := ideal< PX | [
x1^3*x3^2 + 1/2*(2*nu + 1)*x1*x2^2*x3^2 - 1/4*x1^2*x2^2 + nu*x1*x2*x3^2 + 1/4*(nu + 1)*x1^2*x2 + 1/2*x1*x3^2 + 1/4*(-nu - 2)*x1^2 + 1/4*(-nu + 1)*x2^2 + 1/4*(nu + 1)*x2,
x1^2*x2*x3^2 + (nu + 1)*x1^2*x3^2 + 1/2*(nu + 2)*x2^2*x3^2 - 1/2*x1^3 + 1/4*(2*nu + 1)*x1*x2^2 + (-nu + 1)*x2*x3^2 - 1/2*nu*x1*x2 - 1/2*nu*x3^2 + 1/4*x1,
x2^3 - 2*x1^2 + x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S5-4,8,8-g9-path8" ];
s`SolvableDBParents := [ Strings() | "64S29-8,16,16-g25-path75", "64S31-8,16,16-g25-path85", "64S31-8,16,16-g25-path86", "64S30-8,16,16-g25-path43", "64S31-8,16,16-g25-path87", "64S29-8,16,16-g25-path76", "64S30-8,16,16-g25-path44", "64S31-8,16,16-g25-path88", "64S7-4,8,8-g17-path201", "64S6-4,8,8-g17-path65", "64S5-4,8,8-g17-path45", "64S6-4,8,8-g17-path66", "64S17-4,8,8-g17-path226", "64S4-4,8,8-g17-path22", "64S7-4,8,8-g17-path202" ];
