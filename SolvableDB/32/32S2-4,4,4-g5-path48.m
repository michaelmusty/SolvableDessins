...
s`SolvableDBName := "32S2-4,4,4-g5-path48";
s`SolvableDBFilename := "32S2-4,4,4-g5-path48.m";
...
\[ 6, 1, 24, 25, 15, 9, 4, 16, 2, 3, 5, 7, 8, 23, 30, 17, 13, 14, 21, 29, 22, 26, 31, 28, 12, 19, 20, 10, 32, 11, 18, 27 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T4-4,4,4-g3-path9", "32S2-4,4,4-g5-path48" ];
