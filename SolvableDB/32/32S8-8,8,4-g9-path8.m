...
s`SolvableDBName := "32S8-8,8,4-g9-path8";
s`SolvableDBFilename := "32S8-8,8,4-g9-path8.m";
...
s`SolvableDBSanityCheckTiming := 3.110p15;
...
I<x1, x2, x3> := ideal< PX | [
x1^3*x3^2 + nu*x1^2*x2*x3^2 - 1/2*x1^2*x2^2 + x1*x2*x3^2 + nu*x2^2*x3^2 + nu*x1^3 + x1^2*x2 - nu*x1*x2^2 + 1/2*x1^2,
x1*x2^2*x3^2 + 2*nu*x1^2*x3^2 - x1^2*x2 + nu*x1*x2^2 + x1*x3^2 + 2*nu*x2*x3^2 + 2*x1^2 - 2*nu*x1*x2 + 1/2*x2^2 - nu*x1 - 1/2,
x2^3 - 2*x1^2 - x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S8-8,8,4-g9-path8" ];
s`SolvableDBParents := [ Strings() | "64S5-8,8,4-g17-path87", "64S11-8,8,4-g17-path63", "64S13-8,8,4-g17-path53", "64S13-8,8,4-g17-path54", "64S11-8,8,4-g17-path64", "64S5-8,8,4-g17-path88", "64S24-8,8,4-g17-path102" ];
