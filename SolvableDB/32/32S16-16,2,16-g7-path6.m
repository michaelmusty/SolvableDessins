...
s`SolvableDBName := "32S16-16,2,16-g7-path6";
s`SolvableDBFilename := "32S16-16,2,16-g7-path6.m";
...
\[ 26, 29, 28, 20, 17, 18, 31, 23, 25, 21, 19, 9, 10, 16, 8, 27, 12, 32, 14, 30, 11, 2, 5, 7, 6, 22, 4, 24, 15, 3, 13, 1 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,2,8-g3-path6", "32S16-16,2,16-g7-path6" ];
