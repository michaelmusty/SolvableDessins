...
s`SolvableDBName := "32S12-8,8,4-g9-path16";
s`SolvableDBFilename := "32S12-8,8,4-g9-path16.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T6-8,8,2-g3-path2", "32S12-8,8,4-g9-path16" ];
s`SolvableDBParents := [ Strings() | "64S44-16,16,8-g25-path13", "64S44-16,16,8-g25-path14", "64S45-16,16,4-g21-path13", "64S16-8,8,8-g21-path100", "64S45-16,16,4-g21-path14", "64S15-8,8,8-g21-path100", "64S17-8,8,4-g17-path8" ];
s`SolvableDBChildren := [ Strings() | "16T6-8,8,2-g3-path2" ];
