...
s`SolvableDBName := "32S2-4,4,4-g5-path25";
s`SolvableDBFilename := "32S2-4,4,4-g5-path25.m";
...
{ IntegerRing() | 30, 31 }
@};
s`SolvableDBBelyiMapTiming := 1.320p15;
s`SolvableDBSanityCheckTiming := 438.650p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S2-4,4,4-g5-path25" ];
