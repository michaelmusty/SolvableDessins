...
s`SolvableDBName := "32S16-16,16,8-g13-path10";
s`SolvableDBFilename := "32S16-16,16,8-g13-path10.m";
...
{ IntegerRing() | 28, 31 }
@};
s`SolvableDBBelyiMapTiming := 1.140p15;
...
\[ 27, 17, 28, 14, 16, 9, 23, 19, 20, 26, 29, 4, 30, 31, 12, 24, 21, 3, 11, 5, 13, 8, 32, 2, 10, 6, 25, 7, 18, 1, 22, 15 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,4-g5-path6", "32S16-16,16,8-g13-path10" ];
