...
s`SolvableDBName := "32S12-8,8,4-g9-path31";
s`SolvableDBFilename := "32S12-8,8,4-g9-path31.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T8-4,4,4-g3-path14", "32S12-8,8,4-g9-path31" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path117", "64S15-8,8,8-g21-path117", "64S44-16,16,4-g21-path23", "64S45-16,16,8-g25-path23", "64S44-16,16,4-g21-path24", "64S45-16,16,8-g25-path24", "64S17-8,8,4-g17-path25" ];
