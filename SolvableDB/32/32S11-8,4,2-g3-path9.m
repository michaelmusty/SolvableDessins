...
s`SolvableDBName := "32S11-8,4,2-g3-path9";
s`SolvableDBFilename := "32S11-8,4,2-g3-path9.m";
...
s`SolvableDBSanityCheckTiming := 0.160p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path7", "32S11-8,4,2-g3-path9" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,2-g9-path22", "64S20-8,4,4-g13-path22", "64S7-8,8,4-g17-path101", "64S10-8,8,2-g9-path22", "64S9-8,4,4-g13-path90", "64S11-8,8,4-g17-path33", "64S8-8,4,2-g5-path11" ];
