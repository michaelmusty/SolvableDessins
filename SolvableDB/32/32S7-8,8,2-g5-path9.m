...
I<[x]> := ideal< P | [
x[1] - x[2]*x[3]^2,
x[2]^4*x[3]^4 - x[2]^2*x[3]^4 + nu^2*x[2]^2 + nu^2
] >;
...
{ IntegerRing() | 27, 31 }
@};
s`SolvableDBBelyiMapTiming := 0.660000000000000p15;
s`SolvableDBSanityCheckTiming := 0.510000000000000p15;
...
\[ 6, 1, 20, 21, 18, 22, 4, 2, 3, 5, 7, 32, 23, 30, 28, 25, 31, 8, 16, 15, 29, 10, 17, 9, 11, 12, 13, 14, 19, 24, 26, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S7-8,8,2-g5-path9" ];
