...
s`SolvableDBName := "32S12-8,8,4-g9-path17";
s`SolvableDBFilename := "32S12-8,8,4-g9-path17.m";
...
\[ 4, 11, 14, 5, 8, 21, 2, 1, 27, 29, 12, 7, 9, 15, 17, 32, 3, 26, 23, 18, 19, 16, 6, 30, 20, 25, 28, 13, 24, 10, 22, 31 ]:
 Order := 32 > |
[ 26, 22, 24, 7, 20, 29, 27, 11, 6, 25, 13, 32, 15, 1, 10, 23, 5, 16, 30, 28, 8, 14, 4, 18, 31, 9, 3, 19, 2, 12, 21, 17 ],
[ 7, 13, 1, 20, 11, 8, 22, 26, 3, 2, 32, 27, 6, 10, 5, 17, 24, 9, 4, 16, 30, 23, 29, 12, 28, 31, 19, 15, 18, 25, 14, 21 ],
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T6-8,8,2-g3-path3", "32S12-8,8,4-g9-path17" ];
s`SolvableDBParents := [ Strings() | "64S44-16,16,8-g25-path15", "64S44-16,16,8-g25-path16", "64S45-16,16,4-g21-path15", "64S16-8,8,8-g21-path101", "64S45-16,16,4-g21-path16", "64S15-8,8,8-g21-path101", "64S17-8,8,4-g17-path9" ];
