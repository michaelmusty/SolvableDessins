...
s`SolvableDBName := "32S3-8,4,8-g9-path16";
s`SolvableDBFilename := "32S3-8,4,8-g9-path16.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,1,8-g0-path1", "16T5-8,2,8-g3-path1", "32S3-8,4,8-g9-path16" ];
s`SolvableDBParents := [ Strings() | "64S2-8,8,8-g21-path37", "64S3-8,8,8-g21-path37", "64S26-16,4,16-g21-path26", "64S26-16,8,16-g25-path26", "64S27-16,4,16-g21-path22", "64S27-16,8,16-g25-path22", "64S17-8,4,8-g17-path135" ];
