...
s`SolvableDBName := "32S5-8,8,2-g5-path2-notcomputed";
s`SolvableDBFilename := "32S5-8,8,2-g5-path2-notcomputed.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 30, 12, 24, 20, 9, 26, 27, 8, 17, 31, 15, 10, 16, 18, 11, 13, 14, 25, 32, 28, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T2-4,4,2-g1-path1-notcomputed", "16T10-4,4,2-g1-path3-notcomputed", "32S5-8,8,2-g5-path2-notcomputed" ];
