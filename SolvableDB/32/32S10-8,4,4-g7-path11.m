...
s`SolvableDBName := "32S10-8,4,4-g7-path11";
s`SolvableDBFilename := "32S10-8,4,4-g7-path11.m";
...
s`SolvableDBSanityCheckTiming := 2.530p15;
...
I<x1, x2, x3> := ideal< PX | [
x1*x2^2*x3^2 - 2*nu*x1*x2*x3^2 - x1^2*x2 + x1*x3^2 - 2*nu*x1^2 - 1/2*x2^2 - 1/2,
x1^2*x3^2 - nu*x2^2*x3^2 - 1/2*x1*x2^2 - nu*x1*x2 - 1/2*x1,
x2^3 - 2*x1^2 + x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S10-8,4,4-g7-path11" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path39", "64S13-8,4,8-g17-path20", "64S7-8,4,8-g17-path40", "64S14-8,4,8-g17-path20", "64S9-8,4,4-g13-path5", "64S21-8,4,4-g13-path3", "64S9-8,4,4-g13-path6" ];
