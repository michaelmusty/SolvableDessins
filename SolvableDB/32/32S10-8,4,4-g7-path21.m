...
s`SolvableDBName := "32S10-8,4,4-g7-path21";
s`SolvableDBFilename := "32S10-8,4,4-g7-path21.m";
...
{ IntegerRing() | 30, 31 }
@};
s`SolvableDBBelyiMapTiming := 1.520p15;
s`SolvableDBSanityCheckTiming := 33.230p15;
...
s`SolvableDBBelyiMap := KX!((-1/4*x3^4 - 1/4)/x3^2*x4^2 - 1/2/x3^3*x4 + (1/4*x3^4 - 1/4)/x3^4);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S10-8,4,4-g7-path21" ];
s`SolvableDBParents := [ Strings() | "64S13-8,8,4-g17-path27", "64S7-8,8,4-g17-path53", "64S14-8,8,4-g17-path27", "64S7-8,8,4-g17-path54", "64S9-8,4,4-g13-path27", "64S21-8,4,4-g13-path14", "64S9-8,4,4-g13-path28" ];
