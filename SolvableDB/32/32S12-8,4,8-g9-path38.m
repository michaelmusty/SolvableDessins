...
s`SolvableDBName := "32S12-8,4,8-g9-path38";
s`SolvableDBFilename := "32S12-8,4,8-g9-path38.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path33", "32S12-8,4,8-g9-path38" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path78", "64S15-8,8,8-g21-path78", "64S45-16,4,16-g21-path33", "64S44-16,8,16-g25-path33", "64S45-16,4,16-g21-path34", "64S44-16,8,16-g25-path34", "64S17-8,4,8-g17-path32" ];
s`SolvableDBChildren := [ Strings() | "16T8-4,4,4-g3-path33" ];
