...
s`SolvableDBName := "32S11-2,8,4-g3-path10";
s`SolvableDBFilename := "32S11-2,8,4-g3-path10.m";
...
{ IntegerRing() | 25, 30 }
@};
s`SolvableDBBelyiMapTiming := 0.360p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path8", "32S11-2,8,4-g3-path10" ];
s`SolvableDBParents := [ Strings() | "64S20-4,8,4-g13-path2", "64S6-2,8,8-g9-path13", "64S7-4,8,8-g17-path81", "64S9-4,8,4-g13-path70", "64S10-2,8,8-g9-path13", "64S11-4,8,8-g17-path13", "64S8-2,8,4-g5-path2" ];
