...
s`SolvableDBName := "32S3-8,8,4-g9-path28";
s`SolvableDBFilename := "32S3-8,8,4-g9-path28.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path6", "32S3-8,8,4-g9-path28" ];
s`SolvableDBParents := [ Strings() | "64S2-8,8,8-g21-path79", "64S3-8,8,8-g21-path79", "64S26-16,16,4-g21-path39", "64S26-16,16,8-g25-path39", "64S27-16,16,4-g21-path35", "64S27-16,16,8-g25-path35", "64S17-8,8,4-g17-path148" ];
