...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path26", "32S15-8,8,8-g11-path37" ];
s`SolvableDBParents := [ Strings() | "64S22-8,8,8-g21-path31", "64S16-8,8,8-g21-path271", "64S15-8,8,8-g21-path271" ];
