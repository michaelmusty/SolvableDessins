...
s`SolvableDBName := "32S15-8,8,8-g11-path37";
s`SolvableDBFilename := "32S15-8,8,8-g11-path37.m";
...
\[ 6, 1, 8, 16, 20, 23, 4, 24, 2, 3, 5, 7, 26, 22, 13, 31, 19, 28, 30, 9, 18, 27, 11, 29, 17, 32, 10, 12, 14, 15, 21, 25 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T8-4,4,4-g3-path1", "32S15-8,8,8-g11-path37" ];
s`SolvableDBParents := [ Strings() | "64S22-8,8,8-g21-path18", "64S16-8,8,8-g21-path258", "64S15-8,8,8-g21-path258" ];
