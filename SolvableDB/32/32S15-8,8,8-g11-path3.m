...
s`SolvableDBName := "32S15-8,8,8-g11-path3";
s`SolvableDBFilename := "32S15-8,8,8-g11-path3.m";
...
s`SolvableDBSanityCheckTiming := 1.120p15;
s`SolvableDBLocalSanityCheckTiming := 1.780p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T8-4,4,4-g3-path10", "32S15-8,8,8-g11-path3" ];
s`SolvableDBParents := [ Strings() | "64S22-8,8,8-g21-path23", "64S16-8,8,8-g21-path263", "64S15-8,8,8-g21-path263" ];
