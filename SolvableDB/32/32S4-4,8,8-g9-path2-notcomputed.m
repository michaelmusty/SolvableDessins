...
s`SolvableDBName := "32S4-4,8,8-g9-path2-notcomputed";
s`SolvableDBFilename := "32S4-4,8,8-g9-path2-notcomputed.m";
...
\[ 6, 1, 24, 25, 15, 9, 4, 16, 2, 3, 5, 7, 8, 27, 32, 17, 13, 14, 21, 18, 22, 26, 31, 29, 12, 19, 20, 23, 10, 28, 30, 11 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-4,4,2-g1-path4-notcomputed", "16T4-4,4,4-g3-path7-notcomputed", "32S4-4,8,8-g9-path2-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S3-8,8,8-g21-path10-notcomputed", "64S28-4,16,16-g21-path1-notcomputed", "64S28-8,16,16-g25-path1-notcomputed", "64S3-8,8,8-g21-path11-notcomputed", "64S28-4,16,16-g21-path2-notcomputed", "64S28-8,16,16-g25-path2-notcomputed", "64S17-4,8,8-g17-path15-notcomputed" ];
s`SolvableDBChild := "16T4-4,4,4-g3-path7-notcomputed";
