...
s`SolvableDBName := "32S8-4,8,8-g9-path11";
s`SolvableDBFilename := "32S8-4,8,8-g9-path11.m";
...
I<x1, x2, x3> := ideal< PX | [
x1^3*x3^2 + 1/2*(-2*nu - 1)*x1*x2^2*x3^2 - 1/2*x1^2*x2^2 + nu*x1*x2*x3^2 + 1/2*(-2*nu - 1)*x1^2*x2 - 1/2*x1*x3^2 + 1/2*(-2*nu - 1)*x1^2 - 1/4*x2^2 - 1/4,
x1^2*x2*x3^2 + (-2*nu - 1)*x1^2*x3^2 + nu*x2^2*x3^2 - x1^3 + 1/2*(-2*nu - 1)*x1*x2^2 + nu*x2*x3^2 - nu*x1*x2 - 1/2*x1,
x2^3 - 2*x1^2 + x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path9", "32S8-4,8,8-g9-path11" ];
s`SolvableDBParents := [ Strings() | "64S11-4,8,8-g17-path49", "64S5-4,8,8-g17-path73", "64S13-4,8,8-g17-path39", "64S13-4,8,8-g17-path40", "64S5-4,8,8-g17-path74", "64S11-4,8,8-g17-path50", "64S24-4,8,8-g17-path95" ];
