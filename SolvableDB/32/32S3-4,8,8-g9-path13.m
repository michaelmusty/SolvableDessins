...
s`SolvableDBName := "32S3-4,8,8-g9-path13";
s`SolvableDBFilename := "32S3-4,8,8-g9-path13.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T4-4,4,4-g3-path7", "32S3-4,8,8-g9-path13" ];
s`SolvableDBParents := [ Strings() | "64S2-8,8,8-g21-path5", "64S3-8,8,8-g21-path5", "64S26-4,16,16-g21-path23", "64S26-8,16,16-g25-path23", "64S27-4,16,16-g21-path19", "64S27-8,16,16-g25-path19", "64S17-4,8,8-g17-path132" ];
