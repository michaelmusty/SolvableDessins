...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T8-4,4,4-g3-path13", "32S12-8,8,4-g9-path29" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path114", "64S15-8,8,8-g21-path114", "64S44-16,16,4-g21-path19", "64S45-16,16,8-g25-path19", "64S44-16,16,4-g21-path20", "64S45-16,16,8-g25-path20", "64S17-8,8,4-g17-path22" ];
