...
s`SolvableDBName := "32S12-8,8,4-g9-path29";
s`SolvableDBFilename := "32S12-8,8,4-g9-path29.m";
...
s`SolvableDBSanityCheckTiming := 14.300p15;
...
\[ 10, 13, 18, 21, 2, 5, 23, 26, 6, 9, 3, 16, 20, 32, 4, 27, 31, 7, 22, 1, 11, 12, 15, 19, 30, 24, 8, 14, 17, 29, 28, 25 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T8-4,4,4-g3-path14", "32S12-8,8,4-g9-path29" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path136", "64S15-8,8,8-g21-path136", "64S44-16,16,4-g21-path43", "64S45-16,16,8-g25-path43", "64S44-16,16,4-g21-path44", "64S45-16,16,8-g25-path44", "64S17-8,8,4-g17-path44" ];
