...
{ IntegerRing() | 31, 32 }
@};
s`SolvableDBBelyiMapTiming := 2.220p15;
s`SolvableDBSanityCheckTiming := 31084.440p15;
s`SolvableDBLocalSanityCheckTiming := 3.650p15;
...
x1^2*x4^2 - x1*x2*x3 - x2*x4^2,
x2^2*x4^2 - 2*x1*x3 - x4^2,
x2^3 - 2*x1^2 + x2,
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,4-g5-path3", "32S17-16,16,8-g13-path6" ];
s`SolvableDBParents := [ Strings() | "64S27-16,16,8-g25-path11", "64S29-16,16,8-g25-path29", "64S44-16,16,8-g25-path75" ];
