...
s`SolvableDBName := "32S10-4,4,8-g7-path28";
s`SolvableDBFilename := "32S10-4,4,8-g7-path28.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T12-4,2,8-g2-path3", "32S10-4,4,8-g7-path28" ];
s`SolvableDBParents := [ Strings() | "64S13-4,8,8-g17-path7", "64S7-4,8,8-g17-path13", "64S14-4,8,8-g17-path7", "64S7-4,8,8-g17-path14", "64S9-4,4,8-g13-path41", "64S21-4,4,8-g13-path21", "64S9-4,4,8-g13-path42" ];
