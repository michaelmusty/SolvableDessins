...
s`SolvableDBName := "32S5-2,8,8-g5-path7";
s`SolvableDBFilename := "32S5-2,8,8-g5-path7.m";
...
s`SolvableDBParents := [ Strings() | "64S17-4,8,8-g17-path20", "64S7-4,8,8-g17-path21", "64S7-4,8,8-g17-path22", "64S5-4,8,8-g17-path3", "64S29-2,16,16-g13-path7", "64S29-4,16,16-g21-path6", "64S31-2,16,16-g13-path5", "64S31-4,16,16-g21-path5", "64S31-2,16,16-g13-path6", "64S31-4,16,16-g21-path6", "64S30-2,16,16-g13-path3", "64S30-4,16,16-g21-path3", "64S6-2,8,8-g9-path7", "64S6-2,8,8-g9-path8", "64S4-2,8,8-g9-path3" ];
