...
s`SolvableDBSanityCheckTiming := 5.740p15;
s`SolvableDBLocalSanityCheckTiming := 0.460p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T8-4,4,4-g3-path3", "32S12-4,8,8-g9-path40" ];
s`SolvableDBParents := [ Strings() | "64S44-8,16,16-g25-path35", "64S44-8,16,16-g25-path36", "64S45-4,16,16-g21-path35", "64S16-8,8,8-g21-path35", "64S45-4,16,16-g21-path36", "64S15-8,8,8-g21-path35", "64S17-4,8,8-g17-path35" ];
