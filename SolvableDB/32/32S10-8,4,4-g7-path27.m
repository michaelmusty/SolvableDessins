...
s`SolvableDBSanityCheckTiming := 0.790p15;
...
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path45", "64S13-8,4,8-g17-path23", "64S7-8,4,8-g17-path46", "64S14-8,4,8-g17-path23", "64S9-8,4,4-g13-path39", "64S21-8,4,4-g13-path20", "64S9-8,4,4-g13-path40" ];
