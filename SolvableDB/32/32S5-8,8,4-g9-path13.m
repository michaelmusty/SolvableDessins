...
s`SolvableDBName := "32S5-8,8,4-g9-path13";
s`SolvableDBFilename := "32S5-8,8,4-g9-path13.m";
...
\[ 26, 25, 20, 13, 22, 19, 30, 7, 6, 18, 27, 24, 12, 15, 31, 4, 5, 32, 2, 28, 10, 14, 21, 8, 29, 9, 17, 23, 1, 16, 11, 3 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,4-g5-path7", "32S5-8,8,4-g9-path13" ];
