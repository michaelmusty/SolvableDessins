...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 31, 27, 29, 13, 16, 26, 28, 17, 9, 18, 14, 10, 20, 11, 12, 22, 23, 25, 32, 30 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T4-4,4,4-g3-path3", "32S3-8,8,4-g9-path2" ];
s`SolvableDBParents := [ Strings() | "64S2-8,8,8-g21-path66", "64S3-8,8,8-g21-path66", "64S26-16,16,4-g21-path26", "64S26-16,16,8-g25-path26", "64S27-16,16,4-g21-path22", "64S27-16,16,8-g25-path22", "64S17-8,8,4-g17-path135" ];
