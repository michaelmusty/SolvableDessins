...
s`SolvableDBSanityCheckTiming := 1.020p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path7", "32S11-4,4,8-g7-path9" ];
s`SolvableDBParents := [ Strings() | "64S6-4,8,8-g17-path11", "64S11-4,8,8-g17-path33", "64S10-4,8,8-g17-path11", "64S7-4,8,8-g17-path101", "64S9-4,4,8-g13-path112", "64S8-4,4,8-g13-path22", "64S20-4,4,8-g13-path44" ];
