...
\[ 6, 1, 12, 15, 17, 23, 4, 24, 2, 3, 5, 7, 8, 31, 30, 18, 9, 22, 26, 28, 10, 20, 11, 16, 19, 32, 29, 13, 14, 21, 25, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path18", "32S12-8,8,4-g9-path46" ];
s`SolvableDBParents := [ Strings() | "64S44-16,16,8-g25-path7", "64S44-16,16,8-g25-path8", "64S45-16,16,4-g21-path7", "64S16-8,8,8-g21-path101", "64S45-16,16,4-g21-path8", "64S15-8,8,8-g21-path101", "64S17-8,8,4-g17-path9" ];
