...
s`SolvableDBName := "32S5-2,8,8-g5-path18";
s`SolvableDBFilename := "32S5-2,8,8-g5-path18.m";
...
\[ 9, 5, 11, 6, 2, 4, 13, 10, 1, 8, 3, 14, 7, 12, 17, 18, 15, 16, 20, 19, 23, 24, 21, 22, 26, 25, 28, 27, 30, 29, 32, 31 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-2,8,8-g3-path6", "32S5-2,8,8-g5-path18" ];
s`SolvableDBParents := [ Strings() | "64S17-4,8,8-g17-path185", "64S7-4,8,8-g17-path119", "64S7-4,8,8-g17-path120", "64S5-4,8,8-g17-path4", "64S29-2,16,16-g13-path20", "64S29-4,16,16-g21-path20", "64S31-2,16,16-g13-path7", "64S31-4,16,16-g21-path7", "64S31-2,16,16-g13-path8", "64S31-4,16,16-g21-path8", "64S30-2,16,16-g13-path4", "64S30-4,16,16-g21-path4", "64S6-2,8,8-g9-path29", "64S6-2,8,8-g9-path30", "64S4-2,8,8-g9-path4" ];
