...
s`SolvableDBName := "32S19-2,16,4-g4-path1-notcomputed";
s`SolvableDBFilename := "32S19-2,16,4-g4-path1-notcomputed.m";
...
\[ 10, 5, 15, 6, 2, 4, 9, 13, 7, 1, 23, 18, 8, 16, 3, 14, 21, 12, 31, 24, 17, 26, 11, 20, 29, 22, 28, 27, 25, 32, 19, 30 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T4-2,4,2-g0-path2-notcomputed", "16T13-2,8,2-g0-path1-notcomputed", "32S19-2,16,4-g4-path1-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S48-4,16,4-g15-path4-notcomputed", "64S39-4,16,4-g15-path1-notcomputed", "64S38-2,16,4-g7-path2-notcomputed" ];
