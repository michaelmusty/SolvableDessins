...
s`SolvableDBName := "32S3-8,8,4-g9-path20";
s`SolvableDBFilename := "32S3-8,8,4-g9-path20.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,2-g3-path5", "32S3-8,8,4-g9-path20" ];
s`SolvableDBParents := [ Strings() | "64S2-8,8,8-g21-path71", "64S3-8,8,8-g21-path71", "64S26-16,16,4-g21-path31", "64S26-16,16,8-g25-path31", "64S27-16,16,4-g21-path27", "64S27-16,16,8-g25-path27", "64S17-8,8,4-g17-path140" ];
