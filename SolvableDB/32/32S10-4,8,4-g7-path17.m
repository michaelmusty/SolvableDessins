...
s`SolvableDBName := "32S10-4,8,4-g7-path17";
s`SolvableDBFilename := "32S10-4,8,4-g7-path17.m";
...
\[ 20, 5, 25, 24, 6, 30, 4, 23, 12, 16, 8, 1, 11, 29, 14, 22, 7, 27, 26, 9, 31, 28, 13, 17, 19, 3, 21, 10, 32, 2, 18, 15 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path7", "32S10-4,8,4-g7-path17" ];
s`SolvableDBParents := [ Strings() | "64S7-8,8,4-g17-path13", "64S13-8,8,4-g17-path7", "64S7-8,8,4-g17-path14", "64S14-8,8,4-g17-path7", "64S9-4,8,4-g13-path17", "64S21-4,8,4-g13-path9", "64S9-4,8,4-g13-path18" ];
