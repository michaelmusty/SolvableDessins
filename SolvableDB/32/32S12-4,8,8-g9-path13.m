...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-4,8,8-g5-path6", "32S12-4,8,8-g9-path13" ];
s`SolvableDBParents := [ Strings() | "64S44-8,16,16-g25-path7", "64S44-8,16,16-g25-path8", "64S45-4,16,16-g21-path7", "64S16-8,8,8-g21-path5", "64S45-4,16,16-g21-path8", "64S15-8,8,8-g21-path5", "64S17-4,8,8-g17-path5" ];
