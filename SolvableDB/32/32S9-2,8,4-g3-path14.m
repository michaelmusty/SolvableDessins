...
s`SolvableDBName := "32S9-2,8,4-g3-path14";
s`SolvableDBFilename := "32S9-2,8,4-g3-path14.m";
...
\[ 10, 5, 24, 6, 2, 4, 23, 16, 11, 1, 9, 13, 12, 31, 32, 8, 22, 20, 21, 18, 19, 17, 7, 3, 30, 28, 29, 26, 27, 25, 14, 15 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T12-2,8,4-g2-path3", "32S9-2,8,4-g3-path14" ];
...
s`SolvableDBChild := "16T12-2,8,4-g2-path3";
