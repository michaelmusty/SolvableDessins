...
\[ 6, 1, 23, 3, 20, 13, 4, 19, 2, 5, 7, 8, 31, 27, 24, 21, 14, 15, 16, 30, 18, 28, 29, 12, 17, 9, 10, 11, 22, 25, 32, 26 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T6-8,8,4-g5-path1", "32S12-8,8,4-g9-path20" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path116", "64S15-8,8,8-g21-path116", "64S44-16,16,4-g21-path23", "64S45-16,16,8-g25-path23", "64S44-16,16,4-g21-path24", "64S45-16,16,8-g25-path24", "64S17-8,8,4-g17-path24" ];
