...
I<x1, x2, x3> := ideal< PX | [
x1*x2*x3^4 + 2*x1^3 - 2*x3^2,
x2^2*x3^4 - 2*x1^3*x3^2 - x2*x3^4 + 2*x1^2*x2 + 2*x1^2,
x1^4 + x1*x2*x3^2 - x2 - 1
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T4-4,4,4-g3-path15", "32S3-4,8,8-g9-path7" ];
...
s`SolvableDBChildren := [ Strings() | "16T4-4,4,4-g3-path15" ];
