...
s`SolvableDBName := "32S12-8,8,4-g9-path41";
s`SolvableDBFilename := "32S12-8,8,4-g9-path41.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path25", "32S12-8,8,4-g9-path41" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path128", "64S15-8,8,8-g21-path128", "64S44-16,16,4-g21-path35", "64S45-16,16,8-g25-path35", "64S44-16,16,4-g21-path36", "64S45-16,16,8-g25-path36", "64S17-8,8,4-g17-path36" ];
