...
s`SolvableDBName := "32S16-16,2,16-g7-path5";
s`SolvableDBFilename := "32S16-16,2,16-g7-path5.m";
...
s`SolvableDBBelyiMap := KX!(x1^16/16);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,2,8-g3-path3", "32S16-16,2,16-g7-path5" ];
s`SolvableDBParents := [ Strings() | "64S26-16,4,16-g21-path5", "64S44-16,4,16-g21-path51", "64S50-32,2,32-g15-path7", "64S50-32,4,32-g23-path7", "64S51-32,2,32-g15-path5", "64S51-32,4,32-g23-path5", "64S29-16,2,16-g13-path5" ];
