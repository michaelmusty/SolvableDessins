...
s`SolvableDBName := "32S11-8,4,4-g7-path21";
s`SolvableDBFilename := "32S11-8,4,4-g7-path21.m";
...
{ IntegerRing() | 29, 30 }
@};
s`SolvableDBBelyiMapTiming := 3.070p15;
s`SolvableDBSanityCheckTiming := 37.220p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S11-8,4,4-g7-path21" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,4-g17-path21", "64S11-8,8,4-g17-path43", "64S10-8,8,4-g17-path21", "64S7-8,8,4-g17-path111", "64S9-8,4,4-g13-path104", "64S8-8,4,4-g13-path14", "64S20-8,4,4-g13-path36" ];
