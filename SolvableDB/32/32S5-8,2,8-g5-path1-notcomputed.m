...
s`SolvableDBName := "32S5-8,2,8-g5-path1-notcomputed";
s`SolvableDBFilename := "32S5-8,2,8-g5-path1-notcomputed.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 14, 31, 23, 20, 8, 30, 28, 10, 9, 27, 24, 11, 12, 13, 25, 26, 32, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,2,4-g1-path1-notcomputed", "8T2-4,2,4-g1-path2-notcomputed", "16T10-4,2,4-g1-path3-notcomputed", "32S5-8,2,8-g5-path1-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S17-8,4,8-g17-path18-notcomputed", "64S7-8,4,8-g17-path15-notcomputed", "64S7-8,4,8-g17-path16-notcomputed", "64S5-8,4,8-g17-path2-notcomputed", "64S29-16,2,16-g13-path6-notcomputed", "64S29-16,4,16-g21-path5-notcomputed", "64S31-16,2,16-g13-path3-notcomputed", "64S31-16,4,16-g21-path3-notcomputed", "64S31-16,2,16-g13-path4-notcomputed", "64S31-16,4,16-g21-path4-notcomputed", "64S30-16,2,16-g13-path2-notcomputed", "64S30-16,4,16-g21-path2-notcomputed", "64S6-8,2,8-g9-path5-notcomputed", "64S6-8,2,8-g9-path6-notcomputed", "64S4-8,2,8-g9-path2-notcomputed" ];
