...
s`SolvableDBName := "32S12-8,4,8-g9-path17";
s`SolvableDBFilename := "32S12-8,4,8-g9-path17.m";
...
s`SolvableDBSanityCheckTiming := 3.970p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T6-8,2,8-g3-path3", "32S12-8,4,8-g9-path17" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path55", "64S15-8,8,8-g21-path55", "64S45-16,4,16-g21-path15", "64S44-16,8,16-g25-path15", "64S45-16,4,16-g21-path16", "64S44-16,8,16-g25-path16", "64S17-8,4,8-g17-path9" ];
