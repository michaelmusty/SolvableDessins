...
s`SolvableDBName := "32S11-4,8,4-g7-path8";
s`SolvableDBFilename := "32S11-4,8,4-g7-path8.m";
...
s`SolvableDBSanityCheckTiming := 1.340p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S11-4,8,4-g7-path8" ];
s`SolvableDBParents := [ Strings() | "64S6-4,8,8-g17-path21", "64S7-4,8,8-g17-path111", "64S10-4,8,8-g17-path21", "64S11-4,8,8-g17-path43", "64S20-4,8,4-g13-path43", "64S8-4,8,4-g13-path21", "64S9-4,8,4-g13-path111" ];
