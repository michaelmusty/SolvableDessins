...
s`SolvableDBSanityCheckTiming := 401.860p15;
s`SolvableDBLocalSanityCheckTiming := 6.250p15;
...
s`SolvableDBBelyiMap := KX!(1/(16*x1^5)*x3^5 + (-84*x1^4 - 1)/(16*x1^6)*x3^4 + 91/(16*x1^3)*x3^3 - 71/2*x3^2 - 7/(8*x1)*x3 + (-117*x1^2 + 2)/4);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T5-8,8,2-g3-path7", "32S16-16,16,4-g11-path9" ];
s`SolvableDBParents := [ Strings() | "64S50-32,32,8-g27-path21", "64S51-32,32,8-g27-path17", "64S50-32,32,8-g27-path22", "64S51-32,32,8-g27-path18", "64S44-16,16,4-g21-path64", "64S26-16,16,4-g21-path18", "64S29-16,16,4-g21-path9" ];
