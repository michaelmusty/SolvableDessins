...
s`SolvableDBName := "32S6-4,4,4-g5-path20";
s`SolvableDBFilename := "32S6-4,4,4-g5-path20.m";
...
s`SolvableDBSanityCheckTiming := 1.670p15;
...
I<x1, x2, x3> := ideal< PX | [
x1^2*x3^2 + (nu^3 - nu - 1)*x2*x3^2 - x1^2 + (nu^3 - nu + 1)*x2,
x2^2*x3^2 - x2^2 + (2*nu^3 - 2*nu - 3)*x3^2 + 2*nu^3 - 2*nu + 3,
x2^3 - 2*x1^2 - x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path7", "32S6-4,4,4-g5-path20" ];
s`SolvableDBParents := [ Strings() | "64S8-8,4,4-g13-path31", "64S8-4,4,8-g13-path35", "64S4-8,4,8-g17-path32", "64S9-8,4,4-g13-path143", "64S9-4,4,8-g13-path147", "64S5-8,4,8-g17-path66", "64S32-8,4,4-g13-path9", "64S32-4,4,8-g13-path13", "64S36-8,4,8-g17-path9", "64S33-8,4,4-g13-path31", "64S33-4,4,8-g13-path35", "64S37-8,4,8-g17-path20", "64S23-4,4,4-g9-path289", "64S34-4,4,4-g9-path13", "64S35-4,4,4-g9-path46" ];
