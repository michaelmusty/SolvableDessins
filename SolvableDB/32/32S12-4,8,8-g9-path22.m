...
s`SolvableDBName := "32S12-4,8,8-g9-path22";
s`SolvableDBFilename := "32S12-4,8,8-g9-path22.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T6-4,8,8-g5-path3", "32S12-4,8,8-g9-path22" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path15", "64S44-4,16,16-g21-path9", "64S45-8,16,16-g25-path9", "64S44-4,16,16-g21-path10", "64S45-8,16,16-g25-path10", "64S15-8,8,8-g21-path15", "64S17-4,8,8-g17-path15" ];
s`SolvableDBChildren := [ Strings() | "16T6-4,8,8-g5-path3" ];
