...
s`SolvableDBName := "32S16-16,4,16-g11-path3";
s`SolvableDBFilename := "32S16-16,4,16-g11-path3.m";
...
s`SolvableDBSanityCheckTiming := 0.360p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,1,8-g0-path1", "16T5-8,2,8-g3-path1", "32S16-16,4,16-g11-path3" ];
s`SolvableDBParents := [ Strings() | "64S50-32,8,32-g27-path9", "64S51-32,8,32-g27-path5", "64S50-32,8,32-g27-path10", "64S51-32,8,32-g27-path6", "64S44-16,4,16-g21-path58", "64S26-16,4,16-g21-path12", "64S29-16,4,16-g21-path3" ];
