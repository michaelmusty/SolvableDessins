...
s`SolvableDBSanityCheckTiming := 0.210p15;
...
s`SolvableDBBelyiMap := KX!(-x3^8/4);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S7-8,2,8-g5-path10" ];
s`SolvableDBParents := [ Strings() | "64S10-8,4,8-g17-path24", "64S14-8,4,8-g17-path36", "64S4-8,4,8-g17-path36", "64S24-8,4,8-g17-path83", "64S4-8,2,8-g9-path36", "64S12-8,2,8-g9-path2", "64S10-8,2,8-g9-path24" ];
