...
{ IntegerRing() | 30, 31 }
@};
s`SolvableDBBelyiMapTiming := 1.910p15;
s`SolvableDBSanityCheckTiming := 51.920p15;
s`SolvableDBLocalSanityCheckTiming := 4.300p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,2,8-g3-path5", "32S17-16,4,16-g11-path5" ];
