...
s`SolvableDBName := "32S11-8,4,4-g7-path19";
s`SolvableDBFilename := "32S11-8,4,4-g7-path19.m";
...
s`SolvableDBSanityCheckTiming := 1.380p15;
...
I<x1, x2, x3> := ideal< PX | [
x1^2*x3^2 + 1/2*(nu - 2)*x2^2*x3^2 - nu*x2*x3^2 - x1^2 + 1/2*(nu - 2)*x2^2 - 1/2*nu*x3^2 + nu*x2 - 1/2*nu,
x2^3 - 2*x1^2 - x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S11-8,4,4-g7-path19" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,4-g17-path19", "64S11-8,8,4-g17-path41", "64S10-8,8,4-g17-path19", "64S7-8,8,4-g17-path109", "64S9-8,4,4-g13-path101", "64S8-8,4,4-g13-path11", "64S20-8,4,4-g13-path33" ];
