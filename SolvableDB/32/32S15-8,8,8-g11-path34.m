...
s`SolvableDBName := "32S15-8,8,8-g11-path34";
s`SolvableDBFilename := "32S15-8,8,8-g11-path34.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T8-4,4,4-g3-path24", "32S15-8,8,8-g11-path34" ];
s`SolvableDBParents := [ Strings() | "64S15-8,8,8-g21-path268", "64S16-8,8,8-g21-path268", "64S22-8,8,8-g21-path28" ];
