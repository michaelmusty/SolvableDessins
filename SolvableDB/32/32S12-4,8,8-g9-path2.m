...
s`SolvableDBName := "32S12-4,8,8-g9-path2";
s`SolvableDBFilename := "32S12-4,8,8-g9-path2.m";
...
\[ 6, 1, 8, 14, 2, 5, 4, 12, 3, 7, 18, 9, 11, 10, 16, 20, 15, 19, 13, 17, 22, 28, 21, 26, 24, 27, 25, 23, 31, 29, 32, 30 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-2,8,8-g2-path1", "16T5-2,8,8-g3-path2", "32S12-4,8,8-g9-path2" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path16", "64S44-4,16,16-g21-path15", "64S45-8,16,16-g25-path15", "64S44-4,16,16-g21-path16", "64S45-8,16,16-g25-path16", "64S15-8,8,8-g21-path16", "64S17-4,8,8-g17-path16" ];
