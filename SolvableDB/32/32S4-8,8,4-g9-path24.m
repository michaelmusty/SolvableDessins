...
s`SolvableDBName := "32S4-8,8,4-g9-path24";
s`SolvableDBFilename := "32S4-8,8,4-g9-path24.m";
...
\[ 6, 1, 24, 16, 18, 25, 4, 26, 2, 3, 5, 7, 8, 28, 9, 27, 22, 14, 23, 30, 12, 10, 21, 13, 31, 17, 19, 20, 11, 29, 32, 15 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T6-8,8,4-g5-path4", "32S4-8,8,4-g9-path24" ];
...
s`SolvableDBChild := "16T6-8,8,4-g5-path4";
