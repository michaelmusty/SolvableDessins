...
\[ 3, 8, 12, 6, 13, 14, 1, 15, 4, 19, 2, 25, 26, 27, 28, 17, 29, 5, 30, 7, 16, 9, 10, 11, 21, 22, 23, 31, 24, 32, 18, 20 ],
\[ 8, 4, 15, 1, 19, 3, 2, 6, 7, 16, 9, 28, 30, 12, 14, 5, 13, 10, 17, 11, 18, 20, 21, 22, 31, 32, 25, 27, 26, 29, 23, 24 ]:
 Order := 32 >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T1-8,16,16-g7-path2", "32S1-16,32,32-g15-path4" ];
