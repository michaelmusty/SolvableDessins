...
x2^3*x4^2 - x1*x2^2*x3 - x2*x4^2 - x1*x3,
x2^2*x3*x4^2 - x1*x2^2 - x3*x4^2 - x1,
x1*x2*x4^2 - x2^2*x3 - x3,
x1*x3*x4^2 - x2^2 - 1,
x1^2 - x2^2 + 1,
x3^2 - x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S5-8,4,8-g9-path3" ];
