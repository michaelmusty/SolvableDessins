...
phi := KX!((-x[1]^24 + x[1]^16 + x[1]^8 - 1)/(4*x[1]^16)*x[2] + (-x[1]^16 + 2*x[1]^8 - 1)/(2*x[1]^8));
/* assign to object */
...
\[ 9, 5, 11, 6, 2, 4, 13, 10, 1, 8, 3, 14, 7, 12, 17, 18, 15, 16, 20, 19, 23, 24, 21, 22, 26, 25, 28, 27, 30, 29, 32, 31 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-2,8,8-g3-path3", "32S17-2,16,16-g7-path6" ];
