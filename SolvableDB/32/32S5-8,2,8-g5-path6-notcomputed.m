...
s`SolvableDBName := "32S5-8,2,8-g5-path6-notcomputed";
s`SolvableDBFilename := "32S5-8,2,8-g5-path6-notcomputed.m";
...
\[ 6, 1, 4, 17, 12, 18, 13, 2, 3, 5, 7, 15, 14, 16, 26, 25, 28, 27, 9, 10, 8, 11, 19, 20, 30, 32, 29, 31, 21, 22, 23, 24 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,1,4-g0-path1-notcomputed", "8T1-8,2,8-g2-path1-notcomputed", "16T5-8,2,8-g3-path2-notcomputed", "32S5-8,2,8-g5-path6-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S17-8,4,8-g17-path19-notcomputed", "64S7-8,4,8-g17-path17-notcomputed", "64S7-8,4,8-g17-path18-notcomputed", "64S5-8,4,8-g17-path3-notcomputed", "64S29-16,2,16-g13-path7-notcomputed", "64S29-16,4,16-g21-path6-notcomputed", "64S31-16,2,16-g13-path5-notcomputed", "64S31-16,4,16-g21-path5-notcomputed", "64S31-16,2,16-g13-path6-notcomputed", "64S31-16,4,16-g21-path6-notcomputed", "64S30-16,2,16-g13-path3-notcomputed", "64S30-16,4,16-g21-path3-notcomputed", "64S6-8,2,8-g9-path7-notcomputed", "64S6-8,2,8-g9-path8-notcomputed", "64S4-8,2,8-g9-path3-notcomputed" ];
s`SolvableDBChild := "16T5-8,2,8-g3-path2-notcomputed";
