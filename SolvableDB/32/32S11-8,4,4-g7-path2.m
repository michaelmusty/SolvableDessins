...
s`SolvableDBSanityCheckTiming := 3.230p15;
...
I<x1, x2, x3> := ideal< PX | [
x1^2*x3^2 - nu*x1*x2*x3^2 - 1/2*x2^2*x3^2 - nu*x1*x3^2 + 1/4*nu*x1*x2 - 1/4*x2^2 - 1/2*x3^2 - 1/4*nu*x1 - 1/4*x2,
x2^3 - 2*x1^2 + x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S11-8,4,4-g7-path2" ];
s`SolvableDBParents := [ Strings() | "64S6-8,4,8-g17-path15", "64S11-8,4,8-g17-path37", "64S10-8,4,8-g17-path15", "64S7-8,4,8-g17-path105", "64S9-8,4,4-g13-path102", "64S8-8,4,4-g13-path12", "64S20-8,4,4-g13-path34" ];
