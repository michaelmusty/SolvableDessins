...
I<[x]> := ideal< P | [
x[1]^2*x[3]^2 + x[1]*x[2]^3*x[3]^2 + x[1]*x[2] - x[2]^2*x[3]^2 - x[2]^2 - x[3]^2,
-x[1]^2*x[3]^2 + x[1]*x[2]^3 + x[1]*x[2]*x[3]^2 - 2*x[1]*x[2] + x[2]^4*x[3]^2 + 2*x[2]^2*x[3]^2 + 2*x[2]^2 + x[3]^2 + 1,
x[1]^3*x[3]^2 + x[1]^2*x[2] - 2*x[1]*x[2]^2*x[3]^2 - x[1]*x[2]^2 - x[1]*x[3]^2 - x[1] - x[2]^3*x[3]^2 - x[2]*x[3]^2 + x[2],
x[1]^2*x[2]*x[3]^2 + x[1]*x[2]^2*x[3]^2 + x[1] - x[2],
...
s`SolvableDBSanityCheckTiming := 0.310000000000000p15;
