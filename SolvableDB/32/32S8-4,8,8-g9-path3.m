...
s`SolvableDBSanityCheckTiming := 6.920p15;
s`SolvableDBLocalSanityCheckTiming := 2.130p15;
...
I<x1, x2, x3> := ideal< PX | [
x1^2*x2*x3^2 - 2*x1*x2*x3^2 - 1/2*nu*x1*x2^2 - x2*x3^2 - 1/4*nu*x1^2 - nu*x2^2 - nu*x1 + 1/4*nu,
x2^3*x3^2 - 1/4*nu*x1^2*x2^2 - 2*x1*x2*x3^2 - nu*x1*x2^2 - x2*x3^2 - 3/4*nu*x1^2 - 5/4*nu*x2^2 - nu*x1 + 1/4*nu,
x1^3 - 2*x2^2 - x1
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S8-4,8,8-g9-path3" ];
s`SolvableDBParents := [ Strings() | "64S11-4,8,8-g17-path53", "64S5-4,8,8-g17-path77", "64S13-4,8,8-g17-path43", "64S13-4,8,8-g17-path44", "64S5-4,8,8-g17-path78", "64S11-4,8,8-g17-path54", "64S24-4,8,8-g17-path97" ];
