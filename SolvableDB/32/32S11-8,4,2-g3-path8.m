...
s`SolvableDBName := "32S11-8,4,2-g3-path8";
s`SolvableDBFilename := "32S11-8,4,2-g3-path8.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S11-8,4,2-g3-path8" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,2-g9-path21", "64S20-8,4,4-g13-path21", "64S7-8,8,4-g17-path100", "64S10-8,8,2-g9-path21", "64S9-8,4,4-g13-path89", "64S11-8,8,4-g17-path32", "64S8-8,4,2-g5-path10" ];
