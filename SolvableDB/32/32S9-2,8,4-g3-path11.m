...
phi := KX!((x[1]^16 + 32*x[1]^8 + 256)/(x[1]^16 - 32*x[1]^8 + 256));
/* assign to object */
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 23, 24, 25, 22, 20, 21, 18, 17, 26, 15, 16, 14, 11, 12, 13, 19, 30, 29, 28, 27, 32, 31 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path8", "32S9-2,8,4-g3-path11" ];
