...
s`SolvableDBName := "32S15-8,8,8-g11-path46";
s`SolvableDBFilename := "32S15-8,8,8-g11-path46.m";
...
{ IntegerRing() | 30, 32 }
@};
s`SolvableDBBelyiMapTiming := 2.370p15;
s`SolvableDBSanityCheckTiming := 63.420p15;
s`SolvableDBLocalSanityCheckTiming := 5.190p15;
...
I<x1, x2, x3> := ideal< PX | [
x2^2*x3^6 + 53242459018231808/63825668510630625*x1*x2*x3^4 - 65019684968226466299904/402944529569655814903125*nu*x1^3*x3^2 + 3079076259548889088/1085036364680720625*nu*x2*x3^4 - 614457147392/281462092005375*nu*x1^3*x2 - 33448337396865532166144/402944529569655814903125*x1^2*x3^2 - 1024/65535*nu*x2^2*x3^2 - 295512331553603584/18445618199572250625*x1^2*x2 + 8769057131617249656832/48353343548358697788375*nu*x1*x3^2 + 537754139745058816/18445618199572250625*nu*x1*x2 + 568021350748870672384/71107858159351026159375*x3^2,
x1^2*x2*x3^4 + 323852/65535*nu*x1*x2*x3^4 + 465306320896/413735889675*x1^3*x3^2 - 20657872/1114095*x2*x3^4 - 217760137216/413735889675*nu*x1^2*x3^2 - 1024/65535*nu*x1^2*x2 - 276948844544/248241533805*x1*x3^2 - 4096/65535*x1*x2 + 4194304/252637425*nu*x3^2,
x1*x2^2*x3^4 + 809842534/282374895*nu*x2^2*x3^4 - 199788861620224/314592458645025*x1^2*x2*x3^2 - 638747514896384/314592458645025*nu*x1*x2*x3^2 - 44568259302785024/80850261871771425*x1^3 - 1024/65535*nu*x1*x2^2 + 2761433730777088/314592458645025*x2*x3^2 + 5380674666958422016/20616816777301713375*nu*x1^2 - 7744681984/81606344655*x2^2 + 182098366360356651008/350485885214129127375*x1 - 519736809987506176/350485885214129127375*nu,
x1^3*x2*x3^2 - 4294836225/600055808*x2^2*x3^4 + 117426/73249*nu*x1^2*x2*x3^2 - 587080/73249*x1*x2*x3^2 + 537001984/282374895*nu*x1^3 - 2225504/73249*nu*x2*x3^2 + 84410368/94124965*x1^2 + 65535/585992*nu*x2^2 - 8596226048/4800373215*nu*x1 - 8388608/4800373215,
x1^4 - 76/17*nu*x1^3 + 65535/1024*nu*x2*x3^2 - 48/17*x1^2 + 64/17*nu*x1
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T8-4,4,4-g3-path3", "32S15-8,8,8-g11-path46" ];
s`SolvableDBParents := [ Strings() | "64S15-8,8,8-g21-path281", "64S16-8,8,8-g21-path281", "64S22-8,8,8-g21-path41" ];
