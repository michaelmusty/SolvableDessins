...
\[ 6, 1, 22, 23, 20, 24, 8, 25, 2, 3, 4, 5, 7, 21, 28, 26, 11, 14, 27, 9, 31, 19, 13, 12, 17, 29, 16, 30, 10, 32, 15, 18 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S8-8,8,4-g9-path3" ];
s`SolvableDBParents := [ Strings() | "64S5-8,8,4-g17-path69", "64S11-8,8,4-g17-path45", "64S13-8,8,4-g17-path35", "64S13-8,8,4-g17-path36", "64S11-8,8,4-g17-path46", "64S5-8,8,4-g17-path70", "64S24-8,8,4-g17-path93" ];
