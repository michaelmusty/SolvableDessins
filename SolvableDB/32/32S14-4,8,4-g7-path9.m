...
s`SolvableDBName := "32S14-4,8,4-g7-path9";
s`SolvableDBFilename := "32S14-4,8,4-g7-path9.m";
...
\[ 6, 1, 22, 12, 19, 9, 4, 7, 2, 3, 5, 8, 30, 27, 29, 23, 28, 10, 24, 17, 20, 18, 14, 11, 13, 15, 16, 21, 32, 31, 25, 26 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T8-4,4,4-g3-path8", "32S14-4,8,4-g7-path9" ];
