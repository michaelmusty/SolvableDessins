...
s`SolvableDBName := "32S12-8,8,4-g9-path19";
s`SolvableDBFilename := "32S12-8,8,4-g9-path19.m";
...
x2*x3^4 - 5*x1^2*x3^2 - x1*x2 - x3^2,
x1^4 - x2*x3^2 + 6*x1^2 + 1
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T6-8,8,2-g3-path5", "32S12-8,8,4-g9-path19" ];
s`SolvableDBParents := [ Strings() | "64S44-16,16,8-g25-path19", "64S44-16,16,8-g25-path20", "64S45-16,16,4-g21-path19", "64S16-8,8,8-g21-path103", "64S45-16,16,4-g21-path20", "64S15-8,8,8-g21-path103", "64S17-8,8,4-g17-path11" ];
s`SolvableDBChildren := [ Strings() | "16T6-8,8,2-g3-path5" ];
