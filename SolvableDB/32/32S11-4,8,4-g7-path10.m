...
\[ 6, 1, 21, 7, 2, 5, 19, 22, 3, 4, 8, 11, 16, 31, 9, 26, 23, 24, 10, 25, 15, 12, 20, 32, 17, 28, 29, 13, 14, 18, 27, 30 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path7", "32S11-4,8,4-g7-path10" ];
s`SolvableDBParents := [ Strings() | "64S6-4,8,8-g17-path22", "64S7-4,8,8-g17-path112", "64S10-4,8,8-g17-path22", "64S11-4,8,8-g17-path44", "64S20-4,8,4-g13-path42", "64S8-4,8,4-g13-path20", "64S9-4,8,4-g13-path110" ];
