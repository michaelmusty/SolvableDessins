...
phi := KX!((x[1]^16 + 56*x[1]^14 + 924*x[1]^12 + 3976*x[1]^10 + 6470*x[1]^8 + 3976*x[1]^6 + 924*x[1]^4 + 56*x[1]^2 + 1)/(x[1]^16 - 8*x[1]^14 + 28*x[1]^12 - 56*x[1]^10 + 70*x[1]^8 - 56*x[1]^6 + 28*x[1]^4 - 8*x[1]^2 + 1));
/* assign to object */
...
s`SolvableDBName := "32S11-2,4,8-g3-path11";
s`SolvableDBFilename := "32S11-2,4,8-g3-path11.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 18, 25, 26, 27, 21, 22, 19, 11, 17, 28, 15, 16, 24, 23, 12, 13, 14, 20, 30, 29, 32, 31 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path8", "32S11-2,4,8-g3-path11" ];
s`SolvableDBParents := [ Strings() | "64S20-4,4,8-g13-path8", "64S6-2,8,8-g9-path8", "64S7-4,8,8-g17-path76", "64S9-4,4,8-g13-path76", "64S10-2,8,8-g9-path8", "64S11-4,8,8-g17-path8", "64S8-2,4,8-g5-path8" ];
