...
s`SolvableDBName := "32S1-8,32,32-g14-path2-notcomputed";
s`SolvableDBFilename := "32S1-8,32,32-g14-path2-notcomputed.m";
...
\[ 6, 1, 15, 18, 20, 23, 4, 3, 2, 5, 7, 8, 30, 26, 28, 13, 25, 27, 16, 9, 17, 14, 10, 19, 11, 12, 21, 22, 24, 32, 29, 31 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T1-1,4,4-g0-path1-notcomputed", "8T1-2,8,8-g2-path1-notcomputed", "16T1-4,16,16-g6-path1-notcomputed", "32S1-8,32,32-g14-path2-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S1-16,64,64-g30-path3-notcomputed", "64S1-16,64,64-g30-path4-notcomputed", "64S50-8,32,32-g27-path7-notcomputed", "64S50-8,32,32-g27-path8-notcomputed" ];
