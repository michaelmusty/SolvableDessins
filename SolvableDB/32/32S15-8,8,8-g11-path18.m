...
s`SolvableDBBelyiMap := KX!((-x1^8 + 1)/(4*x1^4)*x3^4 + x1^2/2*x3^2 + (x1^8 + 1)/4);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path17", "32S15-8,8,8-g11-path18" ];
s`SolvableDBParents := [ Strings() | "64S15-8,8,8-g21-path250", "64S16-8,8,8-g21-path250", "64S22-8,8,8-g21-path10" ];
