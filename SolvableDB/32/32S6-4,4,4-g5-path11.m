...
s`SolvableDBName := "32S6-4,4,4-g5-path11";
s`SolvableDBFilename := "32S6-4,4,4-g5-path11.m";
...
s`SolvableDBSanityCheckTiming := 0.990p15;
...
\[ 4, 10, 14, 18, 19, 7, 24, 1, 27, 29, 2, 5, 21, 20, 26, 3, 32, 8, 31, 16, 30, 6, 28, 22, 13, 17, 23, 9, 11, 25, 12, 15 ]:
 Order := 32 > |
[ 3, 9, 13, 2, 15, 21, 1, 24, 16, 5, 18, 29, 7, 12, 28, 4, 30, 17, 6, 27, 32, 31, 26, 23, 14, 8, 22, 10, 25, 11, 20, 19 ],
[ 19, 7, 26, 31, 4, 10, 29, 5, 30, 24, 6, 1, 9, 17, 14, 15, 16, 12, 18, 32, 27, 2, 13, 11, 28, 20, 25, 21, 22, 23, 8, 3 ],
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path9", "32S6-4,4,4-g5-path11" ];
s`SolvableDBParents := [ Strings() | "64S8-4,8,4-g13-path25", "64S8-4,4,8-g13-path25", "64S4-4,8,8-g17-path26", "64S9-4,8,4-g13-path137", "64S9-4,4,8-g13-path137", "64S5-4,8,8-g17-path60", "64S32-4,8,4-g13-path3", "64S32-4,4,8-g13-path3", "64S36-4,8,8-g17-path3", "64S33-4,8,4-g13-path25", "64S33-4,4,8-g13-path25", "64S37-4,8,8-g17-path14", "64S23-4,4,4-g9-path279", "64S34-4,4,4-g9-path3", "64S35-4,4,4-g9-path36" ];
