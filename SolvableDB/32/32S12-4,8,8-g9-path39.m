...
{ IntegerRing() | 28, 30 }
@};
s`SolvableDBBelyiMapTiming := 0.980p15;
s`SolvableDBSanityCheckTiming := 5.240p15;
...
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path33", "64S44-4,16,16-g21-path31", "64S45-8,16,16-g25-path31", "64S44-4,16,16-g21-path32", "64S45-8,16,16-g25-path32", "64S15-8,8,8-g21-path33", "64S17-4,8,8-g17-path33" ];
