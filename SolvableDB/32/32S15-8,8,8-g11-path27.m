...
s`SolvableDBName := "32S15-8,8,8-g11-path27";
s`SolvableDBFilename := "32S15-8,8,8-g11-path27.m";
...
s`SolvableDBSanityCheckTiming := 7.820p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T8-4,4,4-g3-path21", "32S15-8,8,8-g11-path27" ];
