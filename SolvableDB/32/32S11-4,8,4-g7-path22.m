...
s`SolvableDBName := "32S11-4,8,4-g7-path22";
s`SolvableDBFilename := "32S11-4,8,4-g7-path22.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S11-4,8,4-g7-path22" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,4-g17-path11", "64S7-8,8,4-g17-path90", "64S10-8,8,4-g17-path11", "64S11-8,8,4-g17-path22", "64S20-4,8,4-g13-path37", "64S8-4,8,4-g13-path15", "64S9-4,8,4-g13-path105" ];
