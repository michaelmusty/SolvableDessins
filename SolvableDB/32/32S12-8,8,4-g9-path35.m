...
s`SolvableDBName := "32S12-8,8,4-g9-path35";
s`SolvableDBFilename := "32S12-8,8,4-g9-path35.m";
...
s`SolvableDBSanityCheckTiming := 5.710p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T8-4,4,4-g3-path16", "32S12-8,8,4-g9-path35" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path121", "64S15-8,8,8-g21-path121", "64S44-16,16,4-g21-path27", "64S45-16,16,8-g25-path27", "64S44-16,16,4-g21-path28", "64S45-16,16,8-g25-path28", "64S17-8,8,4-g17-path29" ];
