...
phi := KX!(1/(4*x[4]^12)*x[2]^3 + (x[4]^16 - 1)/(4*x[4]^24)*x[2]^2 + 1/x[4]^20*x[2] - 3/(4*x[4]^16));
/* assign to object */
...
s`SolvableDBName := "32S16-8,16,16-g13-path15";
s`SolvableDBFilename := "32S16-8,16,16-g13-path15.m";
...
\[ 6, 1, 15, 18, 19, 22, 4, 3, 2, 5, 7, 8, 30, 25, 27, 13, 24, 26, 9, 17, 14, 10, 16, 11, 12, 20, 21, 23, 28, 32, 29, 31 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-4,8,8-g5-path3", "32S16-8,16,16-g13-path15" ];
s`SolvableDBParents := [ Strings() | "64S50-16,32,32-g29-path41", "64S51-16,32,32-g29-path33", "64S50-16,32,32-g29-path42", "64S51-16,32,32-g29-path34", "64S44-8,16,16-g25-path63", "64S26-8,16,16-g25-path17", "64S29-8,16,16-g25-path17" ];
