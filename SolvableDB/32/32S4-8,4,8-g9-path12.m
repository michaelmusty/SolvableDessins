...
s`SolvableDBName := "32S4-8,4,8-g9-path12";
s`SolvableDBFilename := "32S4-8,4,8-g9-path12.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T4-4,4,4-g3-path6", "32S4-8,4,8-g9-path12" ];
s`SolvableDBParents := [ Strings() | "64S28-16,8,16-g25-path7", "64S28-16,4,16-g21-path7", "64S3-8,8,8-g21-path144", "64S28-16,8,16-g25-path8", "64S28-16,4,16-g21-path8", "64S3-8,8,8-g21-path145", "64S17-8,4,8-g17-path160" ];
