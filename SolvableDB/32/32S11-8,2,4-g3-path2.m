...
s`SolvableDBParents := [ Strings() | "64S20-8,4,4-g13-path1", "64S6-8,2,8-g9-path2", "64S7-8,4,8-g17-path15", "64S9-8,4,4-g13-path13", "64S10-8,2,8-g9-path2", "64S11-8,4,8-g17-path3", "64S8-8,2,4-g5-path1" ];
