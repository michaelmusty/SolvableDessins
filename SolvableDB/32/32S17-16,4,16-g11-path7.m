...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,2,8-g3-path7", "32S17-16,4,16-g11-path7" ];
s`SolvableDBParents := [ Strings() | "64S29-16,4,16-g21-path16", "64S44-16,4,16-g21-path78", "64S27-16,4,16-g21-path14" ];
