...
s`SolvableDBName := "32S15-8,8,8-g11-path21";
s`SolvableDBFilename := "32S15-8,8,8-g11-path21.m";
...
\[ 11, 17, 28, 21, 2, 5, 22, 24, 6, 19, 9, 4, 16, 13, 10, 32, 20, 7, 30, 1, 8, 12, 15, 18, 27, 23, 29, 26, 14, 3, 25, 31 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T8-4,4,4-g3-path8", "32S15-8,8,8-g11-path21" ];
s`SolvableDBParents := [ Strings() | "64S22-8,8,8-g21-path43", "64S16-8,8,8-g21-path283", "64S15-8,8,8-g21-path283" ];
