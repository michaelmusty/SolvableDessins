...
s`SolvableDBName := "32S11-2,8,4-g3-path4";
s`SolvableDBFilename := "32S11-2,8,4-g3-path4.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S11-2,8,4-g3-path4" ];
s`SolvableDBParents := [ Strings() | "64S20-4,8,4-g13-path6", "64S6-2,8,8-g9-path17", "64S7-4,8,8-g17-path85", "64S9-4,8,4-g13-path74", "64S10-2,8,8-g9-path17", "64S11-4,8,8-g17-path17", "64S8-2,8,4-g5-path6" ];
