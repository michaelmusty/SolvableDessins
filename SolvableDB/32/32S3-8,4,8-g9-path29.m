...
\[ 26, 29, 18, 27, 20, 9, 30, 22, 31, 13, 14, 28, 21, 4, 12, 5, 16, 32, 11, 25, 17, 15, 7, 2, 10, 24, 23, 3, 6, 19, 1, 8 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,4,8-g5-path7", "32S3-8,4,8-g9-path29" ];
s`SolvableDBParents := [ Strings() | "64S2-8,8,8-g21-path50", "64S3-8,8,8-g21-path50", "64S26-16,4,16-g21-path39", "64S26-16,8,16-g25-path39", "64S27-16,4,16-g21-path35", "64S27-16,8,16-g25-path35", "64S17-8,4,8-g17-path148" ];
