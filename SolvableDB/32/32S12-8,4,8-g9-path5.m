...
phi := KX!(16*x[2]^2/(x[2]^4 + 8*x[2]^2 + 16));
/* assign to object */
...
\[ 26, 23, 27, 31, 25, 32, 24, 16, 14, 15, 17, 13, 30, 29, 28, 21, 22, 4, 5, 6, 7, 3, 19, 18, 20, 9, 12, 1, 10, 11, 8, 2 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,2,8-g3-path4", "32S12-8,4,8-g9-path5" ];
s`SolvableDBParents := [ Strings() | "64S45-16,8,16-g25-path35", "64S45-16,8,16-g25-path36", "64S44-16,4,16-g21-path35", "64S16-8,8,8-g21-path77", "64S44-16,4,16-g21-path36", "64S15-8,8,8-g21-path77", "64S17-8,4,8-g17-path31" ];
