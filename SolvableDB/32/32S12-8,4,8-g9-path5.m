...
s`SolvableDBName := "32S12-8,4,8-g9-path5";
s`SolvableDBFilename := "32S12-8,4,8-g9-path5.m";
...
{ IntegerRing() | 30, 31 }
@};
s`SolvableDBBelyiMapTiming := 1.030p15;
s`SolvableDBSanityCheckTiming := 3.900p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,2,8-g3-path5", "32S12-8,4,8-g9-path5" ];
s`SolvableDBParents := [ Strings() | "64S45-16,8,16-g25-path41", "64S45-16,8,16-g25-path42", "64S44-16,4,16-g21-path41", "64S16-8,8,8-g21-path88", "64S44-16,4,16-g21-path42", "64S15-8,8,8-g21-path88", "64S17-8,4,8-g17-path42" ];
