...
I<[x]> := ideal< P | [
x[1]*x[2]^3*x[3]^2 + 2*x[1]*x[2]^2*x[3]^2 + x[2]^3*x[3]^2 + 1/4*x[1]^2*x[2]^2 + 6*x[1]^2*x[3]^2 + 6*x[1]*x[2]*x[3]^2 + 6*x[2]^2*x[3]^2 - 3/2*x[1]^2*x[2] + 7/4*x[1]*x[2]^2 - x[2]^3 + 8*x[1]*x[3]^2 - 2*x[2]*x[3]^2 - 1/2*x[1]*x[2] + 1/2*x[2]^2 - 2*x[3]^2 + 1/2*x[2],
x[2]^4*x[3]^2 - 3*x[1]*x[2]^2*x[3]^2 - x[1]^2*x[2]^2 + 1/4*x[1]*x[2]^3 - 9*x[1]^2*x[3]^2 + 1/4*x[1]^2*x[2] - x[1]*x[2]^2 + 3/2*x[2]^3 + x[1]*x[2] + x[3]^2 - 1/4*x[2],
x[1]^2*x[2]*x[3]^2 + 2/3*x[1]*x[2]^2*x[3]^2 + 1/3*x[2]^3*x[3]^2 + 2/3*x[1]*x[2]*x[3]^2 + 4/3*x[2]^2*x[3]^2 - 1/6*x[1]^2*x[2] + 1/12*x[1]*x[2]^2 + 4/3*x[1]*x[3]^2 - 1/3*x[2]*x[3]^2 + 1/12*x[2]^2,
x[1]^3 - x[2]^2 - x[1]
] >;
...
phi := KX!(-16*x[1]^4/(16*x[1]^8 - 8*x[1]^4 + 1));
/* assign to object */
