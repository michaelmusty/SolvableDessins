...
\[ 10, 13, 18, 21, 2, 5, 23, 26, 6, 9, 3, 16, 20, 32, 4, 27, 31, 7, 22, 1, 11, 12, 15, 19, 30, 24, 8, 14, 17, 29, 28, 25 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path28", "32S12-8,8,4-g9-path39" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path120", "64S15-8,8,8-g21-path120", "64S44-16,16,4-g21-path29", "64S45-16,16,8-g25-path29", "64S44-16,16,4-g21-path30", "64S45-16,16,8-g25-path30", "64S17-8,8,4-g17-path28" ];
