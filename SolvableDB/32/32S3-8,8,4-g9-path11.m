...
s`SolvableDBName := "32S3-8,8,4-g9-path11";
s`SolvableDBFilename := "32S3-8,8,4-g9-path11.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T4-4,4,4-g3-path5", "32S3-8,8,4-g9-path11" ];
s`SolvableDBParents := [ Strings() | "64S2-8,8,8-g21-path61", "64S3-8,8,8-g21-path61", "64S26-16,16,4-g21-path21", "64S26-16,16,8-g25-path21", "64S27-16,16,4-g21-path17", "64S27-16,16,8-g25-path17", "64S17-8,8,4-g17-path130" ];
