...
s`SolvableDBName := "32S2-4,4,4-g5-path29";
s`SolvableDBFilename := "32S2-4,4,4-g5-path29.m";
...
\[ 12, 29, 26, 7, 2, 5, 17, 11, 20, 27, 13, 9, 23, 18, 31, 10, 24, 30, 25, 1, 14, 16, 8, 4, 3, 19, 22, 32, 6, 21, 28, 15 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S2-4,4,4-g5-path29" ];
