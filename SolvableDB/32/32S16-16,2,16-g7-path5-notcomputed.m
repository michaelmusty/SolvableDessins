...
s`SolvableDBName := "32S16-16,2,16-g7-path5-notcomputed";
s`SolvableDBFilename := "32S16-16,2,16-g7-path5-notcomputed.m";
...
\[ 26, 29, 28, 20, 17, 18, 31, 23, 25, 21, 19, 9, 10, 16, 8, 27, 12, 32, 14, 30, 11, 2, 5, 7, 6, 22, 4, 24, 15, 3, 13, 1 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,1,4-g0-path1-notcomputed", "8T1-8,2,8-g2-path1-notcomputed", "16T5-8,2,8-g3-path2-notcomputed", "32S16-16,2,16-g7-path5-notcomputed" ];
