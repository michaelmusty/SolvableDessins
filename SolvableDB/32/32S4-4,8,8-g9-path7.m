...
s`SolvableDBName := "32S4-4,8,8-g9-path7";
s`SolvableDBFilename := "32S4-4,8,8-g9-path7.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T4-4,4,4-g3-path15", "32S4-4,8,8-g9-path7" ];
s`SolvableDBParents := [ Strings() | "64S3-8,8,8-g21-path132", "64S28-4,16,16-g21-path45", "64S28-8,16,16-g25-path45", "64S3-8,8,8-g21-path133", "64S28-4,16,16-g21-path46", "64S28-8,16,16-g25-path46", "64S17-4,8,8-g17-path179" ];
