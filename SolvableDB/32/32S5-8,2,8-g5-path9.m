...
s`SolvableDBSanityCheckTiming := 0.650p15;
...
I<x1, x2, x3> := ideal< PX | [
x1^2*x3^2 + 1/2*nu^2*x2^2*x3^2 - 1/2*x1*x2 - 1/2*nu^2*x3^2 + 1/2*nu^2*x1,
x1*x2*x3^2 + nu^2*x1*x3^2 - 1/2*x2^2 + 1/2*nu^2*x2,
x2^3 - 2*x1^2 - x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path7", "32S5-8,2,8-g5-path9" ];
