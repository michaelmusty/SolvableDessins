...
s`SolvableDBName := "32S3-8,4,8-g9-path18";
s`SolvableDBFilename := "32S3-8,4,8-g9-path18.m";
...
s`SolvableDBSanityCheckTiming := 12.110p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,2,8-g3-path3", "32S3-8,4,8-g9-path18" ];
