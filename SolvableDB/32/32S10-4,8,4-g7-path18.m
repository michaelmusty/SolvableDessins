...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path5", "32S10-4,8,4-g7-path18" ];
s`SolvableDBParents := [ Strings() | "64S7-8,8,4-g17-path13", "64S13-8,8,4-g17-path7", "64S7-8,8,4-g17-path14", "64S14-8,8,4-g17-path7", "64S9-4,8,4-g13-path19", "64S21-4,8,4-g13-path10", "64S9-4,8,4-g13-path20" ];
