...
s`SolvableDBName := "32S3-8,4,8-g9-path23";
s`SolvableDBFilename := "32S3-8,4,8-g9-path23.m";
...
\[ 26, 29, 18, 27, 20, 9, 30, 22, 31, 13, 14, 28, 21, 4, 12, 5, 16, 32, 11, 25, 17, 15, 7, 2, 10, 24, 23, 3, 6, 19, 1, 8 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path1", "32S3-8,4,8-g9-path23" ];
