...
s`SolvableDBName := "32S12-4,8,8-g9-path31";
s`SolvableDBFilename := "32S12-4,8,8-g9-path31.m";
...
s`SolvableDBLocalSanityCheckTiming := 0.440p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T8-4,4,4-g3-path23", "32S12-4,8,8-g9-path31" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path25", "64S44-4,16,16-g21-path23", "64S45-8,16,16-g25-path23", "64S44-4,16,16-g21-path24", "64S45-8,16,16-g25-path24", "64S15-8,8,8-g21-path25", "64S17-4,8,8-g17-path25" ];
