...
s`SolvableDBName := "32S11-8,4,2-g3-path5";
s`SolvableDBFilename := "32S11-8,4,2-g3-path5.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path3", "32S11-8,4,2-g3-path5" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,2-g9-path18", "64S20-8,4,4-g13-path18", "64S7-8,8,4-g17-path97", "64S10-8,8,2-g9-path18", "64S9-8,4,4-g13-path86", "64S11-8,8,4-g17-path29", "64S8-8,4,2-g5-path7" ];
