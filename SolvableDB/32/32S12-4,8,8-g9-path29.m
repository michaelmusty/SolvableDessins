...
s`SolvableDBName := "32S12-4,8,8-g9-path29";
s`SolvableDBFilename := "32S12-4,8,8-g9-path29.m";
...
s`SolvableDBSanityCheckTiming := 6.230p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T8-4,4,4-g3-path22", "32S12-4,8,8-g9-path29" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path22", "64S44-4,16,16-g21-path19", "64S45-8,16,16-g25-path19", "64S44-4,16,16-g21-path20", "64S45-8,16,16-g25-path20", "64S15-8,8,8-g21-path22", "64S17-4,8,8-g17-path22" ];
