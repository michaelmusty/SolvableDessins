...
s`SolvableDBName := "32S11-4,4,8-g7-path3";
s`SolvableDBFilename := "32S11-4,4,8-g7-path3.m";
...
s`SolvableDBSanityCheckTiming := 3.220p15;
...
I<x1, x2, x3> := ideal< PX | [
x1*x2^2*x3^2 - 2*x2^2*x3^2 - x1^2*x2 - x2^3 - x1*x3^2,
x2^3*x3^2 - 1/2*x1^2*x2^2 - 2*x1*x2*x3^2 - 2*x1*x2^2 - x2*x3^2 + 1/2*x1^2 - 3/2*x2^2 - 1/2,
x1^2*x3^2 - x2^2*x3^2 + 1/2*x1^2*x2 + x1*x2 - 1/2*x2,
x1^3 - 2*x2^2 - x1
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S11-4,4,8-g7-path3" ];
s`SolvableDBParents := [ Strings() | "64S6-4,8,8-g17-path5", "64S11-4,8,8-g17-path27", "64S10-4,8,8-g17-path5", "64S7-4,8,8-g17-path95", "64S9-4,4,8-g13-path106", "64S8-4,4,8-g13-path16", "64S20-4,4,8-g13-path38" ];
