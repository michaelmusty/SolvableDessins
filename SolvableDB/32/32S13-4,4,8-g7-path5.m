...
s`SolvableDBName := "32S13-4,4,8-g7-path5";
s`SolvableDBFilename := "32S13-4,4,8-g7-path5.m";
...
{ IntegerRing() | 29, 31 }
@};
s`SolvableDBBelyiMapTiming := 2.69000000000000p15;
...
\[ 11, 30, 12, 7, 2, 5, 10, 21, 18, 26, 9, 22, 16, 13, 29, 23, 8, 1, 24, 3, 25, 20, 14, 31, 17, 4, 19, 32, 28, 6, 27, 15 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T12-4,2,8-g2-path1", "32S13-4,4,8-g7-path5" ];
s`SolvableDBParents := [ Strings() | "64S46-8,4,16-g19-path17", "64S46-4,8,16-g19-path17", "64S15-8,8,8-g21-path155", "64S46-8,4,16-g19-path18", "64S46-4,8,16-g19-path18", "64S15-8,8,8-g21-path156", "64S21-4,4,8-g13-path43" ];
