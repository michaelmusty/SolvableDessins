...
phi := KX!((x[3]^16 + 8*x[3]^8 + 16)/(16*x[3]^8));
/* assign to object */
...
\[ 6, 1, 24, 16, 18, 9, 4, 25, 2, 3, 5, 7, 8, 11, 32, 12, 13, 14, 23, 28, 26, 10, 21, 22, 17, 19, 20, 31, 30, 15, 27, 29 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T8-4,4,4-g3-path9", "32S13-4,4,8-g7-path5" ];
s`SolvableDBParents := [ Strings() | "64S46-8,4,16-g19-path3", "64S46-4,8,16-g19-path3", "64S15-8,8,8-g21-path21", "64S46-8,4,16-g19-path4", "64S46-4,8,16-g19-path4", "64S15-8,8,8-g21-path22", "64S21-4,4,8-g13-path8" ];
