...
s`SolvableDBName := "32S2-4,4,4-g5-path61";
s`SolvableDBFilename := "32S2-4,4,4-g5-path61.m";
...
\[ 6, 1, 24, 25, 22, 9, 4, 23, 2, 3, 5, 7, 8, 21, 32, 27, 13, 14, 11, 26, 31, 19, 17, 28, 12, 16, 20, 10, 30, 15, 18, 29 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T8-4,4,4-g3-path6", "32S2-4,4,4-g5-path61" ];
