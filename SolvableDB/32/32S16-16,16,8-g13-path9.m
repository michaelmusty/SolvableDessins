...
s`SolvableDBName := "32S16-16,16,8-g13-path9";
s`SolvableDBFilename := "32S16-16,16,8-g13-path9.m";
...
\[ 6, 1, 11, 17, 19, 22, 4, 3, 2, 5, 7, 8, 26, 9, 29, 30, 31, 15, 32, 16, 13, 18, 14, 10, 12, 20, 21, 23, 24, 25, 27, 28 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,4-g5-path6", "32S16-16,16,8-g13-path9" ];
s`SolvableDBParents := [ Strings() | "64S50-32,32,16-g29-path11", "64S51-32,32,16-g29-path3", "64S50-32,32,16-g29-path12", "64S51-32,32,16-g29-path4", "64S44-16,16,8-g25-path48", "64S26-16,16,8-g25-path2", "64S29-16,16,8-g25-path2" ];
