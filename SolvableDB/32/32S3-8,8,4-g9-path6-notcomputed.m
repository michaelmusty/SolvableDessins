...
s`SolvableDBName := "32S3-8,8,4-g9-path6-notcomputed";
s`SolvableDBFilename := "32S3-8,8,4-g9-path6-notcomputed.m";
...
\[ 22, 31, 12, 21, 19, 18, 32, 28, 25, 30, 29, 26, 2, 9, 20, 7, 11, 27, 13, 23, 16, 17, 4, 10, 1, 8, 5, 24, 14, 3, 6, 15 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-4,4,2-g1-path4-notcomputed", "16T5-8,8,2-g3-path3-notcomputed", "32S3-8,8,4-g9-path6-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S2-8,8,8-g21-path9-notcomputed", "64S3-8,8,8-g21-path9-notcomputed", "64S26-16,16,4-g21-path8-notcomputed", "64S26-16,16,8-g25-path5-notcomputed", "64S27-16,16,4-g21-path5-notcomputed", "64S27-16,16,8-g25-path4-notcomputed", "64S17-8,8,4-g17-path13-notcomputed" ];
