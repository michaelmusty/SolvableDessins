...
phi := KX!((-1/16*x[3]^8 + 1/4*x[3]^6 + 5/8*x[3]^4 + 1/4*x[3]^2 - 1/16)/x[3]^4);
/* assign to object */
...
\[ 12, 29, 26, 7, 2, 5, 17, 11, 20, 27, 13, 9, 23, 18, 31, 10, 24, 30, 25, 1, 14, 16, 8, 4, 3, 19, 22, 32, 6, 21, 28, 15 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S2-4,4,4-g5-path26" ];
