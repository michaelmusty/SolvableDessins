...
s`SolvableDBName := "32S11-4,4,8-g7-path18";
s`SolvableDBFilename := "32S11-4,4,8-g7-path18.m";
...
s`SolvableDBLocalSanityCheckTiming := 0.960p15;
...
\[ 11, 28, 12, 7, 2, 5, 10, 30, 18, 29, 9, 21, 24, 13, 32, 17, 8, 1, 23, 3, 20, 14, 31, 22, 27, 19, 15, 6, 4, 16, 26, 25 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S11-4,4,8-g7-path18" ];
s`SolvableDBParents := [ Strings() | "64S6-8,4,8-g17-path4", "64S7-8,4,8-g17-path83", "64S10-8,4,8-g17-path4", "64S11-8,4,8-g17-path15", "64S20-4,4,8-g13-path29", "64S8-4,4,8-g13-path7", "64S9-4,4,8-g13-path97" ];
