...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 23, 9, 17, 29, 14, 21, 18, 22, 12, 31, 13, 27, 11, 19, 20, 10, 32, 30, 28 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T4-4,4,4-g3-path2", "32S4-8,4,8-g9-path3" ];
s`SolvableDBParents := [ Strings() | "64S28-16,8,16-g25-path33", "64S28-16,4,16-g21-path33", "64S3-8,8,8-g21-path170", "64S28-16,8,16-g25-path34", "64S28-16,4,16-g21-path34", "64S3-8,8,8-g21-path171", "64S17-8,4,8-g17-path173" ];
