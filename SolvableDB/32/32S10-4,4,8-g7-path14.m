...
s`SolvableDBName := "32S10-4,4,8-g7-path14";
s`SolvableDBFilename := "32S10-4,4,8-g7-path14.m";
...
[ 11, 30, 8, 23, 2, 5, 14, 22, 18, 13, 9, 21, 4, 26, 31, 7, 12, 1, 15, 17, 20, 25, 10, 32, 3, 16, 29, 19, 24, 6, 28, 27 ],
[ 17, 14, 32, 24, 23, 16, 31, 2, 21, 27, 8, 28, 9, 11, 4, 18, 5, 25, 22, 15, 30, 29, 1, 20, 6, 19, 12, 10, 26, 13, 3, 7 ]
],
[ PermutationGroup<32 |  
\[ 11, 30, 8, 23, 2, 5, 14, 22, 18, 13, 9, 21, 4, 26, 31, 7, 12, 1, 15, 17, 20, 25, 10, 32, 3, 16, 29, 19, 24, 6, 28, 27 ],
\[ 3, 10, 5, 18, 7, 4, 1, 27, 22, 11, 12, 2, 29, 28, 25, 15, 31, 20, 13, 6, 19, 30, 32, 16, 24, 9, 14, 8, 21, 26, 23, 17 ],
...
x1*x2*x4^2 + 1/2*x1*x2*x3 - x1*x4^2 - 2*x3*x4^2 - x2^2 + 1/2*x1*x3,
x2^2*x4^2 + 1/2*x2^2*x3 - x1*x2 + x2*x3 + x4^2 - 1/2*x3,
x1*x3*x4^2 + x2*x4^2 + 1/2*x1*x2 - 1/2*x2*x3 - x4^2 + 1/2*x3,
x2*x3*x4^2 + x1*x4^2 + x3*x4^2 + 1/2*x2^2 - 1/2*x1*x3 + 1/2*x2,
x1^2 - x2^2 + 1,
x3^2 - x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S10-4,4,8-g7-path14" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path5", "64S13-8,4,8-g17-path3", "64S7-8,4,8-g17-path6", "64S14-8,4,8-g17-path3", "64S9-4,4,8-g13-path11", "64S21-4,4,8-g13-path6", "64S9-4,4,8-g13-path12" ];
s`SolvableDBChildren := [ Strings() | "16T10-4,2,4-g1-path11" ];
