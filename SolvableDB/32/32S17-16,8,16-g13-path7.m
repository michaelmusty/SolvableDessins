...
I<[x]> := ideal< P | [
x[3]*x[4]^4 - 4*x[3]^2*x[4]^2 - 2*x[4]^2 + 4*x[3],
x[1]^2*x[3]^2 + x[3]^2 - x[2],
x[1]*x[2]*x[3]^2 + x[2]*x[3]^2 - x[3]*x[4]^2 - x[1]^2 + 2*x[3]^2 - x[1] + 2,
x[2]^2*x[3]^2 + 2*x[1]*x[3]^2 - x[1]*x[2],
x[1]^2*x[4]^2 - 2*x[1]^2*x[3] + x[1]*x[4]^2 - 2*x[1]*x[3] + 2*x[2]*x[3],
x[1]*x[3]*x[4]^2 - 2*x[1]*x[3]^2 + 2*x[2]*x[3]^2 - x[3]*x[4]^2 + 2*x[3]^2 - 2*x[1] + 2,
x[1]^3 - x[2]^2 - x[1],
x[2]*x[4]^2 + 2*x[1]*x[3] - 2*x[2]*x[3] - 2*x[3]
] >;
...
s`SolvableDBName := "32S17-16,8,16-g13-path7";
s`SolvableDBFilename := "32S17-16,8,16-g13-path7.m";
...
\[ 6, 1, 23, 13, 15, 24, 4, 16, 2, 3, 5, 7, 8, 26, 31, 17, 32, 14, 20, 21, 10, 29, 30, 28, 19, 9, 22, 27, 11, 12, 18, 25 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,4,8-g5-path5", "32S17-16,8,16-g13-path7" ];
s`SolvableDBParents := [ Strings() | "64S27-16,8,16-g25-path6", "64S44-16,8,16-g25-path70", "64S29-16,8,16-g25-path24" ];
