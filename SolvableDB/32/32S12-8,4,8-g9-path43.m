...
s`SolvableDBName := "32S12-8,4,8-g9-path43";
s`SolvableDBFilename := "32S12-8,4,8-g9-path43.m";
...
s`SolvableDBSanityCheckTiming := 5.290p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T8-4,4,4-g3-path8", "32S12-8,4,8-g9-path43" ];
s`SolvableDBParents := [ Strings() | "64S45-16,8,16-g25-path37", "64S45-16,8,16-g25-path38", "64S44-16,4,16-g21-path37", "64S16-8,8,8-g21-path84", "64S44-16,4,16-g21-path38", "64S15-8,8,8-g21-path84", "64S17-8,4,8-g17-path38" ];
