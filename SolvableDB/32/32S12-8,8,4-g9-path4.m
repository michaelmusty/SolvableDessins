...
[ 18, 22, 2, 20, 12, 10, 19, 9, 31, 28, 21, 29, 4, 11, 5, 7, 1, 32, 27, 30, 25, 26, 6, 8, 14, 3, 16, 23, 15, 13, 24, 17 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,2-g3-path4", "32S12-8,8,4-g9-path4" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path126", "64S15-8,8,8-g21-path126", "64S44-16,16,4-g21-path33", "64S45-16,16,8-g25-path33", "64S44-16,16,4-g21-path34", "64S45-16,16,8-g25-path34", "64S17-8,8,4-g17-path34" ];
