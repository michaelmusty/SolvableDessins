...
s`SolvableDBName := "32S10-8,4,4-g7-path10";
s`SolvableDBFilename := "32S10-8,4,4-g7-path10.m";
...
s`SolvableDBSanityCheckTiming := 1.050p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S10-8,4,4-g7-path10" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path37", "64S13-8,4,8-g17-path19", "64S7-8,4,8-g17-path38", "64S14-8,4,8-g17-path19", "64S9-8,4,4-g13-path3", "64S21-8,4,4-g13-path2", "64S9-8,4,4-g13-path4" ];
