...
s`SolvableDBName := "32S7-2,8,8-g5-path2";
s`SolvableDBFilename := "32S7-2,8,8-g5-path2.m";
...
s`SolvableDBBelyiMap := KX!((x3^8 + 4)/x3^8);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path10", "32S7-2,8,8-g5-path2" ];
s`SolvableDBParents := [ Strings() | "64S10-4,8,8-g17-path26", "64S14-4,8,8-g17-path38", "64S4-4,8,8-g17-path38", "64S24-4,8,8-g17-path85", "64S4-2,8,8-g9-path38", "64S12-2,8,8-g9-path4", "64S10-2,8,8-g9-path26" ];
