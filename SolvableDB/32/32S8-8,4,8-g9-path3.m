...
x2^2*x4^2 - x1*x3*x4^2 + x2*x4^2 - x1*x3 - x2 + 1,
x1^2 - x2^2 + 1,
x3^2 - x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S8-8,4,8-g9-path3" ];
s`SolvableDBParents := [ Strings() | "64S5-8,4,8-g17-path77", "64S11-8,4,8-g17-path53", "64S13-8,4,8-g17-path43", "64S13-8,4,8-g17-path44", "64S11-8,4,8-g17-path54", "64S5-8,4,8-g17-path78", "64S24-8,4,8-g17-path97" ];
