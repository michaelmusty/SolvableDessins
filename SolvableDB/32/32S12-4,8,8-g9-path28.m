...
s`SolvableDBName := "32S12-4,8,8-g9-path28";
s`SolvableDBFilename := "32S12-4,8,8-g9-path28.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T8-4,4,4-g3-path2", "32S12-4,8,8-g9-path28" ];
s`SolvableDBParents := [ Strings() | "64S44-8,16,16-g25-path23", "64S44-8,16,16-g25-path24", "64S45-4,16,16-g21-path23", "64S16-8,8,8-g21-path21", "64S45-4,16,16-g21-path24", "64S15-8,8,8-g21-path21", "64S17-4,8,8-g17-path21" ];
