...
s`SolvableDBName := "32S11-8,4,4-g7-path3";
s`SolvableDBFilename := "32S11-8,4,4-g7-path3.m";
...
s`SolvableDBSanityCheckTiming := 1.290p15;
...
x2^2*x4^2 - x1*x3*x4^2 + x2*x4^2 - x1*x2 - x2*x3 + x3,
x2*x3*x4^2 - x1*x4^2 + x3*x4^2 - x1*x3 - x2 + 1,
x1^2 - x2^2 + 1,
x3^2 - x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S11-8,4,4-g7-path3" ];
s`SolvableDBParents := [ Strings() | "64S6-8,4,8-g17-path16", "64S11-8,4,8-g17-path38", "64S10-8,4,8-g17-path16", "64S7-8,4,8-g17-path106", "64S9-8,4,4-g13-path106", "64S8-8,4,4-g13-path16", "64S20-8,4,4-g13-path38" ];
