...
s`SolvableDBName := "32S14-4,8,4-g7-path13";
s`SolvableDBFilename := "32S14-4,8,4-g7-path13.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path33", "32S14-4,8,4-g7-path13" ];
