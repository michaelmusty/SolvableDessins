...
s`SolvableDBName := "32S17-16,4,16-g11-path3";
s`SolvableDBFilename := "32S17-16,4,16-g11-path3.m";
...
s`SolvableDBSanityCheckTiming := 0.610p15;
...
s`SolvableDBBelyiMap := KX!((x2^4 + 8*x2^2 + 16)/(16*x2^2));

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,2,8-g3-path3", "32S17-16,4,16-g11-path3" ];
s`SolvableDBParents := [ Strings() | "64S29-16,4,16-g21-path12", "64S44-16,4,16-g21-path74", "64S27-16,4,16-g21-path10" ];
