...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T6-8,8,4-g5-path3", "32S12-8,8,4-g9-path22" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path107", "64S15-8,8,8-g21-path107", "64S44-16,16,4-g21-path9", "64S45-16,16,8-g25-path9", "64S44-16,16,4-g21-path10", "64S45-16,16,8-g25-path10", "64S17-8,8,4-g17-path15" ];
s`SolvableDBChildren := [ Strings() | "16T6-8,8,4-g5-path3" ];
