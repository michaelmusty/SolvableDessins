...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path5", "32S10-4,4,8-g7-path7" ];
s`SolvableDBParents := [ Strings() | "64S13-4,8,8-g17-path15", "64S7-4,8,8-g17-path29", "64S14-4,8,8-g17-path15", "64S7-4,8,8-g17-path30", "64S9-4,4,8-g13-path63", "64S21-4,4,8-g13-path32", "64S9-4,4,8-g13-path64" ];
