...
s`SolvableDBName := "32S12-4,8,8-g9-path42";
s`SolvableDBFilename := "32S12-4,8,8-g9-path42.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path32", "32S12-4,8,8-g9-path42" ];
s`SolvableDBParents := [ Strings() | "64S44-8,16,16-g25-path37", "64S44-8,16,16-g25-path38", "64S45-4,16,16-g21-path37", "64S16-8,8,8-g21-path37", "64S45-4,16,16-g21-path38", "64S15-8,8,8-g21-path37", "64S17-4,8,8-g17-path37" ];
s`SolvableDBChildren := [ Strings() | "16T8-4,4,4-g3-path32" ];
