...
s`SolvableDBName := "32S5-8,2,8-g5-path11";
s`SolvableDBFilename := "32S5-8,2,8-g5-path11.m";
...
s`SolvableDBSanityCheckTiming := 2.380p15;
...
I<x1, x2, x3> := ideal< PX | [
x2^3 - 2*x1^2 + x2,
x1*x3^2 + 1/4*(nu - 1)*x2^2 + 1/4*(-nu + 1)
] >;
X<x1, x2, x3> := Curve(AA, I);
KX<x1, x2, x3> := FunctionField(X);
s`SolvableDBBelyiCurve := X;
s`SolvableDBBelyiMap := KX!(1/x3^8);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S5-8,2,8-g5-path11" ];
