...
s`SolvableDBName := "32S17-8,16,16-g13-path5";
s`SolvableDBFilename := "32S17-8,16,16-g13-path5.m";
...
{ IntegerRing() | 30, 32 }
@};
s`SolvableDBBelyiMapTiming := 3.420p15;
s`SolvableDBSanityCheckTiming := 3.500p15;
...
s`SolvableDBBelyiMap := KX!(1/2*x4^8*x2^3 - x4^16*x2^2 + 3/2*x4^8*x2 + x4^16);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-4,8,8-g5-path3", "32S17-8,16,16-g13-path5" ];
s`SolvableDBParents := [ Strings() | "64S27-8,16,16-g25-path10", "64S44-8,16,16-g25-path74", "64S29-8,16,16-g25-path28" ];
