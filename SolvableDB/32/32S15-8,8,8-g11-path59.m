...
s`SolvableDBName := "32S15-8,8,8-g11-path59";
s`SolvableDBFilename := "32S15-8,8,8-g11-path59.m";
...
s`SolvableDBSanityCheckTiming := 317.120p15;
s`SolvableDBLocalSanityCheckTiming := 5.520p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path6", "32S15-8,8,8-g11-path59" ];
