...
s`SolvableDBName := "32S17-16,8,16-g13-path13";
s`SolvableDBFilename := "32S17-16,8,16-g13-path13.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,4,8-g5-path7", "32S17-16,8,16-g13-path13" ];
s`SolvableDBParents := [ Strings() | "64S27-16,8,16-g25-path5", "64S44-16,8,16-g25-path69", "64S29-16,8,16-g25-path23" ];
