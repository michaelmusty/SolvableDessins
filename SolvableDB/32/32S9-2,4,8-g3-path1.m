...
phi := KX!((-x[1]^16 + 4*x[1]^12 + 10*x[1]^8 + 4*x[1]^4 - 1)/(16*x[1]^8));
/* assign to object */
...
s`SolvableDBName := "32S9-2,4,8-g3-path1";
s`SolvableDBFilename := "32S9-2,4,8-g3-path1.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 14, 23, 24, 11, 20, 21, 18, 17, 25, 15, 16, 26, 12, 13, 19, 22, 31, 30, 32, 28, 27, 29 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S9-2,4,8-g3-path1" ];
