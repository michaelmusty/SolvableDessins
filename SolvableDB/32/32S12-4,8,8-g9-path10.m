...
s`SolvableDBName := "32S12-4,8,8-g9-path10";
s`SolvableDBFilename := "32S12-4,8,8-g9-path10.m";
...
[ 6, 1, 17, 21, 15, 9, 20, 3, 2, 16, 5, 19, 10, 32, 28, 23, 27, 14, 4, 24, 12, 31, 13, 25, 7, 22, 8, 11, 18, 26, 30, 29 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-4,8,8-g5-path3", "32S12-4,8,8-g9-path10" ];
s`SolvableDBParents := [ Strings() | "64S44-8,16,16-g25-path1", "64S44-8,16,16-g25-path2", "64S45-4,16,16-g21-path1", "64S16-8,8,8-g21-path2", "64S45-4,16,16-g21-path2", "64S15-8,8,8-g21-path2", "64S17-4,8,8-g17-path2" ];
