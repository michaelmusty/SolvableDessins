...
s`SolvableDBName := "32S10-4,8,4-g7-path11";
s`SolvableDBFilename := "32S10-4,8,4-g7-path11.m";
...
s`SolvableDBSanityCheckTiming := 2.190p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path9", "32S10-4,8,4-g7-path11" ];
s`SolvableDBParents := [ Strings() | "64S7-4,8,8-g17-path39", "64S13-4,8,8-g17-path20", "64S7-4,8,8-g17-path40", "64S14-4,8,8-g17-path20", "64S9-4,8,4-g13-path5", "64S21-4,8,4-g13-path3", "64S9-4,8,4-g13-path6" ];
