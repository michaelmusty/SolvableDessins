...
[ 16, 8, 31, 15, 3, 17, 5, 18, 13, 22, 10, 11, 29, 24, 23, 14, 32, 4, 1, 6, 9, 20, 30, 28, 2, 19, 26, 27, 7, 25, 21, 12 ],
[ 12, 24, 11, 29, 25, 7, 32, 9, 4, 28, 21, 14, 6, 10, 19, 2, 1, 27, 30, 26, 22, 13, 5, 18, 31, 17, 15, 20, 23, 16, 8, 3 ]
]
];
...
\[ 2, 9, 10, 7, 11, 1, 12, 13, 6, 27, 28, 24, 17, 18, 5, 8, 16, 29, 25, 19, 20, 26, 3, 4, 21, 30, 23, 15, 32, 31, 22, 14 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path2", "32S12-4,8,8-g9-path14" ];
s`SolvableDBParents := [ Strings() | "64S44-8,16,16-g25-path33", "64S44-8,16,16-g25-path34", "64S45-4,16,16-g21-path33", "64S16-8,8,8-g21-path38", "64S45-4,16,16-g21-path34", "64S15-8,8,8-g21-path38", "64S17-4,8,8-g17-path38" ];
