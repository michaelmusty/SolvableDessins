...
s`SolvableDBName := "32S12-4,8,8-g9-path14";
s`SolvableDBFilename := "32S12-4,8,8-g9-path14.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path7", "32S12-4,8,8-g9-path14" ];
s`SolvableDBParents := [ Strings() | "64S44-8,16,16-g25-path9", "64S44-8,16,16-g25-path10", "64S45-4,16,16-g21-path9", "64S16-8,8,8-g21-path6", "64S45-4,16,16-g21-path10", "64S15-8,8,8-g21-path6", "64S17-4,8,8-g17-path6" ];
