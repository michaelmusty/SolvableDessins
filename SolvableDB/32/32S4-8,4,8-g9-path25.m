...
s`SolvableDBName := "32S4-8,4,8-g9-path25";
s`SolvableDBFilename := "32S4-8,4,8-g9-path25.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T6-8,4,8-g5-path5", "32S4-8,4,8-g9-path25" ];
