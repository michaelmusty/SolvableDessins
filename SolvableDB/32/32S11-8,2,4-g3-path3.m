...
s`SolvableDBName := "32S11-8,2,4-g3-path3";
s`SolvableDBFilename := "32S11-8,2,4-g3-path3.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S11-8,2,4-g3-path3" ];
s`SolvableDBParents := [ Strings() | "64S20-8,4,4-g13-path5", "64S6-8,2,8-g9-path16", "64S7-8,4,8-g17-path95", "64S9-8,4,4-g13-path73", "64S10-8,2,8-g9-path16", "64S11-8,4,8-g17-path27", "64S8-8,2,4-g5-path5" ];
