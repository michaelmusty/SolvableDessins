...
s`SolvableDBName := "32S10-4,4,8-g7-path24";
s`SolvableDBFilename := "32S10-4,4,8-g7-path24.m";
...
{ IntegerRing() | 29, 30 }
@};
s`SolvableDBBelyiMapTiming := 3.140p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T12-2,4,8-g2-path2", "32S10-4,4,8-g7-path24" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path25", "64S13-8,4,8-g17-path13", "64S7-8,4,8-g17-path26", "64S14-8,4,8-g17-path13", "64S9-4,4,8-g13-path33", "64S21-4,4,8-g13-path17", "64S9-4,4,8-g13-path34" ];
