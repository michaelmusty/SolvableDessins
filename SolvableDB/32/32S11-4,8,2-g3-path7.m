...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path5", "32S11-4,8,2-g3-path7" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,2-g9-path9", "64S20-4,8,4-g13-path20", "64S7-8,8,4-g17-path77", "64S10-8,8,2-g9-path9", "64S9-4,8,4-g13-path88", "64S11-8,8,4-g17-path9", "64S8-4,8,2-g5-path9" ];
