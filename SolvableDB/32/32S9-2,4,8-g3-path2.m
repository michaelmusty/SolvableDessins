...
s`SolvableDBName := "32S9-2,4,8-g3-path2";
s`SolvableDBFilename := "32S9-2,4,8-g3-path2.m";
...
s`SolvableDBBelyiMap := KX!((x1^16 + 56*x1^14 + 924*x1^12 + 3976*x1^10 + 6470*x1^8 + 3976*x1^6 + 924*x1^4 + 56*x1^2 + 1)/(x1^16 - 8*x1^14 + 28*x1^12 - 56*x1^10 + 70*x1^8 - 56*x1^6 + 28*x1^4 - 8*x1^2 + 1));

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path10", "32S9-2,4,8-g3-path2" ];
s`SolvableDBParents := [ Strings() | "64S8-4,4,8-g13-path54", "64S12-2,8,8-g9-path21", "64S6-4,8,8-g17-path78", "64S21-4,4,8-g13-path159", "64S6-2,8,8-g9-path78", "64S13-4,8,8-g17-path66", "64S38-2,4,16-g7-path16", "64S41-4,4,16-g15-path10", "64S42-2,8,16-g11-path10", "64S40-4,8,16-g19-path10", "64S41-2,4,16-g7-path10", "64S39-4,4,16-g15-path22", "64S40-2,8,16-g11-path10", "64S43-4,8,16-g19-path10", "64S8-2,4,8-g5-path32" ];
