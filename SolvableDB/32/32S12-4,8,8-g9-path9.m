...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path2", "32S12-4,8,8-g9-path9" ];
s`SolvableDBParents := [ Strings() | "64S44-8,16,16-g25-path45", "64S44-8,16,16-g25-path46", "64S45-4,16,16-g21-path45", "64S16-8,8,8-g21-path46", "64S45-4,16,16-g21-path46", "64S15-8,8,8-g21-path46", "64S17-4,8,8-g17-path46" ];
