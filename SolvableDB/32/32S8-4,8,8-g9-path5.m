...
s`SolvableDBName := "32S8-4,8,8-g9-path5";
s`SolvableDBFilename := "32S8-4,8,8-g9-path5.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S8-4,8,8-g9-path5" ];
s`SolvableDBParents := [ Strings() | "64S11-4,8,8-g17-path57", "64S5-4,8,8-g17-path81", "64S13-4,8,8-g17-path47", "64S13-4,8,8-g17-path48", "64S5-4,8,8-g17-path82", "64S11-4,8,8-g17-path58", "64S24-4,8,8-g17-path99" ];
