...
s`SolvableDBName := "32S17-16,16,8-g13-path3";
s`SolvableDBFilename := "32S17-16,16,8-g13-path3.m";
...
\[ 6, 1, 12, 23, 14, 24, 4, 15, 2, 3, 5, 7, 8, 31, 16, 18, 9, 20, 17, 21, 32, 28, 30, 22, 19, 10, 29, 27, 11, 13, 25, 26 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,4-g5-path7", "32S17-16,16,8-g13-path3" ];
s`SolvableDBParents := [ Strings() | "64S27-16,16,8-g25-path6", "64S44-16,16,8-g25-path70", "64S29-16,16,8-g25-path24" ];
