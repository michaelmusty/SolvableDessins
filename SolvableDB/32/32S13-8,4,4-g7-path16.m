...
{ IntegerRing() | 31, 32 }
@};
s`SolvableDBBelyiMapTiming := 2.050p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T8-4,4,4-g3-path4", "32S13-8,4,4-g7-path16" ];
