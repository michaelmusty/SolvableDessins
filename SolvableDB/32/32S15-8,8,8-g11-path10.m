...
\[ 6, 1, 12, 15, 17, 23, 4, 24, 2, 3, 5, 7, 8, 31, 30, 18, 9, 22, 26, 29, 10, 20, 11, 16, 19, 32, 28, 14, 13, 21, 25, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T8-4,4,4-g3-path13", "32S15-8,8,8-g11-path10" ];
s`SolvableDBParents := [ Strings() | "64S15-8,8,8-g21-path282", "64S16-8,8,8-g21-path282", "64S22-8,8,8-g21-path42" ];
