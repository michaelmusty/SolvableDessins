...
\[ 6, 1, 12, 15, 17, 23, 4, 24, 2, 3, 5, 7, 8, 31, 30, 18, 9, 22, 26, 29, 10, 20, 11, 16, 19, 32, 28, 14, 13, 21, 25, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T8-4,4,4-g3-path12", "32S15-8,8,8-g11-path12" ];
s`SolvableDBParents := [ Strings() | "64S15-8,8,8-g21-path287", "64S16-8,8,8-g21-path287", "64S22-8,8,8-g21-path47" ];
