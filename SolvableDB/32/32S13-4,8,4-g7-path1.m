...
{ IntegerRing() | 27, 31 }
@};
s`SolvableDBBelyiMapTiming := 1.39000000000000p15;
...
s`SolvableDBParents := [ Strings() | "64S46-8,16,4-g19-path1", "64S46-4,16,8-g19-path1", "64S15-8,8,8-g21-path25", "64S46-8,16,4-g19-path2", "64S46-4,16,8-g19-path2", "64S15-8,8,8-g21-path26", "64S21-4,8,4-g13-path7" ];
s`SolvableDBChild := "16T12-2,8,4-g2-path1";
