...
s`SolvableDBName := "32S3-4,8,8-g9-path15";
s`SolvableDBFilename := "32S3-4,8,8-g9-path15.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T4-4,4,4-g3-path9", "32S3-4,8,8-g9-path15" ];
s`SolvableDBParents := [ Strings() | "64S2-8,8,8-g21-path7", "64S3-8,8,8-g21-path7", "64S26-4,16,16-g21-path25", "64S26-8,16,16-g25-path25", "64S27-4,16,16-g21-path21", "64S27-8,16,16-g25-path21", "64S17-4,8,8-g17-path134" ];
