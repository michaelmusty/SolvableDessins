...
s`SolvableDBName := "32S12-8,4,8-g9-path44";
s`SolvableDBFilename := "32S12-8,4,8-g9-path44.m";
...
{ IntegerRing() | 30, 32 }
@};
s`SolvableDBBelyiMapTiming := 0.850p15;
s`SolvableDBSanityCheckTiming := 5.220p15;
...
[ 8, 13, 18, 1, 12, 22, 2, 24, 4, 30, 28, 9, 6, 25, 3, 27, 5, 31, 15, 16, 7, 11, 14, 17, 32, 29, 19, 21, 10, 23, 20, 26 ]
],
[ PermutationGroup<32 |  
\[ 2, 9, 8, 16, 11, 1, 25, 19, 21, 13, 24, 31, 26, 18, 29, 12, 3, 30, 4, 14, 5, 10, 22, 6, 28, 7, 32, 23, 27, 15, 17, 20 ],
\[ 3, 10, 14, 6, 16, 23, 1, 11, 19, 18, 25, 2, 24, 7, 17, 29, 21, 12, 30, 4, 26, 5, 20, 31, 27, 15, 8, 9, 22, 28, 32, 13 ],
...
I<x1, x2, x3> := ideal< PX | [
x2^2*x3^6 - 126583155195904/277098404709375*x2*x3^4 + 8589934592/281462092005375*nu*x1^3*x2 - 838417128229055758336/239885264685437119378125*x1^2*x3^2 - 1024/65535*x2^2*x3^2 + 3448016925097984/18445618199572250625*x1^2*x2 + 2881439070388662304768/239885264685437119378125*nu*x1*x3^2 - 2513255020116312064/4703632640890923909375*nu*x1*x2 + 579036811290279411712/44423197163969836921875*x3^2 + 30036579731302776832/4703632640890923909375*x2,
x1*x2*x3^4 + 1546/255*nu*x2*x3^4 + 33554432/858967245*nu*x1^2*x3^2 + 134217728/858967245*x1*x3^2 - 1024/65535*x1*x2 - 268435456/1431612075*nu*x3^2 - 1562624/16842495*nu*x2,
x1^3*x3^2 - 4294836225/8388608*nu*x2*x3^4 - 6*nu*x1^2*x3^2 - 16*x1*x3^2 + 16*nu*x3^2 + 65535/8192*nu*x2,
x1^4 - 16/257*nu*x1^3 - 65535/1024*x2*x3^2 - 96/257*x1^2 + 256/257*nu*x1 + 256/257
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T8-4,4,4-g3-path8", "32S12-8,4,8-g9-path44" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path85", "64S15-8,8,8-g21-path85", "64S45-16,4,16-g21-path39", "64S44-16,8,16-g25-path39", "64S45-16,4,16-g21-path40", "64S44-16,8,16-g25-path40", "64S17-8,4,8-g17-path39" ];
