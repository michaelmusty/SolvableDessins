...
s`SolvableDBName := "32S5-4,8,8-g9-path10";
s`SolvableDBFilename := "32S5-4,8,8-g9-path10.m";
...
{ IntegerRing() | 30, 32 }
@};
s`SolvableDBBelyiMapTiming := 4.640p15;
s`SolvableDBSanityCheckTiming := 7.090p15;
...
I<x1, x2, x3> := ideal< PX | [
x1^3*x3^2 - 1/2*x1*x2^2*x3^2 + 1/4*(-nu^3 + nu)*x1^2*x2^2 - x1^2*x3^2 + x1*x2*x3^2 - 1/2*x2^2*x3^2 + (-nu^3 + nu)*x1^3 + (-nu^3 + nu)*x1^2*x2 + 1/4*(-3*nu^3 + 3*nu)*x1*x2^2 - 1/2*x1*x3^2 - x2*x3^2 + 1/4*(-nu^3 + nu)*x1^2 + 1/2*(nu^3 - nu)*x1*x2 + 1/2*(nu^3 - nu)*x2^2 - 1/2*x3^2 + 1/4*(-nu^3 + nu)*x1 + 1/2*(-nu^3 + nu)*x2,
x1^2*x2*x3^2 - x1*x2^2*x3^2 + 1/2*x2^2*x3^2 + 1/2*(-nu^3 + nu)*x1^3 + 1/2*(-nu^3 + nu)*x1^2*x2 + 1/4*(-nu^3 + nu)*x1*x2^2 - x1*x3^2 + 1/2*(-nu^3 + nu)*x1^2 + 1/2*(nu^3 - nu)*x1*x2 + 1/2*(nu^3 - nu)*x2^2 - 1/2*x3^2 + 1/4*(-nu^3 + nu)*x1 + 1/2*(-nu^3 + nu)*x2,
x2^3 - 2*x1^2 - x2
] >;
