...
s`SolvableDBName := "32S12-4,8,8-g9-path37";
s`SolvableDBFilename := "32S12-4,8,8-g9-path37.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path29", "32S12-4,8,8-g9-path37" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path31", "64S44-4,16,16-g21-path29", "64S45-8,16,16-g25-path29", "64S44-4,16,16-g21-path30", "64S45-8,16,16-g25-path30", "64S15-8,8,8-g21-path31", "64S17-4,8,8-g17-path31" ];
