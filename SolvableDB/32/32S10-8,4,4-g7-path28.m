...
s`SolvableDBSanityCheckTiming := 1.460p15;
...
x2^2*x3^2 - 9/4*x1^3 - 9/4*x1*x3^2 - x2^2
] >;
...
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path47", "64S13-8,4,8-g17-path24", "64S7-8,4,8-g17-path48", "64S14-8,4,8-g17-path24", "64S9-8,4,4-g13-path41", "64S21-8,4,4-g13-path21", "64S9-8,4,4-g13-path42" ];
s`SolvableDBChildren := [ Strings() | "16T12-8,4,2-g2-path3" ];
