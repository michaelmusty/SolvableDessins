...
s`SolvableDBName := "32S19-2,4,16-g4-path1-notcomputed";
s`SolvableDBFilename := "32S19-2,4,16-g4-path1-notcomputed.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 17, 14, 15, 12, 13, 18, 11, 16, 21, 25, 19, 23, 22, 26, 20, 24, 29, 32, 27, 31, 30, 28 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T13-2,2,8-g0-path1-notcomputed", "32S19-2,4,16-g4-path1-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S39-4,4,16-g15-path1-notcomputed", "64S48-4,4,16-g15-path4-notcomputed", "64S38-2,4,16-g7-path2-notcomputed" ];
