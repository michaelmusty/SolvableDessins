...
s`SolvableDBName := "32S8-8,4,8-g9-path11";
s`SolvableDBFilename := "32S8-8,4,8-g9-path11.m";
...
s`SolvableDBSanityCheckTiming := 1.400p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S8-8,4,8-g9-path11" ];
s`SolvableDBParents := [ Strings() | "64S5-8,4,8-g17-path73", "64S11-8,4,8-g17-path49", "64S13-8,4,8-g17-path39", "64S13-8,4,8-g17-path40", "64S11-8,4,8-g17-path50", "64S5-8,4,8-g17-path74", "64S24-8,4,8-g17-path95" ];
