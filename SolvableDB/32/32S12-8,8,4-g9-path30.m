...
s`SolvableDBName := "32S12-8,8,4-g9-path30";
s`SolvableDBFilename := "32S12-8,8,4-g9-path30.m";
...
\[ 6, 1, 12, 15, 17, 23, 4, 24, 2, 3, 5, 7, 8, 31, 30, 18, 9, 22, 26, 28, 10, 20, 11, 16, 19, 32, 29, 13, 14, 21, 25, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T8-4,4,4-g3-path14", "32S12-8,8,4-g9-path30" ];
s`SolvableDBParents := [ Strings() | "64S44-16,16,8-g25-path21", "64S44-16,16,8-g25-path22", "64S45-16,16,4-g21-path21", "64S16-8,8,8-g21-path114", "64S45-16,16,4-g21-path22", "64S15-8,8,8-g21-path114", "64S17-8,8,4-g17-path22" ];
