...
s`SolvableDBName := "32S10-4,4,8-g7-path5";
s`SolvableDBFilename := "32S10-4,4,8-g7-path5.m";
...
\[ 2, 5, 9, 10, 6, 1, 4, 11, 15, 19, 12, 23, 21, 30, 22, 13, 26, 27, 7, 24, 31, 3, 8, 17, 18, 20, 29, 32, 25, 28, 16, 14 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path3", "32S10-4,4,8-g7-path5" ];
s`SolvableDBParents := [ Strings() | "64S13-4,8,8-g17-path17", "64S7-4,8,8-g17-path33", "64S14-4,8,8-g17-path17", "64S7-4,8,8-g17-path34", "64S9-4,4,8-g13-path67", "64S21-4,4,8-g13-path34", "64S9-4,4,8-g13-path68" ];
