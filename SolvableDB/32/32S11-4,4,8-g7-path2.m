...
s`SolvableDBName := "32S11-4,4,8-g7-path2";
s`SolvableDBFilename := "32S11-4,4,8-g7-path2.m";
...
s`SolvableDBLocalSanityCheckTiming := 0.810p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path10", "32S11-4,4,8-g7-path2" ];
s`SolvableDBParents := [ Strings() | "64S6-4,8,8-g17-path4", "64S11-4,8,8-g17-path26", "64S10-4,8,8-g17-path4", "64S7-4,8,8-g17-path94", "64S9-4,4,8-g13-path102", "64S8-4,4,8-g13-path12", "64S20-4,4,8-g13-path34" ];
