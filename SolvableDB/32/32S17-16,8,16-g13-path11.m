...
s`SolvableDBSanityCheckTiming := 521.370p15;
s`SolvableDBLocalSanityCheckTiming := 8.010p15;
...
x3^2*x5^4 + x5^4 + 2*x3^3 - 2*x2*x3 - 2*x4^2,
x2*x3*x4^2 - x1,
x3*x4^3 - x3^2*x5^2 + x3^2*x4 - x5^2 + x4,
x4^4 + x3^2 - x2,
x2^2*x3 - x1*x4^2 - x3,
x2*x3^2 - 1,
x1*x5^2 - x1*x4 - x2*x4 + x4,
x2*x5^2 - x1*x4 - x2*x4 + x5^2 - x4,
x4*x5^2 - x2*x3 - x4^2 + x3,
x1^2 - x2^2 + 1,
x1*x3 - x4^2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,4,8-g5-path6", "32S17-16,8,16-g13-path11" ];
s`SolvableDBParents := [ Strings() | "64S27-16,8,16-g25-path3", "64S44-16,8,16-g25-path67", "64S29-16,8,16-g25-path21" ];
