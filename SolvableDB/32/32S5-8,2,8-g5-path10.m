...
I<[x]> := ideal< P | [
x[2]*x[3]^4 - nu^2*x[2]^3 + x[1]*x[3]^2 - nu^2*x[2],
x[1]^2*x[3]^2 - 2*nu^2*x[1]*x[2] + nu^2*x[3]^2,
x[1]*x[2]*x[3]^2 - nu^2*x[2]^2 - nu^2,
...
s`SolvableDBName := "32S5-8,2,8-g5-path10";
s`SolvableDBFilename := "32S5-8,2,8-g5-path10.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 14, 31, 23, 20, 8, 30, 28, 10, 9, 27, 24, 11, 12, 13, 25, 26, 32, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path8", "32S5-8,2,8-g5-path10" ];
