...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path4", "32S11-4,8,2-g3-path6" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,2-g9-path8", "64S20-4,8,4-g13-path19", "64S7-8,8,4-g17-path76", "64S10-8,8,2-g9-path8", "64S9-4,8,4-g13-path87", "64S11-8,8,4-g17-path8", "64S8-4,8,2-g5-path8" ];
s`SolvableDBChildren := [ Strings() | "16T10-4,4,2-g1-path4" ];
