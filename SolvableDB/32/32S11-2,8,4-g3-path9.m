...
s`SolvableDBName := "32S11-2,8,4-g3-path9";
s`SolvableDBFilename := "32S11-2,8,4-g3-path9.m";
...
s`SolvableDBBelyiMap := KX!((x1^16 + 56*x1^14 + 924*x1^12 + 3976*x1^10 + 6470*x1^8 + 3976*x1^6 + 924*x1^4 + 56*x1^2 + 1)/(64*x1^14 + 896*x1^12 + 4032*x1^10 + 6400*x1^8 + 4032*x1^6 + 896*x1^4 + 64*x1^2));

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path7", "32S11-2,8,4-g3-path9" ];
s`SolvableDBParents := [ Strings() | "64S20-4,8,4-g13-path11", "64S6-2,8,8-g9-path22", "64S7-4,8,8-g17-path90", "64S9-4,8,4-g13-path79", "64S10-2,8,8-g9-path22", "64S11-4,8,8-g17-path22", "64S8-2,8,4-g5-path11" ];
