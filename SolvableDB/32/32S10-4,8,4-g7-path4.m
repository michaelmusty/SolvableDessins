...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S10-4,8,4-g7-path4" ];
s`SolvableDBParents := [ Strings() | "64S7-4,8,8-g17-path57", "64S13-4,8,8-g17-path29", "64S7-4,8,8-g17-path58", "64S14-4,8,8-g17-path29", "64S9-4,8,4-g13-path57", "64S21-4,8,4-g13-path29", "64S9-4,8,4-g13-path58" ];
