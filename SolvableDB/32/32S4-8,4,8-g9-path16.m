...
s`SolvableDBName := "32S4-8,4,8-g9-path16";
s`SolvableDBFilename := "32S4-8,4,8-g9-path16.m";
...
s`SolvableDBSanityCheckTiming := 12.150p15;
s`SolvableDBLocalSanityCheckTiming := 1.320p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T6-8,2,8-g3-path1", "32S4-8,4,8-g9-path16" ];
s`SolvableDBParents := [ Strings() | "64S28-16,8,16-g25-path15", "64S28-16,4,16-g21-path15", "64S3-8,8,8-g21-path152", "64S28-16,8,16-g25-path16", "64S28-16,4,16-g21-path16", "64S3-8,8,8-g21-path153", "64S17-8,4,8-g17-path164" ];
s`SolvableDBChildren := [ Strings() | "16T6-8,2,8-g3-path1" ];
