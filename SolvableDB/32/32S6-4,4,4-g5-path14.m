...
s`SolvableDBSanityCheckTiming := 0.560p15;
...
x1*x2*x4^2 - x1*x4^2 + 2*x3*x4^2 + x1*x2 + 2*x2*x3 + x1,
x2^2*x4^2 + x2^2 + 2*x1*x3 + x4^2 + 2*x2 - 1,
x1*x3*x4^2 - x2*x4^2 + x1*x3 + x4^2 + x2 - 1,
x2*x3*x4^2 - x1*x4^2 + x3*x4^2 + x2*x3 + x1 + x3,
x1^2 - x2^2 + 1,
x3^2 - x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S6-4,4,4-g5-path14" ];
s`SolvableDBParents := [ Strings() | "64S8-8,4,4-g13-path25", "64S8-4,4,8-g13-path28", "64S4-8,4,8-g17-path26", "64S9-8,4,4-g13-path137", "64S9-4,4,8-g13-path140", "64S5-8,4,8-g17-path60", "64S32-8,4,4-g13-path3", "64S32-4,4,8-g13-path6", "64S36-8,4,8-g17-path3", "64S33-8,4,4-g13-path25", "64S33-4,4,8-g13-path28", "64S37-8,4,8-g17-path14", "64S23-4,4,4-g9-path282", "64S34-4,4,4-g9-path6", "64S35-4,4,4-g9-path39" ];
