...
s`SolvableDBName := "32S11-8,2,4-g3-path11";
s`SolvableDBFilename := "32S11-8,2,4-g3-path11.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 14, 32, 23, 20, 8, 31, 27, 10, 9, 26, 11, 12, 13, 24, 30, 28, 25, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path2", "32S11-8,2,4-g3-path11" ];
s`SolvableDBParents := [ Strings() | "64S20-8,4,4-g13-path10", "64S6-8,2,8-g9-path21", "64S7-8,4,8-g17-path100", "64S9-8,4,4-g13-path78", "64S10-8,2,8-g9-path21", "64S11-8,4,8-g17-path32", "64S8-8,2,4-g5-path10" ];
