...
s`SolvableDBName := "32S15-8,8,8-g11-path54";
s`SolvableDBFilename := "32S15-8,8,8-g11-path54.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path33", "32S15-8,8,8-g11-path54" ];
s`SolvableDBParents := [ Strings() | "64S15-8,8,8-g21-path290", "64S16-8,8,8-g21-path290", "64S22-8,8,8-g21-path50" ];
