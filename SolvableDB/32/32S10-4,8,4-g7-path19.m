...
\[ 20, 5, 25, 24, 6, 30, 4, 23, 12, 16, 8, 1, 11, 29, 14, 22, 7, 27, 26, 9, 31, 28, 13, 17, 19, 3, 21, 10, 32, 2, 18, 15 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path2", "32S10-4,8,4-g7-path19" ];
s`SolvableDBParents := [ Strings() | "64S7-8,8,4-g17-path17", "64S13-8,8,4-g17-path9", "64S7-8,8,4-g17-path18", "64S14-8,8,4-g17-path9", "64S9-4,8,4-g13-path23", "64S21-4,8,4-g13-path12", "64S9-4,8,4-g13-path24" ];
