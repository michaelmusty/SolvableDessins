...
I<[x]> := ideal< P | [
x[2]^4*x[3]^2 - 20*x[2]^3*x[3]^2 - 2*x[1]^2*x[2]^2 + 1/2*x[1]*x[2]^3 - 96*x[1]*x[2]*x[3]^2 + 112*x[2]^2*x[3]^2 + 24*x[1]^2*x[2] - 10*x[1]*x[2]^2 + 4*x[2]^3 - 128*x[2]*x[3]^2 + 48*x[1]^2 - 24*x[1]*x[2] - 32*x[2]^2 + 64*x[1],
x[1]*x[2]^2*x[3]^2 + x[2]^3*x[3]^2 + 4*x[1]*x[2]*x[3]^2 - 6*x[2]^2*x[3]^2 - 3/2*x[1]^2*x[2] + 1/2*x[1]*x[2]^2 + 8*x[2]*x[3]^2 - 2*x[1]^2 + x[1]*x[2] + 2*x[2]^2 - 4*x[1],
x[1]^2*x[3]^2 + x[1]*x[2]*x[3]^2 + 1/2*x[2]^2*x[3]^2 - 2*x[2]*x[3]^2 - 1/2*x[1]^2 + 1/4*x[1]*x[2] + 4*x[3]^2 + x[1] + 1/2*x[2],
x[1]^3 - x[2]^2 + 4*x[1]
] >;
...
\[ 11, 30, 12, 7, 2, 5, 10, 21, 18, 26, 9, 22, 16, 13, 32, 23, 8, 1, 24, 3, 25, 20, 14, 31, 17, 4, 19, 29, 15, 6, 27, 28 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path4", "32S10-4,4,8-g7-path6" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path1", "64S13-8,4,8-g17-path1", "64S7-8,4,8-g17-path2", "64S14-8,4,8-g17-path1", "64S9-4,4,8-g13-path1", "64S21-4,4,8-g13-path1", "64S9-4,4,8-g13-path2" ];
