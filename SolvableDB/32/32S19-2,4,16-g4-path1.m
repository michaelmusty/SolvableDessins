...
s`SolvableDBName := "32S19-2,4,16-g4-path1";
s`SolvableDBFilename := "32S19-2,4,16-g4-path1.m";
...
s`SolvableDBParents := [ Strings() | "64S39-4,4,16-g15-path1", "64S48-4,4,16-g15-path4", "64S38-2,4,16-g7-path2" ];
