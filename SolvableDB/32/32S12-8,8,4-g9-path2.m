...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T5-8,8,2-g3-path2", "32S12-8,8,4-g9-path2" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path104", "64S15-8,8,8-g21-path104", "64S44-16,16,4-g21-path3", "64S45-16,16,8-g25-path3", "64S44-16,16,4-g21-path4", "64S45-16,16,8-g25-path4", "64S17-8,8,4-g17-path12" ];
