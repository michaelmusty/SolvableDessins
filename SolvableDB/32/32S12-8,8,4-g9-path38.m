...
s`SolvableDBName := "32S12-8,8,4-g9-path38";
s`SolvableDBFilename := "32S12-8,8,4-g9-path38.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path17", "32S12-8,8,4-g9-path38" ];
s`SolvableDBParents := [ Strings() | "64S44-16,16,8-g25-path33", "64S44-16,16,8-g25-path34", "64S45-16,16,4-g21-path33", "64S16-8,8,8-g21-path124", "64S45-16,16,4-g21-path34", "64S15-8,8,8-g21-path124", "64S17-8,8,4-g17-path32" ];
