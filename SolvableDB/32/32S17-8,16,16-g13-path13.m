...
s`SolvableDBName := "32S17-8,16,16-g13-path13";
s`SolvableDBFilename := "32S17-8,16,16-g13-path13.m";
...
x3*x4^4 - 2*x2*x3^3 + 2*x1*x4^2 - 2*x1*x3,
x2^2*x3^2 - x2*x3^2 + x3*x4^2 - x1*x2 + x1,
x1^2*x4^2 - 2*x1^2*x3 + 2*x2^2*x3 - 2*x2*x3 + 2*x4^2,
x1*x3*x4^2 - 2*x2^2 + 2*x2,
x2^3 - x1^2 + x2,
x1*x3^2 - x2^2 + 1,
x2*x4^2 - 2*x2*x3 + x4^2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path7", "32S17-8,16,16-g13-path13" ];
s`SolvableDBParents := [ Strings() | "64S27-8,16,16-g25-path5", "64S44-8,16,16-g25-path69", "64S29-8,16,16-g25-path23" ];
