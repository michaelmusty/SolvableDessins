...
\[ 6, 1, 24, 25, 15, 9, 4, 16, 2, 3, 5, 7, 8, 27, 32, 17, 13, 14, 21, 18, 22, 26, 31, 29, 12, 19, 20, 23, 10, 28, 30, 11 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T4-4,4,4-g3-path3", "32S4-4,8,8-g9-path2" ];
s`SolvableDBParents := [ Strings() | "64S3-8,8,8-g21-path112", "64S28-4,16,16-g21-path25", "64S28-8,16,16-g25-path25", "64S3-8,8,8-g21-path113", "64S28-4,16,16-g21-path26", "64S28-8,16,16-g25-path26", "64S17-4,8,8-g17-path169" ];
