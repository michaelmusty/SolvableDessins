...
s`SolvableDBName := "32S10-8,4,4-g7-path31";
s`SolvableDBFilename := "32S10-8,4,4-g7-path31.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T14-8,4,4-g4-path2", "32S10-8,4,4-g7-path31" ];
s`SolvableDBParents := [ Strings() | "64S7-8,4,8-g17-path53", "64S13-8,4,8-g17-path27", "64S7-8,4,8-g17-path54", "64S14-8,4,8-g17-path27", "64S9-8,4,4-g13-path49", "64S21-8,4,4-g13-path25", "64S9-8,4,4-g13-path50" ];
