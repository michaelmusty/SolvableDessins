...
s`SolvableDBName := "32S10-4,8,4-g7-path21";
s`SolvableDBFilename := "32S10-4,8,4-g7-path21.m";
...
s`SolvableDBSanityCheckTiming := 36.600p15;
...
x1*x2*x4^2 + (nu - 1)*x2 - nu - 1,
x2^2*x4^2 - nu*x2*x4^2 + (nu - 1)*x1,
x3^2*x4^2 - x1*x3^2 + (nu + 1)*x2*x4^2 + x4^2 + x1,
x2*x3^2 - x3^2 - x2 - 1,
x1^2 - x2^2 - 1
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S10-4,8,4-g7-path21" ];
s`SolvableDBParents := [ Strings() | "64S7-8,8,4-g17-path19", "64S13-8,8,4-g17-path10", "64S7-8,8,4-g17-path20", "64S14-8,8,4-g17-path10", "64S9-4,8,4-g13-path27", "64S21-4,8,4-g13-path14", "64S9-4,8,4-g13-path28" ];
