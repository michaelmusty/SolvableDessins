...
I<[x]> := ideal< P | [
x[1]^6 + x[1]^5 + 8*x[1]^4 - 1/2*x[2]^2*x[3]^2 + 8*x[1]^3 + 15*x[1]^2 + 1/2*x[2]^2 + 8*x[3]^2 + 15*x[1] + 8,
x[2]^2*x[3]^4 - 4*x[1]^5 - 8*x[1]^4 - 2*x[2]^2*x[3]^2 - 16*x[3]^4 - 40*x[1]^3 - 72*x[1]^2 + x[2]^2 - 96*x[3]^2 - 132*x[1] - 80,
x[1]*x[3]^2 - x[3]^2 - x[1] - 1
] >;
...
s`SolvableDBName := "32S17-16,2,16-g7-path1";
s`SolvableDBFilename := "32S17-16,2,16-g7-path1.m";
...
\[ 6, 1, 4, 17, 12, 18, 13, 2, 3, 5, 7, 15, 14, 16, 26, 25, 28, 27, 9, 10, 8, 11, 19, 20, 31, 29, 32, 30, 21, 22, 23, 24 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,2,8-g3-path4", "32S17-16,2,16-g7-path1" ];
s`SolvableDBParents := [ Strings() | "64S44-16,4,16-g21-path12", "64S27-16,4,16-g21-path1", "64S29-16,2,16-g13-path4" ];
