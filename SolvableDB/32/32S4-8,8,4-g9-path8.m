...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 28, 9, 17, 30, 14, 21, 31, 22, 12, 32, 13, 27, 11, 19, 20, 23, 10, 29, 18 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T4-4,4,4-g3-path14", "32S4-8,8,4-g9-path8" ];
s`SolvableDBParents := [ Strings() | "64S3-8,8,8-g21-path222", "64S28-16,16,4-g21-path35", "64S28-16,16,8-g25-path35", "64S3-8,8,8-g21-path223", "64S28-16,16,4-g21-path36", "64S28-16,16,8-g25-path36", "64S17-8,8,4-g17-path174" ];
