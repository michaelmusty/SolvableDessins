...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T10-2,4,4-g1-path4", "32S11-4,4,8-g7-path6" ];
s`SolvableDBParents := [ Strings() | "64S6-4,8,8-g17-path8", "64S11-4,8,8-g17-path30", "64S10-4,8,8-g17-path8", "64S7-4,8,8-g17-path98", "64S9-4,4,8-g13-path109", "64S8-4,4,8-g13-path19", "64S20-4,4,8-g13-path41" ];
