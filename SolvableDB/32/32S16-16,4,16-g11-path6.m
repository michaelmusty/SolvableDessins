...
s`SolvableDBName := "32S16-16,4,16-g11-path6";
s`SolvableDBFilename := "32S16-16,4,16-g11-path6.m";
...
\[ 6, 1, 4, 16, 13, 17, 15, 7, 2, 3, 5, 8, 14, 25, 23, 26, 27, 11, 9, 10, 12, 18, 24, 32, 29, 30, 31, 20, 19, 21, 22, 28 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,2,8-g3-path6", "32S16-16,4,16-g11-path6" ];
s`SolvableDBParents := [ Strings() | "64S50-32,8,32-g27-path15", "64S51-32,8,32-g27-path11", "64S50-32,8,32-g27-path16", "64S51-32,8,32-g27-path12", "64S44-16,4,16-g21-path61", "64S26-16,4,16-g21-path15", "64S29-16,4,16-g21-path6" ];
