...
s`SolvableDBName := "32S11-8,4,4-g7-path14";
s`SolvableDBFilename := "32S11-8,4,4-g7-path14.m";
...
s`SolvableDBSanityCheckTiming := 1759.920p15;
s`SolvableDBLocalSanityCheckTiming := 5.390p15;
...
[ 3, 10, 14, 19, 16, 21, 1, 6, 18, 17, 5, 25, 2, 7, 28, 32, 13, 30, 31, 4, 27, 9, 26, 23, 15, 29, 8, 12, 24, 22, 20, 11 ],
[ 25, 26, 6, 29, 10, 16, 20, 30, 21, 1, 27, 18, 32, 13, 24, 19, 22, 2, 3, 11, 23, 15, 31, 17, 5, 12, 7, 14, 8, 4, 9, 28 ]
],
[ PermutationGroup<32 |  
\[ 12, 23, 8, 26, 2, 5, 31, 18, 6, 7, 21, 9, 16, 17, 29, 4, 30, 13, 1, 32, 24, 25, 19, 10, 11, 28, 14, 3, 27, 20, 22, 15 ],
\[ 3, 10, 14, 19, 16, 21, 1, 6, 18, 17, 5, 25, 2, 7, 28, 32, 13, 30, 31, 4, 27, 9, 26, 23, 15, 29, 8, 12, 24, 22, 20, 11 ],
...
x1*x2*x4^2 + (-nu^3 - 5*nu)*x1 + 2,
x2^2*x4^2 + 1/2*(-nu^3 - 5*nu)*x1*x4^2 - x4^2 + (-nu^3 - 5*nu)*x2,
x3^2*x4^2 + 1/2*(-nu^3 - 5*nu)*x1*x3^2 + 1/2*(-nu^3 - 5*nu)*x1*x4^2 + 1/2*(nu^3 + 5*nu)*x2*x4^2 + 2*x3^2 + 1/2*(nu^3 + 5*nu)*x1,
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S11-8,4,4-g7-path14" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,4-g17-path14", "64S11-8,8,4-g17-path36", "64S10-8,8,4-g17-path14", "64S7-8,8,4-g17-path104", "64S9-8,4,4-g13-path96", "64S8-8,4,4-g13-path6", "64S20-8,4,4-g13-path28" ];
