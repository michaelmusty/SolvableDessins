...
\[ 3, 7, 1, 9, 8, 12, 2, 5, 4, 16, 17, 6, 15, 20, 13, 10, 11, 24, 25, 14, 23, 28, 21, 18, 19, 30, 32, 22, 31, 26, 29, 27 ],
\[ 4, 8, 12, 13, 7, 1, 16, 17, 3, 2, 5, 20, 21, 6, 9, 24, 25, 10, 11, 28, 29, 14, 15, 30, 32, 18, 19, 26, 27, 22, 23, 31 ] >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T13-2,2,8-g0-path1", "32S18-2,2,16-g0-path2" ];
s`SolvableDBParents := [ Strings() | "64S38-4,2,16-g7-path1", "64S38-2,4,16-g7-path1", "64S47-4,4,16-g15-path18", "64S52-2,2,32-g0-path1", "64S53-4,2,32-g8-path1", "64S53-2,4,32-g8-path1", "64S54-4,4,32-g16-path1" ];
