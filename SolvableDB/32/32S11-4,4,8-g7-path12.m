...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path1", "32S11-4,4,8-g7-path12" ];
s`SolvableDBParents := [ Strings() | "64S6-8,4,8-g17-path1", "64S7-8,4,8-g17-path80", "64S10-8,4,8-g17-path1", "64S11-8,4,8-g17-path12", "64S20-4,4,8-g13-path26", "64S8-4,4,8-g13-path4", "64S9-4,4,8-g13-path94" ];
