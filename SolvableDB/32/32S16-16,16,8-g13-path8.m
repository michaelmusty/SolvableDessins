...
s`SolvableDBName := "32S16-16,16,8-g13-path8";
s`SolvableDBFilename := "32S16-16,16,8-g13-path8.m";
...
\[ 27, 17, 28, 14, 16, 9, 23, 19, 20, 26, 29, 4, 30, 31, 12, 24, 21, 3, 11, 5, 13, 8, 32, 2, 10, 6, 25, 7, 18, 1, 22, 15 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,4-g5-path7", "32S16-16,16,8-g13-path8" ];
s`SolvableDBParents := [ Strings() | "64S50-32,32,16-g29-path15", "64S51-32,32,16-g29-path7", "64S50-32,32,16-g29-path16", "64S51-32,32,16-g29-path8", "64S29-16,16,8-g25-path4", "64S26-16,16,8-g25-path4", "64S44-16,16,8-g25-path50" ];
