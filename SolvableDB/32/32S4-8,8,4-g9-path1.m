...
s`SolvableDBName := "32S4-8,8,4-g9-path1";
s`SolvableDBFilename := "32S4-8,8,4-g9-path1.m";
...
{ IntegerRing() | 23, 28 }
@};
s`SolvableDBBelyiMapTiming := 1.330p15;
s`SolvableDBSanityCheckTiming := 6.150p15;
...
I<x1, x2, x3> := ideal< PX | [
x1^2*x3^4 - nu^3*x2*x3^4 + 2*nu^2*x1^4 + 2*nu^2*x1*x2*x3^2 + nu^2*x3^4 - 2*nu*x1^2*x2 + 4*nu*x1*x3^2 - 2*x1^2 + 4*nu^3*x2 + 4*nu^2,
x1*x2*x3^4 + 2*nu^3*x1^2*x2*x3^2 - 2*nu^2*x1^3*x2 + 4*nu^2*x1^2*x3^2 - 4*nu*x1^3 + 2*nu*x2*x3^2 - 4*x1*x2 + 4*nu^3*x1,
x2^2*x3^4 + 2*nu^3*x1^4*x2 + 2*nu^3*x1*x2^2*x3^2 + nu^3*x2*x3^4 - 2*nu^2*x1^2*x2^2 + 2*nu*x1^2*x2 - 4*nu*x1*x3^2 + 4*x1^2 - 2*x2^2 - 2*nu^3*x2 - 4*nu^2,
x1^5 + nu^3*x1^2*x3^2 - 2*nu^2*x1^3 + nu^2*x2*x3^2 - nu*x1*x2 - nu*x3^2 - x1,
x1^3*x3^2 + nu^3*x1^4 + nu^2*x1*x3^2 - x2 + nu^3
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T4-4,4,4-g3-path1", "32S4-8,8,4-g9-path1" ];
s`SolvableDBParents := [ Strings() | "64S3-8,8,8-g21-path188", "64S28-16,16,4-g21-path1", "64S28-16,16,8-g25-path1", "64S3-8,8,8-g21-path189", "64S28-16,16,4-g21-path2", "64S28-16,16,8-g25-path2", "64S17-8,8,4-g17-path157" ];
