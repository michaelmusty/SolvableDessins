...
s`SolvableDBName := "32S17-8,16,16-g13-path6";
s`SolvableDBFilename := "32S17-8,16,16-g13-path6.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-4,8,8-g5-path3", "32S17-8,16,16-g13-path6" ];
s`SolvableDBParents := [ Strings() | "64S27-8,16,16-g25-path11", "64S29-8,16,16-g25-path29", "64S44-8,16,16-g25-path75" ];
