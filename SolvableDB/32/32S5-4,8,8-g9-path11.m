...
s`SolvableDBSanityCheckTiming := 1.660p15;
...
I<x1, x2, x3> := ideal< PX | [
x1^3*x3^2 + 1/2*(-2*nu + 1)*x1*x2^2*x3^2 - 1/4*x1^2*x2^2 - nu*x1*x2*x3^2 + 1/4*(-2*nu + 1)*x1^2*x2 + 1/2*x1*x3^2 + 1/4*(2*nu - 1)*x1^2 + 1/8*x2^2 + 1/8,
x1^2*x2*x3^2 + (-2*nu + 1)*x1^2*x3^2 - nu*x2^2*x3^2 - 1/2*x1^3 + 1/4*(-2*nu + 1)*x1*x2^2 + nu*x2*x3^2 + 1/2*nu*x1*x2 + 1/4*x1,
x2^3 - 2*x1^2 + x2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path9", "32S5-4,8,8-g9-path11" ];
s`SolvableDBParents := [ Strings() | "64S29-8,16,16-g25-path37", "64S31-8,16,16-g25-path9", "64S31-8,16,16-g25-path10", "64S30-8,16,16-g25-path5", "64S31-8,16,16-g25-path11", "64S29-8,16,16-g25-path38", "64S30-8,16,16-g25-path6", "64S31-8,16,16-g25-path12", "64S7-4,8,8-g17-path163", "64S6-4,8,8-g17-path27", "64S5-4,8,8-g17-path26", "64S6-4,8,8-g17-path28", "64S17-4,8,8-g17-path207", "64S4-4,8,8-g17-path3", "64S7-4,8,8-g17-path164" ];
