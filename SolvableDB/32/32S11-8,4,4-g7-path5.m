...
s`SolvableDBName := "32S11-8,4,4-g7-path5";
s`SolvableDBFilename := "32S11-8,4,4-g7-path5.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S11-8,4,4-g7-path5" ];
s`SolvableDBParents := [ Strings() | "64S6-8,4,8-g17-path18", "64S11-8,4,8-g17-path40", "64S10-8,4,8-g17-path18", "64S7-8,4,8-g17-path108", "64S9-8,4,4-g13-path108", "64S8-8,4,4-g13-path18", "64S20-8,4,4-g13-path40" ];
