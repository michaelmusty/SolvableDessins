...
s`SolvableDBName := "32S16-16,8,16-g13-path18";
s`SolvableDBFilename := "32S16-16,8,16-g13-path18.m";
...
s`SolvableDBSanityCheckTiming := 21.630p15;
s`SolvableDBLocalSanityCheckTiming := 4.070p15;
...
x1^2*x4^2 - x1*x2*x3 + 2*x2*x4^2,
x2^2*x4^2 - x1*x3 + x4^2,
x2^3 - x1^2 - x2,
x1*x3^2 - x2^2 - 1,
x3*x4^2 - 1
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,4,8-g5-path7", "32S16-16,8,16-g13-path18" ];
s`SolvableDBParents := [ Strings() | "64S50-32,16,32-g29-path27", "64S51-32,16,32-g29-path19", "64S50-32,16,32-g29-path28", "64S51-32,16,32-g29-path20", "64S29-16,8,16-g25-path10", "64S26-16,8,16-g25-path10", "64S44-16,8,16-g25-path56" ];
