...
s`SolvableDBName := "32S17-16,16,4-g11-path3-notcomputed";
s`SolvableDBFilename := "32S17-16,16,4-g11-path3-notcomputed.m";
...
\[ 6, 1, 17, 14, 16, 13, 8, 3, 2, 4, 5, 7, 25, 15, 27, 24, 23, 10, 9, 11, 12, 18, 31, 26, 32, 29, 30, 20, 19, 21, 22, 28 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-4,4,2-g1-path4-notcomputed", "16T5-8,8,2-g3-path3-notcomputed", "32S17-16,16,4-g11-path3-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S29-16,16,4-g21-path3-notcomputed", "64S44-16,16,4-g21-path13-notcomputed", "64S27-16,16,4-g21-path2-notcomputed" ];
