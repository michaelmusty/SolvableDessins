...
s`SolvableDBName := "32S2-4,4,4-g5-path63";
s`SolvableDBFilename := "32S2-4,4,4-g5-path63.m";
...
\[ 12, 30, 17, 7, 2, 5, 27, 16, 20, 28, 13, 9, 24, 3, 18, 10, 25, 32, 4, 1, 26, 11, 15, 22, 14, 31, 19, 8, 21, 6, 29, 23 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T8-4,4,4-g3-path24", "32S2-4,4,4-g5-path63" ];
