...
s`SolvableDBName := "32S13-4,8,4-g7-path1-notcomputed";
s`SolvableDBFilename := "32S13-4,8,4-g7-path1-notcomputed.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 29, 13, 9, 31, 24, 25, 10, 26, 27, 15, 12, 20, 32, 17, 16, 18, 30, 14, 21, 28 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T4-2,4,2-g0-path2-notcomputed", "16T12-2,8,4-g2-path1-notcomputed", "32S13-4,8,4-g7-path1-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S46-8,16,4-g19-path5-notcomputed", "64S46-4,16,8-g19-path5-notcomputed", "64S15-8,8,8-g21-path26-notcomputed", "64S46-8,16,4-g19-path6-notcomputed", "64S46-4,16,8-g19-path6-notcomputed", "64S15-8,8,8-g21-path27-notcomputed", "64S21-4,8,4-g13-path8-notcomputed" ];
