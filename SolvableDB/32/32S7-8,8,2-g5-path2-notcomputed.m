...
s`SolvableDBName := "32S7-8,8,2-g5-path2-notcomputed";
s`SolvableDBFilename := "32S7-8,8,2-g5-path2-notcomputed.m";
...
\[ 6, 1, 20, 21, 18, 22, 4, 2, 3, 5, 7, 32, 23, 30, 28, 25, 31, 8, 16, 15, 29, 10, 17, 9, 11, 12, 13, 14, 19, 24, 26, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T2-4,4,2-g1-path1-notcomputed", "16T10-4,4,2-g1-path3-notcomputed", "32S7-8,8,2-g5-path2-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S4-8,8,4-g17-path5-notcomputed", "64S24-8,8,4-g17-path6-notcomputed", "64S10-8,8,4-g17-path3-notcomputed", "64S14-8,8,4-g17-path6-notcomputed", "64S4-8,8,2-g9-path5-notcomputed", "64S12-8,8,2-g9-path1-notcomputed", "64S10-8,8,2-g9-path3-notcomputed" ];
