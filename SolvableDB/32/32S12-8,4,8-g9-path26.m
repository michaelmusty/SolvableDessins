...
I<[x]> := ideal< P | [
x[1]^3*x[3]^2 - x[1]^2*x[3]^2 - 3*x[1]*x[3]^2 - x[3]^2 - x[2],
x[2]*x[3]^4 + 2*x[1]^2*x[3]^2 + 8*x[1]*x[3]^2 + x[1]*x[2] + 2*x[3]^2 + 2*x[2],
x[1]^4 + x[1]^3 + x[2]*x[3]^2 - 3*x[1]^2 + x[1]
] >;
...
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path52", "64S15-8,8,8-g21-path52", "64S45-16,4,16-g21-path7", "64S44-16,8,16-g25-path7", "64S45-16,4,16-g21-path8", "64S44-16,8,16-g25-path8", "64S17-8,4,8-g17-path6" ];
