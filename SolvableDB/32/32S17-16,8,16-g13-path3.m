...
s`SolvableDBName := "32S17-16,8,16-g13-path3";
s`SolvableDBFilename := "32S17-16,8,16-g13-path3.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path2", "32S17-16,8,16-g13-path3" ];
s`SolvableDBParents := [ Strings() | "64S27-16,8,16-g25-path8", "64S44-16,8,16-g25-path72", "64S29-16,8,16-g25-path26" ];
