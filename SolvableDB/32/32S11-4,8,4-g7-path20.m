...
s`SolvableDBName := "32S11-4,8,4-g7-path20";
s`SolvableDBFilename := "32S11-4,8,4-g7-path20.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path7", "32S11-4,8,4-g7-path20" ];
s`SolvableDBParents := [ Strings() | "64S6-8,8,4-g17-path9", "64S7-8,8,4-g17-path88", "64S10-8,8,4-g17-path9", "64S11-8,8,4-g17-path20", "64S20-4,8,4-g13-path35", "64S8-4,8,4-g13-path13", "64S9-4,8,4-g13-path103" ];
