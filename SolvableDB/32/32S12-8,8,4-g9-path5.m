...
s`SolvableDBName := "32S12-8,8,4-g9-path5";
s`SolvableDBFilename := "32S12-8,8,4-g9-path5.m";
...
s`SolvableDBSanityCheckTiming := 6.210p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,2-g3-path5", "32S12-8,8,4-g9-path5" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path134", "64S15-8,8,8-g21-path134", "64S44-16,16,4-g21-path41", "64S45-16,16,8-g25-path41", "64S44-16,16,4-g21-path42", "64S45-16,16,8-g25-path42", "64S17-8,8,4-g17-path42" ];
