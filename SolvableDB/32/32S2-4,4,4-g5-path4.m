...
s`SolvableDBName := "32S2-4,4,4-g5-path4";
s`SolvableDBFilename := "32S2-4,4,4-g5-path4.m";
...
\[ 2, 5, 9, 10, 6, 1, 4, 11, 15, 19, 12, 23, 21, 29, 22, 13, 26, 27, 7, 24, 30, 3, 8, 17, 18, 20, 31, 32, 28, 16, 25, 14 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path4", "32S2-4,4,4-g5-path4" ];
