...
s`SolvableDBName := "32S11-8,4,4-g7-path6";
s`SolvableDBFilename := "32S11-8,4,4-g7-path6.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S11-8,4,4-g7-path6" ];
s`SolvableDBParents := [ Strings() | "64S6-8,4,8-g17-path19", "64S11-8,4,8-g17-path41", "64S10-8,4,8-g17-path19", "64S7-8,4,8-g17-path109", "64S9-8,4,4-g13-path109", "64S8-8,4,4-g13-path19", "64S20-8,4,4-g13-path41" ];
