...
I<[x]> := ideal< P | [
x[1]^2*x[2]*x[3]^2 - 2*x[1]*x[2]*x[3]^2 - x[2]*x[3]^2 - 2*x[1]^2 - x[2]^2,
x[1]*x[2]^2*x[3]^2 - x[1]^2*x[3]^2 - 2*x[2]^2*x[3]^2 - x[1]^2*x[2] - 2*x[1]*x[2] + x[3]^2 + x[2],
...
s`SolvableDBName := "32S10-4,4,8-g7-path10";
s`SolvableDBFilename := "32S10-4,4,8-g7-path10.m";
...
s`SolvableDBLocalSanityCheckTiming := 0.580p15;
...
\[ 2, 5, 9, 10, 6, 1, 4, 11, 15, 19, 12, 23, 21, 30, 22, 13, 26, 27, 7, 24, 31, 3, 8, 17, 18, 20, 29, 32, 25, 28, 16, 14 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path7", "32S10-4,4,8-g7-path10" ];
s`SolvableDBParents := [ Strings() | "64S13-4,8,8-g17-path1", "64S7-4,8,8-g17-path1", "64S14-4,8,8-g17-path1", "64S7-4,8,8-g17-path2", "64S9-4,4,8-g13-path1", "64S21-4,4,8-g13-path1", "64S9-4,4,8-g13-path2" ];
