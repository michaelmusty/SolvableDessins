...
s`SolvableDBName := "32S4-4,8,8-g9-path15";
s`SolvableDBFilename := "32S4-4,8,8-g9-path15.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T4-4,4,4-g3-path9", "32S4-4,8,8-g9-path15" ];
s`SolvableDBParents := [ Strings() | "64S3-8,8,8-g21-path100", "64S28-4,16,16-g21-path13", "64S28-8,16,16-g25-path13", "64S3-8,8,8-g21-path101", "64S28-4,16,16-g21-path14", "64S28-8,16,16-g25-path14", "64S17-4,8,8-g17-path163" ];
