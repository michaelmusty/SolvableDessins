...
s`SolvableDBName := "32S4-8,4,8-g9-path11";
s`SolvableDBFilename := "32S4-8,4,8-g9-path11.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T4-4,4,4-g3-path5", "32S4-8,4,8-g9-path11" ];
s`SolvableDBParents := [ Strings() | "64S28-16,8,16-g25-path5", "64S28-16,4,16-g21-path5", "64S3-8,8,8-g21-path142", "64S28-16,8,16-g25-path6", "64S28-16,4,16-g21-path6", "64S3-8,8,8-g21-path143", "64S17-8,4,8-g17-path159" ];
