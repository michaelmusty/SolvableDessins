...
s`SolvableDBSanityCheckTiming := 389.300p15;
...
s`SolvableDBParents := [ Strings() | "64S22-8,8,8-g21-path3", "64S16-8,8,8-g21-path243", "64S15-8,8,8-g21-path243" ];
