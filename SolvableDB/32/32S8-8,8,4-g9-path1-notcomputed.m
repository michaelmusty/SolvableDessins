...
s`SolvableDBName := "32S8-8,8,4-g9-path1-notcomputed";
s`SolvableDBFilename := "32S8-8,8,4-g9-path1-notcomputed.m";
...
\[ 6, 1, 22, 23, 20, 24, 8, 25, 2, 3, 4, 5, 7, 21, 28, 26, 11, 14, 27, 9, 31, 19, 13, 12, 17, 29, 16, 30, 10, 32, 15, 18 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T4-2,4,2-g0-path2-notcomputed", "16T10-4,4,2-g1-path4-notcomputed", "32S8-8,8,4-g9-path1-notcomputed" ];
s`SolvableDBParents := [ Strings() | "64S5-8,8,4-g17-path9-notcomputed", "64S11-8,8,4-g17-path5-notcomputed", "64S13-8,8,4-g17-path7-notcomputed", "64S13-8,8,4-g17-path8-notcomputed", "64S11-8,8,4-g17-path6-notcomputed", "64S5-8,8,4-g17-path10-notcomputed", "64S24-8,8,4-g17-path7-notcomputed" ];
