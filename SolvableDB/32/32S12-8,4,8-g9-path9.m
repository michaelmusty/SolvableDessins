...
s`SolvableDBName := "32S12-8,4,8-g9-path9";
s`SolvableDBFilename := "32S12-8,4,8-g9-path9.m";
...
\[ 6, 1, 23, 13, 15, 24, 4, 16, 2, 3, 5, 7, 8, 22, 30, 17, 29, 14, 20, 21, 10, 28, 31, 27, 19, 9, 32, 11, 12, 18, 25, 26 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path2", "32S12-8,4,8-g9-path9" ];
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path87", "64S15-8,8,8-g21-path87", "64S45-16,4,16-g21-path41", "64S44-16,8,16-g25-path41", "64S45-16,4,16-g21-path42", "64S44-16,8,16-g25-path42", "64S17-8,4,8-g17-path41" ];
