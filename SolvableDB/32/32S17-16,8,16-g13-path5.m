...
I<[x]> := ideal< P | [
x[2]*x[4]^4 - 8*x[3]*x[4]^2 - x[1]^2 - 4*x[1],
x[3]*x[4]^4 - x[1]*x[3]^3 - 2*x[3]^3 + 1/4*x[1]*x[4]^2 - 1/4*x[2]*x[3] - 1/2*x[4]^2,
x[1]*x[2]*x[3]^2 + 2*x[2]*x[3]^2 - 8*x[3]*x[4]^2 - x[1]^2 - 2*x[1],
x[2]^2*x[3]^2 - 8*x[1]*x[3]^2 - x[1]*x[2],
x[1]^2*x[4]^2 - x[1]*x[2]*x[3] - 2*x[2]*x[3] + 4*x[4]^2,
x[1]*x[2]*x[4]^2 - x[2]^2*x[3] - 2*x[2]*x[4]^2 + 8*x[1]*x[3],
x[1]*x[3]*x[4]^2 - 2*x[3]*x[4]^2 - x[1],
x[2]*x[3]*x[4]^2 - 2*x[1]*x[3]^2 - 4*x[3]^2 - x[2],
x[1]^3 - x[2]^2 + 4*x[1],
x[1]^2*x[3] - x[2]*x[4]^2 + 2*x[1]*x[3]
] >;
...
s`SolvableDBName := "32S17-16,8,16-g13-path5";
s`SolvableDBFilename := "32S17-16,8,16-g13-path5.m";
...
\[ 6, 1, 23, 13, 15, 24, 4, 16, 2, 3, 5, 7, 8, 26, 31, 17, 32, 14, 20, 21, 10, 29, 30, 28, 19, 9, 22, 27, 11, 12, 18, 25 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,4,8-g5-path6", "32S17-16,8,16-g13-path5" ];
s`SolvableDBParents := [ Strings() | "64S27-16,8,16-g25-path9", "64S44-16,8,16-g25-path73", "64S29-16,8,16-g25-path27" ];
s`SolvableDBChild := "16T5-8,4,8-g5-path6";
