...
s`SolvableDBSanityCheckTiming := 0.480p15;
...
s`SolvableDBBelyiMap := KX!(-x4^8/2*x2^3 + x4^16*x2^2 + 3*x4^8/2*x2 + x4^16 + 1);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,4,8-g5-path3", "32S17-16,8,16-g13-path5" ];
