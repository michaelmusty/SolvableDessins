...
I<[x]> := ideal< P | [
x[2]^2*x[3]^4 + 4*x[3]^4 + x[1]^2*x[2],
x[1]^3*x[2] + x[2]^2*x[3]^2 + 4*x[3]^2,
x[1]*x[3]^2 - 1
] >;
...
phi := KX!((16*x[3]^16 + 8*x[3]^8 + 1)/(16*x[3]^8));
/* assign to object */
...
s`SolvableDBParents := [ Strings() | "64S16-8,8,8-g21-path19", "64S16-8,8,8-g21-path20", "64S47-4,4,16-g15-path1", "64S49-8,8,16-g23-path1", "64S48-4,4,16-g15-path1", "64S49-8,8,16-g23-path2", "64S21-4,4,8-g13-path10" ];
