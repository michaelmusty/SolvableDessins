...
x[4]^2 + 1/10*(-nu^7 - 3*nu^5 + 3*nu^3 - nu)*x[1]
] >;
...
phi := KX!(1/390625*(2292*nu^6 + 5712*nu^4 - 10356*nu^2 + 8959)*x[4]^16/(x[4]^32 + 1/781250*(2292*nu^6 + 5712*nu^4 - 10356*nu^2 + 8959)*x[4]^16 + 1/2441406250000*(-77238888*nu^6 + 204341088*nu^4 - 211742616*nu^2 + 95108641)));
/* assign to object */
...
s`SolvableDBName := "128S65-16,8,2-g21-path4";
s`SolvableDBFilename := "128S65-16,8,2-g21-path4.m";
...
{ IntegerRing() | 119, 124 }
@};
s`SolvableDBBelyiMapTiming := 22.810p15;
...
\[ 6, 1, 21, 22, 19, 23, 13, 2, 3, 4, 5, 7, 53, 55, 14, 52, 56, 57, 54, 58, 59, 60, 61, 38, 39, 8, 9, 10, 11, 12, 15, 16, 17, 18, 20, 24, 25, 99, 50, 42, 102, 43, 103, 40, 41, 84, 92, 74, 104, 105, 96, 90, 100, 101, 91, 83, 106, 98, 107, 108, 109, 87, 88, 35, 34, 26, 27, 28, 29, 30, 31, 32, 33, 36, 37, 44, 45, 46, 47, 48, 49, 51, 62, 63, 64, 65, 125, 122, 82, 120, 97, 89, 86, 85, 67, 126, 114, 124, 127, 128, 66, 81, 123, 73, 119, 80, 121, 70, 69, 68, 71, 72, 75, 76, 77, 78, 79, 93, 94, 95, 112, 117, 111, 113, 115, 116, 118, 110 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T13-8,2,2-g0-path1", "32S9-8,4,2-g3-path5", "64S6-8,8,2-g9-path13", "128S65-16,8,2-g21-path4" ];
s`SolvableDBParents := [ Strings() | "256S58-16,16,4-g81-path7", "256S378-32,16,2-g53-path1", "256S377-32,8,4-g77-path1", "256S58-16,16,2-g49-path7", "256S166-16,8,4-g73-path13", "256S377-32,8,2-g45-path1", "256S379-32,16,4-g85-path1", "256S62-16,16,4-g81-path7", "256S378-32,16,2-g53-path2", "256S377-32,8,4-g77-path2", "256S62-16,16,2-g49-path7", "256S109-16,8,4-g73-path21", "256S377-32,8,2-g45-path2", "256S379-32,16,4-g85-path2", "256S100-16,8,2-g41-path10" ];
