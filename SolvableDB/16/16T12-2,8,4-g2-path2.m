...
/* Belyi curve */
K := Rationals();
X<[x]> := HyperellipticCurve([Polynomial(K, [ 1, 0, -5, 0, -5, 0, 1 ]), Polynomial(K, [])]);
...
\[ 10, 5, 15, 6, 2, 4, 9, 13, 7, 1, 12, 11, 8, 16, 3, 14 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T12-2,8,4-g2-path2" ];
