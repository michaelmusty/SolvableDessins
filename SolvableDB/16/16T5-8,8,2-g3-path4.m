...
\[ 9, 11, 14, 16, 2, 5, 13, 6, 8, 3, 15, 4, 12, 7, 1, 10 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T5-8,8,2-g3-path4" ];
s`SolvableDBParents := [ Strings() | "32S3-8,8,4-g9-path18", "32S12-8,8,4-g9-path3", "32S16-16,16,2-g7-path5", "32S16-16,16,4-g11-path5", "32S17-16,16,2-g7-path3", "32S17-16,16,4-g11-path3", "32S5-8,8,2-g5-path14" ];
