...
s`SolvableDBName := "16T5-8,4,8-g5-path3-notcomputed";
s`SolvableDBFilename := "16T5-8,4,8-g5-path3-notcomputed.m";
...
\[ 6, 1, 4, 12, 13, 15, 14, 7, 2, 3, 5, 8, 9, 16, 11, 10 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T2-2,2,2-g0-path3-notcomputed", "8T2-4,2,4-g1-path5-notcomputed", "16T5-8,4,8-g5-path3-notcomputed" ];
s`SolvableDBParents := [ Strings() | "32S16-16,8,16-g13-path3-notcomputed", "32S17-16,8,16-g13-path1-notcomputed", "32S16-16,8,16-g13-path4-notcomputed", "32S17-16,8,16-g13-path2-notcomputed", "32S12-8,4,8-g9-path4-notcomputed", "32S3-8,4,8-g9-path7-notcomputed", "32S5-8,4,8-g9-path4-notcomputed" ];
