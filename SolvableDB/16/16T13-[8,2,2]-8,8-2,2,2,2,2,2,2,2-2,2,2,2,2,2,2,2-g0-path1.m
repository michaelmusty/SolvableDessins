...
s`SolvableDBName := "16T13-[8,2,2]-8,8-2,2,2,2,2,2,2,2-2,2,2,2,2,2,2,2-g0-path1";
s`SolvableDBFilename := "16T13-[8,2,2]-8,8-2,2,2,2,2,2,2,2-2,2,2,2,2,2,2,2-g0-path1.m";
...
x0 - x1^2 - 1,
x1*x2 - x1*x4^4 + nu2*x2 + nu2*x4^4,
x1*x4^8 - x1 - nu2*x4^8 - nu2,
x2*x4^4 - 1,
x3 - x4^2
] >);
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-[1,2,2]-11-2-2-g0-path1", "4T2-[2,2,2]-22-22-22-g0-path1", "8T4-[4,2,2]-44-2222-2222-g0-path1", "16T13-[8,2,2]-8,8-2,2,2,2,2,2,2,2-2,2,2,2,2,2,2,2-g0-path1" ];
