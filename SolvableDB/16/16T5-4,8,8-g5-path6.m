...
x1*x3^2 - x2^2 + 1,
x2^4 - x2^3*x3^4 - 2*x2^2 - x2*x3^4 + 1
] >;
X<x1, x2, x3> := Curve(AA, I);
KX<x1, x2, x3> := FunctionField(X);
s`SolvableDBBelyiCurve := X;
s`SolvableDBBelyiMap := KX!(x3^4/4*x2^3 - x3^8/4*x2^2 - 3*x3^4/4*x2 - x3^8/4);

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path6" ];
s`SolvableDBParents := [ Strings() | "32S16-8,16,16-g13-path14", "32S17-8,16,16-g13-path10", "32S16-8,16,16-g13-path15", "32S17-8,16,16-g13-path11", "32S12-4,8,8-g9-path14", "32S3-4,8,8-g9-path29", "32S5-4,8,8-g9-path18" ];
