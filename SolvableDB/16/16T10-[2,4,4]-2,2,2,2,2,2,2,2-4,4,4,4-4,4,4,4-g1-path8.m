...
\[ 1, 2, 16, 3, 9, 6, 4, 11, 5, 14, 12, 15, 13, 10, 8, 7 ],
...
x0 + 1/4*x2^2 + 1/4*x3^4 - 1/2,
x1*x2 - F.1^2*x1*x4^2 + x2 - F.1^2,
x1*x3^2 - F.1^2*x1*x4^2 - x3^2 - F.1^2,
x1*x4^4 + x1 + 2*x4^2,
x2*x3^2 - 1,
x2*x4^2 - x2 + F.1^2*x4^2 + F.1^2,
x3^2*x4^2 + x3^2 - F.1^2*x4^2 + F.1^2
] >;
