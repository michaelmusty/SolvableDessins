...
s`SolvableDBName := "16T12-2,4,8-g2-path1";
s`SolvableDBFilename := "16T12-2,4,8-g2-path1.m";
...
s`SolvableDBParents := [ Strings() | "32S13-4,4,8-g7-path1", "32S10-4,4,8-g7-path23", "32S9-2,4,8-g3-path12" ];
