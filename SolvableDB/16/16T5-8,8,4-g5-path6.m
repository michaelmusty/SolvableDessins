...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path6" ];
s`SolvableDBParents := [ Strings() | "32S16-16,16,8-g13-path15", "32S17-16,16,8-g13-path11", "32S16-16,16,8-g13-path16", "32S17-16,16,8-g13-path12", "32S12-8,8,4-g9-path13", "32S3-8,8,4-g9-path28", "32S5-8,8,4-g9-path17" ];
