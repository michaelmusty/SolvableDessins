...
/* Belyi curve */
K := Rationals();
X<[x]> := HyperellipticCurve([Polynomial(K, [ 0, 1, 0, -6, 0, 0, 0, 6, 0, -1 ]), Polynomial(K, [])]);
...
s`SolvableDBName := "16T14-4,8,4-g4-path2";
s`SolvableDBFilename := "16T14-4,8,4-g4-path2.m";
...
\[ 6, 1, 15, 10, 2, 5, 4, 7, 3, 8, 14, 11, 9, 16, 13, 12 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T14-4,8,4-g4-path2" ];
s`SolvableDBParents := [ Strings() | "32S10-4,8,4-g7-path31", "32S14-4,8,4-g7-path5", "32S10-4,8,4-g7-path32" ];
