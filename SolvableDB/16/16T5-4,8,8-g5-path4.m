...
\[ 6, 1, 8, 7, 2, 5, 14, 12, 3, 4, 13, 9, 15, 10, 16, 11 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-4,8,8-g5-path4" ];
s`SolvableDBParents := [ Strings() | "32S16-8,16,16-g13-path13", "32S17-8,16,16-g13-path9", "32S16-8,16,16-g13-path14", "32S17-8,16,16-g13-path10", "32S12-4,8,8-g9-path12", "32S3-4,8,8-g9-path27", "32S5-4,8,8-g9-path16" ];
