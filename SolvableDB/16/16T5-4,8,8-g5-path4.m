...
s`SolvableDBName := "16T5-4,8,8-g5-path4";
s`SolvableDBFilename := "16T5-4,8,8-g5-path4.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-4,8,8-g5-path4" ];
s`SolvableDBParents := [ Strings() | "32S16-8,16,16-g13-path10", "32S17-8,16,16-g13-path6", "32S16-8,16,16-g13-path11", "32S17-8,16,16-g13-path7", "32S12-4,8,8-g9-path12", "32S3-4,8,8-g9-path27", "32S5-4,8,8-g9-path16" ];
