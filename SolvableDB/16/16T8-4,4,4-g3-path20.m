...
\[ 2, 5, 9, 7, 6, 1, 8, 10, 13, 4, 14, 11, 15, 16, 3, 12 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T8-4,4,4-g3-path20" ];
s`SolvableDBParents := [ Strings() | "32S12-8,4,8-g9-path25", "32S14-4,8,4-g7-path7", "32S15-8,8,8-g11-path17", "32S12-8,4,8-g9-path26", "32S13-4,8,4-g7-path7", "32S15-8,8,8-g11-path18", "32S2-4,4,4-g5-path57" ];
