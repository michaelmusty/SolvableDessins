...
s`SolvableDBParents := [ Strings() | "32S12-8,4,8-g9-path29", "32S14-4,8,4-g7-path9", "32S15-8,8,8-g11-path24", "32S12-8,4,8-g9-path30", "32S13-4,8,4-g7-path9", "32S15-8,8,8-g11-path25", "32S2-4,4,4-g5-path61" ];
