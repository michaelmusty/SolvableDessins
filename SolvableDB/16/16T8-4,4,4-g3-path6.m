...
s`SolvableDBParents := [ Strings() | "32S12-8,4,8-g9-path39", "32S14-4,8,4-g7-path14", "32S15-8,8,8-g11-path59", "32S12-8,4,8-g9-path40", "32S13-4,8,4-g7-path14", "32S15-8,8,8-g11-path60", "32S2-4,4,4-g5-path78" ];
