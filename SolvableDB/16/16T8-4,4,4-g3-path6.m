...
\[ 10, 16, 11, 7, 2, 5, 8, 15, 14, 9, 12, 13, 3, 1, 4, 6 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T8-4,4,4-g3-path6" ];
s`SolvableDBParents := [ Strings() | "32S12-8,4,8-g9-path33", "32S14-4,8,4-g7-path11", "32S15-8,8,8-g11-path25", "32S12-8,4,8-g9-path34", "32S13-4,8,4-g7-path11", "32S15-8,8,8-g11-path26", "32S2-4,4,4-g5-path61" ];
