...
s`SolvableDBName := "16T6-8,8,4-g5-path2";
s`SolvableDBFilename := "16T6-8,8,4-g5-path2.m";
...
{ IntegerRing() | 12, 16 }
@};
s`SolvableDBBelyiMapTiming := 0.880p15;
...
\[ 11, 13, 4, 7, 2, 5, 16, 10, 6, 12, 9, 3, 15, 8, 1, 14 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T6-8,8,4-g5-path2" ];
