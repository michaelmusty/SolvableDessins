...
s`SolvableDBParents := [ Strings() | "32S14-8,4,4-g7-path3", "32S12-4,8,8-g9-path8", "32S15-8,8,8-g11-path3", "32S13-8,4,4-g7-path3", "32S12-4,8,8-g9-path9", "32S15-8,8,8-g11-path4", "32S2-4,4,4-g5-path14" ];
