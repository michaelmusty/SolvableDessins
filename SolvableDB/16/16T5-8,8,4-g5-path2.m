...
s`SolvableDBName := "16T5-8,8,4-g5-path2";
s`SolvableDBFilename := "16T5-8,8,4-g5-path2.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,4-g5-path2" ];
s`SolvableDBParents := [ Strings() | "32S16-16,16,8-g13-path6", "32S17-16,16,8-g13-path2", "32S16-16,16,8-g13-path7", "32S17-16,16,8-g13-path3", "32S12-8,8,4-g9-path10", "32S3-8,8,4-g9-path25", "32S5-8,8,4-g9-path14" ];
