...
phi := KX!((-x[1]^8 + 4*x[1]^6 - 6*x[1]^4 + 4*x[1]^2 - 1)/(16*x[1]^6 + 32*x[1]^4 + 16*x[1]^2));
/* assign to object */
...
\[ 2, 5, 9, 7, 6, 1, 10, 3, 12, 14, 13, 8, 16, 4, 11, 15 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T8-4,4,4-g3-path4" ];
s`SolvableDBParents := [ Strings() | "32S14-8,4,4-g7-path11", "32S12-4,8,8-g9-path33", "32S15-8,8,8-g11-path31", "32S13-8,4,4-g7-path11", "32S12-4,8,8-g9-path34", "32S15-8,8,8-g11-path32", "32S2-4,4,4-g5-path64" ];
s`SolvableDBChild := "8T2-2,4,4-g1-path3";
