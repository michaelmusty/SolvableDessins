...
s`SolvableDBName := "16T5-4,8,8-g5-path7";
s`SolvableDBFilename := "16T5-4,8,8-g5-path7.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path7" ];
s`SolvableDBParents := [ Strings() | "32S16-8,16,16-g13-path17", "32S17-8,16,16-g13-path13", "32S16-8,16,16-g13-path18", "32S17-8,16,16-g13-path14", "32S12-4,8,8-g9-path14", "32S3-4,8,8-g9-path29", "32S5-4,8,8-g9-path18" ];
