...
s`SolvableDBName := "16T5-8,4,8-g5-path1";
s`SolvableDBFilename := "16T5-8,4,8-g5-path1.m";
...
s`SolvableDBParents := [ Strings() | "32S16-16,8,16-g13-path2", "32S17-16,8,16-g13-path1", "32S16-16,8,16-g13-path3", "32S12-8,4,8-g9-path8", "32S3-8,4,8-g9-path23", "32S5-8,4,8-g9-path12", "32S16-16,8,16-g13-path4", "32S16-16,8,16-g13-path5", "32S12-8,4,8-g9-path9", "32S3-8,4,8-g9-path24", "32S5-8,4,8-g9-path13" ];
