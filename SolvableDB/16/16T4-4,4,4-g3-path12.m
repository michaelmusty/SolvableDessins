...
s`SolvableDBName := "16T4-4,4,4-g3-path12";
s`SolvableDBFilename := "16T4-4,4,4-g3-path12.m";
...
\[ 11, 13, 8, 7, 2, 5, 16, 10, 14, 12, 9, 3, 6, 1, 4, 15 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T4-4,4,4-g3-path12" ];
s`SolvableDBParents := [ Strings() | "32S3-8,4,8-g9-path4", "32S3-4,8,8-g9-path4", "32S3-8,8,4-g9-path4", "32S4-8,4,8-g9-path4", "32S4-4,8,8-g9-path4", "32S4-8,8,4-g9-path4", "32S2-4,4,4-g5-path37" ];
