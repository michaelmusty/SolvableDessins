...
{ IntegerRing() | 13, 16 }
@};
s`SolvableDBBelyiMapTiming := 0.600p15;
...
\[ 2, 5, 9, 7, 6, 1, 10, 3, 12, 14, 13, 8, 15, 4, 16, 11 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T6-4,8,8-g5-path3" ];
s`SolvableDBParents := [ Strings() | "32S5-4,8,8-g9-path20", "32S12-4,8,8-g9-path21", "32S4-4,8,8-g9-path22" ];
