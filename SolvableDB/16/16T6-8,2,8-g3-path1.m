...
phi := KX!((x[1]^12 + x[1]^8 - x[1]^4 - 1)/(4*x[1]^8)*x[2] + (-x[1]^12 + x[1]^8 - 3*x[1]^4 - 1)/(4*x[1]^8));
/* assign to object */
...
s`SolvableDBName := "16T6-8,2,8-g3-path1";
s`SolvableDBFilename := "16T6-8,2,8-g3-path1.m";
...
\[ 6, 1, 4, 11, 12, 16, 13, 2, 3, 5, 7, 8, 14, 15, 9, 10 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T6-8,2,8-g3-path1" ];
