...
s`SolvableDBParents := [ Strings() | "32S3-4,8,8-g9-path19", "32S12-4,8,8-g9-path4", "32S16-2,16,16-g7-path6", "32S16-4,16,16-g11-path5", "32S17-2,16,16-g7-path4", "32S17-4,16,16-g11-path4", "32S5-2,8,8-g5-path15" ];
