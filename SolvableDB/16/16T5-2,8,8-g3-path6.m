...
s`SolvableDBName := "16T5-2,8,8-g3-path6";
s`SolvableDBFilename := "16T5-2,8,8-g3-path6.m";
...
s`SolvableDBBelyiMap := KX!((-x1^12 + 2*x1^8 + 4*x1^4 - 8)/(16*x1^8)*x2 + (-3*x1^12 + 14*x1^8 - 20*x1^4 + 8)/(16*x1^8));

/*
Graph Data
*/

s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-2,8,8-g3-path6" ];
s`SolvableDBParents := [ Strings() | "32S3-4,8,8-g9-path21", "32S12-4,8,8-g9-path6", "32S16-2,16,16-g7-path8", "32S16-4,16,16-g11-path8", "32S17-2,16,16-g7-path6", "32S17-4,16,16-g11-path6", "32S5-2,8,8-g5-path17" ];
