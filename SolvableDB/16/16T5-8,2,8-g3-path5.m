...
{ IntegerRing() | 10, 14 }
@};
s`SolvableDBBelyiMapTiming := 0.230000000000000p15;
s`SolvableDBSanityCheckTiming := 0.0600000000000000p15;
...
s`SolvableDBParents := [ Strings() | "32S3-8,4,8-g9-path20", "32S12-8,4,8-g9-path5", "32S16-16,2,16-g7-path7", "32S16-16,4,16-g11-path6", "32S17-16,2,16-g7-path5", "32S17-16,4,16-g11-path5", "32S5-8,2,8-g5-path16" ];
