...
\[ 6, 1, 11, 13, 12, 16, 4, 2, 3, 5, 7, 8, 14, 15, 9, 10 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T6-8,8,2-g3-path5" ];
s`SolvableDBParents := [ Strings() | "32S12-8,8,4-g9-path15", "32S4-8,8,4-g9-path16", "32S5-8,8,2-g5-path19" ];
