...
s`SolvableDBParents := [ Strings() | "32S12-8,4,8-g9-path43", "32S14-4,8,4-g7-path16", "32S15-8,8,8-g11-path62", "32S12-8,4,8-g9-path44", "32S13-4,8,4-g7-path16", "32S15-8,8,8-g11-path63", "32S2-4,4,4-g5-path80" ];
