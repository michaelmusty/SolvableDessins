...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-[2,1,2]-2-11-2-g0-path1", "4T2-[2,2,2]-22-22-22-g0-path2", "8T2-[4,4,2]-44-44-2222-g1-path8", "16T10-[4,4,2]-4,4,4,4-4,4,4,4-2,2,2,2,2,2,2,2-g1-path8" ];
s`SolvableDBChildren := [ Strings() | "8T2-[4,4,2]-44-44-2222-g1-path8" ];
