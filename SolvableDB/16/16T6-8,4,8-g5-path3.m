...
s`SolvableDBName := "16T6-8,4,8-g5-path3";
s`SolvableDBFilename := "16T6-8,4,8-g5-path3.m";
...
{ IntegerRing() | 12, 16 }
@};
s`SolvableDBBelyiMapTiming := 0.420000000000000p15;
s`SolvableDBSanityCheckTiming := 0.410000000000000p15;
s`SolvableDBLocalSanityCheckTiming := 0.260000000000000p15;
...
x1 - x3^2,
x2^2 - x3^2*x4^4 + x3^2 + x4^4 + 1,
x2*x3 - x3^2*x4^2 + x4^2,
x2*x4^2 - x3^3 - x3,
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T6-8,4,8-g5-path3" ];
s`SolvableDBParents := [ Strings() | "32S5-8,4,8-g9-path21", "32S12-8,4,8-g9-path22", "32S4-8,4,8-g9-path23" ];
