...
\[ 11, 16, 4, 7, 2, 5, 14, 10, 15, 12, 9, 13, 8, 3, 1, 6 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T8-4,4,4-g3-path13" ];
s`SolvableDBParents := [ Strings() | "32S12-8,8,4-g9-path31", "32S14-4,4,8-g7-path10", "32S15-8,8,8-g11-path9", "32S12-8,8,4-g9-path32", "32S13-4,4,8-g7-path10", "32S15-8,8,8-g11-path10", "32S2-4,4,4-g5-path53" ];
