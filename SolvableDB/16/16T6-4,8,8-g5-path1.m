...
phi := KX!(x[3]^6/4*x[2]^3 + (-x[3]^12 + x[3]^4)/4*x[2]^2 + x[3]^10*x[2] - 3*x[3]^8/4);
/* assign to object */
...
\[ 2, 5, 9, 7, 6, 1, 10, 3, 12, 14, 13, 8, 15, 4, 16, 11 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T6-4,8,8-g5-path1" ];
