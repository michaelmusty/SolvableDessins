...
s`SolvableDBName := "16T8-4,4,4-g3-path18";
s`SolvableDBFilename := "16T8-4,4,4-g3-path18.m";
...
\[ 2, 5, 4, 7, 6, 1, 9, 10, 3, 12, 13, 14, 15, 8, 16, 11 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path18" ];
s`SolvableDBParents := [ Strings() | "32S12-8,8,4-g9-path45", "32S14-4,4,8-g7-path17", "32S15-8,8,8-g11-path61", "32S12-8,8,4-g9-path46", "32S13-4,4,8-g7-path17", "32S15-8,8,8-g11-path62", "32S2-4,4,4-g5-path79" ];
