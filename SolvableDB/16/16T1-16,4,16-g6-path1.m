...
s`SolvableDBBelyiMap := KX!((x3^20 + 2*x3^12)*x2^2 + (4*x3^18 + 8*x3^10 - 2*x3^2)*x2 + 4*x3^16 + 12*x3^8 + 1);
...
s`SolvableDBParents := [ Strings() | "32S1-32,8,32-g14-path1", "32S16-16,4,16-g11-path1" ];
