...
s`SolvableDBParents := [ Strings() | "32S12-8,8,4-g9-path25", "32S14-4,4,8-g7-path7", "32S15-8,8,8-g11-path1", "32S12-8,8,4-g9-path26", "32S13-4,4,8-g7-path7", "32S15-8,8,8-g11-path2", "32S2-4,4,4-g5-path49" ];
