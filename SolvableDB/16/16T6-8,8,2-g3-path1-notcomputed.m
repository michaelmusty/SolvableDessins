...
s`SolvableDBName := "16T6-8,8,2-g3-path1-notcomputed";
s`SolvableDBFilename := "16T6-8,8,2-g3-path1-notcomputed.m";
...
\[ 6, 1, 11, 13, 12, 16, 4, 2, 3, 5, 7, 8, 14, 15, 9, 10 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-4,4,2-g1-path4-notcomputed", "16T6-8,8,2-g3-path1-notcomputed" ];
s`SolvableDBParents := [ Strings() | "32S12-8,8,4-g9-path6-notcomputed", "32S4-8,8,4-g9-path4-notcomputed", "32S5-8,8,2-g5-path7-notcomputed" ];
