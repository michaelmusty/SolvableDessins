...
\[ 2, 5, 9, 7, 6, 1, 10, 3, 12, 14, 13, 8, 16, 4, 11, 15 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T8-4,4,4-g3-path3" ];
s`SolvableDBParents := [ Strings() | "32S14-8,4,4-g7-path12", "32S12-4,8,8-g9-path35", "32S15-8,8,8-g11-path33", "32S13-8,4,4-g7-path12", "32S12-4,8,8-g9-path36", "32S15-8,8,8-g11-path34", "32S2-4,4,4-g5-path65" ];
