...
s`SolvableDBParents := [ Strings() | "32S14-8,4,4-g7-path14", "32S12-4,8,8-g9-path39", "32S15-8,8,8-g11-path44", "32S13-8,4,4-g7-path14", "32S12-4,8,8-g9-path40", "32S15-8,8,8-g11-path45", "32S2-4,4,4-g5-path71" ];
