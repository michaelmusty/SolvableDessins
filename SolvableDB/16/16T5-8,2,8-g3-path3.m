...
phi := KX!((x[1]^12 - x[1]^8 - x[1]^4 + 1)/(4*x[1]^8)*x[2] + (x[1]^8 + 1)/(2*x[1]^4));
/* assign to object */
...
\[ 9, 12, 16, 11, 2, 5, 14, 6, 8, 4, 7, 15, 3, 13, 1, 10 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,2,8-g3-path3" ];
s`SolvableDBParents := [ Strings() | "32S3-8,4,8-g9-path21", "32S12-8,4,8-g9-path6", "32S16-16,2,16-g7-path8", "32S16-16,4,16-g11-path8", "32S17-16,2,16-g7-path6", "32S17-16,4,16-g11-path6", "32S5-8,2,8-g5-path17" ];
