...
s`SolvableDBParents := [ Strings() | "32S14-8,4,4-g7-path7", "32S12-4,8,8-g9-path25", "32S15-8,8,8-g11-path1", "32S13-8,4,4-g7-path7", "32S12-4,8,8-g9-path26", "32S2-4,4,4-g5-path49" ];
