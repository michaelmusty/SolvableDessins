...
\[ 11, 16, 4, 7, 2, 5, 14, 10, 15, 12, 9, 13, 8, 3, 1, 6 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T8-4,4,4-g3-path15" ];
s`SolvableDBParents := [ Strings() | "32S12-8,8,4-g9-path27", "32S14-4,4,8-g7-path8", "32S15-8,8,8-g11-path3", "32S12-8,8,4-g9-path28", "32S13-4,4,8-g7-path8", "32S15-8,8,8-g11-path4", "32S2-4,4,4-g5-path50" ];
