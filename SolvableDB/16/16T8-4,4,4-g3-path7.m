...
s`SolvableDBName := "16T8-4,4,4-g3-path7";
s`SolvableDBFilename := "16T8-4,4,4-g3-path7.m";
...
\[ 10, 16, 11, 7, 2, 5, 8, 15, 14, 9, 12, 13, 3, 1, 4, 6 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path7" ];
s`SolvableDBParents := [ Strings() | "32S12-8,4,8-g9-path31", "32S14-4,8,4-g7-path10", "32S15-8,8,8-g11-path23", "32S12-8,4,8-g9-path32", "32S13-4,8,4-g7-path10", "32S15-8,8,8-g11-path24", "32S2-4,4,4-g5-path60" ];
