...
\[ 2, 5, 4, 7, 6, 1, 9, 10, 3, 12, 13, 14, 15, 8, 16, 11 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T8-4,4,4-g3-path17" ];
s`SolvableDBParents := [ Strings() | "32S12-8,8,4-g9-path43", "32S14-4,4,8-g7-path16", "32S15-8,8,8-g11-path57", "32S12-8,8,4-g9-path44", "32S13-4,4,8-g7-path16", "32S15-8,8,8-g11-path58", "32S2-4,4,4-g5-path77" ];
