...
{ IntegerRing() | 12, 16 }
@};
s`SolvableDBBelyiMapTiming := 0.150000000000000p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,4,8-g5-path2" ];
s`SolvableDBParents := [ Strings() | "32S16-16,8,16-g13-path6", "32S17-16,8,16-g13-path2", "32S16-16,8,16-g13-path7", "32S17-16,8,16-g13-path3", "32S12-8,4,8-g9-path10", "32S3-8,4,8-g9-path25", "32S5-8,4,8-g9-path14" ];
