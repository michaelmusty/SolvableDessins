...
s`SolvableDBParents := [ Strings() | "32S3-8,4,8-g9-path21", "32S12-8,4,8-g9-path6", "32S16-16,2,16-g7-path8", "32S16-16,4,16-g11-path7", "32S17-16,2,16-g7-path6", "32S17-16,4,16-g11-path6", "32S5-8,2,8-g5-path17" ];
