...
s`SolvableDBParents := [ Strings() | "32S12-8,4,8-g9-path25", "32S14-4,8,4-g7-path7", "32S15-8,8,8-g11-path3", "32S12-8,4,8-g9-path26", "32S13-4,8,4-g7-path7", "32S15-8,8,8-g11-path4", "32S2-4,4,4-g5-path50" ];
