...
s`SolvableDBParents := [ Strings() | "32S12-8,8,4-g9-path27", "32S14-4,4,8-g7-path8", "32S15-8,8,8-g11-path7", "32S12-8,8,4-g9-path28", "32S13-4,4,8-g7-path8", "32S15-8,8,8-g11-path8", "32S2-4,4,4-g5-path52" ];
