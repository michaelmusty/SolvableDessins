...
s`SolvableDBName := "16T6-4,8,8-g5-path5";
s`SolvableDBFilename := "16T6-4,8,8-g5-path5.m";
...
s`SolvableDBLocalSanityCheckTiming := 0.110000000000000p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T6-4,8,8-g5-path5" ];
s`SolvableDBParents := [ Strings() | "32S5-4,8,8-g9-path23", "32S12-4,8,8-g9-path24", "32S4-4,8,8-g9-path25" ];
