...
phi := KX!((-x[1]^12 - x[1]^8 + x[1]^4 + 1)/(4*x[1]^8)*x[2] + (-x[1]^12 - 3*x[1]^8 + x[1]^4 - 1)/(4*x[1]^4));
/* assign to object */
...
s`SolvableDBParents := [ Strings() | "32S12-8,4,8-g9-path19", "32S4-8,4,8-g9-path20", "32S5-8,2,8-g5-path23" ];
