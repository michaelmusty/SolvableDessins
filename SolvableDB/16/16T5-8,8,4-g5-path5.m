...
s`SolvableDBSanityCheckTiming := 0.190p15;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,4-g5-path5" ];
s`SolvableDBParents := [ Strings() | "32S16-16,16,8-g13-path13", "32S17-16,16,8-g13-path9", "32S16-16,16,8-g13-path14", "32S17-16,16,8-g13-path10", "32S12-8,8,4-g9-path12", "32S3-8,8,4-g9-path27", "32S5-8,8,4-g9-path16" ];
