...
s`SolvableDBParents := [ Strings() | "32S12-8,4,8-g9-path37", "32S14-4,8,4-g7-path13", "32S15-8,8,8-g11-path49", "32S12-8,4,8-g9-path38", "32S13-4,8,4-g7-path13", "32S15-8,8,8-g11-path50", "32S2-4,4,4-g5-path73" ];
