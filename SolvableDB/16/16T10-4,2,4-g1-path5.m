...
s`SolvableDBName := "16T10-4,2,4-g1-path5";
s`SolvableDBFilename := "16T10-4,2,4-g1-path5.m";
...
s`SolvableDBParents := [ Strings() | "32S9-8,2,4-g3-path2", "32S6-4,4,4-g5-path5", "32S11-8,4,4-g7-path2", "32S9-4,2,8-g3-path2", "32S7-8,2,8-g5-path2", "32S11-4,4,8-g7-path5", "32S5-8,4,8-g9-path2", "32S11-8,2,4-g3-path2", "32S2-4,4,4-g5-path5", "32S10-8,4,4-g7-path2", "32S11-4,2,8-g3-path2", "32S5-8,2,8-g5-path2", "32S10-4,4,8-g7-path5", "32S8-8,4,8-g9-path2", "32S6-4,2,4-g1-path2" ];
