...
\[ 12, 30, 26, 7, 2, 5, 17, 11, 20, 28, 13, 9, 23, 45, 33, 10, 24, 32, 25, 1, 27, 16, 8, 4, 3, 19, 18, 22, 34, 6, 41, 21, 29, 15, 61, 46, 31, 48, 44, 50, 43, 49, 37, 14, 39, 42, 57, 40, 36, 38, 56, 63, 47, 51, 60, 62, 59, 64, 53, 35, 55, 54, 58, 52 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path2", "32S19-4,16,2-g4-path1", "64S39-4,16,4-g15-path4" ];
s`SolvableDBParents := [ Strings() | "128S64-4,16,8-g37-path43", "128S97-4,16,8-g37-path67", "128S64-4,16,8-g37-path44", "128S94-4,16,8-g37-path67", "128S80-4,16,4-g29-path83", "128S112-4,16,4-g29-path271", "128S80-4,16,4-g29-path84" ];
