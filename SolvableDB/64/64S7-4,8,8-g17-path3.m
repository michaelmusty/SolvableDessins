...
I<[x]> := ideal< P | [
x[4]^2*x[5]^4 + 1/4*(3*nu^2 + 6)*x[5]^4 + 1/8*(27*nu^3 + 180*nu)*x[3]*x[5]^2 + 1/128*(-207*nu^3 - 1233*nu)*x[4]^2 + 1/64*(-216*nu^2 - 999)*x[1] + 1/64*(-216*nu^2 - 999)*x[2] + 1/512*(-1215*nu^3 - 6777*nu),
x[3]*x[4]^2*x[5]^2 + 1/32*(-15*nu^3 - 93*nu)*x[2]*x[4]^2 + 1/4*(-3*nu^2 - 6)*x[3]*x[5]^2 + 1/32*(-27*nu^2 - 180)*x[1]*x[2] + 1/32*(-27*nu^2 - 180)*x[2]^2 + 1/32*(-27*nu^3 - 180*nu)*x[1] + 1/32*(-27*nu^3 - 180*nu)*x[2] + 1/128*(9*nu^2 + 207),
x[3]*x[5]^4 + 1/4*(6*nu^3 + 33*nu)*x[3]^2*x[5]^2 + 1/32*(9*nu^2 + 39)*x[5]^2 + 1/128*(-207*nu^3 - 1233*nu)*x[3],
x[2]^2*x[4]^2 + 1/8*(-15*nu^3 - 93*nu)*x[1]*x[2]^2 + 1/8*(-15*nu^3 - 93*nu)*x[2]^3 - x[4]^2 + 1/8*(15*nu^3 + 93*nu)*x[2],
x[2]*x[3]*x[4]^2 + 1/21*(2*nu^2 - 6)*x[4]^2*x[5]^2 + 1/8*(-15*nu^3 - 93*nu)*x[1]*x[2]*x[3] + 1/8*(-15*nu^3 - 93*nu)*x[2]^2*x[3] + 1/8*(3*nu^2 - 15)*x[1]*x[3] + 1/8*(3*nu^2 - 15)*x[2]*x[3] + 1/2*(-nu^2 - 1)*x[5]^2 + 1/8*(3*nu^3 + 27*nu)*x[3],
x[3]^2*x[4]^2 + (-nu^3 - 7*nu)*x[3]*x[5]^2 + 1/4*(6*nu^2 + 33)*x[3]^2 + 1/8*(-nu^3 - 7*nu)*x[4]^2 + 1/8*(-3*nu^2 - 27)*x[1] + 1/8*(-3*nu^2 - 27)*x[2] + 1/32*(-69*nu^3 - 411*nu),
x[1]*x[3]^2 + 1/2*(-nu^3 - 7*nu)*x[3]^2 + 1/8*(nu^3 + 7*nu)*x[1] - 1/2,
x[2]*x[3]^2 + 1/21*(4*nu^2 - 12)*x[3]*x[5]^2 + 1/2*(-nu^3 - 5*nu)*x[3]^2 + 1/8*(nu^3 + 7*nu)*x[2] + 1/8*(-nu^2 - 3),
x[1]*x[4]^2 + 1/8*(-15*nu^3 - 93*nu)*x[1]*x[2] + 1/8*(-15*nu^3 - 93*nu)*x[2]^2,
x[1]*x[5]^2 + 1/4*(6*nu^3 + 33*nu)*x[1]*x[3] + 1/8*(-15*nu^3 - 93*nu)*x[2]*x[3] + 1/2*(nu^3 + 7*nu)*x[5]^2,
x[2]*x[5]^2 + 1/8*(-15*nu^3 - 93*nu)*x[1]*x[3] + 1/4*(6*nu^3 + 33*nu)*x[2]*x[3] + 1/2*(-nu^3 - 5*nu)*x[5]^2 + 1/8*(-3*nu^2 - 27)*x[3],
x[1]^2 - x[2]^2 + 1
] >;
...
s`SolvableDBName := "64S7-4,8,8-g17-path3";
s`SolvableDBFilename := "64S7-4,8,8-g17-path3.m";
...
{ IntegerRing() | 46, 50 }
@};
s`SolvableDBBelyiMapTiming := 63947.010p15;
s`SolvableDBLocalSanityCheckTiming := 147.480p15;
...
\[ 2, 9, 10, 7, 11, 1, 12, 13, 6, 34, 38, 28, 17, 18, 39, 40, 29, 41, 30, 31, 25, 32, 33, 5, 42, 43, 3, 4, 8, 22, 37, 19, 44, 27, 45, 46, 47, 24, 36, 58, 48, 61, 54, 59, 55, 15, 20, 14, 56, 52, 49, 53, 57, 62, 64, 63, 50, 60, 23, 16, 21, 26, 51, 35 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path4", "32S10-4,4,8-g7-path2", "64S7-4,8,8-g17-path3" ];
s`SolvableDBParents := [ Strings() | "128S69-8,16,16-g49-path17", "128S70-8,16,16-g49-path9", "128S69-8,16,16-g49-path18", "128S70-8,16,16-g49-path10", "128S3-4,8,8-g33-path50", "128S11-4,8,8-g33-path44", "128S4-4,8,8-g33-path20" ];
s`SolvableDBChild := "32S10-4,4,8-g7-path2";
