...
s`SolvableDBName := "64S4-8,8,4-g17-path35";
s`SolvableDBFilename := "64S4-8,8,4-g17-path35.m";
...
\[ 58, 64, 43, 33, 29, 32, 61, 54, 63, 60, 59, 57, 62, 20, 14, 41, 42, 10, 9, 36, 39, 13, 12, 31, 56, 55, 25, 35, 49, 45, 40, 52, 51, 38, 34, 53, 30, 50, 47, 4, 18, 28, 27, 15, 3, 17, 16, 11, 2, 46, 7, 5, 26, 48, 44, 37, 19, 23, 22, 21, 24, 8, 1, 6 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path3", "32S7-8,8,2-g5-path11", "64S4-8,8,4-g17-path35" ];
s`SolvableDBParents := [ Strings() | "128S46-16,16,8-g49-path185", "128S46-16,16,8-g49-path186", "128S52-16,16,8-g49-path61", "128S52-16,16,8-g49-path62", "128S47-16,16,8-g49-path153", "128S47-16,16,8-g49-path154", "128S53-16,16,8-g49-path61", "128S53-16,16,8-g49-path62", "128S12-8,8,4-g33-path509", "128S48-8,8,4-g33-path53", "128S49-8,8,4-g33-path120", "128S2-8,8,4-g33-path109", "128S4-8,8,4-g33-path232", "128S50-8,8,4-g33-path53", "128S51-8,8,4-g33-path120" ];
s`SolvableDBChild := "32S7-8,8,2-g5-path11";
