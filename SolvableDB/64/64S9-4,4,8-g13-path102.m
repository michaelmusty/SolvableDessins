...
s`SolvableDBName := "64S9-4,4,8-g13-path102";
s`SolvableDBFilename := "64S9-4,4,8-g13-path102.m";
...
\[ 12, 39, 42, 7, 2, 5, 38, 25, 22, 64, 13, 9, 28, 46, 14, 20, 56, 10, 60, 58, 30, 1, 31, 11, 32, 16, 18, 24, 15, 63, 59, 61, 4, 53, 62, 17, 54, 33, 6, 43, 34, 37, 55, 48, 49, 29, 40, 19, 35, 41, 36, 23, 50, 3, 47, 51, 21, 26, 52, 44, 8, 45, 57, 27 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S11-4,4,8-g7-path15", "64S9-4,4,8-g13-path102" ];
s`SolvableDBParents := [ Strings() | "128S86-8,4,8-g33-path114", "128S4-8,4,8-g33-path476", "128S3-8,4,8-g33-path1082", "128S85-8,4,8-g33-path114", "128S83-4,4,8-g25-path154", "128S84-4,4,8-g25-path154", "128S26-4,4,8-g25-path1000" ];
