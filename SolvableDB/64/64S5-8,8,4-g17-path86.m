...
s`SolvableDBName := "64S5-8,8,4-g17-path86";
s`SolvableDBFilename := "64S5-8,8,4-g17-path86.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path5", "32S8-8,8,4-g9-path7", "64S5-8,8,4-g17-path86" ];
s`SolvableDBChildren := [ Strings() | "32S8-8,8,4-g9-path7" ];
