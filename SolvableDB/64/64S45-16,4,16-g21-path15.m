...
s`SolvableDBName := "64S45-16,4,16-g21-path15";
s`SolvableDBFilename := "64S45-16,4,16-g21-path15.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T6-8,2,8-g3-path3", "32S12-8,4,8-g9-path17", "64S45-16,4,16-g21-path15" ];
s`SolvableDBChildren := [ Strings() | "32S12-8,4,8-g9-path17" ];
