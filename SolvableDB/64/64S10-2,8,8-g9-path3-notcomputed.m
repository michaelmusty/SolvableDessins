...
s`SolvableDBName := "64S10-2,8,8-g9-path3-notcomputed";
s`SolvableDBFilename := "64S10-2,8,8-g9-path3-notcomputed.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 26, 27, 28, 29, 21, 22, 19, 23, 17, 30, 15, 16, 18, 31, 32, 11, 12, 13, 14, 20, 24, 25, 57, 58, 52, 38, 39, 36, 37, 55, 47, 49, 50, 48, 51, 53, 41, 44, 42, 43, 45, 35, 46, 59, 40, 60, 33, 34, 54, 56, 62, 61, 64, 63 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T10-2,4,4-g1-path4-notcomputed", "32S7-2,8,8-g5-path2-notcomputed", "64S10-2,8,8-g9-path3-notcomputed" ];
s`SolvableDBParents := [ Strings() | "128S4-4,8,8-g33-path3-notcomputed", "128S27-4,8,8-g33-path3-notcomputed", "128S87-2,16,16-g25-path5-notcomputed", "128S88-4,16,16-g41-path5-notcomputed", "128S87-2,16,16-g25-path6-notcomputed", "128S88-4,16,16-g41-path6-notcomputed", "128S2-2,8,8-g17-path3-notcomputed" ];
