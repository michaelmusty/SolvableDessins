...
s`SolvableDBName := "64S26-16,8,16-g25-path1";
s`SolvableDBFilename := "64S26-16,8,16-g25-path1.m";
...
\[ 50, 54, 46, 31, 63, 47, 34, 59, 51, 53, 38, 62, 30, 60, 42, 44, 33, 48, 49, 13, 61, 52, 64, 56, 16, 58, 32, 35, 37, 26, 11, 45, 25, 28, 57, 55, 40, 43, 15, 3, 36, 8, 14, 21, 24, 12, 2, 29, 7, 9, 41, 39, 20, 27, 6, 1, 23, 5, 18, 19, 10, 22, 17, 4 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path2", "32S16-16,8,16-g13-path7", "64S26-16,8,16-g25-path1" ];
s`SolvableDBParents := [ Strings() | "128S128-32,16,32-g57-path43", "128S129-32,16,32-g57-path43", "128S128-32,16,32-g57-path44", "128S129-32,16,32-g57-path44", "128S106-16,8,16-g49-path249", "128S42-16,8,16-g49-path69", "128S44-16,8,16-g49-path69" ];
