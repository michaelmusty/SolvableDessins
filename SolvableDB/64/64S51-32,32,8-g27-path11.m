...
s`SolvableDBName := "64S51-32,32,8-g27-path11";
s`SolvableDBFilename := "64S51-32,32,8-g27-path11.m";
...
\[ 6, 1, 24, 25, 19, 26, 21, 3, 2, 4, 5, 7, 8, 16, 43, 17, 49, 42, 46, 31, 22, 48, 20, 47, 44, 50, 10, 32, 28, 14, 15, 18, 9, 11, 12, 13, 23, 27, 29, 30, 62, 45, 53, 41, 64, 63, 55, 61, 57, 58, 37, 40, 33, 34, 35, 36, 38, 39, 51, 52, 60, 56, 59, 54 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,2-g3-path6", "32S16-16,16,4-g11-path6", "64S51-32,32,8-g27-path11" ];
s`SolvableDBParents := [ Strings() | "128S153-32,32,8-g53-path110", "128S129-32,32,8-g53-path57", "128S131-32,32,8-g53-path110" ];
