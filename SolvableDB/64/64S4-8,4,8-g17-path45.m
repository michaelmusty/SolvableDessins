...
s`SolvableDBName := "64S4-8,4,8-g17-path45";
s`SolvableDBFilename := "64S4-8,4,8-g17-path45.m";
...
\[ 58, 64, 59, 32, 29, 31, 56, 37, 62, 63, 57, 61, 60, 35, 41, 55, 16, 9, 46, 30, 12, 11, 25, 28, 43, 36, 34, 27, 47, 45, 52, 51, 49, 48, 50, 39, 53, 54, 38, 10, 26, 15, 14, 24, 3, 44, 2, 19, 17, 13, 7, 5, 33, 42, 8, 40, 18, 22, 21, 23, 20, 1, 4, 6 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path5", "32S7-8,2,8-g5-path5", "64S4-8,4,8-g17-path45" ];
s`SolvableDBParents := [ Strings() | "128S53-16,8,16-g49-path71", "128S53-16,8,16-g49-path72", "128S46-16,8,16-g49-path195", "128S46-16,8,16-g49-path196", "128S52-16,8,16-g49-path71", "128S52-16,8,16-g49-path72", "128S47-16,8,16-g49-path163", "128S47-16,8,16-g49-path164", "128S12-8,4,8-g33-path514", "128S50-8,4,8-g33-path58", "128S51-8,4,8-g33-path125", "128S2-8,4,8-g33-path114", "128S4-8,4,8-g33-path237", "128S48-8,4,8-g33-path58", "128S49-8,4,8-g33-path125" ];
