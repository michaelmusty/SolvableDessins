...
s`SolvableDBName := "64S50-32,32,16-g29-path29";
s`SolvableDBFilename := "64S50-32,32,16-g29-path29.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 37, 39, 41, 13, 45, 46, 48, 17, 49, 18, 14, 52, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 43, 60, 62, 35, 58, 36, 64, 38, 55, 27, 28, 30, 44, 32, 34, 47, 40, 51, 42, 29, 31, 33, 50, 53, 54, 56, 59, 57, 61, 63 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,4-g5-path5", "32S16-16,16,8-g13-path16", "64S50-32,32,16-g29-path29" ];
s`SolvableDBParents := [ Strings() | "128S159-64,64,32-g61-path49", "128S160-64,64,32-g61-path33", "128S159-64,64,32-g61-path50", "128S160-64,64,32-g61-path34", "128S131-32,32,16-g57-path173", "128S128-32,32,16-g57-path111", "128S153-32,32,16-g57-path173" ];
