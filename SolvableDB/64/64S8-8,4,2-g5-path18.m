...
s`SolvableDBName := "64S8-8,4,2-g5-path18";
s`SolvableDBFilename := "64S8-8,4,2-g5-path18.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 18, 45, 46, 48, 49, 26, 50, 8, 17, 51, 31, 10, 16, 9, 11, 12, 13, 14, 15, 20, 24, 44, 42, 27, 62, 32, 63, 60, 39, 37, 36, 61, 35, 34, 25, 41, 59, 58, 56, 29, 38, 43, 28, 30, 33, 40, 47, 52, 53, 64, 54, 55, 57 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path1", "32S6-4,4,2-g1-path1", "64S8-8,4,2-g5-path18" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,2-g17-path272", "128S76-8,4,4-g25-path135", "128S78-8,8,4-g33-path174", "128S77-8,8,2-g17-path91", "128S26-8,4,4-g25-path825", "128S3-8,8,4-g33-path986", "128S79-16,4,2-g13-path48", "128S81-16,8,2-g21-path42", "128S72-16,4,4-g29-path47", "128S74-16,8,4-g37-path8", "128S71-16,4,2-g13-path8", "128S73-16,8,2-g21-path8", "128S80-16,4,4-g29-path207", "128S82-16,8,4-g37-path76", "128S75-8,4,2-g9-path30" ];
