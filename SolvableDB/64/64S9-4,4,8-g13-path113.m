...
\[ 2, 5, 9, 7, 6, 1, 10, 11, 14, 21, 15, 30, 31, 22, 23, 32, 24, 25, 26, 12, 4, 3, 8, 19, 29, 17, 33, 34, 35, 37, 28, 38, 41, 13, 18, 57, 20, 50, 54, 39, 52, 55, 51, 40, 49, 45, 53, 46, 48, 16, 36, 27, 56, 44, 58, 59, 43, 61, 47, 64, 42, 63, 60, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path8", "32S6-2,4,4-g1-path11", "64S9-4,4,8-g13-path113" ];
s`SolvableDBParents := [ Strings() | "128S86-4,8,8-g33-path158", "128S4-4,8,8-g33-path520", "128S3-4,8,8-g33-path1126", "128S85-4,8,8-g33-path158", "128S83-4,4,8-g25-path233", "128S84-4,4,8-g25-path233", "128S26-4,4,8-g25-path1079" ];
