...
s`SolvableDBName := "64S3-8,8,8-g21-path85";
s`SolvableDBFilename := "64S3-8,8,8-g21-path85.m";
...
\[ 54, 61, 40, 35, 33, 34, 57, 52, 63, 55, 53, 41, 60, 56, 28, 36, 13, 37, 9, 39, 38, 27, 58, 30, 12, 11, 62, 59, 43, 64, 29, 51, 46, 50, 44, 49, 45, 48, 15, 47, 21, 23, 32, 7, 20, 2, 14, 10, 8, 5, 42, 24, 19, 26, 25, 17, 22, 31, 18, 3, 6, 4, 1, 16 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T4-4,4,4-g3-path9", "32S3-8,8,4-g9-path15", "64S3-8,8,8-g21-path85" ];
s`SolvableDBParents := [ Strings() | "128S45-8,16,16-g49-path383", "128S45-8,16,16-g49-path384", "128S44-16,16,8-g49-path285", "128S45-16,8,16-g49-path429", "128S44-16,16,8-g49-path286", "128S45-16,8,16-g49-path430", "128S5-8,8,8-g41-path922" ];
