...
s`SolvableDBName := "64S27-16,16,4-g21-path38";
s`SolvableDBFilename := "64S27-16,16,4-g21-path38.m";
...
\[ 54, 61, 35, 37, 32, 33, 57, 52, 50, 56, 53, 41, 60, 28, 9, 40, 30, 38, 55, 39, 34, 12, 59, 13, 27, 11, 62, 58, 43, 64, 29, 26, 63, 48, 49, 51, 44, 46, 14, 47, 21, 23, 20, 7, 2, 36, 8, 19, 10, 5, 42, 24, 6, 45, 25, 17, 22, 18, 31, 3, 15, 4, 1, 16 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T5-8,8,4-g5-path1", "32S3-8,8,4-g9-path23", "64S27-16,16,4-g21-path38" ];
s`SolvableDBParents := [ Strings() | "128S44-16,16,8-g49-path102", "128S130-32,32,4-g45-path15", "128S130-32,32,8-g53-path15", "128S43-16,16,8-g49-path8", "128S130-32,32,4-g45-path16", "128S130-32,32,8-g53-path16", "128S106-16,16,4-g41-path282" ];
