...
s`SolvableDBName := "64S23-4,4,4-g9-path296";
s`SolvableDBFilename := "64S23-4,4,4-g9-path296.m";
...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 59, 61, 57, 14, 52, 63, 33, 26, 42, 37, 21, 46, 36, 12, 38, 19, 20, 22, 43, 55, 50, 10, 11, 13, 15, 16, 17, 18, 25, 30, 31, 32, 34, 35, 58, 60, 47, 44, 49, 53, 51, 39, 62, 54, 56, 48, 64, 41, 45, 40 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S6-4,4,4-g5-path12", "64S23-4,4,4-g9-path296" ];
s`SolvableDBParents := [ Strings() | "128S122-8,4,4-g25-path59", "128S21-4,8,4-g25-path280", "128S127-8,8,4-g33-path67", "128S122-4,4,8-g25-path67", "128S12-8,4,8-g33-path243", "128S127-4,8,8-g33-path59", "128S25-8,8,8-g41-path600", "128S122-8,4,4-g25-path60", "128S29-4,8,4-g25-path222", "128S127-8,8,4-g33-path68", "128S122-4,4,8-g25-path68", "128S38-8,4,8-g33-path16", "128S127-4,8,8-g33-path60", "128S30-8,8,8-g41-path666", "128S26-8,4,4-g25-path602", "128S123-4,8,4-g25-path31", "128S37-8,8,4-g33-path34", "128S26-4,4,8-g25-path606", "128S126-8,4,8-g33-path31", "128S37-4,8,8-g33-path30", "128S124-8,8,8-g41-path95", "128S16-8,4,4-g25-path398", "128S123-4,8,4-g25-path32", "128S14-8,8,4-g33-path488", "128S16-4,4,8-g25-path402", "128S126-8,4,8-g33-path32", "128S14-4,8,8-g33-path484", "128S124-8,8,8-g41-path96", "128S36-4,4,4-g17-path48", "128S125-4,4,4-g17-path95", "128S125-4,4,4-g17-path96" ];
s`SolvableDBChild := "32S6-4,4,4-g5-path12";
