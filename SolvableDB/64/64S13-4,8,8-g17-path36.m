...
\[ 22, 5, 56, 41, 6, 40, 4, 47, 12, 18, 24, 1, 11, 15, 29, 20, 64, 27, 14, 33, 32, 9, 35, 28, 30, 16, 34, 13, 19, 21, 23, 25, 26, 10, 61, 62, 50, 46, 7, 2, 39, 43, 8, 48, 63, 3, 42, 55, 54, 57, 53, 44, 49, 51, 52, 38, 59, 60, 37, 45, 31, 17, 58, 36 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path8", "32S8-4,8,8-g9-path11", "64S13-4,8,8-g17-path36" ];
s`SolvableDBParents := [ Strings() | "128S96-4,8,16-g37-path33", "128S95-4,8,16-g37-path65", "128S95-4,8,16-g37-path66", "128S97-4,8,16-g37-path33", "128S3-4,8,8-g33-path251", "128S3-4,8,8-g33-path252", "128S28-4,8,8-g33-path105" ];
