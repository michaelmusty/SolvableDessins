...
s`SolvableDBName := "64S4-4,8,8-g17-path18";
s`SolvableDBFilename := "64S4-4,8,8-g17-path18.m";
...
\[ 22, 5, 52, 39, 6, 38, 4, 44, 12, 18, 24, 1, 11, 15, 28, 51, 63, 26, 14, 58, 31, 9, 54, 27, 29, 33, 13, 19, 21, 23, 25, 20, 10, 61, 47, 43, 7, 2, 37, 41, 8, 59, 3, 40, 57, 50, 62, 49, 46, 48, 45, 36, 55, 56, 42, 30, 16, 64, 53, 35, 17, 60, 34, 32 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path2", "32S5-4,8,8-g9-path9", "64S4-4,8,8-g17-path18" ];
s`SolvableDBParents := [ Strings() | "128S46-8,16,16-g49-path155", "128S46-8,16,16-g49-path156", "128S53-8,16,16-g49-path31", "128S53-8,16,16-g49-path32", "128S47-8,16,16-g49-path123", "128S47-8,16,16-g49-path124", "128S52-8,16,16-g49-path31", "128S52-8,16,16-g49-path32", "128S12-4,8,8-g33-path494", "128S50-4,8,8-g33-path38", "128S51-4,8,8-g33-path105", "128S2-4,8,8-g33-path94", "128S4-4,8,8-g33-path217", "128S48-4,8,8-g33-path38", "128S49-4,8,8-g33-path105" ];
