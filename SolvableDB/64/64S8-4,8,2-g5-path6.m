...
s`SolvableDBName := "64S8-4,8,2-g5-path6";
s`SolvableDBFilename := "64S8-4,8,2-g5-path6.m";
...
\[ 11, 27, 30, 7, 2, 5, 26, 19, 55, 12, 8, 22, 10, 38, 42, 9, 58, 23, 1, 24, 16, 13, 54, 53, 47, 28, 6, 4, 41, 25, 64, 34, 35, 50, 51, 32, 33, 29, 17, 15, 14, 48, 31, 45, 52, 20, 3, 40, 43, 36, 37, 62, 46, 57, 21, 39, 18, 56, 60, 61, 63, 44, 59, 49 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S11-4,8,2-g3-path10", "64S8-4,8,2-g5-path6" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,2-g17-path252", "128S26-4,8,4-g25-path844", "128S3-8,8,4-g33-path927", "128S77-8,8,2-g17-path71", "128S76-4,8,4-g25-path154", "128S78-8,8,4-g33-path115", "128S79-4,16,2-g13-path67", "128S81-8,16,2-g21-path61", "128S80-4,16,4-g29-path226", "128S82-8,16,4-g37-path95", "128S71-4,16,2-g13-path27", "128S73-8,16,2-g21-path27", "128S72-4,16,4-g29-path66", "128S74-8,16,4-g37-path27", "128S75-4,8,2-g9-path49" ];
s`SolvableDBChild := "32S11-4,8,2-g3-path10";
