...
\[ 6, 1, 22, 23, 21, 9, 4, 24, 2, 3, 5, 7, 8, 20, 51, 50, 52, 49, 42, 47, 30, 29, 12, 31, 19, 16, 48, 41, 10, 11, 13, 14, 15, 17, 18, 25, 26, 27, 28, 35, 56, 36, 62, 61, 63, 44, 32, 58, 40, 37, 54, 57, 43, 33, 46, 39, 34, 38, 45, 53, 55, 60, 64, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T2-4,4,2-g1-path1-notcomputed", "16T10-4,4,2-g1-path3-notcomputed", "32S6-4,4,2-g1-path2-notcomputed", "64S23-4,4,4-g9-path18-notcomputed" ];
