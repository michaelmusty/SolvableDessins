...
s`SolvableDBName := "64S30-4,16,16-g21-path4";
s`SolvableDBFilename := "64S30-4,16,16-g21-path4.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T5-2,8,8-g3-path1", "32S5-2,8,8-g5-path12", "64S30-4,16,16-g21-path4" ];
