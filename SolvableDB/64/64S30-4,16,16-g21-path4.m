...
\[ 2, 5, 9, 7, 6, 1, 10, 11, 14, 21, 15, 31, 32, 22, 23, 12, 24, 25, 26, 27, 4, 3, 8, 19, 33, 17, 34, 35, 36, 28, 38, 29, 43, 46, 40, 13, 53, 16, 52, 30, 37, 39, 18, 49, 44, 20, 50, 47, 54, 55, 42, 51, 57, 45, 48, 58, 41, 63, 60, 64, 56, 59, 61, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-2,8,8-g3-path6", "32S5-2,8,8-g5-path18", "64S30-4,16,16-g21-path4" ];
s`SolvableDBParents := [ Strings() | "128S70-4,16,16-g41-path65", "128S70-4,16,16-g41-path66", "128S46-4,16,16-g41-path49", "128S54-4,16,16-g41-path111", "128S62-4,16,16-g41-path19", "128S62-4,16,16-g41-path20", "128S109-4,16,16-g41-path260" ];
