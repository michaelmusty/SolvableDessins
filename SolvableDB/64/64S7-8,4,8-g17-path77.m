...
s`SolvableDBName := "64S7-8,4,8-g17-path77";
s`SolvableDBFilename := "64S7-8,4,8-g17-path77.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S11-4,2,8-g3-path7", "64S7-8,4,8-g17-path77" ];
s`SolvableDBChildren := [ Strings() | "32S11-4,2,8-g3-path7" ];
