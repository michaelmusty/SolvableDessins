...
\[ 12, 35, 40, 7, 2, 5, 34, 37, 22, 47, 13, 9, 27, 51, 14, 63, 62, 10, 59, 16, 29, 1, 30, 11, 31, 18, 24, 15, 61, 56, 52, 58, 54, 36, 6, 4, 19, 57, 33, 32, 38, 25, 45, 21, 60, 17, 26, 46, 43, 41, 28, 42, 39, 53, 23, 55, 50, 3, 8, 49, 44, 48, 64, 20 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T4-2,4,2-g0-path2-notcomputed", "16T10-2,4,4-g1-path5-notcomputed", "32S6-4,4,4-g5-path3-notcomputed", "64S34-4,4,4-g9-path2-notcomputed" ];
