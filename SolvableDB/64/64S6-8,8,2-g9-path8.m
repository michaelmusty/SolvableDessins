...
s`SolvableDBName := "64S6-8,8,2-g9-path8";
s`SolvableDBFilename := "64S6-8,8,2-g9-path8.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 36, 12, 45, 34, 48, 27, 42, 8, 17, 49, 31, 10, 16, 18, 9, 11, 13, 14, 15, 20, 24, 25, 60, 52, 56, 35, 62, 61, 39, 54, 59, 63, 55, 26, 41, 44, 58, 29, 38, 43, 28, 30, 32, 33, 37, 40, 46, 47, 50, 51, 53, 64, 57 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S11-4,8,2-g3-path9", "64S6-8,8,2-g9-path8" ];
s`SolvableDBParents := [ Strings() | "128S67-8,16,4-g37-path46", "128S68-8,16,4-g37-path46", "128S63-16,8,2-g21-path86", "128S61-16,16,4-g41-path216", "128S65-16,8,2-g21-path80", "128S62-16,16,4-g41-path184", "128S67-8,16,2-g21-path46", "128S11-8,8,4-g33-path1118", "128S68-8,16,2-g21-path46", "128S3-8,8,4-g33-path584", "128S61-16,16,2-g25-path216", "128S64-16,8,4-g37-path126", "128S62-16,16,2-g25-path184", "128S66-16,8,4-g37-path114", "128S2-8,8,2-g17-path215" ];
s`SolvableDBChild := "32S11-4,8,2-g3-path9";
