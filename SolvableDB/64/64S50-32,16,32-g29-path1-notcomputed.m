...
s`SolvableDBName := "64S50-32,16,32-g29-path1-notcomputed";
s`SolvableDBFilename := "64S50-32,16,32-g29-path1-notcomputed.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 11, 34, 25, 13, 39, 41, 43, 17, 45, 18, 14, 44, 20, 16, 9, 10, 12, 22, 23, 26, 30, 46, 33, 27, 50, 57, 52, 37, 59, 38, 54, 40, 60, 42, 35, 36, 28, 29, 31, 32, 47, 48, 49, 62, 63, 56, 64, 58, 55, 51, 53, 61 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,2,4-g1-path1-notcomputed", "8T1-8,4,8-g3-path1-notcomputed", "16T1-16,8,16-g7-path2-notcomputed", "32S1-32,16,32-g15-path1-notcomputed", "64S50-32,16,32-g29-path1-notcomputed" ];
