...
I<[x]> := ideal< P | [
x[2]^4*x[4]^4 + 2*x[3]^2*x[4]^4 - 2*x[1]*x[2]^3 - x[2]^4 - 4*x[2]*x[3]*x[4]^2 + x[4]^4 + 2*x[1]*x[2] + 4*x[2]^2 - 3,
x[3]^3*x[4]^4 + x[1]*x[2]^2*x[4]^2 + x[3]*x[4]^4 + x[2]^2*x[3] - 2*x[1]*x[4]^2 + 2*x[2]*x[4]^2,
x[1]*x[2]^3*x[4]^2 + x[2]^3*x[3] - 2*x[1]*x[2]*x[4]^2 + 2*x[2]^2*x[4]^2 - x[3]^2*x[4]^2 + x[4]^2,
x[1]*x[2]*x[4]^4 - x[2]^2*x[4]^4 + x[3]^2*x[4]^4 - x[2]*x[3]*x[4]^2 + x[2]^2 - 1,
x[2]^3*x[3]^2 - x[3]^3*x[4]^2 - 2*x[1]*x[2]^2 + x[2]^3 - x[3]*x[4]^2 + 2*x[1] - 2*x[2],
x[2]^2*x[3]*x[4]^2 + x[1]*x[2]^2 + x[3]*x[4]^2 - x[1],
x[2]*x[3]^2*x[4]^2 - x[1]*x[4]^2 + x[2]*x[4]^2 + x[3],
x[1]^2*x[2]^2 - x[1]^2 + x[2]^2 + 1,
x[1]*x[2]^2*x[3] + x[1]*x[2]*x[4]^2 - x[2]^2*x[4]^2 + x[3]^2*x[4]^2 - x[1]*x[3] - x[2]*x[3],
x[1]^2*x[4]^2 - x[1]*x[2]*x[4]^2 - x[1]*x[3] - x[2]*x[3],
x[1]*x[3]*x[4]^2 - 1,
...
s`SolvableDBName := "64S25-8,8,4-g17-path4";
s`SolvableDBFilename := "64S25-8,8,4-g17-path4.m";
...
s`SolvableDBLocalSanityCheckTiming := 11.580p15;
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 63, 26, 51, 50, 40, 34, 33, 9, 36, 62, 45, 44, 52, 13, 12, 19, 60, 55, 48, 59, 10, 49, 56, 11, 14, 15, 16, 17, 18, 20, 21, 23, 25, 31, 32, 35, 37, 43, 61, 42, 53, 57, 58, 54, 64, 47, 46, 38, 39, 41 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path5", "32S2-4,4,4-g5-path3", "64S25-8,8,4-g17-path4" ];
s`SolvableDBParents := [ Strings() | "128S33-8,8,8-g41-path53", "128S13-8,8,8-g41-path23", "128S39-8,8,8-g41-path14", "128S19-8,8,8-g41-path23", "128S15-8,8,8-g41-path59", "128S34-8,8,8-g41-path35", "128S23-8,8,8-g41-path29", "128S40-8,8,8-g41-path5", "128S32-8,8,4-g33-path13", "128S18-8,8,4-g33-path15", "128S38-8,8,4-g33-path4", "128S35-8,8,4-g33-path19", "128S14-8,8,4-g33-path19", "128S37-8,8,4-g33-path13", "128S20-8,8,4-g33-path9" ];
