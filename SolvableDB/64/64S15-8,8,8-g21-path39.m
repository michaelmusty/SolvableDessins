...
\[ 6, 1, 24, 25, 22, 26, 4, 23, 2, 3, 5, 7, 8, 55, 48, 28, 52, 29, 51, 49, 56, 19, 17, 47, 54, 57, 16, 20, 21, 10, 37, 11, 9, 12, 13, 14, 15, 18, 27, 30, 31, 32, 35, 39, 58, 62, 46, 36, 59, 43, 63, 50, 45, 64, 41, 53, 61, 38, 44, 34, 33, 40, 42, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T8-4,4,4-g3-path11", "32S15-8,8,8-g11-path9", "64S15-8,8,8-g21-path39" ];
s`SolvableDBParents := [ Strings() | "128S101-16,16,16-g53-path29", "128S99-16,8,16-g49-path11", "128S100-8,16,8-g45-path11", "128S101-16,16,16-g53-path30", "128S99-16,8,16-g49-path12", "128S100-8,16,8-g45-path12", "128S9-8,8,8-g41-path15" ];
