...
s`SolvableDBName := "64S27-16,4,16-g21-path27";
s`SolvableDBFilename := "64S27-16,4,16-g21-path27.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 23, 41, 17, 46, 14, 21, 45, 22, 49, 44, 42, 48, 50, 19, 20, 10, 38, 30, 9, 11, 12, 13, 18, 27, 28, 29, 31, 61, 63, 57, 47, 59, 43, 58, 64, 60, 62, 36, 34, 32, 33, 35, 37, 39, 40, 51, 52, 53, 54, 55, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,4,8-g5-path5", "32S3-8,4,8-g9-path26", "64S27-16,4,16-g21-path27" ];
s`SolvableDBParents := [ Strings() | "128S130-32,8,32-g53-path69", "128S130-32,4,32-g45-path69", "128S44-16,8,16-g49-path129", "128S130-32,8,32-g53-path70", "128S130-32,4,32-g45-path70", "128S43-16,8,16-g49-path35", "128S106-16,4,16-g41-path309" ];
