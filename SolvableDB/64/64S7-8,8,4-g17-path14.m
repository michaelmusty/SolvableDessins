...
s`SolvableDBName := "64S7-8,8,4-g17-path14";
s`SolvableDBFilename := "64S7-8,8,4-g17-path14.m";
...
s`SolvableDBParents := [ Strings() | "128S69-16,16,4-g41-path25", "128S69-16,16,4-g41-path26", "128S70-16,16,4-g41-path17", "128S70-16,16,4-g41-path18", "128S11-8,8,4-g33-path53", "128S3-8,8,4-g33-path59", "128S4-8,8,4-g33-path29" ];
