...
I<[x]> := ideal< P | [
x[3]^2*x[4]^4 - 2*x[1]*x[4]^4 - x[4]^4 + x[3]^2 + 1,
x[1]*x[3]^2*x[4]^2 - x[3]^2*x[4]^2 + x[2]*x[3]^2 + 3*x[1]*x[4]^2 + x[4]^2 - x[2],
x[1]^2*x[3]^2 + 2*x[1]*x[3]^2 - x[1]^2 - x[3]^2 + 2*x[1] + 1,
x[1]*x[2]*x[3]^2 - 2*x[3]^2*x[4]^2 + 3*x[2]*x[3]^2 + 4*x[1]*x[4]^2 - x[1]*x[2] + 2*x[4]^2 + x[2],
x[2]^2*x[3]^2 - 4*x[1]*x[3]^2 + 4*x[1]^2 - x[2]^2 + 2*x[3]^2 - 4*x[1] - 2,
x[1]^2*x[4]^2 + x[1]*x[4]^2 - x[2],
x[1]^3 - x[2]^2 - x[1],
x[2]*x[4]^2 - x[1] + 1
] >;
...
s`SolvableDBName := "64S20-8,4,4-g13-path9";
s`SolvableDBFilename := "64S20-8,4,4-g13-path9.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 23, 59, 46, 43, 14, 33, 64, 37, 62, 60, 9, 21, 61, 53, 42, 11, 17, 19, 20, 22, 10, 45, 39, 12, 13, 15, 16, 18, 25, 26, 31, 32, 34, 35, 36, 58, 51, 48, 49, 40, 57, 63, 50, 47, 41, 56, 52, 38, 55, 44, 54 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path4", "32S2-4,4,4-g5-path7", "64S20-8,4,4-g13-path9" ];
s`SolvableDBParents := [ Strings() | "128S35-8,8,4-g33-path4", "128S11-8,4,8-g33-path16", "128S31-8,8,8-g41-path13", "128S8-8,8,4-g33-path10", "128S32-8,4,8-g33-path7", "128S10-8,8,8-g41-path49", "128S17-8,8,4-g33-path6", "128S27-8,4,8-g33-path16", "128S23-8,8,8-g41-path19", "128S32-8,8,4-g33-path7", "128S20-8,4,8-g33-path6", "128S34-8,8,8-g41-path13", "128S29-8,4,4-g25-path1", "128S26-8,4,4-g25-path1", "128S16-8,4,4-g25-path3" ];
