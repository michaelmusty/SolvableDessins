...
s`SolvableDBName := "64S33-4,8,4-g13-path44";
s`SolvableDBFilename := "64S33-4,8,4-g13-path44.m";
...
\[ 22, 5, 30, 38, 6, 37, 4, 61, 12, 18, 24, 1, 11, 15, 29, 59, 16, 27, 7, 55, 43, 9, 51, 28, 48, 42, 60, 13, 58, 21, 23, 25, 26, 46, 47, 64, 2, 19, 40, 8, 33, 41, 3, 54, 53, 62, 45, 50, 52, 32, 56, 44, 35, 49, 36, 31, 17, 14, 57, 10, 39, 63, 34, 20 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path3", "32S6-4,4,4-g5-path33", "64S33-4,8,4-g13-path44" ];
s`SolvableDBParents := [ Strings() | "128S78-8,8,4-g33-path19", "128S49-8,8,4-g33-path19", "128S58-8,8,4-g33-path63", "128S85-8,8,4-g33-path19", "128S76-4,8,4-g25-path38", "128S84-4,8,4-g25-path38", "128S122-4,8,4-g25-path494" ];
