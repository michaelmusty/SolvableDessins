...
s`SolvableDBName := "64S7-4,8,8-g17-path191";
s`SolvableDBFilename := "64S7-4,8,8-g17-path191.m";
...
\[ 2, 9, 10, 7, 11, 1, 12, 13, 6, 34, 38, 28, 17, 18, 39, 40, 29, 41, 30, 31, 25, 32, 33, 5, 42, 43, 3, 4, 8, 22, 37, 19, 44, 27, 45, 46, 47, 24, 36, 64, 50, 48, 56, 49, 57, 15, 20, 21, 23, 14, 58, 59, 51, 52, 54, 61, 60, 63, 55, 35, 26, 16, 53, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path9", "32S5-4,8,8-g9-path6", "64S7-4,8,8-g17-path191" ];
s`SolvableDBParents := [ Strings() | "128S69-8,16,16-g49-path269", "128S70-8,16,16-g49-path205", "128S69-8,16,16-g49-path270", "128S70-8,16,16-g49-path206", "128S3-4,8,8-g33-path713", "128S11-4,8,8-g33-path1247", "128S4-4,8,8-g33-path263" ];
