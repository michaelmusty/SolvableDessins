...
s`SolvableDBName := "64S12-8,8,2-g9-path1";
s`SolvableDBFilename := "64S12-8,8,2-g9-path1.m";
...
\[ 6, 1, 20, 21, 18, 22, 4, 2, 3, 5, 7, 46, 23, 42, 47, 43, 48, 44, 16, 15, 38, 49, 17, 8, 9, 10, 11, 12, 13, 14, 19, 64, 56, 55, 28, 45, 50, 62, 36, 37, 35, 40, 58, 61, 41, 39, 63, 59, 51, 33, 24, 25, 26, 27, 29, 30, 31, 32, 34, 53, 60, 54, 52, 57 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path3", "32S7-8,8,2-g5-path11", "64S12-8,8,2-g9-path1" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,4-g33-path53", "128S28-8,8,4-g33-path20", "128S93-16,8,2-g21-path20", "128S92-16,8,4-g37-path20", "128S92-16,8,2-g21-path20", "128S94-16,8,4-g37-path20", "128S93-8,16,2-g21-path20", "128S92-8,16,4-g37-path20", "128S92-8,16,2-g21-path20", "128S94-8,16,4-g37-path20", "128S89-16,16,2-g25-path20", "128S91-16,16,4-g41-path20", "128S91-16,16,2-g25-path20", "128S90-16,16,4-g41-path20", "128S2-8,8,2-g17-path53" ];
