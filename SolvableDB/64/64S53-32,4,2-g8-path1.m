...
I<[x]> := ideal< P | [
x[1]^8*x[2]^2 - x[1]^9 + (-nu^11 + nu^5)*x[1]^7*x[2]^2 + (-nu^11 + nu^5)*x[1]^8 + (nu^14 + nu^10 + nu^2 + 1)*x[1]^6*x[2]^2 + (nu^14 + nu^6 + nu^2 - 1)*x[1]^7 + (nu^15 - nu^13 + nu^9 + nu^7 + nu^5 - nu^3)*x[1]^5*x[2]^2 + (nu^13 - nu^11 - nu^9 - nu^7 + nu^3 - nu)*x[1]^6 + (nu^14 + nu^12 + nu^10 - nu^8 + nu^2 - 1)*x[1]^4*x[2]^2 + (nu^14 - nu^8 + nu^6 + nu^4 + nu^2 + 1)*x[1]^5 + (-nu^13 + nu^11 + nu^7 - nu^5 - nu^3 - nu)*x[1]^3*x[2]^2 + (nu^15 + nu^13 + nu^11 - nu^9 - nu^5 + nu^3)*x[1]^4 + (nu^12 - nu^10 - nu^8 - 1)*x[1]^2*x[2]^2 + (-nu^8 - nu^6 + nu^4 + 1)*x[1]^3 + (-nu^15 - nu^5)*x[1]*x[2]^2 + (nu^11 + nu)*x[1]^2 - nu^10*x[2]^2 - nu^6*x[1]
] >;
...
{ IntegerRing() | 61, 63 }
@};
s`SolvableDBBelyiMapTiming := 5.220p15;
