...
s`SolvableDBName := "64S30-16,16,2-g13-path13";
s`SolvableDBFilename := "64S30-16,16,2-g13-path13.m";
...
\[ 6, 1, 21, 22, 19, 23, 13, 2, 3, 4, 5, 7, 47, 49, 14, 46, 50, 9, 48, 42, 51, 17, 52, 36, 37, 8, 10, 11, 12, 15, 16, 18, 20, 24, 25, 31, 30, 40, 61, 41, 60, 38, 39, 57, 64, 45, 43, 44, 63, 58, 59, 62, 27, 28, 33, 32, 26, 29, 34, 35, 53, 54, 55, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T5-8,8,2-g3-path2", "32S5-8,8,2-g5-path17", "64S30-16,16,2-g13-path13" ];
s`SolvableDBParents := [ Strings() | "128S54-16,16,4-g41-path82", "128S70-16,16,4-g41-path7", "128S109-16,16,4-g41-path231", "128S70-16,16,4-g41-path8", "128S62-16,16,2-g25-path7", "128S46-16,16,2-g25-path43", "128S62-16,16,2-g25-path8" ];
