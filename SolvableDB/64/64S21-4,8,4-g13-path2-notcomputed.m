...
s`SolvableDBName := "64S21-4,8,4-g13-path2-notcomputed";
s`SolvableDBFilename := "64S21-4,8,4-g13-path2-notcomputed.m";
...
\[ 22, 5, 55, 40, 6, 39, 4, 45, 12, 18, 24, 1, 11, 15, 29, 58, 59, 27, 14, 33, 32, 9, 35, 28, 30, 61, 34, 13, 19, 21, 23, 25, 26, 10, 64, 63, 44, 7, 2, 38, 42, 8, 62, 3, 41, 54, 53, 56, 51, 60, 47, 48, 49, 50, 37, 57, 52, 43, 36, 46, 20, 16, 17, 31 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T10-4,4,2-g1-path5-notcomputed", "32S10-4,8,4-g7-path6-notcomputed", "64S21-4,8,4-g13-path2-notcomputed" ];
