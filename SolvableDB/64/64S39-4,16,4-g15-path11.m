...
s`SolvableDBName := "64S39-4,16,4-g15-path11";
s`SolvableDBFilename := "64S39-4,16,4-g15-path11.m";
...
\[ 12, 20, 26, 7, 2, 5, 14, 25, 19, 29, 8, 9, 4, 13, 44, 33, 10, 34, 1, 6, 11, 27, 28, 17, 21, 22, 3, 18, 24, 32, 41, 16, 30, 23, 60, 46, 31, 50, 45, 48, 43, 49, 37, 39, 15, 42, 57, 38, 36, 40, 52, 63, 47, 64, 61, 62, 59, 51, 53, 55, 35, 54, 58, 56 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T13-2,8,2-g0-path1", "32S20-4,16,4-g8-path2", "64S39-4,16,4-g15-path11" ];
s`SolvableDBParents := [ Strings() | "128S64-8,16,4-g37-path35", "128S94-8,16,4-g37-path63", "128S64-8,16,4-g37-path36", "128S97-8,16,4-g37-path63", "128S80-4,16,4-g29-path69", "128S112-4,16,4-g29-path264", "128S80-4,16,4-g29-path70" ];
