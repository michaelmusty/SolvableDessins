...
s`SolvableDBName := "64S4-8,4,8-g17-path37";
s`SolvableDBFilename := "64S4-8,4,8-g17-path37.m";
...
\[ 58, 64, 59, 32, 29, 31, 56, 37, 62, 63, 57, 61, 60, 35, 41, 55, 16, 9, 46, 30, 12, 11, 25, 28, 43, 36, 34, 27, 47, 45, 52, 51, 49, 48, 50, 39, 53, 54, 38, 10, 26, 15, 14, 24, 3, 44, 2, 19, 17, 13, 7, 5, 33, 42, 8, 40, 18, 22, 21, 23, 20, 1, 4, 6 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S7-8,2,8-g5-path1", "64S4-8,4,8-g17-path37" ];
s`SolvableDBParents := [ Strings() | "128S53-16,8,16-g49-path29", "128S53-16,8,16-g49-path30", "128S46-16,8,16-g49-path153", "128S46-16,8,16-g49-path154", "128S52-16,8,16-g49-path29", "128S52-16,8,16-g49-path30", "128S47-16,8,16-g49-path121", "128S47-16,8,16-g49-path122", "128S12-8,4,8-g33-path493", "128S50-8,4,8-g33-path37", "128S51-8,4,8-g33-path104", "128S2-8,4,8-g33-path93", "128S4-8,4,8-g33-path216", "128S48-8,4,8-g33-path37", "128S49-8,4,8-g33-path104" ];
