...
s`SolvableDBName := "64S7-8,8,4-g17-path176";
s`SolvableDBFilename := "64S7-8,8,4-g17-path176.m";
...
[ 19, 44, 37, 59, 13, 11, 6, 9, 15, 52, 22, 30, 1, 36, 39, 10, 49, 54, 5, 38, 17, 7, 40, 29, 62, 25, 42, 46, 4, 2, 56, 28, 48, 33, 20, 41, 18, 55, 8, 51, 53, 31, 16, 12, 64, 63, 34, 47, 58, 45, 61, 43, 14, 3, 35, 27, 26, 21, 24, 50, 23, 57, 32, 60 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path6", "32S5-8,8,4-g9-path17", "64S7-8,8,4-g17-path176" ];
