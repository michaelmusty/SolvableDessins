...
s`SolvableDBName := "64S15-8,8,8-g21-path142";
s`SolvableDBFilename := "64S15-8,8,8-g21-path142.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 44, 26, 62, 56, 14, 34, 48, 9, 53, 61, 31, 45, 35, 13, 12, 57, 50, 51, 59, 60, 43, 63, 38, 17, 10, 11, 15, 16, 18, 19, 20, 21, 23, 25, 32, 33, 36, 37, 49, 55, 58, 39, 41, 52, 46, 64, 40, 54, 47, 42 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T8-4,4,4-g3-path11", "32S13-4,4,8-g7-path12", "64S15-8,8,8-g21-path142" ];
s`SolvableDBParents := [ Strings() | "128S101-16,16,16-g53-path53", "128S99-16,16,8-g49-path11", "128S100-8,8,16-g45-path11", "128S101-16,16,16-g53-path54", "128S99-16,16,8-g49-path12", "128S100-8,8,16-g45-path12", "128S9-8,8,8-g41-path27" ];
