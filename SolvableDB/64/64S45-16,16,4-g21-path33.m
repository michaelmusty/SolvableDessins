...
s`SolvableDBName := "64S45-16,16,4-g21-path33";
s`SolvableDBFilename := "64S45-16,16,4-g21-path33.m";
...
\[ 6, 1, 13, 26, 21, 27, 23, 28, 2, 3, 4, 5, 7, 8, 42, 48, 36, 49, 37, 46, 47, 32, 60, 64, 63, 62, 59, 44, 54, 61, 41, 51, 40, 9, 10, 11, 12, 14, 15, 16, 17, 18, 19, 20, 22, 24, 25, 29, 30, 31, 33, 58, 55, 52, 56, 57, 45, 53, 43, 50, 38, 35, 34, 39 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path25", "32S12-8,8,4-g9-path38", "64S45-16,16,4-g21-path33" ];
s`SolvableDBParents := [ Strings() | "128S102-16,16,8-g49-path382", "128S99-16,16,8-g49-path382", "128S108-16,16,4-g41-path249" ];
