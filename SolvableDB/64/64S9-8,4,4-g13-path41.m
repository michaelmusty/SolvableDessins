...
\[ 32, 29, 33, 13, 56, 20, 39, 7, 6, 48, 57, 28, 12, 54, 44, 55, 60, 41, 49, 2, 46, 10, 50, 59, 17, 25, 22, 8, 35, 4, 16, 9, 37, 31, 1, 14, 27, 24, 30, 53, 63, 34, 26, 52, 43, 45, 42, 61, 47, 40, 15, 64, 36, 58, 19, 38, 62, 23, 11, 21, 3, 5, 51, 18 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path3", "32S10-8,4,4-g7-path22", "64S9-8,4,4-g13-path41" ];
s`SolvableDBParents := [ Strings() | "128S3-8,8,4-g33-path1162", "128S4-8,8,4-g33-path556", "128S86-8,8,4-g33-path194", "128S85-8,8,4-g33-path194", "128S26-8,4,4-g25-path1003", "128S84-8,4,4-g25-path157", "128S83-8,4,4-g25-path157" ];
