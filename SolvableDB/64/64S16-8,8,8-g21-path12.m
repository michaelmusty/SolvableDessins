...
s`SolvableDBName := "64S16-8,8,8-g21-path12";
s`SolvableDBFilename := "64S16-8,8,8-g21-path12.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-2,8,8-g2-path1", "16T5-2,8,8-g3-path2", "32S12-4,8,8-g9-path2", "64S16-8,8,8-g21-path12" ];
