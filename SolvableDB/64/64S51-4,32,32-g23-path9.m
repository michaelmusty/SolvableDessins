...
s`SolvableDBName := "64S51-4,32,32-g23-path9";
s`SolvableDBFilename := "64S51-4,32,32-g23-path9.m";
...
[ 3, 9, 11, 6, 12, 8, 1, 18, 13, 2, 21, 19, 23, 5, 7, 4, 10, 22, 28, 14, 29, 31, 30, 16, 15, 20, 17, 32, 37, 39, 38, 40, 25, 24, 27, 26, 45, 47, 46, 48, 34, 33, 36, 35, 53, 55, 54, 56, 42, 41, 44, 43, 61, 63, 62, 64, 50, 49, 52, 51, 59, 57, 60, 58 ],
[ 10, 14, 6, 20, 4, 7, 16, 5, 1, 15, 9, 2, 12, 17, 27, 25, 26, 3, 8, 24, 18, 19, 11, 36, 34, 35, 33, 13, 23, 28, 21, 22, 44, 42, 43, 41, 31, 32, 29, 30, 52, 50, 51, 49, 39, 40, 37, 38, 60, 58, 59, 57, 47, 48, 45, 46, 61, 62, 63, 64, 55, 56, 53, 54 ]
]
];
...
\[ 2, 5, 9, 7, 6, 1, 10, 3, 12, 14, 13, 8, 19, 4, 17, 15, 20, 11, 18, 16, 23, 21, 28, 25, 27, 24, 26, 22, 30, 32, 29, 31, 35, 33, 36, 34, 39, 37, 40, 38, 42, 44, 41, 43, 46, 48, 45, 47, 51, 49, 52, 50, 55, 53, 56, 54, 58, 60, 57, 59, 62, 64, 61, 63 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T1-1,16,16-g0-path1", "32S16-2,16,16-g7-path1", "64S51-4,32,32-g23-path9" ];
s`SolvableDBParents := [ Strings() | "128S131-4,32,32-g45-path53", "128S153-4,32,32-g45-path112", "128S129-4,32,32-g45-path59" ];
