...
s`SolvableDBName := "64S53-2,32,4-g8-path3";
s`SolvableDBFilename := "64S53-2,32,4-g8-path3.m";
...
\[ 10, 5, 15, 6, 2, 4, 9, 13, 7, 1, 23, 18, 8, 16, 3, 14, 21, 12, 31, 24, 17, 26, 11, 20, 29, 22, 39, 34, 25, 32, 19, 30, 37, 28, 47, 40, 33, 42, 27, 36, 45, 38, 55, 50, 41, 48, 35, 46, 53, 44, 63, 56, 49, 58, 43, 52, 61, 54, 60, 59, 57, 64, 51, 62 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T13-2,8,2-g0-path3", "32S18-2,16,2-g0-path3", "64S53-2,32,4-g8-path3" ];
s`SolvableDBParents := [ Strings() | "128S156-4,32,4-g31-path24", "128S148-4,32,4-g31-path47", "128S147-2,32,4-g15-path27" ];
