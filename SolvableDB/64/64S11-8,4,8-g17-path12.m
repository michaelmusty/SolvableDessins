...
s`SolvableDBName := "64S11-8,4,8-g17-path12";
s`SolvableDBFilename := "64S11-8,4,8-g17-path12.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 51, 57, 55, 56, 63, 48, 59, 9, 36, 34, 15, 60, 64, 13, 12, 47, 43, 62, 14, 39, 41, 50, 35, 10, 11, 16, 17, 18, 19, 20, 21, 23, 25, 26, 31, 32, 33, 37, 58, 61, 53, 38, 44, 52, 49, 40, 46, 54, 45, 42 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S11-4,4,8-g7-path17", "64S11-8,4,8-g17-path12" ];
s`SolvableDBParents := [ Strings() | "128S3-8,4,8-g33-path87", "128S3-8,4,8-g33-path88", "128S27-8,4,8-g33-path110" ];
