...
s`SolvableDBName := "64S50-32,2,32-g15-path3-notcomputed";
s`SolvableDBFilename := "64S50-32,2,32-g15-path3-notcomputed.m";
...
\[ 58, 61, 60, 52, 49, 50, 63, 55, 57, 53, 51, 42, 43, 44, 41, 59, 45, 64, 47, 62, 36, 33, 34, 35, 39, 54, 37, 56, 26, 27, 28, 25, 29, 48, 31, 46, 20, 17, 18, 19, 23, 38, 21, 40, 9, 10, 16, 8, 12, 32, 14, 30, 11, 2, 5, 7, 6, 22, 4, 24, 15, 3, 13, 1 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,1,4-g0-path1-notcomputed", "8T1-8,1,8-g0-path1-notcomputed", "16T1-16,1,16-g0-path1-notcomputed", "32S16-16,2,16-g7-path1-notcomputed", "64S50-32,2,32-g15-path3-notcomputed" ];
