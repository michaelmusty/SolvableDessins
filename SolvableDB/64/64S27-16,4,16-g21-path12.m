...
s`SolvableDBName := "64S27-16,4,16-g21-path12";
s`SolvableDBFilename := "64S27-16,4,16-g21-path12.m";
...
\[ 6, 1, 24, 25, 22, 26, 4, 23, 2, 3, 5, 7, 8, 21, 41, 28, 45, 14, 44, 49, 48, 19, 17, 42, 47, 50, 16, 20, 10, 35, 11, 9, 12, 13, 15, 18, 27, 29, 30, 31, 61, 63, 56, 59, 43, 58, 64, 46, 60, 62, 36, 33, 32, 34, 37, 38, 39, 40, 51, 52, 53, 57, 54, 55 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,2,8-g3-path5", "32S17-16,4,16-g11-path7", "64S27-16,4,16-g21-path12" ];
s`SolvableDBParents := [ Strings() | "128S130-32,8,32-g53-path45", "128S130-32,4,32-g45-path45", "128S44-16,8,16-g49-path117", "128S130-32,8,32-g53-path46", "128S130-32,4,32-g45-path46", "128S43-16,8,16-g49-path23", "128S106-16,4,16-g41-path297" ];
s`SolvableDBChild := "32S17-16,4,16-g11-path7";
