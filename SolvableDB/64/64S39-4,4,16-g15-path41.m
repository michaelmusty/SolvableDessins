...
s`SolvableDBName := "64S39-4,4,16-g15-path41";
s`SolvableDBFilename := "64S39-4,4,16-g15-path41.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path2", "32S9-4,2,8-g3-path4", "64S39-4,4,16-g15-path41" ];
