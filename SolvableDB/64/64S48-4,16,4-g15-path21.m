...
s`SolvableDBName := "64S48-4,16,4-g15-path21";
s`SolvableDBFilename := "64S48-4,16,4-g15-path21.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path1", "32S19-4,16,2-g4-path1", "64S48-4,16,4-g15-path21" ];
