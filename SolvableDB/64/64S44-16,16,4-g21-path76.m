...
s`SolvableDBName := "64S44-16,16,4-g21-path76";
s`SolvableDBFilename := "64S44-16,16,4-g21-path76.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,2-g3-path5", "32S17-16,16,4-g11-path5", "64S44-16,16,4-g21-path76" ];
s`SolvableDBChildren := [ Strings() | "32S17-16,16,4-g11-path5" ];
