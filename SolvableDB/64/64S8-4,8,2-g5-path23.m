...
s`SolvableDBName := "64S8-4,8,2-g5-path23";
s`SolvableDBFilename := "64S8-4,8,2-g5-path23.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T10-4,4,2-g1-path1", "32S9-4,8,2-g3-path1", "64S8-4,8,2-g5-path23" ];
