...
s`SolvableDBName := "64S4-4,8,8-g17-path19";
s`SolvableDBFilename := "64S4-4,8,8-g17-path19.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S5-4,8,8-g9-path5", "64S4-4,8,8-g17-path19" ];
