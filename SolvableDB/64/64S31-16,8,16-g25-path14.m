...
s`SolvableDBName := "64S31-16,8,16-g25-path14";
s`SolvableDBFilename := "64S31-16,8,16-g25-path14.m";
...
\[ 37, 14, 21, 40, 22, 9, 26, 49, 18, 24, 33, 3, 51, 23, 59, 4, 46, 5, 53, 34, 55, 28, 39, 60, 19, 38, 12, 2, 32, 29, 36, 57, 6, 41, 48, 63, 44, 45, 50, 10, 54, 7, 61, 11, 16, 30, 8, 15, 17, 1, 43, 20, 13, 64, 42, 52, 25, 31, 62, 27, 47, 58, 56, 35 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T6-8,4,8-g5-path2", "32S5-8,4,8-g9-path22", "64S31-16,8,16-g25-path14" ];
s`SolvableDBParents := [ Strings() | "128S69-16,8,16-g49-path234", "128S62-16,8,16-g49-path170", "128S55-16,8,16-g49-path78", "128S61-16,8,16-g49-path234", "128S111-16,8,16-g49-path532", "128S47-16,8,16-g49-path78", "128S70-16,8,16-g49-path170" ];
