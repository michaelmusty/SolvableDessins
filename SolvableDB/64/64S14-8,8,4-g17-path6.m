...
s`SolvableDBName := "64S14-8,8,4-g17-path6";
s`SolvableDBFilename := "64S14-8,8,4-g17-path6.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path4", "32S10-4,8,4-g7-path17", "64S14-8,8,4-g17-path6" ];
