...
I<[x]> := ideal< P | [
x[2]^2*x[3]^4 + x[1]^2*x[2]^2 - x[3]^4 - x[1]^2 + (nu^6 - nu^2)*x[2]^2 + nu^6 - nu^2,
x[1]^3*x[2]^2 + x[2]^2*x[3]^2 - x[1]^3 + (nu^6 - nu^2)*x[1]*x[2]^2 - x[3]^2 + (nu^6 - nu^2)*x[1],
x[1]*x[3]^2 - 1
] >;
...
phi := KX!((-1/4*x[1]^16 + 1/2*x[1]^8 - 1/4)/x[1]^8);
/* assign to object */
...
s`SolvableDBName := "64S38-2,4,16-g7-path4";
s`SolvableDBFilename := "64S38-2,4,16-g7-path4.m";
...
{ IntegerRing() | 60, 64 }
@};
s`SolvableDBBelyiMapTiming := 2.580p15;
s`SolvableDBLocalSanityCheckTiming := 1.400p15;
...
\[ 10, 5, 26, 6, 2, 4, 23, 16, 11, 1, 9, 13, 12, 17, 41, 8, 14, 20, 21, 18, 19, 42, 7, 27, 33, 3, 24, 30, 31, 28, 29, 34, 25, 32, 37, 57, 35, 39, 38, 58, 15, 22, 45, 49, 43, 47, 46, 50, 44, 48, 53, 64, 51, 55, 54, 62, 36, 40, 61, 63, 59, 56, 60, 52 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T13-2,2,8-g0-path1", "32S9-2,4,8-g3-path5", "64S38-2,4,16-g7-path4" ];
s`SolvableDBParents := [ Strings() | "128S79-4,4,16-g29-path2", "128S93-2,8,16-g21-path5", "128S63-4,8,16-g37-path2", "128S112-4,4,16-g29-path8", "128S63-2,8,16-g21-path2", "128S96-4,8,16-g37-path5", "128S147-2,4,32-g15-path2", "128S150-4,4,32-g31-path2", "128S151-2,8,32-g23-path2", "128S149-4,8,32-g39-path2", "128S150-2,4,32-g15-path2", "128S148-4,4,32-g31-path2", "128S149-2,8,32-g23-path2", "128S152-4,8,32-g39-path2", "128S79-2,4,16-g13-path2" ];
