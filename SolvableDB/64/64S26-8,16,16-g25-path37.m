...
s`SolvableDBName := "64S26-8,16,16-g25-path37";
s`SolvableDBFilename := "64S26-8,16,16-g25-path37.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 35, 28, 30, 13, 41, 27, 29, 17, 9, 18, 14, 10, 20, 16, 11, 12, 22, 23, 25, 26, 52, 32, 46, 33, 34, 36, 58, 31, 45, 39, 40, 42, 43, 37, 44, 38, 47, 48, 63, 56, 51, 50, 53, 54, 55, 60, 49, 59, 57, 61, 64, 62 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T4-4,4,4-g3-path3", "32S3-4,8,8-g9-path2", "64S26-8,16,16-g25-path37" ];
s`SolvableDBParents := [ Strings() | "128S128-16,32,32-g57-path85", "128S129-16,32,32-g57-path85", "128S128-16,32,32-g57-path86", "128S129-16,32,32-g57-path86", "128S106-8,16,16-g49-path270", "128S42-8,16,16-g49-path90", "128S44-8,16,16-g49-path90" ];
