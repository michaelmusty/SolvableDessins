...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 49, 43, 26, 41, 8, 40, 29, 10, 38, 39, 24, 9, 11, 12, 13, 14, 20, 23, 25, 42, 44, 45, 46, 63, 60, 27, 57, 52, 56, 53, 61, 54, 55, 47, 31, 62, 50, 28, 30, 32, 33, 34, 35, 36, 37, 48, 51, 64, 59, 58 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,2,4-g1-path1-notcomputed", "8T2-4,2,4-g1-path2-notcomputed", "16T10-4,2,4-g1-path3-notcomputed", "32S11-4,2,8-g3-path1-notcomputed", "64S6-8,2,8-g9-path1-notcomputed" ];
