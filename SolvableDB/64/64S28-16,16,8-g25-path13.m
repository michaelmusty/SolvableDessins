...
s`SolvableDBName := "64S28-16,16,8-g25-path13";
s`SolvableDBFilename := "64S28-16,16,8-g25-path13.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 32, 9, 54, 39, 55, 57, 36, 49, 47, 60, 58, 21, 45, 13, 63, 37, 52, 19, 20, 22, 23, 44, 59, 64, 51, 10, 11, 12, 14, 15, 16, 17, 18, 25, 26, 31, 33, 34, 35, 38, 48, 53, 40, 41, 61, 62, 42, 43, 46, 50, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T4-4,4,4-g3-path9", "32S4-8,8,4-g9-path15", "64S28-16,16,8-g25-path13" ];
s`SolvableDBParents := [ Strings() | "128S45-16,16,8-g49-path167", "128S45-16,16,8-g49-path168", "128S107-16,16,8-g49-path261" ];
