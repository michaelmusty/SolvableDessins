...
I<[x]> := ideal< P | [
x[3]^3*x[4]^4 - 1/256*x[1]*x[2]*x[4]^4 - 1/256*x[2]^2*x[4]^4 - 1/16*x[1]*x[3]*x[4]^4 + 1/4*x[3]^2*x[4]^4 + 1/16*x[3]^3*x[4]^2 + 1/64*x[1]*x[4]^4 - 1/128*x[2]*x[4]^4 - 1/16*x[3]*x[4]^4 + 1/1024*x[1]^2*x[4]^2 + 1/8192*x[1]*x[2]*x[4]^2 + 1/4096*x[2]^2*x[4]^2 + 1/128*x[1]*x[3]*x[4]^2 + 5/1024*x[2]*x[3]*x[4]^2 - 1/64*x[3]^2*x[4]^2 - 1/64*x[4]^4 + 1/32768*x[1]^2*x[3] + 1/16384*x[1]*x[2]*x[3] + 1/2048*x[1]*x[3]^2 + 1/2048*x[2]*x[3]^2 + 1/512*x[3]^3 - 1/2048*x[1]*x[4]^2 - 1/2048*x[2]*x[4]^2 - 1/128*x[3]*x[4]^2 - 1/65536*x[1]^2 - 7/16384*x[1]*x[3] - 1/8192*x[2]*x[3] - 5/2048*x[3]^2 - 1/1024*x[4]^2 + 5/65536*x[1] - 1/32768*x[2] + 5/8192*x[3],
x[1]^2*x[4]^4 + 3/4*x[1]*x[2]*x[4]^4 + 1/2*x[2]^2*x[4]^4 - 32*x[3]^2*x[4]^4 + 3/2*x[2]*x[4]^4 - 1/64*x[1]^2*x[4]^2 + 3/64*x[1]*x[2]*x[4]^2 + 1/32*x[2]^2*x[4]^2 - 11/8*x[1]*x[3]*x[4]^2 - 1/4*x[2]*x[3]*x[4]^2 - 2*x[3]^2*x[4]^2 + 2*x[4]^4 + 3/256*x[1]^2*x[3] + 1/128*x[1]*x[2]*x[3] - 5/32*x[1]*x[4]^2 + 3/32*x[2]*x[4]^2 + 1/4*x[3]*x[4]^2 - 3/512*x[1]^2 - 5/64*x[1]*x[3] + 3/256*x[2]*x[3] - 1/16*x[3]^2 + 1/8*x[4]^2 - 3/512*x[1] + 7/1024*x[2] + 3/256,
x[1]^2*x[2]*x[4]^2 - 1/2*x[1]^2*x[3] + 1/4*x[2]^2*x[3] - 4*x[2]*x[4]^2 + 1/4*x[1]^2 - 1/8*x[1]*x[2] + 2*x[1]*x[3] - 2*x[2]*x[3] + 1/2*x[1] - 1/4*x[2] + 2*x[3],
x[1]*x[2]^2*x[4]^2 + 1/4*x[1]^2*x[2]*x[3] + 4*x[1]*x[2]*x[4]^2 + 2*x[2]^2*x[4]^2 - x[1]^2*x[3] + 8*x[2]*x[4]^2 - 1/2*x[1]^2 + 1/4*x[1]*x[2] - 1/8*x[2]^2 - 4*x[1]*x[3] + 3*x[2]*x[3] + 1/2*x[2] - 4*x[3],
x[2]^3*x[4]^2 + 1/4*x[1]*x[2]^2*x[3] - 8*x[1]*x[2]*x[4]^2 - 1/8*x[1]^2*x[2] + 2*x[1]^2*x[3] - 2*x[1]*x[2]*x[3] - 1/2*x[2]^2*x[3] + 1/2*x[1]^2 - 1/4*x[1]*x[2] + 1/4*x[2]^2 + 4*x[1]*x[3] - x[1],
x[1]^2*x[3]*x[4]^2 - 1/4*x[1]^2*x[4]^2 - 1/8*x[2]^2*x[4]^2 + 2*x[1]*x[3]*x[4]^2 - 1/32*x[1]*x[2]*x[3] + 1/2*x[1]*x[4]^2 + 1/64*x[1]^2 + 1/8*x[1]*x[3] - 1/64*x[2],
...
x[2]^2*x[3]*x[4]^2 + x[1]^2*x[4]^2 + 1/2*x[1]*x[2]*x[4]^2 + 1/4*x[2]^2*x[4]^2 - 8*x[1]*x[3]*x[4]^2 + 1/16*x[1]*x[2]*x[3] + x[2]*x[4]^2 - 3/32*x[1]^2 + 1/64*x[1]*x[2] - 3/4*x[1]*x[3] + 3/8*x[2]*x[3] - 1/16*x[1] + 3/32*x[2] - 1/2*x[3],
x[1]*x[3]^2*x[4]^2 - 1/16*x[1]^2*x[4]^2 - 1/32*x[1]*x[2]*x[4]^2 - 1/32*x[2]^2*x[4]^2 + 2*x[3]^2*x[4]^2 - 1/128*x[1]^2*x[3] - 1/128*x[1]*x[2]*x[3] - 1/32*x[2]*x[3]^2 + 1/16*x[1]*x[4]^2 - 1/16*x[2]*x[4]^2 + 1/256*x[1]^2 + 1/16*x[1]*x[3] + 1/8*x[3]^2 - 1/8*x[4]^2 - 1/512*x[2] - 1/32*x[3] - 1/128,
x[2]*x[3]^2*x[4]^2 + 1/8*x[1]^2*x[4]^2 + 1/16*x[1]*x[2]*x[4]^2 + 1/16*x[2]^2*x[4]^2 - 4*x[3]^2*x[4]^2 + 1/64*x[1]^2*x[3] + 1/64*x[1]*x[2]*x[3] + 1/16*x[1]*x[3]^2 + 1/16*x[2]*x[3]^2 + 3/16*x[2]*x[4]^2 - 1/128*x[1]^2 - 3/32*x[1]*x[3] - 1/8*x[3]^2 + 1/4*x[4]^2 - 1/256*x[1] + 1/256*x[2] + 1/128,
x[1]^2*x[3]^2 + 8*x[1]^2*x[4]^2 + 6*x[1]*x[2]*x[4]^2 + 4*x[2]^2*x[4]^2 - 256*x[3]^2*x[4]^2 + 3/2*x[1]^2*x[3] + x[1]*x[2]*x[3] + 4*x[1]*x[3]^2 + 4*x[2]*x[3]^2 + 12*x[2]*x[4]^2 - 9/16*x[1]^2 - 8*x[1]*x[3] - 12*x[3]^2 + 16*x[4]^2 - 1/4*x[1] + 1/4*x[2] + 2*x[3] + 3/4,
x[1]*x[2]*x[3]^2 - 16*x[1]^2*x[4]^2 - 12*x[1]*x[2]*x[4]^2 - 8*x[2]^2*x[4]^2 + 512*x[3]^2*x[4]^2 - 3*x[1]^2*x[3] - 2*x[1]*x[2]*x[3] - 12*x[1]*x[3]^2 - 6*x[2]*x[3]^2 - 24*x[2]*x[4]^2 + 5/4*x[1]^2 - 1/16*x[1]*x[2] + 16*x[1]*x[3] + 24*x[3]^2 - 32*x[4]^2 + 1/4*x[1] - 5/8*x[2] - 4*x[3] - 3/2,
x[2]^2*x[3]^2 + 16*x[1]^2*x[4]^2 + 12*x[1]*x[2]*x[4]^2 + 8*x[2]^2*x[4]^2 - 512*x[3]^2*x[4]^2 + 3*x[1]^2*x[3] + 2*x[1]*x[2]*x[3] + 16*x[1]*x[3]^2 + 24*x[2]*x[4]^2 - 3/2*x[1]^2 + 1/4*x[1]*x[2] - 1/16*x[2]^2 - 16*x[1]*x[3] - 16*x[3]^2 + 32*x[4]^2 + 1/2*x[2] + 4*x[3] + 1,
x[1]^3 - x[2]^2 + 4*x[1]
] >;
...
{ IntegerRing() | 48, 62 }
@};
s`SolvableDBBelyiMapTiming := 6.080p15;
s`SolvableDBLocalSanityCheckTiming := 58.800p15;
