...
s`SolvableDBName := "64S15-8,8,8-g21-path226";
s`SolvableDBFilename := "64S15-8,8,8-g21-path226.m";
...
\[ 4, 11, 17, 23, 24, 28, 32, 1, 39, 29, 47, 7, 50, 2, 5, 51, 49, 56, 40, 3, 58, 60, 15, 38, 20, 35, 52, 36, 33, 6, 16, 14, 63, 27, 55, 62, 59, 8, 57, 13, 9, 12, 18, 61, 10, 34, 42, 45, 43, 41, 64, 31, 37, 30, 21, 25, 19, 53, 26, 54, 48, 22, 44, 46 ]:
 Order := 64 > |
[ 35, 51, 45, 2, 53, 19, 40, 32, 18, 54, 9, 27, 55, 50, 47, 60, 15, 63, 26, 4, 64, 41, 21, 12, 61, 48, 20, 1, 42, 38, 17, 31, 6, 28, 16, 13, 44, 59, 37, 3, 58, 57, 24, 36, 11, 56, 46, 22, 29, 49, 43, 62, 34, 39, 10, 8, 25, 33, 52, 5, 14, 23, 7, 30 ],
[ 46, 25, 12, 34, 31, 21, 43, 64, 48, 40, 20, 49, 63, 56, 52, 8, 7, 2, 29, 42, 36, 59, 27, 16, 47, 30, 5, 58, 13, 55, 38, 18, 50, 15, 6, 53, 60, 51, 45, 33, 61, 17, 14, 9, 19, 23, 3, 57, 32, 44, 1, 24, 22, 35, 28, 11, 10, 62, 54, 26, 39, 37, 41, 4 ],
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T12-8,2,4-g2-path2", "32S13-8,4,4-g7-path2", "64S15-8,8,8-g21-path226" ];
s`SolvableDBChildren := [ Strings() | "32S13-8,4,4-g7-path2" ];
