...
s`SolvableDBName := "64S9-4,4,8-g13-path140";
s`SolvableDBFilename := "64S9-4,4,8-g13-path140.m";
...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 46, 55, 13, 60, 32, 57, 61, 30, 54, 37, 21, 58, 33, 12, 17, 19, 20, 22, 10, 36, 39, 53, 11, 14, 15, 16, 18, 25, 26, 31, 34, 35, 41, 49, 50, 64, 56, 43, 45, 38, 63, 62, 44, 52, 51, 47, 42, 59, 40, 48 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S6-4,4,4-g5-path1", "64S9-4,4,8-g13-path140" ];
s`SolvableDBParents := [ Strings() | "128S3-4,8,8-g33-path1067", "128S86-4,8,8-g33-path99", "128S4-4,8,8-g33-path461", "128S85-4,8,8-g33-path99", "128S84-4,4,8-g25-path101", "128S26-4,4,8-g25-path947", "128S83-4,4,8-g25-path101" ];
