...
s`SolvableDBName := "64S24-4,8,8-g17-path93";
s`SolvableDBFilename := "64S24-4,8,8-g17-path93.m";
...
\[ 22, 5, 54, 41, 6, 40, 4, 46, 12, 18, 24, 1, 11, 15, 29, 53, 63, 27, 14, 33, 32, 9, 35, 28, 30, 60, 34, 13, 19, 21, 23, 25, 26, 10, 59, 64, 48, 45, 7, 2, 39, 43, 8, 62, 3, 42, 52, 55, 51, 61, 47, 49, 50, 38, 57, 58, 37, 44, 31, 20, 16, 56, 36, 17 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path8", "32S8-4,8,8-g9-path11", "64S24-4,8,8-g17-path93" ];
s`SolvableDBParents := [ Strings() | "128S15-8,8,8-g41-path1535", "128S24-8,8,8-g41-path879", "128S15-8,8,8-g41-path1536", "128S22-8,8,8-g41-path639", "128S31-8,8,8-g41-path1409", "128S41-8,8,8-g41-path87", "128S31-8,8,8-g41-path1410", "128S39-8,8,8-g41-path87", "128S17-4,8,8-g33-path541", "128S12-4,8,8-g33-path417", "128S17-4,8,8-g33-path542", "128S28-4,8,8-g33-path633", "128S37-4,8,8-g33-path379", "128S27-4,8,8-g33-path425", "128S37-4,8,8-g33-path380" ];
