...
s`SolvableDBName := "64S27-16,16,8-g25-path12";
s`SolvableDBFilename := "64S27-16,16,8-g25-path12.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 11, 51, 12, 55, 14, 33, 18, 59, 54, 38, 34, 21, 44, 25, 49, 58, 17, 19, 20, 22, 23, 10, 53, 41, 36, 9, 13, 15, 16, 26, 31, 32, 35, 37, 42, 43, 45, 60, 64, 52, 48, 61, 39, 46, 63, 40, 56, 57, 47, 62, 50 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T5-8,8,4-g5-path2", "32S17-16,16,8-g13-path13", "64S27-16,16,8-g25-path12" ];
s`SolvableDBParents := [ Strings() | "128S130-32,32,16-g57-path101", "128S130-32,32,16-g57-path102", "128S130-32,32,16-g57-path103", "128S130-32,32,16-g57-path104", "128S106-16,16,8-g49-path300", "128S44-16,16,8-g49-path163", "128S43-16,16,8-g49-path69" ];
