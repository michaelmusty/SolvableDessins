...
s`SolvableDBName := "64S22-8,8,8-g21-path7-notcomputed";
s`SolvableDBFilename := "64S22-8,8,8-g21-path7-notcomputed.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 62, 26, 52, 51, 41, 34, 33, 9, 36, 61, 46, 45, 53, 13, 12, 19, 60, 38, 49, 59, 10, 50, 58, 54, 11, 14, 15, 16, 17, 18, 20, 21, 23, 25, 31, 32, 35, 37, 44, 57, 43, 64, 47, 56, 63, 48, 39, 40, 42, 55 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T5-4,4,4-g2-path1-notcomputed", "16T8-4,4,4-g3-path15-notcomputed", "32S2-4,4,4-g5-path13-notcomputed", "64S22-8,8,8-g21-path7-notcomputed" ];
