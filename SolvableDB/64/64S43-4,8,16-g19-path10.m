...
\[ 6, 1, 22, 21, 2, 5, 4, 23, 3, 7, 8, 16, 33, 9, 11, 27, 26, 28, 24, 12, 10, 14, 15, 17, 18, 19, 20, 32, 31, 41, 13, 25, 29, 30, 39, 49, 42, 34, 37, 44, 38, 35, 40, 48, 47, 58, 36, 43, 45, 46, 55, 64, 50, 57, 54, 60, 51, 53, 56, 62, 63, 59, 52, 61 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path2", "32S9-2,4,8-g3-path9", "64S43-4,8,16-g19-path10" ];
s`SolvableDBParents := [ Strings() | "128S66-4,8,16-g37-path53", "128S82-4,8,16-g37-path53", "128S94-4,8,16-g37-path78", "128S96-4,8,16-g37-path78", "128S82-4,8,16-g37-path54", "128S66-4,8,16-g37-path54", "128S119-4,8,16-g37-path210" ];
