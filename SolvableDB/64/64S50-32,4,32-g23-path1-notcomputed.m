...
s`SolvableDBName := "64S50-32,4,32-g23-path1-notcomputed";
s`SolvableDBFilename := "64S50-32,4,32-g23-path1-notcomputed.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 20, 34, 36, 13, 39, 40, 42, 17, 43, 18, 14, 45, 16, 9, 10, 11, 12, 22, 23, 25, 41, 55, 33, 37, 47, 57, 49, 58, 38, 52, 59, 35, 54, 28, 26, 27, 29, 30, 31, 32, 44, 46, 56, 61, 62, 63, 64, 50, 48, 51, 53, 60 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,1,4-g0-path1-notcomputed", "8T1-8,1,8-g0-path1-notcomputed", "16T1-16,2,16-g4-path1-notcomputed", "32S1-32,4,32-g12-path1-notcomputed", "64S50-32,4,32-g23-path1-notcomputed" ];
