...
x[1]^2*x[4]^2 - 2*x[1]*x[4]^2 - 8*x[1]*x[2] - 16*x[2],
x[1]*x[2]*x[4]^2 - 2*x[2]*x[4]^2 - 16*x[1]^2 - 8*x[2]^2 - 64,
x[2]^2*x[4]^2 - 8*x[1]^2*x[2] - 8*x[1]*x[4]^2 - 32*x[1]*x[2] - 32*x[2],
x[3]^2*x[4]^2 + 16*x[3]^2 - 1/16*x[4]^2 + 1,
x[1]^3 - x[2]^2 + 4*x[1]
] >;
...
{ IntegerRing() | 47, 64 }
@};
s`SolvableDBBelyiMapTiming := 9.930p15;
s`SolvableDBLocalSanityCheckTiming := 1.490p15;
...
s`SolvableDBParents := [ Strings() | "128S53-16,8,16-g49-path1", "128S53-16,8,16-g49-path2", "128S46-16,8,16-g49-path9", "128S46-16,8,16-g49-path10", "128S52-16,8,16-g49-path1", "128S52-16,8,16-g49-path2", "128S47-16,8,16-g49-path5", "128S47-16,8,16-g49-path6", "128S12-8,4,8-g33-path16", "128S50-8,4,8-g33-path3", "128S51-8,4,8-g33-path8", "128S2-8,4,8-g33-path7", "128S4-8,4,8-g33-path16", "128S48-8,4,8-g33-path3", "128S49-8,4,8-g33-path8" ];
