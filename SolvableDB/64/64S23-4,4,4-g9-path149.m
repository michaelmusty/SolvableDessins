...
s`SolvableDBName := "64S23-4,4,4-g9-path149";
s`SolvableDBFilename := "64S23-4,4,4-g9-path149.m";
...
\[ 12, 38, 43, 7, 2, 5, 37, 41, 22, 33, 13, 9, 28, 19, 14, 58, 61, 10, 29, 60, 30, 1, 31, 11, 32, 16, 18, 24, 15, 25, 64, 21, 27, 57, 63, 53, 39, 6, 4, 44, 40, 56, 36, 8, 26, 50, 51, 52, 20, 48, 34, 46, 3, 59, 23, 54, 47, 45, 42, 62, 35, 49, 17, 55 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T4-4,4,4-g3-path12", "32S2-4,4,4-g5-path37", "64S23-4,4,4-g9-path149" ];
s`SolvableDBParents := [ Strings() | "128S123-8,4,4-g25-path19", "128S122-4,8,4-g25-path33", "128S14-8,8,4-g33-path474", "128S122-4,4,8-g25-path39", "128S14-8,4,8-g33-path471", "128S12-4,8,8-g33-path237", "128S124-8,8,8-g41-path53", "128S21-8,4,4-g25-path274", "128S16-4,8,4-g25-path385", "128S127-8,8,4-g33-path39", "128S16-4,4,8-g25-path388", "128S127-8,4,8-g33-path33", "128S126-4,8,8-g33-path19", "128S25-8,8,8-g41-path579", "128S29-8,4,4-g25-path216", "128S26-4,8,4-g25-path589", "128S127-8,8,4-g33-path40", "128S26-4,4,8-g25-path592", "128S127-8,4,8-g33-path34", "128S126-4,8,8-g33-path20", "128S30-8,8,8-g41-path645", "128S123-8,4,4-g25-path20", "128S122-4,8,4-g25-path34", "128S37-8,8,4-g33-path20", "128S122-4,4,8-g25-path40", "128S37-8,4,8-g33-path17", "128S38-4,8,8-g33-path10", "128S124-8,8,8-g41-path54", "128S125-4,4,4-g17-path53", "128S125-4,4,4-g17-path54", "128S36-4,4,4-g17-path27" ];
s`SolvableDBChild := "32S2-4,4,4-g5-path37";
