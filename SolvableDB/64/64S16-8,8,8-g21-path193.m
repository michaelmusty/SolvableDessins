...
s`SolvableDBName := "64S16-8,8,8-g21-path193";
s`SolvableDBFilename := "64S16-8,8,8-g21-path193.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T13-2,8,2-g0-path3", "32S14-4,8,4-g7-path3", "64S16-8,8,8-g21-path193" ];
