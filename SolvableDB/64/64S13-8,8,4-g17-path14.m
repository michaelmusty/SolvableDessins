...
s`SolvableDBName := "64S13-8,8,4-g17-path14";
s`SolvableDBFilename := "64S13-8,8,4-g17-path14.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 37, 14, 58, 13, 34, 61, 36, 39, 31, 52, 9, 21, 42, 35, 44, 11, 50, 19, 20, 22, 23, 41, 53, 57, 10, 12, 15, 16, 17, 18, 25, 26, 32, 33, 64, 48, 45, 62, 51, 60, 63, 59, 43, 49, 38, 47, 54, 55, 56, 46, 40 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T12-2,8,4-g2-path2", "32S10-4,8,4-g7-path24", "64S13-8,8,4-g17-path14" ];
s`SolvableDBParents := [ Strings() | "128S96-16,8,4-g37-path6", "128S95-16,8,4-g37-path11", "128S97-16,8,4-g37-path6", "128S95-16,8,4-g37-path12", "128S3-8,8,4-g33-path161", "128S28-8,8,4-g33-path60", "128S3-8,8,4-g33-path162" ];
