...
s`SolvableDBName := "64S22-8,8,8-g21-path43";
s`SolvableDBFilename := "64S22-8,8,8-g21-path43.m";
...
\[ 42, 63, 40, 13, 33, 32, 60, 64, 52, 62, 35, 61, 53, 43, 23, 38, 47, 15, 9, 2, 36, 27, 41, 30, 8, 12, 59, 34, 58, 45, 44, 56, 20, 49, 25, 51, 39, 37, 54, 22, 57, 26, 4, 16, 17, 10, 46, 31, 3, 14, 11, 1, 7, 48, 18, 5, 29, 55, 28, 50, 19, 24, 6, 21 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T8-4,4,4-g3-path8", "32S15-8,8,8-g11-path21", "64S22-8,8,8-g21-path43" ];
s`SolvableDBParents := [ Strings() | "128S33-8,8,8-g41-path1517", "128S10-8,8,8-g41-path2399", "128S30-8,8,8-g41-path419", "128S33-8,8,8-g41-path1518", "128S22-8,8,8-g41-path453", "128S34-8,8,8-g41-path1037", "128S19-8,8,8-g41-path905", "128S9-8,8,8-g41-path2052", "128S31-8,8,8-g41-path1037", "128S10-8,8,8-g41-path2400", "128S34-8,8,8-g41-path1038", "128S31-8,8,8-g41-path1038", "128S25-8,8,8-g41-path453", "128S30-8,8,8-g41-path420", "128S19-8,8,8-g41-path906" ];
s`SolvableDBChild := "32S15-8,8,8-g11-path21";
