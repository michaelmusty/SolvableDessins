...
\[ 55, 64, 15, 21, 37, 40, 31, 35, 56, 42, 46, 52, 49, 51, 53, 54, 5, 8, 3, 23, 33, 9, 58, 59, 4, 45, 62, 13, 12, 19, 60, 16, 7, 36, 10, 50, 61, 26, 25, 17, 18, 27, 38, 14, 47, 28, 34, 11, 24, 43, 30, 22, 44, 57, 29, 1, 20, 63, 48, 39, 2, 41, 32, 6 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path32", "32S13-8,4,4-g7-path17", "64S15-8,8,8-g21-path220" ];
s`SolvableDBParents := [ Strings() | "128S99-8,16,16-g49-path161", "128S101-16,16,16-g53-path453", "128S100-16,8,8-g45-path161", "128S99-8,16,16-g49-path162", "128S101-16,16,16-g53-path454", "128S100-16,8,8-g45-path162", "128S9-8,8,8-g41-path227" ];
