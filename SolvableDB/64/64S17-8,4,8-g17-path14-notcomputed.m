...
s`SolvableDBName := "64S17-8,4,8-g17-path14-notcomputed";
s`SolvableDBFilename := "64S17-8,4,8-g17-path14-notcomputed.m";
...
\[ 54, 60, 15, 21, 36, 64, 31, 34, 22, 41, 46, 29, 28, 19, 38, 53, 5, 8, 3, 52, 39, 43, 56, 51, 4, 50, 45, 48, 59, 44, 25, 49, 7, 27, 23, 40, 32, 55, 61, 6, 57, 37, 12, 14, 10, 58, 16, 11, 35, 20, 13, 47, 62, 9, 30, 63, 18, 24, 1, 17, 33, 26, 42, 2 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T2-2,2,2-g0-path3-notcomputed", "8T2-4,2,4-g1-path5-notcomputed", "16T6-8,2,8-g3-path1-notcomputed", "32S4-8,4,8-g9-path4-notcomputed", "64S17-8,4,8-g17-path14-notcomputed" ];
