...
s`SolvableDBName := "64S40-4,8,16-g19-path15";
s`SolvableDBFilename := "64S40-4,8,16-g19-path15.m";
...
\[ 2, 5, 9, 7, 6, 1, 10, 11, 14, 20, 15, 16, 29, 21, 22, 26, 23, 24, 25, 4, 3, 8, 19, 30, 17, 31, 32, 33, 27, 37, 12, 13, 38, 39, 47, 42, 18, 40, 36, 28, 43, 34, 48, 49, 41, 50, 44, 45, 35, 52, 55, 56, 63, 57, 54, 46, 51, 59, 62, 64, 58, 61, 60, 53 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path9", "32S9-2,4,8-g3-path6", "64S40-4,8,16-g19-path15" ];
s`SolvableDBParents := [ Strings() | "128S64-4,8,16-g37-path72", "128S92-4,8,16-g37-path54", "128S82-4,8,16-g37-path26", "128S63-4,8,16-g37-path32", "128S114-4,8,16-g37-path209", "128S81-4,8,16-g37-path9", "128S95-4,8,16-g37-path116" ];
