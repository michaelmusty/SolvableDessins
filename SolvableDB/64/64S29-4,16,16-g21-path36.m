...
s`SolvableDBName := "64S29-4,16,16-g21-path36";
s`SolvableDBFilename := "64S29-4,16,16-g21-path36.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 36, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 45, 17, 43, 30, 32, 37, 13, 14, 18, 21, 28, 29, 35, 41, 31, 42, 51, 56, 34, 46, 33, 49, 48, 50, 54, 55, 52, 38, 40, 44, 47, 53, 58, 61, 60, 62, 63, 64, 57, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path10", "32S5-2,8,8-g5-path7", "64S29-4,16,16-g21-path36" ];
s`SolvableDBParents := [ Strings() | "128S131-8,32,32-g53-path7", "128S133-8,32,32-g53-path13", "128S133-8,32,32-g53-path14", "128S132-8,32,32-g53-path7", "128S131-8,32,32-g53-path8", "128S133-8,32,32-g53-path15", "128S133-8,32,32-g53-path16", "128S132-8,32,32-g53-path8", "128S69-4,16,16-g41-path85", "128S61-4,16,16-g41-path7", "128S54-4,16,16-g41-path43", "128S106-4,16,16-g41-path360", "128S61-4,16,16-g41-path8", "128S69-4,16,16-g41-path86", "128S46-4,16,16-g41-path4" ];
