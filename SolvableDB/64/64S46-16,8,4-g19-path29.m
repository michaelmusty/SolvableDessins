...
s`SolvableDBName := "64S46-16,8,4-g19-path29";
s`SolvableDBFilename := "64S46-16,8,4-g19-path29.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T8-4,4,4-g3-path1", "32S13-8,4,4-g7-path7", "64S46-16,8,4-g19-path29" ];
