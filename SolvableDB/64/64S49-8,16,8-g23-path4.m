...
\[ 6, 1, 23, 24, 20, 21, 18, 11, 2, 3, 4, 5, 7, 8, 40, 41, 31, 14, 28, 9, 12, 10, 26, 13, 36, 29, 15, 16, 17, 19, 22, 25, 56, 57, 47, 30, 44, 27, 45, 39, 32, 52, 33, 34, 35, 37, 38, 42, 50, 64, 61, 46, 49, 43, 59, 55, 48, 63, 51, 53, 54, 58, 60, 62 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T13-2,8,2-g0-path1", "32S14-4,8,4-g7-path2", "64S49-8,16,8-g23-path4" ];
s`SolvableDBParents := [ Strings() | "128S113-8,16,8-g45-path195", "128S103-8,16,8-g45-path160", "128S104-8,16,8-g45-path160" ];
