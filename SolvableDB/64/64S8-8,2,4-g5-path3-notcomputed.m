...
s`SolvableDBName := "64S8-8,2,4-g5-path3-notcomputed";
s`SolvableDBFilename := "64S8-8,2,4-g5-path3-notcomputed.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 41, 39, 23, 20, 40, 38, 42, 43, 36, 37, 8, 9, 10, 11, 12, 13, 14, 24, 34, 32, 30, 58, 59, 44, 45, 56, 60, 61, 46, 55, 57, 25, 26, 27, 28, 29, 31, 33, 35, 49, 51, 62, 63, 53, 64, 54, 47, 48, 50, 52 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T12-8,2,4-g2-path1-notcomputed", "32S9-8,2,4-g3-path4-notcomputed", "64S8-8,2,4-g5-path3-notcomputed" ];
