...
s`SolvableDBName := "64S15-8,8,8-g21-path120";
s`SolvableDBFilename := "64S15-8,8,8-g21-path120.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T8-4,4,4-g3-path15", "32S12-8,8,4-g9-path34", "64S15-8,8,8-g21-path120" ];
s`SolvableDBChildren := [ Strings() | "32S12-8,8,4-g9-path34" ];
