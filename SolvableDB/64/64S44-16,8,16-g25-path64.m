...
s`SolvableDBName := "64S44-16,8,16-g25-path64";
s`SolvableDBFilename := "64S44-16,8,16-g25-path64.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,4,8-g5-path3", "32S16-16,8,16-g13-path9", "64S44-16,8,16-g25-path64" ];
