...
s`SolvableDBName := "64S50-32,32,16-g29-path27";
s`SolvableDBFilename := "64S50-32,32,16-g29-path27.m";
...
\[ 59, 49, 60, 43, 48, 44, 57, 51, 52, 58, 61, 33, 62, 63, 46, 55, 27, 32, 28, 41, 47, 42, 64, 30, 45, 35, 56, 36, 50, 17, 54, 39, 14, 16, 9, 23, 31, 26, 12, 29, 53, 19, 40, 20, 34, 4, 38, 24, 21, 3, 11, 5, 13, 8, 2, 10, 37, 6, 25, 7, 18, 1, 22, 15 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,4-g5-path5", "32S16-16,16,8-g13-path15", "64S50-32,32,16-g29-path27" ];
s`SolvableDBParents := [ Strings() | "128S159-64,64,32-g61-path73", "128S160-64,64,32-g61-path57", "128S159-64,64,32-g61-path74", "128S160-64,64,32-g61-path58", "128S131-32,32,16-g57-path185", "128S128-32,32,16-g57-path123", "128S153-32,32,16-g57-path185" ];
