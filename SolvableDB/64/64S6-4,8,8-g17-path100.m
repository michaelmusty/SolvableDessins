...
s`SolvableDBName := "64S6-4,8,8-g17-path100";
s`SolvableDBFilename := "64S6-4,8,8-g17-path100.m";
...
\[ 6, 1, 21, 7, 2, 5, 19, 22, 3, 4, 8, 11, 42, 33, 9, 26, 23, 24, 10, 25, 15, 12, 20, 28, 17, 34, 30, 32, 13, 14, 16, 18, 27, 31, 59, 49, 29, 50, 43, 44, 45, 37, 40, 39, 36, 48, 35, 38, 41, 46, 54, 63, 47, 64, 60, 61, 62, 51, 53, 56, 55, 52, 57, 58 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S9-2,8,4-g3-path8", "64S6-4,8,8-g17-path100" ];
s`SolvableDBParents := [ Strings() | "128S67-8,8,16-g45-path37", "128S68-8,8,16-g45-path37", "128S68-8,8,16-g45-path38", "128S67-8,8,16-g45-path38", "128S63-4,16,8-g37-path59", "128S61-8,16,16-g49-path337", "128S66-4,16,8-g37-path138", "128S62-8,16,16-g49-path273", "128S65-4,16,8-g37-path53", "128S62-8,16,16-g49-path274", "128S64-4,16,8-g37-path150", "128S61-8,16,16-g49-path338", "128S3-4,8,8-g33-path639", "128S2-4,8,8-g33-path168", "128S11-4,8,8-g33-path1173" ];
