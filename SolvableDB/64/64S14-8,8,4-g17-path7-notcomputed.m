...
s`SolvableDBName := "64S14-8,8,4-g17-path7-notcomputed";
s`SolvableDBFilename := "64S14-8,8,4-g17-path7-notcomputed.m";
...
\[ 58, 62, 44, 34, 31, 33, 60, 37, 63, 56, 59, 57, 41, 30, 14, 42, 64, 43, 27, 9, 36, 40, 13, 12, 17, 32, 61, 51, 10, 38, 50, 46, 52, 49, 28, 35, 53, 55, 54, 48, 8, 29, 21, 19, 15, 3, 18, 16, 7, 2, 47, 5, 11, 45, 39, 22, 20, 24, 23, 25, 26, 6, 1, 4 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T4-2,4,2-g0-path2-notcomputed", "16T10-4,4,2-g1-path4-notcomputed", "32S7-8,8,2-g5-path1-notcomputed", "64S14-8,8,4-g17-path7-notcomputed" ];
s`SolvableDBParents := [ Strings() | "128S98-16,16,4-g41-path5-notcomputed", "128S98-16,16,4-g41-path6-notcomputed", "128S98-16,16,4-g41-path7-notcomputed", "128S98-16,16,4-g41-path8-notcomputed", "128S4-8,8,4-g33-path9-notcomputed", "128S28-8,8,4-g33-path11-notcomputed", "128S4-8,8,4-g33-path10-notcomputed" ];
