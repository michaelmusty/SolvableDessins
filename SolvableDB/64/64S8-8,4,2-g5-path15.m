...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 18, 45, 46, 48, 49, 26, 50, 8, 17, 51, 31, 10, 16, 9, 11, 12, 13, 14, 15, 20, 24, 44, 42, 27, 62, 32, 63, 60, 39, 37, 36, 61, 35, 34, 25, 41, 59, 58, 56, 29, 38, 43, 28, 30, 33, 40, 47, 52, 53, 64, 54, 55, 57 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T10-4,4,2-g1-path4", "32S6-4,4,2-g1-path2", "64S8-8,4,2-g5-path15" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,2-g17-path279", "128S76-8,4,4-g25-path142", "128S78-8,8,4-g33-path181", "128S77-8,8,2-g17-path98", "128S26-8,4,4-g25-path832", "128S3-8,8,4-g33-path993", "128S79-16,4,2-g13-path55", "128S81-16,8,2-g21-path49", "128S72-16,4,4-g29-path54", "128S74-16,8,4-g37-path15", "128S71-16,4,2-g13-path15", "128S73-16,8,2-g21-path15", "128S80-16,4,4-g29-path214", "128S82-16,8,4-g37-path83", "128S75-8,4,2-g9-path37" ];
