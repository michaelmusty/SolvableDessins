...
s`SolvableDBName := "64S27-16,4,16-g21-path43";
s`SolvableDBFilename := "64S27-16,4,16-g21-path43.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T4-4,4,4-g3-path3", "32S3-8,4,8-g9-path9", "64S27-16,4,16-g21-path43" ];
