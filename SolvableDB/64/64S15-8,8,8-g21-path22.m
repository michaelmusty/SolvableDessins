...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 44, 26, 62, 56, 14, 34, 48, 9, 53, 61, 31, 45, 35, 13, 12, 57, 50, 51, 59, 60, 43, 63, 38, 17, 10, 11, 15, 16, 18, 19, 20, 21, 23, 25, 32, 33, 36, 37, 49, 55, 58, 39, 41, 52, 46, 64, 40, 54, 47, 42 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T8-4,4,4-g3-path9", "32S13-4,4,8-g7-path5", "64S15-8,8,8-g21-path22" ];
s`SolvableDBParents := [ Strings() | "128S101-16,16,16-g53-path25", "128S99-16,16,8-g49-path9", "128S100-8,8,16-g45-path9", "128S101-16,16,16-g53-path26", "128S99-16,16,8-g49-path10", "128S100-8,8,16-g45-path10", "128S9-8,8,8-g41-path13" ];
