...
s`SolvableDBName := "64S6-8,4,8-g17-path59";
s`SolvableDBFilename := "64S6-8,4,8-g17-path59.m";
...
\[ 36, 49, 21, 39, 22, 9, 57, 48, 52, 24, 14, 16, 58, 23, 55, 4, 45, 5, 17, 61, 56, 43, 38, 26, 19, 37, 12, 2, 32, 42, 63, 64, 40, 47, 62, 28, 44, 18, 41, 59, 7, 60, 11, 3, 30, 25, 50, 51, 6, 20, 13, 1, 31, 15, 33, 10, 27, 29, 35, 46, 53, 54, 34, 8 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,4,8-g5-path5", "32S5-8,4,8-g9-path15", "64S6-8,4,8-g17-path59" ];
s`SolvableDBParents := [ Strings() | "128S67-8,8,16-g45-path117", "128S67-8,8,16-g45-path118", "128S68-8,8,16-g45-path117", "128S68-8,8,16-g45-path118", "128S63-16,4,8-g37-path48", "128S61-16,8,16-g49-path277", "128S64-16,4,8-g37-path139", "128S61-16,8,16-g49-path278", "128S65-16,4,8-g37-path42", "128S62-16,8,16-g49-path213", "128S66-16,4,8-g37-path127", "128S62-16,8,16-g49-path214", "128S11-8,4,8-g33-path1143", "128S2-8,4,8-g33-path138", "128S3-8,4,8-g33-path609" ];
