...
s`SolvableDBName := "64S6-8,4,8-g17-path27";
s`SolvableDBFilename := "64S6-8,4,8-g17-path27.m";
...
\[ 36, 49, 21, 39, 22, 9, 57, 48, 52, 24, 14, 16, 58, 23, 55, 4, 45, 5, 17, 61, 56, 43, 38, 26, 19, 37, 12, 2, 32, 42, 63, 64, 40, 47, 62, 28, 44, 18, 41, 59, 7, 60, 11, 3, 30, 25, 50, 51, 6, 20, 13, 1, 31, 15, 33, 10, 27, 29, 35, 46, 53, 54, 34, 8 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T6-8,4,8-g5-path5", "32S5-8,4,8-g9-path21", "64S6-8,4,8-g17-path27" ];
s`SolvableDBParents := [ Strings() | "128S67-8,8,16-g45-path161", "128S67-8,8,16-g45-path162", "128S68-8,8,16-g45-path161", "128S68-8,8,16-g45-path162", "128S63-16,4,8-g37-path70", "128S61-16,8,16-g49-path383", "128S64-16,4,8-g37-path161", "128S61-16,8,16-g49-path384", "128S65-16,4,8-g37-path64", "128S62-16,8,16-g49-path319", "128S66-16,4,8-g37-path149", "128S62-16,8,16-g49-path320", "128S11-8,4,8-g33-path1196", "128S2-8,4,8-g33-path191", "128S3-8,4,8-g33-path662" ];
