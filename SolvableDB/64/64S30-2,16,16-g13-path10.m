...
s`SolvableDBName := "64S30-2,16,16-g13-path10";
s`SolvableDBFilename := "64S30-2,16,16-g13-path10.m";
...
\[ 10, 5, 28, 6, 2, 4, 26, 16, 11, 1, 9, 13, 12, 38, 44, 8, 40, 21, 22, 23, 18, 19, 20, 37, 35, 7, 36, 3, 32, 33, 34, 29, 30, 31, 25, 27, 24, 14, 56, 17, 55, 54, 53, 15, 49, 50, 51, 52, 45, 46, 47, 48, 43, 42, 41, 39, 58, 57, 60, 59, 62, 61, 64, 63 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path7", "32S5-2,8,8-g5-path10", "64S30-2,16,16-g13-path10" ];
s`SolvableDBParents := [ Strings() | "128S70-4,16,16-g41-path7", "128S54-4,16,16-g41-path82", "128S70-4,16,16-g41-path8", "128S109-4,16,16-g41-path231", "128S62-2,16,16-g25-path7", "128S46-2,16,16-g25-path43", "128S62-2,16,16-g25-path8" ];
