...
s`SolvableDBName := "64S21-8,4,4-g13-path5-notcomputed";
s`SolvableDBFilename := "64S21-8,4,4-g13-path5-notcomputed.m";
...
\[ 46, 61, 33, 14, 32, 23, 19, 11, 22, 34, 39, 29, 28, 37, 7, 57, 44, 47, 30, 42, 50, 51, 2, 40, 43, 52, 49, 8, 54, 4, 3, 38, 21, 45, 5, 48, 60, 6, 62, 13, 63, 55, 53, 56, 18, 9, 59, 17, 10, 25, 12, 20, 31, 1, 16, 64, 58, 26, 27, 15, 35, 24, 36, 41 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T12-8,2,4-g2-path1-notcomputed", "32S10-8,4,4-g7-path7-notcomputed", "64S21-8,4,4-g13-path5-notcomputed" ];
