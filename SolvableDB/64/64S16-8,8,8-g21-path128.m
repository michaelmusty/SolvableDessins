...
s`SolvableDBName := "64S16-8,8,8-g21-path128";
s`SolvableDBFilename := "64S16-8,8,8-g21-path128.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path25", "32S12-8,8,4-g9-path41", "64S16-8,8,8-g21-path128" ];
