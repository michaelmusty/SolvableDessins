...
s`SolvableDBName := "64S23-4,4,4-g9-path229";
s`SolvableDBFilename := "64S23-4,4,4-g9-path229.m";
s`SolvableDBPassportName := "64S23-4,4,4-g9";
s`SolvableDBPathNumber := 229;
...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 59, 48, 44, 14, 62, 63, 60, 61, 42, 37, 21, 41, 36, 12, 38, 19, 20, 22, 40, 55, 52, 10, 11, 13, 15, 16, 17, 18, 25, 26, 30, 31, 32, 33, 34, 35, 58, 53, 50, 51, 57, 39, 49, 64, 56, 43, 47, 45, 46, 54 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path28", "32S2-4,4,4-g5-path71", "64S23-4,4,4-g9-path229" ];
s`SolvableDBParents := [ Strings() | "128S122-8,4,4-g25-path219", "128S21-4,8,4-g25-path320", "128S127-8,8,4-g33-path225", "128S122-4,4,8-g25-path225", "128S12-8,4,8-g33-path283", "128S127-4,8,8-g33-path219", "128S25-8,8,8-g41-path719", "128S122-8,4,4-g25-path220", "128S29-4,8,4-g25-path262", "128S127-8,8,4-g33-path226", "128S122-4,4,8-g25-path226", "128S38-8,4,8-g33-path56", "128S127-4,8,8-g33-path220", "128S30-8,8,8-g41-path785", "128S26-8,4,4-g25-path682", "128S123-4,8,4-g25-path111", "128S37-8,8,4-g33-path113", "128S26-4,4,8-g25-path685", "128S126-8,4,8-g33-path111", "128S37-4,8,8-g33-path110", "128S124-8,8,8-g41-path333", "128S16-8,4,4-g25-path478", "128S123-4,8,4-g25-path112", "128S14-8,8,4-g33-path567", "128S16-4,4,8-g25-path481", "128S126-8,4,8-g33-path112", "128S14-4,8,8-g33-path564", "128S124-8,8,8-g41-path334", "128S36-4,4,4-g17-path167", "128S125-4,4,4-g17-path333", "128S125-4,4,4-g17-path334" ];
