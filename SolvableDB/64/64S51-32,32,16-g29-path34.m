...
\[ 6, 1, 12, 23, 14, 24, 4, 15, 2, 3, 5, 7, 8, 32, 16, 18, 9, 20, 38, 21, 43, 37, 41, 22, 19, 10, 29, 27, 11, 13, 17, 25, 26, 28, 30, 56, 40, 57, 36, 59, 42, 53, 39, 31, 33, 45, 34, 35, 44, 46, 47, 51, 54, 64, 62, 63, 55, 52, 58, 48, 49, 61, 50, 60 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T1-16,16,8-g7-path2", "32S16-16,16,8-g13-path4", "64S51-32,32,16-g29-path34" ];
s`SolvableDBParents := [ Strings() | "128S129-32,32,16-g57-path118", "128S153-32,32,16-g57-path224", "128S131-32,32,16-g57-path224" ];
