...
s`SolvableDBName := "64S8-8,2,4-g5-path6";
s`SolvableDBFilename := "64S8-8,2,4-g5-path6.m";
...
\[ 46, 43, 49, 56, 50, 61, 20, 17, 21, 47, 22, 32, 45, 38, 60, 48, 55, 44, 64, 28, 33, 52, 4, 37, 5, 42, 6, 40, 15, 41, 54, 53, 10, 14, 19, 18, 57, 36, 63, 62, 59, 58, 25, 39, 51, 8, 35, 12, 23, 27, 16, 1, 13, 24, 11, 26, 30, 3, 31, 7, 2, 29, 34, 9 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S11-8,2,4-g3-path7", "64S8-8,2,4-g5-path6" ];
s`SolvableDBParents := [ Strings() | "128S76-8,4,4-g25-path123", "128S77-8,2,8-g17-path118", "128S3-8,4,8-g33-path1013", "128S26-8,4,4-g25-path813", "128S2-8,2,8-g17-path299", "128S78-8,4,8-g33-path201", "128S79-16,2,4-g13-path75", "128S72-16,4,4-g29-path35", "128S73-16,2,8-g21-path35", "128S82-16,4,8-g37-path103", "128S71-16,2,4-g13-path35", "128S80-16,4,4-g29-path195", "128S81-16,2,8-g21-path69", "128S74-16,4,8-g37-path35", "128S75-8,2,4-g9-path57" ];
