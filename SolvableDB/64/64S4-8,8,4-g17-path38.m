...
s`SolvableDBName := "64S4-8,8,4-g17-path38";
s`SolvableDBFilename := "64S4-8,8,4-g17-path38.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S7-8,8,2-g5-path2", "64S4-8,8,4-g17-path38" ];
