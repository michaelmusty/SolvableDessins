...
s`SolvableDBName := "64S31-4,16,16-g21-path7";
s`SolvableDBFilename := "64S31-4,16,16-g21-path7.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 38, 36, 9, 13, 24, 25, 10, 26, 27, 15, 12, 20, 45, 17, 43, 30, 31, 37, 14, 16, 18, 21, 28, 29, 35, 32, 52, 56, 39, 40, 34, 46, 33, 49, 50, 47, 54, 55, 42, 53, 41, 44, 48, 51, 58, 63, 64, 59, 57, 60, 61, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-2,8,8-g3-path6", "32S5-2,8,8-g5-path18", "64S31-4,16,16-g21-path7" ];
s`SolvableDBParents := [ Strings() | "128S61-4,16,16-g41-path119", "128S62-4,16,16-g41-path87", "128S47-4,16,16-g41-path41", "128S69-4,16,16-g41-path243", "128S111-4,16,16-g41-path541", "128S55-4,16,16-g41-path87", "128S70-4,16,16-g41-path179" ];
