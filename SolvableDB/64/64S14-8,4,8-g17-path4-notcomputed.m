...
s`SolvableDBName := "64S14-8,4,8-g17-path4-notcomputed";
s`SolvableDBFilename := "64S14-8,4,8-g17-path4-notcomputed.m";
...
\[ 42, 63, 13, 18, 20, 16, 10, 25, 22, 34, 44, 29, 28, 47, 49, 2, 50, 38, 30, 39, 8, 48, 58, 3, 40, 5, 7, 51, 56, 45, 41, 43, 21, 4, 52, 37, 17, 62, 6, 64, 33, 9, 55, 53, 14, 57, 61, 12, 19, 54, 11, 32, 24, 59, 23, 1, 36, 60, 46, 35, 15, 27, 26, 31 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T12-8,4,2-g2-path1-notcomputed", "32S10-8,4,4-g7-path8-notcomputed", "64S14-8,4,8-g17-path4-notcomputed" ];
