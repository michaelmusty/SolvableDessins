...
s`SolvableDBName := "64S44-16,4,16-g21-path13-notcomputed";
s`SolvableDBFilename := "64S44-16,4,16-g21-path13-notcomputed.m";
...
\[ 61, 55, 57, 49, 41, 47, 63, 40, 34, 43, 35, 42, 59, 54, 37, 38, 26, 58, 32, 62, 45, 19, 51, 28, 18, 33, 14, 15, 24, 20, 23, 21, 39, 56, 46, 17, 12, 48, 9, 53, 30, 60, 50, 4, 25, 5, 36, 13, 29, 3, 22, 6, 7, 11, 64, 2, 31, 10, 27, 8, 52, 16, 44, 1 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,2,4-g1-path1-notcomputed", "8T2-4,2,4-g1-path2-notcomputed", "16T5-8,2,8-g3-path5-notcomputed", "32S17-16,4,16-g11-path1-notcomputed", "64S44-16,4,16-g21-path13-notcomputed" ];
