...
s`SolvableDBName := "64S10-8,2,8-g9-path26";
s`SolvableDBFilename := "64S10-8,2,8-g9-path26.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S7-8,2,8-g5-path2", "64S10-8,2,8-g9-path26" ];
