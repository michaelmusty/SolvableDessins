...
s`SolvableDBName := "64S50-32,32,2-g15-path4";
s`SolvableDBFilename := "64S50-32,32,2-g15-path4.m";
...
\[ 58, 61, 52, 60, 49, 50, 63, 55, 57, 53, 42, 43, 44, 51, 41, 59, 45, 64, 47, 62, 36, 33, 34, 35, 39, 54, 37, 56, 26, 27, 28, 25, 29, 48, 31, 46, 20, 17, 18, 19, 23, 38, 21, 40, 9, 10, 16, 8, 11, 32, 13, 30, 14, 2, 5, 7, 6, 22, 3, 24, 15, 4, 12, 1 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,2-g3-path6", "32S16-16,16,2-g7-path6", "64S50-32,32,2-g15-path4" ];
s`SolvableDBParents := [ Strings() | "128S128-32,32,4-g45-path52", "128S159-64,64,2-g31-path7", "128S159-64,64,4-g47-path7", "128S153-32,32,4-g45-path83", "128S160-64,64,2-g31-path5", "128S160-64,64,4-g47-path5", "128S131-32,32,2-g29-path44" ];
