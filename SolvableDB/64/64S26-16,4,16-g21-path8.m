...
s`SolvableDBName := "64S26-16,4,16-g21-path8";
s`SolvableDBFilename := "64S26-16,4,16-g21-path8.m";
...
\[ 55, 63, 54, 46, 53, 47, 56, 64, 58, 62, 61, 59, 45, 37, 48, 38, 39, 60, 49, 57, 50, 51, 40, 32, 29, 30, 31, 52, 44, 41, 42, 43, 22, 28, 19, 21, 35, 36, 33, 34, 12, 18, 20, 9, 25, 26, 27, 24, 2, 8, 11, 10, 14, 16, 17, 23, 3, 1, 7, 5, 13, 4, 6, 15 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,2,8-g3-path7", "32S16-16,2,16-g7-path5", "64S26-16,4,16-g21-path8" ];
s`SolvableDBParents := [ Strings() | "128S42-16,8,16-g49-path12", "128S44-16,8,16-g49-path12", "128S128-32,4,32-g45-path12", "128S128-32,8,32-g53-path12", "128S129-32,4,32-g45-path12", "128S129-32,8,32-g53-path12", "128S106-16,4,16-g41-path239" ];
