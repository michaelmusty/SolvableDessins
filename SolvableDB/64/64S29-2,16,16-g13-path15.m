...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-2,8,8-g3-path6", "32S17-2,16,16-g7-path6", "64S29-2,16,16-g13-path15" ];
s`SolvableDBChildren := [ Strings() | "32S17-2,16,16-g7-path6" ];
