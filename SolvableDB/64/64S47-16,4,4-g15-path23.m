...
s`SolvableDBName := "64S47-16,4,4-g15-path23";
s`SolvableDBFilename := "64S47-16,4,4-g15-path23.m";
...
\[ 60, 63, 45, 46, 48, 47, 42, 43, 52, 56, 59, 55, 51, 57, 28, 24, 58, 29, 31, 25, 27, 30, 26, 36, 40, 64, 39, 35, 61, 41, 62, 44, 13, 9, 14, 17, 10, 12, 16, 11, 19, 23, 53, 22, 18, 49, 54, 50, 7, 2, 8, 32, 3, 5, 34, 4, 37, 6, 33, 38, 20, 1, 21, 15 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T13-8,2,2-g0-path3", "32S20-16,4,4-g8-path3", "64S47-16,4,4-g15-path23" ];
s`SolvableDBParents := [ Strings() | "128S103-16,8,8-g45-path103", "128S103-16,8,8-g45-path104", "128S155-32,4,4-g31-path1", "128S157-32,8,8-g47-path1", "128S156-32,4,4-g31-path1", "128S157-32,8,8-g47-path2", "128S112-16,4,4-g29-path276" ];
s`SolvableDBChild := "32S20-16,4,4-g8-path3";
