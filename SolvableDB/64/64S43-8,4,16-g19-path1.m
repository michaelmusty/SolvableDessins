...
s`SolvableDBName := "64S43-8,4,16-g19-path1";
s`SolvableDBFilename := "64S43-8,4,16-g19-path1.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path1", "32S9-4,2,8-g3-path1", "64S43-8,4,16-g19-path1" ];
