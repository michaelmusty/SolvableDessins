...
\[ 6, 1, 23, 3, 20, 13, 4, 19, 2, 5, 7, 8, 37, 43, 44, 46, 14, 15, 16, 36, 18, 38, 35, 12, 17, 39, 9, 10, 11, 21, 22, 24, 25, 26, 51, 58, 49, 41, 40, 60, 59, 55, 42, 57, 31, 53, 33, 34, 27, 28, 29, 30, 32, 45, 47, 48, 63, 62, 64, 61, 56, 50, 52, 54 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T6-8,8,4-g5-path3", "32S12-8,8,4-g9-path21", "64S16-8,8,8-g21-path118" ];
s`SolvableDBParents := [ Strings() | "128S102-16,16,8-g49-path187", "128S102-16,16,8-g49-path188", "128S103-8,8,16-g45-path94", "128S105-16,16,16-g53-path593", "128S105-16,16,16-g53-path594", "128S104-8,8,16-g45-path94", "128S9-8,8,8-g41-path603" ];
