...
I<[x]> := ideal< P | [
x[2]^2*x[3]^4 - nu^6*x[1]^2*x[2]^2 + (-nu^7 + nu^5)*x[2]^2*x[3]^2 + nu^4*x[3]^4 + (-nu^7 - nu)*x[1]*x[2]^2 + nu^6*x[1]^2 + (nu^4 - nu^2)*x[2]^2 + (-nu^3 + nu)*x[3]^2 + (-nu^7 - nu)*x[1] + nu^2 - 1,
x[1]^3*x[2]^2 + (-nu^3 + nu)*x[1]^2*x[2]^2 + nu^2*x[2]^2*x[3]^2 - x[1]^3 + (nu^6 - nu^4)*x[1]*x[2]^2 + (-nu^3 + nu)*x[1]^2 + (nu^7 + nu)*x[2]^2 + nu^6*x[3]^2 + (nu^4 - nu^2)*x[1] - nu^5 + nu^3,
x[1]*x[3]^2 - 1
] >;
...
s`SolvableDBName := "64S41-16,4,2-g7-path2";
s`SolvableDBFilename := "64S41-16,4,2-g7-path2.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 18, 33, 24, 20, 42, 41, 43, 40, 17, 39, 44, 45, 16, 8, 9, 10, 11, 12, 13, 14, 15, 34, 38, 29, 31, 59, 56, 57, 55, 37, 60, 58, 61, 62, 25, 26, 27, 28, 30, 32, 35, 36, 53, 46, 64, 54, 63, 49, 47, 51, 48, 50, 52 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T13-8,2,2-g0-path1", "32S9-8,4,2-g3-path5", "64S41-16,4,2-g7-path2" ];
s`SolvableDBParents := [ Strings() | "128S92-16,8,2-g21-path5", "128S118-16,4,4-g29-path14", "128S95-16,8,4-g37-path9", "128S65-16,8,2-g21-path1", "128S80-16,4,4-g29-path14", "128S66-16,8,4-g37-path1", "128S79-16,4,2-g13-path4" ];
