...
s`SolvableDBName := "64S44-4,16,16-g21-path41";
s`SolvableDBFilename := "64S44-4,16,16-g21-path41.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-2,8,8-g3-path5", "32S12-4,8,8-g9-path5", "64S44-4,16,16-g21-path41" ];
