...
s`SolvableDBName := "64S42-2,8,16-g11-path11";
s`SolvableDBFilename := "64S42-2,8,16-g11-path11.m";
...
\[ 10, 5, 26, 6, 2, 4, 24, 16, 11, 1, 9, 13, 12, 31, 37, 8, 22, 20, 21, 18, 19, 17, 43, 7, 33, 3, 29, 30, 27, 28, 14, 34, 25, 32, 46, 53, 15, 40, 41, 38, 39, 59, 23, 49, 47, 35, 45, 50, 44, 48, 62, 64, 36, 56, 57, 54, 55, 61, 42, 63, 58, 51, 60, 52 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path2", "32S9-2,4,8-g3-path17", "64S42-2,8,16-g11-path11" ];
s`SolvableDBParents := [ Strings() | "128S81-4,8,16-g37-path26", "128S119-4,8,16-g37-path192", "128S65-4,8,16-g37-path26", "128S97-4,8,16-g37-path77", "128S81-2,8,16-g21-path26", "128S93-2,8,16-g21-path77", "128S65-2,8,16-g21-path26" ];
