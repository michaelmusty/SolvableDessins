...
s`SolvableDBName := "64S50-16,32,32-g29-path29";
s`SolvableDBFilename := "64S50-16,32,32-g29-path29.m";
...
\[ 6, 1, 15, 18, 19, 22, 4, 3, 2, 5, 7, 8, 32, 33, 35, 13, 36, 37, 38, 17, 14, 40, 16, 9, 10, 11, 12, 20, 21, 23, 49, 50, 51, 31, 52, 53, 54, 55, 34, 56, 24, 25, 26, 27, 28, 29, 30, 39, 63, 64, 58, 60, 57, 59, 41, 42, 43, 44, 45, 46, 47, 48, 61, 62 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path5", "32S16-8,16,16-g13-path5", "64S50-16,32,32-g29-path29" ];
s`SolvableDBParents := [ Strings() | "128S159-32,64,64-g61-path61", "128S160-32,64,64-g61-path45", "128S159-32,64,64-g61-path62", "128S160-32,64,64-g61-path46", "128S153-16,32,32-g57-path179", "128S128-16,32,32-g57-path117", "128S131-16,32,32-g57-path179" ];
s`SolvableDBChild := "32S16-8,16,16-g13-path5";
