...
s`SolvableDBName := "64S7-8,8,4-g17-path143";
s`SolvableDBFilename := "64S7-8,8,4-g17-path143.m";
...
\[ 6, 1, 22, 23, 21, 24, 4, 25, 2, 3, 5, 7, 8, 43, 42, 44, 49, 14, 10, 35, 47, 50, 17, 46, 45, 19, 16, 20, 27, 36, 9, 11, 12, 13, 15, 18, 26, 28, 29, 30, 59, 63, 64, 48, 41, 53, 62, 60, 55, 56, 34, 39, 31, 32, 33, 37, 38, 40, 51, 52, 54, 61, 57, 58 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S5-8,8,2-g5-path7", "64S7-8,8,4-g17-path143" ];
s`SolvableDBParents := [ Strings() | "128S69-16,16,4-g41-path357", "128S69-16,16,4-g41-path358", "128S70-16,16,4-g41-path293", "128S70-16,16,4-g41-path294", "128S11-8,8,4-g33-path1357", "128S3-8,8,4-g33-path823", "128S4-8,8,4-g33-path373" ];
