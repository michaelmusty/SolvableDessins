...
s`SolvableDBName := "64S29-8,16,16-g25-path33";
s`SolvableDBFilename := "64S29-8,16,16-g25-path33.m";
...
\[ 6, 1, 26, 27, 23, 28, 4, 29, 2, 3, 5, 7, 8, 49, 51, 45, 42, 14, 32, 53, 37, 58, 9, 21, 57, 54, 41, 11, 17, 19, 20, 22, 18, 10, 39, 31, 12, 13, 15, 16, 24, 25, 30, 33, 34, 35, 36, 44, 61, 46, 62, 48, 63, 40, 60, 47, 38, 55, 56, 43, 52, 64, 59, 50 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path4", "32S5-4,8,8-g9-path4", "64S29-8,16,16-g25-path33" ];
s`SolvableDBParents := [ Strings() | "128S131-16,32,32-g57-path29", "128S133-16,32,32-g57-path57", "128S133-16,32,32-g57-path58", "128S132-16,32,32-g57-path29", "128S133-16,32,32-g57-path59", "128S131-16,32,32-g57-path30", "128S132-16,32,32-g57-path30", "128S133-16,32,32-g57-path60", "128S69-8,16,16-g49-path29", "128S61-8,16,16-g49-path29", "128S54-8,16,16-g49-path15", "128S61-8,16,16-g49-path30", "128S106-8,16,16-g49-path332", "128S46-8,16,16-g49-path15", "128S69-8,16,16-g49-path30" ];
