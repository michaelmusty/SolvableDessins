...
s`SolvableDBName := "64S51-16,32,32-g29-path1";
s`SolvableDBFilename := "64S51-16,32,32-g29-path1.m";
...
s`SolvableDBParents := [ Strings() | "128S153-16,32,32-g57-path23", "128S131-16,32,32-g57-path23", "128S129-16,32,32-g57-path7" ];
