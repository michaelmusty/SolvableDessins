...
s`SolvableDBName := "64S21-4,4,8-g13-path11-notcomputed";
s`SolvableDBFilename := "64S21-4,4,8-g13-path11-notcomputed.m";
...
\[ 11, 15, 22, 7, 2, 5, 24, 19, 20, 12, 9, 3, 18, 13, 6, 32, 4, 25, 26, 1, 27, 10, 8, 17, 14, 23, 33, 21, 31, 39, 16, 29, 28, 38, 34, 48, 42, 41, 37, 43, 35, 30, 49, 40, 47, 55, 36, 45, 44, 53, 50, 63, 58, 57, 54, 59, 46, 51, 64, 56, 62, 52, 61, 60 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T13-2,2,8-g0-path1-notcomputed", "32S14-4,4,8-g7-path1-notcomputed", "64S21-4,4,8-g13-path11-notcomputed" ];
