...
s`SolvableDBName := "64S4-4,8,8-g17-path22";
s`SolvableDBFilename := "64S4-4,8,8-g17-path22.m";
...
[ 59, 61, 52, 27, 17, 63, 24, 44, 55, 18, 4, 42, 7, 15, 28, 54, 38, 26, 14, 62, 48, 53, 51, 39, 46, 33, 37, 19, 50, 16, 49, 47, 10, 5, 20, 43, 11, 34, 13, 41, 8, 22, 3, 40, 30, 21, 58, 25, 29, 31, 56, 36, 12, 45, 1, 57, 23, 60, 9, 32, 6, 64, 2, 35 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S5-4,8,8-g9-path8", "64S4-4,8,8-g17-path22" ];
