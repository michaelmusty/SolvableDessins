...
s`SolvableDBName := "64S33-8,4,4-g13-path40";
s`SolvableDBFilename := "64S33-8,4,4-g13-path40.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 49, 60, 50, 61, 56, 16, 55, 9, 36, 34, 15, 42, 63, 13, 12, 45, 41, 53, 14, 38, 64, 48, 10, 11, 17, 18, 19, 20, 21, 23, 25, 26, 31, 32, 33, 35, 39, 59, 52, 46, 47, 43, 62, 54, 44, 58, 37, 51, 40, 57 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S6-4,4,4-g5-path14", "64S33-8,4,4-g13-path40" ];
s`SolvableDBParents := [ Strings() | "128S78-8,4,8-g33-path42", "128S49-8,4,8-g33-path42", "128S58-8,4,8-g33-path86", "128S85-8,4,8-g33-path42", "128S76-8,4,4-g25-path39", "128S84-8,4,4-g25-path39", "128S122-8,4,4-g25-path495" ];
