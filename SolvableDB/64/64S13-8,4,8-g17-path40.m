...
s`SolvableDBName := "64S13-8,4,8-g17-path40";
s`SolvableDBFilename := "64S13-8,4,8-g17-path40.m";
...
\[ 20, 49, 40, 3, 45, 53, 47, 54, 22, 34, 10, 29, 28, 33, 25, 12, 62, 13, 30, 9, 15, 16, 17, 18, 19, 1, 11, 27, 26, 31, 14, 64, 21, 24, 61, 23, 51, 5, 57, 39, 6, 4, 56, 52, 41, 60, 42, 8, 38, 44, 46, 48, 2, 43, 59, 50, 7, 63, 37, 58, 32, 35, 55, 36 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S8-8,4,8-g9-path3", "64S13-8,4,8-g17-path40" ];
s`SolvableDBParents := [ Strings() | "128S96-8,4,16-g37-path40", "128S95-8,4,16-g37-path79", "128S95-8,4,16-g37-path80", "128S97-8,4,16-g37-path40", "128S3-8,4,8-g33-path287", "128S3-8,4,8-g33-path288", "128S28-8,4,8-g33-path123" ];
