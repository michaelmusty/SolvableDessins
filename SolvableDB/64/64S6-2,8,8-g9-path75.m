...
s`SolvableDBName := "64S6-2,8,8-g9-path75";
s`SolvableDBFilename := "64S6-2,8,8-g9-path75.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T13-2,2,8-g0-path1", "32S9-2,4,8-g3-path15", "64S6-2,8,8-g9-path75" ];
