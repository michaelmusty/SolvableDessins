...
s`SolvableDBName := "64S30-2,16,16-g13-path2-notcomputed";
s`SolvableDBFilename := "64S30-2,16,16-g13-path2-notcomputed.m";
...
\[ 10, 5, 28, 6, 2, 4, 26, 16, 11, 1, 9, 13, 12, 38, 44, 8, 40, 21, 22, 23, 18, 19, 20, 37, 35, 7, 36, 3, 32, 33, 34, 29, 30, 31, 25, 27, 24, 14, 56, 17, 55, 54, 53, 15, 49, 50, 51, 52, 45, 46, 47, 48, 43, 42, 41, 39, 58, 57, 60, 59, 62, 61, 64, 63 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T10-2,4,4-g1-path4-notcomputed", "32S5-2,8,8-g5-path2-notcomputed", "64S30-2,16,16-g13-path2-notcomputed" ];
s`SolvableDBParents := [ Strings() | "128S70-4,16,16-g41-path1-notcomputed", "128S54-4,16,16-g41-path7-notcomputed", "128S70-4,16,16-g41-path2-notcomputed", "128S109-4,16,16-g41-path7-notcomputed", "128S62-2,16,16-g25-path1-notcomputed", "128S46-2,16,16-g25-path4-notcomputed", "128S62-2,16,16-g25-path2-notcomputed" ];
