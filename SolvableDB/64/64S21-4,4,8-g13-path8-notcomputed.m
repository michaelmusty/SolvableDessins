...
s`SolvableDBName := "64S21-4,4,8-g13-path8-notcomputed";
s`SolvableDBFilename := "64S21-4,4,8-g13-path8-notcomputed.m";
...
\[ 12, 39, 44, 7, 2, 5, 38, 42, 22, 33, 13, 9, 28, 19, 14, 20, 59, 10, 29, 64, 30, 1, 31, 11, 32, 16, 18, 24, 15, 25, 62, 21, 27, 23, 63, 58, 54, 40, 6, 4, 45, 41, 46, 37, 8, 60, 51, 52, 53, 43, 49, 57, 47, 3, 48, 61, 55, 56, 35, 50, 36, 34, 17, 26 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T12-4,2,8-g2-path1-notcomputed", "32S13-4,4,8-g7-path2-notcomputed", "64S21-4,4,8-g13-path8-notcomputed" ];
