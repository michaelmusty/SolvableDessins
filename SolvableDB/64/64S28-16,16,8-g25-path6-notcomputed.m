...
s`SolvableDBName := "64S28-16,16,8-g25-path6-notcomputed";
s`SolvableDBFilename := "64S28-16,16,8-g25-path6-notcomputed.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 63, 32, 9, 61, 53, 16, 33, 62, 51, 50, 39, 59, 14, 46, 37, 19, 56, 38, 41, 60, 10, 49, 64, 36, 11, 12, 13, 15, 17, 18, 20, 21, 23, 25, 26, 31, 34, 35, 44, 43, 57, 48, 47, 40, 55, 45, 42, 54, 52, 58 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,2-g1-path1-notcomputed", "8T2-4,4,2-g1-path2-notcomputed", "16T6-8,8,4-g5-path2-notcomputed", "32S4-8,8,4-g9-path5-notcomputed", "64S28-16,16,8-g25-path6-notcomputed" ];
