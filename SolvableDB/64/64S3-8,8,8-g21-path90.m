...
s`SolvableDBName := "64S3-8,8,8-g21-path90";
s`SolvableDBFilename := "64S3-8,8,8-g21-path90.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 51, 53, 48, 44, 14, 33, 18, 39, 58, 38, 9, 21, 60, 56, 43, 11, 17, 19, 20, 22, 23, 10, 57, 41, 36, 12, 13, 15, 16, 25, 26, 31, 32, 34, 35, 37, 61, 59, 49, 62, 46, 63, 42, 55, 50, 54, 40, 45, 64, 47, 52 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T4-4,4,4-g3-path14", "32S4-4,8,8-g9-path8", "64S3-8,8,8-g21-path90" ];
s`SolvableDBParents := [ Strings() | "128S45-8,16,16-g49-path373", "128S45-8,16,16-g49-path374", "128S44-16,16,8-g49-path277", "128S45-16,8,16-g49-path421", "128S44-16,16,8-g49-path278", "128S45-16,8,16-g49-path422", "128S5-8,8,8-g41-path917" ];
