...
phi := KX!((x[3]^32 + 2*x[3]^16 + 1)/(x[3]^32 - 2*x[3]^16 + 1));
/* assign to object */
...
s`SolvableDBParents := [ Strings() | "128S150-4,32,4-g31-path1", "128S93-2,16,8-g21-path4", "128S149-4,32,8-g39-path1", "128S150-2,32,4-g15-path1", "128S112-4,16,4-g29-path7", "128S149-2,32,8-g23-path1", "128S96-4,16,8-g37-path4", "128S147-2,32,4-g15-path1", "128S79-4,16,4-g29-path1", "128S151-2,32,8-g23-path1", "128S63-4,16,8-g37-path1", "128S148-4,32,4-g31-path1", "128S63-2,16,8-g21-path1", "128S152-4,32,8-g39-path1", "128S79-2,16,4-g13-path1" ];
