...
s`SolvableDBName := "64S20-4,4,8-g13-path132";
s`SolvableDBFilename := "64S20-4,4,8-g13-path132.m";
...
\[ 12, 39, 44, 7, 2, 5, 38, 42, 22, 33, 13, 9, 28, 19, 14, 58, 59, 10, 29, 63, 30, 1, 31, 11, 32, 16, 18, 24, 15, 25, 62, 21, 27, 36, 61, 48, 54, 40, 6, 4, 45, 41, 57, 37, 8, 26, 51, 52, 53, 20, 49, 34, 47, 3, 60, 23, 55, 46, 35, 43, 17, 56, 64, 50 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path18", "32S2-4,4,4-g5-path79", "64S20-4,4,8-g13-path132" ];
s`SolvableDBParents := [ Strings() | "128S8-8,4,8-g33-path266", "128S11-4,8,8-g33-path493", "128S10-8,8,8-g41-path1442", "128S35-8,4,8-g33-path39", "128S32-4,8,8-g33-path80", "128S31-8,8,8-g41-path80", "128S32-8,4,8-g33-path80", "128S27-4,8,8-g33-path171", "128S34-8,8,8-g41-path80", "128S17-8,4,8-g33-path201", "128S20-4,8,8-g33-path201", "128S23-8,8,8-g41-path566", "128S29-4,4,8-g25-path80", "128S26-4,4,8-g25-path80", "128S16-4,4,8-g25-path242" ];
