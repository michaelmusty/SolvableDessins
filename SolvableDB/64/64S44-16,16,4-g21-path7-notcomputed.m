...
s`SolvableDBName := "64S44-16,16,4-g21-path7-notcomputed";
s`SolvableDBFilename := "64S44-16,16,4-g21-path7-notcomputed.m";
...
\[ 56, 64, 47, 54, 53, 48, 63, 55, 59, 62, 61, 60, 40, 46, 38, 45, 39, 57, 52, 58, 50, 51, 31, 37, 32, 29, 30, 49, 43, 44, 41, 42, 28, 21, 22, 19, 36, 34, 35, 33, 18, 20, 9, 12, 26, 27, 23, 25, 11, 7, 10, 2, 24, 15, 17, 13, 4, 5, 1, 8, 16, 14, 3, 6 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-4,4,2-g1-path4-notcomputed", "16T5-8,8,2-g3-path3-notcomputed", "32S16-16,16,2-g7-path5-notcomputed", "64S44-16,16,4-g21-path7-notcomputed" ];
