...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T4-4,4,4-g3-path1", "32S3-4,8,8-g9-path1", "64S27-8,16,16-g25-path15" ];
