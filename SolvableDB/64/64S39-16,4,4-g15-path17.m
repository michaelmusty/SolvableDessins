...
s`SolvableDBName := "64S39-16,4,4-g15-path17";
s`SolvableDBFilename := "64S39-16,4,4-g15-path17.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T12-8,2,4-g2-path2", "32S9-8,2,4-g3-path13", "64S39-16,4,4-g15-path17" ];
