...
\[ 42, 63, 13, 18, 20, 16, 10, 25, 22, 34, 44, 29, 28, 47, 49, 2, 50, 38, 30, 39, 8, 48, 58, 3, 40, 5, 7, 51, 56, 45, 41, 43, 21, 4, 52, 37, 17, 62, 6, 64, 33, 9, 55, 53, 14, 57, 61, 12, 19, 54, 11, 32, 24, 59, 23, 1, 36, 60, 46, 35, 15, 27, 26, 31 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T14-8,4,4-g4-path2", "32S10-8,4,4-g7-path33", "64S14-8,4,8-g17-path34" ];
s`SolvableDBParents := [ Strings() | "128S98-16,4,16-g41-path69", "128S98-16,4,16-g41-path70", "128S98-16,4,16-g41-path71", "128S98-16,4,16-g41-path72", "128S4-8,4,8-g33-path101", "128S28-8,4,8-g33-path153", "128S4-8,4,8-g33-path102" ];
