...
\[ 41, 62, 13, 18, 20, 16, 10, 63, 22, 39, 43, 29, 28, 33, 25, 2, 49, 37, 50, 38, 8, 48, 59, 3, 58, 5, 7, 55, 56, 45, 40, 42, 44, 24, 51, 23, 60, 6, 4, 47, 9, 36, 34, 15, 14, 57, 21, 12, 35, 31, 46, 64, 54, 17, 11, 1, 53, 30, 61, 27, 52, 26, 19, 32 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T12-8,4,2-g2-path2", "32S10-8,4,4-g7-path27", "64S9-8,4,4-g13-path52" ];
s`SolvableDBParents := [ Strings() | "128S3-8,4,8-g33-path1180", "128S86-8,4,8-g33-path212", "128S4-8,4,8-g33-path574", "128S85-8,4,8-g33-path212", "128S84-8,4,4-g25-path174", "128S26-8,4,4-g25-path1020", "128S83-8,4,4-g25-path174" ];
