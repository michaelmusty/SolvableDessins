...
s`SolvableDBName := "64S8-2,4,8-g5-path30";
s`SolvableDBFilename := "64S8-2,4,8-g5-path30.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 18, 25, 26, 27, 21, 22, 19, 11, 17, 28, 15, 16, 29, 30, 12, 13, 14, 20, 23, 24, 46, 47, 36, 35, 34, 33, 41, 40, 42, 38, 37, 39, 48, 49, 50, 31, 32, 43, 44, 45, 56, 55, 62, 58, 52, 51, 59, 54, 57, 63, 64, 53, 60, 61 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T13-2,2,8-g0-path3", "32S9-2,4,8-g3-path15", "64S8-2,4,8-g5-path30" ];
s`SolvableDBParents := [ Strings() | "128S76-4,4,8-g25-path100", "128S77-2,8,8-g17-path56", "128S3-4,8,8-g33-path912", "128S26-4,4,8-g25-path790", "128S2-2,8,8-g17-path237", "128S78-4,8,8-g33-path100", "128S79-2,4,16-g13-path52", "128S72-4,4,16-g29-path12", "128S73-2,8,16-g21-path12", "128S82-4,8,16-g37-path80", "128S71-2,4,16-g13-path12", "128S80-4,4,16-g29-path172", "128S81-2,8,16-g21-path46", "128S74-4,8,16-g37-path12", "128S75-2,4,8-g9-path34" ];
