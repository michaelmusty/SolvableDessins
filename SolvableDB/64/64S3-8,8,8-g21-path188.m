...
s`SolvableDBName := "64S3-8,8,8-g21-path188";
s`SolvableDBFilename := "64S3-8,8,8-g21-path188.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 47, 9, 58, 35, 14, 33, 46, 59, 12, 57, 60, 21, 61, 13, 31, 37, 17, 19, 20, 22, 23, 10, 53, 40, 36, 11, 15, 16, 18, 25, 26, 32, 34, 38, 62, 39, 56, 45, 42, 52, 48, 43, 41, 51, 44, 54, 63, 50, 55, 64, 49 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T6-8,8,2-g3-path4", "32S4-8,8,4-g9-path17", "64S3-8,8,8-g21-path188" ];
s`SolvableDBParents := [ Strings() | "128S45-16,8,16-g49-path271", "128S45-16,8,16-g49-path272", "128S44-8,16,16-g49-path251", "128S44-8,16,16-g49-path252", "128S45-16,16,8-g49-path301", "128S45-16,16,8-g49-path302", "128S5-8,8,8-g41-path819" ];
