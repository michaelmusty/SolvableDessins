...
s`SolvableDBName := "64S4-8,8,2-g9-path36";
s`SolvableDBFilename := "64S4-8,8,2-g9-path36.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 48, 47, 24, 20, 40, 46, 39, 44, 17, 43, 49, 50, 16, 18, 8, 9, 10, 11, 12, 13, 14, 15, 25, 56, 41, 51, 60, 30, 59, 32, 62, 61, 63, 27, 42, 38, 58, 35, 54, 31, 37, 45, 26, 28, 29, 33, 34, 36, 52, 53, 57, 64, 55 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S7-8,8,2-g5-path9", "64S4-8,8,2-g9-path36" ];
s`SolvableDBParents := [ Strings() | "128S49-8,8,4-g33-path63", "128S4-8,8,4-g33-path175", "128S12-8,8,4-g33-path452", "128S51-8,8,4-g33-path63", "128S46-16,16,2-g25-path81", "128S52-16,16,4-g41-path19", "128S53-16,16,2-g25-path19", "128S47-16,16,4-g41-path65", "128S52-16,16,2-g25-path19", "128S46-16,16,4-g41-path81", "128S47-16,16,2-g25-path65", "128S53-16,16,4-g41-path19", "128S50-8,8,2-g17-path41", "128S48-8,8,2-g17-path41", "128S2-8,8,2-g17-path97" ];
