...
s`SolvableDBName := "64S8-4,4,8-g13-path29";
s`SolvableDBFilename := "64S8-4,4,8-g13-path29.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path2", "32S6-4,4,4-g5-path15", "64S8-4,4,8-g13-path29" ];
