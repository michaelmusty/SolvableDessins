...
s`SolvableDBName := "64S29-8,16,16-g25-path59";
s`SolvableDBFilename := "64S29-8,16,16-g25-path59.m";
...
\[ 6, 1, 26, 27, 23, 28, 4, 29, 2, 3, 5, 7, 8, 49, 51, 45, 42, 14, 32, 53, 37, 58, 9, 21, 57, 54, 41, 11, 17, 19, 20, 22, 18, 10, 39, 31, 12, 13, 15, 16, 24, 25, 30, 33, 34, 35, 36, 44, 61, 46, 62, 48, 63, 40, 60, 47, 38, 55, 56, 43, 52, 64, 59, 50 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T6-4,8,8-g5-path4", "32S5-4,8,8-g9-path21", "64S29-8,16,16-g25-path59" ];
s`SolvableDBParents := [ Strings() | "128S131-16,32,32-g57-path89", "128S133-16,32,32-g57-path177", "128S133-16,32,32-g57-path178", "128S132-16,32,32-g57-path89", "128S133-16,32,32-g57-path179", "128S131-16,32,32-g57-path90", "128S132-16,32,32-g57-path90", "128S133-16,32,32-g57-path180", "128S69-8,16,16-g49-path89", "128S61-8,16,16-g49-path89", "128S54-8,16,16-g49-path45", "128S61-8,16,16-g49-path90", "128S106-8,16,16-g49-path362", "128S46-8,16,16-g49-path45", "128S69-8,16,16-g49-path90" ];
