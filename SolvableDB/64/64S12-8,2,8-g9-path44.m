...
s`SolvableDBName := "64S12-8,2,8-g9-path44";
s`SolvableDBFilename := "64S12-8,2,8-g9-path44.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S9-8,2,4-g3-path8", "64S12-8,2,8-g9-path44" ];
