...
s`SolvableDBName := "64S9-4,4,8-g13-path35";
s`SolvableDBFilename := "64S9-4,4,8-g13-path35.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T12-2,4,8-g2-path3", "32S10-4,4,8-g7-path25", "64S9-4,4,8-g13-path35" ];
s`SolvableDBChildren := [ Strings() | "32S10-4,4,8-g7-path25" ];
