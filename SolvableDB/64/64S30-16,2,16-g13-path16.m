...
s`SolvableDBName := "64S30-16,2,16-g13-path16";
s`SolvableDBFilename := "64S30-16,2,16-g13-path16.m";
...
\[ 6, 1, 19, 21, 17, 22, 16, 2, 3, 4, 5, 7, 40, 45, 43, 15, 42, 49, 41, 50, 51, 52, 9, 39, 24, 8, 10, 11, 12, 13, 14, 18, 20, 23, 25, 27, 31, 37, 32, 33, 48, 47, 44, 61, 46, 60, 57, 64, 63, 58, 59, 62, 30, 28, 38, 36, 26, 29, 34, 35, 53, 54, 55, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S5-8,2,8-g5-path7", "64S30-16,2,16-g13-path16" ];
s`SolvableDBParents := [ Strings() | "128S70-16,4,16-g41-path31", "128S54-16,4,16-g41-path94", "128S70-16,4,16-g41-path32", "128S109-16,4,16-g41-path243", "128S62-16,2,16-g25-path31", "128S46-16,2,16-g25-path55", "128S62-16,2,16-g25-path32" ];
