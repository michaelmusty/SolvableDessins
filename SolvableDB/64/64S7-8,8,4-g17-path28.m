...
s`SolvableDBName := "64S7-8,8,4-g17-path28";
s`SolvableDBFilename := "64S7-8,8,4-g17-path28.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 43, 54, 16, 63, 14, 34, 47, 9, 53, 64, 31, 44, 35, 13, 12, 57, 50, 51, 58, 62, 42, 60, 41, 10, 11, 15, 17, 18, 19, 20, 21, 23, 25, 26, 32, 33, 36, 37, 49, 61, 48, 55, 40, 45, 52, 46, 59, 56, 38, 39 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T12-2,8,4-g2-path2", "32S10-4,8,4-g7-path24", "64S7-8,8,4-g17-path28" ];
s`SolvableDBParents := [ Strings() | "128S69-16,16,8-g49-path355", "128S70-16,16,8-g49-path291", "128S69-16,16,8-g49-path356", "128S70-16,16,8-g49-path292", "128S3-8,8,4-g33-path788", "128S11-8,8,4-g33-path1322", "128S4-8,8,4-g33-path338" ];
