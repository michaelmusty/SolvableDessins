...
s`SolvableDBName := "64S28-8,16,16-g25-path23";
s`SolvableDBFilename := "64S28-8,16,16-g25-path23.m";
...
\[ 24, 5, 52, 40, 6, 9, 21, 44, 11, 16, 1, 25, 26, 54, 62, 27, 46, 14, 33, 41, 28, 63, 38, 29, 4, 30, 39, 12, 2, 17, 47, 60, 55, 51, 10, 34, 42, 36, 43, 45, 53, 56, 3, 58, 7, 8, 57, 59, 48, 61, 49, 35, 32, 20, 31, 50, 22, 13, 23, 18, 64, 37, 19, 15 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T4-4,4,4-g3-path9", "32S4-4,8,8-g9-path15", "64S28-8,16,16-g25-path23" ];
s`SolvableDBParents := [ Strings() | "128S45-8,16,16-g49-path171", "128S107-8,16,16-g49-path263", "128S45-8,16,16-g49-path172" ];
