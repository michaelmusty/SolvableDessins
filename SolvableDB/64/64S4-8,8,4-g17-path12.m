...
s`SolvableDBName := "64S4-8,8,4-g17-path12";
s`SolvableDBFilename := "64S4-8,8,4-g17-path12.m";
...
\[ 44, 61, 31, 14, 30, 22, 64, 11, 21, 20, 38, 28, 27, 36, 7, 17, 42, 45, 40, 48, 49, 2, 39, 41, 16, 57, 8, 51, 4, 37, 33, 53, 43, 5, 46, 62, 6, 63, 13, 59, 60, 52, 24, 9, 50, 19, 58, 18, 12, 26, 1, 32, 56, 47, 3, 25, 10, 35, 54, 55, 34, 15, 23, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path2", "32S5-8,8,4-g9-path8", "64S4-8,8,4-g17-path12" ];
s`SolvableDBParents := [ Strings() | "128S46-16,16,8-g49-path167", "128S46-16,16,8-g49-path168", "128S52-16,16,8-g49-path43", "128S52-16,16,8-g49-path44", "128S47-16,16,8-g49-path135", "128S47-16,16,8-g49-path136", "128S53-16,16,8-g49-path43", "128S53-16,16,8-g49-path44", "128S12-8,8,4-g33-path500", "128S48-8,8,4-g33-path44", "128S49-8,8,4-g33-path111", "128S2-8,8,4-g33-path100", "128S4-8,8,4-g33-path223", "128S50-8,8,4-g33-path44", "128S51-8,8,4-g33-path111" ];
