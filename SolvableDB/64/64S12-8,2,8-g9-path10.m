...
s`SolvableDBName := "64S12-8,2,8-g9-path10";
s`SolvableDBFilename := "64S12-8,2,8-g9-path10.m";
...
\[ 6, 1, 4, 20, 18, 21, 15, 2, 3, 5, 7, 16, 17, 11, 46, 22, 42, 43, 38, 36, 47, 37, 39, 8, 9, 10, 12, 13, 14, 19, 23, 31, 40, 41, 30, 64, 58, 57, 49, 48, 44, 60, 61, 32, 54, 62, 51, 35, 34, 55, 24, 25, 26, 27, 28, 29, 33, 45, 50, 59, 63, 56, 53, 52 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S7-8,2,8-g5-path8", "64S12-8,2,8-g9-path10" ];
s`SolvableDBParents := [ Strings() | "128S2-8,4,8-g33-path75", "128S28-8,4,8-g33-path42", "128S93-16,2,8-g21-path42", "128S92-16,4,8-g37-path42", "128S92-16,2,8-g21-path42", "128S94-16,4,8-g37-path42", "128S93-8,2,16-g21-path42", "128S92-8,4,16-g37-path42", "128S92-8,2,16-g21-path42", "128S94-8,4,16-g37-path42", "128S89-16,2,16-g25-path42", "128S91-16,4,16-g41-path42", "128S91-16,2,16-g25-path42", "128S90-16,4,16-g41-path42", "128S2-8,2,8-g17-path75" ];
