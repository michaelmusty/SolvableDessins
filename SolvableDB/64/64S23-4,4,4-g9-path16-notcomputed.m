...
\[ 2, 5, 9, 7, 6, 1, 10, 11, 14, 21, 15, 29, 30, 22, 23, 31, 24, 25, 26, 12, 4, 3, 8, 19, 32, 17, 33, 34, 36, 28, 37, 50, 40, 13, 57, 20, 48, 39, 56, 51, 55, 49, 44, 46, 52, 47, 43, 16, 35, 18, 27, 54, 38, 58, 59, 53, 42, 45, 61, 64, 41, 63, 60, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T10-2,4,4-g1-path4-notcomputed", "32S6-2,4,4-g1-path2-notcomputed", "64S23-4,4,4-g9-path16-notcomputed" ];
