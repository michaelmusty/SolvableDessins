...
s`SolvableDBName := "64S43-16,4,8-g19-path4";
s`SolvableDBFilename := "64S43-16,4,8-g19-path4.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T12-8,2,4-g2-path1", "32S9-8,2,4-g3-path12", "64S43-16,4,8-g19-path4" ];
