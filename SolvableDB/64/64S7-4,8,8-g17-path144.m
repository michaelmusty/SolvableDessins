...
s`SolvableDBName := "64S7-4,8,8-g17-path144";
s`SolvableDBFilename := "64S7-4,8,8-g17-path144.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 35, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 45, 17, 43, 37, 32, 28, 13, 14, 18, 21, 29, 30, 36, 41, 31, 42, 51, 56, 34, 49, 33, 44, 48, 50, 54, 55, 53, 40, 38, 46, 47, 52, 58, 61, 62, 59, 64, 63, 60, 57 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T6-2,8,8-g3-path2", "32S5-2,8,8-g5-path20", "64S7-4,8,8-g17-path144" ];
s`SolvableDBParents := [ Strings() | "128S70-4,16,16-g41-path327", "128S70-4,16,16-g41-path328", "128S69-4,16,16-g41-path391", "128S69-4,16,16-g41-path392", "128S11-4,8,8-g33-path1395", "128S3-4,8,8-g33-path861", "128S4-4,8,8-g33-path411" ];
