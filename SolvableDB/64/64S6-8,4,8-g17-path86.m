...
s`SolvableDBName := "64S6-8,4,8-g17-path86";
s`SolvableDBFilename := "64S6-8,4,8-g17-path86.m";
...
\[ 49, 62, 50, 32, 29, 31, 48, 37, 56, 59, 47, 61, 54, 35, 64, 60, 16, 9, 53, 30, 12, 11, 25, 63, 55, 36, 34, 51, 42, 39, 45, 44, 52, 57, 43, 58, 46, 10, 3, 15, 24, 2, 13, 7, 5, 33, 18, 38, 22, 21, 40, 17, 41, 23, 14, 1, 19, 28, 4, 8, 20, 6, 27, 26 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path1", "32S9-8,2,4-g3-path2", "64S6-8,4,8-g17-path86" ];
s`SolvableDBParents := [ Strings() | "128S67-8,8,16-g45-path179", "128S67-8,8,16-g45-path180", "128S68-8,8,16-g45-path179", "128S68-8,8,16-g45-path180", "128S63-16,4,8-g37-path79", "128S61-16,8,16-g49-path417", "128S64-16,4,8-g37-path170", "128S61-16,8,16-g49-path418", "128S65-16,4,8-g37-path73", "128S62-16,8,16-g49-path353", "128S66-16,4,8-g37-path158", "128S62-16,8,16-g49-path354", "128S11-8,4,8-g33-path1213", "128S2-8,4,8-g33-path208", "128S3-8,4,8-g33-path679" ];
