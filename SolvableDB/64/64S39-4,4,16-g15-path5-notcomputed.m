...
s`SolvableDBName := "64S39-4,4,16-g15-path5-notcomputed";
s`SolvableDBFilename := "64S39-4,4,16-g15-path5-notcomputed.m";
...
\[ 2, 5, 9, 7, 6, 1, 10, 11, 14, 21, 15, 16, 30, 22, 23, 31, 24, 25, 26, 12, 4, 3, 8, 19, 32, 17, 18, 33, 34, 28, 20, 27, 13, 38, 39, 47, 42, 41, 37, 43, 29, 35, 48, 40, 49, 50, 45, 44, 36, 53, 55, 63, 58, 57, 54, 59, 51, 46, 62, 56, 64, 60, 61, 52 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T4-2,4,2-g0-path2-notcomputed", "16T10-2,4,4-g1-path5-notcomputed", "32S9-2,4,8-g3-path3-notcomputed", "64S39-4,4,16-g15-path5-notcomputed" ];
s`SolvableDBParents := [ Strings() | "128S94-4,8,16-g37-path4-notcomputed", "128S64-4,8,16-g37-path1-notcomputed", "128S97-4,8,16-g37-path4-notcomputed", "128S64-4,8,16-g37-path2-notcomputed", "128S80-4,4,16-g29-path1-notcomputed", "128S112-4,4,16-g29-path13-notcomputed", "128S80-4,4,16-g29-path2-notcomputed" ];
