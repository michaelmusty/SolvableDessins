...
{ IntegerRing() | 48, 60 }
@};
s`SolvableDBBelyiMapTiming := 4.520p15;
s`SolvableDBLocalSanityCheckTiming := 17.430p15;
...
s`SolvableDBParents := [ Strings() | "128S3-8,4,8-g33-path75", "128S86-8,4,8-g33-path11", "128S4-8,4,8-g33-path33", "128S85-8,4,8-g33-path11", "128S84-4,4,8-g25-path14", "128S26-4,4,8-g25-path42", "128S83-4,4,8-g25-path14" ];
