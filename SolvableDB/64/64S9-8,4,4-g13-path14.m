...
s`SolvableDBName := "64S9-8,4,4-g13-path14";
s`SolvableDBFilename := "64S9-8,4,4-g13-path14.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path2", "32S10-8,4,4-g7-path15", "64S9-8,4,4-g13-path14" ];
s`SolvableDBChildren := [ Strings() | "32S10-8,4,4-g7-path15" ];
