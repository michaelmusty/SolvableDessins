...
s`SolvableDBName := "64S39-16,4,4-g15-path11";
s`SolvableDBFilename := "64S39-16,4,4-g15-path11.m";
...
\[ 6, 1, 23, 24, 22, 25, 4, 26, 2, 3, 5, 7, 8, 21, 13, 14, 43, 30, 17, 19, 42, 40, 29, 39, 44, 45, 18, 20, 46, 41, 9, 10, 11, 12, 15, 16, 27, 28, 59, 57, 58, 56, 55, 60, 61, 62, 31, 32, 33, 34, 35, 36, 37, 38, 51, 47, 64, 63, 48, 52, 54, 50, 49, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T13-8,2,2-g0-path3", "32S20-16,4,4-g8-path3", "64S39-16,4,4-g15-path11" ];
s`SolvableDBParents := [ Strings() | "128S64-16,4,8-g37-path7", "128S94-16,4,8-g37-path49", "128S64-16,4,8-g37-path8", "128S97-16,4,8-g37-path49", "128S80-16,4,4-g29-path27", "128S112-16,4,4-g29-path243", "128S80-16,4,4-g29-path28" ];
