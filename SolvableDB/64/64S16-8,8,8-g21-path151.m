...
s`SolvableDBName := "64S16-8,8,8-g21-path151";
s`SolvableDBFilename := "64S16-8,8,8-g21-path151.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path25", "32S14-4,4,8-g7-path15", "64S16-8,8,8-g21-path151" ];
s`SolvableDBChildren := [ Strings() | "32S14-4,4,8-g7-path15" ];
