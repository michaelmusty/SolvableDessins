...
s`SolvableDBName := "64S16-8,8,8-g21-path276";
s`SolvableDBFilename := "64S16-8,8,8-g21-path276.m";
...
\[ 51, 63, 15, 21, 34, 36, 30, 33, 54, 38, 42, 48, 45, 47, 49, 50, 5, 8, 3, 44, 31, 9, 56, 4, 57, 60, 13, 12, 19, 58, 7, 53, 10, 59, 24, 17, 18, 26, 32, 14, 62, 27, 11, 64, 23, 16, 29, 22, 40, 55, 28, 25, 41, 1, 20, 43, 39, 35, 2, 37, 46, 52, 6, 61 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path29", "32S15-8,8,8-g11-path48", "64S16-8,8,8-g21-path276" ];
s`SolvableDBParents := [ Strings() | "128S102-8,16,16-g49-path129", "128S102-8,16,16-g49-path130", "128S103-16,8,8-g45-path65", "128S104-16,8,8-g45-path65", "128S105-16,16,16-g53-path279", "128S105-16,16,16-g53-path280", "128S9-8,8,8-g41-path446" ];
