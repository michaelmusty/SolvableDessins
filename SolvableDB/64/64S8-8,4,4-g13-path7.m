...
phi := KX!((2*x[3]^6 + 2*x[3]^2)/(x[3]^8 - 4*x[3]^6 + 6*x[3]^4 - 4*x[3]^2 + 1)*x[2]^2 + (x[3]^16 - 4*x[3]^14 - 12*x[3]^12 + 4*x[3]^10 - 42*x[3]^8 + 4*x[3]^6 - 12*x[3]^4 - 4*x[3]^2 + 1)/(x[3]^16 - 4*x[3]^12 + 6*x[3]^8 - 4*x[3]^4 + 1));
/* assign to object */
...
s`SolvableDBName := "64S8-8,4,4-g13-path7";
s`SolvableDBFilename := "64S8-8,4,4-g13-path7.m";
...
\[ 49, 62, 50, 31, 28, 30, 48, 36, 56, 59, 47, 61, 54, 34, 64, 60, 16, 9, 53, 29, 12, 11, 25, 63, 55, 35, 33, 42, 39, 45, 44, 52, 58, 43, 57, 46, 51, 10, 3, 15, 24, 2, 13, 7, 5, 32, 18, 38, 22, 21, 40, 17, 41, 23, 14, 1, 37, 19, 4, 8, 20, 6, 27, 26 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T13-8,2,2-g0-path1", "32S9-8,2,4-g3-path5", "64S8-8,4,4-g13-path7" ];
s`SolvableDBParents := [ Strings() | "128S2-8,4,8-g33-path19", "128S3-8,4,8-g33-path70", "128S77-8,4,8-g33-path8", "128S78-8,4,8-g33-path18", "128S79-16,4,4-g29-path9", "128S81-16,4,8-g37-path3", "128S80-16,4,4-g29-path23", "128S82-16,4,8-g37-path8", "128S71-16,4,4-g29-path1", "128S73-16,4,8-g37-path1", "128S72-16,4,4-g29-path7", "128S74-16,4,8-g37-path4", "128S26-8,4,4-g25-path31", "128S75-8,4,4-g25-path5", "128S76-8,4,4-g25-path15" ];
