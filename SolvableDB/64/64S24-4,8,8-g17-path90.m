...
s`SolvableDBName := "64S24-4,8,8-g17-path90";
s`SolvableDBFilename := "64S24-4,8,8-g17-path90.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 51, 35, 9, 33, 24, 25, 10, 26, 27, 15, 12, 20, 34, 17, 16, 18, 32, 48, 13, 14, 21, 28, 29, 30, 36, 60, 53, 31, 42, 43, 55, 57, 46, 49, 52, 37, 50, 45, 40, 58, 44, 47, 41, 38, 39, 54, 56, 59, 62, 64, 61, 63 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path7", "32S7-2,8,8-g5-path10", "64S24-4,8,8-g17-path90" ];
s`SolvableDBParents := [ Strings() | "128S15-8,8,8-g41-path1433", "128S24-8,8,8-g41-path828", "128S15-8,8,8-g41-path1434", "128S22-8,8,8-g41-path588", "128S31-8,8,8-g41-path1307", "128S41-8,8,8-g41-path36", "128S31-8,8,8-g41-path1308", "128S39-8,8,8-g41-path36", "128S17-4,8,8-g33-path439", "128S12-4,8,8-g33-path366", "128S17-4,8,8-g33-path440", "128S28-4,8,8-g33-path582", "128S37-4,8,8-g33-path277", "128S27-4,8,8-g33-path374", "128S37-4,8,8-g33-path278" ];
s`SolvableDBChild := "32S7-2,8,8-g5-path10";
