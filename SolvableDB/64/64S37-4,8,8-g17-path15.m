...
s`SolvableDBName := "64S37-4,8,8-g17-path15";
s`SolvableDBFilename := "64S37-4,8,8-g17-path15.m";
...
\[ 22, 5, 59, 40, 6, 39, 4, 60, 12, 18, 24, 1, 11, 15, 29, 20, 50, 27, 41, 63, 46, 9, 64, 28, 45, 58, 51, 13, 53, 21, 23, 25, 26, 44, 37, 43, 57, 7, 2, 38, 8, 33, 55, 3, 54, 61, 35, 16, 31, 52, 10, 62, 14, 32, 56, 36, 47, 42, 34, 19, 30, 17, 48, 49 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path3", "32S6-4,4,4-g5-path5", "64S37-4,8,8-g17-path15" ];
s`SolvableDBParents := [ Strings() | "128S78-4,8,8-g33-path85", "128S78-4,8,8-g33-path86", "128S51-4,8,8-g33-path43", "128S57-4,8,8-g33-path43", "128S86-4,8,8-g33-path85", "128S86-4,8,8-g33-path86", "128S126-4,8,8-g33-path249" ];
