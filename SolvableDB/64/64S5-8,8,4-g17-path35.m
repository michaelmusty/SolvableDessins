...
s`SolvableDBName := "64S5-8,8,4-g17-path35";
s`SolvableDBFilename := "64S5-8,8,4-g17-path35.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S5-8,8,4-g9-path2", "64S5-8,8,4-g17-path35" ];
