...
s`SolvableDBName := "64S40-2,8,16-g11-path9";
s`SolvableDBFilename := "64S40-2,8,16-g11-path9.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path3", "32S9-2,4,8-g3-path17", "64S40-2,8,16-g11-path9" ];
