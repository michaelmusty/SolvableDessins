...
s`SolvableDBName := "64S31-16,16,2-g13-path42";
s`SolvableDBFilename := "64S31-16,16,2-g13-path42.m";
...
\[ 6, 1, 21, 22, 19, 23, 13, 2, 3, 4, 5, 7, 33, 49, 14, 48, 50, 32, 46, 31, 47, 44, 45, 27, 38, 8, 9, 10, 11, 12, 15, 16, 17, 18, 20, 24, 25, 43, 41, 56, 42, 59, 39, 40, 64, 63, 60, 62, 58, 61, 35, 34, 26, 28, 29, 30, 36, 37, 51, 52, 54, 57, 53, 55 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T6-8,8,2-g3-path3", "32S5-8,8,2-g5-path21", "64S31-16,16,2-g13-path42" ];
s`SolvableDBParents := [ Strings() | "128S111-16,16,4-g41-path459", "128S55-16,16,4-g41-path5", "128S69-16,16,4-g41-path161", "128S70-16,16,4-g41-path97", "128S47-16,16,2-g25-path5", "128S61-16,16,2-g25-path83", "128S62-16,16,2-g25-path51" ];
