...
s`SolvableDBName := "64S46-4,16,8-g19-path2";
s`SolvableDBFilename := "64S46-4,16,8-g19-path2.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T12-2,8,4-g2-path1", "32S13-4,8,4-g7-path1", "64S46-4,16,8-g19-path2" ];
