...
s`SolvableDBName := "64S26-16,16,8-g25-path44";
s`SolvableDBFilename := "64S26-16,16,8-g25-path44.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 37, 39, 41, 13, 40, 42, 43, 17, 45, 18, 14, 47, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 51, 59, 54, 35, 60, 36, 56, 38, 57, 32, 58, 34, 61, 44, 27, 28, 29, 30, 31, 33, 46, 48, 63, 49, 64, 62, 50, 52, 53, 55 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T4-4,4,4-g3-path2", "32S3-8,8,4-g9-path3", "64S26-16,16,8-g25-path44" ];
s`SolvableDBParents := [ Strings() | "128S128-32,32,16-g57-path43", "128S129-32,32,16-g57-path43", "128S128-32,32,16-g57-path44", "128S129-32,32,16-g57-path44", "128S106-16,16,8-g49-path249", "128S42-16,16,8-g49-path69", "128S44-16,16,8-g49-path69" ];
