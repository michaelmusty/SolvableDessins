...
s`SolvableDBName := "64S39-16,4,4-g15-path27";
s`SolvableDBFilename := "64S39-16,4,4-g15-path27.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S9-8,2,4-g3-path7", "64S39-16,4,4-g15-path27" ];
