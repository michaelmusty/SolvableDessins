...
s`SolvableDBName := "64S30-16,16,2-g13-path22";
s`SolvableDBFilename := "64S30-16,16,2-g13-path22.m";
...
\[ 6, 1, 21, 22, 19, 23, 13, 2, 3, 4, 5, 7, 47, 49, 14, 46, 50, 9, 48, 42, 51, 17, 52, 36, 37, 8, 10, 11, 12, 15, 16, 18, 20, 24, 25, 31, 30, 40, 61, 41, 60, 38, 39, 57, 64, 45, 43, 44, 63, 58, 59, 62, 27, 28, 33, 32, 26, 29, 34, 35, 53, 54, 55, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T6-8,8,2-g3-path5", "32S5-8,8,2-g5-path19", "64S30-16,16,2-g13-path22" ];
s`SolvableDBParents := [ Strings() | "128S54-16,16,4-g41-path84", "128S70-16,16,4-g41-path11", "128S109-16,16,4-g41-path233", "128S70-16,16,4-g41-path12", "128S62-16,16,2-g25-path11", "128S46-16,16,2-g25-path45", "128S62-16,16,2-g25-path12" ];
