...
s`SolvableDBName := "64S8-2,8,4-g5-path25";
s`SolvableDBFilename := "64S8-2,8,4-g5-path25.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 25, 26, 27, 28, 21, 22, 19, 23, 17, 29, 15, 16, 18, 30, 11, 12, 13, 14, 20, 24, 46, 47, 44, 48, 49, 41, 43, 50, 42, 45, 36, 39, 37, 33, 40, 31, 32, 34, 35, 38, 54, 62, 60, 51, 59, 63, 61, 64, 55, 53, 57, 52, 56, 58 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T12-2,8,4-g2-path3", "32S9-2,8,4-g3-path14", "64S8-2,8,4-g5-path25" ];
s`SolvableDBParents := [ Strings() | "128S76-4,8,4-g25-path109", "128S2-2,8,8-g17-path285", "128S78-4,8,8-g33-path148", "128S26-4,8,4-g25-path799", "128S77-2,8,8-g17-path104", "128S3-4,8,8-g33-path960", "128S79-2,16,4-g13-path61", "128S72-4,16,4-g29-path21", "128S81-2,16,8-g21-path55", "128S74-4,16,8-g37-path21", "128S71-2,16,4-g13-path21", "128S80-4,16,4-g29-path181", "128S73-2,16,8-g21-path21", "128S82-4,16,8-g37-path89", "128S75-2,8,4-g9-path43" ];
