...
s`SolvableDBName := "64S15-8,8,8-g21-path225";
s`SolvableDBFilename := "64S15-8,8,8-g21-path225.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T12-8,2,4-g2-path2", "32S13-8,4,4-g7-path2", "64S15-8,8,8-g21-path225" ];
