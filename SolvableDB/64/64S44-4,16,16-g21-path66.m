...
s`SolvableDBName := "64S44-4,16,16-g21-path66";
s`SolvableDBFilename := "64S44-4,16,16-g21-path66.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 36, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 45, 17, 43, 30, 32, 37, 13, 14, 18, 21, 28, 29, 35, 41, 31, 42, 51, 56, 34, 46, 33, 49, 48, 50, 54, 55, 52, 38, 40, 44, 47, 53, 58, 61, 60, 62, 63, 64, 57, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-2,8,8-g3-path4", "32S17-2,16,16-g7-path1", "64S44-4,16,16-g21-path66" ];
s`SolvableDBParents := [ Strings() | "128S153-8,32,32-g53-path55", "128S154-4,32,32-g45-path55", "128S102-8,16,16-g49-path266", "128S153-8,32,32-g53-path56", "128S154-4,32,32-g45-path56", "128S99-8,16,16-g49-path266", "128S106-4,16,16-g41-path457" ];
