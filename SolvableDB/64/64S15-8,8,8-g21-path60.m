...
\[ 6, 1, 24, 25, 22, 26, 4, 23, 2, 3, 5, 7, 8, 15, 48, 28, 45, 29, 44, 49, 41, 19, 17, 42, 47, 50, 16, 20, 21, 10, 14, 11, 9, 12, 13, 18, 27, 30, 31, 32, 46, 61, 54, 58, 43, 59, 60, 62, 64, 53, 36, 34, 33, 35, 37, 38, 39, 40, 51, 52, 56, 63, 57, 55 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T6-8,4,8-g5-path1", "32S12-8,4,8-g9-path24", "64S15-8,8,8-g21-path60" ];
s`SolvableDBParents := [ Strings() | "128S100-8,16,8-g45-path103", "128S100-8,16,8-g45-path104", "128S99-16,8,16-g49-path103", "128S101-16,16,16-g53-path333", "128S99-16,8,16-g49-path104", "128S101-16,16,16-g53-path334", "128S9-8,8,8-g41-path167" ];
