...
s`SolvableDBName := "64S23-4,4,4-g9-path48";
s`SolvableDBFilename := "64S23-4,4,4-g9-path48.m";
...
\[ 12, 37, 41, 7, 2, 5, 36, 39, 22, 50, 13, 9, 28, 55, 14, 53, 54, 10, 63, 59, 30, 1, 31, 11, 32, 16, 18, 24, 15, 56, 58, 61, 62, 23, 64, 38, 6, 4, 19, 35, 33, 26, 25, 47, 21, 20, 51, 44, 17, 27, 48, 49, 42, 52, 29, 45, 40, 34, 60, 46, 43, 3, 8, 57 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T4-4,4,4-g3-path9", "32S2-4,4,4-g5-path48", "64S23-4,4,4-g9-path48" ];
s`SolvableDBParents := [ Strings() | "128S26-8,4,4-g25-path658", "128S26-4,8,4-g25-path656", "128S12-8,8,4-g33-path269", "128S29-4,4,8-g25-path248", "128S14-8,4,8-g33-path538", "128S14-4,8,8-g33-path540", "128S30-8,8,8-g41-path746", "128S16-8,4,4-g25-path454", "128S16-4,8,4-g25-path452", "128S38-8,8,4-g33-path42", "128S21-4,4,8-g25-path306", "128S37-8,4,8-g33-path84", "128S37-4,8,8-g33-path86", "128S25-8,8,8-g41-path680", "128S122-8,4,4-g25-path171", "128S122-4,8,4-g25-path167", "128S126-8,8,4-g33-path83", "128S123-4,4,8-g25-path83", "128S127-8,4,8-g33-path167", "128S127-4,8,8-g33-path171", "128S124-8,8,8-g41-path255", "128S122-8,4,4-g25-path172", "128S122-4,8,4-g25-path168", "128S126-8,8,4-g33-path84", "128S123-4,4,8-g25-path84", "128S127-8,4,8-g33-path168", "128S127-4,8,8-g33-path172", "128S124-8,8,8-g41-path256", "128S36-4,4,4-g17-path128", "128S125-4,4,4-g17-path255", "128S125-4,4,4-g17-path256" ];
