...
s`SolvableDBName := "64S21-8,4,4-g13-path22-notcomputed";
s`SolvableDBFilename := "64S21-8,4,4-g13-path22-notcomputed.m";
...
\[ 49, 62, 54, 33, 30, 32, 52, 35, 56, 61, 50, 47, 59, 53, 64, 48, 60, 63, 27, 9, 34, 38, 13, 12, 17, 31, 55, 10, 36, 41, 46, 44, 39, 57, 45, 58, 51, 43, 7, 18, 2, 15, 16, 5, 11, 3, 20, 28, 24, 23, 42, 25, 40, 19, 26, 1, 14, 37, 8, 4, 22, 6, 21, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T13-8,2,2-g0-path1-notcomputed", "32S9-8,4,2-g3-path5-notcomputed", "64S21-8,4,4-g13-path22-notcomputed" ];
