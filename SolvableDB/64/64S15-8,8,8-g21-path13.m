...
\[ 6, 1, 8, 24, 20, 25, 22, 26, 2, 3, 4, 5, 7, 30, 31, 14, 16, 32, 28, 9, 23, 19, 36, 13, 12, 17, 29, 11, 43, 10, 34, 37, 15, 18, 21, 27, 40, 39, 51, 33, 42, 52, 44, 35, 47, 48, 54, 55, 50, 45, 41, 56, 38, 46, 49, 53, 59, 60, 63, 64, 62, 57, 58, 61 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T8-4,4,4-g3-path1", "32S12-4,8,8-g9-path39", "64S15-8,8,8-g21-path13" ];
s`SolvableDBParents := [ Strings() | "128S101-16,16,16-g53-path11", "128S101-16,16,16-g53-path12", "128S99-8,16,16-g49-path3", "128S100-16,8,8-g45-path3", "128S100-16,8,8-g45-path4", "128S99-8,16,16-g49-path4", "128S9-8,8,8-g41-path6" ];
