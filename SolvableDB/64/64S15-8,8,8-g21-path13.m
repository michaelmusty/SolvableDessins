...
s`SolvableDBName := "64S15-8,8,8-g21-path13";
s`SolvableDBFilename := "64S15-8,8,8-g21-path13.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T6-4,8,8-g5-path1", "32S12-4,8,8-g9-path20", "64S15-8,8,8-g21-path13" ];
