...
\[ 10, 5, 28, 6, 2, 4, 26, 16, 11, 1, 9, 13, 12, 17, 44, 8, 14, 21, 22, 23, 18, 19, 20, 31, 38, 7, 33, 3, 30, 29, 24, 34, 27, 32, 37, 49, 35, 25, 40, 39, 48, 46, 55, 15, 47, 42, 45, 41, 36, 51, 50, 54, 64, 52, 43, 58, 59, 56, 57, 62, 63, 60, 61, 53 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S9-2,4,8-g3-path1", "64S40-2,8,16-g11-path16" ];
s`SolvableDBParents := [ Strings() | "128S114-4,8,16-g37-path199", "128S95-4,8,16-g37-path106", "128S64-4,8,16-g37-path62", "128S82-4,8,16-g37-path16", "128S92-2,8,16-g21-path61", "128S63-2,8,16-g21-path39", "128S81-2,8,16-g21-path16" ];
