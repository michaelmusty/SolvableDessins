...
s`SolvableDBName := "64S15-8,8,8-g21-path171";
s`SolvableDBFilename := "64S15-8,8,8-g21-path171.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T8-4,4,4-g3-path13", "32S13-4,4,8-g7-path9", "64S15-8,8,8-g21-path171" ];
