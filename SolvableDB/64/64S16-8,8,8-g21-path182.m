...
s`SolvableDBName := "64S16-8,8,8-g21-path182";
s`SolvableDBFilename := "64S16-8,8,8-g21-path182.m";
...
\[ 6, 1, 23, 13, 21, 24, 4, 22, 2, 3, 5, 7, 8, 43, 32, 26, 29, 27, 10, 34, 9, 17, 33, 11, 16, 19, 20, 31, 12, 14, 15, 18, 25, 28, 59, 48, 45, 49, 30, 50, 46, 44, 42, 37, 39, 36, 35, 38, 40, 41, 56, 63, 61, 51, 47, 64, 62, 60, 58, 53, 55, 52, 54, 57 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T8-4,4,4-g3-path9", "32S14-4,8,4-g7-path8", "64S16-8,8,8-g21-path182" ];
s`SolvableDBParents := [ Strings() | "128S102-16,8,16-g49-path179", "128S102-16,8,16-g49-path180", "128S103-8,16,8-g45-path90", "128S104-8,16,8-g45-path90", "128S105-16,16,16-g53-path507", "128S105-16,16,16-g53-path508", "128S9-8,8,8-g41-path560" ];
s`SolvableDBChild := "32S14-4,8,4-g7-path8";
