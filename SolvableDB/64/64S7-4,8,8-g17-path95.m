...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S11-4,4,8-g7-path3", "64S7-4,8,8-g17-path95" ];
s`SolvableDBChildren := [ Strings() | "32S11-4,4,8-g7-path3" ];
