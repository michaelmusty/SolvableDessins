...
s`SolvableDBName := "64S10-4,8,8-g17-path2";
s`SolvableDBFilename := "64S10-4,8,8-g17-path2.m";
...
s`SolvableDBLocalSanityCheckTiming := 3.890p15;
...
s`SolvableDBParents := [ Strings() | "128S87-4,16,16-g41-path1", "128S88-4,16,16-g41-path7", "128S87-4,16,16-g41-path2", "128S88-4,16,16-g41-path8", "128S4-4,8,8-g33-path4", "128S2-4,8,8-g33-path1", "128S27-4,8,8-g33-path4" ];
