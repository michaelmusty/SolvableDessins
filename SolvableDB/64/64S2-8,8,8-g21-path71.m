...
s`SolvableDBName := "64S2-8,8,8-g21-path71";
s`SolvableDBFilename := "64S2-8,8,8-g21-path71.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 37, 39, 41, 13, 40, 42, 43, 17, 45, 18, 14, 47, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 59, 61, 62, 35, 63, 36, 64, 38, 58, 32, 60, 34, 49, 44, 27, 28, 29, 30, 31, 33, 46, 48, 50, 51, 53, 57, 54, 55, 56, 52 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path3", "32S3-8,8,4-g9-path26", "64S2-8,8,8-g21-path71" ];
s`SolvableDBParents := [ Strings() | "128S42-8,16,16-g49-path111", "128S43-8,16,16-g49-path103", "128S42-16,8,16-g49-path111", "128S43-16,8,16-g49-path103", "128S42-16,16,8-g49-path111", "128S43-16,16,8-g49-path103", "128S5-8,8,8-g41-path698" ];
