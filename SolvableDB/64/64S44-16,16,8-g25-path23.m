...
\[ 6, 1, 12, 26, 23, 27, 4, 28, 2, 3, 5, 7, 8, 42, 40, 18, 9, 30, 51, 56, 61, 55, 57, 20, 58, 53, 22, 16, 19, 21, 10, 44, 37, 32, 11, 13, 14, 15, 17, 24, 25, 29, 31, 33, 34, 62, 50, 35, 36, 59, 64, 39, 54, 38, 48, 43, 52, 47, 49, 63, 41, 45, 46, 60 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T8-4,4,4-g3-path17", "32S12-8,8,4-g9-path44", "64S44-16,16,8-g25-path23" ];
s`SolvableDBParents := [ Strings() | "128S153-32,32,16-g57-path51", "128S153-32,32,16-g57-path52", "128S154-32,32,16-g57-path51", "128S154-32,32,16-g57-path52", "128S106-16,16,8-g49-path421", "128S102-16,16,8-g49-path308", "128S99-16,16,8-g49-path308" ];
