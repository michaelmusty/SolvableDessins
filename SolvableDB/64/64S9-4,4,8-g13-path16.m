...
\[ 12, 38, 43, 7, 2, 5, 37, 40, 22, 51, 13, 9, 28, 58, 14, 20, 59, 10, 61, 64, 30, 1, 31, 11, 32, 16, 18, 24, 15, 62, 57, 60, 55, 63, 54, 17, 39, 6, 4, 19, 44, 35, 33, 56, 25, 49, 21, 41, 34, 42, 27, 23, 36, 50, 3, 48, 52, 29, 53, 45, 8, 47, 46, 26 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S10-4,4,8-g7-path15", "64S9-4,4,8-g13-path16" ];
s`SolvableDBParents := [ Strings() | "128S86-8,4,8-g33-path90", "128S4-8,4,8-g33-path452", "128S3-8,4,8-g33-path1058", "128S85-8,4,8-g33-path90", "128S83-4,4,8-g25-path98", "128S84-4,4,8-g25-path98", "128S26-4,4,8-g25-path944" ];
