...
s`SolvableDBName := "64S23-4,4,4-g9-path8-notcomputed";
s`SolvableDBFilename := "64S23-4,4,4-g9-path8-notcomputed.m";
...
\[ 12, 38, 43, 7, 2, 5, 37, 41, 22, 33, 13, 9, 28, 19, 14, 58, 61, 10, 29, 60, 30, 1, 31, 11, 32, 16, 18, 24, 15, 25, 64, 21, 27, 57, 63, 53, 39, 6, 4, 44, 40, 56, 36, 8, 26, 50, 51, 52, 20, 48, 34, 46, 3, 59, 23, 54, 47, 45, 42, 62, 35, 49, 17, 55 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T10-2,4,4-g1-path4-notcomputed", "32S2-4,4,4-g5-path2-notcomputed", "64S23-4,4,4-g9-path8-notcomputed" ];
