...
s`SolvableDBName := "64S40-16,8,2-g11-path4";
s`SolvableDBFilename := "64S40-16,8,2-g11-path4.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 34, 12, 24, 20, 41, 40, 37, 39, 17, 38, 42, 43, 16, 18, 8, 9, 10, 11, 13, 14, 15, 25, 52, 31, 59, 57, 58, 55, 36, 60, 61, 62, 26, 27, 28, 29, 30, 32, 33, 35, 56, 50, 51, 44, 64, 63, 54, 47, 45, 49, 46, 48, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T12-8,4,2-g2-path3", "32S9-8,4,2-g3-path14", "64S40-16,8,2-g11-path4" ];
s`SolvableDBParents := [ Strings() | "128S114-16,8,4-g37-path193", "128S95-16,8,4-g37-path100", "128S64-16,8,4-g37-path56", "128S82-16,8,4-g37-path10", "128S92-16,8,2-g21-path55", "128S63-16,8,2-g21-path33", "128S81-16,8,2-g21-path10" ];
