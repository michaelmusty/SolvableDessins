...
s`SolvableDBName := "64S41-4,2,16-g7-path16";
s`SolvableDBFilename := "64S41-4,2,16-g7-path16.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S9-4,2,8-g3-path8", "64S41-4,2,16-g7-path16" ];
