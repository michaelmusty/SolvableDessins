...
s`SolvableDBName := "64S9-4,8,4-g13-path88";
s`SolvableDBFilename := "64S9-4,8,4-g13-path88.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path5", "32S11-4,8,2-g3-path7", "64S9-4,8,4-g13-path88" ];
s`SolvableDBChildren := [ Strings() | "32S11-4,8,2-g3-path7" ];
