...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 45, 47, 17, 35, 14, 21, 51, 22, 56, 50, 38, 54, 57, 19, 20, 23, 10, 44, 31, 9, 11, 12, 13, 18, 27, 28, 29, 30, 32, 36, 33, 34, 61, 40, 43, 46, 53, 62, 48, 64, 63, 49, 59, 39, 52, 55, 37, 41, 42, 58, 60 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,4,8-g5-path7", "32S16-16,8,16-g13-path18", "64S44-16,8,16-g25-path49" ];
s`SolvableDBParents := [ Strings() | "128S153-32,16,32-g57-path91", "128S154-32,16,32-g57-path91", "128S153-32,16,32-g57-path92", "128S154-32,16,32-g57-path92", "128S102-16,8,16-g49-path328", "128S106-16,8,16-g49-path441", "128S99-16,8,16-g49-path328" ];
