...
s`SolvableDBName := "64S6-4,8,8-g17-path92";
s`SolvableDBFilename := "64S6-4,8,8-g17-path92.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path1", "32S9-2,8,4-g3-path15", "64S6-4,8,8-g17-path92" ];
s`SolvableDBChildren := [ Strings() | "32S9-2,8,4-g3-path15" ];
