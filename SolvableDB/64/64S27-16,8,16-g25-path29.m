...
s`SolvableDBName := "64S27-16,8,16-g25-path29";
s`SolvableDBFilename := "64S27-16,8,16-g25-path29.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 28, 41, 17, 48, 14, 21, 45, 22, 49, 44, 42, 47, 50, 19, 20, 23, 10, 29, 31, 9, 11, 12, 13, 18, 27, 30, 32, 61, 43, 56, 46, 58, 59, 60, 62, 63, 64, 37, 38, 33, 34, 35, 36, 39, 40, 51, 52, 53, 57, 55, 54 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T4-4,4,4-g3-path8", "32S3-8,4,8-g9-path12", "64S27-16,8,16-g25-path29" ];
s`SolvableDBParents := [ Strings() | "128S130-32,16,32-g57-path141", "128S130-32,16,32-g57-path142", "128S130-32,16,32-g57-path143", "128S130-32,16,32-g57-path144", "128S106-16,8,16-g49-path310", "128S44-16,8,16-g49-path173", "128S43-16,8,16-g49-path79" ];
