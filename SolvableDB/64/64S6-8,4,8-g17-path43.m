...
s`SolvableDBName := "64S6-8,4,8-g17-path43";
s`SolvableDBFilename := "64S6-8,4,8-g17-path43.m";
...
\[ 36, 49, 21, 39, 22, 9, 57, 48, 52, 24, 14, 16, 58, 23, 55, 4, 45, 5, 17, 61, 56, 43, 38, 26, 19, 37, 12, 2, 32, 42, 63, 64, 40, 47, 62, 28, 44, 18, 41, 59, 7, 60, 11, 3, 30, 25, 50, 51, 6, 20, 13, 1, 31, 15, 33, 10, 27, 29, 35, 46, 53, 54, 34, 8 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S5-8,4,8-g9-path6", "64S6-8,4,8-g17-path43" ];
s`SolvableDBParents := [ Strings() | "128S67-8,8,16-g45-path175", "128S67-8,8,16-g45-path176", "128S68-8,8,16-g45-path175", "128S68-8,8,16-g45-path176", "128S63-16,4,8-g37-path77", "128S61-16,8,16-g49-path411", "128S64-16,4,8-g37-path168", "128S61-16,8,16-g49-path412", "128S65-16,4,8-g37-path71", "128S62-16,8,16-g49-path347", "128S66-16,4,8-g37-path156", "128S62-16,8,16-g49-path348", "128S11-8,4,8-g33-path1210", "128S2-8,4,8-g33-path205", "128S3-8,4,8-g33-path676" ];
