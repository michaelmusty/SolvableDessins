...
s`SolvableDBName := "64S31-16,8,16-g25-path17";
s`SolvableDBFilename := "64S31-16,8,16-g25-path17.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path2", "32S5-8,4,8-g9-path13", "64S31-16,8,16-g25-path17" ];
