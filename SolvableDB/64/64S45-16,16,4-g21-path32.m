...
s`SolvableDBName := "64S45-16,16,4-g21-path32";
s`SolvableDBFilename := "64S45-16,16,4-g21-path32.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T8-4,4,4-g3-path16", "32S12-8,8,4-g9-path36", "64S45-16,16,4-g21-path32" ];
