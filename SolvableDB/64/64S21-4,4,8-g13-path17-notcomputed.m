...
s`SolvableDBName := "64S21-4,4,8-g13-path17-notcomputed";
s`SolvableDBFilename := "64S21-4,4,8-g13-path17-notcomputed.m";
...
\[ 2, 5, 9, 10, 6, 1, 4, 11, 15, 19, 12, 23, 21, 30, 22, 13, 26, 27, 7, 24, 31, 3, 8, 17, 18, 20, 32, 33, 34, 28, 16, 25, 14, 35, 41, 42, 47, 39, 36, 44, 29, 38, 40, 48, 49, 50, 45, 43, 37, 51, 58, 57, 62, 55, 52, 60, 54, 46, 56, 63, 64, 61, 59, 53 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T10-2,4,4-g1-path4-notcomputed", "32S9-2,4,8-g3-path2-notcomputed", "64S21-4,4,8-g13-path17-notcomputed" ];
