...
s`SolvableDBName := "64S3-8,8,8-g21-path178";
s`SolvableDBFilename := "64S3-8,8,8-g21-path178.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 47, 9, 59, 35, 14, 33, 46, 53, 12, 58, 60, 21, 61, 13, 31, 37, 17, 19, 20, 22, 23, 10, 52, 40, 36, 11, 15, 16, 18, 25, 26, 32, 34, 38, 54, 39, 55, 42, 51, 48, 62, 41, 43, 45, 57, 44, 63, 50, 56, 64, 49 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T4-4,4,4-g3-path5", "32S4-8,4,8-g9-path7", "64S3-8,8,8-g21-path178" ];
s`SolvableDBParents := [ Strings() | "128S45-16,8,16-g49-path291", "128S45-16,8,16-g49-path292", "128S44-8,16,16-g49-path261", "128S44-8,16,16-g49-path262", "128S45-16,16,8-g49-path311", "128S45-16,16,8-g49-path312", "128S5-8,8,8-g41-path829" ];
