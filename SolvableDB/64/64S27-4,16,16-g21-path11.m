...
s`SolvableDBName := "64S27-4,16,16-g21-path11";
s`SolvableDBFilename := "64S27-4,16,16-g21-path11.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T5-2,8,8-g3-path4", "32S17-4,16,16-g11-path4", "64S27-4,16,16-g21-path11" ];
