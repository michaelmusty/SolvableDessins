...
s`SolvableDBName := "64S44-16,16,4-g21-path71";
s`SolvableDBFilename := "64S44-16,16,4-g21-path71.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T5-8,8,2-g3-path7", "32S17-16,16,2-g7-path7", "64S44-16,16,4-g21-path71" ];
s`SolvableDBChildren := [ Strings() | "32S17-16,16,2-g7-path7" ];
