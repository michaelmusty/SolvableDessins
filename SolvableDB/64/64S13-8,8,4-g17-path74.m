...
s`SolvableDBName := "64S13-8,8,4-g17-path74";
s`SolvableDBFilename := "64S13-8,8,4-g17-path74.m";
...
\[ 49, 62, 54, 34, 31, 33, 52, 36, 56, 61, 50, 47, 59, 51, 64, 48, 60, 63, 27, 9, 35, 38, 13, 12, 17, 32, 55, 53, 10, 37, 41, 46, 44, 39, 57, 45, 58, 43, 7, 15, 2, 18, 16, 5, 11, 3, 20, 29, 24, 23, 40, 25, 42, 19, 26, 1, 28, 14, 8, 4, 22, 6, 21, 30 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T13-8,2,2-g0-path3", "32S9-8,4,2-g3-path17", "64S13-8,8,4-g17-path74" ];
s`SolvableDBParents := [ Strings() | "128S96-16,8,4-g37-path29", "128S95-16,8,4-g37-path57", "128S97-16,8,4-g37-path29", "128S95-16,8,4-g37-path58", "128S3-8,8,4-g33-path253", "128S28-8,8,4-g33-path106", "128S3-8,8,4-g33-path254" ];
