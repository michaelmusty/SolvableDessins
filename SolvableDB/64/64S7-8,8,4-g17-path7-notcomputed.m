...
s`SolvableDBName := "64S7-8,8,4-g17-path7-notcomputed";
s`SolvableDBFilename := "64S7-8,8,4-g17-path7-notcomputed.m";
...
\[ 32, 29, 33, 13, 56, 20, 40, 7, 6, 48, 57, 28, 12, 15, 44, 62, 61, 41, 50, 2, 46, 10, 51, 59, 17, 25, 22, 8, 36, 4, 16, 9, 38, 54, 31, 1, 34, 27, 24, 30, 64, 35, 26, 52, 43, 45, 42, 53, 60, 47, 49, 55, 3, 58, 18, 39, 63, 23, 11, 37, 21, 19, 5, 14 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T2-4,4,2-g1-path1-notcomputed", "16T10-4,4,2-g1-path3-notcomputed", "32S10-8,4,4-g7-path5-notcomputed", "64S7-8,8,4-g17-path7-notcomputed" ];
s`SolvableDBChild := "32S10-8,4,4-g7-path5-notcomputed";
