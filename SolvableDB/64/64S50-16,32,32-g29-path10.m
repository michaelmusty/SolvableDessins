...
s`SolvableDBName := "64S50-16,32,32-g29-path10";
s`SolvableDBFilename := "64S50-16,32,32-g29-path10.m";
...
\[ 42, 24, 54, 56, 57, 58, 40, 38, 6, 41, 19, 15, 63, 60, 62, 52, 64, 59, 61, 55, 43, 51, 53, 44, 39, 36, 1, 21, 4, 3, 35, 37, 17, 13, 45, 49, 46, 48, 50, 47, 27, 28, 2, 5, 7, 8, 18, 14, 20, 16, 29, 33, 30, 32, 34, 31, 9, 10, 11, 12, 22, 23, 25, 26 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T5-4,8,8-g5-path7", "32S16-8,16,16-g13-path11", "64S50-16,32,32-g29-path10" ];
s`SolvableDBParents := [ Strings() | "128S159-32,64,64-g61-path67", "128S160-32,64,64-g61-path51", "128S159-32,64,64-g61-path68", "128S160-32,64,64-g61-path52", "128S131-16,32,32-g57-path182", "128S128-16,32,32-g57-path120", "128S153-16,32,32-g57-path182" ];
