...
s`SolvableDBName := "64S27-16,16,4-g21-path11";
s`SolvableDBFilename := "64S27-16,16,4-g21-path11.m";
...
\[ 58, 61, 34, 37, 51, 40, 56, 52, 50, 55, 59, 41, 60, 28, 9, 27, 22, 38, 54, 39, 12, 64, 33, 13, 31, 36, 62, 57, 42, 29, 53, 25, 48, 49, 32, 46, 43, 45, 14, 63, 23, 20, 7, 2, 5, 8, 11, 19, 10, 35, 47, 24, 6, 16, 17, 21, 18, 44, 30, 3, 15, 4, 1, 26 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,2-g3-path5", "32S17-16,16,4-g11-path7", "64S27-16,16,4-g21-path11" ];
s`SolvableDBParents := [ Strings() | "128S44-16,16,8-g49-path136", "128S130-32,32,4-g45-path83", "128S130-32,32,8-g53-path83", "128S43-16,16,8-g49-path42", "128S130-32,32,4-g45-path84", "128S130-32,32,8-g53-path84", "128S106-16,16,4-g41-path316" ];
