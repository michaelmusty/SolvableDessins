...
s`SolvableDBName := "64S29-2,16,16-g13-path21";
s`SolvableDBFilename := "64S29-2,16,16-g13-path21.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 14, 26, 27, 11, 21, 22, 19, 23, 17, 28, 15, 16, 18, 25, 24, 12, 13, 20, 34, 33, 35, 48, 30, 29, 31, 43, 39, 44, 37, 45, 42, 41, 36, 38, 40, 47, 46, 32, 51, 55, 49, 56, 54, 53, 50, 52, 61, 60, 62, 58, 57, 59, 64, 63 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T5-2,8,8-g3-path7", "32S5-2,8,8-g5-path15", "64S29-2,16,16-g13-path21" ];
s`SolvableDBParents := [ Strings() | "128S106-4,16,16-g41-path339", "128S69-4,16,16-g41-path43", "128S69-4,16,16-g41-path44", "128S54-4,16,16-g41-path22", "128S131-2,32,32-g29-path22", "128S131-4,32,32-g45-path22", "128S133-2,32,32-g29-path43", "128S133-4,32,32-g45-path43", "128S133-2,32,32-g29-path44", "128S133-4,32,32-g45-path44", "128S132-2,32,32-g29-path22", "128S132-4,32,32-g45-path22", "128S61-2,16,16-g25-path43", "128S61-2,16,16-g25-path44", "128S46-2,16,16-g25-path22" ];
