...
s`SolvableDBName := "64S42-2,8,16-g11-path6";
s`SolvableDBFilename := "64S42-2,8,16-g11-path6.m";
...
\[ 10, 5, 26, 6, 2, 4, 24, 16, 11, 1, 9, 13, 12, 31, 37, 8, 22, 20, 21, 18, 19, 17, 43, 7, 33, 3, 29, 30, 27, 28, 14, 34, 25, 32, 46, 53, 15, 40, 41, 38, 39, 59, 23, 49, 47, 35, 45, 50, 44, 48, 62, 64, 36, 56, 57, 54, 55, 61, 42, 63, 58, 51, 60, 52 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path8", "32S9-2,4,8-g3-path11", "64S42-2,8,16-g11-path6" ];
s`SolvableDBParents := [ Strings() | "128S81-4,8,16-g37-path21", "128S119-4,8,16-g37-path187", "128S65-4,8,16-g37-path21", "128S97-4,8,16-g37-path72", "128S81-2,8,16-g21-path21", "128S93-2,8,16-g21-path72", "128S65-2,8,16-g21-path21" ];
