...
s`SolvableDBName := "64S44-16,4,16-g21-path24";
s`SolvableDBFilename := "64S44-16,4,16-g21-path24.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T8-4,4,4-g3-path21", "32S12-8,4,8-g9-path31", "64S44-16,4,16-g21-path24" ];
