...
s`SolvableDBName := "64S28-16,8,16-g25-path48";
s`SolvableDBFilename := "64S28-16,8,16-g25-path48.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T4-4,4,4-g3-path2", "32S4-8,4,8-g9-path8", "64S28-16,8,16-g25-path48" ];
