...
x[2]^2*x[4]^2 + nu^2*x[1]*x[2]^2 + x[4]^2 - nu^2*x[1],
x[3]^2*x[4]^2 - x[1]*x[3]^2 + nu^2*x[4]^2 + nu^2*x[1],
x[1]*x[4]^2 + 1
] >;
...
s`SolvableDBName := "64S9-8,4,4-g13-path19";
s`SolvableDBFilename := "64S9-8,4,4-g13-path19.m";
...
{ IntegerRing() | 46, 60 }
@};
s`SolvableDBBelyiMapTiming := 4.260p15;
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 23, 47, 31, 25, 60, 10, 35, 37, 64, 40, 9, 21, 61, 56, 17, 11, 54, 19, 20, 22, 33, 51, 42, 12, 13, 14, 15, 16, 18, 26, 32, 34, 36, 59, 49, 50, 46, 62, 55, 39, 43, 58, 41, 63, 45, 53, 48, 38, 57, 44, 52 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path5", "32S6-4,4,4-g5-path9", "64S9-8,4,4-g13-path19" ];
s`SolvableDBParents := [ Strings() | "128S3-8,8,4-g33-path82", "128S86-8,8,4-g33-path18", "128S4-8,8,4-g33-path40", "128S85-8,8,4-g33-path18", "128S84-8,4,4-g25-path13", "128S26-8,4,4-g25-path41", "128S83-8,4,4-g25-path13" ];
