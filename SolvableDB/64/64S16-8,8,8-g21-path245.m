...
s`SolvableDBName := "64S16-8,8,8-g21-path245";
s`SolvableDBFilename := "64S16-8,8,8-g21-path245.m";
...
\[ 51, 63, 15, 21, 34, 36, 30, 33, 54, 38, 42, 48, 45, 47, 49, 50, 5, 8, 3, 44, 31, 9, 56, 4, 57, 60, 13, 12, 19, 58, 7, 53, 10, 59, 24, 17, 18, 26, 32, 14, 62, 27, 11, 64, 23, 16, 29, 22, 40, 55, 28, 25, 41, 1, 20, 43, 39, 35, 2, 37, 46, 52, 6, 61 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path32", "32S15-8,8,8-g11-path54", "64S16-8,8,8-g21-path245" ];
s`SolvableDBParents := [ Strings() | "128S102-8,16,16-g49-path163", "128S102-8,16,16-g49-path164", "128S103-16,8,8-g45-path82", "128S104-16,8,8-g45-path82", "128S105-16,16,16-g53-path411", "128S105-16,16,16-g53-path412", "128S9-8,8,8-g41-path512" ];
