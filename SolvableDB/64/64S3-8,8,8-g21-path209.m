...
s`SolvableDBName := "64S3-8,8,8-g21-path209";
s`SolvableDBFilename := "64S3-8,8,8-g21-path209.m";
...
[ 27, 3, 60, 9, 56, 14, 59, 52, 10, 34, 17, 18, 64, 20, 16, 33, 39, 26, 23, 21, 22, 42, 40, 41, 55, 28, 47, 2, 8, 32, 1, 25, 29, 24, 36, 11, 30, 13, 54, 44, 45, 43, 53, 57, 51, 49, 48, 5, 58, 61, 4, 50, 6, 7, 46, 63, 38, 37, 35, 62, 15, 12, 31, 19 ],
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T6-8,8,2-g3-path4", "32S4-8,8,4-g9-path19", "64S3-8,8,8-g21-path209" ];
