...
s`SolvableDBName := "64S6-8,4,8-g17-path80";
s`SolvableDBFilename := "64S6-8,4,8-g17-path80.m";
...
\[ 6, 1, 18, 21, 19, 22, 4, 23, 2, 3, 5, 7, 8, 33, 31, 25, 27, 29, 9, 16, 10, 11, 15, 17, 13, 32, 30, 42, 12, 14, 20, 24, 26, 28, 34, 49, 39, 35, 41, 45, 38, 37, 40, 48, 47, 57, 36, 43, 44, 46, 50, 55, 64, 56, 51, 52, 54, 61, 58, 63, 62, 53, 59, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path2", "32S9-4,2,8-g3-path11", "64S6-8,4,8-g17-path80" ];
s`SolvableDBParents := [ Strings() | "128S67-16,8,8-g45-path27", "128S68-16,8,8-g45-path27", "128S68-16,8,8-g45-path28", "128S67-16,8,8-g45-path28", "128S63-8,4,16-g37-path54", "128S61-16,8,16-g49-path303", "128S66-8,4,16-g37-path133", "128S62-16,8,16-g49-path239", "128S65-8,4,16-g37-path48", "128S62-16,8,16-g49-path240", "128S64-8,4,16-g37-path145", "128S61-16,8,16-g49-path304", "128S3-8,4,8-g33-path622", "128S2-8,4,8-g33-path151", "128S11-8,4,8-g33-path1156" ];
