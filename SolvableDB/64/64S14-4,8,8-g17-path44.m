...
s`SolvableDBName := "64S14-4,8,8-g17-path44";
s`SolvableDBFilename := "64S14-4,8,8-g17-path44.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 51, 35, 9, 33, 24, 25, 10, 26, 27, 15, 12, 20, 34, 17, 16, 18, 32, 48, 13, 14, 21, 28, 29, 30, 36, 56, 53, 31, 55, 41, 42, 58, 50, 45, 52, 37, 46, 49, 40, 59, 44, 47, 43, 61, 38, 39, 54, 62, 57, 64, 60, 63 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T10-2,4,4-g1-path1", "32S7-2,8,8-g5-path3", "64S14-4,8,8-g17-path44" ];
s`SolvableDBParents := [ Strings() | "128S98-4,16,16-g41-path125", "128S98-4,16,16-g41-path126", "128S98-4,16,16-g41-path127", "128S98-4,16,16-g41-path128", "128S4-4,8,8-g33-path129", "128S28-4,8,8-g33-path167", "128S4-4,8,8-g33-path130" ];
