...
s`SolvableDBName := "64S46-8,16,4-g19-path27";
s`SolvableDBFilename := "64S46-8,16,4-g19-path27.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T12-4,8,2-g2-path3", "32S13-4,8,4-g7-path6", "64S46-8,16,4-g19-path27" ];
