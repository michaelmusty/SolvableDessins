...
s`SolvableDBName := "64S40-16,2,8-g11-path17";
s`SolvableDBFilename := "64S40-16,2,8-g11-path17.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 40, 38, 23, 20, 39, 37, 41, 42, 35, 36, 24, 8, 9, 10, 11, 12, 13, 14, 25, 31, 58, 57, 43, 56, 55, 59, 60, 61, 54, 26, 27, 28, 29, 30, 32, 33, 34, 50, 47, 53, 44, 62, 63, 45, 49, 51, 46, 64, 48, 52 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S9-8,2,4-g3-path7", "64S40-16,2,8-g11-path17" ];
s`SolvableDBParents := [ Strings() | "128S114-16,4,8-g37-path200", "128S95-16,4,8-g37-path107", "128S64-16,4,8-g37-path63", "128S82-16,4,8-g37-path17", "128S92-16,2,8-g21-path62", "128S63-16,2,8-g21-path40", "128S81-16,2,8-g21-path17" ];
