...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 53, 45, 55, 13, 33, 32, 35, 46, 30, 42, 38, 21, 59, 34, 12, 17, 19, 20, 22, 23, 10, 37, 40, 31, 11, 14, 15, 16, 18, 25, 26, 36, 43, 58, 49, 50, 63, 56, 44, 54, 39, 61, 47, 62, 51, 52, 57, 41, 64, 48, 60 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S8-4,8,8-g9-path1", "64S13-4,8,8-g17-path43" ];
s`SolvableDBParents := [ Strings() | "128S96-4,16,8-g37-path1", "128S95-4,16,8-g37-path1", "128S97-4,16,8-g37-path1", "128S95-4,16,8-g37-path2", "128S3-4,8,8-g33-path137", "128S28-4,8,8-g33-path48", "128S3-4,8,8-g33-path138" ];
