...
s`SolvableDBName := "64S44-4,16,16-g21-path23";
s`SolvableDBFilename := "64S44-4,16,16-g21-path23.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T8-4,4,4-g3-path23", "32S12-4,8,8-g9-path31", "64S44-4,16,16-g21-path23" ];
