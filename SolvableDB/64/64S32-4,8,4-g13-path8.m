...
s`SolvableDBName := "64S32-4,8,4-g13-path8";
s`SolvableDBFilename := "64S32-4,8,4-g13-path8.m";
...
\[ 21, 5, 44, 38, 6, 37, 4, 61, 12, 18, 23, 1, 11, 15, 28, 60, 31, 26, 51, 10, 9, 52, 27, 64, 59, 20, 13, 58, 22, 24, 25, 30, 47, 43, 42, 7, 2, 36, 40, 8, 49, 3, 55, 35, 54, 62, 45, 46, 16, 48, 53, 63, 56, 33, 57, 19, 34, 14, 17, 41, 39, 50, 29, 32 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S6-4,4,4-g5-path26", "64S32-4,8,4-g13-path8" ];
s`SolvableDBParents := [ Strings() | "128S77-8,8,4-g33-path11", "128S134-4,8,8-g33-path43", "128S137-8,8,8-g41-path87", "128S58-8,8,4-g33-path22", "128S136-4,8,8-g33-path43", "128S135-8,8,8-g41-path87", "128S48-8,8,4-g33-path11", "128S136-4,8,8-g33-path44", "128S135-8,8,8-g41-path88", "128S86-8,8,4-g33-path22", "128S134-4,8,8-g33-path44", "128S137-8,8,8-g41-path88", "128S83-4,8,4-g25-path44", "128S75-4,8,4-g25-path22", "128S122-4,8,4-g25-path456" ];
