...
s`SolvableDBName := "64S9-4,4,8-g13-path22";
s`SolvableDBFilename := "64S9-4,4,8-g13-path22.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S10-4,4,8-g7-path19", "64S9-4,4,8-g13-path22" ];
