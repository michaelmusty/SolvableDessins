...
s`SolvableDBName := "64S7-8,8,4-g17-path107";
s`SolvableDBFilename := "64S7-8,8,4-g17-path107.m";
...
\[ 47, 59, 33, 14, 32, 23, 60, 11, 22, 49, 40, 29, 28, 19, 7, 55, 46, 48, 62, 43, 50, 51, 2, 41, 44, 52, 57, 8, 53, 4, 25, 39, 38, 20, 27, 5, 16, 31, 6, 45, 13, 64, 26, 21, 24, 37, 9, 35, 56, 3, 12, 42, 1, 34, 63, 18, 10, 17, 36, 30, 58, 15, 61, 54 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S11-8,4,4-g7-path14", "64S7-8,8,4-g17-path107" ];
s`SolvableDBParents := [ Strings() | "128S69-16,16,4-g41-path249", "128S70-16,16,4-g41-path185", "128S69-16,16,4-g41-path250", "128S70-16,16,4-g41-path186", "128S3-8,8,4-g33-path698", "128S11-8,8,4-g33-path1232", "128S4-8,8,4-g33-path248" ];
