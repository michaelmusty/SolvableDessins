...
s`SolvableDBName := "64S20-4,4,8-g13-path12";
s`SolvableDBFilename := "64S20-4,4,8-g13-path12.m";
...
\[ 11, 30, 12, 7, 2, 5, 10, 33, 18, 31, 9, 22, 51, 13, 36, 37, 8, 1, 24, 3, 25, 20, 14, 34, 35, 56, 29, 39, 59, 6, 4, 17, 32, 57, 47, 49, 52, 62, 40, 46, 38, 16, 60, 26, 27, 28, 21, 15, 48, 54, 23, 42, 41, 55, 64, 58, 19, 44, 45, 61, 63, 53, 43, 50 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S11-4,2,8-g3-path1", "64S20-4,4,8-g13-path12" ];
s`SolvableDBParents := [ Strings() | "128S11-8,4,8-g33-path519", "128S35-4,8,8-g33-path65", "128S31-8,8,8-g41-path122", "128S32-8,4,8-g33-path122", "128S8-4,8,8-g33-path292", "128S10-8,8,8-g41-path1484", "128S27-8,4,8-g33-path197", "128S17-4,8,8-g33-path227", "128S23-8,8,8-g41-path608", "128S20-8,4,8-g33-path227", "128S32-4,8,8-g33-path122", "128S34-8,8,8-g41-path122", "128S29-4,4,8-g25-path122", "128S26-4,4,8-g25-path122", "128S16-4,4,8-g25-path284" ];
