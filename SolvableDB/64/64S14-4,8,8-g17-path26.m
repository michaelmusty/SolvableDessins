...
s`SolvableDBName := "64S14-4,8,8-g17-path26";
s`SolvableDBFilename := "64S14-4,8,8-g17-path26.m";
...
\[ 22, 5, 55, 41, 6, 40, 4, 46, 12, 18, 24, 1, 11, 15, 29, 54, 63, 27, 14, 33, 32, 9, 35, 28, 30, 59, 34, 13, 19, 21, 23, 25, 26, 10, 62, 64, 57, 45, 7, 2, 39, 43, 8, 61, 3, 42, 53, 37, 51, 60, 47, 48, 49, 50, 38, 58, 52, 44, 20, 16, 56, 31, 36, 17 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path10", "32S10-4,8,4-g7-path7", "64S14-4,8,8-g17-path26" ];
s`SolvableDBParents := [ Strings() | "128S98-4,16,16-g41-path153", "128S98-4,16,16-g41-path154", "128S98-4,16,16-g41-path155", "128S98-4,16,16-g41-path156", "128S4-4,8,8-g33-path143", "128S28-4,8,8-g33-path174", "128S4-4,8,8-g33-path144" ];
