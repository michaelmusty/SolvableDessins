...
s`SolvableDBName := "64S10-8,8,4-g17-path1";
s`SolvableDBFilename := "64S10-8,8,4-g17-path1.m";
...
\[ 6, 1, 26, 27, 21, 28, 23, 29, 2, 3, 4, 5, 7, 8, 63, 35, 45, 42, 16, 10, 9, 51, 62, 48, 56, 61, 13, 12, 59, 49, 57, 60, 31, 64, 58, 11, 14, 15, 17, 18, 19, 20, 22, 24, 25, 30, 32, 33, 34, 44, 46, 41, 54, 52, 50, 47, 55, 53, 38, 39, 40, 36, 37, 43 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S11-4,8,4-g7-path18", "64S10-8,8,4-g17-path1" ];
s`SolvableDBParents := [ Strings() | "128S87-16,16,4-g41-path27", "128S88-16,16,4-g41-path93", "128S87-16,16,4-g41-path28", "128S88-16,16,4-g41-path94", "128S4-8,8,4-g33-path47", "128S2-8,8,4-g33-path14", "128S27-8,8,4-g33-path47" ];
