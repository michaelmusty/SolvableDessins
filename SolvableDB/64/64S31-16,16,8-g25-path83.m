...
s`SolvableDBName := "64S31-16,16,8-g25-path83";
s`SolvableDBFilename := "64S31-16,16,8-g25-path83.m";
...
\[ 6, 1, 26, 27, 21, 28, 23, 29, 2, 3, 4, 5, 7, 8, 41, 35, 50, 47, 16, 49, 51, 34, 63, 58, 61, 52, 64, 48, 39, 36, 60, 62, 45, 40, 44, 37, 9, 10, 11, 12, 13, 14, 15, 17, 18, 19, 20, 22, 24, 25, 30, 31, 32, 33, 59, 57, 55, 38, 53, 54, 56, 46, 42, 43 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T10-4,4,2-g1-path4", "32S5-8,8,4-g9-path2", "64S31-16,16,8-g25-path83" ];
s`SolvableDBParents := [ Strings() | "128S70-16,16,8-g49-path126", "128S62-16,16,8-g49-path126", "128S111-16,16,8-g49-path488", "128S61-16,16,8-g49-path190", "128S55-16,16,8-g49-path34", "128S47-16,16,8-g49-path34", "128S69-16,16,8-g49-path190" ];
