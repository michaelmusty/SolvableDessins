...
s`SolvableDBName := "64S8-8,4,2-g5-path12";
s`SolvableDBFilename := "64S8-8,4,2-g5-path12.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 18, 45, 46, 48, 49, 26, 50, 8, 17, 51, 31, 10, 16, 9, 11, 12, 13, 14, 15, 20, 24, 44, 42, 27, 62, 32, 63, 60, 39, 37, 36, 61, 35, 34, 25, 41, 59, 58, 56, 29, 38, 43, 28, 30, 33, 40, 47, 52, 53, 64, 54, 55, 57 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S6-4,4,2-g1-path3", "64S8-8,4,2-g5-path12" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,2-g17-path291", "128S76-8,4,4-g25-path154", "128S78-8,8,4-g33-path193", "128S77-8,8,2-g17-path110", "128S26-8,4,4-g25-path844", "128S3-8,8,4-g33-path1005", "128S79-16,4,2-g13-path67", "128S81-16,8,2-g21-path61", "128S72-16,4,4-g29-path66", "128S74-16,8,4-g37-path27", "128S71-16,4,2-g13-path27", "128S73-16,8,2-g21-path27", "128S80-16,4,4-g29-path226", "128S82-16,8,4-g37-path95", "128S75-8,4,2-g9-path49" ];
