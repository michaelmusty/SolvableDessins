...
s`SolvableDBName := "64S7-4,8,8-g17-path186";
s`SolvableDBFilename := "64S7-4,8,8-g17-path186.m";
...
\[ 12, 40, 45, 7, 2, 5, 39, 43, 22, 34, 13, 9, 28, 19, 14, 26, 60, 10, 29, 49, 30, 1, 31, 11, 32, 33, 18, 24, 15, 25, 54, 21, 59, 27, 37, 62, 64, 53, 41, 6, 4, 46, 42, 57, 38, 8, 50, 51, 52, 48, 47, 58, 3, 56, 61, 23, 55, 20, 16, 36, 44, 17, 35, 63 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T6-4,8,8-g5-path4", "32S5-4,8,8-g9-path21", "64S7-4,8,8-g17-path186" ];
s`SolvableDBParents := [ Strings() | "128S69-8,16,16-g49-path319", "128S69-8,16,16-g49-path320", "128S70-8,16,16-g49-path255", "128S70-8,16,16-g49-path256", "128S11-4,8,8-g33-path1280", "128S3-4,8,8-g33-path746", "128S4-4,8,8-g33-path296" ];
