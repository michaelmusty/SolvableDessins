...
I<[x]> := ideal< P | [
x[2]*x[3]^6 + nu^6*x[2]^3*x[3]^2 + 1/2*(nu^6 - 2*nu^4 - 2*nu^2 - 1)*x[1]*x[3]^4 + 1/2*(-nu^5 - 2*nu^3 - 5*nu)*x[1]*x[2]*x[3]^2 + 1/2*(nu^7 + nu^5 + 2*nu^3 - 2*nu)*x[3]^4 + 1/2*(-nu^6 + 2*nu^4 + 2*nu^2 - 1)*x[1]^3 + 1/2*(-nu^6 - 2*nu^4 - 2*nu^2 + 1)*x[1]*x[2]^2 + 1/2*(nu^6 + 4*nu^4 + nu^2 + 4)*x[2]*x[3]^2 + 1/2*(-nu^7 - nu)*x[1]^2 + 1/2*(-2*nu^7 + 2*nu^5 + nu^3 + nu)*x[2]^2 + 1/2*(-nu^6 - nu^4)*x[1] + 1/2*(nu^7 + nu^5 + 2*nu^3 - 2*nu),
x[1]^2*x[3]^4 + (-nu^7 - nu^5)*x[1]*x[3]^4 - x[1]^4 + (-nu^2 + 1)*x[1]*x[2]*x[3]^2 - nu^4*x[3]^4 + (-nu^7 - nu^5)*x[1]^3 + (-nu^7 - nu^5)*x[2]*x[3]^2 + (nu^6 + nu^4 - 1)*x[1]^2 + (-nu^7 - nu^5)*x[1],
x[1]*x[2]*x[3]^4 - x[1]^2*x[3]^2 + x[2]^2*x[3]^2 + 1/2*(-2*nu^7 - nu^5 - nu^3 - 2*nu)*x[1]^2*x[2] + 1/2*(nu^5 + 3*nu^3 + 2*nu)*x[1]*x[3]^2 + 1/2*(-nu^6 + 2*nu^4 + 2*nu^2 + 1)*x[1]*x[2] + 1/2*(-2*nu^6 + nu^4 - nu^2 + 2)*x[3]^2,
x[1]^2*x[2]*x[3]^2 - x[1]^3 - nu^2*x[2]*x[3]^2 + (-nu^7 + nu^3)*x[1]^2 - nu^2*x[1],
x[1]*x[2]^2*x[3]^2 + nu^2*x[2]*x[3]^4 + 1/2*(2*nu^6 + 2*nu^4 - nu^2 - 1)*x[1]^2*x[2] + 1/2*(-2*nu^6 - 2*nu^4 - nu^2 - 1)*x[1]*x[3]^2 + 1/2*(-2*nu^7 - nu^5 - nu^3 - 2*nu)*x[1]*x[2] + 1/2*(nu^7 + 2*nu^5 - 2*nu^3 - nu)*x[3]^2,
x[1]^3*x[2] - x[1]^2*x[3]^2 + (nu^5 + nu^3)*x[1]^2*x[2] + (nu^7 + nu^5)*x[1]*x[3]^2 - x[1]*x[2] + nu^4*x[3]^2,
x[1]^2*x[2]^2 + (nu^2 - 1)*x[1]*x[2]*x[3]^2 + (nu^5 + nu^3)*x[1]*x[2]^2 + (nu^7 + nu^5)*x[2]*x[3]^2 - nu^2*x[1]^2 - x[2]^2 + (nu^5 + nu)*x[1] - nu^4
] >;
...
{ IntegerRing() | 63, 64 }
@};
s`SolvableDBBelyiMapTiming := 2.030p15;
s`SolvableDBLocalSanityCheckTiming := 4.130p15;
...
s`SolvableDBParents := [ Strings() | "128S114-8,16,4-g37-path7", "128S95-8,16,4-g37-path7", "128S64-8,16,4-g37-path7", "128S82-8,16,4-g37-path1", "128S92-8,16,2-g21-path4", "128S63-8,16,2-g21-path4", "128S81-8,16,2-g21-path1" ];
