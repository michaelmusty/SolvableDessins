...
\[ 6, 1, 4, 22, 18, 23, 20, 24, 2, 3, 5, 7, 8, 17, 19, 21, 31, 9, 52, 30, 53, 12, 11, 54, 41, 48, 50, 42, 44, 10, 13, 14, 15, 16, 25, 26, 27, 28, 29, 45, 46, 47, 49, 51, 58, 33, 39, 57, 61, 63, 38, 35, 36, 32, 62, 55, 34, 37, 40, 43, 56, 64, 59, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S6-4,2,4-g1-path3", "64S9-8,4,4-g13-path116" ];
s`SolvableDBParents := [ Strings() | "128S86-8,4,8-g33-path199", "128S4-8,4,8-g33-path561", "128S3-8,4,8-g33-path1167", "128S85-8,4,8-g33-path199", "128S83-8,4,4-g25-path133", "128S84-8,4,4-g25-path133", "128S26-8,4,4-g25-path979" ];
