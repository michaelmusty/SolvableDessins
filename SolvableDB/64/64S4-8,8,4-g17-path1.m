...
s`SolvableDBName := "64S4-8,8,4-g17-path1";
s`SolvableDBFilename := "64S4-8,8,4-g17-path1.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T10-4,4,2-g1-path1", "32S5-8,8,4-g9-path1", "64S4-8,8,4-g17-path1" ];
