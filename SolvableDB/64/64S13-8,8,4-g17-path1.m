...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 37, 14, 58, 13, 34, 61, 36, 39, 31, 52, 9, 21, 42, 35, 44, 11, 50, 19, 20, 22, 23, 41, 53, 57, 10, 12, 15, 16, 17, 18, 25, 26, 32, 33, 64, 48, 45, 62, 51, 60, 63, 59, 43, 49, 38, 47, 54, 55, 56, 46, 40 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T14-4,8,4-g4-path1", "32S10-4,8,4-g7-path34", "64S13-8,8,4-g17-path1" ];
s`SolvableDBParents := [ Strings() | "128S96-16,8,4-g37-path19", "128S95-16,8,4-g37-path37", "128S97-16,8,4-g37-path19", "128S95-16,8,4-g37-path38", "128S3-8,8,4-g33-path207", "128S28-8,8,4-g33-path83", "128S3-8,8,4-g33-path208" ];
