...
s`SolvableDBName := "64S6-8,4,8-g17-path31";
s`SolvableDBFilename := "64S6-8,4,8-g17-path31.m";
...
\[ 36, 49, 21, 39, 22, 9, 57, 48, 52, 24, 14, 16, 58, 23, 55, 4, 45, 5, 17, 61, 56, 43, 38, 26, 19, 37, 12, 2, 32, 42, 63, 64, 40, 47, 62, 28, 44, 18, 41, 59, 7, 60, 11, 3, 30, 25, 50, 51, 6, 20, 13, 1, 31, 15, 33, 10, 27, 29, 35, 46, 53, 54, 34, 8 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path1", "32S5-8,4,8-g9-path12", "64S6-8,4,8-g17-path31" ];
s`SolvableDBParents := [ Strings() | "128S67-8,8,16-g45-path177", "128S67-8,8,16-g45-path178", "128S68-8,8,16-g45-path177", "128S68-8,8,16-g45-path178", "128S63-16,4,8-g37-path78", "128S61-16,8,16-g49-path413", "128S64-16,4,8-g37-path169", "128S61-16,8,16-g49-path414", "128S65-16,4,8-g37-path72", "128S62-16,8,16-g49-path349", "128S66-16,4,8-g37-path157", "128S62-16,8,16-g49-path350", "128S11-8,4,8-g33-path1211", "128S2-8,4,8-g33-path206", "128S3-8,4,8-g33-path677" ];
