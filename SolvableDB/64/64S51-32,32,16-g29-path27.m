...
s`SolvableDBName := "64S51-32,32,16-g29-path27";
s`SolvableDBFilename := "64S51-32,32,16-g29-path27.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T5-8,8,4-g5-path1", "32S16-16,16,8-g13-path5", "64S51-32,32,16-g29-path27" ];
