...
s`SolvableDBName := "64S7-8,8,4-g17-path94";
s`SolvableDBFilename := "64S7-8,8,4-g17-path94.m";
...
\[ 45, 46, 44, 63, 54, 62, 17, 52, 20, 61, 43, 24, 23, 15, 42, 49, 34, 48, 50, 57, 51, 39, 59, 55, 64, 3, 47, 18, 22, 53, 5, 25, 6, 4, 36, 56, 41, 16, 10, 37, 14, 30, 58, 19, 9, 31, 26, 21, 29, 60, 35, 13, 40, 33, 1, 28, 12, 8, 11, 27, 38, 2, 32, 7 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S11-8,4,2-g3-path4", "64S7-8,8,4-g17-path94" ];
s`SolvableDBParents := [ Strings() | "128S69-16,16,8-g49-path389", "128S70-16,16,8-g49-path325", "128S69-16,16,8-g49-path390", "128S70-16,16,8-g49-path326", "128S3-8,8,4-g33-path820", "128S11-8,8,4-g33-path1354", "128S4-8,8,4-g33-path370" ];
