...
s`SolvableDBName := "64S39-16,4,4-g15-path12";
s`SolvableDBFilename := "64S39-16,4,4-g15-path12.m";
...
\[ 53, 64, 50, 35, 52, 37, 48, 34, 56, 62, 51, 60, 59, 38, 31, 54, 61, 63, 10, 36, 49, 32, 33, 17, 27, 13, 47, 55, 28, 9, 41, 46, 44, 39, 45, 58, 57, 43, 16, 2, 18, 12, 3, 15, 7, 11, 20, 29, 25, 24, 26, 40, 42, 19, 8, 21, 5, 1, 14, 30, 22, 4, 6, 23 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T13-8,2,2-g0-path3", "32S20-16,4,4-g8-path3", "64S39-16,4,4-g15-path12" ];
s`SolvableDBParents := [ Strings() | "128S94-16,8,4-g37-path57", "128S64-16,8,4-g37-path23", "128S97-16,8,4-g37-path57", "128S64-16,8,4-g37-path24", "128S80-16,4,4-g29-path31", "128S112-16,4,4-g29-path245", "128S80-16,4,4-g29-path32" ];
