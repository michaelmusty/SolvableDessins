...
s`SolvableDBName := "64S7-8,4,8-g17-path43";
s`SolvableDBFilename := "64S7-8,4,8-g17-path43.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T12-8,4,2-g2-path1", "32S10-8,4,4-g7-path26", "64S7-8,4,8-g17-path43" ];
