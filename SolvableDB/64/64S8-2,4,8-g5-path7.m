...
s`SolvableDBName := "64S8-2,4,8-g5-path7";
s`SolvableDBFilename := "64S8-2,4,8-g5-path7.m";
...
\[ 10, 5, 28, 6, 2, 4, 25, 16, 11, 1, 9, 13, 12, 20, 49, 8, 55, 21, 22, 14, 18, 19, 37, 35, 7, 32, 36, 3, 38, 33, 34, 26, 30, 31, 24, 27, 23, 29, 47, 59, 43, 52, 41, 48, 50, 51, 39, 44, 15, 45, 46, 42, 58, 57, 17, 60, 54, 53, 40, 56, 62, 61, 64, 63 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S11-2,4,8-g3-path8", "64S8-2,4,8-g5-path7" ];
s`SolvableDBParents := [ Strings() | "128S76-4,4,8-g25-path117", "128S77-2,8,8-g17-path73", "128S3-4,8,8-g33-path929", "128S26-4,4,8-g25-path807", "128S2-2,8,8-g17-path254", "128S78-4,8,8-g33-path117", "128S79-2,4,16-g13-path69", "128S72-4,4,16-g29-path29", "128S73-2,8,16-g21-path29", "128S82-4,8,16-g37-path97", "128S71-2,4,16-g13-path29", "128S80-4,4,16-g29-path189", "128S81-2,8,16-g21-path63", "128S74-4,8,16-g37-path29", "128S75-2,4,8-g9-path51" ];
s`SolvableDBChild := "32S11-2,4,8-g3-path8";
