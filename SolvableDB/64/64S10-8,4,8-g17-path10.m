...
s`SolvableDBName := "64S10-8,4,8-g17-path10";
s`SolvableDBFilename := "64S10-8,4,8-g17-path10.m";
...
\[ 6, 1, 26, 27, 22, 28, 24, 29, 2, 3, 4, 5, 7, 8, 61, 55, 35, 54, 47, 46, 19, 9, 52, 50, 63, 62, 13, 12, 32, 60, 49, 39, 56, 59, 33, 10, 11, 14, 15, 16, 17, 18, 20, 21, 23, 25, 30, 31, 34, 37, 41, 48, 51, 36, 43, 58, 64, 53, 45, 57, 38, 42, 40, 44 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path5", "32S11-4,4,8-g7-path16", "64S10-8,4,8-g17-path10" ];
s`SolvableDBParents := [ Strings() | "128S87-16,4,16-g41-path63", "128S88-16,4,16-g41-path129", "128S87-16,4,16-g41-path64", "128S88-16,4,16-g41-path130", "128S4-8,4,8-g33-path65", "128S2-8,4,8-g33-path32", "128S27-8,4,8-g33-path65" ];
