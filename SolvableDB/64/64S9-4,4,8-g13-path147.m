...
s`SolvableDBName := "64S9-4,4,8-g13-path147";
s`SolvableDBFilename := "64S9-4,4,8-g13-path147.m";
...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 60, 61, 51, 14, 53, 63, 33, 26, 43, 38, 21, 47, 37, 12, 39, 19, 20, 22, 44, 57, 56, 35, 10, 11, 13, 15, 16, 17, 18, 25, 30, 31, 32, 34, 36, 59, 62, 48, 45, 50, 54, 49, 52, 40, 55, 58, 64, 42, 46, 41 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S6-4,4,4-g5-path12", "64S9-4,4,8-g13-path147" ];
s`SolvableDBParents := [ Strings() | "128S3-8,4,8-g33-path1132", "128S86-8,4,8-g33-path164", "128S4-8,4,8-g33-path526", "128S85-8,4,8-g33-path164", "128S84-4,4,8-g25-path236", "128S26-4,4,8-g25-path1082", "128S83-4,4,8-g25-path236" ];
