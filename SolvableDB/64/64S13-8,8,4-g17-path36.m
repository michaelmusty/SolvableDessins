...
s`SolvableDBName := "64S13-8,8,4-g17-path36";
s`SolvableDBFilename := "64S13-8,8,4-g17-path36.m";
...
\[ 32, 54, 51, 44, 50, 58, 43, 7, 22, 35, 19, 29, 28, 13, 11, 56, 62, 33, 30, 64, 27, 23, 12, 14, 10, 60, 25, 15, 36, 24, 18, 9, 21, 17, 31, 1, 34, 5, 57, 47, 6, 4, 42, 40, 59, 55, 8, 61, 3, 41, 39, 63, 46, 38, 49, 45, 53, 2, 52, 20, 16, 26, 48, 37 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S8-8,8,4-g9-path3", "64S13-8,8,4-g17-path36" ];
s`SolvableDBParents := [ Strings() | "128S96-8,16,4-g37-path9", "128S95-8,16,4-g37-path17", "128S95-8,16,4-g37-path18", "128S97-8,16,4-g37-path9", "128S3-8,8,4-g33-path159", "128S3-8,8,4-g33-path160", "128S28-8,8,4-g33-path59" ];
