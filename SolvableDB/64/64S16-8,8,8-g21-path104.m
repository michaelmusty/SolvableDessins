...
s`SolvableDBName := "64S16-8,8,8-g21-path104";
s`SolvableDBFilename := "64S16-8,8,8-g21-path104.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T5-8,8,2-g3-path2", "32S12-8,8,4-g9-path2", "64S16-8,8,8-g21-path104" ];
