...
s`SolvableDBName := "64S8-4,8,4-g13-path10";
s`SolvableDBFilename := "64S8-4,8,4-g13-path10.m";
...
\[ 22, 5, 52, 38, 6, 37, 4, 43, 12, 18, 24, 1, 11, 15, 28, 51, 58, 26, 14, 57, 31, 9, 64, 27, 29, 33, 13, 19, 21, 23, 25, 20, 10, 60, 42, 7, 2, 36, 40, 8, 59, 3, 39, 56, 50, 55, 48, 45, 46, 47, 44, 35, 54, 41, 61, 16, 62, 34, 53, 17, 49, 32, 30, 63 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path4", "32S11-4,8,4-g7-path4", "64S8-4,8,4-g13-path10" ];
s`SolvableDBParents := [ Strings() | "128S2-4,8,8-g33-path267", "128S3-4,8,8-g33-path1020", "128S77-4,8,8-g33-path86", "128S78-4,8,8-g33-path208", "128S79-4,16,4-g29-path85", "128S81-4,16,8-g37-path37", "128S80-4,16,4-g29-path243", "128S82-4,16,8-g37-path110", "128S71-4,16,4-g29-path5", "128S73-4,16,8-g37-path3", "128S72-4,16,4-g29-path83", "128S74-4,16,8-g37-path42", "128S26-4,8,4-g25-path861", "128S75-4,8,4-g25-path49", "128S76-4,8,4-g25-path171" ];
