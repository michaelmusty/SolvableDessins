...
s`SolvableDBName := "64S36-8,2,8-g9-path7";
s`SolvableDBFilename := "64S36-8,2,8-g9-path7.m";
...
[ 30, 57, 55, 34, 54, 14, 47, 46, 50, 51, 38, 17, 28, 6, 64, 26, 12, 22, 37, 62, 25, 18, 33, 40, 21, 16, 53, 13, 43, 1, 52, 44, 23, 4, 58, 39, 19, 11, 36, 24, 63, 61, 29, 32, 48, 8, 7, 45, 60, 9, 10, 31, 27, 5, 3, 59, 2, 35, 56, 49, 42, 20, 41, 15 ],
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S6-4,2,4-g1-path5", "64S36-8,2,8-g9-path7" ];
