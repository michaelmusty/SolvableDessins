...
s`SolvableDBName := "64S44-16,16,4-g21-path66";
s`SolvableDBFilename := "64S44-16,16,4-g21-path66.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T5-8,8,2-g3-path2", "32S17-16,16,2-g7-path2", "64S44-16,16,4-g21-path66" ];
