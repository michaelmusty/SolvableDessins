...
\[ 11, 27, 30, 7, 2, 5, 26, 19, 55, 12, 8, 22, 10, 38, 42, 9, 58, 23, 1, 24, 16, 13, 54, 53, 47, 28, 6, 4, 41, 25, 64, 34, 35, 50, 51, 32, 33, 29, 17, 15, 14, 48, 31, 45, 52, 20, 3, 40, 43, 36, 37, 62, 46, 57, 21, 39, 18, 56, 60, 61, 63, 44, 59, 49 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path5", "32S11-4,8,2-g3-path5", "64S8-4,8,2-g5-path3" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,2-g17-path244", "128S26-4,8,4-g25-path836", "128S3-8,8,4-g33-path919", "128S77-8,8,2-g17-path63", "128S76-4,8,4-g25-path146", "128S78-8,8,4-g33-path107", "128S79-4,16,2-g13-path59", "128S81-8,16,2-g21-path53", "128S80-4,16,4-g29-path218", "128S82-8,16,4-g37-path87", "128S71-4,16,2-g13-path19", "128S73-8,16,2-g21-path19", "128S72-4,16,4-g29-path58", "128S74-8,16,4-g37-path19", "128S75-4,8,2-g9-path41" ];
