...
s`SolvableDBName := "64S36-8,8,2-g9-path3";
s`SolvableDBFilename := "64S36-8,8,2-g9-path3.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S6-4,4,2-g1-path11", "64S36-8,8,2-g9-path3" ];
