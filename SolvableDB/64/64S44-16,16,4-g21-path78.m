...
[ 57, 45, 64, 55, 49, 50, 35, 62, 16, 63, 13, 39, 29, 52, 46, 27, 59, 54, 48, 28, 58, 47, 53, 37, 33, 19, 38, 6, 34, 61, 14, 23, 44, 11, 21, 31, 43, 9, 30, 51, 26, 32, 60, 56, 10, 3, 8, 41, 1, 20, 17, 36, 42, 4, 18, 25, 5, 7, 40, 24, 12, 22, 2, 15 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T5-8,8,2-g3-path7", "32S17-16,16,4-g11-path7", "64S44-16,16,4-g21-path78" ];
s`SolvableDBChildren := [ Strings() | "32S17-16,16,4-g11-path7" ];
