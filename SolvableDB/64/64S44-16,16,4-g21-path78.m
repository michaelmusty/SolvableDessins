...
s`SolvableDBName := "64S44-16,16,4-g21-path78";
s`SolvableDBFilename := "64S44-16,16,4-g21-path78.m";
...
\[ 61, 60, 49, 63, 39, 47, 38, 56, 36, 37, 41, 42, 26, 54, 57, 31, 58, 45, 51, 62, 16, 33, 28, 15, 34, 40, 14, 22, 19, 23, 18, 20, 11, 48, 9, 55, 46, 52, 32, 35, 59, 50, 3, 13, 24, 5, 44, 17, 30, 8, 21, 4, 6, 10, 2, 29, 12, 27, 7, 64, 53, 25, 43, 1 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,2-g3-path7", "32S17-16,16,4-g11-path2", "64S44-16,16,4-g21-path78" ];
s`SolvableDBParents := [ Strings() | "128S102-16,16,8-g49-path225", "128S153-32,32,4-g45-path21", "128S154-32,32,8-g53-path21", "128S153-32,32,4-g45-path22", "128S154-32,32,8-g53-path22", "128S99-16,16,8-g49-path225", "128S106-16,16,4-g41-path416" ];
