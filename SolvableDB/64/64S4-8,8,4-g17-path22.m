...
s`SolvableDBName := "64S4-8,8,4-g17-path22";
s`SolvableDBFilename := "64S4-8,8,4-g17-path22.m";
...
\[ 44, 61, 31, 14, 30, 22, 64, 11, 21, 20, 38, 28, 27, 36, 7, 17, 42, 45, 40, 48, 49, 2, 39, 41, 16, 57, 8, 51, 4, 37, 33, 53, 43, 5, 46, 62, 6, 63, 13, 59, 60, 52, 24, 9, 50, 19, 58, 18, 12, 26, 1, 32, 56, 47, 3, 25, 10, 35, 54, 55, 34, 15, 23, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S5-8,8,4-g9-path3", "64S4-8,8,4-g17-path22" ];
s`SolvableDBParents := [ Strings() | "128S46-16,16,8-g49-path151", "128S46-16,16,8-g49-path152", "128S52-16,16,8-g49-path27", "128S52-16,16,8-g49-path28", "128S47-16,16,8-g49-path119", "128S47-16,16,8-g49-path120", "128S53-16,16,8-g49-path27", "128S53-16,16,8-g49-path28", "128S12-8,8,4-g33-path492", "128S48-8,8,4-g33-path36", "128S49-8,8,4-g33-path103", "128S2-8,8,4-g33-path92", "128S4-8,8,4-g33-path215", "128S50-8,8,4-g33-path36", "128S51-8,8,4-g33-path103" ];
