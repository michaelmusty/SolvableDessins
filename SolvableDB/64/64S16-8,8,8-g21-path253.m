...
s`SolvableDBName := "64S16-8,8,8-g21-path253";
s`SolvableDBFilename := "64S16-8,8,8-g21-path253.m";
...
\[ 6, 1, 23, 3, 20, 13, 4, 19, 2, 5, 7, 8, 37, 47, 48, 52, 14, 15, 16, 36, 18, 46, 35, 12, 17, 45, 9, 10, 11, 21, 22, 24, 25, 26, 59, 63, 57, 49, 54, 50, 55, 51, 38, 39, 40, 41, 42, 62, 31, 44, 53, 61, 33, 34, 43, 60, 27, 28, 29, 30, 32, 56, 64, 58 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path25", "32S15-8,8,8-g11-path39", "64S16-8,8,8-g21-path253" ];
s`SolvableDBParents := [ Strings() | "128S102-16,16,8-g49-path23", "128S102-16,16,8-g49-path24", "128S103-8,8,16-g45-path12", "128S105-16,16,16-g53-path203", "128S105-16,16,16-g53-path204", "128S104-8,8,16-g45-path12", "128S9-8,8,8-g41-path408" ];
