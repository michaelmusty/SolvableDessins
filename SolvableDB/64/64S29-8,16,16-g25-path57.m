...
s`SolvableDBName := "64S29-8,16,16-g25-path57";
s`SolvableDBFilename := "64S29-8,16,16-g25-path57.m";
...
\[ 6, 1, 26, 27, 23, 28, 4, 29, 2, 3, 5, 7, 8, 49, 51, 45, 42, 14, 32, 53, 37, 58, 9, 21, 57, 54, 41, 11, 17, 19, 20, 22, 18, 10, 39, 31, 12, 13, 15, 16, 24, 25, 30, 33, 34, 35, 36, 44, 61, 46, 62, 48, 63, 40, 60, 47, 38, 55, 56, 43, 52, 64, 59, 50 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T6-4,8,8-g5-path1", "32S5-4,8,8-g9-path22", "64S29-8,16,16-g25-path57" ];
s`SolvableDBParents := [ Strings() | "128S131-16,32,32-g57-path85", "128S133-16,32,32-g57-path169", "128S133-16,32,32-g57-path170", "128S132-16,32,32-g57-path85", "128S133-16,32,32-g57-path171", "128S131-16,32,32-g57-path86", "128S132-16,32,32-g57-path86", "128S133-16,32,32-g57-path172", "128S69-8,16,16-g49-path85", "128S61-8,16,16-g49-path85", "128S54-8,16,16-g49-path43", "128S61-8,16,16-g49-path86", "128S106-8,16,16-g49-path360", "128S46-8,16,16-g49-path43", "128S69-8,16,16-g49-path86" ];
