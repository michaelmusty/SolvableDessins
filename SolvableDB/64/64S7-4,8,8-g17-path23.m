...
s`SolvableDBName := "64S7-4,8,8-g17-path23";
s`SolvableDBFilename := "64S7-4,8,8-g17-path23.m";
...
s`SolvableDBParents := [ Strings() | "128S69-8,16,16-g49-path25", "128S70-8,16,16-g49-path17", "128S69-8,16,16-g49-path26", "128S70-8,16,16-g49-path18", "128S3-4,8,8-g33-path57", "128S11-4,8,8-g33-path51", "128S4-4,8,8-g33-path27" ];
