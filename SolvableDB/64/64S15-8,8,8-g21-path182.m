...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 43, 17, 60, 61, 14, 48, 47, 9, 36, 62, 31, 63, 35, 13, 12, 57, 50, 38, 58, 56, 42, 49, 16, 53, 10, 11, 15, 18, 19, 20, 21, 23, 25, 26, 32, 33, 34, 37, 64, 55, 59, 44, 41, 45, 52, 54, 39, 40, 51, 46 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T12-2,8,4-g2-path2", "32S13-4,8,4-g7-path2", "64S15-8,8,8-g21-path182" ];
s`SolvableDBParents := [ Strings() | "128S101-16,16,16-g53-path359", "128S99-16,8,16-g49-path115", "128S100-8,16,8-g45-path115", "128S101-16,16,16-g53-path360", "128S99-16,8,16-g49-path116", "128S100-8,16,8-g45-path116", "128S9-8,8,8-g41-path180" ];
