...
s`SolvableDBName := "64S4-8,2,8-g9-path8";
s`SolvableDBFilename := "64S4-8,2,8-g9-path8.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 41, 49, 43, 50, 42, 32, 51, 52, 31, 37, 44, 8, 9, 10, 11, 12, 13, 14, 20, 23, 24, 25, 39, 45, 40, 46, 38, 47, 48, 30, 58, 63, 62, 59, 60, 61, 64, 57, 33, 28, 35, 27, 26, 29, 34, 36, 53, 54, 55, 56 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,1,8-g0-path1", "16T5-8,2,8-g3-path1", "32S5-8,2,8-g5-path13", "64S4-8,2,8-g9-path8" ];
s`SolvableDBParents := [ Strings() | "128S4-8,4,8-g33-path164", "128S49-8,4,8-g33-path52", "128S51-8,4,8-g33-path52", "128S12-8,4,8-g33-path441", "128S46-16,2,16-g25-path70", "128S47-16,4,16-g41-path54", "128S53-16,2,16-g25-path8", "128S52-16,4,16-g41-path8", "128S52-16,2,16-g25-path8", "128S53-16,4,16-g41-path8", "128S47-16,2,16-g25-path54", "128S46-16,4,16-g41-path70", "128S50-8,2,8-g17-path30", "128S48-8,2,8-g17-path30", "128S2-8,2,8-g17-path86" ];
