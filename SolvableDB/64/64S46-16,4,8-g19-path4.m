...
s`SolvableDBName := "64S46-16,4,8-g19-path4";
s`SolvableDBFilename := "64S46-16,4,8-g19-path4.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T8-4,4,4-g3-path23", "32S13-8,4,4-g7-path10", "64S46-16,4,8-g19-path4" ];
