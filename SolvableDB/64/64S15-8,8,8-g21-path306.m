...
s`SolvableDBName := "64S15-8,8,8-g21-path306";
s`SolvableDBFilename := "64S15-8,8,8-g21-path306.m";
...
\[ 62, 63, 52, 36, 33, 35, 45, 38, 64, 59, 60, 61, 44, 34, 50, 54, 53, 21, 28, 9, 43, 42, 41, 13, 12, 17, 15, 48, 31, 10, 39, 23, 51, 57, 55, 49, 29, 56, 40, 32, 37, 47, 46, 22, 19, 27, 11, 4, 7, 58, 2, 26, 14, 30, 5, 16, 3, 18, 8, 24, 20, 25, 6, 1 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T8-4,4,4-g3-path3", "32S15-8,8,8-g11-path33", "64S15-8,8,8-g21-path306" ];
s`SolvableDBParents := [ Strings() | "128S99-8,16,16-g49-path97", "128S101-16,16,16-g53-path241", "128S100-16,8,8-g45-path97", "128S99-8,16,16-g49-path98", "128S101-16,16,16-g53-path242", "128S100-16,8,8-g45-path98", "128S9-8,8,8-g41-path121" ];
