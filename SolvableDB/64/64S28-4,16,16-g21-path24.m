...
s`SolvableDBName := "64S28-4,16,16-g21-path24";
s`SolvableDBFilename := "64S28-4,16,16-g21-path24.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T4-4,4,4-g3-path10", "32S4-4,8,8-g9-path2", "64S28-4,16,16-g21-path24" ];
s`SolvableDBChildren := [ Strings() | "32S4-4,8,8-g9-path2" ];
