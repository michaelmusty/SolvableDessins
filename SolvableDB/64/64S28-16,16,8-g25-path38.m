...
s`SolvableDBName := "64S28-16,16,8-g25-path38";
s`SolvableDBFilename := "64S28-16,16,8-g25-path38.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 63, 32, 9, 61, 53, 16, 33, 62, 51, 50, 39, 59, 14, 46, 37, 19, 56, 38, 41, 60, 10, 49, 64, 36, 11, 12, 13, 15, 17, 18, 20, 21, 23, 25, 26, 31, 34, 35, 44, 43, 57, 48, 47, 40, 55, 45, 42, 54, 52, 58 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T4-4,4,4-g3-path5", "32S4-8,8,4-g9-path7", "64S28-16,16,8-g25-path38" ];
s`SolvableDBParents := [ Strings() | "128S45-16,16,8-g49-path109", "128S45-16,16,8-g49-path110", "128S107-16,16,8-g49-path232" ];
