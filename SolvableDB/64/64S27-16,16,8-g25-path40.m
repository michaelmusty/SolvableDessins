...
s`SolvableDBName := "64S27-16,16,8-g25-path40";
s`SolvableDBFilename := "64S27-16,16,8-g25-path40.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 43, 45, 17, 49, 14, 21, 18, 22, 48, 32, 47, 44, 50, 19, 20, 23, 10, 42, 31, 9, 11, 12, 13, 27, 28, 29, 30, 55, 46, 57, 61, 62, 59, 60, 41, 63, 64, 38, 36, 33, 34, 35, 37, 39, 40, 51, 52, 56, 53, 58, 54 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T4-4,4,4-g3-path2", "32S3-8,8,4-g9-path3", "64S27-16,16,8-g25-path40" ];
s`SolvableDBParents := [ Strings() | "128S130-32,32,16-g57-path85", "128S130-32,32,16-g57-path86", "128S130-32,32,16-g57-path87", "128S130-32,32,16-g57-path88", "128S106-16,16,8-g49-path296", "128S44-16,16,8-g49-path159", "128S43-16,16,8-g49-path65" ];
