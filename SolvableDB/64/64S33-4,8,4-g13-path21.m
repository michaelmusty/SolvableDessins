...
s`SolvableDBName := "64S33-4,8,4-g13-path21";
s`SolvableDBFilename := "64S33-4,8,4-g13-path21.m";
...
\[ 12, 32, 26, 7, 2, 5, 31, 11, 20, 39, 13, 9, 23, 40, 36, 10, 54, 34, 25, 1, 27, 16, 8, 4, 58, 30, 33, 37, 14, 50, 24, 6, 42, 41, 60, 56, 38, 44, 22, 48, 51, 21, 35, 28, 46, 59, 55, 29, 19, 3, 18, 43, 15, 57, 64, 53, 63, 49, 61, 52, 45, 47, 17, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path3", "32S6-4,4,2-g1-path11", "64S33-4,8,4-g13-path21" ];
s`SolvableDBParents := [ Strings() | "128S58-8,8,4-g33-path61", "128S49-8,8,4-g33-path17", "128S78-8,8,4-g33-path17", "128S85-8,8,4-g33-path17", "128S122-4,8,4-g25-path490", "128S84-4,8,4-g25-path34", "128S76-4,8,4-g25-path34" ];
