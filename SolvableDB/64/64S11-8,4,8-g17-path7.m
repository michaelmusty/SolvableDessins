...
s`SolvableDBName := "64S11-8,4,8-g17-path7";
s`SolvableDBFilename := "64S11-8,4,8-g17-path7.m";
...
[ 47, 19, 62, 61, 57, 34, 50, 17, 26, 42, 41, 54, 25, 63, 45, 49, 38, 64, 40, 37, 48, 55, 15, 52, 58, 46, 6, 31, 22, 4, 60, 36, 51, 29, 14, 44, 28, 1, 18, 7, 56, 53, 20, 9, 10, 12, 30, 59, 43, 13, 23, 27, 33, 32, 24, 3, 39, 2, 5, 16, 8, 35, 11, 21 ]
]
];
...
\[ 6, 1, 18, 22, 20, 23, 4, 24, 2, 3, 5, 7, 8, 48, 41, 32, 52, 31, 47, 9, 16, 10, 11, 53, 17, 19, 51, 46, 45, 29, 12, 13, 14, 15, 21, 25, 26, 27, 28, 30, 57, 62, 44, 58, 56, 40, 34, 49, 36, 61, 63, 33, 35, 50, 42, 39, 37, 38, 43, 54, 55, 64, 59, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S11-4,2,8-g3-path6", "64S11-8,4,8-g17-path7" ];
s`SolvableDBParents := [ Strings() | "128S3-8,4,8-g33-path71", "128S3-8,4,8-g33-path72", "128S27-8,4,8-g33-path102" ];
