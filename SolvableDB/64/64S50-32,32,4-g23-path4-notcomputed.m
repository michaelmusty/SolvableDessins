...
s`SolvableDBName := "64S50-32,32,4-g23-path4-notcomputed";
s`SolvableDBFilename := "64S50-32,32,4-g23-path4-notcomputed.m";
...
\[ 6, 1, 16, 3, 14, 17, 8, 15, 2, 4, 5, 7, 25, 13, 24, 26, 27, 11, 9, 10, 12, 18, 34, 23, 35, 36, 33, 20, 19, 21, 22, 28, 42, 43, 44, 41, 29, 30, 31, 32, 50, 51, 52, 49, 37, 38, 39, 40, 58, 59, 60, 57, 45, 46, 47, 48, 64, 61, 62, 63, 53, 54, 55, 56 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T1-8,8,1-g0-path1-notcomputed", "16T5-8,8,2-g3-path1-notcomputed", "32S16-16,16,2-g7-path3-notcomputed", "64S50-32,32,4-g23-path4-notcomputed" ];
s`SolvableDBParents := [ Strings() | "128S159-64,64,8-g55-path7-notcomputed", "128S160-64,64,8-g55-path3-notcomputed", "128S159-64,64,8-g55-path8-notcomputed", "128S160-64,64,8-g55-path4-notcomputed", "128S131-32,32,4-g45-path5-notcomputed", "128S128-32,32,4-g45-path8-notcomputed", "128S153-32,32,4-g45-path11-notcomputed" ];
