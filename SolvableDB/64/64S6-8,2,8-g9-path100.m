...
s`SolvableDBName := "64S6-8,2,8-g9-path100";
s`SolvableDBFilename := "64S6-8,2,8-g9-path100.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 40, 38, 23, 20, 39, 37, 41, 42, 35, 36, 24, 8, 9, 10, 11, 12, 13, 14, 25, 31, 58, 57, 43, 56, 55, 59, 60, 44, 54, 26, 27, 28, 29, 30, 32, 33, 34, 50, 47, 49, 62, 61, 64, 51, 53, 45, 63, 46, 48, 52 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path7", "32S9-8,2,4-g3-path9", "64S6-8,2,8-g9-path100" ];
s`SolvableDBParents := [ Strings() | "128S67-8,4,16-g37-path10", "128S68-8,4,16-g37-path10", "128S63-16,2,8-g21-path50", "128S61-16,4,16-g41-path136", "128S65-16,2,8-g21-path44", "128S62-16,4,16-g41-path104", "128S67-8,2,16-g21-path10", "128S11-8,4,8-g33-path1038", "128S68-8,2,16-g21-path10", "128S3-8,4,8-g33-path504", "128S61-16,2,16-g25-path136", "128S64-16,4,8-g37-path90", "128S62-16,2,16-g25-path104", "128S66-16,4,8-g37-path78", "128S2-8,2,8-g17-path135" ];
