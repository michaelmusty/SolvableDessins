...
s`SolvableDBName := "64S34-4,4,4-g9-path17";
s`SolvableDBFilename := "64S34-4,4,4-g9-path17.m";
...
\[ 12, 36, 42, 7, 2, 5, 35, 39, 21, 20, 13, 9, 27, 58, 14, 17, 57, 10, 63, 26, 1, 29, 11, 30, 16, 18, 23, 15, 64, 31, 56, 54, 62, 44, 37, 6, 4, 60, 38, 41, 59, 34, 33, 3, 48, 49, 40, 32, 50, 61, 19, 22, 51, 45, 43, 24, 25, 28, 47, 8, 46, 55, 53, 52 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path5", "32S6-4,4,4-g5-path27", "64S34-4,4,4-g9-path17" ];
s`SolvableDBParents := [ Strings() | "128S75-8,4,4-g25-path40", "128S75-4,8,4-g25-path38", "128S50-8,8,4-g33-path9", "128S140-4,4,8-g25-path9", "128S138-8,4,8-g33-path16", "128S138-4,8,8-g33-path18", "128S142-8,8,8-g41-path25", "128S84-8,4,4-g25-path84", "128S84-4,8,4-g25-path82", "128S57-8,8,4-g33-path20", "128S141-4,4,8-g25-path9", "128S139-8,4,8-g33-path16", "128S139-4,8,8-g33-path18", "128S143-8,8,8-g41-path25", "128S125-4,4,4-g17-path676" ];
