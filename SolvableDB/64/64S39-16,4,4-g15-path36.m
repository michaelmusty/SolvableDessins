...
s`SolvableDBName := "64S39-16,4,4-g15-path36";
s`SolvableDBFilename := "64S39-16,4,4-g15-path36.m";
...
\[ 6, 1, 22, 23, 20, 24, 8, 25, 2, 3, 4, 5, 7, 29, 14, 26, 11, 37, 43, 41, 42, 19, 39, 44, 45, 28, 16, 46, 40, 9, 10, 12, 13, 15, 17, 18, 21, 27, 59, 58, 56, 57, 55, 60, 61, 62, 30, 31, 32, 33, 34, 35, 36, 38, 54, 47, 63, 64, 50, 49, 52, 48, 51, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path3", "32S9-8,4,2-g3-path11", "64S39-16,4,4-g15-path36" ];
s`SolvableDBParents := [ Strings() | "128S94-16,8,4-g37-path65", "128S64-16,8,4-g37-path39", "128S97-16,8,4-g37-path65", "128S64-16,8,4-g37-path40", "128S80-16,4,4-g29-path65", "128S112-16,4,4-g29-path262", "128S80-16,4,4-g29-path66" ];
