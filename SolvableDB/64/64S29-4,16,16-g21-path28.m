...
s`SolvableDBName := "64S29-4,16,16-g21-path28";
s`SolvableDBFilename := "64S29-4,16,16-g21-path28.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 36, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 45, 17, 43, 30, 32, 37, 13, 14, 18, 21, 28, 29, 35, 41, 31, 42, 51, 56, 34, 46, 33, 49, 48, 50, 54, 55, 52, 38, 40, 44, 47, 53, 58, 61, 60, 62, 63, 64, 57, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path9", "32S5-2,8,8-g5-path6", "64S29-4,16,16-g21-path28" ];
s`SolvableDBParents := [ Strings() | "128S131-8,32,32-g53-path23", "128S133-8,32,32-g53-path45", "128S133-8,32,32-g53-path46", "128S132-8,32,32-g53-path23", "128S131-8,32,32-g53-path24", "128S133-8,32,32-g53-path47", "128S133-8,32,32-g53-path48", "128S132-8,32,32-g53-path24", "128S69-4,16,16-g41-path101", "128S61-4,16,16-g41-path23", "128S54-4,16,16-g41-path51", "128S106-4,16,16-g41-path368", "128S61-4,16,16-g41-path24", "128S69-4,16,16-g41-path102", "128S46-4,16,16-g41-path12" ];
