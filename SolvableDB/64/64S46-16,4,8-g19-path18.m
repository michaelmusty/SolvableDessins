...
s`SolvableDBName := "64S46-16,4,8-g19-path18";
s`SolvableDBFilename := "64S46-16,4,8-g19-path18.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T8-4,4,4-g3-path5", "32S13-8,4,4-g7-path17", "64S46-16,4,8-g19-path18" ];
