...
s`SolvableDBName := "64S11-8,4,8-g17-path1-notcomputed";
s`SolvableDBFilename := "64S11-8,4,8-g17-path1-notcomputed.m";
...
[ 10, 22, 28, 45, 12, 3, 29, 42, 4, 39, 31, 30, 55, 37, 5, 50, 15, 46, 6, 7, 54, 56, 18, 62, 34, 1, 14, 13, 35, 53, 40, 61, 57, 11, 60, 47, 2, 33, 32, 24, 20, 59, 25, 17, 21, 8, 23, 26, 19, 27, 48, 41, 64, 38, 63, 16, 9, 52, 36, 58, 51, 43, 49, 44 ]
]
];
...
\[ 6, 1, 18, 22, 20, 23, 4, 24, 2, 3, 5, 7, 8, 48, 41, 32, 52, 31, 47, 9, 16, 10, 11, 53, 17, 19, 51, 46, 45, 29, 12, 13, 14, 15, 21, 25, 26, 27, 28, 30, 57, 62, 44, 58, 56, 40, 34, 49, 36, 61, 63, 33, 35, 50, 42, 39, 37, 38, 43, 54, 55, 64, 59, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,2,4-g1-path1-notcomputed", "8T2-4,2,4-g1-path2-notcomputed", "16T10-4,2,4-g1-path3-notcomputed", "32S11-4,2,8-g3-path1-notcomputed", "64S11-8,4,8-g17-path1-notcomputed" ];
s`SolvableDBChild := "32S11-4,2,8-g3-path1-notcomputed";
