...
s`SolvableDBName := "64S31-4,16,16-g21-path44";
s`SolvableDBFilename := "64S31-4,16,16-g21-path44.m";
...
\[ 2, 5, 9, 7, 6, 1, 10, 11, 14, 21, 15, 16, 31, 22, 23, 32, 24, 25, 26, 27, 4, 3, 8, 19, 33, 17, 34, 35, 36, 28, 29, 38, 43, 47, 40, 13, 41, 12, 42, 30, 51, 53, 18, 49, 44, 48, 20, 50, 54, 55, 56, 39, 52, 45, 46, 37, 58, 61, 62, 59, 63, 64, 57, 60 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T6-2,8,8-g3-path3", "32S5-2,8,8-g5-path23", "64S31-4,16,16-g21-path44" ];
s`SolvableDBParents := [ Strings() | "128S55-4,16,16-g41-path64", "128S61-4,16,16-g41-path96", "128S70-4,16,16-g41-path156", "128S69-4,16,16-g41-path220", "128S62-4,16,16-g41-path64", "128S111-4,16,16-g41-path518", "128S47-4,16,16-g41-path18" ];
