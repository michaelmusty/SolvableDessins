...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 11, 53, 12, 58, 14, 33, 59, 62, 40, 61, 34, 21, 45, 25, 47, 60, 17, 19, 20, 22, 23, 10, 55, 41, 36, 9, 13, 15, 16, 18, 26, 31, 32, 35, 37, 38, 42, 44, 46, 49, 64, 54, 50, 51, 63, 48, 43, 39, 56, 57, 52 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T8-4,4,4-g3-path14", "32S12-8,8,4-g9-path30", "64S44-16,16,8-g25-path22" ];
s`SolvableDBParents := [ Strings() | "128S153-32,32,16-g57-path43", "128S154-32,32,16-g57-path43", "128S153-32,32,16-g57-path44", "128S154-32,32,16-g57-path44", "128S102-16,16,8-g49-path304", "128S106-16,16,8-g49-path417", "128S99-16,16,8-g49-path304" ];
