...
s`SolvableDBName := "64S41-4,4,16-g15-path3";
s`SolvableDBFilename := "64S41-4,4,16-g15-path3.m";
...
\[ 2, 5, 9, 7, 6, 1, 10, 11, 14, 20, 15, 28, 29, 21, 22, 12, 23, 24, 25, 4, 3, 8, 19, 30, 17, 31, 32, 33, 26, 37, 13, 38, 16, 42, 47, 39, 18, 40, 34, 27, 43, 36, 48, 49, 41, 50, 44, 45, 35, 52, 57, 56, 63, 55, 51, 46, 54, 59, 62, 64, 58, 61, 60, 53 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T12-2,4,8-g2-path1", "32S9-2,4,8-g3-path12", "64S41-4,4,16-g15-path3" ];
s`SolvableDBParents := [ Strings() | "128S92-4,8,16-g37-path79", "128S66-4,8,16-g37-path34", "128S65-4,8,16-g37-path17", "128S95-4,8,16-g37-path158", "128S80-4,4,16-g29-path160", "128S79-4,4,16-g29-path80", "128S118-4,4,16-g29-path434" ];
