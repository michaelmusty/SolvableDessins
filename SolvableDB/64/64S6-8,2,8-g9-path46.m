...
s`SolvableDBName := "64S6-8,2,8-g9-path46";
s`SolvableDBFilename := "64S6-8,2,8-g9-path46.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 14, 49, 46, 50, 47, 40, 45, 44, 9, 29, 41, 8, 10, 11, 12, 13, 20, 23, 24, 25, 37, 42, 38, 43, 36, 39, 35, 64, 58, 53, 57, 62, 61, 30, 59, 55, 33, 48, 26, 27, 28, 31, 32, 34, 51, 52, 63, 60, 54, 56 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S5-8,2,8-g5-path1", "64S6-8,2,8-g9-path46" ];
s`SolvableDBParents := [ Strings() | "128S11-8,4,8-g33-path1113", "128S3-8,4,8-g33-path579", "128S67-16,2,8-g21-path42", "128S67-16,4,8-g37-path42", "128S68-16,2,8-g21-path42", "128S68-16,4,8-g37-path42", "128S63-8,2,16-g21-path82", "128S64-8,4,16-g37-path122", "128S65-8,2,16-g21-path76", "128S66-8,4,16-g37-path110", "128S61-16,2,16-g25-path211", "128S61-16,4,16-g41-path211", "128S62-16,2,16-g25-path179", "128S62-16,4,16-g41-path179", "128S2-8,2,8-g17-path210" ];
