...
s`SolvableDBName := "64S31-16,16,8-g25-path9";
s`SolvableDBFilename := "64S31-16,16,8-g25-path9.m";
...
\[ 51, 56, 63, 13, 32, 38, 41, 25, 24, 19, 29, 62, 17, 48, 45, 33, 28, 59, 49, 2, 46, 10, 50, 20, 57, 7, 58, 8, 36, 21, 22, 9, 39, 55, 27, 5, 54, 11, 31, 6, 44, 23, 47, 4, 37, 12, 53, 64, 3, 15, 40, 34, 16, 18, 42, 60, 30, 43, 61, 1, 14, 26, 35, 52 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T6-8,8,4-g5-path1", "32S5-8,8,4-g9-path19", "64S31-16,16,8-g25-path9" ];
s`SolvableDBParents := [ Strings() | "128S61-16,16,8-g49-path225", "128S62-16,16,8-g49-path161", "128S47-16,16,8-g49-path69", "128S69-16,16,8-g49-path225", "128S111-16,16,8-g49-path523", "128S55-16,16,8-g49-path69", "128S70-16,16,8-g49-path161" ];
