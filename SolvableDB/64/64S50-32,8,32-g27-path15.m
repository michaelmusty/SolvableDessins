...
s`SolvableDBName := "64S50-32,8,32-g27-path15";
s`SolvableDBFilename := "64S50-32,8,32-g27-path15.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 35, 36, 37, 13, 41, 43, 44, 17, 45, 18, 14, 47, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 40, 42, 57, 31, 59, 61, 49, 39, 62, 52, 60, 33, 54, 38, 27, 28, 29, 30, 32, 34, 46, 48, 56, 55, 51, 58, 63, 64, 50, 53 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,2,8-g3-path6", "32S16-16,4,16-g11-path6", "64S50-32,8,32-g27-path15" ];
s`SolvableDBParents := [ Strings() | "128S159-64,16,64-g59-path47", "128S160-64,16,64-g59-path39", "128S159-64,16,64-g59-path48", "128S160-64,16,64-g59-path40", "128S153-32,8,32-g53-path98", "128S128-32,8,32-g53-path67", "128S131-32,8,32-g53-path98" ];
