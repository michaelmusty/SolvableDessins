...
s`SolvableDBName := "64S50-32,16,32-g29-path42";
s`SolvableDBFilename := "64S50-32,16,32-g29-path42.m";
...
\[ 61, 55, 59, 51, 53, 49, 45, 60, 50, 64, 37, 54, 39, 52, 43, 58, 48, 47, 44, 36, 33, 63, 35, 57, 29, 62, 38, 34, 56, 15, 19, 26, 27, 42, 32, 31, 28, 41, 46, 18, 17, 10, 24, 16, 40, 3, 8, 22, 12, 25, 13, 11, 9, 23, 30, 6, 5, 2, 14, 4, 20, 1, 7, 21 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T1-16,8,16-g7-path2", "32S16-16,8,16-g13-path2", "64S50-32,16,32-g29-path42" ];
s`SolvableDBParents := [ Strings() | "128S159-64,32,64-g61-path77", "128S160-64,32,64-g61-path61", "128S159-64,32,64-g61-path78", "128S160-64,32,64-g61-path62", "128S131-32,16,32-g57-path187", "128S128-32,16,32-g57-path125", "128S153-32,16,32-g57-path187" ];
