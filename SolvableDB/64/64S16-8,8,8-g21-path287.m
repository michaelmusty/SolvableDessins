...
s`SolvableDBName := "64S16-8,8,8-g21-path287";
s`SolvableDBFilename := "64S16-8,8,8-g21-path287.m";
s`SolvableDBPathNumber := 287;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path32", "32S15-8,8,8-g11-path51", "64S16-8,8,8-g21-path287" ];
