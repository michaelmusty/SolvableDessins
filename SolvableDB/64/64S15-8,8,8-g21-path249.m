...
s`SolvableDBName := "64S15-8,8,8-g21-path249";
s`SolvableDBFilename := "64S15-8,8,8-g21-path249.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path17", "32S15-8,8,8-g11-path17", "64S15-8,8,8-g21-path249" ];
