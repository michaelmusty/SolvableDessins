...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path32", "32S12-4,8,8-g9-path42", "64S16-8,8,8-g21-path37" ];
s`SolvableDBChildren := [ Strings() | "32S12-4,8,8-g9-path42" ];
