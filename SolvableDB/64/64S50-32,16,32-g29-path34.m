...
s`SolvableDBName := "64S50-32,16,32-g29-path34";
s`SolvableDBFilename := "64S50-32,16,32-g29-path34.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 27, 38, 29, 13, 43, 45, 47, 17, 49, 18, 14, 33, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 30, 54, 35, 55, 36, 37, 61, 62, 63, 41, 64, 42, 52, 44, 58, 46, 39, 48, 40, 28, 31, 32, 34, 50, 51, 53, 56, 57, 59, 60 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,4,8-g5-path3", "32S16-16,8,16-g13-path16", "64S50-32,16,32-g29-path34" ];
s`SolvableDBParents := [ Strings() | "128S160-64,32,64-g61-path69", "128S159-64,32,64-g61-path85", "128S159-64,32,64-g61-path86", "128S160-64,32,64-g61-path70", "128S153-32,16,32-g57-path191", "128S131-32,16,32-g57-path191", "128S128-32,16,32-g57-path129" ];
