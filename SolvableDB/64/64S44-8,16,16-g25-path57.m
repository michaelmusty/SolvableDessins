...
s`SolvableDBName := "64S44-8,16,16-g25-path57";
s`SolvableDBFilename := "64S44-8,16,16-g25-path57.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T1-8,16,16-g7-path1", "32S16-8,16,16-g13-path2", "64S44-8,16,16-g25-path57" ];
