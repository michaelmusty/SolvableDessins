...
\[ 41, 62, 13, 18, 20, 16, 10, 63, 22, 39, 43, 29, 28, 33, 25, 2, 49, 37, 50, 38, 8, 48, 59, 3, 58, 5, 7, 55, 56, 45, 40, 42, 44, 24, 51, 23, 60, 6, 4, 47, 9, 36, 34, 15, 14, 57, 21, 12, 35, 31, 46, 64, 54, 17, 11, 1, 53, 30, 61, 27, 52, 26, 19, 32 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path1", "32S10-8,4,4-g7-path2", "64S9-8,4,4-g13-path4" ];
s`SolvableDBParents := [ Strings() | "128S3-8,4,8-g33-path1143", "128S86-8,4,8-g33-path175", "128S4-8,4,8-g33-path537", "128S85-8,4,8-g33-path175", "128S84-8,4,4-g25-path102", "128S26-8,4,4-g25-path948", "128S83-8,4,4-g25-path102" ];
