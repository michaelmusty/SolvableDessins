...
phi := KX!((-2*x[3]^6 - 2*x[3]^2)/(x[3]^8 - 4*x[3]^6 + 6*x[3]^4 - 4*x[3]^2 + 1)*x[2]^2 + (x[3]^4 + 2*x[3]^2 + 1)/(x[3]^4 - 2*x[3]^2 + 1));
/* assign to object */
...
s`SolvableDBLocalSanityCheckTiming := 7.180p15;
...
s`SolvableDBParents := [ Strings() | "128S11-8,4,8-g33-path21", "128S28-4,8,8-g33-path15", "128S33-8,8,8-g41-path5", "128S28-8,4,8-g33-path15", "128S18-4,8,8-g33-path5", "128S24-8,8,8-g41-path6", "128S35-8,4,8-g33-path9", "128S11-4,8,8-g33-path21", "128S9-8,8,8-g41-path57", "128S18-8,4,8-g33-path5", "128S35-4,8,8-g33-path9", "128S33-8,8,8-g41-path6", "128S112-4,4,16-g29-path3", "128S114-8,4,16-g37-path3", "128S119-4,8,16-g37-path3", "128S120-8,8,16-g45-path5", "128S118-4,4,16-g29-path5", "128S119-8,4,16-g37-path3", "128S115-4,8,16-g37-path3", "128S117-8,8,16-g45-path3", "128S118-4,4,16-g29-path6", "128S121-8,4,16-g37-path3", "128S114-4,8,16-g37-path3", "128S113-8,8,16-g45-path3", "128S116-4,4,16-g29-path3", "128S115-8,4,16-g37-path3", "128S121-4,8,16-g37-path3", "128S120-8,8,16-g45-path6", "128S26-4,4,8-g25-path11", "128S26-4,4,8-g25-path12", "128S21-4,4,8-g25-path4" ];
