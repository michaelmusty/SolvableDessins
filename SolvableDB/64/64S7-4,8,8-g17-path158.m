...
s`SolvableDBName := "64S7-4,8,8-g17-path158";
s`SolvableDBFilename := "64S7-4,8,8-g17-path158.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 35, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 45, 17, 43, 37, 32, 28, 13, 14, 18, 21, 29, 30, 36, 41, 31, 42, 51, 56, 34, 49, 33, 44, 48, 50, 54, 55, 53, 40, 38, 46, 47, 52, 58, 61, 62, 59, 64, 63, 60, 57 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path4", "32S5-2,8,8-g5-path4", "64S7-4,8,8-g17-path158" ];
s`SolvableDBParents := [ Strings() | "128S70-4,16,16-g41-path347", "128S70-4,16,16-g41-path348", "128S69-4,16,16-g41-path411", "128S69-4,16,16-g41-path412", "128S11-4,8,8-g33-path1410", "128S3-4,8,8-g33-path876", "128S4-4,8,8-g33-path426" ];
