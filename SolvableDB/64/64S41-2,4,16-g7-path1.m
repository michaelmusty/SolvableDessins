...
s`SolvableDBName := "64S41-2,4,16-g7-path1";
s`SolvableDBFilename := "64S41-2,4,16-g7-path1.m";
...
s`SolvableDBParents := [ Strings() | "128S118-4,4,16-g29-path13", "128S92-2,8,16-g21-path5", "128S95-4,8,16-g37-path9", "128S80-4,4,16-g29-path13", "128S65-2,8,16-g21-path1", "128S66-4,8,16-g37-path1", "128S79-2,4,16-g13-path4" ];
