...
s`SolvableDBName := "64S44-16,4,16-g21-path38";
s`SolvableDBFilename := "64S44-16,4,16-g21-path38.m";
...
\[ 6, 1, 24, 25, 22, 26, 4, 23, 2, 3, 5, 7, 8, 21, 41, 28, 45, 14, 44, 49, 48, 19, 17, 42, 47, 50, 16, 20, 10, 35, 11, 9, 12, 13, 15, 18, 27, 29, 30, 31, 61, 63, 60, 53, 43, 64, 54, 46, 56, 58, 36, 33, 32, 34, 37, 38, 39, 40, 51, 52, 59, 55, 62, 57 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path30", "32S12-8,4,8-g9-path37", "64S44-16,4,16-g21-path38" ];
s`SolvableDBParents := [ Strings() | "128S102-16,8,16-g49-path253", "128S154-32,4,32-g45-path51", "128S153-32,8,32-g53-path51", "128S99-16,8,16-g49-path253", "128S154-32,4,32-g45-path52", "128S153-32,8,32-g53-path52", "128S106-16,4,16-g41-path444" ];
