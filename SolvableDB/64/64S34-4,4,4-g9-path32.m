...
s`SolvableDBName := "64S34-4,4,4-g9-path32";
s`SolvableDBFilename := "64S34-4,4,4-g9-path32.m";
...
\[ 12, 36, 42, 7, 2, 5, 35, 39, 21, 20, 13, 9, 27, 58, 14, 17, 57, 10, 63, 26, 1, 29, 11, 30, 16, 18, 23, 15, 64, 31, 56, 54, 62, 44, 37, 6, 4, 60, 38, 41, 59, 34, 33, 3, 48, 49, 40, 32, 50, 61, 19, 22, 51, 45, 43, 24, 25, 28, 47, 8, 46, 55, 53, 52 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path3", "32S6-4,4,4-g5-path33", "64S34-4,4,4-g9-path32" ];
s`SolvableDBParents := [ Strings() | "128S75-8,4,4-g25-path27", "128S75-4,8,4-g25-path27", "128S50-8,8,4-g33-path4", "128S140-4,4,8-g25-path4", "128S138-8,4,8-g33-path5", "128S138-4,8,8-g33-path5", "128S142-8,8,8-g41-path6", "128S84-8,4,4-g25-path71", "128S84-4,8,4-g25-path71", "128S57-8,8,4-g33-path15", "128S141-4,4,8-g25-path4", "128S139-8,4,8-g33-path5", "128S139-4,8,8-g33-path5", "128S143-8,8,8-g41-path6", "128S125-4,4,4-g17-path657" ];
