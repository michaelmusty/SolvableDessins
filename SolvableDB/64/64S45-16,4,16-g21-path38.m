...
s`SolvableDBName := "64S45-16,4,16-g21-path38";
s`SolvableDBFilename := "64S45-16,4,16-g21-path38.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T8-4,4,4-g3-path7", "32S12-8,4,8-g9-path42", "64S45-16,4,16-g21-path38" ];
