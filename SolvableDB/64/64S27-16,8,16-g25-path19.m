...
s`SolvableDBName := "64S27-16,8,16-g25-path19";
s`SolvableDBFilename := "64S27-16,8,16-g25-path19.m";
...
[ 10, 30, 31, 5, 8, 3, 11, 37, 39, 32, 13, 34, 51, 27, 16, 18, 14, 38, 2, 21, 1, 6, 7, 29, 15, 24, 9, 19, 12, 40, 35, 55, 57, 36, 54, 59, 52, 33, 58, 63, 17, 23, 44, 4, 22, 25, 41, 28, 26, 42, 60, 53, 62, 56, 64, 46, 45, 49, 47, 61, 48, 20, 50, 43 ]
]
];
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 28, 41, 17, 48, 14, 21, 45, 22, 49, 44, 42, 47, 50, 19, 20, 23, 10, 29, 31, 9, 11, 12, 13, 18, 27, 30, 32, 61, 43, 56, 46, 58, 59, 60, 62, 63, 64, 37, 38, 33, 34, 35, 36, 39, 40, 51, 52, 53, 57, 55, 54 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,2,8-g3-path7", "32S3-8,4,8-g9-path18", "64S27-16,8,16-g25-path19" ];
s`SolvableDBParents := [ Strings() | "128S130-32,16,32-g57-path21", "128S130-32,16,32-g57-path22", "128S130-32,16,32-g57-path23", "128S130-32,16,32-g57-path24", "128S106-16,8,16-g49-path280", "128S44-16,8,16-g49-path143", "128S43-16,8,16-g49-path49" ];
