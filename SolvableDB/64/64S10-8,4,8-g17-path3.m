...
s`SolvableDBName := "64S10-8,4,8-g17-path3";
s`SolvableDBFilename := "64S10-8,4,8-g17-path3.m";
...
s`SolvableDBLocalSanityCheckTiming := 3.850p15;
...
[ 17, 14, 42, 48, 23, 50, 44, 2, 33, 26, 8, 27, 9, 11, 56, 29, 5, 53, 32, 39, 41, 43, 1, 58, 59, 12, 10, 21, 25, 19, 13, 38, 31, 61, 57, 63, 64, 30, 4, 28, 40, 7, 47, 3, 54, 45, 55, 20, 62, 18, 46, 49, 6, 51, 22, 24, 37, 15, 16, 52, 36, 60, 34, 35 ],
[ 14, 33, 11, 5, 8, 17, 2, 41, 25, 31, 13, 9, 48, 28, 7, 42, 54, 23, 20, 1, 18, 50, 46, 3, 44, 40, 21, 58, 37, 59, 16, 29, 39, 12, 26, 10, 27, 4, 63, 6, 56, 45, 24, 51, 22, 32, 53, 61, 38, 36, 47, 43, 34, 30, 15, 57, 49, 64, 35, 19, 52, 55, 62, 60 ]
]
];
...
\[ 59, 64, 56, 32, 29, 31, 58, 37, 62, 61, 57, 63, 49, 35, 28, 43, 16, 9, 54, 30, 12, 11, 25, 41, 55, 36, 34, 26, 47, 45, 52, 51, 60, 39, 50, 48, 53, 46, 19, 10, 27, 24, 8, 15, 3, 44, 2, 38, 23, 13, 7, 5, 33, 42, 14, 21, 18, 40, 22, 17, 4, 1, 20, 6 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path4", "32S7-8,2,8-g5-path3", "64S10-8,4,8-g17-path3" ];
s`SolvableDBParents := [ Strings() | "128S87-16,4,16-g41-path5", "128S88-16,4,16-g41-path11", "128S87-16,4,16-g41-path6", "128S88-16,4,16-g41-path12", "128S4-8,4,8-g33-path6", "128S2-8,4,8-g33-path3", "128S27-8,4,8-g33-path6" ];
