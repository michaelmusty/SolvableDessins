...
s`SolvableDBName := "64S26-16,16,8-g25-path3";
s`SolvableDBFilename := "64S26-16,16,8-g25-path3.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 10, 11, 22, 13, 35, 37, 39, 17, 25, 18, 14, 38, 20, 16, 9, 12, 23, 26, 29, 31, 51, 53, 55, 33, 40, 34, 54, 36, 27, 32, 28, 30, 41, 42, 45, 47, 48, 63, 61, 49, 56, 50, 64, 52, 43, 44, 46, 57, 60, 58, 59, 62 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path3", "32S16-16,16,8-g13-path11", "64S26-16,16,8-g25-path3" ];
s`SolvableDBParents := [ Strings() | "128S128-32,32,16-g57-path51", "128S129-32,32,16-g57-path51", "128S128-32,32,16-g57-path52", "128S129-32,32,16-g57-path52", "128S106-16,16,8-g49-path253", "128S42-16,16,8-g49-path73", "128S44-16,16,8-g49-path73" ];
