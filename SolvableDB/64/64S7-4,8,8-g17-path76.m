...
s`SolvableDBName := "64S7-4,8,8-g17-path76";
s`SolvableDBFilename := "64S7-4,8,8-g17-path76.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T10-2,4,4-g1-path4", "32S11-2,4,8-g3-path6", "64S7-4,8,8-g17-path76" ];
