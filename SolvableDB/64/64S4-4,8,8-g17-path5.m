...
x[2]^4*x[4]^2 - 2*x[1]*x[2]^3 + x[2]^4 + 2*x[1]*x[2] - 2*x[2]^2 + x[4]^2 - 1,
...
s`SolvableDBName := "64S4-4,8,8-g17-path5";
s`SolvableDBFilename := "64S4-4,8,8-g17-path5.m";
...
{ IntegerRing() | 62, 63 }
@};
s`SolvableDBBelyiMapTiming := 4.580p15;
s`SolvableDBLocalSanityCheckTiming := 17.560p15;
...
s`SolvableDBParents := [ Strings() | "128S46-8,16,16-g49-path11", "128S46-8,16,16-g49-path12", "128S53-8,16,16-g49-path3", "128S53-8,16,16-g49-path4", "128S47-8,16,16-g49-path7", "128S47-8,16,16-g49-path8", "128S52-8,16,16-g49-path3", "128S52-8,16,16-g49-path4", "128S12-4,8,8-g33-path17", "128S50-4,8,8-g33-path4", "128S51-4,8,8-g33-path9", "128S2-4,8,8-g33-path8", "128S4-4,8,8-g33-path17", "128S48-4,8,8-g33-path4", "128S49-4,8,8-g33-path9" ];
