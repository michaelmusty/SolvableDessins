...
s`SolvableDBName := "64S8-8,2,4-g5-path1";
s`SolvableDBFilename := "64S8-8,2,4-g5-path1.m";
...
\[ 46, 43, 49, 56, 50, 61, 20, 17, 21, 47, 22, 32, 45, 38, 60, 48, 55, 44, 64, 28, 33, 52, 4, 37, 5, 42, 6, 40, 15, 41, 54, 53, 10, 14, 19, 18, 57, 36, 63, 62, 59, 58, 25, 39, 51, 8, 35, 12, 23, 27, 16, 1, 13, 24, 11, 26, 30, 3, 31, 7, 2, 29, 34, 9 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path1", "32S11-8,2,4-g3-path2", "64S8-8,2,4-g5-path1" ];
s`SolvableDBParents := [ Strings() | "128S76-8,4,4-g25-path121", "128S77-8,2,8-g17-path116", "128S3-8,4,8-g33-path1011", "128S26-8,4,4-g25-path811", "128S2-8,2,8-g17-path297", "128S78-8,4,8-g33-path199", "128S79-16,2,4-g13-path73", "128S72-16,4,4-g29-path33", "128S73-16,2,8-g21-path33", "128S82-16,4,8-g37-path101", "128S71-16,2,4-g13-path33", "128S80-16,4,4-g29-path193", "128S81-16,2,8-g21-path67", "128S74-16,4,8-g37-path33", "128S75-8,2,4-g9-path55" ];
