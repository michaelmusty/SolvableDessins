...
I<[x]> := ideal< P | [
x[3]^2*x[4]^4 + x[2]^2*x[3]^2 + x[4]^4 + 2*x[2]*x[4]^2 + x[2]^2 - 2,
x[2]^3*x[3]^2 - x[3]^2*x[4]^2 + 2*x[1]*x[2]^2 + x[2]^3 - x[4]^2 - 2*x[1] - 2*x[2],
x[2]*x[3]^2*x[4]^2 + x[2]*x[4]^2 + x[3]^2 - 1,
x[1]^2*x[2]^2 - x[1]^2 + x[2]^2 + 1,
x[2]^2*x[4]^2 - x[1]*x[2]^2 + x[4]^2 + x[1],
...
s`SolvableDBName := "64S8-4,8,4-g13-path3";
s`SolvableDBFilename := "64S8-4,8,4-g13-path3.m";
...
\[ 6, 1, 26, 27, 23, 9, 4, 28, 2, 3, 5, 7, 8, 49, 43, 52, 13, 62, 31, 50, 56, 29, 35, 21, 57, 33, 12, 17, 19, 20, 22, 18, 10, 37, 11, 14, 15, 16, 24, 25, 30, 32, 34, 53, 46, 47, 61, 40, 51, 41, 36, 60, 59, 64, 44, 39, 48, 54, 55, 38, 45, 42, 58, 63 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path5", "32S6-4,4,4-g5-path3", "64S8-4,8,4-g13-path3" ];
s`SolvableDBParents := [ Strings() | "128S2-4,8,8-g33-path21", "128S3-4,8,8-g33-path72", "128S77-4,8,8-g33-path10", "128S78-4,8,8-g33-path20", "128S79-4,16,4-g29-path14", "128S81-4,16,8-g37-path5", "128S80-4,16,4-g29-path28", "128S82-4,16,8-g37-path10", "128S71-4,16,4-g29-path6", "128S73-4,16,8-g37-path3", "128S72-4,16,4-g29-path12", "128S74-4,16,8-g37-path6", "128S26-4,8,4-g25-path36", "128S75-4,8,4-g25-path10", "128S76-4,8,4-g25-path20" ];
