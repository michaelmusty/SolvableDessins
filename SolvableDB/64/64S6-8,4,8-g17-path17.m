...
s`SolvableDBName := "64S6-8,4,8-g17-path17";
s`SolvableDBFilename := "64S6-8,4,8-g17-path17.m";
...
\[ 6, 1, 26, 27, 23, 28, 4, 29, 2, 3, 5, 7, 8, 22, 44, 56, 42, 14, 32, 34, 57, 9, 58, 21, 59, 37, 10, 18, 17, 19, 20, 13, 43, 38, 62, 11, 12, 15, 16, 24, 25, 30, 31, 33, 35, 55, 45, 60, 63, 48, 46, 49, 61, 47, 36, 64, 39, 51, 50, 53, 41, 52, 54, 40 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path8", "32S11-8,4,4-g7-path10", "64S6-8,4,8-g17-path17" ];
s`SolvableDBParents := [ Strings() | "128S67-16,8,8-g45-path15", "128S68-16,8,8-g45-path15", "128S68-16,8,8-g45-path16", "128S67-16,8,8-g45-path16", "128S63-8,4,16-g37-path48", "128S61-16,8,16-g49-path279", "128S66-8,4,16-g37-path127", "128S62-16,8,16-g49-path215", "128S65-8,4,16-g37-path42", "128S62-16,8,16-g49-path216", "128S64-8,4,16-g37-path139", "128S61-16,8,16-g49-path280", "128S3-8,4,8-g33-path610", "128S2-8,4,8-g33-path139", "128S11-8,4,8-g33-path1144" ];
