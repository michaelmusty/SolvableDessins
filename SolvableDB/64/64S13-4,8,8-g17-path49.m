...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 53, 45, 55, 13, 33, 32, 35, 46, 30, 42, 38, 21, 59, 34, 12, 17, 19, 20, 22, 23, 10, 37, 40, 31, 11, 14, 15, 16, 18, 25, 26, 36, 43, 58, 49, 50, 63, 56, 44, 54, 39, 61, 47, 62, 51, 52, 57, 41, 64, 48, 60 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path9", "32S8-4,8,8-g9-path6", "64S13-4,8,8-g17-path49" ];
s`SolvableDBParents := [ Strings() | "128S96-4,16,8-g37-path8", "128S95-4,16,8-g37-path15", "128S97-4,16,8-g37-path8", "128S95-4,16,8-g37-path16", "128S3-4,8,8-g33-path169", "128S28-4,8,8-g33-path64", "128S3-4,8,8-g33-path170" ];
