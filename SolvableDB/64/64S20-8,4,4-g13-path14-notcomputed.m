...
s`SolvableDBName := "64S20-8,4,4-g13-path14-notcomputed";
s`SolvableDBFilename := "64S20-8,4,4-g13-path14-notcomputed.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 42, 61, 64, 62, 14, 16, 46, 9, 52, 63, 31, 43, 34, 13, 12, 56, 49, 50, 57, 41, 59, 40, 10, 11, 15, 17, 18, 19, 20, 21, 23, 25, 26, 32, 33, 35, 36, 48, 55, 47, 58, 39, 44, 51, 45, 54, 60, 37, 38, 53 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-2,4,4-g1-path4-notcomputed", "16T4-4,4,4-g3-path1-notcomputed", "32S2-4,4,4-g5-path10-notcomputed", "64S20-8,4,4-g13-path14-notcomputed" ];
