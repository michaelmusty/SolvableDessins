...
s`SolvableDBName := "64S15-8,8,8-g21-path206";
s`SolvableDBFilename := "64S15-8,8,8-g21-path206.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T8-4,4,4-g3-path20", "32S13-4,8,4-g7-path9", "64S15-8,8,8-g21-path206" ];
