...
s`SolvableDBName := "64S29-16,16,4-g21-path31";
s`SolvableDBFilename := "64S29-16,16,4-g21-path31.m";
...
\[ 6, 1, 22, 23, 20, 24, 8, 25, 2, 3, 4, 5, 7, 44, 14, 42, 49, 43, 10, 47, 36, 48, 17, 50, 45, 29, 16, 30, 27, 35, 9, 11, 12, 13, 15, 18, 19, 21, 26, 28, 62, 63, 61, 64, 41, 53, 46, 57, 55, 59, 33, 37, 31, 32, 34, 38, 39, 40, 51, 52, 58, 54, 60, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,1-g0-path1", "16T5-8,8,2-g3-path1", "32S5-8,8,2-g5-path16", "64S29-16,16,4-g21-path31" ];
s`SolvableDBParents := [ Strings() | "128S131-32,32,8-g53-path21", "128S133-32,32,8-g53-path41", "128S133-32,32,8-g53-path42", "128S132-32,32,8-g53-path21", "128S131-32,32,8-g53-path22", "128S133-32,32,8-g53-path43", "128S133-32,32,8-g53-path44", "128S132-32,32,8-g53-path22", "128S69-16,16,4-g41-path99", "128S61-16,16,4-g41-path21", "128S54-16,16,4-g41-path50", "128S106-16,16,4-g41-path367", "128S61-16,16,4-g41-path22", "128S69-16,16,4-g41-path100", "128S46-16,16,4-g41-path11" ];
