...
s`SolvableDBName := "64S39-16,4,4-g15-path13";
s`SolvableDBFilename := "64S39-16,4,4-g15-path13.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path1", "32S9-8,2,4-g3-path1", "64S39-16,4,4-g15-path13" ];
