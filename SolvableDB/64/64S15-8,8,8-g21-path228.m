...
s`SolvableDBName := "64S15-8,8,8-g21-path228";
s`SolvableDBFilename := "64S15-8,8,8-g21-path228.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T12-8,2,4-g2-path3", "32S13-8,4,4-g7-path3", "64S15-8,8,8-g21-path228" ];
