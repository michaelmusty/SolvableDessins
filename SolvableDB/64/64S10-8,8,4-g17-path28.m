...
s`SolvableDBName := "64S10-8,8,4-g17-path28";
s`SolvableDBFilename := "64S10-8,8,4-g17-path28.m";
...
\[ 58, 62, 41, 33, 29, 32, 61, 54, 63, 56, 59, 57, 40, 28, 42, 43, 14, 10, 9, 36, 39, 13, 12, 31, 60, 50, 25, 35, 49, 47, 64, 52, 51, 26, 53, 34, 30, 55, 45, 8, 27, 20, 18, 17, 16, 15, 3, 11, 2, 46, 7, 5, 38, 48, 44, 21, 19, 23, 22, 37, 24, 6, 1, 4 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path5", "32S7-8,8,2-g5-path5", "64S10-8,8,4-g17-path28" ];
s`SolvableDBParents := [ Strings() | "128S87-16,16,4-g41-path39", "128S88-16,16,4-g41-path105", "128S87-16,16,4-g41-path40", "128S88-16,16,4-g41-path106", "128S4-8,8,4-g33-path53", "128S2-8,8,4-g33-path20", "128S27-8,8,4-g33-path53" ];
