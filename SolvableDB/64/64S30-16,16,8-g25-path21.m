...
s`SolvableDBName := "64S30-16,16,8-g25-path21";
s`SolvableDBFilename := "64S30-16,16,8-g25-path21.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 41, 54, 34, 31, 11, 16, 33, 50, 36, 63, 51, 46, 21, 61, 47, 19, 59, 38, 57, 62, 10, 40, 56, 39, 9, 12, 13, 14, 15, 17, 18, 20, 23, 25, 26, 32, 35, 37, 45, 44, 52, 58, 64, 49, 48, 55, 43, 60, 42, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S5-8,8,4-g9-path7", "64S30-16,16,8-g25-path21" ];
s`SolvableDBParents := [ Strings() | "128S62-16,16,8-g49-path51", "128S62-16,16,8-g49-path52", "128S46-16,16,8-g49-path104", "128S54-16,16,8-g49-path104", "128S70-16,16,8-g49-path51", "128S70-16,16,8-g49-path52", "128S109-16,16,8-g49-path253" ];
