...
s`SolvableDBName := "64S14-8,8,4-g17-path3-notcomputed";
s`SolvableDBFilename := "64S14-8,8,4-g17-path3-notcomputed.m";
...
\[ 46, 63, 33, 14, 32, 23, 19, 11, 22, 35, 40, 29, 28, 38, 7, 17, 44, 47, 30, 42, 50, 51, 2, 41, 43, 52, 48, 8, 54, 4, 3, 39, 21, 58, 45, 5, 16, 62, 6, 64, 13, 55, 53, 56, 18, 9, 61, 10, 57, 25, 12, 20, 31, 1, 34, 59, 37, 60, 49, 26, 27, 15, 36, 24 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T14-8,4,4-g4-path1-notcomputed", "32S10-8,4,4-g7-path10-notcomputed", "64S14-8,8,4-g17-path3-notcomputed" ];
