...
s`SolvableDBName := "64S42-2,16,8-g11-path7";
s`SolvableDBFilename := "64S42-2,16,8-g11-path7.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path1", "32S9-2,8,4-g3-path15", "64S42-2,16,8-g11-path7" ];
