...
s`SolvableDBName := "64S9-8,4,4-g13-path7";
s`SolvableDBFilename := "64S9-8,4,4-g13-path7.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 23, 60, 48, 44, 14, 39, 64, 55, 62, 9, 61, 21, 47, 38, 10, 18, 63, 19, 20, 22, 43, 52, 56, 11, 12, 13, 15, 16, 17, 25, 26, 31, 32, 33, 34, 35, 36, 59, 53, 50, 51, 41, 58, 46, 49, 37, 57, 54, 42, 45, 40 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S10-8,4,4-g7-path4", "64S9-8,4,4-g13-path7" ];
s`SolvableDBParents := [ Strings() | "128S86-8,4,8-g33-path180", "128S4-8,4,8-g33-path542", "128S3-8,4,8-g33-path1148", "128S85-8,4,8-g33-path180", "128S83-8,4,4-g25-path107", "128S84-8,4,4-g25-path107", "128S26-8,4,4-g25-path953" ];
