...
s`SolvableDBName := "64S4-4,8,8-g17-path23";
s`SolvableDBFilename := "64S4-4,8,8-g17-path23.m";
...
\[ 22, 5, 52, 39, 6, 38, 4, 44, 12, 18, 24, 1, 11, 15, 28, 51, 63, 26, 14, 58, 31, 9, 54, 27, 29, 33, 13, 19, 21, 23, 25, 20, 10, 61, 47, 43, 7, 2, 37, 41, 8, 59, 3, 40, 57, 50, 62, 49, 46, 48, 45, 36, 55, 56, 42, 30, 16, 64, 53, 35, 17, 60, 34, 32 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T6-4,8,8-g5-path2", "32S5-4,8,8-g9-path19", "64S4-4,8,8-g17-path23" ];
s`SolvableDBParents := [ Strings() | "128S46-8,16,16-g49-path209", "128S46-8,16,16-g49-path210", "128S53-8,16,16-g49-path85", "128S53-8,16,16-g49-path86", "128S47-8,16,16-g49-path177", "128S47-8,16,16-g49-path178", "128S52-8,16,16-g49-path85", "128S52-8,16,16-g49-path86", "128S12-4,8,8-g33-path521", "128S50-4,8,8-g33-path65", "128S51-4,8,8-g33-path132", "128S2-4,8,8-g33-path121", "128S4-4,8,8-g33-path244", "128S48-4,8,8-g33-path65", "128S49-4,8,8-g33-path132" ];
