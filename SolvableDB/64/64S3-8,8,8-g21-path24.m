...
\[ 6, 1, 24, 25, 19, 26, 21, 3, 2, 4, 5, 7, 8, 16, 36, 17, 13, 38, 9, 34, 22, 27, 20, 30, 12, 11, 10, 44, 28, 14, 15, 18, 23, 29, 31, 32, 52, 40, 37, 35, 57, 41, 53, 46, 54, 33, 43, 45, 47, 49, 39, 42, 48, 50, 51, 64, 55, 63, 56, 58, 59, 61, 62, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-2,8,8-g3-path3", "32S3-4,8,8-g9-path21", "64S3-8,8,8-g21-path24" ];
s`SolvableDBParents := [ Strings() | "128S45-16,8,16-g49-path483", "128S45-16,8,16-g49-path484", "128S44-8,16,16-g49-path309", "128S44-8,16,16-g49-path310", "128S45-16,16,8-g49-path409", "128S45-16,16,8-g49-path410", "128S5-8,8,8-g41-path950" ];
