...
s`SolvableDBName := "64S16-8,8,8-g21-path173";
s`SolvableDBFilename := "64S16-8,8,8-g21-path173.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path1", "32S14-4,8,4-g7-path1", "64S16-8,8,8-g21-path173" ];
