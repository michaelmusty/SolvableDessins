...
s`SolvableDBName := "64S48-4,16,4-g15-path14";
s`SolvableDBFilename := "64S48-4,16,4-g15-path14.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T14-4,8,4-g4-path3", "32S14-4,8,4-g7-path6", "64S48-4,16,4-g15-path14" ];
