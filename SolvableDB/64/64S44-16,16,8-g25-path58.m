...
s`SolvableDBName := "64S44-16,16,8-g25-path58";
s`SolvableDBFilename := "64S44-16,16,8-g25-path58.m";
...
[ 8, 13, 17, 1, 10, 15, 2, 28, 30, 31, 26, 9, 34, 3, 27, 29, 35, 11, 4, 5, 14, 18, 6, 16, 7, 44, 45, 46, 33, 47, 48, 12, 49, 50, 51, 19, 20, 23, 25, 21, 24, 22, 32, 60, 61, 52, 62, 63, 64, 58, 54, 36, 37, 40, 42, 38, 41, 39, 43, 55, 56, 59, 53, 57 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T1-16,16,8-g7-path2", "32S16-16,16,8-g13-path3", "64S44-16,16,8-g25-path58" ];
