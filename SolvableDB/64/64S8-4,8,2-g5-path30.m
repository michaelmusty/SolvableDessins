...
s`SolvableDBName := "64S8-4,8,2-g5-path30";
s`SolvableDBFilename := "64S8-4,8,2-g5-path30.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T13-2,8,2-g0-path2", "32S9-4,8,2-g3-path16", "64S8-4,8,2-g5-path30" ];
