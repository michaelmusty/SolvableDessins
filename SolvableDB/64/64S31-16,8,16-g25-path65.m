...
s`SolvableDBName := "64S31-16,8,16-g25-path65";
s`SolvableDBFilename := "64S31-16,8,16-g25-path65.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S5-8,4,8-g9-path3", "64S31-16,8,16-g25-path65" ];
s`SolvableDBChildren := [ Strings() | "32S5-8,4,8-g9-path3" ];
