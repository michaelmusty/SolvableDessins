...
s`SolvableDBName := "64S6-8,2,8-g9-path3-notcomputed";
s`SolvableDBFilename := "64S6-8,2,8-g9-path3-notcomputed.m";
...
\[ 47, 44, 49, 55, 50, 60, 20, 17, 21, 48, 22, 33, 39, 63, 59, 45, 53, 36, 64, 29, 34, 52, 4, 40, 32, 5, 43, 6, 42, 15, 46, 57, 54, 10, 14, 41, 19, 18, 51, 56, 62, 61, 58, 26, 12, 25, 8, 37, 23, 28, 16, 1, 11, 13, 27, 31, 24, 3, 7, 2, 30, 35, 38, 9 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T10-4,2,4-g1-path5-notcomputed", "32S5-8,2,8-g5-path2-notcomputed", "64S6-8,2,8-g9-path3-notcomputed" ];
s`SolvableDBParents := [ Strings() | "128S67-8,4,16-g37-path2-notcomputed", "128S68-8,4,16-g37-path2-notcomputed", "128S63-16,2,8-g21-path6-notcomputed", "128S61-16,4,16-g41-path13-notcomputed", "128S65-16,2,8-g21-path4-notcomputed", "128S62-16,4,16-g41-path9-notcomputed", "128S67-8,2,16-g21-path2-notcomputed", "128S11-8,4,8-g33-path35-notcomputed", "128S68-8,2,16-g21-path2-notcomputed", "128S3-8,4,8-g33-path41-notcomputed", "128S61-16,2,16-g25-path13-notcomputed", "128S64-16,4,8-g37-path10-notcomputed", "128S62-16,2,16-g25-path9-notcomputed", "128S66-16,4,8-g37-path6-notcomputed", "128S2-8,2,8-g17-path14-notcomputed" ];
