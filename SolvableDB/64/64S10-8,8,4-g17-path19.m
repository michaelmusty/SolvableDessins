...
s`SolvableDBName := "64S10-8,8,4-g17-path19";
s`SolvableDBFilename := "64S10-8,8,4-g17-path19.m";
...
\[ 44, 61, 31, 14, 30, 22, 64, 11, 21, 20, 38, 28, 27, 36, 7, 19, 42, 45, 40, 47, 48, 2, 39, 41, 49, 56, 8, 51, 4, 37, 33, 53, 43, 5, 16, 62, 6, 63, 13, 59, 60, 52, 24, 9, 50, 55, 18, 12, 17, 26, 1, 32, 58, 3, 35, 10, 46, 25, 57, 54, 34, 15, 23, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path7", "32S11-8,4,4-g7-path17", "64S10-8,8,4-g17-path19" ];
s`SolvableDBParents := [ Strings() | "128S87-16,16,4-g41-path15", "128S88-16,16,4-g41-path81", "128S87-16,16,4-g41-path16", "128S88-16,16,4-g41-path82", "128S4-8,8,4-g33-path41", "128S2-8,8,4-g33-path8", "128S27-8,8,4-g33-path41" ];
