...
s`SolvableDBName := "64S15-8,8,8-g21-path203";
s`SolvableDBFilename := "64S15-8,8,8-g21-path203.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T8-4,4,4-g3-path19", "32S13-4,8,4-g7-path8", "64S15-8,8,8-g21-path203" ];
