...
I<[x]> := ideal< P | [
4*x[1]^2*x[2]*x[3]^2 + x[2]^2*x[3]^4 - x[2]^2 - 2*x[3]^4 + 2,
x[1]^4 + x[1]^2*x[2] + 1/2*x[2]^2*x[3]^2 + 1/2*x[2]^2 - x[3]^2
] >;
...
s`SolvableDBName := "64S20-4,8,4-g13-path1";
s`SolvableDBFilename := "64S20-4,8,4-g13-path1.m";
...
s`SolvableDBLocalSanityCheckTiming := 0.860000000000000p15;
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 35, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 37, 17, 45, 51, 31, 13, 14, 18, 21, 28, 29, 34, 32, 44, 30, 42, 46, 60, 48, 55, 33, 43, 52, 41, 50, 53, 36, 54, 59, 58, 57, 40, 38, 47, 49, 56, 62, 63, 64, 61 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path4", "32S11-2,8,4-g3-path2", "64S20-4,8,4-g13-path1" ];
s`SolvableDBParents := [ Strings() | "128S8-8,8,4-g33-path9", "128S11-4,8,8-g33-path18", "128S10-8,8,8-g41-path48", "128S35-8,8,4-g33-path3", "128S32-4,8,8-g33-path12", "128S31-8,8,8-g41-path12", "128S32-8,8,4-g33-path6", "128S27-4,8,8-g33-path18", "128S34-8,8,8-g41-path12", "128S17-8,8,4-g33-path5", "128S20-4,8,8-g33-path8", "128S23-8,8,8-g41-path18", "128S29-4,8,4-g25-path6", "128S26-4,8,4-g25-path6", "128S16-4,8,4-g25-path8" ];
