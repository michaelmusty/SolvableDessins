...
s`SolvableDBName := "64S4-8,2,8-g9-path34";
s`SolvableDBFilename := "64S4-8,2,8-g9-path34.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 48, 49, 26, 50, 8, 41, 29, 10, 40, 35, 42, 9, 11, 12, 13, 14, 20, 23, 24, 25, 43, 44, 45, 46, 47, 63, 27, 28, 36, 61, 54, 60, 55, 31, 56, 57, 62, 51, 33, 30, 32, 34, 37, 38, 39, 52, 53, 64, 59, 58 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S6-4,2,4-g1-path8", "64S4-8,2,8-g9-path34" ];
s`SolvableDBParents := [ Strings() | "128S4-8,4,8-g33-path178", "128S49-8,4,8-g33-path66", "128S51-8,4,8-g33-path66", "128S12-8,4,8-g33-path455", "128S46-16,2,16-g25-path84", "128S47-16,4,16-g41-path68", "128S53-16,2,16-g25-path22", "128S52-16,4,16-g41-path22", "128S52-16,2,16-g25-path22", "128S53-16,4,16-g41-path22", "128S47-16,2,16-g25-path68", "128S46-16,4,16-g41-path84", "128S50-8,2,8-g17-path44", "128S48-8,2,8-g17-path44", "128S2-8,2,8-g17-path100" ];
