...
s`SolvableDBName := "64S13-4,8,8-g17-path5";
s`SolvableDBFilename := "64S13-4,8,8-g17-path5.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T12-4,2,8-g2-path1", "32S10-4,4,8-g7-path26", "64S13-4,8,8-g17-path5" ];
s`SolvableDBChildren := [ Strings() | "32S10-4,4,8-g7-path26" ];
