...
s`SolvableDBName := "64S6-8,4,8-g17-path69";
s`SolvableDBFilename := "64S6-8,4,8-g17-path69.m";
...
\[ 6, 1, 18, 21, 19, 22, 4, 23, 2, 3, 5, 7, 8, 33, 31, 25, 27, 29, 9, 16, 10, 11, 15, 17, 13, 32, 30, 42, 12, 14, 20, 24, 26, 28, 34, 49, 39, 35, 41, 45, 38, 37, 40, 48, 47, 57, 36, 43, 44, 46, 50, 55, 64, 56, 51, 52, 54, 61, 58, 63, 62, 53, 59, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S9-4,2,8-g3-path1", "64S6-8,4,8-g17-path69" ];
s`SolvableDBParents := [ Strings() | "128S67-16,8,8-g45-path73", "128S68-16,8,8-g45-path73", "128S68-16,8,8-g45-path74", "128S67-16,8,8-g45-path74", "128S63-8,4,16-g37-path77", "128S61-16,8,16-g49-path379", "128S66-8,4,16-g37-path156", "128S62-16,8,16-g49-path315", "128S65-8,4,16-g37-path71", "128S62-16,8,16-g49-path316", "128S64-8,4,16-g37-path168", "128S61-16,8,16-g49-path380", "128S3-8,4,8-g33-path660", "128S2-8,4,8-g33-path189", "128S11-8,4,8-g33-path1194" ];
