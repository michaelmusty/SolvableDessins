...
s`SolvableDBName := "64S50-32,32,8-g27-path9";
s`SolvableDBFilename := "64S50-32,32,8-g27-path9.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 37, 39, 41, 13, 40, 42, 43, 17, 45, 18, 14, 47, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 59, 61, 49, 35, 62, 36, 51, 38, 58, 32, 60, 34, 54, 44, 27, 28, 29, 30, 31, 33, 46, 48, 55, 56, 52, 57, 63, 64, 50, 53 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,2-g3-path3", "32S16-16,16,4-g11-path3", "64S50-32,32,8-g27-path9" ];
s`SolvableDBParents := [ Strings() | "128S159-64,64,16-g59-path13", "128S160-64,64,16-g59-path5", "128S159-64,64,16-g59-path14", "128S160-64,64,16-g59-path6", "128S153-32,32,8-g53-path81", "128S128-32,32,8-g53-path50", "128S131-32,32,8-g53-path81" ];
