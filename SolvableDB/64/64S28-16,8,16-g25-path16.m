...
s`SolvableDBName := "64S28-16,8,16-g25-path16";
s`SolvableDBFilename := "64S28-16,8,16-g25-path16.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T6-8,2,8-g3-path1", "32S4-8,4,8-g9-path16", "64S28-16,8,16-g25-path16" ];
s`SolvableDBChildren := [ Strings() | "32S4-8,4,8-g9-path16" ];
