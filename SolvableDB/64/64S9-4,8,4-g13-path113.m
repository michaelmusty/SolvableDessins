...
\[ 2, 5, 9, 7, 6, 1, 10, 11, 14, 21, 15, 20, 30, 22, 23, 31, 24, 25, 26, 27, 4, 3, 8, 19, 32, 17, 33, 34, 35, 29, 37, 50, 12, 40, 13, 48, 49, 56, 38, 51, 54, 57, 47, 43, 52, 44, 46, 42, 16, 18, 28, 53, 58, 59, 39, 55, 36, 45, 61, 62, 41, 63, 64, 60 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path8", "32S6-2,4,4-g1-path11", "64S9-4,8,4-g13-path113" ];
s`SolvableDBParents := [ Strings() | "128S86-4,8,8-g33-path172", "128S4-4,8,8-g33-path534", "128S3-4,8,8-g33-path1140", "128S85-4,8,8-g33-path172", "128S83-4,8,4-g25-path99", "128S84-4,8,4-g25-path99", "128S26-4,8,4-g25-path945" ];
