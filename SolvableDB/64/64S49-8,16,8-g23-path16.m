...
s`SolvableDBName := "64S49-8,16,8-g23-path16";
s`SolvableDBFilename := "64S49-8,16,8-g23-path16.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T8-4,4,4-g3-path8", "32S14-4,8,4-g7-path16", "64S49-8,16,8-g23-path16" ];
