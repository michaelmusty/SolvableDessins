...
s`SolvableDBName := "64S10-8,8,4-g17-path30";
s`SolvableDBFilename := "64S10-8,8,4-g17-path30.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path4", "32S7-8,8,2-g5-path6", "64S10-8,8,4-g17-path30" ];
