...
s`SolvableDBName := "64S4-8,2,8-g9-path36";
s`SolvableDBFilename := "64S4-8,2,8-g9-path36.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 48, 47, 23, 20, 46, 41, 49, 50, 40, 35, 42, 8, 9, 10, 11, 12, 13, 14, 24, 25, 43, 44, 33, 45, 31, 63, 51, 30, 38, 56, 59, 62, 58, 36, 61, 54, 52, 57, 27, 26, 28, 29, 32, 34, 37, 39, 53, 64, 60, 55 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path7", "32S7-8,2,8-g5-path9", "64S4-8,2,8-g9-path36" ];
s`SolvableDBParents := [ Strings() | "128S4-8,4,8-g33-path191", "128S49-8,4,8-g33-path79", "128S51-8,4,8-g33-path79", "128S12-8,4,8-g33-path468", "128S46-16,2,16-g25-path97", "128S47-16,4,16-g41-path81", "128S53-16,2,16-g25-path35", "128S52-16,4,16-g41-path35", "128S52-16,2,16-g25-path35", "128S53-16,4,16-g41-path35", "128S47-16,2,16-g25-path81", "128S46-16,4,16-g41-path97", "128S50-8,2,8-g17-path57", "128S48-8,2,8-g17-path57", "128S2-8,2,8-g17-path113" ];
