...
s`SolvableDBName := "64S28-4,16,16-g21-path28";
s`SolvableDBFilename := "64S28-4,16,16-g21-path28.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T6-4,8,8-g5-path1", "32S4-4,8,8-g9-path21", "64S28-4,16,16-g21-path28" ];
s`SolvableDBChildren := [ Strings() | "32S4-4,8,8-g9-path21" ];
