...
\[ 6, 1, 18, 22, 20, 9, 4, 23, 2, 3, 5, 7, 8, 47, 41, 51, 52, 30, 46, 31, 16, 12, 32, 17, 19, 53, 45, 44, 28, 10, 11, 13, 14, 15, 21, 24, 25, 26, 27, 29, 57, 62, 63, 40, 56, 37, 48, 33, 61, 43, 35, 36, 58, 49, 54, 39, 34, 38, 42, 50, 55, 64, 60, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path5", "32S11-4,2,8-g3-path5", "64S9-4,4,8-g13-path85" ];
s`SolvableDBParents := [ Strings() | "128S3-8,4,8-g33-path1096", "128S86-8,4,8-g33-path128", "128S4-8,4,8-g33-path490", "128S85-8,4,8-g33-path128", "128S84-4,4,8-g25-path174", "128S26-4,4,8-g25-path1020", "128S83-4,4,8-g25-path174" ];
