...
s`SolvableDBName := "64S6-8,8,4-g17-path25";
s`SolvableDBFilename := "64S6-8,8,4-g17-path25.m";
...
\[ 36, 53, 64, 39, 34, 9, 25, 58, 59, 54, 19, 45, 20, 55, 49, 48, 61, 10, 23, 29, 57, 41, 38, 8, 27, 37, 12, 2, 40, 5, 16, 62, 31, 46, 43, 28, 60, 30, 63, 24, 51, 21, 50, 13, 4, 11, 42, 47, 22, 14, 32, 17, 6, 26, 52, 15, 33, 44, 1, 3, 35, 56, 7, 18 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T6-8,8,4-g5-path4", "32S5-8,8,4-g9-path22", "64S6-8,8,4-g17-path25" ];
s`SolvableDBParents := [ Strings() | "128S67-8,16,8-g45-path189", "128S67-8,16,8-g45-path190", "128S68-8,16,8-g45-path189", "128S68-8,16,8-g45-path190", "128S63-16,8,4-g37-path84", "128S61-16,16,8-g49-path409", "128S64-16,8,4-g37-path175", "128S61-16,16,8-g49-path410", "128S65-16,8,4-g37-path78", "128S62-16,16,8-g49-path345", "128S66-16,8,4-g37-path163", "128S62-16,16,8-g49-path346", "128S11-8,8,4-g33-path1209", "128S2-8,8,4-g33-path204", "128S3-8,8,4-g33-path675" ];
