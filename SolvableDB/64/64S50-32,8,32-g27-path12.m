...
s`SolvableDBName := "64S50-32,8,32-g27-path12";
s`SolvableDBFilename := "64S50-32,8,32-g27-path12.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 35, 36, 37, 13, 41, 43, 44, 17, 45, 18, 14, 47, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 40, 42, 57, 31, 56, 59, 60, 39, 61, 62, 58, 33, 63, 38, 27, 28, 29, 30, 32, 34, 46, 48, 64, 54, 49, 50, 52, 53, 55, 51 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,2,8-g3-path4", "32S16-16,4,16-g11-path7", "64S50-32,8,32-g27-path12" ];
s`SolvableDBParents := [ Strings() | "128S159-64,16,64-g59-path23", "128S160-64,16,64-g59-path15", "128S159-64,16,64-g59-path24", "128S160-64,16,64-g59-path16", "128S153-32,8,32-g53-path86", "128S128-32,8,32-g53-path55", "128S131-32,8,32-g53-path86" ];
