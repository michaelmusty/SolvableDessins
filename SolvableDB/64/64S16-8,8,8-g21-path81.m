...
\[ 6, 1, 26, 13, 23, 27, 4, 28, 2, 3, 5, 7, 8, 55, 40, 46, 36, 32, 31, 42, 10, 45, 57, 20, 58, 43, 33, 17, 19, 9, 21, 22, 44, 38, 11, 12, 14, 15, 16, 18, 24, 25, 29, 30, 34, 63, 53, 49, 50, 37, 54, 62, 51, 39, 56, 61, 60, 52, 35, 64, 48, 41, 47, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,4,8-g5-path4", "32S12-8,4,8-g9-path12", "64S16-8,8,8-g21-path81" ];
s`SolvableDBParents := [ Strings() | "128S102-16,8,16-g49-path121", "128S102-16,8,16-g49-path122", "128S103-8,16,8-g45-path61", "128S104-8,16,8-g45-path61", "128S105-16,16,16-g53-path341", "128S105-16,16,16-g53-path342", "128S9-8,8,8-g41-path477" ];
