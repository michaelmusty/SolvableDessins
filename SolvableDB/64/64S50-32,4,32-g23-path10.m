...
s`SolvableDBName := "64S50-32,4,32-g23-path10";
s`SolvableDBFilename := "64S50-32,4,32-g23-path10.m";
...
\[ 6, 1, 4, 16, 13, 17, 15, 7, 2, 3, 5, 8, 14, 25, 23, 26, 27, 11, 9, 10, 12, 18, 24, 34, 35, 36, 33, 20, 19, 21, 22, 28, 42, 43, 44, 41, 29, 30, 31, 32, 50, 51, 52, 49, 37, 38, 39, 40, 58, 59, 60, 57, 45, 46, 47, 48, 64, 61, 62, 63, 53, 54, 55, 56 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,2,8-g3-path7", "32S16-16,2,16-g7-path5", "64S50-32,4,32-g23-path10" ];
s`SolvableDBParents := [ Strings() | "128S159-64,8,64-g55-path23", "128S160-64,8,64-g55-path19", "128S159-64,8,64-g55-path24", "128S160-64,8,64-g55-path20", "128S153-32,4,32-g45-path99", "128S128-32,4,32-g45-path68", "128S131-32,4,32-g45-path49" ];
