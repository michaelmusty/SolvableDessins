...
s`SolvableDBName := "64S44-16,16,8-g25-path50";
s`SolvableDBFilename := "64S44-16,16,8-g25-path50.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 45, 47, 17, 56, 14, 21, 54, 22, 36, 53, 49, 41, 57, 19, 20, 23, 10, 44, 31, 9, 11, 12, 13, 18, 27, 28, 29, 30, 32, 61, 48, 62, 55, 42, 64, 60, 43, 46, 38, 33, 34, 52, 63, 37, 39, 50, 59, 35, 40, 51, 58 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,4-g5-path7", "32S16-16,16,8-g13-path8", "64S44-16,16,8-g25-path50" ];
s`SolvableDBParents := [ Strings() | "128S153-32,32,16-g57-path135", "128S154-32,32,16-g57-path135", "128S153-32,32,16-g57-path136", "128S154-32,32,16-g57-path136", "128S102-16,16,8-g49-path350", "128S106-16,16,8-g49-path463", "128S99-16,16,8-g49-path350" ];
