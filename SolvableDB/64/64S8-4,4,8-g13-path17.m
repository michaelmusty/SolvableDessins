...
s`SolvableDBName := "64S8-4,4,8-g13-path17";
s`SolvableDBFilename := "64S8-4,4,8-g13-path17.m";
...
\[ 12, 37, 43, 7, 2, 5, 36, 40, 22, 32, 13, 9, 27, 19, 14, 64, 59, 10, 28, 16, 29, 1, 30, 11, 31, 18, 24, 15, 25, 55, 21, 26, 57, 60, 51, 38, 6, 4, 44, 39, 61, 54, 35, 8, 41, 49, 34, 50, 48, 46, 3, 58, 23, 52, 53, 45, 17, 42, 33, 62, 56, 47, 20, 63 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path5", "32S11-4,4,8-g7-path2", "64S8-4,4,8-g13-path17" ];
s`SolvableDBParents := [ Strings() | "128S2-4,8,8-g33-path239", "128S3-4,8,8-g33-path992", "128S77-4,8,8-g33-path58", "128S78-4,8,8-g33-path180", "128S79-4,4,16-g29-path105", "128S81-4,8,16-g37-path48", "128S80-4,4,16-g29-path263", "128S82-4,8,16-g37-path121", "128S71-4,4,16-g29-path25", "128S73-4,8,16-g37-path14", "128S72-4,4,16-g29-path103", "128S74-4,8,16-g37-path53", "128S26-4,4,8-g25-path881", "128S75-4,4,8-g25-path69", "128S76-4,4,8-g25-path191" ];
