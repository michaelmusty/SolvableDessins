...
s`SolvableDBName := "64S44-4,16,16-g21-path25";
s`SolvableDBFilename := "64S44-4,16,16-g21-path25.m";
...
\[ 6, 1, 23, 24, 22, 9, 4, 25, 2, 3, 5, 7, 8, 38, 13, 14, 27, 44, 17, 19, 47, 32, 29, 12, 15, 18, 20, 21, 10, 40, 30, 11, 16, 26, 28, 31, 52, 33, 58, 36, 37, 39, 54, 34, 43, 55, 35, 46, 45, 48, 41, 51, 42, 49, 50, 63, 56, 53, 64, 59, 57, 60, 61, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T6-4,8,8-g5-path1", "32S12-4,8,8-g9-path23", "64S44-4,16,16-g21-path25" ];
s`SolvableDBParents := [ Strings() | "128S153-8,32,32-g53-path15", "128S154-4,32,32-g45-path15", "128S102-8,16,16-g49-path216", "128S153-8,32,32-g53-path16", "128S154-4,32,32-g45-path16", "128S99-8,16,16-g49-path216", "128S106-4,16,16-g41-path407" ];
