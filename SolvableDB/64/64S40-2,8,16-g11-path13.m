...
s`SolvableDBName := "64S40-2,8,16-g11-path13";
s`SolvableDBFilename := "64S40-2,8,16-g11-path13.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S9-2,4,8-g3-path5", "64S40-2,8,16-g11-path13" ];
