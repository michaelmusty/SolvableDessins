...
s`SolvableDBName := "64S24-8,8,4-g17-path3";
s`SolvableDBFilename := "64S24-8,8,4-g17-path3.m";
...
{ IntegerRing() | 49, 54 }
@};
s`SolvableDBBelyiMapTiming := 1.110p15;
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 61, 49, 50, 13, 34, 55, 36, 39, 31, 57, 9, 21, 43, 35, 45, 11, 56, 19, 20, 22, 23, 42, 58, 52, 10, 12, 14, 15, 16, 17, 18, 25, 26, 32, 33, 37, 38, 48, 53, 54, 64, 60, 46, 40, 62, 63, 51, 44, 59, 47, 41 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path4", "32S2-4,4,4-g5-path7", "64S24-8,8,4-g17-path3" ];
s`SolvableDBParents := [ Strings() | "128S15-8,8,8-g41-path49", "128S41-8,8,8-g41-path7", "128S15-8,8,8-g41-path50", "128S39-8,8,8-g41-path7", "128S31-8,8,8-g41-path43", "128S24-8,8,8-g41-path28", "128S31-8,8,8-g41-path44", "128S22-8,8,8-g41-path16", "128S37-8,8,4-g33-path7", "128S12-8,8,4-g33-path10", "128S37-8,8,4-g33-path8", "128S28-8,8,4-g33-path25", "128S17-8,8,4-g33-path9", "128S27-8,8,4-g33-path19", "128S17-8,8,4-g33-path10" ];
