...
s`SolvableDBName := "64S17-4,8,8-g17-path5-notcomputed";
s`SolvableDBFilename := "64S17-4,8,8-g17-path5-notcomputed.m";
...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 49, 46, 55, 13, 14, 32, 56, 59, 30, 58, 38, 21, 57, 34, 12, 17, 19, 20, 22, 23, 10, 52, 39, 35, 11, 15, 16, 18, 25, 26, 31, 33, 36, 37, 60, 41, 64, 43, 47, 48, 53, 61, 44, 51, 45, 42, 54, 40, 63, 50, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-2,4,4-g1-path4-notcomputed", "16T6-2,8,8-g3-path1-notcomputed", "32S12-4,8,8-g9-path6-notcomputed", "64S17-4,8,8-g17-path5-notcomputed" ];
