...
s`SolvableDBName := "64S43-8,16,4-g19-path14";
s`SolvableDBFilename := "64S43-8,16,4-g19-path14.m";
...
\[ 6, 1, 22, 23, 20, 24, 8, 25, 2, 3, 4, 5, 7, 43, 28, 26, 11, 34, 27, 9, 32, 19, 13, 12, 17, 29, 16, 30, 10, 33, 14, 15, 18, 21, 59, 49, 44, 50, 31, 46, 45, 48, 41, 39, 37, 38, 35, 36, 40, 42, 56, 62, 60, 51, 61, 63, 47, 64, 55, 57, 53, 58, 52, 54 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path2", "32S9-4,8,2-g3-path15", "64S43-8,16,4-g19-path14" ];
s`SolvableDBParents := [ Strings() | "128S66-8,16,4-g37-path59", "128S82-8,16,4-g37-path59", "128S94-8,16,4-g37-path81", "128S96-8,16,4-g37-path81", "128S82-8,16,4-g37-path60", "128S66-8,16,4-g37-path60", "128S119-8,16,4-g37-path213" ];
