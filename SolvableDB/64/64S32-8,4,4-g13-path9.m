...
s`SolvableDBName := "64S32-8,4,4-g13-path9";
s`SolvableDBFilename := "64S32-8,4,4-g13-path9.m";
...
\[ 6, 1, 26, 27, 22, 28, 24, 29, 2, 3, 4, 5, 7, 8, 62, 59, 63, 61, 45, 16, 19, 9, 51, 49, 41, 64, 13, 12, 32, 60, 48, 38, 39, 53, 10, 11, 14, 15, 17, 18, 20, 21, 23, 25, 30, 31, 33, 34, 36, 58, 46, 44, 43, 55, 42, 47, 52, 56, 57, 54, 35, 37, 50, 40 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S6-4,4,4-g5-path19", "64S32-8,4,4-g13-path9" ];
s`SolvableDBParents := [ Strings() | "128S134-8,8,4-g33-path27", "128S77-8,4,8-g33-path14", "128S137-8,8,8-g41-path97", "128S134-8,8,4-g33-path28", "128S86-8,4,8-g33-path36", "128S137-8,8,8-g41-path98", "128S136-8,8,4-g33-path27", "128S48-8,4,8-g33-path14", "128S135-8,8,8-g41-path97", "128S136-8,8,4-g33-path28", "128S58-8,4,8-g33-path36", "128S135-8,8,8-g41-path98", "128S122-8,4,4-g25-path439", "128S75-8,4,4-g25-path5", "128S83-8,4,4-g25-path27" ];
