...
s`SolvableDBName := "64S39-4,4,16-g15-path40";
s`SolvableDBFilename := "64S39-4,4,16-g15-path40.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S9-4,2,8-g3-path3", "64S39-4,4,16-g15-path40" ];
