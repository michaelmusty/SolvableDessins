...
s`SolvableDBName := "64S23-4,4,4-g9-path309";
s`SolvableDBFilename := "64S23-4,4,4-g9-path309.m";
s`SolvableDBPassportName := "64S23-4,4,4-g9";
s`SolvableDBPathNumber := 309;
...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 59, 61, 57, 14, 52, 63, 33, 26, 42, 37, 21, 46, 36, 12, 38, 19, 20, 22, 43, 55, 50, 10, 11, 13, 15, 16, 17, 18, 25, 30, 31, 32, 34, 35, 58, 60, 47, 44, 49, 53, 51, 39, 62, 54, 56, 48, 64, 41, 45, 40 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path1", "32S6-4,4,4-g5-path13", "64S23-4,4,4-g9-path309" ];
s`SolvableDBParents := [ Strings() | "128S122-8,4,4-g25-path19", "128S21-4,8,4-g25-path270", "128S127-8,8,4-g33-path23", "128S122-4,4,8-g25-path23", "128S12-8,4,8-g33-path233", "128S127-4,8,8-g33-path19", "128S25-8,8,8-g41-path568", "128S122-8,4,4-g25-path20", "128S29-4,8,4-g25-path212", "128S127-8,8,4-g33-path24", "128S122-4,4,8-g25-path24", "128S38-8,4,8-g33-path6", "128S127-4,8,8-g33-path20", "128S30-8,8,8-g41-path634", "128S26-8,4,4-g25-path582", "128S123-4,8,4-g25-path11", "128S37-8,8,4-g33-path12", "128S26-4,4,8-g25-path584", "128S126-8,4,8-g33-path11", "128S37-4,8,8-g33-path10", "128S124-8,8,8-g41-path31", "128S16-8,4,4-g25-path378", "128S123-4,8,4-g25-path12", "128S14-8,8,4-g33-path466", "128S16-4,4,8-g25-path380", "128S126-8,4,8-g33-path12", "128S14-4,8,8-g33-path464", "128S124-8,8,8-g41-path32", "128S36-4,4,4-g17-path16", "128S125-4,4,4-g17-path31", "128S125-4,4,4-g17-path32" ];
