...
s`SolvableDBName := "64S44-16,4,16-g21-path27";
s`SolvableDBFilename := "64S44-16,4,16-g21-path27.m";
...
\[ 48, 56, 53, 31, 26, 27, 50, 60, 39, 58, 47, 37, 64, 52, 32, 62, 11, 12, 29, 9, 28, 49, 44, 22, 45, 17, 59, 24, 51, 41, 57, 19, 46, 30, 36, 54, 21, 2, 5, 10, 33, 25, 8, 63, 15, 35, 6, 38, 4, 43, 23, 61, 40, 14, 16, 20, 7, 42, 1, 18, 13, 34, 3, 55 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T8-4,4,4-g3-path10", "32S12-8,4,8-g9-path45", "64S44-16,4,16-g21-path27" ];
s`SolvableDBParents := [ Strings() | "128S102-16,8,16-g49-path212", "128S99-16,8,16-g49-path212", "128S153-32,4,32-g45-path9", "128S154-32,8,32-g53-path9", "128S153-32,4,32-g45-path10", "128S154-32,8,32-g53-path10", "128S106-16,4,16-g41-path403" ];
