...
s`SolvableDBName := "64S29-16,16,4-g21-path13";
s`SolvableDBFilename := "64S29-16,16,4-g21-path13.m";
...
\[ 57, 64, 35, 55, 51, 37, 56, 34, 43, 63, 59, 47, 54, 52, 31, 29, 27, 10, 60, 40, 38, 36, 33, 19, 28, 12, 49, 53, 50, 9, 58, 15, 41, 24, 62, 18, 46, 25, 32, 61, 8, 13, 21, 7, 11, 5, 14, 2, 4, 39, 48, 42, 20, 3, 44, 23, 45, 6, 30, 17, 1, 22, 26, 16 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,2-g3-path5", "32S17-16,16,4-g11-path7", "64S29-16,16,4-g21-path13" ];
s`SolvableDBParents := [ Strings() | "128S131-32,32,8-g53-path25", "128S133-32,32,8-g53-path49", "128S133-32,32,8-g53-path50", "128S132-32,32,8-g53-path25", "128S131-32,32,8-g53-path26", "128S133-32,32,8-g53-path51", "128S133-32,32,8-g53-path52", "128S132-32,32,8-g53-path26", "128S69-16,16,4-g41-path103", "128S61-16,16,4-g41-path25", "128S54-16,16,4-g41-path52", "128S106-16,16,4-g41-path369", "128S61-16,16,4-g41-path26", "128S69-16,16,4-g41-path104", "128S46-16,16,4-g41-path13" ];
s`SolvableDBChild := "32S17-16,16,4-g11-path7";
