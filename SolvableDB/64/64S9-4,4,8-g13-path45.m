...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 45, 47, 13, 48, 32, 46, 61, 30, 55, 37, 21, 62, 33, 12, 17, 19, 20, 22, 10, 64, 39, 31, 11, 14, 15, 16, 18, 25, 26, 34, 35, 36, 60, 49, 41, 52, 58, 56, 43, 44, 38, 63, 51, 59, 57, 40, 42, 53, 50, 54 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path2", "32S10-4,4,8-g7-path9", "64S9-4,4,8-g13-path45" ];
s`SolvableDBParents := [ Strings() | "128S86-4,8,8-g33-path96", "128S4-4,8,8-g33-path458", "128S3-4,8,8-g33-path1064", "128S85-4,8,8-g33-path96", "128S83-4,4,8-g25-path97", "128S84-4,4,8-g25-path97", "128S26-4,4,8-g25-path943" ];
