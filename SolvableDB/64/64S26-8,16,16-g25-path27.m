...
s`SolvableDBName := "64S26-8,16,16-g25-path27";
s`SolvableDBFilename := "64S26-8,16,16-g25-path27.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-2,8,8-g2-path1", "16T5-2,8,8-g3-path2", "32S3-4,8,8-g9-path17", "64S26-8,16,16-g25-path27" ];
