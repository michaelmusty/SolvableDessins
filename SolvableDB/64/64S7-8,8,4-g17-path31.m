...
s`SolvableDBName := "64S7-8,8,4-g17-path31";
s`SolvableDBFilename := "64S7-8,8,4-g17-path31.m";
...
[ 39, 59, 23, 9, 17, 13, 24, 46, 26, 34, 30, 5, 61, 10, 35, 51, 20, 19, 52, 12, 29, 37, 45, 44, 6, 56, 42, 2, 8, 32, 64, 38, 49, 60, 47, 7, 16, 11, 58, 48, 53, 31, 1, 36, 62, 21, 57, 63, 41, 40, 22, 55, 33, 28, 18, 4, 15, 43, 54, 14, 25, 3, 50, 27 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T14-4,8,4-g4-path2", "32S10-4,8,4-g7-path32", "64S7-8,8,4-g17-path31" ];
s`SolvableDBChildren := [ Strings() | "32S10-4,8,4-g7-path32" ];
