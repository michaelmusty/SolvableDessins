...
\[ 6, 1, 20, 21, 18, 22, 4, 2, 3, 5, 7, 46, 23, 42, 47, 43, 48, 44, 16, 15, 38, 49, 17, 8, 9, 10, 11, 12, 13, 14, 19, 64, 56, 55, 28, 45, 50, 62, 36, 37, 35, 40, 58, 61, 41, 39, 63, 59, 51, 33, 24, 25, 26, 27, 29, 30, 31, 32, 34, 53, 60, 54, 52, 57 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T2-4,4,2-g1-path1-notcomputed", "16T10-4,4,2-g1-path3-notcomputed", "32S7-8,8,2-g5-path2-notcomputed", "64S12-8,8,2-g9-path1-notcomputed" ];
