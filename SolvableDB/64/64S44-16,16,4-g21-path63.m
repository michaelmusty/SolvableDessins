...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,2-g3-path6", "32S16-16,16,4-g11-path8", "64S44-16,16,4-g21-path63" ];
s`SolvableDBChildren := [ Strings() | "32S16-16,16,4-g11-path8" ];
