...
I<[x]> := ideal< P | [
x[1]^16*x[2]^2 - x[1]^17 - x[1]^15*x[2]^2 - x[1]^16 + x[1]^14*x[2]^2 - x[1]^13*x[2]^2 + x[1]^12*x[2]^2 - x[1]^11*x[2]^2 + x[1]^10*x[2]^2 - x[1]^9*x[2]^2 + x[1]^8*x[2]^2 - x[1]^7*x[2]^2 + x[1]^6*x[2]^2 - x[1]^5*x[2]^2 + x[1]^4*x[2]^2 - x[1]^3*x[2]^2 + x[1]^2*x[2]^2 - x[1]*x[2]^2 - x[1] - 1
] >;
...
s`SolvableDBParents := [ Strings() | "128S148-32,4,4-g31-path9", "128S155-32,4,4-g31-path5", "128S148-32,4,4-g31-path10" ];
