...
s`SolvableDBName := "64S22-8,8,8-g21-path246";
s`SolvableDBFilename := "64S22-8,8,8-g21-path246.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T8-4,4,4-g3-path22", "32S2-4,4,4-g5-path63", "64S22-8,8,8-g21-path246" ];
