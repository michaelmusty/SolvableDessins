...
s`SolvableDBName := "64S47-4,4,16-g15-path22";
s`SolvableDBFilename := "64S47-4,4,16-g15-path22.m";
...
\[ 12, 25, 4, 7, 2, 5, 24, 27, 19, 11, 13, 9, 17, 18, 14, 20, 10, 21, 1, 22, 15, 41, 43, 3, 6, 29, 26, 30, 8, 31, 33, 36, 28, 32, 37, 38, 39, 34, 57, 59, 16, 45, 42, 46, 23, 47, 49, 52, 44, 48, 53, 54, 55, 50, 64, 63, 35, 61, 58, 62, 40, 56, 60, 51 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T13-2,2,8-g0-path3", "32S20-4,4,16-g8-path1", "64S47-4,4,16-g15-path22" ];
s`SolvableDBParents := [ Strings() | "128S103-8,8,16-g45-path141", "128S103-8,8,16-g45-path142", "128S155-4,4,32-g31-path20", "128S157-8,8,32-g47-path39", "128S156-4,4,32-g31-path20", "128S157-8,8,32-g47-path40", "128S112-4,4,16-g29-path295" ];
