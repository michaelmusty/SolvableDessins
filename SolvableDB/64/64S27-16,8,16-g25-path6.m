...
s`SolvableDBName := "64S27-16,8,16-g25-path6";
s`SolvableDBFilename := "64S27-16,8,16-g25-path6.m";
...
\[ 39, 48, 46, 40, 32, 9, 59, 25, 52, 54, 14, 16, 44, 49, 47, 33, 13, 64, 51, 18, 53, 31, 38, 20, 27, 7, 35, 12, 2, 21, 60, 43, 45, 24, 61, 5, 62, 11, 50, 42, 55, 19, 56, 3, 26, 57, 63, 15, 58, 37, 28, 41, 10, 17, 29, 34, 8, 36, 22, 4, 30, 6, 1, 23 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,4,8-g5-path5", "32S17-16,8,16-g13-path7", "64S27-16,8,16-g25-path6" ];
s`SolvableDBParents := [ Strings() | "128S130-32,16,32-g57-path37", "128S130-32,16,32-g57-path38", "128S130-32,16,32-g57-path39", "128S130-32,16,32-g57-path40", "128S106-16,8,16-g49-path284", "128S44-16,8,16-g49-path147", "128S43-16,8,16-g49-path53" ];
