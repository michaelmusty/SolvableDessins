...
s`SolvableDBName := "64S40-8,4,16-g19-path2";
s`SolvableDBFilename := "64S40-8,4,16-g19-path2.m";
...
\[ 6, 1, 4, 21, 18, 22, 20, 23, 2, 3, 5, 7, 8, 17, 19, 13, 16, 9, 26, 29, 12, 11, 25, 33, 30, 32, 31, 42, 10, 14, 15, 24, 27, 28, 39, 40, 41, 34, 38, 35, 44, 36, 49, 48, 47, 57, 37, 43, 45, 46, 55, 56, 58, 50, 54, 51, 52, 60, 62, 64, 63, 61, 53, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path1", "32S9-4,2,8-g3-path2", "64S40-8,4,16-g19-path2" ];
s`SolvableDBParents := [ Strings() | "128S95-8,4,16-g37-path119", "128S92-8,4,16-g37-path57", "128S114-8,4,16-g37-path212", "128S63-8,4,16-g37-path35", "128S82-8,4,16-g37-path29", "128S81-8,4,16-g37-path12", "128S64-8,4,16-g37-path75" ];
