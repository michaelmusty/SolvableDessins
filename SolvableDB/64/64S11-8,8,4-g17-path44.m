...
s`SolvableDBName := "64S11-8,8,4-g17-path44";
s`SolvableDBFilename := "64S11-8,8,4-g17-path44.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S11-8,4,4-g7-path22", "64S11-8,8,4-g17-path44" ];
