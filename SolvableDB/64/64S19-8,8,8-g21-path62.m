...
s`SolvableDBName := "64S19-8,8,8-g21-path62";
s`SolvableDBFilename := "64S19-8,8,8-g21-path62.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 62, 50, 52, 13, 34, 56, 36, 40, 31, 59, 9, 21, 44, 35, 46, 11, 57, 19, 20, 22, 23, 43, 58, 64, 61, 10, 12, 14, 15, 16, 17, 18, 25, 26, 32, 33, 37, 38, 39, 49, 53, 63, 54, 47, 51, 41, 42, 48, 45, 60, 55 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path9", "32S2-4,4,4-g5-path6", "64S19-8,8,8-g21-path62" ];
s`SolvableDBParents := [ Strings() | "128S7-8,8,8-g41-path1147", "128S7-8,8,8-g41-path1148", "128S7-8,8,8-g41-path1149", "128S24-8,8,8-g41-path223", "128S23-8,8,8-g41-path445", "128S25-8,8,8-g41-path223", "128S23-8,8,8-g41-path446", "128S24-8,8,8-g41-path224", "128S25-8,8,8-g41-path224", "128S23-8,8,8-g41-path447", "128S23-8,8,8-g41-path448", "128S24-8,8,8-g41-path225", "128S23-8,8,8-g41-path449", "128S23-8,8,8-g41-path450", "128S25-8,8,8-g41-path225" ];
