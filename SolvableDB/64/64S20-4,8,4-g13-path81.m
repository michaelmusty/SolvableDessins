...
s`SolvableDBName := "64S20-4,8,4-g13-path81";
s`SolvableDBFilename := "64S20-4,8,4-g13-path81.m";
...
\[ 22, 5, 54, 40, 6, 39, 4, 46, 12, 18, 24, 1, 11, 15, 29, 62, 61, 27, 14, 16, 32, 9, 56, 28, 30, 47, 34, 13, 19, 21, 23, 25, 26, 10, 52, 59, 45, 7, 2, 38, 42, 8, 33, 60, 3, 41, 43, 53, 58, 51, 48, 49, 50, 37, 57, 64, 44, 35, 17, 55, 36, 63, 20, 31 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T8-4,4,4-g3-path13", "32S2-4,4,4-g5-path53", "64S20-4,8,4-g13-path81" ];
s`SolvableDBParents := [ Strings() | "128S8-8,8,4-g33-path253", "128S11-4,8,8-g33-path583", "128S10-8,8,8-g41-path1621", "128S35-8,8,4-g33-path26", "128S32-4,8,8-g33-path259", "128S31-8,8,8-g41-path259", "128S32-8,8,4-g33-path53", "128S27-4,8,8-g33-path261", "128S34-8,8,8-g41-path259", "128S17-8,8,4-g33-path188", "128S20-4,8,8-g33-path291", "128S23-8,8,8-g41-path745", "128S29-4,8,4-g25-path53", "128S26-4,8,4-g25-path53", "128S16-4,8,4-g25-path215" ];
