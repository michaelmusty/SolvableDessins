...
s`SolvableDBName := "64S25-4,8,8-g17-path2-notcomputed";
s`SolvableDBFilename := "64S25-4,8,8-g17-path2-notcomputed.m";
...
\[ 22, 5, 54, 40, 6, 39, 4, 62, 12, 18, 24, 1, 11, 15, 29, 59, 50, 27, 41, 16, 48, 9, 35, 28, 46, 45, 51, 13, 56, 21, 23, 25, 26, 44, 61, 43, 52, 7, 2, 38, 8, 33, 57, 3, 42, 60, 37, 58, 47, 53, 10, 49, 55, 34, 17, 14, 63, 30, 64, 32, 31, 19, 36, 20 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T5-4,4,4-g2-path1-notcomputed", "16T8-4,4,4-g3-path15-notcomputed", "32S2-4,4,4-g5-path13-notcomputed", "64S25-4,8,8-g17-path2-notcomputed" ];
s`SolvableDBParents := [ Strings() | "128S33-8,8,8-g41-path50-notcomputed", "128S39-8,8,8-g41-path11-notcomputed", "128S34-8,8,8-g41-path32-notcomputed", "128S40-8,8,8-g41-path2-notcomputed", "128S15-8,8,8-g41-path56-notcomputed", "128S23-8,8,8-g41-path26-notcomputed", "128S13-8,8,8-g41-path20-notcomputed", "128S19-8,8,8-g41-path20-notcomputed", "128S18-4,8,8-g33-path16-notcomputed", "128S14-4,8,8-g33-path20-notcomputed", "128S20-4,8,8-g33-path10-notcomputed", "128S35-4,8,8-g33-path20-notcomputed", "128S37-4,8,8-g33-path14-notcomputed", "128S32-4,8,8-g33-path14-notcomputed", "128S38-4,8,8-g33-path5-notcomputed" ];
