...
s`SolvableDBName := "64S23-4,4,4-g9-path308";
s`SolvableDBFilename := "64S23-4,4,4-g9-path308.m";
s`SolvableDBPassportName := "64S23-4,4,4-g9";
s`SolvableDBPathNumber := 308;
...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 49, 30, 25, 60, 41, 34, 42, 64, 54, 37, 21, 61, 36, 12, 38, 19, 20, 22, 56, 45, 51, 10, 11, 13, 14, 15, 16, 17, 18, 26, 31, 32, 33, 35, 59, 43, 52, 48, 62, 39, 44, 58, 63, 47, 40, 50, 55, 57, 53, 46 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path3", "32S6-4,4,4-g5-path33", "64S23-4,4,4-g9-path308" ];
s`SolvableDBParents := [ Strings() | "128S26-8,4,4-g25-path586", "128S26-4,8,4-g25-path586", "128S12-8,8,4-g33-path233", "128S29-4,4,8-g25-path212", "128S14-8,4,8-g33-path468", "128S14-4,8,8-g33-path468", "128S30-8,8,8-g41-path640", "128S16-8,4,4-g25-path382", "128S16-4,8,4-g25-path382", "128S38-8,8,4-g33-path6", "128S21-4,4,8-g25-path270", "128S37-8,4,8-g33-path14", "128S37-4,8,8-g33-path14", "128S25-8,8,8-g41-path574", "128S122-8,4,4-g25-path27", "128S122-4,8,4-g25-path27", "128S126-8,8,4-g33-path11", "128S123-4,4,8-g25-path11", "128S127-8,4,8-g33-path27", "128S127-4,8,8-g33-path27", "128S124-8,8,8-g41-path43", "128S122-8,4,4-g25-path28", "128S122-4,8,4-g25-path28", "128S126-8,8,4-g33-path12", "128S123-4,4,8-g25-path12", "128S127-8,4,8-g33-path28", "128S127-4,8,8-g33-path28", "128S124-8,8,8-g41-path44", "128S36-4,4,4-g17-path22", "128S125-4,4,4-g17-path43", "128S125-4,4,4-g17-path44" ];
