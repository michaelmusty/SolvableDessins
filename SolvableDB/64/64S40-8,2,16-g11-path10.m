...
s`SolvableDBName := "64S40-8,2,16-g11-path10";
s`SolvableDBFilename := "64S40-8,2,16-g11-path10.m";
...
\[ 6, 1, 19, 21, 17, 22, 16, 2, 3, 4, 5, 7, 28, 39, 12, 30, 8, 24, 23, 13, 9, 11, 26, 27, 36, 10, 14, 15, 18, 20, 25, 44, 40, 31, 58, 46, 33, 41, 32, 34, 45, 38, 54, 29, 35, 37, 42, 43, 47, 56, 48, 62, 55, 53, 50, 51, 59, 49, 63, 57, 64, 61, 52, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path2", "32S9-4,2,8-g3-path17", "64S40-8,2,16-g11-path10" ];
s`SolvableDBParents := [ Strings() | "128S114-8,4,16-g37-path192", "128S95-8,4,16-g37-path99", "128S64-8,4,16-g37-path55", "128S82-8,4,16-g37-path9", "128S92-8,2,16-g21-path54", "128S63-8,2,16-g21-path32", "128S81-8,2,16-g21-path9" ];
