...
s`SolvableDBName := "64S15-8,8,8-g21-path221";
s`SolvableDBFilename := "64S15-8,8,8-g21-path221.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 48, 46, 58, 13, 14, 12, 56, 59, 31, 44, 60, 21, 61, 35, 33, 15, 10, 19, 20, 22, 23, 17, 41, 9, 36, 11, 16, 18, 25, 26, 32, 34, 37, 38, 52, 54, 64, 43, 47, 49, 42, 45, 55, 51, 57, 62, 50, 40, 53, 39, 63 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T8-4,4,4-g3-path1", "32S13-8,4,4-g7-path14", "64S15-8,8,8-g21-path221" ];
s`SolvableDBParents := [ Strings() | "128S101-16,16,16-g53-path467", "128S101-16,16,16-g53-path468", "128S99-8,16,16-g49-path165", "128S100-16,8,8-g45-path165", "128S100-16,8,8-g45-path166", "128S99-8,16,16-g49-path166", "128S9-8,8,8-g41-path234" ];
