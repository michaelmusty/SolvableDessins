...
s`SolvableDBName := "64S5-4,8,8-g17-path35";
s`SolvableDBFilename := "64S5-4,8,8-g17-path35.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path10", "32S5-4,8,8-g9-path2", "64S5-4,8,8-g17-path35" ];
