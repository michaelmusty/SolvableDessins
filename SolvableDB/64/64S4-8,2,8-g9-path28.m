...
s`SolvableDBName := "64S4-8,2,8-g9-path28";
s`SolvableDBFilename := "64S4-8,2,8-g9-path28.m";
...
[ 57, 50, 56, 34, 30, 37, 46, 18, 49, 54, 38, 17, 28, 19, 60, 26, 12, 8, 14, 62, 25, 45, 36, 47, 21, 16, 58, 13, 42, 5, 51, 43, 39, 4, 55, 23, 6, 11, 33, 44, 64, 29, 32, 40, 22, 7, 24, 52, 9, 2, 31, 48, 59, 10, 35, 3, 1, 27, 53, 15, 63, 20, 61, 41 ],
[ 47, 39, 49, 56, 40, 55, 22, 59, 16, 23, 6, 57, 42, 60, 10, 37, 28, 52, 63, 8, 34, 32, 43, 31, 14, 12, 1, 50, 25, 46, 19, 35, 48, 30, 20, 27, 64, 17, 53, 36, 2, 18, 41, 11, 58, 26, 33, 5, 45, 51, 4, 3, 15, 38, 24, 54, 62, 13, 61, 9, 7, 21, 44, 29 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S6-4,2,4-g1-path3", "64S4-8,2,8-g9-path28" ];
