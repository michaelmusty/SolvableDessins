...
s`SolvableDBName := "64S25-4,8,8-g17-path111";
s`SolvableDBFilename := "64S25-4,8,8-g17-path111.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T10-2,4,4-g1-path4", "32S2-4,4,4-g5-path6", "64S25-4,8,8-g17-path111" ];
