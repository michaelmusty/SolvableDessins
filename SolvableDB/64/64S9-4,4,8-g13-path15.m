...
s`SolvableDBParents := [ Strings() | "128S86-4,8,8-g33-path14", "128S4-4,8,8-g33-path36", "128S3-4,8,8-g33-path78", "128S85-4,8,8-g33-path14", "128S83-4,4,8-g25-path20", "128S84-4,4,8-g25-path20", "128S26-4,4,8-g25-path48" ];
