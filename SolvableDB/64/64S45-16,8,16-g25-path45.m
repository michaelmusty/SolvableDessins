...
s`SolvableDBName := "64S45-16,8,16-g25-path45";
s`SolvableDBFilename := "64S45-16,8,16-g25-path45.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,2,8-g3-path7", "32S12-8,4,8-g9-path7", "64S45-16,8,16-g25-path45" ];
