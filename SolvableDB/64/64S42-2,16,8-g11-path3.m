...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 24, 25, 26, 22, 20, 21, 18, 17, 27, 15, 16, 14, 28, 11, 12, 13, 19, 23, 43, 42, 44, 45, 46, 38, 41, 39, 40, 34, 36, 37, 35, 30, 29, 31, 32, 33, 59, 60, 61, 58, 56, 55, 57, 62, 52, 51, 53, 50, 47, 48, 49, 54, 64, 63 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T12-2,8,4-g2-path3", "32S9-2,8,4-g3-path14", "64S42-2,16,8-g11-path3" ];
s`SolvableDBParents := [ Strings() | "128S65-4,16,8-g37-path30", "128S119-4,16,8-g37-path196", "128S81-4,16,8-g37-path30", "128S97-4,16,8-g37-path81", "128S65-2,16,8-g21-path30", "128S93-2,16,8-g21-path81", "128S81-2,16,8-g21-path30" ];
