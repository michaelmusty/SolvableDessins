...
s`SolvableDBName := "64S50-32,32,8-g27-path12";
s`SolvableDBFilename := "64S50-32,32,8-g27-path12.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 37, 39, 41, 13, 40, 42, 43, 17, 45, 18, 14, 47, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 56, 59, 60, 35, 61, 36, 62, 38, 57, 32, 58, 34, 63, 44, 27, 28, 29, 30, 31, 33, 46, 48, 64, 54, 49, 50, 51, 53, 55, 52 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,2-g3-path7", "32S16-16,16,4-g11-path4", "64S50-32,32,8-g27-path12" ];
s`SolvableDBParents := [ Strings() | "128S159-64,64,16-g59-path31", "128S160-64,64,16-g59-path23", "128S159-64,64,16-g59-path32", "128S160-64,64,16-g59-path24", "128S153-32,32,8-g53-path90", "128S128-32,32,8-g53-path59", "128S131-32,32,8-g53-path90" ];
