...
s`SolvableDBName := "64S16-8,8,8-g21-path40";
s`SolvableDBFilename := "64S16-8,8,8-g21-path40.m";
...
\[ 6, 1, 8, 16, 20, 23, 4, 24, 2, 3, 5, 7, 26, 22, 13, 40, 19, 41, 42, 48, 18, 49, 52, 53, 17, 54, 9, 10, 11, 12, 14, 15, 21, 25, 37, 51, 56, 36, 35, 62, 39, 38, 47, 46, 43, 32, 31, 63, 55, 44, 34, 57, 64, 50, 45, 33, 27, 28, 29, 30, 59, 60, 61, 58 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T8-4,4,4-g3-path12", "32S15-8,8,8-g11-path7", "64S16-8,8,8-g21-path40" ];
s`SolvableDBParents := [ Strings() | "128S102-8,16,16-g49-path11", "128S102-8,16,16-g49-path12", "128S103-16,8,8-g45-path6", "128S105-16,16,16-g53-path35", "128S105-16,16,16-g53-path36", "128S104-16,8,8-g45-path6", "128S9-8,8,8-g41-path36" ];
s`SolvableDBChild := "32S15-8,8,8-g11-path7";
