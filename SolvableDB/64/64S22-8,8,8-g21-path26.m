...
s`SolvableDBName := "64S22-8,8,8-g21-path26";
s`SolvableDBFilename := "64S22-8,8,8-g21-path26.m";
...
\[ 39, 63, 12, 35, 33, 29, 60, 58, 46, 62, 61, 48, 64, 37, 2, 38, 34, 13, 50, 9, 53, 57, 27, 7, 11, 36, 54, 32, 55, 41, 43, 30, 15, 44, 24, 59, 18, 42, 25, 51, 49, 40, 16, 4, 10, 1, 19, 22, 21, 23, 56, 28, 52, 8, 5, 31, 45, 47, 14, 17, 20, 3, 6, 26 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T8-4,4,4-g3-path15", "32S15-8,8,8-g11-path3", "64S22-8,8,8-g21-path26" ];
s`SolvableDBParents := [ Strings() | "128S33-8,8,8-g41-path1573", "128S33-8,8,8-g41-path1574", "128S22-8,8,8-g41-path481", "128S10-8,8,8-g41-path2455", "128S30-8,8,8-g41-path475", "128S34-8,8,8-g41-path1093", "128S19-8,8,8-g41-path961", "128S9-8,8,8-g41-path2080", "128S31-8,8,8-g41-path1093", "128S31-8,8,8-g41-path1094", "128S25-8,8,8-g41-path481", "128S10-8,8,8-g41-path2456", "128S34-8,8,8-g41-path1094", "128S30-8,8,8-g41-path476", "128S19-8,8,8-g41-path962" ];
s`SolvableDBChild := "32S15-8,8,8-g11-path3";
