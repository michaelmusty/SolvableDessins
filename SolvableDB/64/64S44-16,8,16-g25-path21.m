...
s`SolvableDBName := "64S44-16,8,16-g25-path21";
s`SolvableDBFilename := "64S44-16,8,16-g25-path21.m";
...
\[ 6, 1, 26, 14, 22, 27, 23, 28, 2, 3, 4, 5, 7, 8, 44, 25, 45, 55, 61, 32, 47, 51, 40, 43, 52, 58, 53, 56, 50, 38, 36, 60, 59, 42, 9, 10, 11, 12, 13, 15, 16, 17, 18, 19, 20, 21, 24, 29, 30, 31, 33, 34, 49, 64, 48, 39, 62, 46, 35, 63, 37, 41, 54, 57 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T8-4,4,4-g3-path19", "32S12-8,4,8-g9-path44", "64S44-16,8,16-g25-path21" ];
s`SolvableDBParents := [ Strings() | "128S153-32,16,32-g57-path95", "128S153-32,16,32-g57-path96", "128S154-32,16,32-g57-path95", "128S154-32,16,32-g57-path96", "128S106-16,8,16-g49-path443", "128S102-16,8,16-g49-path330", "128S99-16,8,16-g49-path330" ];
