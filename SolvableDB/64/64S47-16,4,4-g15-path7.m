...
s`SolvableDBName := "64S47-16,4,4-g15-path7";
s`SolvableDBFilename := "64S47-16,4,4-g15-path7.m";
...
\[ 6, 1, 8, 16, 19, 22, 4, 23, 2, 3, 5, 7, 18, 21, 13, 33, 34, 35, 37, 17, 38, 39, 40, 9, 10, 11, 12, 14, 15, 20, 36, 31, 49, 50, 51, 52, 53, 54, 55, 56, 24, 25, 26, 27, 28, 29, 30, 32, 61, 58, 63, 64, 41, 57, 43, 59, 42, 44, 45, 46, 47, 48, 62, 60 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T14-8,4,4-g4-path3", "32S14-8,4,4-g7-path5", "64S47-16,4,4-g15-path7" ];
s`SolvableDBParents := [ Strings() | "128S103-16,8,8-g45-path147", "128S103-16,8,8-g45-path148", "128S155-32,4,4-g31-path23", "128S157-32,8,8-g47-path45", "128S156-32,4,4-g31-path23", "128S157-32,8,8-g47-path46", "128S112-16,4,4-g29-path298" ];
