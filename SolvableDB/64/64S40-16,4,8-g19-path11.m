...
\[ 6, 1, 4, 21, 18, 22, 20, 23, 2, 3, 5, 7, 8, 17, 19, 13, 43, 42, 26, 38, 44, 45, 46, 28, 33, 41, 40, 27, 9, 10, 11, 12, 14, 15, 16, 24, 25, 39, 59, 57, 58, 56, 60, 61, 62, 55, 29, 30, 31, 32, 34, 35, 36, 37, 54, 47, 63, 64, 48, 52, 50, 49, 51, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T12-8,2,4-g2-path3", "32S9-8,2,4-g3-path13", "64S40-16,4,8-g19-path11" ];
s`SolvableDBParents := [ Strings() | "128S64-16,4,8-g37-path74", "128S92-16,4,8-g37-path56", "128S82-16,4,8-g37-path28", "128S63-16,4,8-g37-path34", "128S114-16,4,8-g37-path211", "128S81-16,4,8-g37-path11", "128S95-16,4,8-g37-path118" ];
