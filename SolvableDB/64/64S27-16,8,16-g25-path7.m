...
s`SolvableDBName := "64S27-16,8,16-g25-path7";
s`SolvableDBFilename := "64S27-16,8,16-g25-path7.m";
...
\[ 61, 50, 42, 47, 32, 48, 59, 25, 53, 55, 14, 16, 46, 49, 9, 33, 35, 64, 52, 36, 54, 12, 45, 20, 27, 7, 13, 31, 37, 21, 60, 38, 41, 24, 56, 5, 62, 11, 29, 18, 44, 58, 39, 19, 57, 3, 26, 63, 40, 15, 2, 28, 43, 8, 17, 30, 34, 10, 22, 4, 51, 6, 1, 23 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path2", "32S17-16,8,16-g13-path4", "64S27-16,8,16-g25-path7" ];
s`SolvableDBParents := [ Strings() | "128S130-32,16,32-g57-path25", "128S130-32,16,32-g57-path26", "128S130-32,16,32-g57-path27", "128S130-32,16,32-g57-path28", "128S106-16,8,16-g49-path281", "128S44-16,8,16-g49-path144", "128S43-16,8,16-g49-path50" ];
