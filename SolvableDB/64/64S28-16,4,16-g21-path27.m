...
s`SolvableDBName := "64S28-16,4,16-g21-path27";
s`SolvableDBFilename := "64S28-16,4,16-g21-path27.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T6-8,4,8-g5-path1", "32S4-8,4,8-g9-path21", "64S28-16,4,16-g21-path27" ];
s`SolvableDBChildren := [ Strings() | "32S4-8,4,8-g9-path21" ];
