...
s`SolvableDBName := "64S7-4,8,8-g17-path85";
s`SolvableDBFilename := "64S7-4,8,8-g17-path85.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 36, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 30, 17, 46, 52, 32, 33, 13, 14, 18, 21, 28, 29, 35, 44, 31, 45, 47, 40, 49, 55, 58, 34, 43, 53, 41, 51, 54, 37, 56, 60, 57, 59, 38, 42, 48, 50, 62, 63, 64, 61 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path8", "32S11-2,8,4-g3-path11", "64S7-4,8,8-g17-path85" ];
s`SolvableDBParents := [ Strings() | "128S69-8,16,16-g49-path393", "128S70-8,16,16-g49-path329", "128S69-8,16,16-g49-path394", "128S70-8,16,16-g49-path330", "128S3-4,8,8-g33-path810", "128S11-4,8,8-g33-path1344", "128S4-4,8,8-g33-path360" ];
