...
s`SolvableDBName := "64S3-8,8,8-g21-path161";
s`SolvableDBFilename := "64S3-8,8,8-g21-path161.m";
...
\[ 56, 61, 15, 21, 37, 64, 31, 35, 22, 42, 48, 29, 28, 19, 39, 55, 5, 8, 3, 53, 40, 44, 54, 52, 4, 51, 46, 50, 60, 45, 25, 16, 7, 36, 27, 47, 41, 49, 57, 63, 6, 58, 38, 12, 14, 10, 26, 59, 34, 11, 43, 13, 32, 62, 23, 9, 30, 18, 24, 1, 17, 20, 33, 2 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T4-4,4,4-g3-path8", "32S4-8,4,8-g9-path12", "64S3-8,8,8-g21-path161" ];
s`SolvableDBParents := [ Strings() | "128S45-8,16,16-g49-path257", "128S45-8,16,16-g49-path258", "128S44-16,16,8-g49-path207", "128S45-16,8,16-g49-path325", "128S44-16,16,8-g49-path208", "128S45-16,8,16-g49-path326", "128S5-8,8,8-g41-path846" ];
