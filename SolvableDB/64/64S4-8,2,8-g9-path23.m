...
s`SolvableDBName := "64S4-8,2,8-g9-path23";
s`SolvableDBFilename := "64S4-8,2,8-g9-path23.m";
...
[ 7, 12, 11, 1, 13, 16, 25, 29, 28, 2, 30, 35, 38, 3, 39, 24, 40, 4, 5, 14, 6, 15, 54, 36, 56, 58, 8, 53, 60, 55, 9, 10, 31, 62, 64, 26, 23, 34, 27, 37, 17, 33, 32, 18, 19, 41, 20, 42, 21, 45, 22, 43, 63, 61, 59, 57, 44, 49, 47, 51, 46, 50, 48, 52 ]
]
];
...
[ 50, 20, 52, 62, 44, 61, 45, 33, 22, 47, 43, 14, 18, 64, 63, 46, 58, 34, 57, 35, 54, 53, 6, 41, 19, 40, 42, 15, 31, 32, 51, 59, 60, 1, 3, 17, 21, 4, 48, 49, 26, 29, 55, 38, 56, 36, 12, 8, 23, 25, 28, 30, 39, 16, 10, 5, 13, 37, 2, 9, 24, 7, 27, 11 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path7", "32S5-8,2,8-g5-path9", "64S4-8,2,8-g9-path23" ];
