...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 47, 9, 55, 35, 14, 33, 46, 59, 12, 58, 60, 21, 57, 13, 31, 37, 17, 19, 20, 22, 23, 10, 52, 40, 36, 11, 15, 16, 18, 25, 26, 32, 34, 38, 43, 39, 62, 42, 51, 48, 53, 44, 45, 50, 56, 61, 63, 54, 41, 64, 49 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path5", "32S17-8,16,16-g13-path1", "64S27-8,16,16-g25-path2" ];
s`SolvableDBParents := [ Strings() | "128S130-16,32,32-g57-path33", "128S130-16,32,32-g57-path34", "128S130-16,32,32-g57-path35", "128S130-16,32,32-g57-path36", "128S106-8,16,16-g49-path283", "128S44-8,16,16-g49-path146", "128S43-8,16,16-g49-path52" ];
s`SolvableDBChild := "32S17-8,16,16-g13-path1";
