...
s`SolvableDBName := "64S26-8,16,16-g25-path15";
s`SolvableDBFilename := "64S26-8,16,16-g25-path15.m";
...
\[ 54, 24, 63, 62, 64, 57, 49, 41, 6, 51, 19, 15, 48, 50, 60, 52, 40, 42, 59, 53, 61, 56, 55, 27, 45, 37, 1, 21, 4, 3, 47, 39, 17, 13, 18, 20, 44, 22, 46, 25, 30, 31, 14, 16, 36, 23, 38, 26, 29, 32, 58, 34, 33, 9, 43, 35, 2, 5, 7, 8, 10, 11, 12, 28 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-4,8,8-g5-path3", "32S16-8,16,16-g13-path16", "64S26-8,16,16-g25-path15" ];
s`SolvableDBParents := [ Strings() | "128S128-16,32,32-g57-path9", "128S129-16,32,32-g57-path9", "128S128-16,32,32-g57-path10", "128S129-16,32,32-g57-path10", "128S106-8,16,16-g49-path232", "128S42-8,16,16-g49-path52", "128S44-8,16,16-g49-path52" ];
