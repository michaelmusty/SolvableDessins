...
s`SolvableDBName := "64S50-8,32,32-g27-path9";
s`SolvableDBFilename := "64S50-8,32,32-g27-path9.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T5-2,8,8-g3-path1", "32S16-4,16,16-g11-path3", "64S50-8,32,32-g27-path9" ];
