...
s`SolvableDBName := "64S22-8,8,8-g21-path23";
s`SolvableDBFilename := "64S22-8,8,8-g21-path23.m";
...
\[ 39, 63, 12, 35, 33, 29, 60, 58, 46, 62, 61, 48, 64, 37, 2, 38, 34, 13, 50, 9, 53, 57, 27, 7, 11, 36, 54, 32, 55, 41, 43, 30, 15, 44, 24, 59, 18, 42, 25, 51, 49, 40, 16, 4, 10, 1, 19, 22, 21, 23, 56, 28, 52, 8, 5, 31, 45, 47, 14, 17, 20, 3, 6, 26 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T8-4,4,4-g3-path16", "32S15-8,8,8-g11-path1", "64S22-8,8,8-g21-path23" ];
s`SolvableDBParents := [ Strings() | "128S33-8,8,8-g41-path1583", "128S33-8,8,8-g41-path1584", "128S22-8,8,8-g41-path486", "128S10-8,8,8-g41-path2465", "128S30-8,8,8-g41-path485", "128S34-8,8,8-g41-path1103", "128S19-8,8,8-g41-path971", "128S9-8,8,8-g41-path2085", "128S31-8,8,8-g41-path1103", "128S31-8,8,8-g41-path1104", "128S25-8,8,8-g41-path486", "128S10-8,8,8-g41-path2466", "128S34-8,8,8-g41-path1104", "128S30-8,8,8-g41-path486", "128S19-8,8,8-g41-path972" ];
s`SolvableDBChild := "32S15-8,8,8-g11-path1";
