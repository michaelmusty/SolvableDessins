...
s`SolvableDBName := "64S6-2,8,8-g9-path21";
s`SolvableDBFilename := "64S6-2,8,8-g9-path21.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 14, 26, 27, 11, 21, 22, 19, 23, 17, 28, 15, 16, 18, 29, 30, 12, 13, 20, 24, 25, 38, 37, 39, 41, 52, 53, 32, 31, 33, 47, 34, 49, 50, 48, 46, 45, 40, 44, 42, 43, 54, 35, 36, 51, 57, 61, 55, 59, 58, 62, 56, 60, 64, 63 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path5", "32S11-2,8,4-g3-path2", "64S6-2,8,8-g9-path21" ];
s`SolvableDBParents := [ Strings() | "128S11-4,8,8-g33-path1104", "128S3-4,8,8-g33-path570", "128S67-2,16,8-g21-path41", "128S67-4,16,8-g37-path41", "128S68-2,16,8-g21-path41", "128S68-4,16,8-g37-path41", "128S63-2,8,16-g21-path81", "128S64-4,8,16-g37-path121", "128S65-2,8,16-g21-path75", "128S66-4,8,16-g37-path109", "128S61-2,16,16-g25-path202", "128S61-4,16,16-g41-path202", "128S62-2,16,16-g25-path170", "128S62-4,16,16-g41-path170", "128S2-2,8,8-g17-path201" ];
