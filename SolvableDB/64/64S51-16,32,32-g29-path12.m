...
s`SolvableDBName := "64S51-16,32,32-g29-path12";
s`SolvableDBFilename := "64S51-16,32,32-g29-path12.m";
...
\[ 62, 63, 36, 38, 33, 34, 44, 52, 58, 54, 61, 49, 59, 42, 9, 41, 30, 50, 48, 40, 35, 12, 43, 13, 27, 11, 60, 14, 31, 55, 20, 28, 26, 64, 53, 56, 23, 57, 18, 32, 47, 39, 51, 22, 2, 37, 8, 25, 21, 46, 29, 24, 19, 17, 16, 10, 7, 5, 3, 4, 6, 45, 15, 1 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T1-8,16,16-g7-path2", "32S16-8,16,16-g13-path2", "64S51-16,32,32-g29-path12" ];
s`SolvableDBParents := [ Strings() | "128S153-16,32,32-g57-path204", "128S131-16,32,32-g57-path204", "128S129-16,32,32-g57-path98" ];
