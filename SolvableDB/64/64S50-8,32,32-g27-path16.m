...
s`SolvableDBName := "64S50-8,32,32-g27-path16";
s`SolvableDBFilename := "64S50-8,32,32-g27-path16.m";
...
\[ 2, 9, 8, 7, 10, 1, 11, 12, 21, 24, 27, 28, 16, 23, 3, 26, 20, 22, 4, 25, 5, 29, 30, 6, 31, 32, 18, 14, 19, 15, 40, 34, 36, 37, 13, 38, 46, 48, 42, 43, 17, 44, 45, 47, 41, 35, 49, 50, 59, 54, 53, 33, 55, 56, 57, 52, 60, 39, 61, 62, 58, 63, 64, 51 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-2,8,8-g3-path4", "32S16-4,16,16-g11-path3", "64S50-8,32,32-g27-path16" ];
s`SolvableDBParents := [ Strings() | "128S159-16,64,64-g59-path23", "128S160-16,64,64-g59-path15", "128S159-16,64,64-g59-path24", "128S160-16,64,64-g59-path16", "128S153-8,32,32-g53-path86", "128S128-8,32,32-g53-path55", "128S131-8,32,32-g53-path86" ];
