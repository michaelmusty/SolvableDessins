...
s`SolvableDBName := "64S8-4,2,8-g5-path5";
s`SolvableDBFilename := "64S8-4,2,8-g5-path5.m";
...
\[ 11, 27, 26, 3, 2, 5, 29, 17, 21, 9, 8, 55, 12, 39, 56, 13, 1, 14, 10, 15, 19, 54, 38, 53, 4, 25, 6, 43, 28, 49, 50, 30, 31, 61, 52, 34, 24, 35, 47, 51, 36, 37, 7, 33, 20, 32, 18, 40, 46, 44, 64, 23, 42, 57, 16, 45, 62, 60, 58, 63, 41, 22, 59, 48 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S11-4,2,8-g3-path8", "64S8-4,2,8-g5-path5" ];
s`SolvableDBParents := [ Strings() | "128S77-8,2,8-g17-path79", "128S26-4,4,8-g25-path852", "128S78-8,4,8-g33-path123", "128S2-8,2,8-g17-path260", "128S76-4,4,8-g25-path162", "128S3-8,4,8-g33-path935", "128S79-4,2,16-g13-path75", "128S73-8,2,16-g21-path35", "128S80-4,4,16-g29-path234", "128S74-8,4,16-g37-path35", "128S71-4,2,16-g13-path35", "128S81-8,2,16-g21-path69", "128S72-4,4,16-g29-path74", "128S82-8,4,16-g37-path103", "128S75-4,2,8-g9-path57" ];
