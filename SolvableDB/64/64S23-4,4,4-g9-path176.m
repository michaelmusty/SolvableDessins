...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T8-4,4,4-g3-path21", "32S2-4,4,4-g5-path62", "64S23-4,4,4-g9-path176" ];
s`SolvableDBChildren := [ Strings() | "32S2-4,4,4-g5-path62" ];
