...
s`SolvableDBName := "64S4-8,2,8-g9-path6";
s`SolvableDBFilename := "64S4-8,2,8-g9-path6.m";
...
[ 3, 9, 1, 17, 10, 19, 24, 23, 2, 5, 27, 25, 37, 33, 32, 39, 4, 43, 6, 45, 42, 41, 8, 7, 12, 34, 11, 36, 35, 38, 40, 15, 14, 26, 29, 28, 13, 30, 16, 31, 22, 21, 18, 49, 20, 50, 51, 52, 44, 46, 47, 48, 55, 56, 53, 54, 59, 60, 57, 58, 63, 64, 61, 62 ],
[ 27, 36, 24, 31, 9, 10, 28, 56, 25, 37, 23, 54, 8, 40, 5, 11, 3, 15, 39, 6, 14, 4, 35, 12, 29, 64, 38, 34, 62, 26, 13, 16, 1, 60, 58, 55, 30, 53, 7, 2, 32, 19, 17, 42, 33, 20, 41, 18, 43, 22, 45, 21, 57, 59, 61, 63, 51, 47, 49, 44, 52, 48, 50, 46 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,2,8-g3-path3", "32S5-8,2,8-g5-path14", "64S4-8,2,8-g9-path6" ];
