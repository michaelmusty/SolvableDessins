...
s`SolvableDBName := "64S31-16,16,2-g13-path4-notcomputed";
s`SolvableDBFilename := "64S31-16,16,2-g13-path4-notcomputed.m";
...
\[ 6, 1, 21, 22, 19, 23, 13, 2, 3, 4, 5, 7, 33, 49, 14, 48, 50, 32, 46, 31, 47, 44, 45, 27, 38, 8, 9, 10, 11, 12, 15, 16, 17, 18, 20, 24, 25, 43, 41, 56, 42, 59, 39, 40, 64, 63, 60, 62, 58, 61, 35, 34, 26, 28, 29, 30, 36, 37, 51, 52, 54, 57, 53, 55 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-4,4,2-g1-path4-notcomputed", "16T6-8,8,2-g3-path1-notcomputed", "32S5-8,8,2-g5-path7-notcomputed", "64S31-16,16,2-g13-path4-notcomputed" ];
