...
s`SolvableDBName := "64S7-4,8,8-g17-path84";
s`SolvableDBFilename := "64S7-4,8,8-g17-path84.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 36, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 30, 17, 46, 52, 32, 33, 13, 14, 18, 21, 28, 29, 35, 44, 31, 45, 47, 40, 49, 55, 58, 34, 43, 53, 41, 51, 54, 37, 56, 60, 57, 59, 38, 42, 48, 50, 62, 63, 64, 61 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path10", "32S11-2,8,4-g3-path7", "64S7-4,8,8-g17-path84" ];
s`SolvableDBParents := [ Strings() | "128S69-8,16,16-g49-path391", "128S70-8,16,16-g49-path327", "128S69-8,16,16-g49-path392", "128S70-8,16,16-g49-path328", "128S3-4,8,8-g33-path808", "128S11-4,8,8-g33-path1342", "128S4-4,8,8-g33-path358" ];
