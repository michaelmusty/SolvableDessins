...
s`SolvableDBName := "64S9-4,4,8-g13-path126";
s`SolvableDBFilename := "64S9-4,4,8-g13-path126.m";
...
\[ 11, 30, 12, 7, 2, 5, 10, 33, 18, 31, 9, 22, 51, 13, 36, 37, 8, 1, 24, 3, 25, 20, 14, 34, 35, 59, 40, 39, 15, 6, 4, 17, 32, 54, 57, 46, 52, 63, 50, 47, 38, 28, 60, 27, 26, 29, 44, 16, 55, 42, 23, 48, 41, 19, 56, 64, 21, 45, 58, 61, 62, 43, 53, 49 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path8", "32S6-4,2,4-g1-path10", "64S9-4,4,8-g13-path126" ];
s`SolvableDBParents := [ Strings() | "128S86-8,4,8-g33-path120", "128S4-8,4,8-g33-path482", "128S3-8,4,8-g33-path1088", "128S85-8,4,8-g33-path120", "128S83-4,4,8-g25-path163", "128S84-4,4,8-g25-path163", "128S26-4,4,8-g25-path1009" ];
