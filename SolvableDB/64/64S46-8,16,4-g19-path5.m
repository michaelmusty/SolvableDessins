...
s`SolvableDBName := "64S46-8,16,4-g19-path5";
s`SolvableDBFilename := "64S46-8,16,4-g19-path5.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path27", "32S13-4,8,4-g7-path11", "64S46-8,16,4-g19-path5" ];
