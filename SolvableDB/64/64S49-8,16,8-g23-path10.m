...
s`SolvableDBName := "64S49-8,16,8-g23-path10";
s`SolvableDBFilename := "64S49-8,16,8-g23-path10.m";
...
[ 16, 28, 34, 14, 36, 41, 4, 7, 19, 44, 18, 25, 11, 13, 50, 21, 52, 24, 1, 30, 32, 37, 57, 8, 20, 48, 49, 6, 42, 2, 46, 5, 56, 26, 63, 9, 3, 53, 62, 64, 12, 31, 33, 23, 58, 10, 60, 17, 40, 39, 61, 22, 15, 43, 59, 55, 29, 47, 51, 27, 54, 35, 38, 45 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path33", "32S14-4,8,4-g7-path13", "64S49-8,16,8-g23-path10" ];
