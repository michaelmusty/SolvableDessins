...
s`SolvableDBName := "64S13-8,4,8-g17-path29";
s`SolvableDBFilename := "64S13-8,4,8-g17-path29.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 23, 44, 58, 13, 14, 17, 35, 59, 31, 9, 60, 21, 61, 34, 10, 18, 33, 19, 20, 22, 12, 39, 43, 56, 11, 15, 16, 25, 26, 32, 36, 37, 57, 49, 62, 50, 55, 42, 46, 45, 51, 53, 47, 38, 64, 40, 52, 63, 54, 48, 41 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T12-8,4,2-g2-path1", "32S10-8,4,4-g7-path26", "64S13-8,4,8-g17-path29" ];
s`SolvableDBParents := [ Strings() | "128S96-8,4,16-g37-path24", "128S95-8,4,16-g37-path47", "128S95-8,4,16-g37-path48", "128S97-8,4,16-g37-path24", "128S3-8,4,8-g33-path235", "128S3-8,4,8-g33-path236", "128S28-8,4,8-g33-path97" ];
