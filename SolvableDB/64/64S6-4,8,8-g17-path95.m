...
s`SolvableDBName := "64S6-4,8,8-g17-path95";
s`SolvableDBFilename := "64S6-4,8,8-g17-path95.m";
...
\[ 6, 1, 21, 7, 2, 5, 19, 22, 3, 4, 8, 11, 42, 33, 9, 26, 23, 24, 10, 25, 15, 12, 20, 28, 17, 34, 30, 32, 13, 14, 16, 18, 27, 31, 59, 49, 29, 50, 43, 44, 45, 37, 40, 39, 36, 48, 35, 38, 41, 46, 54, 63, 47, 64, 60, 61, 62, 51, 53, 56, 55, 52, 57, 58 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path4", "32S9-2,8,4-g3-path4", "64S6-4,8,8-g17-path95" ];
s`SolvableDBParents := [ Strings() | "128S67-8,8,16-g45-path53", "128S68-8,8,16-g45-path53", "128S68-8,8,16-g45-path54", "128S67-8,8,16-g45-path54", "128S63-4,16,8-g37-path67", "128S61-8,16,16-g49-path373", "128S66-4,16,8-g37-path146", "128S62-8,16,16-g49-path309", "128S65-4,16,8-g37-path61", "128S62-8,16,16-g49-path310", "128S64-4,16,8-g37-path158", "128S61-8,16,16-g49-path374", "128S3-4,8,8-g33-path657", "128S2-4,8,8-g33-path186", "128S11-4,8,8-g33-path1191" ];
