...
s`SolvableDBName := "64S21-4,8,4-g13-path8-notcomputed";
s`SolvableDBFilename := "64S21-4,8,4-g13-path8-notcomputed.m";
...
\[ 12, 39, 43, 7, 2, 5, 38, 42, 22, 34, 13, 9, 28, 19, 14, 58, 59, 10, 29, 62, 30, 1, 31, 11, 32, 33, 18, 24, 15, 25, 64, 21, 20, 27, 23, 63, 54, 40, 6, 4, 44, 41, 37, 8, 60, 50, 51, 52, 53, 48, 57, 46, 45, 3, 47, 61, 55, 56, 36, 49, 16, 26, 17, 35 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T4-2,4,2-g0-path2-notcomputed", "16T12-2,8,4-g2-path1-notcomputed", "32S13-4,8,4-g7-path1-notcomputed", "64S21-4,8,4-g13-path8-notcomputed" ];
