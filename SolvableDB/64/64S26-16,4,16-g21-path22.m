...
s`SolvableDBName := "64S26-16,4,16-g21-path22";
s`SolvableDBFilename := "64S26-16,4,16-g21-path22.m";
...
\[ 48, 56, 51, 50, 26, 27, 64, 58, 45, 47, 62, 37, 53, 29, 31, 60, 35, 28, 30, 44, 9, 46, 49, 10, 39, 24, 63, 42, 36, 54, 57, 17, 32, 12, 52, 23, 14, 16, 33, 11, 25, 22, 2, 59, 5, 19, 6, 43, 15, 61, 55, 20, 38, 4, 8, 21, 3, 34, 13, 41, 7, 18, 1, 40 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,2,8-g3-path6", "32S3-8,4,8-g9-path19", "64S26-16,4,16-g21-path22" ];
s`SolvableDBParents := [ Strings() | "128S42-16,8,16-g49-path43", "128S44-16,8,16-g49-path43", "128S128-32,4,32-g45-path43", "128S128-32,8,32-g53-path43", "128S129-32,4,32-g45-path43", "128S129-32,8,32-g53-path43", "128S106-16,4,16-g41-path270" ];
