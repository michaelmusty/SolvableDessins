...
s`SolvableDBName := "64S50-2,32,32-g15-path9";
s`SolvableDBFilename := "64S50-2,32,32-g15-path9.m";
...
\[ 2, 1, 7, 6, 8, 4, 3, 5, 11, 16, 9, 14, 15, 12, 13, 10, 19, 20, 17, 18, 23, 24, 21, 22, 27, 28, 25, 26, 31, 32, 29, 30, 35, 36, 33, 34, 39, 40, 37, 38, 43, 44, 41, 42, 47, 48, 45, 46, 51, 52, 49, 50, 55, 56, 53, 54, 59, 60, 57, 58, 63, 64, 61, 62 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T5-2,8,8-g3-path1", "32S16-2,16,16-g7-path5", "64S50-2,32,32-g15-path9" ];
s`SolvableDBParents := [ Strings() | "128S128-4,32,32-g45-path55", "128S153-4,32,32-g45-path86", "128S159-2,64,64-g31-path10", "128S159-4,64,64-g47-path10", "128S160-2,64,64-g31-path8", "128S160-4,64,64-g47-path8", "128S131-2,32,32-g29-path47" ];
