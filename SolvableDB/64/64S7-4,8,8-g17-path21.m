...
s`SolvableDBName := "64S7-4,8,8-g17-path21";
s`SolvableDBFilename := "64S7-4,8,8-g17-path21.m";
...
[ 31, 37, 4, 58, 55, 20, 60, 56, 47, 7, 64, 16, 63, 15, 59, 21, 51, 39, 8, 11, 34, 17, 50, 45, 27, 22, 28, 40, 49, 13, 38, 29, 52, 12, 1, 33, 24, 35, 23, 25, 36, 3, 32, 53, 2, 44, 5, 46, 43, 18, 26, 41, 48, 19, 9, 54, 14, 42, 57, 61, 10, 30, 62, 6 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T14-4,4,8-g4-path3", "32S10-4,4,8-g7-path34", "64S7-4,8,8-g17-path21" ];
