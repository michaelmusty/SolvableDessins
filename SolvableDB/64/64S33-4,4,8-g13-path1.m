...
s`SolvableDBName := "64S33-4,4,8-g13-path1";
s`SolvableDBFilename := "64S33-4,4,8-g13-path1.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path1", "32S6-2,4,4-g1-path1", "64S33-4,4,8-g13-path1" ];
