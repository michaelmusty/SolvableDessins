...
s`SolvableDBName := "64S33-8,4,4-g13-path7";
s`SolvableDBFilename := "64S33-8,4,4-g13-path7.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S6-4,2,4-g1-path5", "64S33-8,4,4-g13-path7" ];
s`SolvableDBChildren := [ Strings() | "32S6-4,2,4-g1-path5" ];
