...
\[ 6, 1, 21, 22, 19, 8, 4, 2, 3, 5, 7, 44, 48, 46, 49, 50, 47, 51, 26, 17, 25, 11, 16, 18, 9, 10, 12, 13, 14, 15, 20, 23, 24, 43, 28, 27, 45, 56, 60, 58, 40, 37, 38, 36, 52, 54, 31, 35, 55, 32, 33, 42, 41, 29, 30, 34, 39, 53, 62, 63, 64, 61, 57, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path7", "32S6-4,4,2-g1-path6", "64S8-4,8,2-g5-path20" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,2-g17-path249", "128S26-4,8,4-g25-path841", "128S3-8,8,4-g33-path924", "128S77-8,8,2-g17-path68", "128S76-4,8,4-g25-path151", "128S78-8,8,4-g33-path112", "128S79-4,16,2-g13-path64", "128S81-8,16,2-g21-path58", "128S80-4,16,4-g29-path223", "128S82-8,16,4-g37-path92", "128S71-4,16,2-g13-path24", "128S73-8,16,2-g21-path24", "128S72-4,16,4-g29-path63", "128S74-8,16,4-g37-path24", "128S75-4,8,2-g9-path46" ];
