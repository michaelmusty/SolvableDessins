...
s`SolvableDBName := "64S50-16,32,32-g29-path25";
s`SolvableDBFilename := "64S50-16,32,32-g29-path25.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path7", "32S16-8,16,16-g13-path17", "64S50-16,32,32-g29-path25" ];
s`SolvableDBChildren := [ Strings() | "32S16-8,16,16-g13-path17" ];
