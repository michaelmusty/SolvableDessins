...
s`SolvableDBName := "64S30-4,16,16-g21-path3";
s`SolvableDBFilename := "64S30-4,16,16-g21-path3.m";
...
\[ 2, 5, 9, 7, 6, 1, 10, 11, 14, 21, 15, 31, 32, 22, 23, 12, 24, 25, 26, 27, 4, 3, 8, 19, 33, 17, 34, 35, 36, 28, 38, 29, 43, 46, 40, 13, 53, 16, 52, 30, 37, 39, 18, 49, 44, 20, 50, 47, 54, 55, 42, 51, 57, 45, 48, 58, 41, 63, 60, 64, 56, 59, 61, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-2,8,8-g3-path5", "32S5-2,8,8-g5-path16", "64S30-4,16,16-g21-path3" ];
s`SolvableDBParents := [ Strings() | "128S70-4,16,16-g41-path51", "128S70-4,16,16-g41-path52", "128S46-4,16,16-g41-path42", "128S54-4,16,16-g41-path104", "128S62-4,16,16-g41-path5", "128S62-4,16,16-g41-path6", "128S109-4,16,16-g41-path253" ];
