...
s`SolvableDBName := "64S35-4,4,4-g9-path27";
s`SolvableDBFilename := "64S35-4,4,4-g9-path27.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S6-4,4,2-g1-path3", "64S35-4,4,4-g9-path27" ];
s`SolvableDBChildren := [ Strings() | "32S6-4,4,2-g1-path3" ];
