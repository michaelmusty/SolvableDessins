...
s`SolvableDBName := "64S7-8,4,8-g17-path97";
s`SolvableDBFilename := "64S7-8,4,8-g17-path97.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S11-8,2,4-g3-path5", "64S7-8,4,8-g17-path97" ];
