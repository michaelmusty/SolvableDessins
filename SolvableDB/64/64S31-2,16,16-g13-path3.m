...
phi := KX!((240*x[3]^15 + 24*x[3]^7)*x[4]^7 + (-360*x[3]^14 - 44*x[3]^6)*x[4]^6 + (64*x[3]^13 + 16*x[3]^5)*x[4]^5 + (28*x[3]^12 + 4*x[3]^4)*x[4]^4 + 12*x[3]^11*x[4]^3 + (240*x[3]^18 + 30*x[3]^10)*x[4]^2 + (-240*x[3]^17 - 28*x[3]^9)*x[4] + 124*x[3]^16 + 21*x[3]^8 + 1);
/* assign to object */
...
s`SolvableDBName := "64S31-2,16,16-g13-path3";
s`SolvableDBFilename := "64S31-2,16,16-g13-path3.m";
...
s`SolvableDBLocalSanityCheckTiming := 2.890p15;
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 26, 27, 28, 29, 21, 22, 19, 23, 17, 30, 15, 16, 18, 25, 24, 11, 12, 13, 14, 20, 53, 54, 34, 33, 38, 52, 51, 35, 41, 46, 39, 43, 42, 49, 50, 40, 48, 47, 44, 45, 37, 36, 31, 32, 56, 55, 64, 62, 60, 59, 63, 58, 61, 57 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path4", "32S5-2,8,8-g5-path2", "64S31-2,16,16-g13-path3" ];
s`SolvableDBParents := [ Strings() | "128S69-4,16,16-g41-path13", "128S55-4,16,16-g41-path1", "128S111-4,16,16-g41-path13", "128S70-4,16,16-g41-path5", "128S62-2,16,16-g25-path3", "128S61-2,16,16-g25-path7", "128S47-2,16,16-g25-path1" ];
