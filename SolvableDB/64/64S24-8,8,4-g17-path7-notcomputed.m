...
\[ 46, 63, 33, 14, 32, 23, 19, 11, 22, 35, 40, 29, 28, 38, 7, 20, 44, 47, 30, 42, 51, 52, 2, 41, 43, 16, 49, 8, 54, 4, 3, 39, 21, 59, 45, 5, 48, 62, 6, 64, 13, 55, 53, 57, 18, 9, 61, 17, 10, 60, 25, 12, 31, 1, 34, 50, 56, 26, 58, 37, 27, 15, 36, 24 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T2-4,4,2-g1-path1-notcomputed", "16T10-4,4,2-g1-path3-notcomputed", "32S8-8,8,4-g9-path2-notcomputed", "64S24-8,8,4-g17-path7-notcomputed" ];
