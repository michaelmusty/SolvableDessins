...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 15, 58, 59, 55, 34, 33, 11, 13, 41, 50, 38, 21, 60, 53, 26, 63, 17, 19, 20, 22, 23, 10, 45, 14, 36, 9, 12, 16, 18, 25, 31, 32, 35, 37, 49, 42, 57, 40, 62, 61, 46, 43, 47, 48, 52, 44, 51, 54, 56, 64, 39 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T8-4,4,4-g3-path6", "32S15-8,8,8-g11-path26", "64S15-8,8,8-g21-path294" ];
s`SolvableDBParents := [ Strings() | "128S100-8,16,8-g45-path61", "128S100-8,16,8-g45-path62", "128S99-16,8,16-g49-path61", "128S101-16,16,16-g53-path217", "128S99-16,8,16-g49-path62", "128S101-16,16,16-g53-path218", "128S9-8,8,8-g41-path109" ];
