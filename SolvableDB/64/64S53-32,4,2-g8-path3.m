...
s`SolvableDBName := "64S53-32,4,2-g8-path3";
s`SolvableDBFilename := "64S53-32,4,2-g8-path3.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T13-8,2,2-g0-path3", "32S18-16,2,2-g0-path3", "64S53-32,4,2-g8-path3" ];
