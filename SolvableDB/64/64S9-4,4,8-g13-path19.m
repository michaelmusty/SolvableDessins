...
s`SolvableDBParents := [ Strings() | "128S3-4,8,8-g33-path76", "128S86-4,8,8-g33-path12", "128S4-4,8,8-g33-path34", "128S85-4,8,8-g33-path12", "128S84-4,4,8-g25-path15", "128S26-4,4,8-g25-path43", "128S83-4,4,8-g25-path15" ];
