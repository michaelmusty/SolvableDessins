...
s`SolvableDBName := "64S48-4,4,16-g15-path2";
s`SolvableDBFilename := "64S48-4,4,16-g15-path2.m";
...
\[ 6, 1, 24, 16, 18, 9, 4, 25, 2, 3, 5, 7, 8, 11, 33, 12, 13, 14, 23, 28, 26, 10, 21, 22, 17, 19, 20, 32, 31, 41, 15, 27, 29, 30, 42, 49, 39, 34, 35, 44, 38, 37, 40, 48, 47, 58, 36, 43, 45, 46, 57, 64, 50, 55, 51, 60, 54, 53, 56, 63, 62, 52, 59, 61 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T14-4,4,8-g4-path2", "32S14-4,4,8-g7-path4", "64S48-4,4,16-g15-path2" ];
s`SolvableDBParents := [ Strings() | "128S158-8,4,32-g39-path27", "128S158-4,8,32-g39-path27", "128S104-8,8,16-g45-path129", "128S158-8,4,32-g39-path28", "128S158-4,8,32-g39-path28", "128S104-8,8,16-g45-path130", "128S112-4,4,16-g29-path312" ];
