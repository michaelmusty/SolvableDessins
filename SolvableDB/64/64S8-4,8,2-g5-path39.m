...
\[ 6, 1, 21, 22, 19, 8, 4, 2, 3, 5, 7, 41, 40, 23, 20, 29, 30, 42, 26, 17, 25, 11, 16, 18, 9, 10, 12, 13, 14, 15, 24, 58, 48, 43, 28, 27, 47, 44, 59, 35, 36, 31, 38, 34, 39, 32, 33, 37, 45, 57, 50, 60, 61, 64, 46, 63, 62, 55, 49, 53, 52, 51, 54, 56 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path2", "32S9-4,8,2-g3-path8", "64S8-4,8,2-g5-path39" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,2-g17-path242", "128S26-4,8,4-g25-path834", "128S3-8,8,4-g33-path917", "128S77-8,8,2-g17-path61", "128S76-4,8,4-g25-path144", "128S78-8,8,4-g33-path105", "128S79-4,16,2-g13-path57", "128S81-8,16,2-g21-path51", "128S80-4,16,4-g29-path216", "128S82-8,16,4-g37-path85", "128S71-4,16,2-g13-path17", "128S73-8,16,2-g21-path17", "128S72-4,16,4-g29-path56", "128S74-8,16,4-g37-path17", "128S75-4,8,2-g9-path39" ];
