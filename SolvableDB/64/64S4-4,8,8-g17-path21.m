...
s`SolvableDBName := "64S4-4,8,8-g17-path21";
s`SolvableDBFilename := "64S4-4,8,8-g17-path21.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path5", "32S5-4,8,8-g9-path7", "64S4-4,8,8-g17-path21" ];
