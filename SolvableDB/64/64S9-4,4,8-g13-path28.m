...
s`SolvableDBName := "64S9-4,4,8-g13-path28";
s`SolvableDBFilename := "64S9-4,4,8-g13-path28.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S10-4,4,8-g7-path21", "64S9-4,4,8-g13-path28" ];
