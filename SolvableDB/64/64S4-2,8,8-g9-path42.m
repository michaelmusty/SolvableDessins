...
s`SolvableDBName := "64S4-2,8,8-g9-path42";
s`SolvableDBFilename := "64S4-2,8,8-g9-path42.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 26, 27, 28, 29, 21, 22, 19, 23, 17, 30, 15, 16, 18, 31, 32, 11, 12, 13, 14, 20, 24, 25, 53, 54, 49, 52, 39, 55, 37, 46, 42, 41, 47, 48, 50, 40, 43, 44, 35, 45, 56, 36, 33, 34, 38, 51, 59, 61, 57, 64, 58, 63, 62, 60 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path8", "32S7-2,8,8-g5-path11", "64S4-2,8,8-g9-path42" ];
s`SolvableDBParents := [ Strings() | "128S4-4,8,8-g33-path167", "128S49-4,8,8-g33-path55", "128S51-4,8,8-g33-path55", "128S12-4,8,8-g33-path444", "128S46-2,16,16-g25-path73", "128S47-4,16,16-g41-path57", "128S53-2,16,16-g25-path11", "128S52-4,16,16-g41-path11", "128S52-2,16,16-g25-path11", "128S53-4,16,16-g41-path11", "128S47-2,16,16-g25-path57", "128S46-4,16,16-g41-path73", "128S50-2,8,8-g17-path33", "128S48-2,8,8-g17-path33", "128S2-2,8,8-g17-path89" ];
