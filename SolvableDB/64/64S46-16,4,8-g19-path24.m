...
s`SolvableDBName := "64S46-16,4,8-g19-path24";
s`SolvableDBFilename := "64S46-16,4,8-g19-path24.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T12-8,4,2-g2-path1", "32S13-8,4,4-g7-path4", "64S46-16,4,8-g19-path24" ];
