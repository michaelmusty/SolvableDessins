...
\[ 19, 5, 17, 22, 6, 9, 4, 16, 11, 21, 1, 10, 14, 3, 40, 24, 30, 15, 26, 46, 25, 12, 44, 13, 27, 2, 7, 20, 23, 8, 38, 31, 28, 33, 18, 35, 55, 36, 57, 32, 37, 39, 50, 34, 43, 29, 54, 47, 45, 48, 41, 51, 49, 53, 42, 62, 52, 56, 64, 59, 58, 60, 61, 63 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-2,8,8-g3-path4", "32S16-4,16,16-g11-path3", "64S51-8,32,32-g27-path15" ];
s`SolvableDBParents := [ Strings() | "128S153-8,32,32-g53-path114", "128S129-8,32,32-g53-path61", "128S131-8,32,32-g53-path114" ];
