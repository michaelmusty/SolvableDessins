...
s`SolvableDBName := "64S6-8,8,4-g17-path12-notcomputed";
s`SolvableDBFilename := "64S6-8,8,4-g17-path12-notcomputed.m";
...
\[ 49, 62, 53, 33, 29, 32, 54, 46, 57, 60, 50, 47, 61, 52, 64, 48, 63, 10, 9, 35, 37, 13, 12, 31, 55, 51, 25, 34, 40, 42, 59, 44, 43, 56, 58, 30, 45, 11, 15, 2, 17, 3, 7, 5, 16, 38, 19, 18, 23, 22, 39, 41, 27, 24, 36, 14, 1, 26, 4, 21, 8, 6, 28, 20 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T10-4,4,2-g1-path5-notcomputed", "32S9-8,4,2-g3-path3-notcomputed", "64S6-8,8,4-g17-path12-notcomputed" ];
