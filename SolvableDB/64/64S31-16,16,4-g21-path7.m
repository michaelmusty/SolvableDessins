...
s`SolvableDBName := "64S31-16,16,4-g21-path7";
s`SolvableDBFilename := "64S31-16,16,4-g21-path7.m";
...
\[ 6, 1, 22, 23, 20, 24, 8, 25, 2, 3, 4, 5, 7, 44, 14, 42, 49, 43, 27, 48, 35, 50, 45, 46, 17, 29, 16, 30, 10, 36, 9, 11, 12, 13, 15, 18, 19, 21, 26, 28, 55, 47, 62, 58, 41, 63, 57, 61, 59, 60, 32, 37, 31, 33, 34, 38, 39, 40, 51, 52, 53, 64, 54, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,2-g3-path5", "32S5-8,8,2-g5-path18", "64S31-16,16,4-g21-path7" ];
s`SolvableDBParents := [ Strings() | "128S111-16,16,4-g41-path540", "128S55-16,16,4-g41-path86", "128S47-16,16,4-g41-path40", "128S69-16,16,4-g41-path242", "128S61-16,16,4-g41-path118", "128S62-16,16,4-g41-path86", "128S70-16,16,4-g41-path178" ];
