...
s`SolvableDBName := "64S17-4,8,8-g17-path189";
s`SolvableDBFilename := "64S17-4,8,8-g17-path189.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 36, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 45, 17, 43, 30, 32, 37, 13, 14, 18, 21, 28, 29, 35, 41, 31, 42, 51, 56, 34, 46, 33, 49, 48, 50, 54, 55, 52, 38, 40, 44, 47, 53, 58, 61, 60, 62, 63, 64, 57, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-2,8,8-g3-path4", "32S5-2,8,8-g5-path12", "64S17-4,8,8-g17-path189" ];
s`SolvableDBParents := [ Strings() | "128S106-8,16,16-g49-path53", "128S108-4,16,16-g41-path53", "128S9-8,8,8-g41-path665", "128S111-4,16,16-g41-path105", "128S10-8,8,8-g41-path105", "128S110-8,16,16-g49-path105", "128S111-4,16,16-g41-path106", "128S10-8,8,8-g41-path106", "128S110-8,16,16-g49-path106", "128S109-8,16,16-g49-path53", "128S107-4,16,16-g41-path53", "128S7-8,8,8-g41-path53", "128S106-4,16,16-g41-path53", "128S5-8,8,8-g41-path53", "128S108-8,16,16-g49-path53", "128S111-8,16,16-g49-path105", "128S110-4,16,16-g41-path105", "128S15-8,8,8-g41-path105", "128S111-8,16,16-g49-path106", "128S110-4,16,16-g41-path106", "128S15-8,8,8-g41-path106", "128S109-4,16,16-g41-path53", "128S13-8,8,8-g41-path53", "128S107-8,16,16-g49-path53", "128S14-4,8,8-g33-path105", "128S14-4,8,8-g33-path106", "128S12-4,8,8-g33-path53", "128S8-4,8,8-g33-path53", "128S11-4,8,8-g33-path105", "128S11-4,8,8-g33-path106", "128S6-4,8,8-g33-path53" ];
s`SolvableDBChild := "32S5-2,8,8-g5-path12";
