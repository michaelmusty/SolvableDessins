...
s`SolvableDBName := "64S17-8,4,8-g17-path191";
s`SolvableDBFilename := "64S17-8,4,8-g17-path191.m";
...
[ 63, 49, 58, 40, 54, 55, 64, 50, 21, 46, 44, 62, 23, 47, 38, 51, 59, 34, 27, 57, 33, 30, 35, 53, 52, 31, 45, 48, 61, 43, 16, 19, 41, 6, 42, 56, 60, 25, 22, 20, 9, 13, 39, 2, 32, 12, 8, 29, 11, 14, 26, 15, 17, 1, 18, 37, 4, 7, 24, 36, 28, 10, 5, 3 ],
...
[ 41, 26, 45, 62, 21, 44, 19, 18, 24, 25, 16, 15, 5, 6, 48, 50, 23, 49, 60, 46, 53, 64, 54, 42, 61, 47, 36, 20, 4, 3, 8, 37, 17, 11, 1, 22, 43, 29, 7, 10, 59, 63, 58, 51, 56, 52, 55, 57, 31, 34, 14, 28, 13, 33, 2, 30, 12, 32, 35, 39, 40, 38, 9, 27 ],
...
\[ 47, 42, 61, 56, 50, 59, 48, 21, 18, 43, 23, 22, 16, 41, 64, 54, 44, 53, 57, 60, 34, 38, 51, 49, 58, 63, 4, 19, 45, 25, 5, 20, 6, 17, 26, 62, 46, 3, 15, 37, 55, 31, 52, 35, 40, 39, 9, 27, 13, 33, 1, 7, 11, 14, 24, 10, 36, 28, 2, 12, 32, 30, 8, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path2", "32S5-8,2,8-g5-path11", "64S17-8,4,8-g17-path191" ];
s`SolvableDBParents := [ Strings() | "128S9-8,8,8-g41-path923", "128S5-8,8,8-g41-path311", "128S15-8,8,8-g41-path621", "128S10-8,8,8-g41-path621", "128S15-8,8,8-g41-path622", "128S10-8,8,8-g41-path622", "128S7-8,8,8-g41-path311", "128S13-8,8,8-g41-path311", "128S106-16,4,16-g41-path84", "128S108-16,8,16-g49-path84", "128S108-16,4,16-g41-path84", "128S106-16,8,16-g49-path84", "128S111-16,4,16-g41-path167", "128S110-16,8,16-g49-path167", "128S110-16,4,16-g41-path167", "128S111-16,8,16-g49-path167", "128S111-16,4,16-g41-path168", "128S110-16,8,16-g49-path168", "128S110-16,4,16-g41-path168", "128S111-16,8,16-g49-path168", "128S109-16,4,16-g41-path84", "128S107-16,8,16-g49-path84", "128S107-16,4,16-g41-path84", "128S109-16,8,16-g49-path84", "128S8-8,4,8-g33-path84", "128S11-8,4,8-g33-path167", "128S14-8,4,8-g33-path167", "128S11-8,4,8-g33-path168", "128S14-8,4,8-g33-path168", "128S12-8,4,8-g33-path84", "128S6-8,4,8-g33-path84" ];
s`SolvableDBChild := "32S5-8,2,8-g5-path11";
