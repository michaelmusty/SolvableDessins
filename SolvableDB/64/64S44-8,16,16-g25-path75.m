...
s`SolvableDBName := "64S44-8,16,16-g25-path75";
s`SolvableDBFilename := "64S44-8,16,16-g25-path75.m";
...
\[ 50, 58, 15, 21, 34, 63, 30, 33, 22, 38, 44, 28, 27, 19, 35, 49, 5, 8, 3, 46, 36, 40, 47, 4, 43, 42, 45, 56, 41, 24, 7, 61, 26, 37, 52, 60, 6, 55, 32, 12, 14, 10, 54, 51, 11, 57, 13, 59, 62, 9, 23, 29, 25, 64, 18, 1, 16, 17, 20, 31, 53, 48, 2, 39 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-4,8,8-g5-path3", "32S17-8,16,16-g13-path11", "64S44-8,16,16-g25-path75" ];
s`SolvableDBParents := [ Strings() | "128S153-16,32,32-g57-path105", "128S153-16,32,32-g57-path106", "128S154-16,32,32-g57-path105", "128S154-16,32,32-g57-path106", "128S106-8,16,16-g49-path448", "128S102-8,16,16-g49-path335", "128S99-8,16,16-g49-path335" ];
