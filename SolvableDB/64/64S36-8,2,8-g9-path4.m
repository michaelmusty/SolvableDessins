...
s`SolvableDBName := "64S36-8,2,8-g9-path4";
s`SolvableDBFilename := "64S36-8,2,8-g9-path4.m";
...
[ 54, 51, 28, 12, 30, 37, 62, 18, 43, 57, 52, 4, 55, 19, 61, 21, 34, 8, 14, 47, 16, 46, 36, 48, 26, 25, 60, 3, 50, 5, 38, 56, 39, 17, 63, 23, 6, 31, 33, 45, 58, 64, 9, 59, 40, 22, 20, 24, 53, 29, 2, 11, 49, 1, 13, 32, 10, 41, 44, 27, 15, 7, 35, 42 ],
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S6-4,2,4-g1-path2", "64S36-8,2,8-g9-path4" ];
