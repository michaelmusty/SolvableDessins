...
s`SolvableDBName := "64S5-8,4,8-g17-path34";
s`SolvableDBFilename := "64S5-8,4,8-g17-path34.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T6-8,4,8-g5-path1", "32S5-8,4,8-g9-path19", "64S5-8,4,8-g17-path34" ];
