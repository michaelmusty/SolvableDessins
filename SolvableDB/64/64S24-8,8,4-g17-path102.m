...
s`SolvableDBName := "64S24-8,8,4-g17-path102";
s`SolvableDBFilename := "64S24-8,8,4-g17-path102.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S8-8,8,4-g9-path8", "64S24-8,8,4-g17-path102" ];
