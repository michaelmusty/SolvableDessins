...
s`SolvableDBName := "64S43-16,8,4-g19-path16";
s`SolvableDBFilename := "64S43-16,8,4-g19-path16.m";
...
\[ 6, 1, 22, 23, 20, 24, 8, 25, 2, 3, 4, 5, 7, 21, 28, 26, 11, 14, 43, 41, 40, 19, 39, 44, 45, 29, 16, 30, 46, 42, 9, 10, 12, 13, 15, 17, 18, 27, 59, 57, 56, 58, 55, 60, 61, 62, 31, 32, 33, 34, 35, 36, 37, 38, 54, 47, 63, 64, 50, 49, 52, 48, 51, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path1", "32S9-8,4,2-g3-path1", "64S43-16,8,4-g19-path16" ];
s`SolvableDBParents := [ Strings() | "128S66-16,8,4-g37-path41", "128S94-16,8,4-g37-path72", "128S82-16,8,4-g37-path41", "128S96-16,8,4-g37-path72", "128S82-16,8,4-g37-path42", "128S119-16,8,4-g37-path204", "128S66-16,8,4-g37-path42" ];
