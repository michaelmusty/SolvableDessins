...
s`SolvableDBName := "64S26-16,4,16-g21-path3-notcomputed";
s`SolvableDBFilename := "64S26-16,4,16-g21-path3-notcomputed.m";
...
\[ 55, 63, 54, 46, 53, 47, 56, 64, 58, 62, 61, 59, 45, 37, 48, 38, 39, 60, 49, 57, 50, 51, 40, 32, 29, 30, 31, 52, 44, 41, 42, 43, 22, 28, 19, 21, 35, 36, 33, 34, 12, 18, 20, 9, 25, 26, 27, 24, 2, 8, 11, 10, 14, 16, 17, 23, 3, 1, 7, 5, 13, 4, 6, 15 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,1,4-g0-path1-notcomputed", "8T1-8,1,8-g0-path1-notcomputed", "16T1-16,2,16-g4-path1-notcomputed", "32S16-16,2,16-g7-path2-notcomputed", "64S26-16,4,16-g21-path3-notcomputed" ];
