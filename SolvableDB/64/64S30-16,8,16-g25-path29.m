...
s`SolvableDBName := "64S30-16,8,16-g25-path29";
s`SolvableDBFilename := "64S30-16,8,16-g25-path29.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 62, 26, 55, 56, 50, 34, 33, 46, 37, 35, 15, 41, 64, 45, 43, 19, 60, 63, 14, 39, 10, 51, 57, 36, 9, 11, 12, 13, 16, 17, 18, 20, 21, 23, 25, 31, 32, 38, 61, 44, 53, 42, 52, 59, 47, 49, 48, 58, 54, 40 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path1", "32S5-8,4,8-g9-path2", "64S30-16,8,16-g25-path29" ];
s`SolvableDBParents := [ Strings() | "128S62-16,8,16-g49-path65", "128S62-16,8,16-g49-path66", "128S46-16,8,16-g49-path111", "128S54-16,8,16-g49-path111", "128S70-16,8,16-g49-path65", "128S70-16,8,16-g49-path66", "128S109-16,8,16-g49-path260" ];
