...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 61, 55, 51, 50, 41, 23, 33, 9, 62, 60, 45, 57, 53, 13, 12, 19, 59, 16, 47, 36, 10, 63, 58, 26, 11, 14, 15, 17, 18, 20, 21, 25, 31, 32, 34, 35, 37, 38, 43, 42, 44, 64, 49, 56, 46, 39, 40, 48, 52, 54 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T6-2,8,8-g3-path3", "32S12-4,8,8-g9-path19", "64S15-8,8,8-g21-path27" ];
s`SolvableDBParents := [ Strings() | "128S99-8,16,16-g49-path51", "128S101-16,16,16-g53-path101", "128S100-16,8,8-g45-path51", "128S99-8,16,16-g49-path52", "128S101-16,16,16-g53-path102", "128S100-16,8,8-g45-path52", "128S9-8,8,8-g41-path51" ];
