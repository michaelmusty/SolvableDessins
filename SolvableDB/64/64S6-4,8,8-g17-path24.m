...
s`SolvableDBName := "64S6-4,8,8-g17-path24";
s`SolvableDBFilename := "64S6-4,8,8-g17-path24.m";
...
\[ 12, 38, 44, 7, 2, 5, 37, 41, 22, 33, 13, 9, 27, 19, 14, 20, 59, 10, 28, 32, 29, 1, 30, 11, 31, 18, 24, 15, 25, 57, 21, 64, 26, 61, 62, 53, 39, 6, 4, 45, 40, 46, 56, 36, 8, 52, 50, 35, 51, 49, 47, 58, 3, 60, 23, 54, 55, 42, 34, 43, 17, 63, 48, 16 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path4", "32S5-4,8,8-g9-path4", "64S6-4,8,8-g17-path24" ];
s`SolvableDBParents := [ Strings() | "128S67-8,16,8-g45-path97", "128S67-8,16,8-g45-path98", "128S68-8,16,8-g45-path97", "128S68-8,16,8-g45-path98", "128S63-4,8,16-g37-path89", "128S61-8,16,16-g49-path439", "128S64-4,8,16-g37-path180", "128S61-8,16,16-g49-path440", "128S65-4,8,16-g37-path83", "128S62-8,16,16-g49-path375", "128S66-4,8,16-g37-path168", "128S62-8,16,16-g49-path376", "128S11-4,8,8-g33-path1224", "128S2-4,8,8-g33-path219", "128S3-4,8,8-g33-path690" ];
