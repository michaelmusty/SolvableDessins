...
s`SolvableDBName := "64S51-32,32,8-g27-path18";
s`SolvableDBFilename := "64S51-32,32,8-g27-path18.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 43, 45, 17, 49, 14, 21, 18, 22, 48, 32, 47, 44, 50, 19, 20, 23, 10, 42, 31, 9, 11, 12, 13, 27, 28, 29, 30, 60, 46, 64, 61, 63, 53, 56, 41, 55, 59, 38, 36, 33, 34, 35, 37, 39, 40, 51, 52, 62, 58, 57, 54 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T5-8,8,2-g3-path4", "32S16-16,16,4-g11-path5", "64S51-32,32,8-g27-path18" ];
s`SolvableDBParents := [ Strings() | "128S131-32,32,8-g53-path117", "128S129-32,32,8-g53-path64", "128S153-32,32,8-g53-path117" ];
