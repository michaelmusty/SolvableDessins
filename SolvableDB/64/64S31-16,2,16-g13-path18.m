...
s`SolvableDBName := "64S31-16,2,16-g13-path18";
s`SolvableDBFilename := "64S31-16,2,16-g13-path18.m";
...
\[ 6, 1, 19, 21, 17, 22, 16, 2, 3, 4, 5, 7, 33, 45, 43, 35, 41, 49, 42, 50, 48, 47, 28, 32, 24, 8, 9, 10, 11, 12, 13, 14, 15, 18, 20, 23, 25, 40, 38, 34, 62, 61, 44, 55, 46, 59, 64, 60, 58, 63, 39, 27, 26, 29, 30, 31, 36, 37, 51, 52, 57, 53, 56, 54 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T6-8,2,8-g3-path3", "32S5-8,2,8-g5-path23", "64S31-16,2,16-g13-path18" ];
s`SolvableDBParents := [ Strings() | "128S111-16,4,16-g41-path465", "128S55-16,4,16-g41-path11", "128S69-16,4,16-g41-path167", "128S70-16,4,16-g41-path103", "128S47-16,2,16-g25-path11", "128S61-16,2,16-g25-path89", "128S62-16,2,16-g25-path57" ];
