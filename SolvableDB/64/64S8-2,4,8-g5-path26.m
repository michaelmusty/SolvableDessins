...
s`SolvableDBName := "64S8-2,4,8-g5-path26";
s`SolvableDBFilename := "64S8-2,4,8-g5-path26.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T12-2,4,8-g2-path1", "32S9-2,4,8-g3-path12", "64S8-2,4,8-g5-path26" ];
