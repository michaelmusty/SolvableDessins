...
s`SolvableDBName := "64S8-8,2,4-g5-path22";
s`SolvableDBFilename := "64S8-8,2,4-g5-path22.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path7", "32S6-4,2,4-g1-path9", "64S8-8,2,4-g5-path22" ];
