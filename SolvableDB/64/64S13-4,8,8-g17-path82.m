...
s`SolvableDBName := "64S13-4,8,8-g17-path82";
s`SolvableDBFilename := "64S13-4,8,8-g17-path82.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 43, 34, 9, 33, 24, 25, 10, 26, 27, 15, 12, 20, 30, 17, 16, 18, 32, 28, 13, 14, 21, 29, 59, 46, 31, 50, 45, 44, 49, 48, 37, 39, 40, 42, 35, 36, 38, 41, 54, 64, 47, 63, 60, 61, 51, 62, 53, 56, 55, 52, 57, 58 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T12-2,8,4-g2-path2", "32S9-2,8,4-g3-path13", "64S13-4,8,8-g17-path82" ];
s`SolvableDBParents := [ Strings() | "128S96-4,16,8-g37-path19", "128S95-4,16,8-g37-path37", "128S97-4,16,8-g37-path19", "128S95-4,16,8-g37-path38", "128S3-4,8,8-g33-path219", "128S28-4,8,8-g33-path89", "128S3-4,8,8-g33-path220" ];
