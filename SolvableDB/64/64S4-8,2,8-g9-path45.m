...
s`SolvableDBName := "64S4-8,2,8-g9-path45";
s`SolvableDBFilename := "64S4-8,2,8-g9-path45.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 48, 47, 23, 20, 46, 41, 49, 50, 40, 35, 42, 8, 9, 10, 11, 12, 13, 14, 24, 25, 43, 44, 33, 45, 31, 63, 51, 30, 38, 56, 59, 62, 58, 36, 61, 54, 52, 57, 27, 26, 28, 29, 32, 34, 37, 39, 53, 64, 60, 55 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path5", "32S7-8,2,8-g5-path5", "64S4-8,2,8-g9-path45" ];
s`SolvableDBParents := [ Strings() | "128S4-8,4,8-g33-path162", "128S49-8,4,8-g33-path50", "128S51-8,4,8-g33-path50", "128S12-8,4,8-g33-path439", "128S46-16,2,16-g25-path68", "128S47-16,4,16-g41-path52", "128S53-16,2,16-g25-path6", "128S52-16,4,16-g41-path6", "128S52-16,2,16-g25-path6", "128S53-16,4,16-g41-path6", "128S47-16,2,16-g25-path52", "128S46-16,4,16-g41-path68", "128S50-8,2,8-g17-path28", "128S48-8,2,8-g17-path28", "128S2-8,2,8-g17-path84" ];
