...
s`SolvableDBName := "64S7-8,8,4-g17-path123";
s`SolvableDBFilename := "64S7-8,8,4-g17-path123.m";
...
\[ 6, 1, 22, 23, 21, 24, 4, 25, 2, 3, 5, 7, 8, 43, 42, 44, 49, 14, 10, 35, 47, 50, 17, 46, 45, 19, 16, 20, 27, 36, 9, 11, 12, 13, 15, 18, 26, 28, 29, 30, 59, 63, 64, 48, 41, 53, 62, 60, 55, 56, 34, 39, 31, 32, 33, 37, 38, 40, 51, 52, 54, 61, 57, 58 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,2-g3-path6", "32S5-8,8,2-g5-path15", "64S7-8,8,4-g17-path123" ];
s`SolvableDBParents := [ Strings() | "128S69-16,16,4-g41-path395", "128S69-16,16,4-g41-path396", "128S70-16,16,4-g41-path331", "128S70-16,16,4-g41-path332", "128S11-8,8,4-g33-path1389", "128S3-8,8,4-g33-path855", "128S4-8,8,4-g33-path405" ];
