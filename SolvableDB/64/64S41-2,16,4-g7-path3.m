...
I<[x]> := ideal< P | [
x[2]^2*x[3]^6 - x[3]^6 + x[1]^5,
x[1]^6 + x[2]^2*x[3]^4 - x[3]^4,
x[1]*x[3]^2 - 1
] >;
...
s`SolvableDBName := "64S41-2,16,4-g7-path3";
s`SolvableDBFilename := "64S41-2,16,4-g7-path3.m";
...
s`SolvableDBParents := [ Strings() | "128S118-4,16,4-g29-path13", "128S92-2,16,8-g21-path5", "128S95-4,16,8-g37-path9", "128S80-4,16,4-g29-path13", "128S65-2,16,8-g21-path1", "128S66-4,16,8-g37-path1", "128S79-2,16,4-g13-path4" ];
