...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 43, 34, 9, 33, 24, 25, 10, 26, 27, 15, 12, 20, 30, 17, 16, 18, 32, 28, 13, 14, 21, 29, 59, 46, 31, 50, 45, 44, 49, 48, 37, 39, 40, 42, 35, 36, 38, 41, 57, 64, 47, 51, 60, 61, 62, 63, 53, 56, 55, 54, 52, 58 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path7", "32S9-2,8,4-g3-path10", "64S43-4,16,8-g19-path12" ];
s`SolvableDBParents := [ Strings() | "128S66-4,16,8-g37-path45", "128S94-4,16,8-g37-path74", "128S82-4,16,8-g37-path45", "128S96-4,16,8-g37-path74", "128S82-4,16,8-g37-path46", "128S119-4,16,8-g37-path206", "128S66-4,16,8-g37-path46" ];
