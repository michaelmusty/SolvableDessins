...
s`SolvableDBName := "64S4-4,8,8-g17-path33";
s`SolvableDBFilename := "64S4-4,8,8-g17-path33.m";
...
\[ 6, 1, 26, 27, 23, 9, 4, 28, 2, 3, 5, 7, 8, 50, 44, 54, 13, 64, 31, 51, 60, 29, 36, 21, 61, 33, 12, 17, 19, 20, 22, 18, 10, 38, 56, 11, 14, 15, 16, 24, 25, 30, 32, 34, 35, 47, 62, 55, 41, 53, 42, 45, 37, 63, 59, 52, 46, 48, 58, 40, 49, 57, 39, 43 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S6-4,4,4-g5-path8", "64S4-4,8,8-g17-path33" ];
s`SolvableDBParents := [ Strings() | "128S46-8,16,16-g49-path203", "128S46-8,16,16-g49-path204", "128S53-8,16,16-g49-path79", "128S53-8,16,16-g49-path80", "128S47-8,16,16-g49-path171", "128S47-8,16,16-g49-path172", "128S52-8,16,16-g49-path79", "128S52-8,16,16-g49-path80", "128S12-4,8,8-g33-path518", "128S50-4,8,8-g33-path62", "128S51-4,8,8-g33-path129", "128S2-4,8,8-g33-path118", "128S4-4,8,8-g33-path241", "128S48-4,8,8-g33-path62", "128S49-4,8,8-g33-path129" ];
