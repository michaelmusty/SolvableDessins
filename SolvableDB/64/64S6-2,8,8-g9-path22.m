...
s`SolvableDBName := "64S6-2,8,8-g9-path22";
s`SolvableDBFilename := "64S6-2,8,8-g9-path22.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 14, 26, 27, 11, 21, 22, 19, 23, 17, 28, 15, 16, 18, 29, 30, 12, 13, 20, 24, 25, 38, 37, 39, 41, 52, 53, 32, 31, 33, 47, 34, 49, 50, 48, 46, 45, 40, 44, 42, 43, 54, 35, 36, 51, 57, 61, 55, 59, 58, 62, 56, 60, 64, 63 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path7", "32S11-2,8,4-g3-path10", "64S6-2,8,8-g9-path22" ];
s`SolvableDBParents := [ Strings() | "128S11-4,8,8-g33-path1106", "128S3-4,8,8-g33-path572", "128S67-2,16,8-g21-path43", "128S67-4,16,8-g37-path43", "128S68-2,16,8-g21-path43", "128S68-4,16,8-g37-path43", "128S63-2,8,16-g21-path83", "128S64-4,8,16-g37-path123", "128S65-2,8,16-g21-path77", "128S66-4,8,16-g37-path111", "128S61-2,16,16-g25-path204", "128S61-4,16,16-g41-path204", "128S62-2,16,16-g25-path172", "128S62-4,16,16-g41-path172", "128S2-2,8,8-g17-path203" ];
