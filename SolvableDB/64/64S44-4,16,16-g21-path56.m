...
s`SolvableDBName := "64S44-4,16,16-g21-path56";
s`SolvableDBFilename := "64S44-4,16,16-g21-path56.m";
...
\[ 11, 32, 14, 7, 2, 5, 26, 29, 19, 12, 9, 25, 17, 13, 18, 8, 3, 35, 1, 27, 10, 4, 28, 16, 21, 22, 33, 45, 24, 31, 39, 6, 34, 20, 36, 15, 41, 30, 38, 42, 51, 54, 46, 23, 44, 49, 48, 50, 53, 62, 52, 37, 43, 55, 40, 57, 60, 59, 61, 63, 64, 47, 56, 58 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T5-2,8,8-g3-path1", "32S16-4,16,16-g11-path5", "64S44-4,16,16-g21-path56" ];
s`SolvableDBParents := [ Strings() | "128S153-8,32,32-g53-path63", "128S154-4,32,32-g45-path63", "128S102-8,16,16-g49-path272", "128S153-8,32,32-g53-path64", "128S154-4,32,32-g45-path64", "128S99-8,16,16-g49-path272", "128S106-4,16,16-g41-path463" ];
