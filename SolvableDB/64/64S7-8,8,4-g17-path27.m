...
s`SolvableDBName := "64S7-8,8,4-g17-path27";
s`SolvableDBFilename := "64S7-8,8,4-g17-path27.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T12-2,8,4-g2-path3", "32S10-4,8,4-g7-path25", "64S7-8,8,4-g17-path27" ];
