...
s`SolvableDBName := "64S50-2,32,32-g15-path3";
s`SolvableDBFilename := "64S50-2,32,32-g15-path3.m";
...
\[ 2, 1, 7, 6, 8, 4, 3, 5, 11, 16, 9, 14, 15, 12, 13, 10, 19, 20, 17, 18, 23, 24, 21, 22, 27, 28, 25, 26, 31, 32, 29, 30, 35, 36, 33, 34, 39, 40, 37, 38, 43, 44, 41, 42, 47, 48, 45, 46, 51, 52, 49, 50, 55, 56, 53, 54, 59, 60, 57, 58, 63, 64, 61, 62 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-2,8,8-g3-path6", "32S16-2,16,16-g7-path9", "64S50-2,32,32-g15-path3" ];
s`SolvableDBParents := [ Strings() | "128S128-4,32,32-g45-path49", "128S159-2,64,64-g31-path4", "128S159-4,64,64-g47-path4", "128S153-4,32,32-g45-path80", "128S160-2,64,64-g31-path2", "128S160-4,64,64-g47-path2", "128S131-2,32,32-g29-path41" ];
