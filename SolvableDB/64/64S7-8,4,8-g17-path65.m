...
s`SolvableDBName := "64S7-8,4,8-g17-path65";
s`SolvableDBFilename := "64S7-8,4,8-g17-path65.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S10-8,4,4-g7-path8", "64S7-8,4,8-g17-path65" ];
