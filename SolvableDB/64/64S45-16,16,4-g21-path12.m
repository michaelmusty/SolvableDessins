...
s`SolvableDBName := "64S45-16,16,4-g21-path12";
s`SolvableDBFilename := "64S45-16,16,4-g21-path12.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 44, 12, 62, 13, 21, 9, 47, 34, 36, 60, 39, 63, 11, 50, 26, 31, 49, 54, 61, 59, 43, 64, 42, 10, 14, 15, 16, 17, 18, 19, 20, 23, 25, 32, 33, 35, 37, 51, 56, 52, 40, 57, 48, 38, 45, 58, 55, 46, 41, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,4-g5-path5", "32S12-8,8,4-g9-path13", "64S45-16,16,4-g21-path12" ];
s`SolvableDBParents := [ Strings() | "128S102-16,16,8-g49-path371", "128S99-16,16,8-g49-path371", "128S108-16,16,4-g41-path238" ];
