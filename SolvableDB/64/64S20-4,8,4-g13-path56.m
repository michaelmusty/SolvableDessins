...
s`SolvableDBName := "64S20-4,8,4-g13-path56";
s`SolvableDBFilename := "64S20-4,8,4-g13-path56.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S2-4,4,4-g5-path14", "64S20-4,8,4-g13-path56" ];
s`SolvableDBChildren := [ Strings() | "32S2-4,4,4-g5-path14" ];
