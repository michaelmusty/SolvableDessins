...
\[ 6, 1, 20, 21, 18, 22, 4, 2, 3, 5, 7, 37, 23, 32, 40, 38, 41, 39, 16, 15, 34, 42, 17, 8, 9, 10, 11, 12, 13, 14, 19, 36, 28, 56, 57, 54, 35, 52, 55, 51, 53, 58, 24, 25, 26, 27, 29, 30, 31, 33, 62, 60, 64, 59, 43, 63, 61, 45, 44, 46, 47, 48, 49, 50 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T13-8,2,2-g0-path3", "32S9-8,4,2-g3-path17", "64S42-16,8,2-g11-path1" ];
s`SolvableDBParents := [ Strings() | "128S81-16,8,4-g37-path26", "128S119-16,8,4-g37-path192", "128S65-16,8,4-g37-path26", "128S97-16,8,4-g37-path77", "128S81-16,8,2-g21-path26", "128S93-16,8,2-g21-path77", "128S65-16,8,2-g21-path26" ];
