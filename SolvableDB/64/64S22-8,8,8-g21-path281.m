...
s`SolvableDBName := "64S22-8,8,8-g21-path281";
s`SolvableDBFilename := "64S22-8,8,8-g21-path281.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path32", "32S2-4,4,4-g5-path74", "64S22-8,8,8-g21-path281" ];
