...
s`SolvableDBName := "64S2-8,8,8-g21-path27";
s`SolvableDBFilename := "64S2-8,8,8-g21-path27.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 35, 28, 30, 13, 41, 27, 29, 17, 9, 18, 14, 10, 20, 16, 11, 12, 22, 23, 25, 26, 52, 32, 46, 33, 34, 36, 59, 31, 45, 39, 40, 42, 43, 37, 44, 38, 47, 48, 64, 56, 51, 50, 53, 54, 55, 57, 63, 58, 49, 60, 61, 62 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path5", "32S3-4,8,8-g9-path23", "64S2-8,8,8-g21-path27" ];
s`SolvableDBParents := [ Strings() | "128S42-8,16,16-g49-path105", "128S43-8,16,16-g49-path97", "128S42-16,8,16-g49-path105", "128S43-16,8,16-g49-path97", "128S42-16,16,8-g49-path105", "128S43-16,16,8-g49-path97", "128S5-8,8,8-g41-path692" ];
