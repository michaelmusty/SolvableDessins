...
s`SolvableDBName := "64S44-16,4,16-g21-path42";
s`SolvableDBFilename := "64S44-16,4,16-g21-path42.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,2,8-g3-path5", "32S12-8,4,8-g9-path5", "64S44-16,4,16-g21-path42" ];
