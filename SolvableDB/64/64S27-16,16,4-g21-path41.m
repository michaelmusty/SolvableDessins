...
s`SolvableDBName := "64S27-16,16,4-g21-path41";
s`SolvableDBFilename := "64S27-16,16,4-g21-path41.m";
...
\[ 54, 61, 35, 37, 32, 33, 57, 52, 50, 56, 53, 41, 60, 28, 9, 40, 30, 38, 55, 39, 34, 12, 59, 13, 27, 11, 62, 58, 43, 64, 29, 26, 63, 48, 49, 51, 44, 46, 14, 47, 21, 23, 20, 7, 2, 36, 8, 19, 10, 5, 42, 24, 6, 45, 25, 17, 22, 18, 31, 3, 15, 4, 1, 16 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T4-4,4,4-g3-path9", "32S3-8,8,4-g9-path15", "64S27-16,16,4-g21-path41" ];
s`SolvableDBParents := [ Strings() | "128S44-16,16,8-g49-path117", "128S130-32,32,4-g45-path45", "128S130-32,32,8-g53-path45", "128S43-16,16,8-g49-path23", "128S130-32,32,4-g45-path46", "128S130-32,32,8-g53-path46", "128S106-16,16,4-g41-path297" ];
