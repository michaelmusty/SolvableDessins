...
s`SolvableDBName := "64S42-2,16,8-g11-path12";
s`SolvableDBFilename := "64S42-2,16,8-g11-path12.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S9-2,8,4-g3-path4", "64S42-2,16,8-g11-path12" ];
