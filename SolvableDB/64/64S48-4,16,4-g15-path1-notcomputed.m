...
s`SolvableDBName := "64S48-4,16,4-g15-path1-notcomputed";
s`SolvableDBFilename := "64S48-4,16,4-g15-path1-notcomputed.m";
...
\[ 19, 5, 27, 13, 6, 20, 4, 11, 12, 17, 21, 1, 14, 7, 45, 32, 24, 28, 9, 2, 25, 26, 34, 29, 8, 3, 22, 23, 10, 33, 37, 30, 16, 18, 61, 49, 43, 48, 44, 50, 31, 46, 41, 15, 39, 36, 53, 40, 42, 38, 52, 63, 59, 62, 60, 64, 47, 51, 57, 35, 55, 56, 58, 54 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T4-2,4,2-g0-path2-notcomputed", "16T13-2,8,2-g0-path1-notcomputed", "32S14-4,8,4-g7-path1-notcomputed", "64S48-4,16,4-g15-path1-notcomputed" ];
