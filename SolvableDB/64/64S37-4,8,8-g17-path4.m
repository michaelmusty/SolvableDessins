...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 21, 36, 9, 51, 24, 25, 10, 26, 27, 15, 12, 20, 30, 17, 31, 52, 32, 34, 13, 14, 16, 18, 28, 29, 35, 33, 50, 55, 40, 60, 57, 41, 49, 45, 53, 46, 48, 43, 38, 37, 56, 42, 44, 58, 39, 47, 54, 59, 62, 63, 64, 61 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path7", "32S6-2,4,4-g1-path10", "64S37-4,8,8-g17-path4" ];
s`SolvableDBParents := [ Strings() | "128S86-4,8,8-g33-path65", "128S86-4,8,8-g33-path66", "128S51-4,8,8-g33-path33", "128S57-4,8,8-g33-path33", "128S78-4,8,8-g33-path65", "128S78-4,8,8-g33-path66", "128S126-4,8,8-g33-path239" ];
