...
s`SolvableDBName := "64S15-8,8,8-g21-path208";
s`SolvableDBFilename := "64S15-8,8,8-g21-path208.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T12-8,2,4-g2-path1", "32S13-8,4,4-g7-path1", "64S15-8,8,8-g21-path208" ];
