...
s`SolvableDBName := "64S48-16,4,4-g15-path23";
s`SolvableDBFilename := "64S48-16,4,4-g15-path23.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T13-8,2,2-g0-path3", "32S19-16,4,2-g4-path3", "64S48-16,4,4-g15-path23" ];
s`SolvableDBChildren := [ Strings() | "32S19-16,4,2-g4-path3" ];
