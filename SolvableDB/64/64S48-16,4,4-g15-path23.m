...
\[ 6, 1, 22, 23, 21, 24, 4, 25, 2, 3, 5, 7, 8, 20, 38, 26, 13, 14, 43, 42, 41, 28, 39, 44, 45, 19, 16, 46, 40, 9, 10, 11, 12, 15, 17, 18, 27, 29, 59, 57, 58, 56, 55, 60, 61, 62, 30, 31, 32, 33, 34, 35, 36, 37, 50, 63, 47, 64, 54, 51, 48, 52, 49, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T13-8,2,2-g0-path1", "32S19-16,4,2-g4-path2", "64S48-16,4,4-g15-path23" ];
s`SolvableDBParents := [ Strings() | "128S158-32,8,4-g39-path23", "128S158-32,4,8-g39-path23", "128S104-16,8,8-g45-path125", "128S158-32,8,4-g39-path24", "128S158-32,4,8-g39-path24", "128S104-16,8,8-g45-path126", "128S112-16,4,4-g29-path310" ];
