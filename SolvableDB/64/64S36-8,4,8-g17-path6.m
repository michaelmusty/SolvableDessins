...
s`SolvableDBName := "64S36-8,4,8-g17-path6";
s`SolvableDBFilename := "64S36-8,4,8-g17-path6.m";
...
\[ 6, 1, 26, 27, 22, 28, 24, 29, 2, 3, 4, 5, 7, 8, 61, 57, 62, 60, 46, 16, 19, 9, 51, 49, 42, 63, 13, 12, 32, 58, 35, 39, 40, 64, 34, 10, 11, 14, 15, 17, 18, 20, 21, 23, 25, 30, 31, 33, 37, 59, 47, 45, 56, 48, 52, 43, 55, 53, 54, 36, 38, 50, 41, 44 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S6-4,4,4-g5-path15", "64S36-8,4,8-g17-path6" ];
s`SolvableDBParents := [ Strings() | "128S126-8,4,8-g33-path228", "128S77-8,4,8-g33-path43", "128S85-8,4,8-g33-path87", "128S77-8,4,8-g33-path44", "128S85-8,4,8-g33-path88", "128S50-8,4,8-g33-path22", "128S56-8,4,8-g33-path44" ];
