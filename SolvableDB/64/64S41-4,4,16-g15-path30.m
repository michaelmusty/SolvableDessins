...
s`SolvableDBName := "64S41-4,4,16-g15-path30";
s`SolvableDBFilename := "64S41-4,4,16-g15-path30.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S9-4,2,8-g3-path5", "64S41-4,4,16-g15-path30" ];
