...
s`SolvableDBName := "64S44-16,16,4-g21-path52";
s`SolvableDBFilename := "64S44-16,16,4-g21-path52.m";
...
\[ 6, 1, 17, 3, 14, 13, 4, 15, 2, 5, 7, 8, 25, 24, 16, 27, 23, 12, 9, 10, 11, 18, 35, 26, 33, 36, 34, 20, 19, 21, 22, 28, 42, 44, 41, 43, 29, 30, 31, 32, 51, 49, 52, 50, 37, 38, 39, 40, 58, 60, 57, 59, 45, 46, 47, 48, 62, 61, 64, 63, 53, 54, 55, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,2-g3-path7", "32S16-16,16,2-g7-path4", "64S44-16,16,4-g21-path52" ];
s`SolvableDBParents := [ Strings() | "128S102-16,16,8-g49-path245", "128S153-32,32,4-g45-path43", "128S154-32,32,8-g53-path43", "128S153-32,32,4-g45-path44", "128S154-32,32,8-g53-path44", "128S99-16,16,8-g49-path245", "128S106-16,16,4-g41-path436" ];
