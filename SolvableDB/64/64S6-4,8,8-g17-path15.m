...
s`SolvableDBName := "64S6-4,8,8-g17-path15";
s`SolvableDBFilename := "64S6-4,8,8-g17-path15.m";
...
\[ 6, 1, 26, 27, 23, 9, 4, 28, 2, 3, 5, 7, 8, 42, 43, 57, 13, 14, 31, 52, 58, 29, 36, 21, 59, 33, 12, 17, 19, 20, 22, 18, 10, 37, 54, 11, 15, 16, 24, 25, 30, 32, 34, 35, 64, 56, 61, 46, 48, 40, 45, 41, 44, 53, 60, 49, 63, 39, 50, 47, 55, 51, 38, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path10", "32S11-4,8,4-g7-path7", "64S6-4,8,8-g17-path15" ];
s`SolvableDBParents := [ Strings() | "128S67-8,16,8-g45-path85", "128S67-8,16,8-g45-path86", "128S68-8,16,8-g45-path85", "128S68-8,16,8-g45-path86", "128S63-4,8,16-g37-path83", "128S61-8,16,16-g49-path407", "128S64-4,8,16-g37-path174", "128S61-8,16,16-g49-path408", "128S65-4,8,16-g37-path77", "128S62-8,16,16-g49-path343", "128S66-4,8,16-g37-path162", "128S62-8,16,16-g49-path344", "128S11-4,8,8-g33-path1208", "128S2-4,8,8-g33-path203", "128S3-4,8,8-g33-path674" ];
