...
\[ 38, 50, 21, 40, 23, 9, 59, 55, 53, 25, 14, 16, 56, 24, 48, 4, 13, 5, 52, 35, 54, 31, 44, 39, 27, 19, 34, 12, 2, 41, 60, 37, 46, 45, 63, 64, 57, 29, 18, 43, 58, 61, 7, 11, 3, 26, 49, 62, 20, 6, 36, 22, 1, 10, 17, 30, 47, 8, 28, 33, 51, 42, 32, 15 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,2,4-g1-path1-notcomputed", "8T2-4,2,4-g1-path2-notcomputed", "16T10-4,2,4-g1-path3-notcomputed", "32S5-8,4,8-g9-path1-notcomputed", "64S17-8,4,8-g17-path20-notcomputed" ];
