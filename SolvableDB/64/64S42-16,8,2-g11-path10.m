...
\[ 6, 1, 20, 21, 18, 22, 4, 2, 3, 5, 7, 37, 23, 32, 40, 38, 41, 39, 16, 15, 34, 42, 17, 8, 9, 10, 11, 12, 13, 14, 19, 36, 28, 56, 57, 54, 35, 52, 55, 51, 53, 58, 24, 25, 26, 27, 29, 30, 31, 33, 62, 60, 64, 59, 43, 63, 61, 45, 44, 46, 47, 48, 49, 50 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path2", "32S9-8,4,2-g3-path8", "64S42-16,8,2-g11-path10" ];
s`SolvableDBParents := [ Strings() | "128S81-16,8,4-g37-path27", "128S119-16,8,4-g37-path193", "128S65-16,8,4-g37-path27", "128S97-16,8,4-g37-path78", "128S81-16,8,2-g21-path27", "128S93-16,8,2-g21-path78", "128S65-16,8,2-g21-path27" ];
