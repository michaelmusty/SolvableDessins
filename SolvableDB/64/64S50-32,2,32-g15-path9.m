...
s`SolvableDBName := "64S50-32,2,32-g15-path9";
s`SolvableDBFilename := "64S50-32,2,32-g15-path9.m";
...
\[ 58, 61, 60, 52, 49, 50, 63, 55, 57, 53, 51, 42, 43, 44, 41, 59, 45, 64, 47, 62, 36, 33, 34, 35, 39, 54, 37, 56, 26, 27, 28, 25, 29, 48, 31, 46, 20, 17, 18, 19, 23, 38, 21, 40, 9, 10, 16, 8, 12, 32, 14, 30, 11, 2, 5, 7, 6, 22, 4, 24, 15, 3, 13, 1 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,2,8-g3-path3", "32S16-16,2,16-g7-path8", "64S50-32,2,32-g15-path9" ];
s`SolvableDBParents := [ Strings() | "128S128-32,4,32-g45-path56", "128S160-64,2,64-g31-path9", "128S160-64,4,64-g47-path9", "128S159-64,2,64-g31-path11", "128S159-64,4,64-g47-path11", "128S153-32,4,32-g45-path87", "128S131-32,2,32-g29-path48" ];
