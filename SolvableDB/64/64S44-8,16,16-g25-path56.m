...
s`SolvableDBName := "64S44-8,16,16-g25-path56";
s`SolvableDBFilename := "64S44-8,16,16-g25-path56.m";
...
\[ 29, 47, 36, 31, 48, 9, 49, 50, 45, 53, 62, 61, 58, 46, 30, 32, 13, 54, 51, 34, 26, 52, 28, 12, 2, 59, 63, 60, 25, 56, 42, 43, 64, 44, 57, 41, 35, 33, 11, 27, 10, 7, 8, 19, 1, 55, 6, 39, 24, 17, 21, 40, 23, 38, 18, 5, 22, 16, 20, 3, 4, 15, 37, 14 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path2", "32S16-8,16,16-g13-path17", "64S44-8,16,16-g25-path56" ];
s`SolvableDBParents := [ Strings() | "128S153-16,32,32-g57-path65", "128S153-16,32,32-g57-path66", "128S154-16,32,32-g57-path65", "128S154-16,32,32-g57-path66", "128S106-8,16,16-g49-path428", "128S102-8,16,16-g49-path315", "128S99-8,16,16-g49-path315" ];
