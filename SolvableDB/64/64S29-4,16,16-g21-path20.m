...
s`SolvableDBName := "64S29-4,16,16-g21-path20";
s`SolvableDBFilename := "64S29-4,16,16-g21-path20.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 36, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 45, 17, 43, 30, 32, 37, 13, 14, 18, 21, 28, 29, 35, 41, 31, 42, 51, 56, 34, 46, 33, 49, 48, 50, 54, 55, 52, 38, 40, 44, 47, 53, 58, 61, 60, 62, 63, 64, 57, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-2,8,8-g3-path6", "32S5-2,8,8-g5-path18", "64S29-4,16,16-g21-path20" ];
s`SolvableDBParents := [ Strings() | "128S131-8,32,32-g53-path39", "128S133-8,32,32-g53-path77", "128S133-8,32,32-g53-path78", "128S132-8,32,32-g53-path39", "128S131-8,32,32-g53-path40", "128S133-8,32,32-g53-path79", "128S133-8,32,32-g53-path80", "128S132-8,32,32-g53-path40", "128S69-4,16,16-g41-path117", "128S61-4,16,16-g41-path39", "128S54-4,16,16-g41-path59", "128S106-4,16,16-g41-path376", "128S61-4,16,16-g41-path40", "128S69-4,16,16-g41-path118", "128S46-4,16,16-g41-path20" ];
