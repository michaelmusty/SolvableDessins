...
s`SolvableDBName := "64S6-2,8,8-g9-path7";
s`SolvableDBFilename := "64S6-2,8,8-g9-path7.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 26, 27, 28, 29, 21, 22, 19, 23, 17, 30, 15, 16, 18, 25, 24, 11, 12, 13, 14, 20, 52, 39, 48, 53, 54, 43, 51, 50, 32, 42, 45, 40, 36, 49, 41, 47, 46, 33, 44, 38, 37, 31, 34, 35, 63, 64, 58, 57, 60, 59, 62, 61, 55, 56 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S11-2,4,8-g3-path8", "64S6-2,8,8-g9-path7" ];
s`SolvableDBParents := [ Strings() | "128S67-4,8,16-g37-path46", "128S68-4,8,16-g37-path46", "128S63-2,16,8-g21-path86", "128S61-4,16,16-g41-path220", "128S65-2,16,8-g21-path80", "128S62-4,16,16-g41-path188", "128S67-2,8,16-g21-path46", "128S11-4,8,8-g33-path1122", "128S68-2,8,16-g21-path46", "128S3-4,8,8-g33-path588", "128S61-2,16,16-g25-path220", "128S64-4,16,8-g37-path126", "128S62-2,16,16-g25-path188", "128S66-4,16,8-g37-path114", "128S2-2,8,8-g17-path219" ];
