...
s`SolvableDBName := "64S9-8,4,4-g13-path56";
s`SolvableDBFilename := "64S9-8,4,4-g13-path56.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T14-8,4,4-g4-path3", "32S10-8,4,4-g7-path34", "64S9-8,4,4-g13-path56" ];
s`SolvableDBChildren := [ Strings() | "32S10-8,4,4-g7-path34" ];
