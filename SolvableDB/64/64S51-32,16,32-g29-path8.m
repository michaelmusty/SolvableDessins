...
s`SolvableDBName := "64S51-32,16,32-g29-path8";
s`SolvableDBFilename := "64S51-32,16,32-g29-path8.m";
...
\[ 6, 1, 23, 24, 15, 25, 4, 16, 2, 3, 5, 7, 8, 37, 30, 17, 42, 14, 21, 11, 13, 9, 40, 10, 18, 19, 20, 22, 36, 29, 12, 26, 27, 28, 55, 39, 56, 52, 58, 41, 35, 38, 31, 33, 32, 43, 34, 44, 45, 46, 61, 53, 63, 51, 64, 54, 62, 57, 47, 49, 48, 59, 50, 60 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,4,8-g5-path4", "32S16-16,8,16-g13-path13", "64S51-32,16,32-g29-path8" ];
s`SolvableDBParents := [ Strings() | "128S129-32,16,32-g57-path107", "128S131-32,16,32-g57-path213", "128S153-32,16,32-g57-path213" ];
