...
s`SolvableDBName := "64S8-2,8,4-g5-path18";
s`SolvableDBFilename := "64S8-2,8,4-g5-path18.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S6-2,4,4-g1-path5", "64S8-2,8,4-g5-path18" ];
