...
s`SolvableDBName := "64S24-8,4,8-g17-path22";
s`SolvableDBFilename := "64S24-8,4,8-g17-path22.m";
...
[ 44, 28, 58, 46, 12, 25, 59, 9, 4, 54, 39, 37, 24, 41, 47, 36, 5, 34, 18, 17, 57, 60, 16, 7, 35, 29, 40, 32, 21, 2, 43, 42, 50, 15, 13, 22, 55, 53, 49, 63, 48, 11, 27, 20, 6, 26, 56, 33, 30, 10, 31, 23, 19, 64, 1, 38, 8, 52, 45, 3, 62, 51, 61, 14 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path5", "32S2-4,4,4-g5-path29", "64S24-8,4,8-g17-path22" ];
