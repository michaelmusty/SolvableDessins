...
s`SolvableDBName := "64S24-4,8,8-g17-path87";
s`SolvableDBFilename := "64S24-4,8,8-g17-path87.m";
...
[ 9, 15, 25, 45, 22, 3, 46, 13, 18, 50, 31, 40, 4, 23, 28, 38, 6, 41, 49, 2, 59, 34, 51, 5, 42, 1, 56, 55, 11, 26, 10, 8, 60, 43, 12, 20, 24, 14, 30, 19, 61, 62, 64, 37, 47, 52, 27, 17, 58, 54, 7, 16, 48, 21, 63, 32, 36, 33, 29, 35, 39, 53, 57, 44 ],
[ 36, 37, 60, 53, 48, 30, 44, 17, 38, 39, 26, 20, 50, 27, 56, 32, 12, 63, 57, 8, 35, 59, 24, 11, 61, 23, 29, 64, 33, 2, 49, 21, 14, 62, 16, 5, 6, 22, 7, 46, 52, 58, 54, 10, 31, 13, 42, 1, 51, 40, 45, 43, 19, 41, 47, 3, 4, 55, 9, 15, 28, 18, 34, 25 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S7-2,8,8-g5-path4", "64S24-4,8,8-g17-path87" ];
s`SolvableDBChildren := [ Strings() | "32S7-2,8,8-g5-path4" ];
