...
\[ 32, 29, 33, 13, 62, 20, 39, 7, 6, 46, 53, 28, 12, 52, 44, 56, 61, 41, 47, 2, 45, 10, 48, 57, 55, 25, 22, 8, 35, 4, 58, 9, 37, 31, 1, 14, 27, 24, 30, 51, 59, 19, 21, 50, 17, 64, 16, 40, 18, 49, 36, 54, 63, 23, 43, 34, 11, 42, 60, 15, 26, 38, 5, 3 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S11-8,4,4-g7-path18", "64S9-8,4,4-g13-path93" ];
s`SolvableDBParents := [ Strings() | "128S3-8,8,4-g33-path1137", "128S4-8,8,4-g33-path531", "128S86-8,8,4-g33-path169", "128S85-8,8,4-g33-path169", "128S26-8,4,4-g25-path941", "128S84-8,4,4-g25-path95", "128S83-8,4,4-g25-path95" ];
