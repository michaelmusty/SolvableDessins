...
s`SolvableDBName := "64S8-8,4,2-g5-path33";
s`SolvableDBFilename := "64S8-8,4,2-g5-path33.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 18, 33, 24, 20, 42, 41, 43, 40, 17, 39, 44, 45, 16, 8, 9, 10, 11, 12, 13, 14, 15, 34, 38, 29, 31, 59, 56, 57, 55, 37, 60, 58, 61, 46, 25, 26, 27, 28, 30, 32, 35, 36, 47, 62, 63, 54, 64, 51, 53, 49, 48, 50, 52 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S9-8,4,2-g3-path7", "64S8-8,4,2-g5-path33" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,2-g17-path299", "128S76-8,4,4-g25-path162", "128S78-8,8,4-g33-path201", "128S77-8,8,2-g17-path118", "128S26-8,4,4-g25-path852", "128S3-8,8,4-g33-path1013", "128S79-16,4,2-g13-path75", "128S81-16,8,2-g21-path69", "128S72-16,4,4-g29-path74", "128S74-16,8,4-g37-path35", "128S71-16,4,2-g13-path35", "128S73-16,8,2-g21-path35", "128S80-16,4,4-g29-path234", "128S82-16,8,4-g37-path103", "128S75-8,4,2-g9-path57" ];
