...
s`SolvableDBName := "64S45-16,4,16-g21-path44";
s`SolvableDBFilename := "64S45-16,4,16-g21-path44.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path1", "32S12-8,4,8-g9-path8", "64S45-16,4,16-g21-path44" ];
