...
\[ 46, 47, 55, 41, 50, 58, 17, 49, 20, 63, 45, 24, 23, 31, 53, 64, 39, 59, 42, 61, 14, 34, 57, 40, 60, 3, 48, 18, 22, 43, 5, 25, 6, 4, 62, 44, 16, 15, 10, 36, 37, 54, 51, 9, 52, 38, 56, 13, 26, 28, 1, 27, 12, 8, 11, 35, 19, 21, 2, 29, 30, 33, 32, 7 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,2-g3-path7", "32S17-16,16,2-g7-path2", "64S27-16,16,4-g21-path4" ];
s`SolvableDBParents := [ Strings() | "128S44-16,16,8-g49-path128", "128S130-32,32,4-g45-path67", "128S130-32,32,8-g53-path67", "128S43-16,16,8-g49-path34", "128S130-32,32,4-g45-path68", "128S130-32,32,8-g53-path68", "128S106-16,16,4-g41-path308" ];
