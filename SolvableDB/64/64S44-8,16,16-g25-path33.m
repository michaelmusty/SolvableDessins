...
s`SolvableDBName := "64S44-8,16,16-g25-path33";
s`SolvableDBFilename := "64S44-8,16,16-g25-path33.m";
...
\[ 6, 1, 26, 27, 23, 28, 4, 29, 2, 3, 5, 7, 8, 47, 49, 44, 41, 14, 31, 35, 57, 53, 9, 20, 56, 52, 40, 11, 17, 19, 21, 22, 10, 37, 12, 13, 15, 16, 18, 24, 25, 30, 32, 33, 34, 61, 64, 45, 60, 46, 59, 38, 51, 58, 62, 36, 54, 42, 55, 63, 39, 43, 48, 50 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path2", "32S12-4,8,8-g9-path14", "64S44-8,16,16-g25-path33" ];
s`SolvableDBParents := [ Strings() | "128S153-16,32,32-g57-path23", "128S153-16,32,32-g57-path24", "128S154-16,32,32-g57-path23", "128S154-16,32,32-g57-path24", "128S106-8,16,16-g49-path407", "128S102-8,16,16-g49-path294", "128S99-8,16,16-g49-path294" ];
