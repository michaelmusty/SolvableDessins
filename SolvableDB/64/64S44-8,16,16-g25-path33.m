...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path29", "32S12-4,8,8-g9-path38", "64S44-8,16,16-g25-path33" ];
s`SolvableDBChildren := [ Strings() | "32S12-4,8,8-g9-path38" ];
