...
s`SolvableDBName := "64S21-8,4,4-g13-path14-notcomputed";
s`SolvableDBFilename := "64S21-8,4,4-g13-path14-notcomputed.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 23, 47, 58, 13, 14, 61, 35, 38, 31, 57, 9, 21, 41, 34, 43, 11, 50, 19, 20, 22, 40, 53, 52, 10, 12, 15, 16, 17, 18, 25, 26, 32, 33, 36, 56, 64, 44, 48, 49, 60, 62, 59, 42, 51, 37, 46, 54, 55, 45, 39, 63 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T10-2,4,4-g1-path4-notcomputed", "32S2-4,4,4-g5-path2-notcomputed", "64S21-8,4,4-g13-path14-notcomputed" ];
s`SolvableDBChild := "32S2-4,4,4-g5-path2-notcomputed";
