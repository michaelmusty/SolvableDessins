...
s`SolvableDBName := "64S20-4,4,8-g13-path43";
s`SolvableDBFilename := "64S20-4,4,8-g13-path43.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S11-4,4,8-g7-path8", "64S20-4,4,8-g13-path43" ];
