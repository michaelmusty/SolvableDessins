...
s`SolvableDBName := "64S31-8,16,16-g25-path54";
s`SolvableDBFilename := "64S31-8,16,16-g25-path54.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T6-4,8,8-g5-path3", "32S5-4,8,8-g9-path21", "64S31-8,16,16-g25-path54" ];
s`SolvableDBChildren := [ Strings() | "32S5-4,8,8-g9-path21" ];
