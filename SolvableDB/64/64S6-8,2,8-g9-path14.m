...
s`SolvableDBName := "64S6-8,2,8-g9-path14";
s`SolvableDBFilename := "64S6-8,2,8-g9-path14.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 14, 48, 45, 49, 46, 38, 44, 43, 9, 29, 39, 8, 10, 11, 12, 13, 20, 23, 24, 25, 40, 41, 42, 37, 35, 36, 57, 59, 52, 56, 61, 63, 30, 60, 54, 55, 33, 26, 27, 28, 31, 32, 34, 47, 50, 51, 62, 58, 64, 53 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path5", "32S11-8,2,4-g3-path5", "64S6-8,2,8-g9-path14" ];
s`SolvableDBParents := [ Strings() | "128S11-8,4,8-g33-path1122", "128S3-8,4,8-g33-path588", "128S67-16,2,8-g21-path48", "128S67-16,4,8-g37-path48", "128S68-16,2,8-g21-path48", "128S68-16,4,8-g37-path48", "128S63-8,2,16-g21-path88", "128S64-8,4,16-g37-path128", "128S65-8,2,16-g21-path82", "128S66-8,4,16-g37-path116", "128S61-16,2,16-g25-path220", "128S61-16,4,16-g41-path220", "128S62-16,2,16-g25-path188", "128S62-16,4,16-g41-path188", "128S2-8,2,8-g17-path219" ];
