...
\[ 58, 57, 53, 50, 55, 52, 62, 39, 38, 42, 59, 56, 41, 40, 63, 36, 37, 64, 34, 60, 48, 49, 54, 46, 61, 47, 51, 43, 19, 26, 24, 22, 21, 25, 20, 13, 44, 30, 31, 32, 45, 33, 35, 27, 4, 7, 6, 18, 15, 12, 5, 2, 28, 10, 14, 8, 29, 9, 17, 23, 1, 16, 11, 3 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,2-g1-path1-notcomputed", "8T1-8,8,4-g3-path1-notcomputed", "16T5-8,8,4-g5-path2-notcomputed", "32S16-16,16,8-g13-path7-notcomputed", "64S29-16,16,8-g25-path4-notcomputed" ];
