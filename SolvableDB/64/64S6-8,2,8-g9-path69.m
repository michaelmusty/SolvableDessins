...
s`SolvableDBName := "64S6-8,2,8-g9-path69";
s`SolvableDBFilename := "64S6-8,2,8-g9-path69.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 14, 40, 23, 20, 8, 35, 28, 10, 9, 27, 36, 11, 12, 13, 24, 25, 37, 38, 29, 39, 26, 31, 34, 58, 44, 46, 45, 47, 54, 30, 32, 33, 41, 42, 43, 55, 56, 57, 49, 50, 51, 53, 61, 48, 62, 63, 64, 52, 59, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S9-4,2,8-g3-path1", "64S6-8,2,8-g9-path69" ];
s`SolvableDBParents := [ Strings() | "128S11-8,4,8-g33-path1106", "128S3-8,4,8-g33-path572", "128S67-16,2,8-g21-path38", "128S67-16,4,8-g37-path38", "128S68-16,2,8-g21-path38", "128S68-16,4,8-g37-path38", "128S63-8,2,16-g21-path78", "128S64-8,4,16-g37-path118", "128S65-8,2,16-g21-path72", "128S66-8,4,16-g37-path106", "128S61-16,2,16-g25-path204", "128S61-16,4,16-g41-path204", "128S62-16,2,16-g25-path172", "128S62-16,4,16-g41-path172", "128S2-8,2,8-g17-path203" ];
