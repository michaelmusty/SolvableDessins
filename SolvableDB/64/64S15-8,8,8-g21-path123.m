...
\[ 39, 58, 12, 35, 33, 29, 60, 55, 43, 54, 53, 47, 64, 37, 2, 38, 34, 13, 56, 9, 57, 52, 27, 7, 11, 36, 49, 59, 50, 40, 63, 51, 15, 41, 24, 62, 18, 46, 25, 61, 4, 10, 1, 19, 31, 32, 22, 28, 8, 5, 45, 42, 20, 3, 44, 23, 48, 6, 30, 17, 21, 14, 16, 26 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path25", "32S12-8,8,4-g9-path37", "64S15-8,8,8-g21-path123" ];
s`SolvableDBParents := [ Strings() | "128S100-8,8,16-g45-path17", "128S100-8,8,16-g45-path18", "128S99-16,16,8-g49-path17", "128S101-16,16,16-g53-path63", "128S99-16,16,8-g49-path18", "128S101-16,16,16-g53-path64", "128S9-8,8,8-g41-path32" ];
