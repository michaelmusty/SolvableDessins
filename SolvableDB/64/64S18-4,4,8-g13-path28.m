...
s`SolvableDBName := "64S18-4,4,8-g13-path28";
s`SolvableDBFilename := "64S18-4,4,8-g13-path28.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T4-4,4,4-g3-path1", "32S2-4,4,4-g5-path34", "64S18-4,4,8-g13-path28" ];
