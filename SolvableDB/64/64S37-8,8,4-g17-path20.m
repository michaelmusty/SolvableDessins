...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 60, 26, 34, 31, 11, 51, 43, 9, 36, 44, 64, 42, 21, 13, 12, 62, 38, 54, 61, 59, 47, 48, 63, 10, 14, 15, 16, 17, 18, 19, 20, 23, 25, 32, 33, 35, 37, 57, 45, 52, 56, 53, 46, 41, 58, 39, 50, 40, 55, 49 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S6-4,4,4-g5-path29", "64S37-8,8,4-g17-path20" ];
s`SolvableDBParents := [ Strings() | "128S86-8,8,4-g33-path77", "128S78-8,8,4-g33-path77", "128S126-8,8,4-g33-path245", "128S57-8,8,4-g33-path39", "128S78-8,8,4-g33-path78", "128S86-8,8,4-g33-path78", "128S51-8,8,4-g33-path39" ];
