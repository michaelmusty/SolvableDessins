...
s`SolvableDBName := "64S17-8,4,8-g17-path53";
s`SolvableDBFilename := "64S17-8,4,8-g17-path53.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 23, 52, 47, 44, 14, 33, 56, 38, 60, 58, 9, 21, 59, 54, 43, 11, 17, 19, 20, 22, 10, 46, 40, 35, 12, 13, 15, 16, 18, 25, 26, 31, 32, 34, 36, 37, 57, 48, 62, 50, 41, 61, 63, 42, 53, 39, 55, 45, 64, 49, 51 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path1", "32S2-4,4,4-g5-path23", "64S17-8,4,8-g17-path53" ];
s`SolvableDBParents := [ Strings() | "128S9-8,8,8-g41-path846", "128S5-8,8,8-g41-path234", "128S15-8,8,8-g41-path467", "128S10-8,8,8-g41-path467", "128S15-8,8,8-g41-path468", "128S10-8,8,8-g41-path468", "128S7-8,8,8-g41-path234", "128S13-8,8,8-g41-path234", "128S106-16,4,16-g41-path7", "128S108-16,8,16-g49-path7", "128S108-16,4,16-g41-path7", "128S106-16,8,16-g49-path7", "128S111-16,4,16-g41-path13", "128S110-16,8,16-g49-path13", "128S110-16,4,16-g41-path13", "128S111-16,8,16-g49-path13", "128S111-16,4,16-g41-path14", "128S110-16,8,16-g49-path14", "128S110-16,4,16-g41-path14", "128S111-16,8,16-g49-path14", "128S109-16,4,16-g41-path7", "128S107-16,8,16-g49-path7", "128S107-16,4,16-g41-path7", "128S109-16,8,16-g49-path7", "128S8-8,4,8-g33-path7", "128S11-8,4,8-g33-path13", "128S14-8,4,8-g33-path13", "128S11-8,4,8-g33-path14", "128S14-8,4,8-g33-path14", "128S12-8,4,8-g33-path7", "128S6-8,4,8-g33-path7" ];
