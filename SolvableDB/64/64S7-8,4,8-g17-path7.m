...
s`SolvableDBName := "64S7-8,4,8-g17-path7";
s`SolvableDBFilename := "64S7-8,4,8-g17-path7.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 23, 57, 47, 44, 14, 33, 62, 38, 54, 58, 9, 21, 59, 52, 43, 11, 17, 19, 20, 22, 10, 46, 40, 36, 12, 13, 15, 16, 18, 25, 26, 31, 32, 34, 35, 37, 56, 50, 41, 61, 53, 63, 42, 55, 51, 39, 48, 45, 64, 49, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T12-2,4,8-g2-path3", "32S10-4,4,8-g7-path25", "64S7-8,4,8-g17-path7" ];
s`SolvableDBParents := [ Strings() | "128S69-16,4,16-g41-path443", "128S70-16,4,16-g41-path379", "128S69-16,4,16-g41-path444", "128S70-16,4,16-g41-path380", "128S3-8,4,8-g33-path893", "128S11-8,4,8-g33-path1427", "128S4-8,4,8-g33-path443" ];
