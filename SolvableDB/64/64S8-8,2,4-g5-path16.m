...
s`SolvableDBName := "64S8-8,2,4-g5-path16";
s`SolvableDBFilename := "64S8-8,2,4-g5-path16.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S6-4,2,4-g1-path3", "64S8-8,2,4-g5-path16" ];
