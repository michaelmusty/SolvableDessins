...
s`SolvableDBName := "64S21-4,4,8-g13-path5-notcomputed";
s`SolvableDBFilename := "64S21-4,4,8-g13-path5-notcomputed.m";
...
\[ 12, 39, 45, 7, 2, 5, 38, 42, 22, 33, 13, 9, 28, 19, 14, 20, 63, 10, 29, 64, 30, 1, 31, 11, 32, 16, 18, 24, 15, 25, 61, 21, 27, 23, 59, 62, 55, 40, 6, 4, 46, 41, 47, 58, 37, 8, 60, 52, 53, 54, 43, 50, 57, 48, 3, 49, 56, 36, 17, 51, 34, 44, 35, 26 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T12-2,4,8-g2-path1-notcomputed", "32S10-4,4,8-g7-path7-notcomputed", "64S21-4,4,8-g13-path5-notcomputed" ];
