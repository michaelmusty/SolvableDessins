...
s`SolvableDBName := "64S26-4,16,16-g21-path45";
s`SolvableDBFilename := "64S26-4,16,16-g21-path45.m";
...
\[ 2, 9, 8, 7, 10, 1, 11, 12, 6, 26, 19, 15, 16, 23, 3, 25, 20, 22, 4, 24, 5, 27, 28, 29, 30, 21, 40, 34, 17, 13, 33, 35, 36, 14, 44, 46, 39, 41, 42, 18, 43, 45, 47, 48, 37, 31, 38, 32, 51, 52, 53, 54, 55, 64, 49, 58, 59, 60, 61, 62, 63, 56, 57, 50 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path5", "32S3-4,8,8-g9-path23", "64S26-4,16,16-g21-path45" ];
s`SolvableDBParents := [ Strings() | "128S128-8,32,32-g53-path34", "128S129-4,32,32-g45-path34", "128S44-8,16,16-g49-path34", "128S128-4,32,32-g45-path34", "128S42-8,16,16-g49-path34", "128S129-8,32,32-g53-path34", "128S106-4,16,16-g41-path261" ];
