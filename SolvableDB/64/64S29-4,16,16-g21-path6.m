...
s`SolvableDBName := "64S29-4,16,16-g21-path6";
s`SolvableDBFilename := "64S29-4,16,16-g21-path6.m";
...
\[ 2, 9, 10, 7, 11, 1, 12, 13, 6, 29, 32, 25, 17, 18, 5, 8, 16, 33, 26, 27, 19, 21, 28, 3, 4, 22, 34, 35, 24, 31, 36, 15, 39, 45, 44, 38, 41, 30, 14, 42, 51, 53, 46, 23, 20, 49, 48, 50, 54, 55, 52, 37, 57, 43, 47, 58, 40, 61, 60, 62, 63, 64, 56, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-2,8,8-g3-path3", "32S16-4,16,16-g11-path8", "64S29-4,16,16-g21-path6" ];
s`SolvableDBParents := [ Strings() | "128S131-8,32,32-g53-path53", "128S133-8,32,32-g53-path105", "128S133-8,32,32-g53-path106", "128S132-8,32,32-g53-path53", "128S131-8,32,32-g53-path54", "128S133-8,32,32-g53-path107", "128S133-8,32,32-g53-path108", "128S132-8,32,32-g53-path54", "128S69-4,16,16-g41-path131", "128S61-4,16,16-g41-path53", "128S54-4,16,16-g41-path66", "128S106-4,16,16-g41-path383", "128S61-4,16,16-g41-path54", "128S69-4,16,16-g41-path132", "128S46-4,16,16-g41-path27" ];
