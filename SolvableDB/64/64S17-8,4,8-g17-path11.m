...
I<[x]> := ideal< P | [
x[2]^3*x[4]^4 + 8*x[1]*x[2]^5 - 16*x[1]*x[2]^4 + 8*x[2]^5 - 8*x[2]^3*x[4]^2 + 4*x[2]^2*x[3]*x[4]^2 + x[2]*x[4]^4 + 8*x[1]*x[2]^3 - 16*x[2]^4 + 8*x[2]^2*x[4]^2 + 4*x[1]*x[3]*x[4]^2 + 12*x[2]*x[3]*x[4]^2 + 8*x[1]^2*x[2] - 24*x[1]*x[2]^2 + 16*x[2]^3 + 16*x[2]^2*x[3] + 4*x[2]*x[4]^2 - 4*x[3]*x[4]^2 - 8*x[1]^2 + 24*x[1]*x[2] - 40*x[2]^2 - 48*x[2]*x[3] + 56*x[2] + 32*x[3] - 40,
x[2]^3*x[3]*x[4]^2 - 2*x[1]*x[2]^4 + x[2]^2*x[3]*x[4]^2 + 2*x[1]*x[2]^3 - 2*x[2]^4 + x[2]^2*x[4]^2 + x[2]*x[3]*x[4]^2 - 2*x[1]*x[2]^2 + 2*x[2]^3 - x[3]*x[4]^2 + 2*x[1]*x[2] - 2*x[2]^2 - 4*x[2]*x[3] - x[4]^2 + 6*x[2] + 4*x[3] - 4,
x[1]^2*x[4]^4 + x[2]^2*x[4]^4 - 8*x[1]^4*x[2] + 8*x[1]*x[2]^4 + 8*x[1]^4 - 16*x[1]^3*x[2] - 16*x[1]*x[2]^3 + 8*x[2]^4 - 8*x[1]^2*x[4]^2 - 8*x[2]^2*x[4]^2 - 8*x[1]*x[3]*x[4]^2 + 8*x[2]*x[3]*x[4]^2 + x[4]^4 + 16*x[1]^3 - 8*x[1]^2*x[2] + 8*x[1]*x[2]^2 - 16*x[2]^3 - 8*x[1]*x[4]^2 + 8*x[2]*x[4]^2 + 24*x[3]*x[4]^2 + 16*x[1]^2 - 16*x[1]*x[2] + 16*x[2]^2 - 16*x[1]*x[3] + 16*x[2]*x[3] + 16*x[4]^2 + 32*x[1] - 32*x[2] - 64*x[3] + 72,
x[2]^3*x[3]^2 - 2*x[1]*x[2]^2 + x[2]^3 - x[1]*x[3]^2 + x[1] + 2*x[2],
x[1]^2*x[3]*x[4]^2 + x[2]^2*x[3]*x[4]^2 - 2*x[1]^3*x[2] - 2*x[1]*x[2]^3 - x[1]*x[3]*x[4]^2 + x[2]*x[3]*x[4]^2 + 2*x[1]^3 - 2*x[1]^2*x[2] + 2*x[1]*x[2]^2 - 2*x[2]^3 - x[1]*x[4]^2 + x[2]*x[4]^2 + 2*x[3]*x[4]^2 + 2*x[1]^2 - 2*x[1]*x[2] + 2*x[2]^2 + x[4]^2 + 2*x[1] - 2*x[2] - 4*x[3] + 6,
x[3]*x[4]^4 + x[4]^4 - 8*x[1]^2*x[2] + 8*x[1]*x[2]^2 + 4*x[1]*x[4]^2 - 4*x[2]*x[4]^2 - 8*x[3]*x[4]^2 + 8*x[1]^2 - 8*x[1]*x[2] + 8*x[2]^2 - 4*x[4]^2 + 8*x[3],
x[1]^2*x[2]^2 - x[1]^2 - x[2]^2 - 1,
x[1]^2*x[3]^2 + x[2]^2*x[3]^2 + x[1]^2 - 2*x[1]*x[2] + x[2]^2 + 2,
x[1]*x[2]*x[4]^2 + x[1]*x[3]*x[4]^2 - x[2]*x[3]*x[4]^2 - 2*x[1]^2*x[2] + 2*x[1]*x[2]^2 + x[1]*x[4]^2 - x[2]*x[4]^2 - 2*x[3]*x[4]^2 + 2*x[1]^2 - 2*x[1]*x[2] + 2*x[2]^2 - 2*x[4]^2 + 4*x[3] - 2,
x[3]^2*x[4]^2 - 2*x[1]*x[3]^2 + 2*x[2]*x[3]^2 + 2*x[3]*x[4]^2 - 4*x[1]*x[2] - 4*x[3]^2 + x[4]^2 + 2*x[1] - 2*x[2] + 4,
x[1]*x[2]*x[3] + 1/2*x[3]*x[4]^2 - x[1]*x[2] - x[1]*x[3] + x[2]*x[3] + 1/2*x[4]^2 + x[1] - x[2] - x[3] + 1
] >;
...
phi := KX!((4*x[3]^8 + 4*x[3]^4)/(x[3]^12 - 2*x[3]^11 + 2*x[3]^9 - 3*x[3]^8 + 4*x[3]^7 - 4*x[3]^5 + 3*x[3]^4 - 2*x[3]^3 + 2*x[3] - 1)*x[2]*x[4]^2 + (-16*x[3]^10 - 16*x[3]^6)/(x[3]^14 - x[3]^12 - 3*x[3]^10 + 3*x[3]^8 + 3*x[3]^6 - 3*x[3]^4 - x[3]^2 + 1)*x[2] + (x[3]^14 - x[3]^12 + 5*x[3]^10 - 21*x[3]^8 - 5*x[3]^6 - 11*x[3]^4 - x[3]^2 + 1)/(x[3]^14 - x[3]^12 - 3*x[3]^10 + 3*x[3]^8 + 3*x[3]^6 - 3*x[3]^4 - x[3]^2 + 1));
/* assign to object */
...
s`SolvableDBName := "64S17-8,4,8-g17-path11";
s`SolvableDBFilename := "64S17-8,4,8-g17-path11.m";
...
s`SolvableDBLocalSanityCheckTiming := 2.950p15;
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 23, 52, 47, 44, 14, 33, 56, 38, 60, 58, 9, 21, 59, 54, 43, 11, 17, 19, 20, 22, 10, 46, 40, 35, 12, 13, 15, 16, 18, 25, 26, 31, 32, 34, 36, 37, 57, 48, 62, 50, 41, 61, 63, 42, 53, 39, 55, 45, 64, 49, 51 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path5", "32S2-4,4,4-g5-path5", "64S17-8,4,8-g17-path11" ];
s`SolvableDBParents := [ Strings() | "128S9-8,8,8-g41-path43", "128S5-8,8,8-g41-path7", "128S15-8,8,8-g41-path13", "128S10-8,8,8-g41-path13", "128S15-8,8,8-g41-path14", "128S10-8,8,8-g41-path14", "128S7-8,8,8-g41-path7", "128S13-8,8,8-g41-path7", "128S106-16,4,16-g41-path1", "128S108-16,8,16-g49-path1", "128S108-16,4,16-g41-path1", "128S106-16,8,16-g49-path1", "128S111-16,4,16-g41-path1", "128S110-16,8,16-g49-path1", "128S110-16,4,16-g41-path1", "128S111-16,8,16-g49-path1", "128S111-16,4,16-g41-path2", "128S110-16,8,16-g49-path2", "128S110-16,4,16-g41-path2", "128S111-16,8,16-g49-path2", "128S109-16,4,16-g41-path1", "128S107-16,8,16-g49-path1", "128S107-16,4,16-g41-path1", "128S109-16,8,16-g49-path1", "128S8-8,4,8-g33-path1", "128S11-8,4,8-g33-path1", "128S14-8,4,8-g33-path1", "128S11-8,4,8-g33-path2", "128S14-8,4,8-g33-path2", "128S12-8,4,8-g33-path1", "128S6-8,4,8-g33-path1" ];
