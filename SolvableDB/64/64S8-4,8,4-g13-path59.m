...
s`SolvableDBName := "64S8-4,8,4-g13-path59";
s`SolvableDBFilename := "64S8-4,8,4-g13-path59.m";
...
\[ 6, 1, 21, 7, 2, 5, 19, 22, 3, 4, 8, 11, 42, 32, 9, 26, 23, 24, 10, 25, 15, 12, 20, 33, 17, 34, 29, 13, 14, 16, 18, 27, 31, 30, 59, 49, 28, 50, 44, 43, 45, 37, 39, 40, 36, 48, 35, 38, 41, 46, 54, 63, 47, 64, 60, 61, 62, 51, 53, 56, 55, 52, 57, 58 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S9-2,8,4-g3-path8", "64S8-4,8,4-g13-path59" ];
s`SolvableDBParents := [ Strings() | "128S2-4,8,8-g33-path302", "128S3-4,8,8-g33-path1055", "128S77-4,8,8-g33-path121", "128S78-4,8,8-g33-path243", "128S79-4,16,4-g29-path156", "128S81-4,16,8-g37-path72", "128S80-4,16,4-g29-path314", "128S82-4,16,8-g37-path145", "128S71-4,16,4-g29-path76", "128S73-4,16,8-g37-path38", "128S72-4,16,4-g29-path154", "128S74-4,16,8-g37-path77", "128S26-4,8,4-g25-path932", "128S75-4,8,4-g25-path120", "128S76-4,8,4-g25-path242" ];
