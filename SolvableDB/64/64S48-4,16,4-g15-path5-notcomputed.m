...
s`SolvableDBName := "64S48-4,16,4-g15-path5-notcomputed";
s`SolvableDBFilename := "64S48-4,16,4-g15-path5-notcomputed.m";
...
\[ 6, 1, 22, 23, 21, 9, 4, 24, 2, 3, 5, 7, 8, 43, 34, 25, 13, 27, 26, 33, 30, 28, 12, 17, 19, 16, 20, 10, 32, 11, 14, 15, 18, 29, 59, 50, 44, 49, 45, 48, 31, 46, 41, 39, 37, 36, 35, 38, 40, 42, 52, 64, 60, 62, 61, 63, 47, 51, 57, 55, 53, 56, 54, 58 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T4-2,4,2-g0-path2-notcomputed", "16T13-2,8,2-g0-path1-notcomputed", "32S19-4,16,2-g4-path1-notcomputed", "64S48-4,16,4-g15-path5-notcomputed" ];
s`SolvableDBParents := [ Strings() | "128S158-8,32,4-g39-path3-notcomputed", "128S158-4,32,8-g39-path3-notcomputed", "128S104-8,16,8-g45-path9-notcomputed", "128S158-8,32,4-g39-path4-notcomputed", "128S158-4,32,8-g39-path4-notcomputed", "128S104-8,16,8-g45-path10-notcomputed", "128S112-4,16,4-g29-path23-notcomputed" ];
