...
s`SolvableDBName := "64S6-8,4,8-g17-path38";
s`SolvableDBFilename := "64S6-8,4,8-g17-path38.m";
...
\[ 20, 47, 38, 3, 43, 50, 45, 51, 22, 64, 10, 28, 27, 19, 63, 12, 62, 13, 21, 9, 15, 16, 17, 18, 1, 11, 26, 25, 30, 14, 59, 29, 23, 57, 49, 5, 58, 37, 6, 4, 46, 60, 39, 55, 40, 48, 36, 42, 44, 2, 41, 56, 8, 61, 54, 35, 31, 7, 33, 53, 52, 34, 32, 24 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path7", "32S5-8,4,8-g9-path9", "64S6-8,4,8-g17-path38" ];
s`SolvableDBParents := [ Strings() | "128S67-16,8,8-g45-path17", "128S68-16,8,8-g45-path17", "128S68-16,8,8-g45-path18", "128S67-16,8,8-g45-path18", "128S63-8,4,16-g37-path49", "128S61-16,8,16-g49-path281", "128S66-8,4,16-g37-path128", "128S62-16,8,16-g49-path217", "128S65-8,4,16-g37-path43", "128S62-16,8,16-g49-path218", "128S64-8,4,16-g37-path140", "128S61-16,8,16-g49-path282", "128S3-8,4,8-g33-path611", "128S2-8,4,8-g33-path140", "128S11-8,4,8-g33-path1145" ];
