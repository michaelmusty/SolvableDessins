...
s`SolvableDBName := "64S29-4,16,16-g21-path2";
s`SolvableDBFilename := "64S29-4,16,16-g21-path2.m";
...
\[ 2, 9, 10, 7, 11, 1, 12, 13, 6, 29, 32, 25, 17, 18, 5, 8, 16, 33, 26, 27, 19, 21, 28, 3, 4, 22, 34, 35, 24, 31, 36, 15, 39, 45, 44, 38, 41, 30, 14, 42, 51, 53, 46, 23, 20, 49, 48, 50, 54, 55, 52, 37, 57, 43, 47, 58, 40, 61, 60, 62, 63, 64, 56, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T5-2,8,8-g3-path7", "32S16-4,16,16-g11-path6", "64S29-4,16,16-g21-path2" ];
s`SolvableDBParents := [ Strings() | "128S131-8,32,32-g53-path59", "128S133-8,32,32-g53-path117", "128S133-8,32,32-g53-path118", "128S132-8,32,32-g53-path59", "128S131-8,32,32-g53-path60", "128S133-8,32,32-g53-path119", "128S133-8,32,32-g53-path120", "128S132-8,32,32-g53-path60", "128S69-4,16,16-g41-path137", "128S61-4,16,16-g41-path59", "128S54-4,16,16-g41-path69", "128S106-4,16,16-g41-path386", "128S61-4,16,16-g41-path60", "128S69-4,16,16-g41-path138", "128S46-4,16,16-g41-path30" ];
