...
s`SolvableDBName := "64S29-16,4,16-g21-path31";
s`SolvableDBFilename := "64S29-16,4,16-g21-path31.m";
...
\[ 6, 1, 4, 22, 18, 23, 20, 24, 2, 3, 5, 7, 8, 17, 19, 21, 16, 42, 46, 43, 49, 48, 50, 26, 45, 41, 12, 37, 36, 29, 9, 10, 11, 13, 14, 15, 25, 27, 28, 30, 44, 47, 61, 63, 62, 64, 53, 56, 54, 59, 33, 32, 31, 34, 35, 38, 39, 40, 51, 52, 60, 58, 55, 57 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,2,8-g3-path7", "32S5-8,2,8-g5-path14", "64S29-16,4,16-g21-path31" ];
s`SolvableDBParents := [ Strings() | "128S131-32,8,32-g53-path63", "128S133-32,8,32-g53-path125", "128S133-32,8,32-g53-path126", "128S132-32,8,32-g53-path63", "128S131-32,8,32-g53-path64", "128S133-32,8,32-g53-path127", "128S133-32,8,32-g53-path128", "128S132-32,8,32-g53-path64", "128S69-16,4,16-g41-path141", "128S61-16,4,16-g41-path63", "128S54-16,4,16-g41-path71", "128S106-16,4,16-g41-path388", "128S61-16,4,16-g41-path64", "128S69-16,4,16-g41-path142", "128S46-16,4,16-g41-path32" ];
