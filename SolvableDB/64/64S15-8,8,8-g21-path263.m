...
\[ 6, 1, 24, 16, 18, 25, 4, 26, 2, 3, 5, 7, 8, 44, 53, 50, 55, 14, 23, 30, 45, 10, 21, 49, 56, 17, 19, 20, 11, 57, 36, 52, 9, 12, 13, 15, 22, 27, 28, 29, 31, 32, 62, 63, 58, 54, 35, 46, 60, 43, 38, 41, 42, 39, 64, 61, 48, 51, 37, 59, 33, 34, 40, 47 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T8-4,4,4-g3-path16", "32S15-8,8,8-g11-path1", "64S15-8,8,8-g21-path263" ];
s`SolvableDBParents := [ Strings() | "128S101-16,16,16-g53-path259", "128S99-16,16,8-g49-path73", "128S100-8,8,16-g45-path73", "128S101-16,16,16-g53-path260", "128S99-16,16,8-g49-path74", "128S100-8,8,16-g45-path74", "128S9-8,8,8-g41-path130" ];
