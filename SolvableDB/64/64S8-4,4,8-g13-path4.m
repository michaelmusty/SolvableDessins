...
{ IntegerRing() | 44, 62 }
@};
s`SolvableDBBelyiMapTiming := 2.760p15;
s`SolvableDBLocalSanityCheckTiming := 17.090p15;
...
s`SolvableDBParents := [ Strings() | "128S81-8,4,16-g37-path3", "128S80-4,4,16-g29-path23", "128S3-8,4,8-g33-path64", "128S73-8,4,16-g37-path1", "128S72-4,4,16-g29-path7", "128S78-8,4,8-g33-path12", "128S79-4,4,16-g29-path9", "128S2-8,4,8-g33-path16", "128S82-8,4,16-g37-path8", "128S71-4,4,16-g29-path1", "128S77-8,4,8-g33-path5", "128S74-8,4,16-g37-path4", "128S75-4,4,8-g25-path5", "128S26-4,4,8-g25-path31", "128S76-4,4,8-g25-path15" ];
