...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 57, 45, 46, 13, 33, 32, 35, 58, 30, 42, 38, 21, 59, 34, 12, 17, 19, 20, 22, 23, 10, 37, 40, 31, 11, 14, 15, 16, 18, 25, 26, 36, 61, 54, 63, 48, 49, 56, 44, 39, 51, 62, 47, 53, 43, 52, 55, 41, 64, 50, 60 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T14-4,4,8-g4-path2", "32S10-4,4,8-g7-path30", "64S13-4,8,8-g17-path13" ];
s`SolvableDBParents := [ Strings() | "128S96-4,16,8-g37-path43", "128S95-4,16,8-g37-path85", "128S97-4,16,8-g37-path43", "128S95-4,16,8-g37-path86", "128S3-4,8,8-g33-path305", "128S28-4,8,8-g33-path132", "128S3-4,8,8-g33-path306" ];
