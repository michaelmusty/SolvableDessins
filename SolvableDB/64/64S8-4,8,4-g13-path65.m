...
s`SolvableDBName := "64S8-4,8,4-g13-path65";
s`SolvableDBFilename := "64S8-4,8,4-g13-path65.m";
...
\[ 19, 5, 33, 23, 6, 29, 4, 22, 12, 16, 8, 1, 11, 45, 25, 21, 34, 10, 9, 32, 18, 13, 28, 3, 20, 24, 31, 7, 2, 37, 17, 15, 26, 27, 61, 49, 43, 50, 44, 46, 30, 48, 41, 14, 39, 38, 53, 36, 42, 40, 58, 64, 59, 51, 47, 63, 60, 62, 55, 35, 57, 54, 52, 56 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S9-4,8,2-g3-path4", "64S8-4,8,4-g13-path65" ];
s`SolvableDBParents := [ Strings() | "128S81-8,16,4-g37-path57", "128S82-8,16,4-g37-path130", "128S73-8,16,4-g37-path23", "128S74-8,16,4-g37-path62", "128S79-4,16,4-g29-path128", "128S2-8,8,4-g33-path248", "128S80-4,16,4-g29-path286", "128S3-8,8,4-g33-path962", "128S71-4,16,4-g29-path48", "128S77-8,8,4-g33-path67", "128S72-4,16,4-g29-path126", "128S78-8,8,4-g33-path150", "128S26-4,8,4-g25-path904", "128S75-4,8,4-g25-path92", "128S76-4,8,4-g25-path214" ];
