...
s`SolvableDBName := "64S3-8,8,8-g21-path134";
s`SolvableDBFilename := "64S3-8,8,8-g21-path134.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 51, 53, 48, 44, 14, 33, 18, 39, 58, 38, 9, 21, 60, 56, 43, 11, 17, 19, 20, 22, 23, 10, 57, 41, 36, 12, 13, 15, 16, 25, 26, 31, 32, 34, 35, 37, 61, 59, 49, 62, 46, 63, 42, 55, 50, 54, 40, 45, 64, 47, 52 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T6-4,8,8-g5-path2", "32S4-4,8,8-g9-path21", "64S3-8,8,8-g21-path134" ];
s`SolvableDBParents := [ Strings() | "128S45-8,16,16-g49-path287", "128S45-8,16,16-g49-path288", "128S44-16,16,8-g49-path233", "128S45-16,8,16-g49-path375", "128S44-16,16,8-g49-path234", "128S45-16,8,16-g49-path376", "128S5-8,8,8-g41-path873" ];
