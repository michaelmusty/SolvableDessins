...
s`SolvableDBName := "64S12-8,2,8-g9-path28";
s`SolvableDBFilename := "64S12-8,2,8-g9-path28.m";
...
\[ 6, 1, 4, 20, 18, 21, 15, 2, 3, 5, 7, 16, 17, 11, 33, 22, 24, 8, 27, 26, 10, 34, 35, 9, 12, 13, 14, 19, 23, 29, 36, 37, 28, 32, 41, 40, 38, 25, 43, 51, 45, 52, 30, 31, 39, 42, 44, 46, 53, 54, 50, 56, 57, 47, 58, 60, 63, 48, 49, 55, 59, 64, 62, 61 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T13-2,2,8-g0-path1", "32S9-4,2,8-g3-path16", "64S12-8,2,8-g9-path28" ];
s`SolvableDBParents := [ Strings() | "128S2-8,4,8-g33-path60", "128S28-8,4,8-g33-path27", "128S93-16,2,8-g21-path27", "128S92-16,4,8-g37-path27", "128S92-16,2,8-g21-path27", "128S94-16,4,8-g37-path27", "128S93-8,2,16-g21-path27", "128S92-8,4,16-g37-path27", "128S92-8,2,16-g21-path27", "128S94-8,4,16-g37-path27", "128S89-16,2,16-g25-path27", "128S91-16,4,16-g41-path27", "128S91-16,2,16-g25-path27", "128S90-16,4,16-g41-path27", "128S2-8,2,8-g17-path60" ];
