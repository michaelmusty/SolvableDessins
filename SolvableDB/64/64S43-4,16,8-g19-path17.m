...
s`SolvableDBName := "64S43-4,16,8-g19-path17";
s`SolvableDBFilename := "64S43-4,16,8-g19-path17.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path7", "32S9-2,8,4-g3-path9", "64S43-4,16,8-g19-path17" ];
s`SolvableDBChildren := [ Strings() | "32S9-2,8,4-g3-path9" ];
