...
s`SolvableDBName := "64S7-4,8,8-g17-path24";
s`SolvableDBFilename := "64S7-4,8,8-g17-path24.m";
...
\[ 22, 5, 54, 41, 6, 40, 4, 47, 12, 18, 24, 1, 11, 15, 29, 60, 63, 27, 14, 16, 32, 9, 56, 28, 30, 48, 34, 13, 19, 21, 23, 25, 26, 10, 37, 64, 50, 46, 7, 2, 39, 43, 8, 33, 59, 3, 42, 44, 53, 61, 52, 49, 51, 38, 57, 58, 45, 31, 55, 62, 35, 20, 36, 17 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path5", "32S10-4,4,8-g7-path2", "64S7-4,8,8-g17-path24" ];
s`SolvableDBParents := [ Strings() | "128S70-4,16,16-g41-path359", "128S70-4,16,16-g41-path360", "128S69-4,16,16-g41-path423", "128S69-4,16,16-g41-path424", "128S11-4,8,8-g33-path1418", "128S3-4,8,8-g33-path884", "128S4-4,8,8-g33-path434" ];
