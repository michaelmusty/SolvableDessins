...
s`SolvableDBName := "64S29-2,16,16-g13-path8";
s`SolvableDBFilename := "64S29-2,16,16-g13-path8.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 12, 11, 15, 17, 13, 18, 14, 16, 20, 19, 23, 24, 21, 22, 26, 25, 28, 27, 30, 29, 32, 31, 35, 36, 33, 34, 39, 40, 37, 38, 42, 41, 44, 43, 46, 45, 48, 47, 51, 52, 49, 50, 55, 56, 53, 54, 58, 57, 60, 59, 62, 61, 64, 63 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-2,8,8-g3-path4", "32S16-2,16,16-g7-path3", "64S29-2,16,16-g13-path8" ];
s`SolvableDBParents := [ Strings() | "128S106-4,16,16-g41-path346", "128S69-4,16,16-g41-path57", "128S69-4,16,16-g41-path58", "128S54-4,16,16-g41-path29", "128S131-2,32,32-g29-path29", "128S131-4,32,32-g45-path29", "128S133-2,32,32-g29-path57", "128S133-4,32,32-g45-path57", "128S133-2,32,32-g29-path58", "128S133-4,32,32-g45-path58", "128S132-2,32,32-g29-path29", "128S132-4,32,32-g45-path29", "128S61-2,16,16-g25-path57", "128S61-2,16,16-g25-path58", "128S46-2,16,16-g25-path29" ];
