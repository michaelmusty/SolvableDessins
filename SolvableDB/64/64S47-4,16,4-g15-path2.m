...
s`SolvableDBName := "64S47-4,16,4-g15-path2";
s`SolvableDBFilename := "64S47-4,16,4-g15-path2.m";
...
\[ 20, 5, 31, 26, 6, 25, 4, 7, 12, 17, 18, 1, 11, 13, 47, 42, 22, 14, 23, 9, 10, 21, 16, 29, 2, 8, 35, 36, 3, 32, 24, 28, 61, 58, 39, 30, 40, 27, 38, 34, 45, 19, 51, 52, 15, 48, 41, 44, 63, 64, 55, 46, 56, 43, 54, 50, 59, 37, 33, 62, 57, 49, 60, 53 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T13-2,8,2-g0-path1", "32S14-4,8,4-g7-path1", "64S47-4,16,4-g15-path2" ];
s`SolvableDBParents := [ Strings() | "128S103-8,16,8-g45-path9", "128S103-8,16,8-g45-path10", "128S155-4,32,4-g31-path2", "128S157-8,32,8-g47-path3", "128S156-4,32,4-g31-path2", "128S157-8,32,8-g47-path4", "128S112-4,16,4-g29-path20" ];
