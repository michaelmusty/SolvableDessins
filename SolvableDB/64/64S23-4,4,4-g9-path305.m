...
s`SolvableDBName := "64S23-4,4,4-g9-path305";
s`SolvableDBFilename := "64S23-4,4,4-g9-path305.m";
...
[ 31, 43, 4, 16, 34, 20, 39, 57, 64, 7, 44, 63, 62, 15, 40, 21, 47, 54, 17, 24, 3, 8, 45, 55, 10, 22, 28, 53, 49, 29, 5, 13, 12, 1, 60, 51, 38, 46, 25, 48, 33, 32, 11, 2, 18, 58, 50, 14, 56, 19, 9, 35, 61, 23, 6, 30, 26, 37, 52, 59, 27, 42, 41, 36 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S6-4,4,4-g5-path5", "64S23-4,4,4-g9-path305" ];
