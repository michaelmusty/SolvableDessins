...
s`SolvableDBName := "64S50-32,32,8-g27-path6-notcomputed";
s`SolvableDBFilename := "64S50-32,32,8-g27-path6-notcomputed.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 37, 39, 41, 13, 40, 42, 43, 17, 45, 18, 14, 47, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 56, 59, 60, 35, 61, 36, 62, 38, 57, 32, 58, 34, 63, 44, 27, 28, 29, 30, 31, 33, 46, 48, 64, 54, 49, 50, 51, 53, 55, 52 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-4,4,2-g1-path4-notcomputed", "16T5-8,8,2-g3-path3-notcomputed", "32S16-16,16,4-g11-path5-notcomputed", "64S50-32,32,8-g27-path6-notcomputed" ];
s`SolvableDBChild := "32S16-16,16,4-g11-path5-notcomputed";
