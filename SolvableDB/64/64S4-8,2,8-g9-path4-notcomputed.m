...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 48, 49, 26, 50, 8, 41, 29, 10, 40, 35, 42, 9, 11, 12, 13, 14, 20, 23, 24, 25, 43, 44, 45, 46, 47, 63, 27, 28, 36, 61, 54, 60, 55, 31, 56, 57, 62, 51, 33, 30, 32, 34, 37, 38, 39, 52, 53, 64, 59, 58 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T10-4,2,4-g1-path5-notcomputed", "32S6-4,2,4-g1-path2-notcomputed", "64S4-8,2,8-g9-path4-notcomputed" ];
