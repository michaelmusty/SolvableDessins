...
s`SolvableDBName := "64S31-16,4,16-g21-path10";
s`SolvableDBFilename := "64S31-16,4,16-g21-path10.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,2,8-g2-path1", "16T5-8,2,8-g3-path2", "32S5-8,2,8-g5-path13", "64S31-16,4,16-g21-path10" ];
