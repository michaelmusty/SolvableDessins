...
s`SolvableDBName := "64S36-8,2,8-g9-path8";
s`SolvableDBFilename := "64S36-8,2,8-g9-path8.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 49, 50, 26, 51, 8, 42, 29, 10, 40, 41, 43, 9, 11, 12, 13, 14, 20, 23, 24, 25, 44, 45, 46, 47, 48, 63, 56, 27, 28, 33, 35, 57, 64, 58, 31, 55, 54, 62, 38, 37, 34, 36, 30, 32, 39, 52, 53, 61, 59, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path2", "32S6-4,2,4-g1-path11", "64S36-8,2,8-g9-path8" ];
s`SolvableDBParents := [ Strings() | "128S85-8,4,8-g33-path53", "128S56-8,4,8-g33-path27", "128S85-8,4,8-g33-path54", "128S126-8,4,8-g33-path211", "128S77-8,2,8-g17-path31", "128S50-8,2,8-g17-path16", "128S77-8,2,8-g17-path32" ];
