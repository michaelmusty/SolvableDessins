...
s`SolvableDBName := "64S50-32,16,32-g29-path27";
s`SolvableDBFilename := "64S50-32,16,32-g29-path27.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,4,8-g5-path7", "32S16-16,8,16-g13-path18", "64S50-32,16,32-g29-path27" ];
