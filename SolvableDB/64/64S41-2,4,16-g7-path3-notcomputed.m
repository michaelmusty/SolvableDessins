...
s`SolvableDBName := "64S41-2,4,16-g7-path3-notcomputed";
s`SolvableDBFilename := "64S41-2,4,16-g7-path3-notcomputed.m";
...
\[ 10, 5, 27, 6, 2, 4, 25, 16, 11, 1, 9, 13, 12, 20, 37, 8, 29, 21, 22, 14, 18, 19, 31, 39, 7, 33, 3, 30, 17, 28, 23, 34, 26, 32, 47, 49, 15, 41, 24, 42, 38, 40, 48, 46, 55, 44, 35, 43, 36, 51, 50, 56, 64, 58, 45, 52, 59, 54, 57, 62, 63, 60, 61, 53 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T12-2,4,8-g2-path1-notcomputed", "32S9-2,4,8-g3-path4-notcomputed", "64S41-2,4,16-g7-path3-notcomputed" ];
