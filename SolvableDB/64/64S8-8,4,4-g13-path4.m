...
x[3]^2*x[4]^2 - 1/2*x[1]*x[3]^2 - 1/4*x[2]*x[3]^2 + x[3]^2 + 1/16*x[4]^2 - 1/32*x[1] + 1/64*x[2] + 1/16,
x[1]^3 - x[2]^2 + 4*x[1],
...
s`SolvableDBName := "64S8-8,4,4-g13-path4";
s`SolvableDBFilename := "64S8-8,4,4-g13-path4.m";
...
s`SolvableDBLocalSanityCheckTiming := 1.340p15;
...
s`SolvableDBParents := [ Strings() | "128S2-8,4,8-g33-path20", "128S3-8,4,8-g33-path71", "128S77-8,4,8-g33-path9", "128S78-8,4,8-g33-path19", "128S79-16,4,4-g29-path11", "128S81-16,4,8-g37-path4", "128S80-16,4,4-g29-path25", "128S82-16,4,8-g37-path9", "128S71-16,4,4-g29-path3", "128S73-16,4,8-g37-path2", "128S72-16,4,4-g29-path9", "128S74-16,4,8-g37-path5", "128S26-8,4,4-g25-path33", "128S75-8,4,4-g25-path7", "128S76-8,4,4-g25-path17" ];
