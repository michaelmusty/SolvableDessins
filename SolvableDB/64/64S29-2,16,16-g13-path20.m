...
s`SolvableDBName := "64S29-2,16,16-g13-path20";
s`SolvableDBFilename := "64S29-2,16,16-g13-path20.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 14, 26, 27, 11, 21, 22, 19, 23, 17, 28, 15, 16, 18, 25, 24, 12, 13, 20, 34, 33, 35, 48, 30, 29, 31, 43, 39, 44, 37, 45, 42, 41, 36, 38, 40, 47, 46, 32, 51, 55, 49, 56, 54, 53, 50, 52, 61, 60, 62, 58, 57, 59, 64, 63 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-2,8,8-g3-path6", "32S5-2,8,8-g5-path18", "64S29-2,16,16-g13-path20" ];
s`SolvableDBParents := [ Strings() | "128S106-4,16,16-g41-path340", "128S69-4,16,16-g41-path45", "128S69-4,16,16-g41-path46", "128S54-4,16,16-g41-path23", "128S131-2,32,32-g29-path23", "128S131-4,32,32-g45-path23", "128S133-2,32,32-g29-path45", "128S133-4,32,32-g45-path45", "128S133-2,32,32-g29-path46", "128S133-4,32,32-g45-path46", "128S132-2,32,32-g29-path23", "128S132-4,32,32-g45-path23", "128S61-2,16,16-g25-path45", "128S61-2,16,16-g25-path46", "128S46-2,16,16-g25-path23" ];
