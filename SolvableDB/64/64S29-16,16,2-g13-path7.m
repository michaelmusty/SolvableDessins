...
I<[x]> := ideal< P | [
x[3]*x[4]^4 + 2*x[3]^2*x[4]^2 + 4*x[4]^2 + 4*x[3],
x[1]^2*x[3]^2 + x[1]*x[3]^2 + x[3]*x[4]^2 - x[1]*x[2] - x[2] + 2,
x[2]^2*x[4]^2 + 2*x[1]^2*x[3] + 2*x[1]*x[2]*x[3] + 2*x[2]^2*x[3] + 2*x[2]*x[4]^2 + 2*x[1]*x[3] + 4*x[2]*x[3] + 2*x[4]^2,
x[2]*x[3]*x[4]^2 + 2*x[1]^2 + 2*x[1] + 2*x[2],
x[1]^3 - x[2]^2 - x[1],
x[2]*x[3]^2 - x[1]^2 - 1,
x[1]*x[4]^2 - x[2]*x[4]^2 - 2*x[2]*x[3] - x[4]^2
] >;
...
\[ 49, 57, 46, 51, 26, 27, 61, 39, 55, 48, 34, 42, 47, 24, 20, 59, 28, 62, 8, 50, 41, 31, 10, 40, 36, 23, 63, 15, 56, 32, 58, 21, 12, 17, 18, 54, 25, 7, 5, 30, 52, 53, 16, 11, 2, 64, 60, 6, 45, 22, 38, 3, 13, 33, 43, 35, 19, 4, 14, 29, 44, 37, 1, 9 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path4", "32S5-8,8,2-g5-path1", "64S29-16,16,2-g13-path7" ];
s`SolvableDBParents := [ Strings() | "128S131-32,32,4-g45-path2", "128S133-32,32,4-g45-path3", "128S133-32,32,4-g45-path4", "128S132-32,32,4-g45-path2", "128S131-32,32,2-g29-path2", "128S106-16,16,4-g41-path14", "128S133-32,32,2-g29-path3", "128S69-16,16,4-g41-path3", "128S133-32,32,2-g29-path4", "128S69-16,16,4-g41-path4", "128S132-32,32,2-g29-path2", "128S54-16,16,4-g41-path2", "128S61-16,16,2-g25-path3", "128S61-16,16,2-g25-path4", "128S46-16,16,2-g25-path2" ];
