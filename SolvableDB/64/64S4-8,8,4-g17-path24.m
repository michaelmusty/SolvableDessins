...
s`SolvableDBName := "64S4-8,8,4-g17-path24";
s`SolvableDBFilename := "64S4-8,8,4-g17-path24.m";
...
\[ 6, 1, 26, 27, 23, 28, 4, 29, 2, 3, 5, 7, 8, 59, 32, 50, 48, 41, 34, 37, 47, 54, 9, 20, 60, 18, 43, 11, 56, 19, 21, 22, 55, 64, 51, 10, 12, 13, 14, 15, 16, 17, 24, 25, 30, 31, 33, 35, 46, 36, 53, 63, 52, 39, 58, 44, 62, 49, 40, 38, 57, 45, 42, 61 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S6-4,4,4-g5-path31", "64S4-8,8,4-g17-path24" ];
s`SolvableDBParents := [ Strings() | "128S46-16,16,8-g49-path165", "128S46-16,16,8-g49-path166", "128S52-16,16,8-g49-path41", "128S52-16,16,8-g49-path42", "128S47-16,16,8-g49-path133", "128S47-16,16,8-g49-path134", "128S53-16,16,8-g49-path41", "128S53-16,16,8-g49-path42", "128S12-8,8,4-g33-path499", "128S48-8,8,4-g33-path43", "128S49-8,8,4-g33-path110", "128S2-8,8,4-g33-path99", "128S4-8,8,4-g33-path222", "128S50-8,8,4-g33-path43", "128S51-8,8,4-g33-path110" ];
