...
s`SolvableDBName := "64S31-16,16,4-g21-path19";
s`SolvableDBFilename := "64S31-16,16,4-g21-path19.m";
...
\[ 6, 1, 22, 23, 20, 24, 8, 25, 2, 3, 4, 5, 7, 44, 14, 42, 49, 43, 27, 48, 35, 50, 45, 46, 17, 29, 16, 30, 10, 36, 9, 11, 12, 13, 15, 18, 19, 21, 26, 28, 55, 47, 62, 58, 41, 63, 57, 61, 59, 60, 32, 37, 31, 33, 34, 38, 39, 40, 51, 52, 53, 64, 54, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T5-8,8,2-g3-path4", "32S5-8,8,2-g5-path14", "64S31-16,16,4-g21-path19" ];
s`SolvableDBParents := [ Strings() | "128S111-16,16,4-g41-path520", "128S55-16,16,4-g41-path66", "128S47-16,16,4-g41-path20", "128S69-16,16,4-g41-path222", "128S61-16,16,4-g41-path98", "128S62-16,16,4-g41-path66", "128S70-16,16,4-g41-path158" ];
