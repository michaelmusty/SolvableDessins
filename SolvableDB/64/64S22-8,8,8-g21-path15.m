...
s`SolvableDBName := "64S22-8,8,8-g21-path15";
s`SolvableDBFilename := "64S22-8,8,8-g21-path15.m";
...
\[ 42, 64, 50, 18, 20, 16, 10, 25, 60, 61, 43, 45, 39, 47, 59, 26, 63, 58, 14, 34, 8, 9, 57, 3, 31, 5, 35, 13, 12, 56, 41, 38, 44, 2, 4, 62, 51, 36, 24, 21, 33, 29, 28, 40, 22, 55, 30, 37, 15, 11, 17, 32, 48, 23, 53, 49, 52, 7, 19, 1, 27, 54, 46, 6 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path28", "32S15-8,8,8-g11-path46", "64S22-8,8,8-g21-path15" ];
s`SolvableDBParents := [ Strings() | "128S33-8,8,8-g41-path1609", "128S33-8,8,8-g41-path1610", "128S22-8,8,8-g41-path499", "128S10-8,8,8-g41-path2491", "128S30-8,8,8-g41-path511", "128S34-8,8,8-g41-path1129", "128S19-8,8,8-g41-path997", "128S9-8,8,8-g41-path2098", "128S31-8,8,8-g41-path1129", "128S31-8,8,8-g41-path1130", "128S25-8,8,8-g41-path499", "128S10-8,8,8-g41-path2492", "128S34-8,8,8-g41-path1130", "128S30-8,8,8-g41-path512", "128S19-8,8,8-g41-path998" ];
s`SolvableDBChild := "32S15-8,8,8-g11-path46";
