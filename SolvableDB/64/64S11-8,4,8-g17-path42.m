...
s`SolvableDBName := "64S11-8,4,8-g17-path42";
s`SolvableDBFilename := "64S11-8,4,8-g17-path42.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S11-8,4,4-g7-path7", "64S11-8,4,8-g17-path42" ];
