...
s`SolvableDBName := "64S32-8,4,4-g13-path1";
s`SolvableDBFilename := "64S32-8,4,4-g13-path1.m";
...
{ IntegerRing() | 48, 62 }
@};
s`SolvableDBBelyiMapTiming := 3.180p15;
...
\[ 6, 1, 26, 27, 21, 28, 23, 29, 2, 3, 4, 5, 7, 8, 60, 57, 45, 42, 62, 10, 9, 33, 59, 47, 55, 58, 13, 12, 56, 52, 61, 31, 46, 41, 11, 14, 15, 16, 17, 18, 19, 20, 22, 24, 25, 30, 32, 34, 44, 63, 64, 50, 48, 49, 38, 37, 39, 40, 35, 36, 54, 51, 43, 53 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path5", "32S6-4,4,4-g5-path9", "64S32-8,4,4-g13-path1" ];
s`SolvableDBParents := [ Strings() | "128S77-8,8,4-g33-path2", "128S134-8,4,8-g33-path3", "128S137-8,8,8-g41-path9", "128S86-8,8,4-g33-path4", "128S134-8,4,8-g33-path4", "128S137-8,8,8-g41-path10", "128S48-8,8,4-g33-path2", "128S136-8,4,8-g33-path3", "128S135-8,8,8-g41-path9", "128S58-8,8,4-g33-path4", "128S136-8,4,8-g33-path4", "128S135-8,8,8-g41-path10", "128S122-8,4,4-g25-path15", "128S75-8,4,4-g25-path1", "128S83-8,4,4-g25-path3" ];
