...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T8-4,4,4-g3-path8", "32S15-8,8,8-g11-path64", "64S16-8,8,8-g21-path301" ];
s`SolvableDBChildren := [ Strings() | "32S15-8,8,8-g11-path64" ];
