...
s`SolvableDBName := "64S7-8,8,4-g17-path81";
s`SolvableDBFilename := "64S7-8,8,4-g17-path81.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 48, 50, 31, 25, 14, 10, 36, 38, 49, 40, 9, 21, 59, 55, 17, 11, 54, 19, 20, 22, 23, 33, 52, 42, 12, 13, 15, 16, 18, 26, 32, 34, 35, 37, 64, 53, 58, 47, 60, 61, 43, 41, 62, 46, 63, 39, 56, 57, 44, 45, 51 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S11-4,8,4-g7-path14", "64S7-8,8,4-g17-path81" ];
s`SolvableDBParents := [ Strings() | "128S69-16,16,4-g41-path315", "128S69-16,16,4-g41-path316", "128S70-16,16,4-g41-path251", "128S70-16,16,4-g41-path252", "128S11-8,8,4-g33-path1313", "128S3-8,8,4-g33-path779", "128S4-8,8,4-g33-path329" ];
