...
s`SolvableDBName := "64S27-8,16,16-g25-path9";
s`SolvableDBFilename := "64S27-8,16,16-g25-path9.m";
...
\[ 4, 7, 15, 20, 21, 28, 32, 1, 12, 40, 25, 45, 2, 27, 22, 51, 29, 3, 23, 52, 54, 58, 16, 48, 36, 5, 9, 46, 31, 6, 34, 56, 49, 41, 37, 30, 19, 8, 43, 33, 64, 10, 38, 11, 26, 62, 13, 53, 59, 14, 57, 60, 35, 17, 18, 24, 47, 44, 39, 61, 42, 63, 55, 50 ]:
 Order := 64 > |
[ 51, 64, 59, 48, 15, 39, 21, 56, 63, 16, 40, 25, 26, 46, 60, 27, 62, 20, 50, 47, 28, 43, 54, 9, 4, 30, 44, 61, 11, 52, 55, 14, 57, 36, 41, 49, 5, 23, 37, 24, 3, 32, 7, 8, 18, 38, 34, 31, 53, 22, 29, 35, 45, 58, 33, 17, 12, 42, 13, 2, 19, 10, 1, 6 ],
[ 3, 10, 14, 6, 16, 27, 1, 36, 35, 18, 41, 2, 38, 48, 17, 49, 53, 21, 40, 22, 24, 9, 4, 59, 5, 32, 47, 29, 13, 54, 37, 33, 15, 7, 42, 50, 8, 55, 62, 30, 23, 25, 11, 45, 19, 12, 61, 60, 28, 51, 52, 46, 43, 57, 64, 20, 39, 31, 58, 44, 63, 34, 26, 56 ],
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path2", "32S17-8,16,16-g13-path4", "64S27-8,16,16-g25-path9" ];
s`SolvableDBChildren := [ Strings() | "32S17-8,16,16-g13-path4" ];
