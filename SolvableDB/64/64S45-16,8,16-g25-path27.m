...
s`SolvableDBName := "64S45-16,8,16-g25-path27";
s`SolvableDBFilename := "64S45-16,8,16-g25-path27.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path30", "32S12-8,4,8-g9-path35", "64S45-16,8,16-g25-path27" ];
