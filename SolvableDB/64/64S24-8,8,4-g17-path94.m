...
s`SolvableDBName := "64S24-8,8,4-g17-path94";
s`SolvableDBFilename := "64S24-8,8,4-g17-path94.m";
...
\[ 46, 63, 33, 14, 32, 23, 19, 11, 22, 35, 40, 29, 28, 38, 7, 20, 44, 47, 30, 42, 51, 52, 2, 41, 43, 16, 49, 8, 54, 4, 3, 39, 21, 59, 45, 5, 48, 62, 6, 64, 13, 55, 53, 57, 18, 9, 61, 17, 10, 60, 25, 12, 31, 1, 34, 50, 56, 26, 58, 37, 27, 15, 36, 24 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S8-8,8,4-g9-path9", "64S24-8,8,4-g17-path94" ];
s`SolvableDBParents := [ Strings() | "128S15-8,8,8-g41-path1899", "128S41-8,8,8-g41-path269", "128S15-8,8,8-g41-path1900", "128S39-8,8,8-g41-path269", "128S31-8,8,8-g41-path1773", "128S24-8,8,8-g41-path1061", "128S31-8,8,8-g41-path1774", "128S22-8,8,8-g41-path821", "128S37-8,8,4-g33-path331", "128S12-8,8,4-g33-path393", "128S37-8,8,4-g33-path332", "128S28-8,8,4-g33-path609", "128S17-8,8,4-g33-path493", "128S27-8,8,4-g33-path401", "128S17-8,8,4-g33-path494" ];
s`SolvableDBChild := "32S8-8,8,4-g9-path9";
