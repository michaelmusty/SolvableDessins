...
s`SolvableDBName := "64S10-8,2,8-g9-path23";
s`SolvableDBFilename := "64S10-8,2,8-g9-path23.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 49, 48, 23, 20, 47, 42, 50, 51, 40, 41, 43, 8, 9, 10, 11, 12, 13, 14, 24, 25, 44, 45, 33, 46, 31, 61, 34, 52, 54, 38, 32, 30, 62, 35, 55, 63, 57, 36, 29, 37, 60, 39, 26, 27, 28, 53, 56, 64, 58, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S7-8,2,8-g5-path7", "64S10-8,2,8-g9-path23" ];
s`SolvableDBParents := [ Strings() | "128S88-16,4,16-g41-path3", "128S87-16,2,16-g25-path3", "128S27-8,4,8-g33-path2", "128S87-16,2,16-g25-path4", "128S4-8,4,8-g33-path2", "128S88-16,4,16-g41-path4", "128S2-8,2,8-g17-path2" ];
