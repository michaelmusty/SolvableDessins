...
s`SolvableDBName := "64S6-8,4,8-g17-path48";
s`SolvableDBFilename := "64S6-8,4,8-g17-path48.m";
...
\[ 20, 47, 38, 3, 43, 50, 45, 51, 22, 64, 10, 28, 27, 19, 63, 12, 62, 13, 21, 9, 15, 16, 17, 18, 1, 11, 26, 25, 30, 14, 59, 29, 23, 57, 49, 5, 58, 37, 6, 4, 46, 60, 39, 55, 40, 48, 36, 42, 44, 2, 41, 56, 8, 61, 54, 35, 31, 7, 33, 53, 52, 34, 32, 24 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S5-8,4,8-g9-path4", "64S6-8,4,8-g17-path48" ];
s`SolvableDBParents := [ Strings() | "128S67-16,8,8-g45-path57", "128S68-16,8,8-g45-path57", "128S68-16,8,8-g45-path58", "128S67-16,8,8-g45-path58", "128S63-8,4,16-g37-path69", "128S61-16,8,16-g49-path353", "128S66-8,4,16-g37-path148", "128S62-16,8,16-g49-path289", "128S65-8,4,16-g37-path63", "128S62-16,8,16-g49-path290", "128S64-8,4,16-g37-path160", "128S61-16,8,16-g49-path354", "128S3-8,4,8-g33-path647", "128S2-8,4,8-g33-path176", "128S11-8,4,8-g33-path1181" ];
