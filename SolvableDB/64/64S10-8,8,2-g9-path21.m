...
\[ 43, 48, 42, 64, 54, 62, 17, 19, 44, 41, 23, 22, 51, 15, 45, 63, 29, 46, 58, 50, 34, 59, 57, 3, 38, 5, 47, 6, 4, 31, 39, 53, 16, 9, 52, 21, 49, 40, 25, 20, 55, 18, 8, 33, 37, 60, 61, 26, 35, 30, 12, 56, 24, 28, 13, 14, 1, 11, 10, 32, 7, 2, 36, 27 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S11-8,4,2-g3-path3", "64S10-8,8,2-g9-path21" ];
s`SolvableDBParents := [ Strings() | "128S4-8,8,4-g33-path17", "128S27-8,8,4-g33-path17", "128S87-16,16,2-g25-path33", "128S88-16,16,4-g41-path33", "128S87-16,16,2-g25-path34", "128S88-16,16,4-g41-path34", "128S2-8,8,2-g17-path17" ];
