...
s`SolvableDBName := "64S13-4,8,8-g17-path46";
s`SolvableDBFilename := "64S13-4,8,8-g17-path46.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S8-4,8,8-g9-path4", "64S13-4,8,8-g17-path46" ];
