...
s`SolvableDBName := "64S51-32,32,16-g29-path10";
s`SolvableDBFilename := "64S51-32,32,16-g29-path10.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 45, 47, 17, 56, 14, 21, 33, 22, 41, 53, 49, 36, 42, 19, 20, 23, 10, 44, 31, 9, 11, 12, 13, 18, 27, 28, 29, 30, 32, 61, 48, 64, 54, 59, 62, 63, 43, 46, 35, 55, 52, 34, 60, 39, 50, 37, 58, 38, 40, 51, 57 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path3", "32S16-16,16,8-g13-path12", "64S51-32,32,16-g29-path10" ];
s`SolvableDBParents := [ Strings() | "128S153-32,32,16-g57-path211", "128S131-32,32,16-g57-path211", "128S129-32,32,16-g57-path105" ];
