...
\[ 6, 1, 24, 25, 19, 26, 21, 3, 2, 4, 5, 7, 8, 16, 23, 17, 48, 29, 41, 45, 22, 49, 20, 42, 47, 50, 10, 44, 28, 14, 15, 18, 9, 11, 12, 13, 27, 30, 31, 32, 61, 62, 63, 46, 53, 64, 55, 43, 57, 58, 39, 35, 33, 34, 36, 37, 38, 40, 51, 52, 59, 60, 56, 54 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,2,8-g2-path1", "16T5-8,2,8-g3-path2", "32S16-16,4,16-g11-path3", "64S51-32,8,32-g27-path9" ];
s`SolvableDBParents := [ Strings() | "128S153-32,8,32-g53-path101", "128S129-32,8,32-g53-path48", "128S131-32,8,32-g53-path101" ];
