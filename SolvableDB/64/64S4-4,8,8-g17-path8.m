...
s`SolvableDBName := "64S4-4,8,8-g17-path8";
s`SolvableDBFilename := "64S4-4,8,8-g17-path8.m";
...
\[ 22, 5, 52, 39, 6, 38, 4, 44, 12, 18, 24, 1, 11, 15, 28, 51, 63, 26, 14, 58, 31, 9, 54, 27, 29, 33, 13, 19, 21, 23, 25, 20, 10, 61, 47, 43, 7, 2, 37, 41, 8, 59, 3, 40, 57, 50, 62, 49, 46, 48, 45, 36, 55, 56, 42, 30, 16, 64, 53, 35, 17, 60, 34, 32 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path8", "32S5-4,8,8-g9-path11", "64S4-4,8,8-g17-path8" ];
s`SolvableDBParents := [ Strings() | "128S46-8,16,16-g49-path175", "128S46-8,16,16-g49-path176", "128S53-8,16,16-g49-path51", "128S53-8,16,16-g49-path52", "128S47-8,16,16-g49-path143", "128S47-8,16,16-g49-path144", "128S52-8,16,16-g49-path51", "128S52-8,16,16-g49-path52", "128S12-4,8,8-g33-path504", "128S50-4,8,8-g33-path48", "128S51-4,8,8-g33-path115", "128S2-4,8,8-g33-path104", "128S4-4,8,8-g33-path227", "128S48-4,8,8-g33-path48", "128S49-4,8,8-g33-path115" ];
