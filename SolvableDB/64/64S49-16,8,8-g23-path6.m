...
s`SolvableDBName := "64S49-16,8,8-g23-path6";
s`SolvableDBFilename := "64S49-16,8,8-g23-path6.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T8-4,4,4-g3-path24", "32S14-8,4,4-g7-path11", "64S49-16,8,8-g23-path6" ];
