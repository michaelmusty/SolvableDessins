...
s`SolvableDBName := "64S7-8,4,8-g17-path176";
s`SolvableDBFilename := "64S7-8,4,8-g17-path176.m";
...
\[ 41, 60, 13, 18, 20, 16, 10, 64, 22, 40, 43, 29, 28, 19, 49, 2, 50, 38, 51, 39, 8, 48, 52, 3, 59, 5, 7, 56, 57, 45, 25, 42, 44, 27, 23, 37, 46, 34, 6, 4, 9, 35, 61, 31, 14, 58, 30, 12, 47, 36, 15, 62, 63, 55, 32, 11, 1, 53, 21, 26, 24, 54, 17, 33 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S5-8,4,8-g9-path8", "64S7-8,4,8-g17-path176" ];
s`SolvableDBParents := [ Strings() | "128S69-16,8,16-g49-path361", "128S70-16,8,16-g49-path297", "128S69-16,8,16-g49-path362", "128S70-16,8,16-g49-path298", "128S3-8,4,8-g33-path836", "128S11-8,4,8-g33-path1370", "128S4-8,4,8-g33-path386" ];
