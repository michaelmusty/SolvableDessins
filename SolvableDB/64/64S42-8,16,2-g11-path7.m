...
\[ 2, 8, 9, 7, 10, 1, 11, 18, 24, 22, 25, 26, 27, 28, 20, 19, 23, 5, 29, 3, 4, 6, 13, 38, 16, 33, 37, 15, 21, 43, 42, 44, 45, 41, 46, 40, 39, 14, 34, 12, 17, 35, 53, 36, 32, 51, 59, 60, 61, 56, 55, 58, 62, 57, 54, 30, 31, 48, 63, 64, 50, 49, 52, 47 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S9-4,8,2-g3-path7", "64S42-8,16,2-g11-path7" ];
s`SolvableDBParents := [ Strings() | "128S65-8,16,4-g37-path28", "128S119-8,16,4-g37-path194", "128S81-8,16,4-g37-path28", "128S97-8,16,4-g37-path79", "128S65-8,16,2-g21-path28", "128S93-8,16,2-g21-path79", "128S81-8,16,2-g21-path28" ];
