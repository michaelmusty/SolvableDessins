...
\[ 48, 62, 34, 35, 31, 32, 51, 53, 46, 50, 47, 61, 58, 38, 9, 37, 29, 54, 49, 36, 33, 12, 13, 26, 11, 59, 52, 64, 60, 63, 25, 56, 43, 44, 45, 55, 42, 57, 30, 2, 28, 8, 19, 10, 7, 5, 6, 40, 24, 17, 22, 39, 23, 41, 27, 1, 18, 3, 4, 16, 21, 15, 14, 20 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path5", "32S16-8,16,16-g13-path5", "64S51-16,32,32-g29-path22" ];
s`SolvableDBParents := [ Strings() | "128S129-16,32,32-g57-path102", "128S131-16,32,32-g57-path208", "128S153-16,32,32-g57-path208" ];
