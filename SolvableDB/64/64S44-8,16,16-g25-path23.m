...
s`SolvableDBName := "64S44-8,16,16-g25-path23";
s`SolvableDBFilename := "64S44-8,16,16-g25-path23.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T8-4,4,4-g3-path2", "32S12-4,8,8-g9-path28", "64S44-8,16,16-g25-path23" ];
s`SolvableDBChildren := [ Strings() | "32S12-4,8,8-g9-path28" ];
