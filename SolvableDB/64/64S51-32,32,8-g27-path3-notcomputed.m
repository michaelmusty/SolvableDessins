...
s`SolvableDBName := "64S51-32,32,8-g27-path3-notcomputed";
s`SolvableDBFilename := "64S51-32,32,8-g27-path3-notcomputed.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 43, 45, 17, 49, 14, 21, 18, 22, 48, 32, 47, 44, 50, 19, 20, 23, 10, 42, 31, 9, 11, 12, 13, 27, 28, 29, 30, 63, 46, 53, 61, 62, 64, 55, 41, 56, 57, 38, 36, 33, 34, 35, 37, 39, 40, 51, 52, 60, 59, 58, 54 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-4,4,2-g1-path4-notcomputed", "16T5-8,8,2-g3-path3-notcomputed", "32S16-16,16,4-g11-path5-notcomputed", "64S51-32,32,8-g27-path3-notcomputed" ];
