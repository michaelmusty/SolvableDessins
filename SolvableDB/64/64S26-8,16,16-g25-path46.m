...
s`SolvableDBName := "64S26-8,16,16-g25-path46";
s`SolvableDBFilename := "64S26-8,16,16-g25-path46.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 35, 28, 30, 13, 41, 27, 29, 17, 9, 18, 14, 10, 20, 16, 11, 12, 22, 23, 25, 26, 52, 32, 46, 33, 34, 36, 58, 31, 45, 39, 40, 42, 43, 37, 44, 38, 47, 48, 63, 56, 51, 50, 53, 54, 55, 60, 49, 59, 57, 61, 64, 62 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-4,8,8-g5-path6", "32S3-4,8,8-g9-path24", "64S26-8,16,16-g25-path46" ];
s`SolvableDBParents := [ Strings() | "128S128-16,32,32-g57-path65", "128S129-16,32,32-g57-path65", "128S128-16,32,32-g57-path66", "128S129-16,32,32-g57-path66", "128S106-8,16,16-g49-path260", "128S42-8,16,16-g49-path80", "128S44-8,16,16-g49-path80" ];
