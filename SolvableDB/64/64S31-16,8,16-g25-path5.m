...
s`SolvableDBName := "64S31-16,8,16-g25-path5";
s`SolvableDBFilename := "64S31-16,8,16-g25-path5.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S5-8,4,8-g9-path10", "64S31-16,8,16-g25-path5" ];
s`SolvableDBChildren := [ Strings() | "32S5-8,4,8-g9-path10" ];
