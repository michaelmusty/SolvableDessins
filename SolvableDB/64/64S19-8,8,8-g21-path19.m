...
s`SolvableDBName := "64S19-8,8,8-g21-path19";
s`SolvableDBFilename := "64S19-8,8,8-g21-path19.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 62, 50, 52, 13, 34, 56, 36, 40, 31, 59, 9, 21, 44, 35, 46, 11, 57, 19, 20, 22, 23, 43, 58, 64, 61, 10, 12, 14, 15, 16, 17, 18, 25, 26, 32, 33, 37, 38, 39, 49, 53, 63, 54, 47, 51, 41, 42, 48, 45, 60, 55 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T8-4,4,4-g3-path13", "32S2-4,4,4-g5-path53", "64S19-8,8,8-g21-path19" ];
s`SolvableDBParents := [ Strings() | "128S7-8,8,8-g41-path1039", "128S7-8,8,8-g41-path1040", "128S7-8,8,8-g41-path1041", "128S24-8,8,8-g41-path115", "128S23-8,8,8-g41-path229", "128S25-8,8,8-g41-path115", "128S23-8,8,8-g41-path230", "128S24-8,8,8-g41-path116", "128S25-8,8,8-g41-path116", "128S23-8,8,8-g41-path231", "128S23-8,8,8-g41-path232", "128S24-8,8,8-g41-path117", "128S23-8,8,8-g41-path233", "128S23-8,8,8-g41-path234", "128S25-8,8,8-g41-path117" ];
