...
phi := KX!((x[4]^16 + 2*x[4]^8 + 1)/(x[4]^16 - 2*x[4]^8 + 1));
/* assign to object */
...
s`SolvableDBName := "64S20-4,8,4-g13-path7";
s`SolvableDBFilename := "64S20-4,8,4-g13-path7.m";
...
\[ 22, 5, 54, 40, 6, 39, 4, 46, 12, 18, 24, 1, 11, 15, 29, 62, 61, 27, 14, 16, 32, 9, 56, 28, 30, 47, 34, 13, 19, 21, 23, 25, 26, 10, 52, 59, 45, 7, 2, 38, 42, 8, 33, 60, 3, 41, 43, 53, 58, 51, 48, 49, 50, 37, 57, 64, 44, 35, 17, 55, 36, 63, 20, 31 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path5", "32S2-4,4,4-g5-path3", "64S20-4,8,4-g13-path7" ];
s`SolvableDBParents := [ Strings() | "128S8-8,8,4-g33-path7", "128S11-4,8,8-g33-path16", "128S10-8,8,8-g41-path44", "128S35-8,8,4-g33-path1", "128S32-4,8,8-g33-path8", "128S31-8,8,8-g41-path8", "128S32-8,8,4-g33-path2", "128S27-4,8,8-g33-path16", "128S34-8,8,8-g41-path8", "128S17-8,8,4-g33-path3", "128S20-4,8,8-g33-path6", "128S23-8,8,8-g41-path14", "128S29-4,8,4-g25-path2", "128S26-4,8,4-g25-path2", "128S16-4,8,4-g25-path4" ];
