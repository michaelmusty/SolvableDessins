...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 41, 39, 23, 20, 40, 38, 42, 43, 36, 37, 8, 9, 10, 11, 12, 13, 14, 24, 34, 32, 30, 58, 59, 44, 45, 56, 60, 61, 46, 55, 57, 25, 26, 27, 28, 29, 31, 33, 35, 49, 51, 62, 63, 53, 64, 54, 47, 48, 50, 52 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path7", "32S9-8,2,4-g3-path9", "64S8-8,2,4-g5-path37" ];
s`SolvableDBParents := [ Strings() | "128S76-8,4,4-g25-path101", "128S77-8,2,8-g17-path96", "128S3-8,4,8-g33-path991", "128S26-8,4,4-g25-path791", "128S2-8,2,8-g17-path277", "128S78-8,4,8-g33-path179", "128S79-16,2,4-g13-path53", "128S72-16,4,4-g29-path13", "128S73-16,2,8-g21-path13", "128S82-16,4,8-g37-path81", "128S71-16,2,4-g13-path13", "128S80-16,4,4-g29-path173", "128S81-16,2,8-g21-path47", "128S74-16,4,8-g37-path13", "128S75-8,2,4-g9-path35" ];
