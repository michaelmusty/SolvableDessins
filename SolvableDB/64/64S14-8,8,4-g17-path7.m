...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 64, 37, 16, 51, 40, 47, 33, 9, 54, 63, 44, 58, 53, 13, 12, 19, 61, 52, 48, 57, 10, 62, 60, 11, 14, 15, 17, 18, 20, 21, 23, 25, 26, 31, 32, 34, 35, 36, 42, 49, 41, 55, 43, 50, 56, 59, 46, 45, 38, 39 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path7", "32S10-4,8,4-g7-path17", "64S14-8,8,4-g17-path7" ];
s`SolvableDBParents := [ Strings() | "128S98-16,16,4-g41-path17", "128S98-16,16,4-g41-path18", "128S98-16,16,4-g41-path19", "128S98-16,16,4-g41-path20", "128S4-8,8,4-g33-path75", "128S28-8,8,4-g33-path140", "128S4-8,8,4-g33-path76" ];
