...
s`SolvableDBName := "64S9-4,8,4-g13-path49";
s`SolvableDBFilename := "64S9-4,8,4-g13-path49.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T14-4,8,4-g4-path2", "32S10-4,8,4-g7-path31", "64S9-4,8,4-g13-path49" ];
