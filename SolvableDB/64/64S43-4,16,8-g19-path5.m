...
s`SolvableDBName := "64S43-4,16,8-g19-path5";
s`SolvableDBFilename := "64S43-4,16,8-g19-path5.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T12-2,8,4-g2-path2", "32S9-2,8,4-g3-path13", "64S43-4,16,8-g19-path5" ];
s`SolvableDBChildren := [ Strings() | "32S9-2,8,4-g3-path13" ];
