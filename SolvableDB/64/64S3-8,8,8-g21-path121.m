...
s`SolvableDBName := "64S3-8,8,8-g21-path121";
s`SolvableDBFilename := "64S3-8,8,8-g21-path121.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T6-4,8,8-g5-path4", "32S4-4,8,8-g9-path24", "64S3-8,8,8-g21-path121" ];
