...
s`SolvableDBName := "64S36-8,2,8-g9-path9";
s`SolvableDBFilename := "64S36-8,2,8-g9-path9.m";
...
[ 57, 46, 47, 64, 51, 30, 33, 37, 38, 18, 44, 58, 62, 55, 24, 32, 61, 34, 54, 36, 60, 14, 19, 21, 59, 53, 35, 48, 52, 50, 56, 5, 4, 63, 9, 17, 28, 49, 6, 8, 29, 45, 39, 3, 26, 12, 31, 22, 41, 23, 25, 27, 15, 43, 40, 13, 16, 10, 1, 42, 7, 11, 2, 20 ]
]
];
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 49, 50, 26, 51, 8, 42, 29, 10, 40, 41, 43, 9, 11, 12, 13, 14, 20, 23, 24, 25, 44, 45, 46, 47, 48, 63, 56, 27, 28, 33, 35, 57, 64, 58, 31, 55, 54, 62, 38, 37, 34, 36, 30, 32, 39, 52, 53, 61, 59, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path7", "32S6-4,2,4-g1-path9", "64S36-8,2,8-g9-path9" ];
s`SolvableDBParents := [ Strings() | "128S85-8,4,8-g33-path55", "128S56-8,4,8-g33-path28", "128S85-8,4,8-g33-path56", "128S126-8,4,8-g33-path212", "128S77-8,2,8-g17-path33", "128S50-8,2,8-g17-path17", "128S77-8,2,8-g17-path34" ];
