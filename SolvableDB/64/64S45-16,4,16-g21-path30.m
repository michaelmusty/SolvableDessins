...
s`SolvableDBName := "64S45-16,4,16-g21-path30";
s`SolvableDBFilename := "64S45-16,4,16-g21-path30.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 42, 61, 59, 62, 39, 16, 46, 37, 12, 14, 10, 64, 48, 15, 35, 56, 50, 9, 34, 41, 58, 40, 52, 11, 13, 17, 18, 19, 20, 21, 23, 25, 26, 31, 32, 33, 36, 49, 55, 47, 57, 63, 43, 45, 54, 44, 51, 60, 38, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,4,8-g5-path3", "32S12-8,4,8-g9-path13", "64S45-16,4,16-g21-path30" ];
s`SolvableDBParents := [ Strings() | "128S102-16,8,16-g49-path393", "128S99-16,8,16-g49-path393", "128S108-16,4,16-g41-path260" ];
