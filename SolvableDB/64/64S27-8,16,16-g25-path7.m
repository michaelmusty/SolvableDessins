...
s`SolvableDBName := "64S27-8,16,16-g25-path7";
s`SolvableDBFilename := "64S27-8,16,16-g25-path7.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 47, 9, 59, 35, 14, 33, 46, 48, 12, 49, 60, 21, 56, 13, 31, 37, 17, 19, 20, 22, 23, 10, 54, 40, 36, 11, 15, 16, 18, 25, 26, 32, 34, 38, 61, 58, 57, 39, 62, 42, 53, 50, 52, 43, 45, 44, 63, 55, 41, 64, 51 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-4,8,8-g5-path6", "32S17-8,16,16-g13-path4", "64S27-8,16,16-g25-path7" ];
s`SolvableDBParents := [ Strings() | "128S130-16,32,32-g57-path137", "128S130-16,32,32-g57-path138", "128S130-16,32,32-g57-path139", "128S130-16,32,32-g57-path140", "128S106-8,16,16-g49-path309", "128S44-8,16,16-g49-path172", "128S43-8,16,16-g49-path78" ];
