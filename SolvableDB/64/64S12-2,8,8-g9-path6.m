...
s`SolvableDBName := "64S12-2,8,8-g9-path6";
s`SolvableDBFilename := "64S12-2,8,8-g9-path6.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S7-2,8,8-g5-path4", "64S12-2,8,8-g9-path6" ];
