...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,1,8-g0-path1", "16T5-8,2,8-g3-path1", "32S17-16,4,16-g11-path1", "64S29-16,4,16-g21-path10" ];
s`SolvableDBChildren := [ Strings() | "32S17-16,4,16-g11-path1" ];
