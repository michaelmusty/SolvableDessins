...
s`SolvableDBName := "64S32-8,2,4-g5-path1";
s`SolvableDBFilename := "64S32-8,2,4-g5-path1.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 47, 40, 25, 48, 8, 39, 28, 10, 38, 33, 9, 11, 12, 13, 14, 20, 23, 24, 41, 42, 43, 44, 45, 63, 26, 55, 58, 51, 52, 64, 53, 61, 30, 56, 62, 36, 27, 29, 31, 32, 34, 35, 37, 46, 49, 50, 54, 60, 57, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S6-4,2,4-g1-path4", "64S32-8,2,4-g5-path1" ];
s`SolvableDBParents := [ Strings() | "128S134-8,4,4-g25-path2", "128S48-8,2,8-g17-path13", "128S135-8,4,8-g33-path13", "128S136-8,4,4-g25-path2", "128S77-8,2,8-g17-path13", "128S137-8,4,8-g33-path13", "128S122-8,4,4-g25-path414", "128S135-8,2,8-g17-path13", "128S58-8,4,8-g33-path24", "128S83-8,4,4-g25-path2", "128S137-8,2,8-g17-path13", "128S86-8,4,8-g33-path24", "128S75-8,2,4-g9-path2", "128S134-8,2,4-g9-path2", "128S136-8,2,4-g9-path2" ];
