...
s`SolvableDBName := "64S31-8,16,16-g25-path23";
s`SolvableDBFilename := "64S31-8,16,16-g25-path23.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-4,8,8-g5-path3", "32S5-4,8,8-g9-path14", "64S31-8,16,16-g25-path23" ];
