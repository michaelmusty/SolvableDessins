...
\[ 6, 1, 26, 27, 22, 28, 23, 29, 2, 3, 4, 5, 7, 8, 60, 53, 48, 47, 37, 52, 31, 9, 59, 42, 61, 49, 13, 12, 19, 57, 45, 50, 10, 56, 11, 14, 15, 16, 17, 18, 20, 21, 24, 25, 30, 32, 33, 34, 40, 55, 39, 64, 41, 63, 62, 54, 43, 38, 35, 36, 46, 44, 51, 58 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path26", "32S12-4,8,8-g9-path42", "64S16-8,8,8-g21-path23" ];
s`SolvableDBParents := [ Strings() | "128S102-8,16,16-g49-path49", "128S102-8,16,16-g49-path50", "128S103-16,8,8-g45-path25", "128S104-16,8,8-g45-path25", "128S105-16,16,16-g53-path55", "128S105-16,16,16-g53-path56", "128S9-8,8,8-g41-path334" ];
