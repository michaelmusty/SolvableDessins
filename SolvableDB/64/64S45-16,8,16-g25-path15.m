...
s`SolvableDBName := "64S45-16,8,16-g25-path15";
s`SolvableDBFilename := "64S45-16,8,16-g25-path15.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T8-4,4,4-g3-path10", "32S12-8,4,8-g9-path25", "64S45-16,8,16-g25-path15" ];
