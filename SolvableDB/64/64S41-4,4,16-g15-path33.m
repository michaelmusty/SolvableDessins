...
\[ 11, 28, 12, 7, 2, 5, 10, 30, 18, 29, 9, 21, 24, 13, 32, 17, 8, 1, 23, 3, 20, 14, 31, 22, 33, 19, 40, 6, 4, 16, 26, 25, 15, 36, 34, 42, 48, 39, 27, 38, 43, 35, 47, 49, 41, 56, 45, 44, 37, 52, 50, 57, 64, 55, 46, 54, 51, 59, 63, 62, 58, 53, 61, 60 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T12-4,2,8-g2-path3", "32S9-4,2,8-g3-path12", "64S41-4,4,16-g15-path33" ];
s`SolvableDBParents := [ Strings() | "128S65-8,4,16-g37-path3", "128S66-8,4,16-g37-path20", "128S92-8,4,16-g37-path65", "128S95-8,4,16-g37-path144", "128S118-4,4,16-g29-path408", "128S79-4,4,16-g29-path54", "128S80-4,4,16-g29-path134" ];
