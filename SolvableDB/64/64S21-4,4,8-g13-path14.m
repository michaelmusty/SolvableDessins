...
I<[x]> := ideal< P | [
x[3]^2*x[4]^4 + x[2]^2*x[3]^2 - x[4]^4 - 2*x[1]*x[4]^2 - 2*x[1]*x[2] + x[2]^2 - 2,
x[2]^3*x[3]^2 - x[3]^2*x[4]^2 - 2*x[1]*x[2]^2 + x[2]^3 + x[4]^2 + 2*x[1] - 2*x[2],
...
s`SolvableDBName := "64S21-4,4,8-g13-path14";
s`SolvableDBFilename := "64S21-4,4,8-g13-path14.m";
...
s`SolvableDBLocalSanityCheckTiming := 6.010p15;
...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 44, 58, 13, 14, 32, 34, 59, 30, 40, 37, 21, 60, 33, 12, 17, 19, 20, 22, 10, 43, 38, 56, 11, 15, 16, 18, 25, 26, 31, 35, 36, 57, 49, 61, 50, 55, 42, 46, 45, 62, 47, 53, 64, 63, 41, 51, 54, 48, 39, 52 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path5", "32S2-4,4,4-g5-path3", "64S21-4,4,8-g13-path14" ];
s`SolvableDBParents := [ Strings() | "128S11-8,4,8-g33-path23", "128S28-4,8,8-g33-path17", "128S33-8,8,8-g41-path9", "128S28-8,4,8-g33-path17", "128S18-4,8,8-g33-path7", "128S24-8,8,8-g41-path8", "128S35-8,4,8-g33-path11", "128S11-4,8,8-g33-path23", "128S9-8,8,8-g41-path59", "128S18-8,4,8-g33-path7", "128S35-4,8,8-g33-path11", "128S33-8,8,8-g41-path10", "128S112-4,4,16-g29-path5", "128S114-8,4,16-g37-path5", "128S119-4,8,16-g37-path5", "128S120-8,8,16-g45-path9", "128S118-4,4,16-g29-path9", "128S119-8,4,16-g37-path5", "128S115-4,8,16-g37-path5", "128S117-8,8,16-g45-path5", "128S118-4,4,16-g29-path10", "128S121-8,4,16-g37-path5", "128S114-4,8,16-g37-path5", "128S113-8,8,16-g45-path5", "128S116-4,4,16-g29-path5", "128S115-8,4,16-g37-path5", "128S121-4,8,16-g37-path5", "128S120-8,8,16-g45-path10", "128S26-4,4,8-g25-path15", "128S26-4,4,8-g25-path16", "128S21-4,4,8-g25-path6" ];
