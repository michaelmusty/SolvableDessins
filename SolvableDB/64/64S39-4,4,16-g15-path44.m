...
\[ 11, 30, 12, 7, 2, 5, 10, 21, 18, 26, 9, 22, 16, 13, 32, 23, 8, 1, 24, 3, 25, 20, 14, 31, 17, 4, 19, 33, 42, 6, 27, 28, 15, 38, 34, 39, 48, 41, 29, 43, 35, 36, 47, 40, 49, 57, 44, 45, 37, 54, 50, 55, 64, 58, 46, 59, 52, 51, 63, 56, 62, 53, 60, 61 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T12-4,2,8-g2-path1", "32S9-4,2,8-g3-path13", "64S39-4,4,16-g15-path44" ];
s`SolvableDBParents := [ Strings() | "128S64-8,4,16-g37-path39", "128S94-8,4,16-g37-path65", "128S64-8,4,16-g37-path40", "128S97-8,4,16-g37-path65", "128S80-4,4,16-g29-path85", "128S112-4,4,16-g29-path272", "128S80-4,4,16-g29-path86" ];
