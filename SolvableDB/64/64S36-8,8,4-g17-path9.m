...
s`SolvableDBName := "64S36-8,8,4-g17-path9";
s`SolvableDBFilename := "64S36-8,8,4-g17-path9.m";
...
\[ 6, 1, 26, 27, 21, 28, 23, 29, 2, 3, 4, 5, 7, 8, 60, 25, 16, 42, 55, 10, 9, 34, 59, 47, 62, 58, 13, 12, 56, 52, 61, 57, 31, 45, 41, 11, 14, 15, 17, 18, 19, 20, 22, 24, 30, 32, 33, 35, 44, 63, 54, 50, 48, 53, 51, 38, 39, 40, 36, 37, 64, 46, 43, 49 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S6-4,4,4-g5-path29", "64S36-8,8,4-g17-path9" ];
s`SolvableDBParents := [ Strings() | "128S126-8,8,4-g33-path220", "128S77-8,8,4-g33-path27", "128S85-8,8,4-g33-path71", "128S77-8,8,4-g33-path28", "128S85-8,8,4-g33-path72", "128S50-8,8,4-g33-path14", "128S56-8,8,4-g33-path36" ];
