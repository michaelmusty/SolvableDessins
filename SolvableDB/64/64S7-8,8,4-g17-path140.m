...
s`SolvableDBName := "64S7-8,8,4-g17-path140";
s`SolvableDBFilename := "64S7-8,8,4-g17-path140.m";
...
[ 39, 58, 11, 28, 26, 29, 38, 40, 62, 32, 37, 57, 52, 4, 7, 2, 35, 13, 31, 55, 19, 5, 20, 10, 30, 53, 9, 64, 51, 33, 47, 56, 44, 60, 12, 34, 50, 41, 59, 54, 15, 1, 8, 25, 36, 16, 21, 27, 23, 3, 63, 61, 22, 43, 49, 24, 17, 46, 42, 45, 18, 48, 6, 14 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T6-8,8,2-g3-path3", "32S5-8,8,2-g5-path21", "64S7-8,8,4-g17-path140" ];
