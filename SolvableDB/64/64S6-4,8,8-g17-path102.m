...
s`SolvableDBName := "64S6-4,8,8-g17-path102";
s`SolvableDBFilename := "64S6-4,8,8-g17-path102.m";
...
\[ 6, 1, 21, 7, 2, 5, 19, 22, 3, 4, 8, 11, 42, 33, 9, 26, 23, 24, 10, 25, 15, 12, 20, 28, 17, 34, 30, 32, 13, 14, 16, 18, 27, 31, 59, 49, 29, 50, 43, 44, 45, 37, 40, 39, 36, 48, 35, 38, 41, 46, 54, 63, 47, 64, 60, 61, 62, 51, 53, 56, 55, 52, 57, 58 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path9", "32S9-2,8,4-g3-path6", "64S6-4,8,8-g17-path102" ];
s`SolvableDBParents := [ Strings() | "128S67-8,8,16-g45-path27", "128S68-8,8,16-g45-path27", "128S68-8,8,16-g45-path28", "128S67-8,8,16-g45-path28", "128S63-4,16,8-g37-path54", "128S61-8,16,16-g49-path311", "128S66-4,16,8-g37-path133", "128S62-8,16,16-g49-path247", "128S65-4,16,8-g37-path48", "128S62-8,16,16-g49-path248", "128S64-4,16,8-g37-path145", "128S61-8,16,16-g49-path312", "128S3-4,8,8-g33-path626", "128S2-4,8,8-g33-path155", "128S11-4,8,8-g33-path1160" ];
