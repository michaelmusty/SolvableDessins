...
s`SolvableDBName := "64S7-8,4,8-g17-path54";
s`SolvableDBFilename := "64S7-8,4,8-g17-path54.m";
...
\[ 42, 62, 13, 18, 20, 16, 10, 58, 22, 40, 44, 29, 28, 33, 25, 2, 50, 38, 51, 39, 8, 49, 59, 3, 57, 5, 7, 55, 56, 46, 41, 43, 45, 24, 52, 23, 17, 61, 6, 4, 48, 9, 36, 34, 15, 14, 64, 21, 12, 35, 31, 47, 60, 37, 11, 1, 30, 19, 63, 32, 27, 26, 53, 54 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path8", "32S10-8,4,4-g7-path10", "64S7-8,4,8-g17-path54" ];
s`SolvableDBParents := [ Strings() | "128S69-16,4,16-g41-path319", "128S69-16,4,16-g41-path320", "128S70-16,4,16-g41-path255", "128S70-16,4,16-g41-path256", "128S11-8,4,8-g33-path1280", "128S3-8,4,8-g33-path746", "128S4-8,4,8-g33-path296" ];
