...
\[ 49, 57, 55, 45, 26, 27, 61, 41, 59, 48, 37, 47, 32, 31, 51, 46, 23, 20, 8, 50, 30, 10, 42, 62, 39, 22, 63, 18, 56, 52, 58, 21, 16, 25, 11, 28, 36, 24, 54, 7, 5, 13, 9, 2, 64, 53, 60, 6, 44, 14, 40, 4, 12, 33, 43, 38, 19, 15, 17, 29, 35, 34, 1, 3 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T2-2,2,2-g0-path3-notcomputed", "8T2-4,2,4-g1-path5-notcomputed", "16T6-8,2,8-g3-path1-notcomputed", "32S5-8,2,8-g5-path7-notcomputed", "64S29-16,2,16-g13-path5-notcomputed" ];
