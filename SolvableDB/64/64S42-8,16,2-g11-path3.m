...
I<[x]> := ideal< P | [
x[2]*x[3]^6 + (-2*nu^5 - 2*nu)*x[2]^2*x[3]^4 + nu^6*x[2]^3*x[3]^2 + 1/2*(-nu^6 - 3)*x[1]*x[3]^4 + 1/2*(7*nu^5 + 3*nu)*x[1]*x[2]*x[3]^2 + 1/2*(nu^7 + nu^5)*x[3]^4 + 1/2*(nu^6 + 1)*x[1]^3 + 1/2*(-3*nu^6 + 1)*x[1]*x[2]^2 + 1/2*(nu^6 + nu^2 + 2)*x[2]*x[3]^2 + 1/2*(-nu^7 + nu)*x[1]^2 + 1/2*(nu^3 - nu)*x[2]^2 + 1/2*(-nu^6 - nu^4)*x[1] + 1/2*(nu^7 - nu^5),
...
x[1]*x[2]*x[3]^4 + (nu^7 - nu^3)*x[2]*x[3]^4 - x[1]^2*x[3]^2 + nu^4*x[2]^2*x[3]^2 + 1/2*(nu^7 + nu)*x[1]^2*x[2] + 1/2*(-nu^7 + 4*nu^3 - nu)*x[1]*x[3]^2 + 1/2*(-3*nu^4 - nu^2)*x[1]*x[2] + 1/2*(-nu^6 + 1)*x[3]^2,
x[1]^2*x[2]*x[3]^2 - x[1]^3 - nu^2*x[2]*x[3]^2 + (nu^7 + nu^3)*x[1]^2 + nu^2*x[1],
x[1]*x[2]^2*x[3]^2 + nu^6*x[2]*x[3]^4 + (-nu^7 + nu^3)*x[2]^2*x[3]^2 + 1/2*(nu^6 - nu^4 - 2)*x[1]^2*x[2] + 1/2*(-3*nu^6 + nu^4)*x[1]*x[3]^2 + 1/2*(3*nu^7 - 2*nu^3 - nu)*x[1]*x[2] + 1/2*(-nu^5 - nu^3)*x[3]^2,
...
s`SolvableDBLocalSanityCheckTiming := 4.290p15;
...
s`SolvableDBParents := [ Strings() | "128S65-8,16,4-g37-path2", "128S119-8,16,4-g37-path7", "128S81-8,16,4-g37-path2", "128S97-8,16,4-g37-path7", "128S65-8,16,2-g21-path2", "128S93-8,16,2-g21-path7", "128S81-8,16,2-g21-path2" ];
