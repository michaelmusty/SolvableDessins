...
s`SolvableDBName := "64S9-4,8,4-g13-path25";
s`SolvableDBFilename := "64S9-4,8,4-g13-path25.m";
...
\[ 2, 9, 10, 7, 11, 1, 12, 13, 6, 37, 38, 28, 39, 15, 40, 41, 42, 43, 30, 31, 25, 32, 33, 5, 44, 45, 3, 4, 8, 46, 47, 48, 49, 50, 20, 51, 27, 24, 29, 64, 34, 26, 53, 61, 17, 62, 35, 52, 58, 16, 54, 22, 55, 60, 18, 57, 63, 23, 56, 36, 21, 19, 59, 14 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S10-4,8,4-g7-path20", "64S9-4,8,4-g13-path25" ];
s`SolvableDBParents := [ Strings() | "128S3-8,8,4-g33-path1090", "128S86-8,8,4-g33-path122", "128S4-8,8,4-g33-path484", "128S85-8,8,4-g33-path122", "128S84-4,8,4-g25-path156", "128S26-4,8,4-g25-path1002", "128S83-4,8,4-g25-path156" ];
