...
\[ 6, 1, 23, 3, 20, 13, 4, 19, 2, 5, 7, 8, 37, 47, 48, 52, 14, 15, 16, 36, 18, 46, 35, 12, 17, 45, 9, 10, 11, 21, 22, 24, 25, 26, 59, 63, 57, 49, 54, 50, 55, 51, 38, 39, 40, 41, 42, 62, 31, 44, 53, 61, 33, 34, 43, 60, 27, 28, 29, 30, 32, 56, 64, 58 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T8-4,4,4-g3-path17", "32S15-8,8,8-g11-path57", "64S16-8,8,8-g21-path257" ];
s`SolvableDBParents := [ Strings() | "128S102-16,16,8-g49-path133", "128S102-16,16,8-g49-path134", "128S103-8,8,16-g45-path67", "128S105-16,16,16-g53-path493", "128S105-16,16,16-g53-path494", "128S104-8,8,16-g45-path67", "128S9-8,8,8-g41-path553" ];
