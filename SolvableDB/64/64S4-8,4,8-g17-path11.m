...
s`SolvableDBName := "64S4-8,4,8-g17-path11";
s`SolvableDBFilename := "64S4-8,4,8-g17-path11.m";
...
\[ 41, 61, 13, 18, 20, 16, 10, 64, 22, 38, 43, 28, 27, 57, 47, 2, 48, 36, 21, 37, 8, 46, 58, 3, 5, 7, 54, 55, 44, 40, 42, 29, 49, 35, 31, 50, 6, 4, 62, 19, 9, 51, 63, 14, 56, 12, 32, 52, 17, 26, 23, 53, 45, 11, 1, 33, 60, 59, 34, 15, 25, 30, 24, 39 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S5-8,4,8-g9-path6", "64S4-8,4,8-g17-path11" ];
s`SolvableDBParents := [ Strings() | "128S53-16,8,16-g49-path47", "128S53-16,8,16-g49-path48", "128S46-16,8,16-g49-path171", "128S46-16,8,16-g49-path172", "128S52-16,8,16-g49-path47", "128S52-16,8,16-g49-path48", "128S47-16,8,16-g49-path139", "128S47-16,8,16-g49-path140", "128S12-8,4,8-g33-path502", "128S50-8,4,8-g33-path46", "128S51-8,4,8-g33-path113", "128S2-8,4,8-g33-path102", "128S4-8,4,8-g33-path225", "128S48-8,4,8-g33-path46", "128S49-8,4,8-g33-path113" ];
