...
s`SolvableDBName := "64S45-16,4,16-g21-path25";
s`SolvableDBFilename := "64S45-16,4,16-g21-path25.m";
...
\[ 6, 1, 26, 14, 22, 27, 23, 28, 2, 3, 4, 5, 7, 8, 42, 61, 43, 62, 64, 16, 45, 50, 39, 41, 51, 59, 52, 56, 49, 37, 35, 60, 40, 9, 10, 11, 12, 13, 15, 17, 18, 19, 20, 21, 24, 25, 29, 30, 31, 32, 33, 48, 55, 46, 57, 38, 58, 54, 44, 34, 63, 47, 53, 36 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T8-4,4,4-g3-path10", "32S12-8,4,8-g9-path46", "64S45-16,4,16-g21-path25" ];
s`SolvableDBParents := [ Strings() | "128S102-16,8,16-g49-path369", "128S99-16,8,16-g49-path369", "128S108-16,4,16-g41-path236" ];
s`SolvableDBChild := "32S12-8,4,8-g9-path46";
