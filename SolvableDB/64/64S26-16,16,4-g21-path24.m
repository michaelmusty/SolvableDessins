...
s`SolvableDBName := "64S26-16,16,4-g21-path24";
s`SolvableDBFilename := "64S26-16,16,4-g21-path24.m";
...
\[ 48, 55, 51, 50, 26, 27, 57, 64, 45, 47, 33, 62, 42, 29, 31, 44, 53, 28, 30, 60, 9, 49, 46, 10, 35, 24, 63, 36, 39, 56, 54, 13, 18, 20, 40, 22, 12, 25, 23, 32, 11, 52, 2, 58, 5, 15, 6, 43, 19, 59, 61, 16, 34, 3, 21, 4, 41, 17, 7, 38, 8, 14, 1, 37 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T4-4,4,4-g3-path14", "32S3-8,8,4-g9-path8", "64S26-16,16,4-g21-path24" ];
s`SolvableDBParents := [ Strings() | "128S128-32,32,8-g53-path39", "128S129-32,32,4-g45-path39", "128S44-16,16,8-g49-path39", "128S128-32,32,4-g45-path39", "128S42-16,16,8-g49-path39", "128S129-32,32,8-g53-path39", "128S106-16,16,4-g41-path266" ];
