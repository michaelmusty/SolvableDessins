...
s`SolvableDBName := "64S17-4,8,8-g17-path164";
s`SolvableDBFilename := "64S17-4,8,8-g17-path164.m";
...
\[ 12, 40, 46, 7, 2, 5, 39, 43, 22, 34, 13, 9, 28, 19, 14, 20, 64, 10, 29, 62, 30, 1, 31, 11, 32, 33, 18, 24, 15, 25, 59, 21, 57, 27, 37, 63, 61, 54, 41, 6, 4, 47, 42, 23, 58, 38, 8, 52, 16, 53, 35, 50, 48, 3, 26, 60, 55, 56, 44, 45, 51, 49, 17, 36 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T4-4,4,4-g3-path10", "32S4-4,8,8-g9-path5", "64S17-4,8,8-g17-path164" ];
s`SolvableDBParents := [ Strings() | "128S106-8,16,16-g49-path15", "128S108-4,16,16-g41-path15", "128S9-8,8,8-g41-path627", "128S111-4,16,16-g41-path29", "128S10-8,8,8-g41-path29", "128S110-8,16,16-g49-path29", "128S111-4,16,16-g41-path30", "128S10-8,8,8-g41-path30", "128S110-8,16,16-g49-path30", "128S109-8,16,16-g49-path15", "128S107-4,16,16-g41-path15", "128S7-8,8,8-g41-path15", "128S106-4,16,16-g41-path15", "128S5-8,8,8-g41-path15", "128S108-8,16,16-g49-path15", "128S111-8,16,16-g49-path29", "128S110-4,16,16-g41-path29", "128S15-8,8,8-g41-path29", "128S111-8,16,16-g49-path30", "128S110-4,16,16-g41-path30", "128S15-8,8,8-g41-path30", "128S109-4,16,16-g41-path15", "128S13-8,8,8-g41-path15", "128S107-8,16,16-g49-path15", "128S14-4,8,8-g33-path29", "128S14-4,8,8-g33-path30", "128S12-4,8,8-g33-path15", "128S8-4,8,8-g33-path15", "128S11-4,8,8-g33-path29", "128S11-4,8,8-g33-path30", "128S6-4,8,8-g33-path15" ];
s`SolvableDBChild := "32S4-4,8,8-g9-path5";
