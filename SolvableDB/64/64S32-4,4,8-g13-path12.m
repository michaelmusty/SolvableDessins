...
s`SolvableDBName := "64S32-4,4,8-g13-path12";
s`SolvableDBFilename := "64S32-4,4,8-g13-path12.m";
...
\[ 12, 36, 41, 7, 2, 5, 35, 38, 22, 48, 13, 9, 27, 52, 14, 62, 51, 10, 60, 16, 29, 1, 30, 11, 31, 18, 24, 15, 61, 59, 57, 56, 58, 44, 37, 6, 4, 19, 55, 33, 32, 39, 25, 46, 21, 63, 17, 26, 47, 42, 49, 28, 40, 23, 50, 3, 43, 53, 54, 8, 45, 64, 34, 20 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path2", "32S6-4,4,4-g5-path9", "64S32-4,4,8-g13-path12" ];
s`SolvableDBParents := [ Strings() | "128S134-8,4,8-g33-path15", "128S77-4,8,8-g33-path8", "128S137-8,8,8-g41-path33", "128S136-8,4,8-g33-path15", "128S58-4,8,8-g33-path30", "128S135-8,8,8-g41-path33", "128S136-8,4,8-g33-path16", "128S48-4,8,8-g33-path8", "128S135-8,8,8-g41-path34", "128S134-8,4,8-g33-path16", "128S86-4,8,8-g33-path30", "128S137-8,8,8-g41-path34", "128S83-4,4,8-g25-path39", "128S75-4,4,8-g25-path17", "128S122-4,4,8-g25-path451" ];
