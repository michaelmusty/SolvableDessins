...
s`SolvableDBName := "64S9-8,4,4-g13-path40";
s`SolvableDBFilename := "64S9-8,4,4-g13-path40.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T12-8,4,2-g2-path2", "32S10-8,4,4-g7-path27", "64S9-8,4,4-g13-path40" ];
s`SolvableDBChildren := [ Strings() | "32S10-8,4,4-g7-path27" ];
