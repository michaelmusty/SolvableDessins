...
s`SolvableDBName := "64S41-4,16,4-g15-path18";
s`SolvableDBFilename := "64S41-4,16,4-g15-path18.m";
...
\[ 19, 5, 33, 23, 6, 29, 4, 22, 12, 16, 8, 1, 11, 45, 25, 21, 34, 10, 9, 32, 18, 13, 28, 3, 20, 24, 31, 7, 2, 37, 17, 15, 26, 27, 61, 49, 43, 50, 44, 46, 30, 48, 41, 14, 39, 38, 53, 36, 42, 40, 56, 51, 59, 62, 47, 64, 60, 63, 55, 35, 57, 58, 54, 52 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path1", "32S9-4,8,2-g3-path1", "64S41-4,16,4-g15-path18" ];
s`SolvableDBParents := [ Strings() | "128S92-8,16,4-g37-path64", "128S95-8,16,4-g37-path143", "128S65-8,16,4-g37-path2", "128S66-8,16,4-g37-path19", "128S118-4,16,4-g29-path415", "128S79-4,16,4-g29-path61", "128S80-4,16,4-g29-path141" ];
