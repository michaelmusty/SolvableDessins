...
s`SolvableDBName := "64S29-16,16,2-g13-path23";
s`SolvableDBFilename := "64S29-16,16,2-g13-path23.m";
...
\[ 49, 57, 46, 51, 26, 27, 61, 39, 55, 48, 34, 42, 47, 24, 20, 59, 28, 62, 8, 50, 41, 31, 10, 40, 36, 23, 63, 15, 56, 32, 58, 21, 12, 17, 18, 54, 25, 7, 5, 30, 52, 53, 16, 11, 2, 64, 60, 6, 45, 22, 38, 3, 13, 33, 43, 35, 19, 4, 14, 29, 44, 37, 1, 9 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,2-g3-path7", "32S5-8,8,2-g5-path13", "64S29-16,16,2-g13-path23" ];
s`SolvableDBParents := [ Strings() | "128S131-32,32,4-g45-path13", "128S133-32,32,4-g45-path25", "128S133-32,32,4-g45-path26", "128S132-32,32,4-g45-path13", "128S131-32,32,2-g29-path13", "128S106-16,16,4-g41-path330", "128S133-32,32,2-g29-path25", "128S69-16,16,4-g41-path25", "128S133-32,32,2-g29-path26", "128S69-16,16,4-g41-path26", "128S132-32,32,2-g29-path13", "128S54-16,16,4-g41-path13", "128S61-16,16,2-g25-path25", "128S61-16,16,2-g25-path26", "128S46-16,16,2-g25-path13" ];
