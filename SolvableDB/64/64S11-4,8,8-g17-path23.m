...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 18, 46, 61, 13, 55, 32, 47, 62, 30, 60, 38, 21, 59, 34, 12, 17, 19, 20, 22, 23, 10, 58, 40, 31, 11, 14, 15, 16, 25, 26, 33, 35, 36, 37, 56, 57, 48, 49, 51, 43, 45, 39, 63, 52, 54, 53, 44, 64, 42, 50, 41 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path2", "32S11-4,4,8-g7-path9", "64S11-4,8,8-g17-path23" ];
s`SolvableDBParents := [ Strings() | "128S3-4,8,8-g33-path75", "128S3-4,8,8-g33-path76", "128S27-4,8,8-g33-path104" ];
