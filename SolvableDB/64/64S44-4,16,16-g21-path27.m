...
s`SolvableDBName := "64S44-4,16,16-g21-path27";
s`SolvableDBFilename := "64S44-4,16,16-g21-path27.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path26", "32S12-4,8,8-g9-path35", "64S44-4,16,16-g21-path27" ];
