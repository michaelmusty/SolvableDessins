...
s`SolvableDBName := "64S8-4,4,8-g13-path3";
s`SolvableDBFilename := "64S8-4,4,8-g13-path3.m";
...
s`SolvableDBLocalSanityCheckTiming := 1.260p15;
...
s`SolvableDBParents := [ Strings() | "128S2-4,8,8-g33-path16", "128S3-4,8,8-g33-path67", "128S77-4,8,8-g33-path5", "128S78-4,8,8-g33-path15", "128S79-4,4,16-g29-path10", "128S81-4,8,16-g37-path3", "128S80-4,4,16-g29-path24", "128S82-4,8,16-g37-path8", "128S71-4,4,16-g29-path2", "128S73-4,8,16-g37-path1", "128S72-4,4,16-g29-path8", "128S74-4,8,16-g37-path4", "128S26-4,4,8-g25-path32", "128S75-4,4,8-g25-path6", "128S76-4,4,8-g25-path16" ];
