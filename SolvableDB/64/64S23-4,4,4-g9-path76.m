...
s`SolvableDBName := "64S23-4,4,4-g9-path76";
s`SolvableDBFilename := "64S23-4,4,4-g9-path76.m";
...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 59, 48, 44, 14, 62, 63, 60, 61, 42, 37, 21, 41, 36, 12, 38, 19, 20, 22, 40, 55, 52, 10, 11, 13, 15, 16, 17, 18, 25, 26, 30, 31, 32, 33, 34, 35, 58, 53, 50, 51, 57, 39, 49, 64, 56, 43, 47, 45, 46, 54 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T8-4,4,4-g3-path22", "32S2-4,4,4-g5-path52", "64S23-4,4,4-g9-path76" ];
s`SolvableDBParents := [ Strings() | "128S122-8,4,4-g25-path165", "128S21-4,8,4-g25-path307", "128S127-8,8,4-g33-path153", "128S122-4,4,8-g25-path153", "128S12-8,4,8-g33-path270", "128S127-4,8,8-g33-path165", "128S25-8,8,8-g41-path669", "128S122-8,4,4-g25-path166", "128S29-4,8,4-g25-path249", "128S127-8,8,4-g33-path154", "128S122-4,4,8-g25-path154", "128S38-8,4,8-g33-path43", "128S127-4,8,8-g33-path166", "128S30-8,8,8-g41-path735", "128S26-8,4,4-g25-path655", "128S123-4,8,4-g25-path85", "128S37-8,8,4-g33-path77", "128S26-4,4,8-g25-path649", "128S126-8,4,8-g33-path85", "128S37-4,8,8-g33-path83", "128S124-8,8,8-g41-path233", "128S16-8,4,4-g25-path451", "128S123-4,8,4-g25-path86", "128S14-8,8,4-g33-path531", "128S16-4,4,8-g25-path445", "128S126-8,4,8-g33-path86", "128S14-4,8,8-g33-path537", "128S124-8,8,8-g41-path234", "128S36-4,4,4-g17-path117", "128S125-4,4,4-g17-path233", "128S125-4,4,4-g17-path234" ];
