...
s`SolvableDBName := "64S8-4,4,8-g13-path10";
s`SolvableDBFilename := "64S8-4,4,8-g13-path10.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S11-4,4,8-g7-path18", "64S8-4,4,8-g13-path10" ];
