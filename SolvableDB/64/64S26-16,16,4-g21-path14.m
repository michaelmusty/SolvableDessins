...
s`SolvableDBName := "64S26-16,16,4-g21-path14";
s`SolvableDBFilename := "64S26-16,16,4-g21-path14.m";
...
\[ 53, 55, 30, 64, 32, 44, 57, 50, 45, 52, 33, 62, 10, 11, 22, 27, 48, 46, 51, 60, 25, 54, 28, 42, 35, 24, 63, 36, 39, 56, 49, 13, 23, 2, 5, 31, 7, 9, 18, 26, 29, 47, 20, 58, 40, 15, 6, 43, 19, 59, 61, 16, 34, 3, 38, 8, 14, 1, 12, 21, 4, 41, 17, 37 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,2-g3-path5", "32S16-16,16,4-g11-path9", "64S26-16,16,4-g21-path14" ];
s`SolvableDBParents := [ Strings() | "128S128-32,32,8-g53-path35", "128S129-32,32,4-g45-path35", "128S44-16,16,8-g49-path35", "128S128-32,32,4-g45-path35", "128S42-16,16,8-g49-path35", "128S129-32,32,8-g53-path35", "128S106-16,16,4-g41-path262" ];
