...
s`SolvableDBName := "64S10-8,8,4-g17-path20";
s`SolvableDBFilename := "64S10-8,8,4-g17-path20.m";
...
\[ 44, 61, 31, 14, 30, 22, 64, 11, 21, 20, 38, 28, 27, 36, 7, 19, 42, 45, 40, 47, 48, 2, 39, 41, 49, 56, 8, 51, 4, 37, 33, 53, 43, 5, 16, 62, 6, 63, 13, 59, 60, 52, 24, 9, 50, 55, 18, 12, 17, 26, 1, 32, 58, 3, 35, 10, 46, 25, 57, 54, 34, 15, 23, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path1", "32S11-8,4,4-g7-path12", "64S10-8,8,4-g17-path20" ];
s`SolvableDBParents := [ Strings() | "128S87-16,16,4-g41-path63", "128S88-16,16,4-g41-path129", "128S87-16,16,4-g41-path64", "128S88-16,16,4-g41-path130", "128S4-8,8,4-g33-path65", "128S2-8,8,4-g33-path32", "128S27-8,8,4-g33-path65" ];
