...
s`SolvableDBName := "64S37-8,8,4-g17-path18";
s`SolvableDBFilename := "64S37-8,8,4-g17-path18.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path5", "32S6-4,4,4-g5-path29", "64S37-8,8,4-g17-path18" ];
