...
s`SolvableDBName := "64S30-16,16,8-g25-path39";
s`SolvableDBFilename := "64S30-16,16,8-g25-path39.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 41, 54, 34, 31, 11, 16, 33, 50, 36, 63, 51, 46, 21, 61, 47, 19, 59, 38, 57, 62, 10, 40, 56, 39, 9, 12, 13, 14, 15, 17, 18, 20, 23, 25, 26, 32, 35, 37, 45, 44, 52, 58, 64, 49, 48, 55, 43, 60, 42, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T5-8,8,4-g5-path2", "32S5-8,8,4-g9-path18", "64S30-16,16,8-g25-path39" ];
s`SolvableDBParents := [ Strings() | "128S62-16,16,8-g49-path15", "128S62-16,16,8-g49-path16", "128S46-16,16,8-g49-path86", "128S54-16,16,8-g49-path86", "128S70-16,16,8-g49-path15", "128S70-16,16,8-g49-path16", "128S109-16,16,8-g49-path235" ];
