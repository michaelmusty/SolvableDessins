...
s`SolvableDBName := "64S14-8,4,8-g17-path19";
s`SolvableDBFilename := "64S14-8,4,8-g17-path19.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S10-8,4,4-g7-path10", "64S14-8,4,8-g17-path19" ];
