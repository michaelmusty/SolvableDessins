...
s`SolvableDBName := "64S32-4,4,8-g13-path15";
s`SolvableDBFilename := "64S32-4,4,8-g13-path15.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S6-4,4,4-g5-path22", "64S32-4,4,8-g13-path15" ];
