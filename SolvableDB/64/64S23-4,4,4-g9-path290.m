...
s`SolvableDBName := "64S23-4,4,4-g9-path290";
s`SolvableDBFilename := "64S23-4,4,4-g9-path290.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S6-4,4,4-g5-path21", "64S23-4,4,4-g9-path290" ];
