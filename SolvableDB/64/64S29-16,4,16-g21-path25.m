...
s`SolvableDBName := "64S29-16,4,16-g21-path25";
s`SolvableDBFilename := "64S29-16,4,16-g21-path25.m";
...
\[ 6, 1, 4, 22, 18, 23, 20, 24, 2, 3, 5, 7, 8, 17, 19, 21, 16, 42, 46, 43, 49, 48, 50, 26, 45, 41, 12, 37, 36, 29, 9, 10, 11, 13, 14, 15, 25, 27, 28, 30, 44, 47, 61, 63, 62, 64, 53, 56, 54, 59, 33, 32, 31, 34, 35, 38, 39, 40, 51, 52, 60, 58, 55, 57 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T6-8,2,8-g3-path3", "32S5-8,2,8-g5-path23", "64S29-16,4,16-g21-path25" ];
s`SolvableDBParents := [ Strings() | "128S131-32,8,32-g53-path37", "128S133-32,8,32-g53-path73", "128S133-32,8,32-g53-path74", "128S132-32,8,32-g53-path37", "128S131-32,8,32-g53-path38", "128S133-32,8,32-g53-path75", "128S133-32,8,32-g53-path76", "128S132-32,8,32-g53-path38", "128S69-16,4,16-g41-path115", "128S61-16,4,16-g41-path37", "128S54-16,4,16-g41-path58", "128S106-16,4,16-g41-path375", "128S61-16,4,16-g41-path38", "128S69-16,4,16-g41-path116", "128S46-16,4,16-g41-path19" ];
