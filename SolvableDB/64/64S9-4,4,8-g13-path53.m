...
s`SolvableDBName := "64S9-4,4,8-g13-path53";
s`SolvableDBFilename := "64S9-4,4,8-g13-path53.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T14-4,4,8-g4-path3", "32S10-4,4,8-g7-path33", "64S9-4,4,8-g13-path53" ];
s`SolvableDBChildren := [ Strings() | "32S10-4,4,8-g7-path33" ];
