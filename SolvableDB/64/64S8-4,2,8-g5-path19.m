...
s`SolvableDBName := "64S8-4,2,8-g5-path19";
s`SolvableDBFilename := "64S8-4,2,8-g5-path19.m";
...
\[ 6, 1, 4, 21, 19, 8, 15, 2, 3, 5, 7, 16, 17, 18, 26, 48, 46, 49, 25, 40, 9, 38, 39, 41, 10, 11, 12, 13, 14, 20, 22, 23, 24, 42, 43, 44, 45, 55, 53, 54, 52, 35, 34, 58, 57, 28, 59, 27, 29, 37, 36, 33, 32, 30, 31, 47, 50, 51, 61, 62, 56, 64, 60, 63 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path2", "32S6-4,2,4-g1-path11", "64S8-4,2,8-g5-path19" ];
s`SolvableDBParents := [ Strings() | "128S77-8,2,8-g17-path74", "128S26-4,4,8-g25-path847", "128S78-8,4,8-g33-path118", "128S2-8,2,8-g17-path255", "128S76-4,4,8-g25-path157", "128S3-8,4,8-g33-path930", "128S79-4,2,16-g13-path70", "128S73-8,2,16-g21-path30", "128S80-4,4,16-g29-path229", "128S74-8,4,16-g37-path30", "128S71-4,2,16-g13-path30", "128S81-8,2,16-g21-path64", "128S72-4,4,16-g29-path69", "128S82-8,4,16-g37-path98", "128S75-4,2,8-g9-path52" ];
