...
s`SolvableDBName := "64S8-4,4,8-g13-path66";
s`SolvableDBFilename := "64S8-4,4,8-g13-path66.m";
...
\[ 6, 1, 18, 21, 19, 9, 4, 22, 2, 3, 5, 7, 8, 33, 31, 15, 26, 28, 29, 16, 12, 24, 17, 13, 30, 32, 42, 10, 11, 14, 20, 23, 25, 27, 34, 49, 39, 37, 41, 45, 38, 35, 40, 47, 48, 57, 36, 43, 44, 46, 50, 55, 64, 56, 54, 52, 51, 61, 58, 62, 63, 53, 59, 60 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path5", "32S9-4,2,8-g3-path5", "64S8-4,4,8-g13-path66" ];
s`SolvableDBParents := [ Strings() | "128S81-8,4,16-g37-path56", "128S80-4,4,16-g29-path282", "128S3-8,4,8-g33-path961", "128S73-8,4,16-g37-path22", "128S72-4,4,16-g29-path122", "128S78-8,4,8-g33-path149", "128S79-4,4,16-g29-path124", "128S2-8,4,8-g33-path247", "128S82-8,4,16-g37-path129", "128S71-4,4,16-g29-path44", "128S77-8,4,8-g33-path66", "128S74-8,4,16-g37-path61", "128S75-4,4,8-g25-path88", "128S26-4,4,8-g25-path900", "128S76-4,4,8-g25-path210" ];
