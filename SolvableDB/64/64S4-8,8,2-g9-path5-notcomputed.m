...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 48, 47, 24, 20, 40, 46, 39, 44, 17, 43, 49, 50, 16, 18, 8, 9, 10, 11, 12, 13, 14, 15, 25, 56, 41, 51, 60, 30, 59, 32, 62, 61, 63, 27, 42, 38, 58, 35, 54, 31, 37, 45, 26, 28, 29, 33, 34, 36, 52, 53, 57, 64, 55 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T2-4,4,2-g1-path1-notcomputed", "16T10-4,4,2-g1-path3-notcomputed", "32S7-8,8,2-g5-path2-notcomputed", "64S4-8,8,2-g9-path5-notcomputed" ];
