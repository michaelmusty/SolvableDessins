...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 49, 48, 24, 20, 50, 47, 51, 45, 17, 44, 52, 53, 16, 18, 8, 9, 10, 11, 12, 13, 14, 15, 25, 60, 27, 54, 39, 30, 61, 32, 35, 34, 40, 63, 41, 42, 38, 31, 56, 55, 64, 57, 43, 37, 46, 26, 28, 29, 33, 36, 58, 62, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T2-4,4,2-g1-path1-notcomputed", "16T10-4,4,2-g1-path3-notcomputed", "32S7-8,8,2-g5-path2-notcomputed", "64S10-8,8,2-g9-path3-notcomputed" ];
