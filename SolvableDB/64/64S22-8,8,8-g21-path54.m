...
s`SolvableDBName := "64S22-8,8,8-g21-path54";
s`SolvableDBFilename := "64S22-8,8,8-g21-path54.m";
...
\[ 45, 64, 33, 40, 32, 23, 19, 11, 53, 50, 57, 49, 42, 39, 7, 26, 60, 46, 14, 16, 61, 9, 36, 62, 31, 63, 35, 13, 12, 4, 3, 38, 59, 58, 44, 5, 47, 2, 30, 15, 21, 24, 37, 18, 29, 48, 17, 10, 22, 27, 55, 20, 1, 34, 56, 43, 28, 52, 41, 51, 25, 8, 54, 6 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T8-4,4,4-g3-path6", "32S15-8,8,8-g11-path26", "64S22-8,8,8-g21-path54" ];
s`SolvableDBParents := [ Strings() | "128S33-8,8,8-g41-path1487", "128S10-8,8,8-g41-path2369", "128S30-8,8,8-g41-path389", "128S33-8,8,8-g41-path1488", "128S22-8,8,8-g41-path438", "128S34-8,8,8-g41-path1007", "128S19-8,8,8-g41-path875", "128S9-8,8,8-g41-path2037", "128S31-8,8,8-g41-path1007", "128S10-8,8,8-g41-path2370", "128S34-8,8,8-g41-path1008", "128S31-8,8,8-g41-path1008", "128S25-8,8,8-g41-path438", "128S30-8,8,8-g41-path390", "128S19-8,8,8-g41-path876" ];
s`SolvableDBChild := "32S15-8,8,8-g11-path26";
