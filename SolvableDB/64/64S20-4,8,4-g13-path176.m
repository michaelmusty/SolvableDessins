...
s`SolvableDBName := "64S20-4,8,4-g13-path176";
s`SolvableDBFilename := "64S20-4,8,4-g13-path176.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path28", "32S2-4,4,4-g5-path69", "64S20-4,8,4-g13-path176" ];
s`SolvableDBChildren := [ Strings() | "32S2-4,4,4-g5-path69" ];
