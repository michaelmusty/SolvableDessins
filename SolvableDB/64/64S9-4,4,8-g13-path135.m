...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 60, 61, 51, 14, 53, 63, 33, 26, 43, 38, 21, 47, 37, 12, 39, 19, 20, 22, 44, 57, 56, 35, 10, 11, 13, 15, 16, 17, 18, 25, 30, 31, 32, 34, 36, 59, 62, 48, 45, 50, 54, 49, 52, 40, 55, 58, 64, 42, 46, 41 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path2", "32S6-4,4,4-g5-path22", "64S9-4,4,8-g13-path135" ];
s`SolvableDBParents := [ Strings() | "128S3-8,4,8-g33-path1087", "128S86-8,4,8-g33-path119", "128S4-8,4,8-g33-path481", "128S85-8,4,8-g33-path119", "128S84-4,4,8-g25-path159", "128S26-4,4,8-g25-path1005", "128S83-4,4,8-g25-path159" ];
