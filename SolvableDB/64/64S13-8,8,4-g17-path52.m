...
s`SolvableDBName := "64S13-8,8,4-g17-path52";
s`SolvableDBFilename := "64S13-8,8,4-g17-path52.m";
...
\[ 32, 54, 51, 44, 50, 58, 43, 7, 22, 35, 19, 29, 28, 13, 11, 56, 62, 33, 30, 64, 27, 23, 12, 14, 10, 60, 25, 15, 36, 24, 18, 9, 21, 17, 31, 1, 34, 5, 57, 47, 6, 4, 42, 40, 59, 55, 8, 61, 3, 41, 39, 63, 46, 38, 49, 45, 53, 2, 52, 20, 16, 26, 48, 37 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T10-4,4,2-g1-path4", "32S8-8,8,4-g9-path2", "64S13-8,8,4-g17-path52" ];
s`SolvableDBParents := [ Strings() | "128S96-8,16,4-g37-path28", "128S95-8,16,4-g37-path55", "128S95-8,16,4-g37-path56", "128S97-8,16,4-g37-path28", "128S3-8,8,4-g33-path239", "128S3-8,8,4-g33-path240", "128S28-8,8,4-g33-path99" ];
