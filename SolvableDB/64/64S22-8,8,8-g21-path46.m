...
s`SolvableDBName := "64S22-8,8,8-g21-path46";
s`SolvableDBFilename := "64S22-8,8,8-g21-path46.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path31", "32S15-8,8,8-g11-path50", "64S22-8,8,8-g21-path46" ];
s`SolvableDBChildren := [ Strings() | "32S15-8,8,8-g11-path50" ];
