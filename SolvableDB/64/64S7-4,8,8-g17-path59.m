...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 45, 46, 55, 13, 60, 32, 58, 61, 30, 14, 38, 21, 62, 34, 12, 17, 19, 20, 22, 23, 10, 54, 39, 35, 11, 15, 16, 18, 25, 26, 31, 33, 36, 37, 41, 64, 49, 50, 57, 43, 47, 59, 52, 63, 44, 40, 48, 42, 53, 56, 51 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T14-4,8,4-g4-path3", "32S10-4,8,4-g7-path29", "64S7-4,8,8-g17-path59" ];
s`SolvableDBParents := [ Strings() | "128S69-8,16,16-g49-path313", "128S69-8,16,16-g49-path314", "128S70-8,16,16-g49-path249", "128S70-8,16,16-g49-path250", "128S11-4,8,8-g33-path1275", "128S3-4,8,8-g33-path741", "128S4-4,8,8-g33-path291" ];
