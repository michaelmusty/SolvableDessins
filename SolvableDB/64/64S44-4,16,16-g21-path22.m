...
s`SolvableDBName := "64S44-4,16,16-g21-path22";
s`SolvableDBFilename := "64S44-4,16,16-g21-path22.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-2,8,8-g3-path3", "32S12-4,8,8-g9-path3", "64S44-4,16,16-g21-path22" ];
