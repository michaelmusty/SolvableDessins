...
\[ 42, 64, 51, 18, 20, 16, 10, 25, 60, 61, 44, 46, 39, 48, 59, 26, 63, 58, 14, 34, 8, 9, 57, 3, 31, 5, 35, 13, 12, 55, 41, 43, 45, 2, 4, 62, 38, 17, 24, 21, 33, 29, 36, 28, 40, 22, 56, 30, 37, 15, 11, 32, 49, 23, 50, 53, 52, 7, 19, 1, 27, 54, 47, 6 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T8-4,4,4-g3-path17", "32S12-8,8,4-g9-path44", "64S15-8,8,8-g21-path115" ];
s`SolvableDBParents := [ Strings() | "128S101-16,16,16-g53-path203", "128S99-16,16,8-g49-path57", "128S100-8,8,16-g45-path57", "128S101-16,16,16-g53-path204", "128S99-16,16,8-g49-path58", "128S100-8,8,16-g45-path58", "128S9-8,8,8-g41-path102" ];
