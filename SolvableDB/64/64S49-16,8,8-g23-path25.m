...
s`SolvableDBName := "64S49-16,8,8-g23-path25";
s`SolvableDBFilename := "64S49-16,8,8-g23-path25.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T14-8,4,4-g4-path2", "32S14-8,4,4-g7-path5", "64S49-16,8,8-g23-path25" ];
