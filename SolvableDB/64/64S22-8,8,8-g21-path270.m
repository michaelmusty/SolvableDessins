...
s`SolvableDBName := "64S22-8,8,8-g21-path270";
s`SolvableDBFilename := "64S22-8,8,8-g21-path270.m";
s`SolvableDBPathNumber := 270;
...
\[ 4, 11, 17, 23, 24, 28, 32, 1, 39, 43, 47, 7, 50, 2, 5, 51, 49, 56, 29, 3, 59, 61, 15, 38, 20, 35, 52, 36, 13, 6, 16, 14, 63, 27, 55, 62, 60, 8, 57, 9, 12, 18, 33, 58, 10, 34, 41, 45, 42, 40, 64, 31, 37, 30, 21, 25, 19, 48, 53, 26, 54, 22, 44, 46 ]:
 Order := 64 > |
[ 30, 8, 57, 56, 62, 19, 43, 42, 14, 54, 58, 15, 55, 63, 20, 60, 27, 50, 26, 46, 1, 40, 28, 17, 9, 48, 47, 64, 41, 16, 12, 24, 6, 21, 38, 13, 44, 61, 37, 59, 45, 31, 3, 36, 25, 2, 4, 22, 29, 7, 32, 53, 23, 39, 10, 51, 11, 18, 33, 5, 52, 34, 49, 35 ],
[ 51, 18, 47, 64, 27, 35, 17, 16, 44, 57, 56, 3, 43, 42, 34, 24, 41, 32, 45, 11, 6, 53, 46, 52, 2, 61, 23, 55, 10, 26, 5, 49, 29, 4, 54, 21, 62, 31, 58, 63, 20, 7, 19, 50, 39, 1, 25, 9, 12, 33, 38, 15, 36, 60, 30, 14, 48, 40, 28, 22, 37, 59, 13, 8 ],
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path29", "32S2-4,4,4-g5-path70", "64S22-8,8,8-g21-path270" ];
s`SolvableDBChildren := [ Strings() | "32S2-4,4,4-g5-path70" ];
