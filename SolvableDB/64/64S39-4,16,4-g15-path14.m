...
s`SolvableDBName := "64S39-4,16,4-g15-path14";
s`SolvableDBFilename := "64S39-4,16,4-g15-path14.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 43, 34, 9, 32, 24, 25, 10, 26, 27, 15, 12, 20, 33, 17, 16, 18, 31, 13, 14, 21, 28, 29, 59, 46, 30, 50, 44, 45, 49, 48, 37, 40, 39, 42, 35, 36, 38, 41, 57, 64, 47, 51, 60, 61, 62, 63, 53, 56, 55, 54, 52, 58 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T12-2,8,4-g2-path1", "32S9-2,8,4-g3-path12", "64S39-4,16,4-g15-path14" ];
s`SolvableDBParents := [ Strings() | "128S64-4,16,8-g37-path45", "128S97-4,16,8-g37-path68", "128S64-4,16,8-g37-path46", "128S94-4,16,8-g37-path68", "128S80-4,16,4-g29-path91", "128S112-4,16,4-g29-path275", "128S80-4,16,4-g29-path92" ];
