...
s`SolvableDBName := "64S37-8,4,8-g17-path9";
s`SolvableDBFilename := "64S37-8,4,8-g17-path9.m";
...
\[ 6, 1, 4, 22, 18, 23, 20, 24, 2, 3, 5, 7, 8, 17, 19, 21, 32, 9, 46, 31, 52, 12, 11, 53, 30, 48, 50, 42, 44, 54, 10, 13, 14, 15, 16, 25, 26, 27, 28, 29, 45, 47, 49, 51, 58, 36, 40, 57, 64, 63, 39, 37, 33, 34, 62, 43, 35, 38, 41, 55, 56, 61, 59, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path7", "32S6-4,2,4-g1-path9", "64S37-8,4,8-g17-path9" ];
s`SolvableDBParents := [ Strings() | "128S86-8,4,8-g33-path79", "128S86-8,4,8-g33-path80", "128S51-8,4,8-g33-path40", "128S57-8,4,8-g33-path40", "128S78-8,4,8-g33-path79", "128S78-8,4,8-g33-path80", "128S126-8,4,8-g33-path246" ];
