...
s`SolvableDBName := "64S37-8,8,4-g17-path11";
s`SolvableDBFilename := "64S37-8,8,4-g17-path11.m";
...
\[ 6, 1, 22, 23, 20, 24, 8, 25, 2, 3, 4, 5, 7, 21, 51, 50, 52, 53, 49, 9, 42, 39, 13, 12, 32, 29, 16, 30, 44, 48, 10, 11, 14, 15, 17, 18, 19, 26, 27, 28, 34, 40, 63, 58, 64, 62, 45, 33, 38, 31, 56, 61, 41, 47, 43, 36, 35, 37, 46, 54, 55, 60, 57, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path2", "32S6-4,4,2-g1-path8", "64S37-8,8,4-g17-path11" ];
s`SolvableDBParents := [ Strings() | "128S86-8,8,4-g33-path71", "128S86-8,8,4-g33-path72", "128S51-8,8,4-g33-path36", "128S57-8,8,4-g33-path36", "128S78-8,8,4-g33-path71", "128S78-8,8,4-g33-path72", "128S126-8,8,4-g33-path242" ];
