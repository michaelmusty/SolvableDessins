...
s`SolvableDBName := "64S44-8,16,16-g25-path70";
s`SolvableDBFilename := "64S44-8,16,16-g25-path70.m";
...
\[ 12, 41, 44, 7, 2, 5, 40, 42, 59, 35, 13, 9, 58, 54, 14, 20, 64, 10, 30, 48, 31, 1, 32, 11, 33, 34, 18, 24, 22, 15, 61, 51, 21, 63, 57, 38, 60, 56, 19, 25, 17, 27, 53, 39, 8, 28, 49, 50, 46, 23, 52, 16, 29, 3, 26, 55, 45, 47, 43, 6, 4, 36, 62, 37 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path2", "32S17-8,16,16-g13-path14", "64S44-8,16,16-g25-path70" ];
s`SolvableDBParents := [ Strings() | "128S153-16,32,32-g57-path153", "128S154-16,32,32-g57-path153", "128S153-16,32,32-g57-path154", "128S154-16,32,32-g57-path154", "128S102-8,16,16-g49-path359", "128S106-8,16,16-g49-path472", "128S99-8,16,16-g49-path359" ];
