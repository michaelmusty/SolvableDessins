...
s`SolvableDBName := "64S47-4,4,16-g15-path12";
s`SolvableDBFilename := "64S47-4,4,16-g15-path12.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T14-4,4,8-g4-path1", "32S14-4,4,8-g7-path4", "64S47-4,4,16-g15-path12" ];
