...
s`SolvableDBName := "64S34-4,4,4-g9-path4";
s`SolvableDBFilename := "64S34-4,4,4-g9-path4.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path1", "32S6-4,4,4-g5-path12", "64S34-4,4,4-g9-path4" ];
