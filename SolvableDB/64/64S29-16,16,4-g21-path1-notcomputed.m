...
s`SolvableDBName := "64S29-16,16,4-g21-path1-notcomputed";
s`SolvableDBFilename := "64S29-16,16,4-g21-path1-notcomputed.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 43, 45, 17, 49, 14, 21, 31, 22, 44, 36, 47, 48, 50, 19, 20, 23, 10, 42, 9, 11, 12, 13, 18, 27, 28, 29, 30, 62, 46, 63, 61, 64, 53, 57, 41, 55, 59, 38, 40, 32, 33, 34, 35, 37, 39, 51, 52, 60, 56, 54, 58 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T1-8,8,2-g2-path1-notcomputed", "16T1-16,16,4-g6-path1-notcomputed", "32S16-16,16,4-g11-path1-notcomputed", "64S29-16,16,4-g21-path1-notcomputed" ];
