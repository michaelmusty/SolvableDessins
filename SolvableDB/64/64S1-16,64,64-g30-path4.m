...
s`SolvableDBName := "64S1-16,64,64-g30-path4";
s`SolvableDBFilename := "64S1-16,64,64-g30-path4.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 26, 11, 34, 25, 29, 19, 21, 24, 4, 35, 5, 36, 37, 7, 38, 30, 32, 9, 33, 10, 48, 50, 31, 47, 54, 20, 27, 41, 43, 45, 17, 46, 18, 49, 59, 22, 60, 42, 51, 53, 55, 56, 28, 57, 58, 63, 64, 44, 52, 39, 40, 61, 62 ],
\[ 26, 33, 38, 8, 48, 16, 12, 50, 56, 57, 30, 58, 27, 60, 29, 51, 1, 23, 3, 2, 36, 32, 63, 13, 9, 64, 40, 41, 53, 43, 55, 45, 46, 52, 54, 61, 11, 62, 4, 5, 6, 7, 14, 10, 15, 34, 28, 49, 25, 59, 44, 17, 18, 39, 19, 21, 24, 35, 31, 42, 20, 22, 37, 47 ]:
 Order := 64 >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-2,8,8-g2-path1", "16T1-4,16,16-g6-path1", "32S1-8,32,32-g14-path2", "64S1-16,64,64-g30-path4" ];
