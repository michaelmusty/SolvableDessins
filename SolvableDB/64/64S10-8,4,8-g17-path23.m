...
s`SolvableDBName := "64S10-8,4,8-g17-path23";
s`SolvableDBFilename := "64S10-8,4,8-g17-path23.m";
...
[ 37, 49, 34, 15, 35, 25, 36, 52, 43, 46, 60, 54, 22, 62, 20, 6, 64, 16, 40, 24, 19, 33, 57, 4, 18, 45, 51, 30, 50, 41, 55, 28, 47, 7, 1, 3, 5, 21, 58, 38, 32, 61, 31, 63, 27, 12, 13, 56, 11, 59, 26, 14, 29, 10, 9, 39, 17, 48, 53, 2, 44, 8, 42, 23 ],
[ 45, 40, 46, 34, 51, 61, 54, 9, 20, 41, 21, 28, 29, 31, 35, 57, 11, 63, 16, 36, 15, 56, 2, 37, 64, 13, 33, 50, 7, 48, 4, 39, 59, 60, 52, 49, 62, 25, 17, 24, 53, 8, 18, 14, 38, 55, 58, 23, 47, 5, 19, 32, 1, 43, 6, 44, 12, 42, 3, 22, 27, 30, 26, 10 ]
]
];
...
\[ 59, 64, 56, 32, 29, 31, 58, 37, 62, 61, 57, 63, 49, 35, 28, 43, 16, 9, 54, 30, 12, 11, 25, 41, 55, 36, 34, 26, 47, 45, 52, 51, 60, 39, 50, 48, 53, 46, 19, 10, 27, 24, 8, 15, 3, 44, 2, 38, 23, 13, 7, 5, 33, 42, 14, 21, 18, 40, 22, 17, 4, 1, 20, 6 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S7-8,2,8-g5-path7", "64S10-8,4,8-g17-path23" ];
s`SolvableDBParents := [ Strings() | "128S87-16,4,16-g41-path57", "128S88-16,4,16-g41-path123", "128S87-16,4,16-g41-path58", "128S88-16,4,16-g41-path124", "128S4-8,4,8-g33-path62", "128S2-8,4,8-g33-path29", "128S27-8,4,8-g33-path62" ];
