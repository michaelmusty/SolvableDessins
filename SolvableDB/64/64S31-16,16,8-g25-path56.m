...
s`SolvableDBName := "64S31-16,16,8-g25-path56";
s`SolvableDBFilename := "64S31-16,16,8-g25-path56.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 45, 54, 34, 31, 11, 16, 48, 59, 36, 63, 51, 60, 21, 41, 32, 13, 50, 38, 57, 62, 44, 9, 43, 53, 10, 12, 14, 15, 17, 18, 19, 20, 23, 25, 26, 33, 35, 37, 40, 56, 52, 58, 64, 49, 47, 55, 42, 46, 61, 39 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path3", "32S5-8,8,4-g9-path15", "64S31-16,16,8-g25-path56" ];
s`SolvableDBParents := [ Strings() | "128S55-16,16,8-g49-path4", "128S61-16,16,8-g49-path160", "128S70-16,16,8-g49-path96", "128S69-16,16,8-g49-path160", "128S62-16,16,8-g49-path96", "128S111-16,16,8-g49-path458", "128S47-16,16,8-g49-path4" ];
