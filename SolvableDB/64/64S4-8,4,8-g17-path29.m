...
s`SolvableDBName := "64S4-8,4,8-g17-path29";
s`SolvableDBFilename := "64S4-8,4,8-g17-path29.m";
...
\[ 6, 1, 26, 27, 23, 28, 4, 29, 2, 3, 5, 7, 8, 22, 47, 60, 44, 14, 53, 34, 37, 59, 9, 21, 46, 58, 42, 11, 62, 19, 20, 13, 55, 50, 63, 10, 12, 15, 16, 17, 18, 24, 25, 30, 31, 32, 33, 35, 57, 48, 61, 64, 51, 49, 52, 38, 41, 39, 54, 36, 40, 43, 45, 56 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S6-4,4,4-g5-path15", "64S4-8,4,8-g17-path29" ];
s`SolvableDBParents := [ Strings() | "128S53-16,8,16-g49-path49", "128S53-16,8,16-g49-path50", "128S46-16,8,16-g49-path173", "128S46-16,8,16-g49-path174", "128S52-16,8,16-g49-path49", "128S52-16,8,16-g49-path50", "128S47-16,8,16-g49-path141", "128S47-16,8,16-g49-path142", "128S12-8,4,8-g33-path503", "128S50-8,4,8-g33-path47", "128S51-8,4,8-g33-path114", "128S2-8,4,8-g33-path103", "128S4-8,4,8-g33-path226", "128S48-8,4,8-g33-path47", "128S49-8,4,8-g33-path114" ];
