...
s`SolvableDBName := "64S16-8,8,8-g21-path60";
s`SolvableDBFilename := "64S16-8,8,8-g21-path60.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T6-8,4,8-g5-path2", "32S12-8,4,8-g9-path21", "64S16-8,8,8-g21-path60" ];
