...
s`SolvableDBName := "64S20-4,8,4-g13-path126";
s`SolvableDBFilename := "64S20-4,8,4-g13-path126.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T4-4,4,4-g3-path7", "32S2-4,4,4-g5-path46", "64S20-4,8,4-g13-path126" ];
s`SolvableDBChildren := [ Strings() | "32S2-4,4,4-g5-path46" ];
