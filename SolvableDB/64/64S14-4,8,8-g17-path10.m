...
s`SolvableDBName := "64S14-4,8,8-g17-path10";
s`SolvableDBFilename := "64S14-4,8,8-g17-path10.m";
...
\[ 22, 5, 54, 41, 6, 40, 4, 46, 12, 18, 24, 1, 11, 15, 29, 60, 64, 27, 14, 33, 32, 9, 35, 28, 30, 62, 34, 13, 19, 21, 23, 25, 26, 10, 59, 63, 49, 45, 7, 2, 39, 43, 8, 61, 3, 42, 53, 52, 55, 51, 48, 50, 16, 38, 57, 58, 37, 44, 31, 47, 56, 20, 17, 36 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path2", "32S10-4,4,8-g7-path9", "64S14-4,8,8-g17-path10" ];
s`SolvableDBParents := [ Strings() | "128S98-4,16,16-g41-path137", "128S98-4,16,16-g41-path138", "128S98-4,16,16-g41-path139", "128S98-4,16,16-g41-path140", "128S4-4,8,8-g33-path135", "128S28-4,8,8-g33-path170", "128S4-4,8,8-g33-path136" ];
