...
s`SolvableDBName := "64S51-32,32,4-g23-path4";
s`SolvableDBFilename := "64S51-32,32,4-g23-path4.m";
...
\[ 6, 1, 17, 14, 16, 13, 8, 3, 2, 4, 5, 7, 25, 15, 27, 24, 23, 10, 9, 11, 12, 18, 35, 26, 33, 36, 34, 20, 19, 21, 22, 28, 42, 44, 41, 43, 29, 30, 31, 32, 51, 49, 52, 50, 37, 38, 39, 40, 58, 60, 57, 59, 45, 46, 47, 48, 63, 64, 61, 62, 53, 54, 55, 56 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,2-g3-path3", "32S16-16,16,2-g7-path3", "64S51-32,32,4-g23-path4" ];
s`SolvableDBParents := [ Strings() | "128S131-32,32,4-g45-path54", "128S153-32,32,4-g45-path113", "128S129-32,32,4-g45-path60" ];
