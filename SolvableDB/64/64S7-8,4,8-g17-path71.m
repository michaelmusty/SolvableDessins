...
s`SolvableDBName := "64S7-8,4,8-g17-path71";
s`SolvableDBFilename := "64S7-8,4,8-g17-path71.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S11-4,2,8-g3-path11", "64S7-8,4,8-g17-path71" ];
s`SolvableDBChildren := [ Strings() | "32S11-4,2,8-g3-path11" ];
