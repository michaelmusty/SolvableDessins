...
s`SolvableDBName := "64S15-8,8,8-g21-path273";
s`SolvableDBFilename := "64S15-8,8,8-g21-path273.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path27", "32S15-8,8,8-g11-path39", "64S15-8,8,8-g21-path273" ];
