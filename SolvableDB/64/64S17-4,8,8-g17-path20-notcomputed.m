...
s`SolvableDBName := "64S17-4,8,8-g17-path20-notcomputed";
s`SolvableDBFilename := "64S17-4,8,8-g17-path20-notcomputed.m";
...
\[ 22, 5, 53, 41, 6, 40, 4, 46, 12, 18, 24, 1, 11, 15, 29, 52, 63, 27, 14, 16, 32, 9, 56, 28, 30, 58, 34, 13, 19, 21, 23, 25, 26, 10, 61, 64, 35, 45, 7, 2, 39, 43, 8, 60, 3, 42, 51, 50, 20, 47, 48, 49, 38, 31, 57, 54, 44, 59, 33, 55, 62, 37, 36, 17 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T10-2,4,4-g1-path4-notcomputed", "32S5-4,8,8-g9-path2-notcomputed", "64S17-4,8,8-g17-path20-notcomputed" ];
