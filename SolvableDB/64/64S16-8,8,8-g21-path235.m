...
s`SolvableDBName := "64S16-8,8,8-g21-path235";
s`SolvableDBFilename := "64S16-8,8,8-g21-path235.m";
...
\[ 6, 1, 8, 16, 20, 23, 4, 24, 2, 3, 5, 7, 26, 22, 13, 35, 19, 36, 37, 39, 18, 38, 40, 41, 17, 42, 9, 10, 11, 12, 14, 15, 21, 25, 51, 52, 53, 54, 55, 43, 56, 57, 27, 28, 29, 30, 31, 32, 33, 34, 46, 63, 62, 64, 58, 44, 60, 45, 47, 48, 49, 50, 61, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T8-4,4,4-g3-path23", "32S14-8,4,4-g7-path8", "64S16-8,8,8-g21-path235" ];
s`SolvableDBParents := [ Strings() | "128S102-8,16,16-g49-path183", "128S102-8,16,16-g49-path184", "128S103-16,8,8-g45-path92", "128S105-16,16,16-g53-path475", "128S105-16,16,16-g53-path476", "128S104-16,8,8-g45-path92", "128S9-8,8,8-g41-path544" ];
