...
\[ 54, 60, 15, 21, 37, 64, 31, 35, 22, 41, 47, 29, 28, 19, 38, 53, 5, 8, 3, 52, 39, 43, 61, 51, 4, 16, 45, 49, 59, 44, 25, 50, 7, 20, 27, 46, 40, 55, 62, 6, 57, 23, 12, 14, 10, 32, 58, 34, 11, 42, 13, 26, 63, 9, 30, 36, 18, 24, 1, 17, 56, 33, 48, 2 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,1,4-g0-path1-notcomputed", "8T2-4,2,4-g1-path1-notcomputed", "16T4-4,4,4-g3-path5-notcomputed", "32S4-8,8,4-g9-path3-notcomputed", "64S17-8,8,4-g17-path14-notcomputed" ];
