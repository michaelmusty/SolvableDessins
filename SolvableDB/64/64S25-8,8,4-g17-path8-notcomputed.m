...
s`SolvableDBName := "64S25-8,8,4-g17-path8-notcomputed";
s`SolvableDBFilename := "64S25-8,8,4-g17-path8-notcomputed.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 63, 26, 51, 50, 40, 34, 33, 9, 36, 62, 45, 44, 52, 13, 12, 19, 60, 55, 48, 59, 10, 49, 56, 11, 14, 15, 16, 17, 18, 20, 21, 23, 25, 31, 32, 35, 37, 43, 61, 42, 53, 57, 58, 54, 64, 47, 46, 38, 39, 41 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T2-4,4,2-g1-path1-notcomputed", "16T10-4,4,2-g1-path3-notcomputed", "32S2-4,4,4-g5-path8-notcomputed", "64S25-8,8,4-g17-path8-notcomputed" ];
