...
s`SolvableDBName := "64S7-8,8,4-g17-path63";
s`SolvableDBFilename := "64S7-8,8,4-g17-path63.m";
...
\[ 32, 29, 33, 13, 56, 20, 40, 7, 6, 48, 57, 28, 12, 15, 44, 62, 61, 41, 50, 2, 46, 10, 51, 59, 17, 25, 22, 8, 36, 4, 16, 9, 38, 54, 31, 1, 34, 27, 24, 30, 64, 35, 26, 52, 43, 45, 42, 53, 60, 47, 49, 55, 3, 58, 18, 39, 63, 23, 11, 37, 21, 19, 5, 14 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T14-8,4,4-g4-path3", "32S10-8,4,4-g7-path32", "64S7-8,8,4-g17-path63" ];
s`SolvableDBParents := [ Strings() | "128S69-16,16,8-g49-path373", "128S69-16,16,8-g49-path374", "128S70-16,16,8-g49-path309", "128S70-16,16,8-g49-path310", "128S11-8,8,4-g33-path1334", "128S3-8,8,4-g33-path800", "128S4-8,8,4-g33-path350" ];
