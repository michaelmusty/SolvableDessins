...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path2", "32S17-8,16,16-g13-path3", "64S29-8,16,16-g25-path26" ];
s`SolvableDBChildren := [ Strings() | "32S17-8,16,16-g13-path3" ];
