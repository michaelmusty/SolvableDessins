...
s`SolvableDBName := "64S23-4,4,4-g9-path304";
s`SolvableDBFilename := "64S23-4,4,4-g9-path304.m";
s`SolvableDBPassportName := "64S23-4,4,4-g9";
s`SolvableDBPathNumber := 304;
...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 45, 53, 13, 60, 32, 64, 61, 30, 52, 36, 21, 56, 33, 12, 17, 19, 20, 22, 10, 55, 38, 11, 14, 15, 16, 18, 25, 26, 31, 34, 35, 40, 62, 54, 47, 42, 44, 37, 63, 59, 51, 50, 49, 48, 58, 46, 41, 57, 39, 43 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path10", "32S6-4,4,4-g5-path7", "64S23-4,4,4-g9-path304" ];
s`SolvableDBParents := [ Strings() | "128S123-8,4,4-g25-path31", "128S122-4,8,4-g25-path55", "128S14-8,8,4-g33-path482", "128S122-4,4,8-g25-path55", "128S14-8,4,8-g33-path482", "128S12-4,8,8-g33-path243", "128S124-8,8,8-g41-path79", "128S21-8,4,4-g25-path280", "128S16-4,8,4-g25-path396", "128S127-8,8,4-g33-path55", "128S16-4,4,8-g25-path396", "128S127-8,4,8-g33-path55", "128S126-4,8,8-g33-path31", "128S25-8,8,8-g41-path592", "128S29-8,4,4-g25-path222", "128S26-4,8,4-g25-path600", "128S127-8,8,4-g33-path56", "128S26-4,4,8-g25-path600", "128S127-8,4,8-g33-path56", "128S126-4,8,8-g33-path32", "128S30-8,8,8-g41-path658", "128S123-8,4,4-g25-path32", "128S122-4,8,4-g25-path56", "128S37-8,8,4-g33-path28", "128S122-4,4,8-g25-path56", "128S37-8,4,8-g33-path28", "128S38-4,8,8-g33-path16", "128S124-8,8,8-g41-path80", "128S125-4,4,4-g17-path79", "128S125-4,4,4-g17-path80", "128S36-4,4,4-g17-path40" ];
