...
s`SolvableDBName := "64S4-4,8,8-g17-path10";
s`SolvableDBFilename := "64S4-4,8,8-g17-path10.m";
...
\[ 22, 5, 52, 39, 6, 38, 4, 44, 12, 18, 24, 1, 11, 15, 28, 51, 63, 26, 14, 58, 31, 9, 54, 27, 29, 33, 13, 19, 21, 23, 25, 20, 10, 61, 47, 43, 7, 2, 37, 41, 8, 59, 3, 40, 57, 50, 62, 49, 46, 48, 45, 36, 55, 56, 42, 30, 16, 64, 53, 35, 17, 60, 34, 32 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path2", "32S5-4,8,8-g9-path18", "64S4-4,8,8-g17-path10" ];
s`SolvableDBParents := [ Strings() | "128S46-8,16,16-g49-path163", "128S46-8,16,16-g49-path164", "128S53-8,16,16-g49-path39", "128S53-8,16,16-g49-path40", "128S47-8,16,16-g49-path131", "128S47-8,16,16-g49-path132", "128S52-8,16,16-g49-path39", "128S52-8,16,16-g49-path40", "128S12-4,8,8-g33-path498", "128S50-4,8,8-g33-path42", "128S51-4,8,8-g33-path109", "128S2-4,8,8-g33-path98", "128S4-4,8,8-g33-path221", "128S48-4,8,8-g33-path42", "128S49-4,8,8-g33-path109" ];
