...
s`SolvableDBName := "64S11-8,8,4-g17-path12";
s`SolvableDBFilename := "64S11-8,8,4-g17-path12.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 63, 54, 34, 31, 11, 16, 42, 9, 53, 43, 64, 41, 21, 13, 12, 61, 38, 51, 57, 62, 46, 59, 44, 10, 14, 15, 17, 18, 19, 20, 23, 25, 26, 32, 33, 35, 36, 37, 48, 60, 52, 58, 50, 47, 45, 55, 40, 56, 39, 49 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S11-4,8,4-g7-path18", "64S11-8,8,4-g17-path12" ];
s`SolvableDBParents := [ Strings() | "128S3-8,8,4-g33-path39", "128S3-8,8,4-g33-path40", "128S27-8,8,4-g33-path86" ];
