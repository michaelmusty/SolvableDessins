...
s`SolvableDBName := "64S49-16,8,8-g23-path12";
s`SolvableDBFilename := "64S49-16,8,8-g23-path12.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T8-4,4,4-g3-path3", "32S14-8,4,4-g7-path14", "64S49-16,8,8-g23-path12" ];
