...
s`SolvableDBName := "64S37-8,4,8-g17-path12";
s`SolvableDBFilename := "64S37-8,4,8-g17-path12.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 50, 61, 51, 62, 60, 16, 56, 9, 36, 34, 15, 43, 64, 13, 12, 46, 42, 37, 14, 39, 58, 49, 53, 10, 11, 17, 18, 19, 20, 21, 23, 25, 26, 31, 32, 33, 35, 40, 55, 47, 45, 48, 63, 57, 54, 44, 59, 38, 52, 41 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path2", "32S6-4,4,4-g5-path22", "64S37-8,4,8-g17-path12" ];
s`SolvableDBParents := [ Strings() | "128S78-8,4,8-g33-path49", "128S78-8,4,8-g33-path50", "128S51-8,4,8-g33-path25", "128S57-8,4,8-g33-path25", "128S86-8,4,8-g33-path49", "128S86-8,4,8-g33-path50", "128S126-8,4,8-g33-path231" ];
