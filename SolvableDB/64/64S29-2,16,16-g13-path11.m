...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-2,8,8-g2-path1", "16T5-2,8,8-g3-path2", "32S17-2,16,16-g7-path2", "64S29-2,16,16-g13-path11" ];
s`SolvableDBChildren := [ Strings() | "32S17-2,16,16-g7-path2" ];
