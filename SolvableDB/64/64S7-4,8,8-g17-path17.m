...
s`SolvableDBName := "64S7-4,8,8-g17-path17";
s`SolvableDBFilename := "64S7-4,8,8-g17-path17.m";
...
\[ 2, 9, 10, 7, 11, 1, 12, 13, 6, 34, 38, 28, 17, 18, 39, 40, 29, 41, 30, 31, 25, 32, 33, 5, 42, 43, 3, 4, 8, 22, 37, 19, 44, 27, 45, 46, 47, 24, 36, 58, 48, 61, 54, 59, 55, 15, 20, 14, 56, 52, 49, 53, 57, 62, 64, 63, 50, 60, 23, 16, 21, 26, 51, 35 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path9", "32S10-4,4,8-g7-path6", "64S7-4,8,8-g17-path17" ];
s`SolvableDBParents := [ Strings() | "128S69-8,16,16-g49-path435", "128S70-8,16,16-g49-path371", "128S69-8,16,16-g49-path436", "128S70-8,16,16-g49-path372", "128S3-4,8,8-g33-path863", "128S11-4,8,8-g33-path1397", "128S4-4,8,8-g33-path413" ];
