...
s`SolvableDBName := "64S32-4,2,8-g5-path1";
s`SolvableDBFilename := "64S32-4,2,8-g5-path1.m";
...
\[ 6, 1, 4, 21, 19, 8, 15, 2, 3, 5, 7, 16, 17, 18, 26, 47, 45, 48, 25, 39, 9, 38, 34, 40, 10, 11, 12, 13, 14, 20, 22, 23, 24, 41, 42, 43, 44, 52, 51, 53, 32, 58, 59, 64, 28, 61, 27, 29, 60, 35, 30, 31, 33, 36, 37, 46, 49, 50, 54, 62, 63, 57, 56, 55 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S6-4,2,4-g1-path4", "64S32-4,2,8-g5-path1" ];
s`SolvableDBParents := [ Strings() | "128S48-8,2,8-g17-path11", "128S136-4,4,8-g25-path22", "128S137-8,4,8-g33-path11", "128S77-8,2,8-g17-path11", "128S134-4,4,8-g25-path22", "128S135-8,4,8-g33-path11", "128S135-8,2,8-g17-path11", "128S83-4,4,8-g25-path22", "128S86-8,4,8-g33-path11", "128S137-8,2,8-g17-path11", "128S122-4,4,8-g25-path434", "128S58-8,4,8-g33-path11", "128S75-4,2,8-g9-path11", "128S134-4,2,8-g9-path11", "128S136-4,2,8-g9-path11" ];
