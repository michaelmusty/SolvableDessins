...
s`SolvableDBName := "64S4-4,8,8-g17-path29";
s`SolvableDBFilename := "64S4-4,8,8-g17-path29.m";
...
\[ 6, 1, 26, 27, 23, 9, 4, 28, 2, 3, 5, 7, 8, 50, 44, 54, 13, 64, 31, 51, 60, 29, 36, 21, 61, 33, 12, 17, 19, 20, 22, 18, 10, 38, 56, 11, 14, 15, 16, 24, 25, 30, 32, 34, 35, 47, 62, 55, 41, 53, 42, 45, 37, 63, 59, 52, 46, 48, 58, 40, 49, 57, 39, 43 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path2", "32S6-4,4,4-g5-path9", "64S4-4,8,8-g17-path29" ];
s`SolvableDBParents := [ Strings() | "128S46-8,16,16-g49-path143", "128S46-8,16,16-g49-path144", "128S53-8,16,16-g49-path19", "128S53-8,16,16-g49-path20", "128S47-8,16,16-g49-path111", "128S47-8,16,16-g49-path112", "128S52-8,16,16-g49-path19", "128S52-8,16,16-g49-path20", "128S12-4,8,8-g33-path488", "128S50-4,8,8-g33-path32", "128S51-4,8,8-g33-path99", "128S2-4,8,8-g33-path88", "128S4-4,8,8-g33-path211", "128S48-4,8,8-g33-path32", "128S49-4,8,8-g33-path99" ];
