...
s`SolvableDBName := "64S13-4,8,8-g17-path54";
s`SolvableDBFilename := "64S13-4,8,8-g17-path54.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S8-4,8,8-g9-path8", "64S13-4,8,8-g17-path54" ];
