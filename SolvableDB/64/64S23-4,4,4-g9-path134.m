...
s`SolvableDBName := "64S23-4,4,4-g9-path134";
s`SolvableDBFilename := "64S23-4,4,4-g9-path134.m";
...
[ 58, 60, 30, 29, 20, 49, 15, 39, 26, 50, 8, 45, 41, 24, 28, 2, 51, 46, 11, 9, 10, 16, 17, 44, 27, 5, 52, 40, 13, 33, 61, 18, 48, 54, 57, 32, 14, 62, 19, 7, 4, 55, 25, 37, 6, 36, 42, 3, 12, 53, 56, 43, 21, 31, 63, 23, 59, 38, 64, 22, 34, 1, 47, 35 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S2-4,4,4-g5-path5", "64S23-4,4,4-g9-path134" ];
s`SolvableDBChildren := [ Strings() | "32S2-4,4,4-g5-path5" ];
