...
s`SolvableDBName := "64S17-4,8,8-g17-path192";
s`SolvableDBFilename := "64S17-4,8,8-g17-path192.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 36, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 45, 17, 43, 30, 32, 37, 13, 14, 18, 21, 28, 29, 35, 41, 31, 42, 51, 56, 34, 46, 33, 49, 48, 50, 54, 55, 52, 38, 40, 44, 47, 53, 58, 61, 60, 62, 63, 64, 57, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S5-2,8,8-g5-path8", "64S17-4,8,8-g17-path192" ];
s`SolvableDBParents := [ Strings() | "128S106-8,16,16-g49-path24", "128S108-4,16,16-g41-path24", "128S9-8,8,8-g41-path636", "128S111-4,16,16-g41-path47", "128S10-8,8,8-g41-path47", "128S110-8,16,16-g49-path47", "128S111-4,16,16-g41-path48", "128S10-8,8,8-g41-path48", "128S110-8,16,16-g49-path48", "128S109-8,16,16-g49-path24", "128S107-4,16,16-g41-path24", "128S7-8,8,8-g41-path24", "128S106-4,16,16-g41-path24", "128S5-8,8,8-g41-path24", "128S108-8,16,16-g49-path24", "128S111-8,16,16-g49-path47", "128S110-4,16,16-g41-path47", "128S15-8,8,8-g41-path47", "128S111-8,16,16-g49-path48", "128S110-4,16,16-g41-path48", "128S15-8,8,8-g41-path48", "128S109-4,16,16-g41-path24", "128S13-8,8,8-g41-path24", "128S107-8,16,16-g49-path24", "128S14-4,8,8-g33-path47", "128S14-4,8,8-g33-path48", "128S12-4,8,8-g33-path24", "128S8-4,8,8-g33-path24", "128S11-4,8,8-g33-path47", "128S11-4,8,8-g33-path48", "128S6-4,8,8-g33-path24" ];
s`SolvableDBChild := "32S5-2,8,8-g5-path8";
