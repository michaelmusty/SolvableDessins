...
s`SolvableDBName := "64S27-4,16,16-g21-path8";
s`SolvableDBFilename := "64S27-4,16,16-g21-path8.m";
...
\[ 12, 32, 17, 7, 2, 5, 27, 16, 20, 29, 13, 9, 24, 3, 18, 10, 25, 40, 4, 1, 26, 11, 28, 22, 14, 47, 19, 35, 8, 31, 33, 6, 34, 30, 36, 23, 15, 41, 42, 37, 51, 53, 21, 45, 49, 48, 43, 50, 62, 55, 52, 38, 54, 39, 46, 57, 60, 59, 61, 64, 63, 44, 58, 56 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T5-2,8,8-g3-path1", "32S17-4,16,16-g11-path3", "64S27-4,16,16-g21-path8" ];
s`SolvableDBParents := [ Strings() | "128S44-8,16,16-g49-path113", "128S130-4,32,32-g45-path37", "128S130-8,32,32-g53-path37", "128S43-8,16,16-g49-path19", "128S130-4,32,32-g45-path38", "128S130-8,32,32-g53-path38", "128S106-4,16,16-g41-path293" ];
