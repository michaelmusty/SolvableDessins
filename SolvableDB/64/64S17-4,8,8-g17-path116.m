...
s`SolvableDBName := "64S17-4,8,8-g17-path116";
s`SolvableDBFilename := "64S17-4,8,8-g17-path116.m";
...
\[ 22, 5, 55, 41, 6, 40, 4, 47, 12, 18, 24, 1, 11, 15, 29, 61, 63, 27, 14, 16, 32, 9, 57, 28, 30, 48, 34, 13, 19, 21, 23, 25, 26, 10, 53, 64, 35, 46, 7, 2, 39, 43, 8, 33, 59, 3, 42, 44, 54, 37, 52, 49, 50, 51, 38, 58, 60, 45, 56, 31, 62, 20, 36, 17 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path26", "32S2-4,4,4-g5-path69", "64S17-4,8,8-g17-path116" ];
s`SolvableDBParents := [ Strings() | "128S106-8,16,16-g49-path78", "128S108-4,16,16-g41-path78", "128S9-8,8,8-g41-path690", "128S111-4,16,16-g41-path155", "128S10-8,8,8-g41-path155", "128S110-8,16,16-g49-path155", "128S111-4,16,16-g41-path156", "128S10-8,8,8-g41-path156", "128S110-8,16,16-g49-path156", "128S109-8,16,16-g49-path78", "128S107-4,16,16-g41-path78", "128S7-8,8,8-g41-path78", "128S106-4,16,16-g41-path78", "128S5-8,8,8-g41-path78", "128S108-8,16,16-g49-path78", "128S111-8,16,16-g49-path155", "128S110-4,16,16-g41-path155", "128S15-8,8,8-g41-path155", "128S111-8,16,16-g49-path156", "128S110-4,16,16-g41-path156", "128S15-8,8,8-g41-path156", "128S109-4,16,16-g41-path78", "128S13-8,8,8-g41-path78", "128S107-8,16,16-g49-path78", "128S14-4,8,8-g33-path155", "128S14-4,8,8-g33-path156", "128S12-4,8,8-g33-path78", "128S8-4,8,8-g33-path78", "128S11-4,8,8-g33-path155", "128S11-4,8,8-g33-path156", "128S6-4,8,8-g33-path78" ];
s`SolvableDBChild := "32S2-4,4,4-g5-path69";
