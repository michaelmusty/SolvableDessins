...
s`SolvableDBName := "64S21-8,4,4-g13-path9-notcomputed";
s`SolvableDBFilename := "64S21-8,4,4-g13-path9-notcomputed.m";
...
\[ 49, 62, 51, 34, 31, 33, 54, 35, 56, 61, 50, 47, 59, 32, 52, 48, 60, 64, 28, 9, 53, 38, 37, 13, 12, 17, 63, 55, 10, 36, 41, 46, 44, 39, 45, 58, 57, 43, 7, 18, 2, 27, 11, 5, 16, 3, 20, 29, 25, 24, 26, 40, 42, 19, 4, 1, 15, 21, 22, 14, 8, 6, 30, 23 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T14-8,4,4-g4-path1-notcomputed", "32S14-8,4,4-g7-path2-notcomputed", "64S21-8,4,4-g13-path9-notcomputed" ];
