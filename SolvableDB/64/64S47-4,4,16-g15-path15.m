...
s`SolvableDBName := "64S47-4,4,16-g15-path15";
s`SolvableDBFilename := "64S47-4,4,16-g15-path15.m";
...
\[ 12, 25, 4, 7, 2, 5, 24, 27, 19, 11, 13, 9, 17, 18, 14, 20, 10, 21, 1, 22, 15, 41, 43, 3, 6, 29, 26, 30, 8, 31, 33, 36, 28, 32, 37, 38, 39, 34, 57, 59, 16, 45, 42, 46, 23, 47, 49, 52, 44, 48, 53, 54, 55, 50, 64, 61, 35, 60, 58, 40, 62, 63, 56, 51 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T8-4,4,4-g3-path15", "32S14-4,4,8-g7-path8", "64S47-4,4,16-g15-path15" ];
s`SolvableDBParents := [ Strings() | "128S103-8,8,16-g45-path107", "128S103-8,8,16-g45-path108", "128S155-4,4,32-g31-path3", "128S157-8,8,32-g47-path5", "128S156-4,4,32-g31-path3", "128S157-8,8,32-g47-path6", "128S112-4,4,16-g29-path278" ];
