...
\[ 41, 61, 13, 18, 20, 16, 10, 57, 22, 38, 43, 28, 27, 56, 47, 2, 48, 36, 21, 37, 8, 46, 58, 3, 5, 7, 53, 54, 44, 40, 42, 29, 35, 49, 17, 50, 6, 4, 62, 19, 9, 51, 63, 14, 59, 12, 32, 52, 31, 26, 23, 64, 11, 1, 34, 60, 39, 55, 33, 15, 25, 30, 24, 45 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path1", "32S11-8,4,4-g7-path2", "64S10-8,4,8-g17-path19" ];
s`SolvableDBParents := [ Strings() | "128S87-16,4,16-g41-path33", "128S88-16,4,16-g41-path99", "128S87-16,4,16-g41-path34", "128S88-16,4,16-g41-path100", "128S4-8,4,8-g33-path50", "128S2-8,4,8-g33-path17", "128S27-8,4,8-g33-path50" ];
