...
s`SolvableDBName := "64S4-8,4,8-g17-path27";
s`SolvableDBFilename := "64S4-8,4,8-g17-path27.m";
...
\[ 6, 1, 26, 27, 23, 28, 4, 29, 2, 3, 5, 7, 8, 22, 47, 60, 44, 14, 53, 34, 37, 59, 9, 21, 46, 58, 42, 11, 62, 19, 20, 13, 55, 50, 63, 10, 12, 15, 16, 17, 18, 24, 25, 30, 31, 32, 33, 35, 57, 48, 61, 64, 51, 49, 52, 38, 41, 39, 54, 36, 40, 43, 45, 56 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path5", "32S6-4,4,4-g5-path16", "64S4-8,4,8-g17-path27" ];
s`SolvableDBParents := [ Strings() | "128S53-16,8,16-g49-path23", "128S53-16,8,16-g49-path24", "128S46-16,8,16-g49-path147", "128S46-16,8,16-g49-path148", "128S52-16,8,16-g49-path23", "128S52-16,8,16-g49-path24", "128S47-16,8,16-g49-path115", "128S47-16,8,16-g49-path116", "128S12-8,4,8-g33-path490", "128S50-8,4,8-g33-path34", "128S51-8,4,8-g33-path101", "128S2-8,4,8-g33-path90", "128S4-8,4,8-g33-path213", "128S48-8,4,8-g33-path34", "128S49-8,4,8-g33-path101" ];
