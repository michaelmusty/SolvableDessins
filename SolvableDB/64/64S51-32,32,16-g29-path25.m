...
s`SolvableDBName := "64S51-32,32,16-g29-path25";
s`SolvableDBFilename := "64S51-32,32,16-g29-path25.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 45, 47, 17, 56, 14, 21, 54, 22, 36, 53, 49, 41, 57, 19, 20, 23, 10, 44, 31, 9, 11, 12, 13, 18, 27, 28, 29, 30, 32, 52, 48, 64, 55, 42, 62, 60, 43, 46, 38, 33, 34, 61, 63, 37, 39, 50, 59, 35, 40, 51, 58 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T5-8,8,4-g5-path2", "32S16-16,16,8-g13-path18", "64S51-32,32,16-g29-path25" ];
s`SolvableDBParents := [ Strings() | "128S131-32,32,16-g57-path236", "128S153-32,32,16-g57-path236", "128S129-32,32,16-g57-path130" ];
