...
[ 8, 13, 18, 1, 12, 23, 2, 31, 34, 36, 33, 9, 40, 27, 3, 30, 5, 37, 4, 15, 16, 7, 11, 14, 6, 17, 39, 35, 51, 29, 52, 54, 32, 58, 10, 55, 57, 59, 38, 60, 24, 21, 19, 25, 22, 20, 26, 28, 41, 45, 62, 53, 49, 61, 63, 50, 56, 64, 43, 46, 42, 44, 47, 48 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,2,8-g3-path7", "32S17-16,4,16-g11-path7", "64S29-16,4,16-g21-path16" ];
s`SolvableDBChildren := [ Strings() | "32S17-16,4,16-g11-path7" ];
