...
s`SolvableDBName := "64S7-4,8,8-g17-path10";
s`SolvableDBFilename := "64S7-4,8,8-g17-path10.m";
...
\[ 22, 5, 54, 41, 6, 40, 4, 47, 12, 18, 24, 1, 11, 15, 29, 60, 63, 27, 14, 16, 32, 9, 56, 28, 30, 48, 34, 13, 19, 21, 23, 25, 26, 10, 37, 64, 50, 46, 7, 2, 39, 43, 8, 33, 59, 3, 42, 44, 53, 61, 52, 49, 51, 38, 57, 58, 45, 31, 55, 62, 35, 20, 36, 17 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T12-4,2,8-g2-path2", "32S10-4,4,8-g7-path28", "64S7-4,8,8-g17-path10" ];
s`SolvableDBParents := [ Strings() | "128S70-4,16,16-g41-path271", "128S70-4,16,16-g41-path272", "128S69-4,16,16-g41-path335", "128S69-4,16,16-g41-path336", "128S11-4,8,8-g33-path1355", "128S3-4,8,8-g33-path821", "128S4-4,8,8-g33-path371" ];
