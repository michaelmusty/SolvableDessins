...
s`SolvableDBName := "64S39-4,16,4-g15-path38";
s`SolvableDBFilename := "64S39-4,16,4-g15-path38.m";
...
\[ 20, 5, 25, 24, 6, 30, 4, 23, 12, 16, 8, 1, 11, 44, 34, 22, 7, 27, 26, 9, 32, 28, 13, 17, 19, 3, 21, 10, 33, 2, 37, 18, 15, 29, 60, 49, 43, 50, 45, 48, 31, 46, 41, 39, 14, 36, 53, 38, 42, 40, 58, 51, 59, 62, 61, 63, 47, 64, 57, 55, 35, 56, 54, 52 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S9-4,8,2-g3-path10", "64S39-4,16,4-g15-path38" ];
s`SolvableDBParents := [ Strings() | "128S64-8,16,4-g37-path17", "128S94-8,16,4-g37-path54", "128S64-8,16,4-g37-path18", "128S97-8,16,4-g37-path54", "128S80-4,16,4-g29-path17", "128S112-4,16,4-g29-path238", "128S80-4,16,4-g29-path18" ];
