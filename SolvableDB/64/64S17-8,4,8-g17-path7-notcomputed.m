...
s`SolvableDBName := "64S17-8,4,8-g17-path7-notcomputed";
s`SolvableDBFilename := "64S17-8,4,8-g17-path7-notcomputed.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 23, 52, 47, 44, 14, 33, 56, 38, 60, 58, 9, 21, 59, 54, 43, 11, 17, 19, 20, 22, 10, 46, 40, 35, 12, 13, 15, 16, 18, 25, 26, 31, 32, 34, 36, 37, 57, 48, 62, 50, 41, 61, 63, 42, 53, 39, 55, 45, 64, 49, 51 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T5-4,4,4-g2-path1-notcomputed", "16T8-4,4,4-g3-path15-notcomputed", "32S2-4,4,4-g5-path13-notcomputed", "64S17-8,4,8-g17-path7-notcomputed" ];
