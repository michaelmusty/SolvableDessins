...
s`SolvableDBName := "64S44-16,16,8-g25-path63";
s`SolvableDBFilename := "64S44-16,16,8-g25-path63.m";
...
\[ 58, 59, 53, 50, 55, 52, 62, 39, 40, 42, 57, 54, 43, 63, 36, 56, 37, 64, 34, 60, 48, 49, 46, 61, 47, 41, 19, 25, 38, 21, 22, 51, 23, 32, 20, 13, 44, 28, 30, 31, 45, 33, 35, 24, 4, 7, 14, 18, 6, 12, 5, 2, 26, 10, 29, 8, 27, 9, 17, 16, 1, 3, 11, 15 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T1-16,16,8-g7-path2", "32S16-16,16,8-g13-path4", "64S44-16,16,8-g25-path63" ];
s`SolvableDBParents := [ Strings() | "128S153-32,32,16-g57-path55", "128S153-32,32,16-g57-path56", "128S154-32,32,16-g57-path55", "128S154-32,32,16-g57-path56", "128S106-16,16,8-g49-path423", "128S102-16,16,8-g49-path310", "128S99-16,16,8-g49-path310" ];
