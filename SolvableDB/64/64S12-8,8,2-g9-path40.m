...
s`SolvableDBName := "64S12-8,8,2-g9-path40";
s`SolvableDBFilename := "64S12-8,8,2-g9-path40.m";
...
\[ 6, 1, 20, 21, 18, 22, 4, 2, 3, 5, 7, 37, 23, 32, 40, 38, 41, 39, 16, 15, 34, 42, 17, 8, 9, 10, 11, 12, 13, 14, 19, 36, 28, 56, 57, 54, 35, 52, 55, 51, 53, 43, 24, 25, 26, 27, 29, 30, 31, 33, 44, 64, 59, 63, 58, 46, 62, 45, 47, 48, 49, 50, 60, 61 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path5", "32S9-8,4,2-g3-path5", "64S12-8,8,2-g9-path40" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,4-g33-path62", "128S28-8,8,4-g33-path29", "128S93-16,8,2-g21-path29", "128S92-16,8,4-g37-path29", "128S92-16,8,2-g21-path29", "128S94-16,8,4-g37-path29", "128S93-8,16,2-g21-path29", "128S92-8,16,4-g37-path29", "128S92-8,16,2-g21-path29", "128S94-8,16,4-g37-path29", "128S89-16,16,2-g25-path29", "128S91-16,16,4-g41-path29", "128S91-16,16,2-g25-path29", "128S90-16,16,4-g41-path29", "128S2-8,8,2-g17-path62" ];
