...
s`SolvableDBName := "64S26-16,8,16-g25-path37";
s`SolvableDBFilename := "64S26-16,8,16-g25-path37.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 35, 36, 37, 13, 41, 43, 44, 17, 45, 18, 14, 47, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 40, 42, 57, 31, 52, 59, 54, 39, 60, 56, 58, 33, 61, 38, 27, 28, 29, 30, 32, 34, 46, 48, 63, 49, 64, 62, 50, 51, 53, 55 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T4-4,4,4-g3-path6", "32S3-8,4,8-g9-path10", "64S26-16,8,16-g25-path37" ];
s`SolvableDBParents := [ Strings() | "128S128-32,16,32-g57-path83", "128S129-32,16,32-g57-path83", "128S128-32,16,32-g57-path84", "128S129-32,16,32-g57-path84", "128S106-16,8,16-g49-path269", "128S42-16,8,16-g49-path89", "128S44-16,8,16-g49-path89" ];
