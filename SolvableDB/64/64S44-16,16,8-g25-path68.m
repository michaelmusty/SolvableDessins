...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path6", "32S17-16,16,8-g13-path12", "64S44-16,16,8-g25-path68" ];
s`SolvableDBChildren := [ Strings() | "32S17-16,16,8-g13-path12" ];
