...
s`SolvableDBName := "64S50-16,32,32-g29-path3-notcomputed";
s`SolvableDBFilename := "64S50-16,32,32-g29-path3-notcomputed.m";
...
\[ 55, 59, 57, 35, 27, 28, 38, 62, 52, 54, 42, 61, 58, 30, 32, 43, 37, 29, 31, 13, 9, 56, 44, 10, 16, 46, 24, 64, 47, 41, 60, 48, 26, 50, 63, 34, 51, 45, 12, 17, 23, 18, 33, 15, 11, 36, 22, 3, 2, 40, 20, 5, 8, 6, 49, 19, 53, 25, 21, 4, 14, 39, 7, 1 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-2,4,4-g1-path4-notcomputed", "16T5-4,8,8-g5-path3-notcomputed", "32S16-8,16,16-g13-path6-notcomputed", "64S50-16,32,32-g29-path3-notcomputed" ];
s`SolvableDBChild := "32S16-8,16,16-g13-path6-notcomputed";
