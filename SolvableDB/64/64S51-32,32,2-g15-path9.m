...
s`SolvableDBName := "64S51-32,32,2-g15-path9";
s`SolvableDBFilename := "64S51-32,32,2-g15-path9.m";
...
\[ 6, 1, 17, 14, 13, 18, 4, 2, 3, 5, 7, 26, 12, 15, 25, 9, 28, 27, 16, 10, 8, 11, 19, 20, 35, 36, 33, 34, 21, 22, 23, 24, 42, 41, 44, 43, 29, 30, 31, 32, 51, 52, 49, 50, 37, 38, 39, 40, 58, 57, 60, 59, 45, 46, 47, 48, 63, 61, 64, 62, 53, 54, 55, 56 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T5-8,8,2-g3-path4", "32S16-16,16,2-g7-path5", "64S51-32,32,2-g15-path9" ];
s`SolvableDBParents := [ Strings() | "128S153-32,32,4-g45-path105", "128S129-32,32,4-g45-path52", "128S131-32,32,2-g29-path55" ];
