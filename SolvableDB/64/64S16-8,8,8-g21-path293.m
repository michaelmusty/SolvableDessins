...
s`SolvableDBName := "64S16-8,8,8-g21-path293";
s`SolvableDBFilename := "64S16-8,8,8-g21-path293.m";
s`SolvableDBPathNumber := 293;
...
[ 52, 23, 58, 30, 63, 57, 60, 28, 6, 64, 48, 62, 50, 43, 54, 12, 38, 56, 36, 61, 37, 47, 27, 10, 42, 44, 1, 53, 20, 40, 45, 26, 35, 19, 18, 25, 41, 34, 21, 7, 33, 51, 49, 15, 22, 13, 55, 59, 31, 32, 17, 9, 3, 46, 14, 39, 2, 24, 5, 16, 11, 4, 29, 8 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T8-4,4,4-g3-path5", "32S15-8,8,8-g11-path57", "64S16-8,8,8-g21-path293" ];
