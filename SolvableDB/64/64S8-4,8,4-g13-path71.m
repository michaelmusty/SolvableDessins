...
s`SolvableDBName := "64S8-4,8,4-g13-path71";
s`SolvableDBFilename := "64S8-4,8,4-g13-path71.m";
...
\[ 19, 5, 33, 23, 6, 29, 4, 22, 12, 16, 8, 1, 11, 45, 25, 21, 34, 10, 9, 32, 18, 13, 28, 3, 20, 24, 31, 7, 2, 37, 17, 15, 26, 27, 61, 49, 43, 50, 44, 46, 30, 48, 41, 14, 39, 38, 53, 36, 42, 40, 58, 64, 59, 51, 47, 63, 60, 62, 55, 35, 57, 54, 52, 56 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path3", "32S9-4,8,2-g3-path11", "64S8-4,8,4-g13-path71" ];
s`SolvableDBParents := [ Strings() | "128S81-8,16,4-g37-path48", "128S82-8,16,4-g37-path121", "128S73-8,16,4-g37-path14", "128S74-8,16,4-g37-path53", "128S79-4,16,4-g29-path112", "128S2-8,8,4-g33-path239", "128S80-4,16,4-g29-path270", "128S3-8,8,4-g33-path953", "128S71-4,16,4-g29-path32", "128S77-8,8,4-g33-path58", "128S72-4,16,4-g29-path110", "128S78-8,8,4-g33-path141", "128S26-4,8,4-g25-path888", "128S75-4,8,4-g25-path76", "128S76-4,8,4-g25-path198" ];
