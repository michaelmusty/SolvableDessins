...
I<[x]> := ideal< P | [
x[2]^4*x[3]^2 + 2*x[1]*x[2]^3 + x[2]^4 - 2*x[1]*x[2] - 2*x[2]^2 + x[3]^2 - 1,
...
s`SolvableDBName := "64S32-4,4,8-g13-path1";
s`SolvableDBFilename := "64S32-4,4,8-g13-path1.m";
...
s`SolvableDBParents := [ Strings() | "128S134-8,4,8-g33-path1", "128S77-4,8,8-g33-path1", "128S137-8,8,8-g41-path3", "128S136-8,4,8-g33-path1", "128S58-4,8,8-g33-path3", "128S135-8,8,8-g41-path3", "128S136-8,4,8-g33-path2", "128S48-4,8,8-g33-path1", "128S135-8,8,8-g41-path4", "128S134-8,4,8-g33-path2", "128S86-4,8,8-g33-path3", "128S137-8,8,8-g41-path4", "128S83-4,4,8-g25-path4", "128S75-4,4,8-g25-path2", "128S122-4,4,8-g25-path16" ];
