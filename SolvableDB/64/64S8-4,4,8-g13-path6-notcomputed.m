...
s`SolvableDBName := "64S8-4,4,8-g13-path6-notcomputed";
s`SolvableDBFilename := "64S8-4,4,8-g13-path6-notcomputed.m";
...
\[ 2, 5, 9, 10, 6, 1, 4, 11, 15, 19, 12, 22, 16, 28, 21, 29, 25, 30, 7, 23, 3, 8, 17, 18, 20, 31, 32, 26, 34, 41, 14, 33, 39, 13, 38, 47, 42, 37, 27, 45, 24, 35, 40, 48, 49, 50, 44, 36, 43, 51, 56, 55, 62, 57, 54, 46, 52, 61, 58, 63, 64, 60, 53, 59 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T13-2,2,8-g0-path1-notcomputed", "32S9-2,4,8-g3-path5-notcomputed", "64S8-4,4,8-g13-path6-notcomputed" ];
