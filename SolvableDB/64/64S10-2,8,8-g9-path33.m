...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 26, 27, 28, 29, 21, 22, 19, 23, 17, 30, 15, 16, 18, 31, 32, 11, 12, 13, 14, 20, 24, 25, 57, 58, 52, 38, 39, 36, 37, 55, 47, 49, 50, 48, 51, 53, 41, 44, 42, 43, 45, 35, 46, 59, 40, 60, 33, 34, 54, 56, 62, 61, 64, 63 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path3", "32S7-2,8,8-g5-path5", "64S10-2,8,8-g9-path33" ];
s`SolvableDBParents := [ Strings() | "128S4-4,8,8-g33-path30", "128S27-4,8,8-g33-path30", "128S87-2,16,16-g25-path59", "128S88-4,16,16-g41-path59", "128S87-2,16,16-g25-path60", "128S88-4,16,16-g41-path60", "128S2-2,8,8-g17-path30" ];
