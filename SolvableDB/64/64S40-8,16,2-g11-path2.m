...
s`SolvableDBName := "64S40-8,16,2-g11-path2";
s`SolvableDBFilename := "64S40-8,16,2-g11-path2.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S9-4,8,2-g3-path10", "64S40-8,16,2-g11-path2" ];
