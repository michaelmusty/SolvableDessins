...
I<[x]> := ideal< P | [
x[1]^6*x[2]^2 - x[1]^6 + x[2]^2*x[3]^4 + x[3]^4,
x[2]^2*x[3]^6 + x[1]^5*x[2]^2 + x[3]^6 - x[1]^5,
x[1]*x[3]^2 - 1
] >;
...
s`SolvableDBName := "64S48-4,4,16-g15-path3";
s`SolvableDBFilename := "64S48-4,4,16-g15-path3.m";
...
s`SolvableDBParents := [ Strings() | "128S158-8,4,32-g39-path3", "128S158-4,8,32-g39-path3", "128S104-8,8,16-g45-path9", "128S158-8,4,32-g39-path4", "128S158-4,8,32-g39-path4", "128S104-8,8,16-g45-path10", "128S112-4,4,16-g29-path23" ];
