...
\[ 2, 5, 9, 10, 6, 1, 4, 11, 15, 19, 12, 23, 21, 30, 22, 13, 26, 27, 7, 24, 31, 3, 8, 17, 18, 20, 32, 33, 34, 28, 16, 25, 14, 35, 41, 42, 47, 39, 36, 44, 29, 38, 40, 48, 49, 50, 45, 43, 37, 51, 58, 57, 62, 55, 52, 60, 54, 46, 56, 63, 64, 61, 59, 53 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path2", "32S19-2,4,16-g4-path3", "64S39-4,4,16-g15-path2" ];
s`SolvableDBParents := [ Strings() | "128S64-8,4,16-g37-path7", "128S94-8,4,16-g37-path49", "128S64-8,4,16-g37-path8", "128S97-8,4,16-g37-path49", "128S80-4,4,16-g29-path19", "128S112-4,4,16-g29-path239", "128S80-4,4,16-g29-path20" ];
