...
\[ 6, 1, 18, 22, 20, 23, 4, 24, 2, 3, 5, 7, 8, 33, 13, 15, 28, 27, 21, 9, 16, 10, 11, 26, 17, 19, 12, 31, 32, 41, 14, 25, 29, 30, 42, 49, 39, 34, 38, 44, 35, 37, 40, 47, 48, 58, 36, 43, 45, 46, 57, 64, 50, 55, 53, 60, 54, 51, 56, 62, 63, 52, 59, 61 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path2", "32S9-4,2,8-g3-path11", "64S13-8,4,8-g17-path68" ];
s`SolvableDBParents := [ Strings() | "128S96-8,4,16-g37-path11", "128S95-8,4,16-g37-path21", "128S95-8,4,16-g37-path22", "128S97-8,4,16-g37-path11", "128S3-8,4,8-g33-path181", "128S3-8,4,8-g33-path182", "128S28-8,4,8-g33-path70" ];
