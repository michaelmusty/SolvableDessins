...
s`SolvableDBName := "64S40-8,16,4-g19-path14";
s`SolvableDBFilename := "64S40-8,16,4-g19-path14.m";
...
\[ 6, 1, 21, 22, 19, 23, 8, 24, 2, 3, 4, 5, 7, 43, 34, 33, 26, 10, 9, 32, 27, 13, 12, 29, 16, 28, 25, 31, 11, 14, 15, 17, 18, 20, 59, 49, 45, 50, 30, 48, 44, 46, 41, 37, 39, 36, 35, 38, 40, 42, 58, 62, 61, 51, 47, 64, 60, 63, 57, 53, 55, 56, 52, 54 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path2", "32S9-4,8,2-g3-path15", "64S40-8,16,4-g19-path14" ];
s`SolvableDBParents := [ Strings() | "128S95-8,16,4-g37-path120", "128S92-8,16,4-g37-path58", "128S114-8,16,4-g37-path213", "128S63-8,16,4-g37-path36", "128S82-8,16,4-g37-path30", "128S81-8,16,4-g37-path13", "128S64-8,16,4-g37-path76" ];
