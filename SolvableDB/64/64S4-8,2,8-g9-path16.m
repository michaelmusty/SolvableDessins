...
s`SolvableDBName := "64S4-8,2,8-g9-path16";
s`SolvableDBFilename := "64S4-8,2,8-g9-path16.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 41, 49, 43, 50, 42, 32, 51, 52, 31, 37, 44, 8, 9, 10, 11, 12, 13, 14, 20, 23, 24, 25, 39, 45, 40, 46, 38, 47, 48, 30, 58, 63, 62, 59, 60, 61, 64, 57, 33, 28, 35, 27, 26, 29, 34, 36, 53, 54, 55, 56 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S5-8,2,8-g5-path7", "64S4-8,2,8-g9-path16" ];
s`SolvableDBParents := [ Strings() | "128S4-8,4,8-g33-path183", "128S49-8,4,8-g33-path71", "128S51-8,4,8-g33-path71", "128S12-8,4,8-g33-path460", "128S46-16,2,16-g25-path89", "128S47-16,4,16-g41-path73", "128S53-16,2,16-g25-path27", "128S52-16,4,16-g41-path27", "128S52-16,2,16-g25-path27", "128S53-16,4,16-g41-path27", "128S47-16,2,16-g25-path73", "128S46-16,4,16-g41-path89", "128S50-8,2,8-g17-path49", "128S48-8,2,8-g17-path49", "128S2-8,2,8-g17-path105" ];
