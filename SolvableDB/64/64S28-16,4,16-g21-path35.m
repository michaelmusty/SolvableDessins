...
s`SolvableDBName := "64S28-16,4,16-g21-path35";
s`SolvableDBFilename := "64S28-16,4,16-g21-path35.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T6-8,4,8-g5-path5", "32S4-8,4,8-g9-path25", "64S28-16,4,16-g21-path35" ];
s`SolvableDBChildren := [ Strings() | "32S4-8,4,8-g9-path25" ];
