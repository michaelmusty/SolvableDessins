...
\[ 44, 48, 59, 39, 52, 62, 17, 19, 45, 43, 23, 22, 50, 55, 63, 64, 29, 46, 57, 14, 34, 58, 54, 3, 38, 5, 47, 6, 4, 41, 51, 16, 15, 9, 42, 21, 40, 60, 27, 35, 25, 49, 53, 8, 32, 56, 61, 26, 33, 12, 24, 28, 13, 1, 30, 31, 11, 10, 18, 20, 7, 2, 37, 36 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-4,4,2-g1-path4-notcomputed", "16T6-8,8,2-g3-path1-notcomputed", "32S5-8,8,2-g5-path7-notcomputed", "64S4-8,8,2-g9-path2-notcomputed" ];
