...
s`SolvableDBName := "64S7-8,4,8-g17-path34";
s`SolvableDBFilename := "64S7-8,4,8-g17-path34.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 44, 57, 55, 56, 14, 49, 48, 9, 35, 61, 31, 64, 34, 13, 12, 59, 51, 63, 62, 43, 50, 42, 36, 10, 11, 15, 16, 17, 18, 19, 20, 21, 23, 25, 26, 32, 33, 37, 58, 60, 54, 38, 45, 47, 40, 52, 39, 46, 53, 41 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path8", "32S10-4,4,8-g7-path21", "64S7-8,4,8-g17-path34" ];
s`SolvableDBParents := [ Strings() | "128S69-16,8,16-g49-path319", "128S70-16,8,16-g49-path255", "128S69-16,8,16-g49-path320", "128S70-16,8,16-g49-path256", "128S3-8,4,8-g33-path798", "128S11-8,4,8-g33-path1332", "128S4-8,4,8-g33-path348" ];
