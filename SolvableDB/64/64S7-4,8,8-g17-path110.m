...
s`SolvableDBName := "64S7-4,8,8-g17-path110";
s`SolvableDBFilename := "64S7-4,8,8-g17-path110.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path5", "32S11-4,8,4-g7-path7", "64S7-4,8,8-g17-path110" ];
