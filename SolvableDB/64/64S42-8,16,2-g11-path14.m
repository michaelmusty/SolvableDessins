...
s`SolvableDBName := "64S42-8,16,2-g11-path14";
s`SolvableDBFilename := "64S42-8,16,2-g11-path14.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path4", "32S9-4,8,2-g3-path6", "64S42-8,16,2-g11-path14" ];
