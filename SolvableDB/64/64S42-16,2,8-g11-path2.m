...
s`SolvableDBName := "64S42-16,2,8-g11-path2";
s`SolvableDBFilename := "64S42-16,2,8-g11-path2.m";
...
\[ 6, 1, 4, 20, 18, 21, 15, 2, 3, 5, 7, 16, 17, 11, 40, 22, 38, 39, 36, 34, 41, 35, 37, 8, 9, 10, 12, 13, 14, 19, 23, 31, 30, 56, 57, 53, 42, 52, 55, 51, 58, 54, 24, 25, 26, 27, 28, 29, 32, 33, 64, 59, 62, 60, 43, 61, 63, 45, 44, 46, 47, 48, 49, 50 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S9-8,2,4-g3-path1", "64S42-16,2,8-g11-path2" ];
s`SolvableDBParents := [ Strings() | "128S65-16,4,8-g37-path34", "128S97-16,4,8-g37-path85", "128S81-16,4,8-g37-path34", "128S119-16,4,8-g37-path200", "128S81-16,2,8-g21-path34", "128S93-16,2,8-g21-path85", "128S65-16,2,8-g21-path34" ];
