...
I<[x]> := ideal< P | [
x[2]^4*x[3]^2 + x[2]^4 - 2*x[2]^2*x[4]^2 - 2*x[2]^2 + x[3]^2 - 2*x[4]^2 - 1,
x[2]^2*x[4]^4 + x[2]^4 + x[4]^4 - x[2]^2,
x[1]^2*x[2]^2 - x[1]^2 + x[2]^2 + 1,
x[1]*x[2]^3 + x[2]^2*x[4]^2 - x[1]*x[2] + x[4]^2,
x[3]^2*x[4]^2 - x[3]^2 + x[4]^2 + 1,
...
{ IntegerRing() | 56, 62 }
@};
s`SolvableDBBelyiMapTiming := 5.510p15;
s`SolvableDBLocalSanityCheckTiming := 19.810p15;
...
s`SolvableDBParents := [ Strings() | "128S56-4,8,8-g33-path4", "128S77-4,8,8-g33-path3", "128S85-4,8,8-g33-path7", "128S77-4,8,8-g33-path4", "128S85-4,8,8-g33-path8", "128S50-4,8,8-g33-path2", "128S126-4,8,8-g33-path8" ];
