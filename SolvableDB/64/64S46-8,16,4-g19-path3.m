...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 53, 50, 54, 13, 62, 61, 63, 39, 31, 43, 9, 21, 42, 35, 44, 11, 55, 19, 20, 22, 23, 41, 46, 14, 10, 12, 15, 16, 17, 18, 25, 26, 32, 33, 34, 36, 37, 60, 57, 64, 38, 45, 49, 47, 56, 40, 48, 52, 51, 58, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path7", "32S13-4,8,4-g7-path10", "64S46-8,16,4-g19-path3" ];
s`SolvableDBParents := [ Strings() | "128S100-8,16,8-g45-path275", "128S100-8,16,8-g45-path276", "128S115-8,16,4-g37-path185" ];
