...
\[ 6, 1, 24, 25, 19, 26, 21, 7, 2, 3, 4, 5, 8, 11, 23, 48, 28, 15, 20, 45, 43, 49, 42, 22, 47, 50, 17, 41, 16, 27, 29, 12, 9, 10, 13, 14, 18, 30, 31, 32, 62, 61, 44, 60, 53, 64, 55, 46, 57, 58, 39, 36, 33, 34, 35, 37, 38, 40, 51, 52, 59, 63, 54, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T6-8,4,8-g5-path1", "32S12-8,4,8-g9-path24", "64S45-16,8,16-g25-path16" ];
s`SolvableDBParents := [ Strings() | "128S102-16,8,16-g49-path430", "128S99-16,8,16-g49-path430", "128S108-16,8,16-g49-path251" ];
