...
s`SolvableDBName := "64S44-16,8,16-g25-path8";
s`SolvableDBFilename := "64S44-16,8,16-g25-path8.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 44, 26, 58, 55, 40, 34, 48, 38, 12, 14, 10, 63, 49, 15, 36, 56, 51, 9, 35, 61, 43, 59, 42, 53, 11, 13, 16, 17, 18, 19, 20, 21, 23, 25, 31, 32, 33, 37, 50, 64, 60, 62, 45, 41, 47, 46, 52, 39, 54, 57 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T8-4,4,4-g3-path20", "32S12-8,4,8-g9-path26", "64S44-16,8,16-g25-path8" ];
s`SolvableDBParents := [ Strings() | "128S153-32,16,32-g57-path129", "128S154-32,16,32-g57-path129", "128S153-32,16,32-g57-path130", "128S154-32,16,32-g57-path130", "128S102-16,8,16-g49-path347", "128S106-16,8,16-g49-path460", "128S99-16,8,16-g49-path347" ];
