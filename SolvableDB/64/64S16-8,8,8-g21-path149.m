...
s`SolvableDBName := "64S16-8,8,8-g21-path149";
s`SolvableDBFilename := "64S16-8,8,8-g21-path149.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T8-4,4,4-g3-path18", "32S14-4,4,8-g7-path14", "64S16-8,8,8-g21-path149" ];
s`SolvableDBChildren := [ Strings() | "32S14-4,4,8-g7-path14" ];
