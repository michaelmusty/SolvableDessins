...
s`SolvableDBName := "64S14-8,4,8-g17-path13";
s`SolvableDBFilename := "64S14-8,4,8-g17-path13.m";
...
\[ 6, 1, 27, 28, 22, 29, 24, 30, 2, 3, 4, 5, 7, 8, 63, 57, 37, 51, 40, 48, 33, 9, 54, 62, 45, 64, 53, 13, 12, 19, 61, 52, 49, 10, 58, 60, 36, 11, 14, 15, 16, 17, 18, 20, 21, 23, 25, 26, 31, 32, 34, 35, 43, 50, 42, 55, 44, 46, 56, 59, 47, 38, 39, 41 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path7", "32S10-4,4,8-g7-path20", "64S14-8,4,8-g17-path13" ];
s`SolvableDBParents := [ Strings() | "128S98-16,4,16-g41-path33", "128S98-16,4,16-g41-path34", "128S98-16,4,16-g41-path35", "128S98-16,4,16-g41-path36", "128S4-8,4,8-g33-path83", "128S28-8,4,8-g33-path144", "128S4-8,4,8-g33-path84" ];
