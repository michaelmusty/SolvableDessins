...
s`SolvableDBName := "64S30-16,8,16-g25-path6";
s`SolvableDBFilename := "64S30-16,8,16-g25-path6.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S5-8,4,8-g9-path11", "64S30-16,8,16-g25-path6" ];
