...
s`SolvableDBName := "64S44-4,16,16-g21-path17";
s`SolvableDBFilename := "64S44-4,16,16-g21-path17.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T8-4,4,4-g3-path2", "32S12-4,8,8-g9-path27", "64S44-4,16,16-g21-path17" ];
