...
\[ 6, 1, 18, 22, 20, 23, 4, 24, 2, 3, 5, 7, 8, 45, 46, 15, 51, 50, 52, 41, 16, 53, 47, 26, 17, 19, 12, 34, 36, 9, 10, 11, 13, 14, 21, 25, 27, 28, 29, 49, 62, 44, 42, 38, 43, 61, 57, 63, 39, 48, 40, 56, 60, 35, 54, 33, 30, 31, 32, 37, 55, 64, 58, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path8", "32S11-8,2,4-g3-path10", "64S9-8,4,4-g13-path70" ];
s`SolvableDBParents := [ Strings() | "128S3-8,4,8-g33-path1136", "128S86-8,4,8-g33-path168", "128S4-8,4,8-g33-path530", "128S85-8,4,8-g33-path168", "128S84-8,4,4-g25-path91", "128S26-8,4,4-g25-path937", "128S83-8,4,4-g25-path91" ];
