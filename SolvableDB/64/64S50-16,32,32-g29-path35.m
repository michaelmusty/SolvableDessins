...
s`SolvableDBName := "64S50-16,32,32-g29-path35";
s`SolvableDBFilename := "64S50-16,32,32-g29-path35.m";
...
\[ 55, 59, 57, 35, 27, 28, 38, 62, 52, 54, 42, 61, 58, 30, 32, 43, 37, 29, 31, 13, 9, 56, 44, 10, 16, 46, 24, 64, 47, 41, 60, 48, 26, 50, 63, 34, 51, 45, 12, 17, 23, 18, 33, 15, 11, 36, 22, 3, 2, 40, 20, 5, 8, 6, 49, 19, 53, 25, 21, 4, 14, 39, 7, 1 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-4,8,8-g5-path6", "32S16-8,16,16-g13-path8", "64S50-16,32,32-g29-path35" ];
s`SolvableDBParents := [ Strings() | "128S159-32,64,64-g61-path73", "128S160-32,64,64-g61-path57", "128S159-32,64,64-g61-path74", "128S160-32,64,64-g61-path58", "128S131-16,32,32-g57-path185", "128S128-16,32,32-g57-path123", "128S153-16,32,32-g57-path185" ];
