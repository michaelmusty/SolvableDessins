...
s`SolvableDBName := "64S22-8,8,8-g21-path71";
s`SolvableDBFilename := "64S22-8,8,8-g21-path71.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path8", "32S2-4,4,4-g5-path10", "64S22-8,8,8-g21-path71" ];
