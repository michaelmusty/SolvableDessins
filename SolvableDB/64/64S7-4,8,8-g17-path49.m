...
s`SolvableDBName := "64S7-4,8,8-g17-path49";
s`SolvableDBFilename := "64S7-4,8,8-g17-path49.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T14-4,8,4-g4-path1", "32S10-4,8,4-g7-path29", "64S7-4,8,8-g17-path49" ];
