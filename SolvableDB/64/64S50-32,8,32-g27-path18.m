...
s`SolvableDBName := "64S50-32,8,32-g27-path18";
s`SolvableDBFilename := "64S50-32,8,32-g27-path18.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 35, 36, 37, 13, 41, 43, 44, 17, 45, 18, 14, 47, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 40, 42, 57, 31, 56, 59, 60, 39, 61, 62, 58, 33, 63, 38, 27, 28, 29, 30, 32, 34, 46, 48, 64, 54, 49, 50, 52, 53, 55, 51 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,2,8-g3-path3", "32S16-16,4,16-g11-path8", "64S50-32,8,32-g27-path18" ];
s`SolvableDBParents := [ Strings() | "128S159-64,16,64-g59-path33", "128S160-64,16,64-g59-path25", "128S159-64,16,64-g59-path34", "128S160-64,16,64-g59-path26", "128S153-32,8,32-g53-path91", "128S128-32,8,32-g53-path60", "128S131-32,8,32-g53-path91" ];
