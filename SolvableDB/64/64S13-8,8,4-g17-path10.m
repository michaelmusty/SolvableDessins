...
s`SolvableDBName := "64S13-8,8,4-g17-path10";
s`SolvableDBFilename := "64S13-8,8,4-g17-path10.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 37, 14, 58, 13, 34, 61, 36, 39, 31, 52, 9, 21, 42, 35, 44, 11, 50, 19, 20, 22, 23, 41, 53, 57, 10, 12, 15, 16, 17, 18, 25, 26, 32, 33, 64, 48, 45, 62, 51, 60, 63, 59, 43, 49, 38, 47, 54, 55, 56, 46, 40 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S10-4,8,4-g7-path20", "64S13-8,8,4-g17-path10" ];
s`SolvableDBParents := [ Strings() | "128S96-16,8,4-g37-path9", "128S95-16,8,4-g37-path17", "128S97-16,8,4-g37-path9", "128S95-16,8,4-g37-path18", "128S3-8,8,4-g33-path169", "128S28-8,8,4-g33-path64", "128S3-8,8,4-g33-path170" ];
