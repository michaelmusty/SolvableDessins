...
s`SolvableDBName := "64S6-8,4,8-g17-path60";
s`SolvableDBFilename := "64S6-8,4,8-g17-path60.m";
...
\[ 20, 47, 38, 3, 43, 50, 45, 51, 22, 64, 10, 28, 27, 19, 63, 12, 62, 13, 21, 9, 15, 16, 17, 18, 1, 11, 26, 25, 30, 14, 59, 29, 23, 57, 49, 5, 58, 37, 6, 4, 46, 60, 39, 55, 40, 48, 36, 42, 44, 2, 41, 56, 8, 61, 54, 35, 31, 7, 33, 53, 52, 34, 32, 24 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,4,8-g5-path5", "32S5-8,4,8-g9-path15", "64S6-8,4,8-g17-path60" ];
s`SolvableDBParents := [ Strings() | "128S67-16,8,8-g45-path99", "128S68-16,8,8-g45-path99", "128S68-16,8,8-g45-path100", "128S67-16,8,8-g45-path100", "128S63-8,4,16-g37-path90", "128S61-16,8,16-g49-path441", "128S66-8,4,16-g37-path169", "128S62-16,8,16-g49-path377", "128S65-8,4,16-g37-path84", "128S62-16,8,16-g49-path378", "128S64-8,4,16-g37-path181", "128S61-16,8,16-g49-path442", "128S3-8,4,8-g33-path691", "128S2-8,4,8-g33-path220", "128S11-8,4,8-g33-path1225" ];
