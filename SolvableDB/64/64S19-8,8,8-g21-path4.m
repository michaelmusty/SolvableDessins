...
s`SolvableDBName := "64S19-8,8,8-g21-path4";
s`SolvableDBFilename := "64S19-8,8,8-g21-path4.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 62, 50, 52, 13, 34, 56, 36, 40, 31, 59, 9, 21, 44, 35, 46, 11, 57, 19, 20, 22, 23, 43, 58, 64, 61, 10, 12, 14, 15, 16, 17, 18, 25, 26, 32, 33, 37, 38, 39, 49, 53, 63, 54, 47, 51, 41, 42, 48, 45, 60, 55 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path7", "32S2-4,4,4-g5-path60", "64S19-8,8,8-g21-path4" ];
s`SolvableDBParents := [ Strings() | "128S7-8,8,8-g41-path1078", "128S7-8,8,8-g41-path1079", "128S7-8,8,8-g41-path1080", "128S24-8,8,8-g41-path154", "128S23-8,8,8-g41-path307", "128S25-8,8,8-g41-path154", "128S23-8,8,8-g41-path308", "128S24-8,8,8-g41-path155", "128S25-8,8,8-g41-path155", "128S23-8,8,8-g41-path309", "128S23-8,8,8-g41-path310", "128S24-8,8,8-g41-path156", "128S23-8,8,8-g41-path311", "128S23-8,8,8-g41-path312", "128S25-8,8,8-g41-path156" ];
