...
s`SolvableDBName := "64S27-4,16,16-g21-path3";
s`SolvableDBFilename := "64S27-4,16,16-g21-path3.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 16, 36, 9, 39, 24, 25, 10, 26, 27, 15, 12, 20, 45, 17, 43, 30, 32, 37, 13, 14, 18, 21, 28, 29, 35, 41, 31, 42, 51, 56, 34, 46, 33, 49, 48, 50, 54, 55, 52, 38, 40, 44, 47, 53, 58, 61, 60, 62, 64, 63, 59, 57 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T5-2,8,8-g3-path1", "32S17-2,16,16-g7-path3", "64S27-4,16,16-g21-path3" ];
s`SolvableDBParents := [ Strings() | "128S44-8,16,16-g49-path136", "128S130-4,32,32-g45-path83", "128S130-8,32,32-g53-path83", "128S43-8,16,16-g49-path42", "128S130-4,32,32-g45-path84", "128S130-8,32,32-g53-path84", "128S106-4,16,16-g41-path316" ];
