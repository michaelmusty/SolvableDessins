...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 50, 56, 48, 44, 14, 33, 36, 39, 51, 42, 9, 21, 59, 55, 43, 11, 17, 19, 20, 22, 23, 10, 53, 38, 15, 12, 13, 16, 18, 25, 26, 31, 32, 34, 35, 37, 64, 57, 49, 54, 58, 41, 62, 60, 61, 40, 45, 46, 63, 52, 47 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path31", "32S13-4,4,8-g7-path15", "64S15-8,8,8-g21-path163" ];
s`SolvableDBParents := [ Strings() | "128S100-8,8,16-g45-path169", "128S100-8,8,16-g45-path170", "128S99-16,16,8-g49-path169", "128S101-16,16,16-g53-path515", "128S99-16,16,8-g49-path170", "128S101-16,16,16-g53-path516", "128S9-8,8,8-g41-path258" ];
