...
s`SolvableDBName := "64S29-8,16,16-g25-path42";
s`SolvableDBFilename := "64S29-8,16,16-g25-path42.m";
...
\[ 2, 9, 10, 11, 12, 1, 13, 14, 22, 39, 40, 29, 28, 19, 41, 26, 42, 43, 44, 34, 45, 5, 36, 7, 46, 47, 3, 4, 6, 8, 25, 38, 48, 49, 27, 50, 51, 52, 54, 61, 56, 37, 35, 15, 57, 21, 63, 31, 16, 60, 58, 23, 59, 18, 20, 30, 33, 64, 17, 62, 24, 32, 55, 53 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-4,8,8-g5-path6", "32S5-4,8,8-g9-path13", "64S29-8,16,16-g25-path42" ];
s`SolvableDBParents := [ Strings() | "128S133-16,32,32-g57-path97", "128S133-16,32,32-g57-path98", "128S131-16,32,32-g57-path49", "128S132-16,32,32-g57-path49", "128S131-16,32,32-g57-path50", "128S132-16,32,32-g57-path50", "128S133-16,32,32-g57-path99", "128S133-16,32,32-g57-path100", "128S54-8,16,16-g49-path25", "128S61-8,16,16-g49-path49", "128S69-8,16,16-g49-path49", "128S69-8,16,16-g49-path50", "128S61-8,16,16-g49-path50", "128S106-8,16,16-g49-path342", "128S46-8,16,16-g49-path25" ];
