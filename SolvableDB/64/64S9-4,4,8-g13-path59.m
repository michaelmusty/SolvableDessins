...
s`SolvableDBName := "64S9-4,4,8-g13-path59";
s`SolvableDBFilename := "64S9-4,4,8-g13-path59.m";
...
\[ 4, 7, 15, 20, 21, 28, 31, 1, 12, 39, 25, 36, 2, 47, 50, 51, 9, 3, 23, 17, 44, 38, 60, 61, 54, 5, 45, 46, 6, 14, 29, 55, 35, 43, 56, 8, 42, 16, 63, 57, 10, 64, 11, 53, 52, 13, 58, 27, 33, 49, 19, 41, 37, 62, 40, 18, 30, 32, 22, 59, 34, 24, 48, 26 ]:
 Order := 64 > |
[ 28, 4, 9, 38, 61, 12, 55, 15, 7, 6, 21, 23, 39, 33, 63, 37, 35, 47, 20, 62, 18, 36, 10, 42, 41, 51, 2, 14, 45, 31, 26, 46, 1, 17, 52, 43, 25, 27, 56, 24, 16, 49, 57, 29, 50, 53, 11, 60, 40, 44, 30, 34, 59, 8, 3, 64, 22, 19, 32, 5, 48, 58, 54, 13 ],
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S10-4,4,8-g7-path5", "64S9-4,4,8-g13-path59" ];
