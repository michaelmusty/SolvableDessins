...
s`SolvableDBName := "64S16-8,8,8-g21-path274";
s`SolvableDBFilename := "64S16-8,8,8-g21-path274.m";
...
[ 18, 42, 2, 47, 44, 49, 6, 58, 15, 9, 21, 28, 1, 56, 48, 11, 12, 51, 14, 53, 20, 63, 27, 54, 24, 25, 30, 45, 26, 52, 19, 31, 17, 37, 40, 35, 5, 8, 55, 16, 38, 29, 39, 22, 61, 57, 46, 4, 32, 43, 50, 41, 36, 3, 13, 7, 10, 23, 33, 59, 60, 64, 62, 34 ]
]
];
...
\[ 19, 43, 50, 3, 35, 38, 41, 59, 25, 26, 10, 62, 31, 30, 24, 57, 63, 14, 27, 15, 9, 16, 17, 18, 1, 13, 12, 64, 55, 28, 23, 58, 22, 53, 47, 4, 36, 60, 49, 46, 61, 39, 6, 40, 34, 42, 2, 54, 8, 7, 56, 45, 48, 51, 32, 52, 29, 33, 44, 5, 37, 21, 11, 20 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T8-4,4,4-g3-path14", "32S15-8,8,8-g11-path6", "64S16-8,8,8-g21-path274" ];
s`SolvableDBParents := [ Strings() | "128S102-16,16,8-g49-path55", "128S102-16,16,8-g49-path56", "128S103-8,8,16-g45-path28", "128S104-8,8,16-g45-path28", "128S105-16,16,16-g53-path287", "128S105-16,16,16-g53-path288", "128S9-8,8,8-g41-path450" ];
s`SolvableDBChild := "32S15-8,8,8-g11-path6";
