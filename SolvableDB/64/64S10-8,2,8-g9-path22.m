...
s`SolvableDBName := "64S10-8,2,8-g9-path22";
s`SolvableDBFilename := "64S10-8,2,8-g9-path22.m";
...
\[ 47, 44, 51, 60, 52, 62, 20, 17, 21, 48, 22, 33, 46, 56, 55, 50, 58, 57, 64, 29, 34, 54, 4, 25, 45, 5, 43, 6, 41, 15, 49, 38, 59, 10, 14, 19, 18, 24, 32, 42, 63, 35, 61, 26, 31, 53, 8, 36, 39, 12, 23, 28, 16, 1, 7, 37, 40, 11, 13, 27, 3, 2, 30, 9 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S11-8,2,4-g3-path6", "64S10-8,2,8-g9-path22" ];
s`SolvableDBParents := [ Strings() | "128S88-16,4,16-g41-path13", "128S87-16,2,16-g25-path13", "128S27-8,4,8-g33-path7", "128S87-16,2,16-g25-path14", "128S4-8,4,8-g33-path7", "128S88-16,4,16-g41-path14", "128S2-8,2,8-g17-path7" ];
