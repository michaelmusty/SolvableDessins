...
s`SolvableDBName := "64S29-8,16,16-g25-path16";
s`SolvableDBFilename := "64S29-8,16,16-g25-path16.m";
...
\[ 31, 47, 37, 33, 48, 9, 49, 50, 46, 53, 62, 61, 58, 36, 32, 34, 13, 52, 51, 38, 35, 26, 29, 12, 2, 59, 54, 63, 60, 64, 25, 56, 43, 44, 45, 55, 42, 57, 28, 11, 30, 10, 7, 8, 19, 1, 6, 40, 24, 17, 22, 39, 23, 41, 18, 5, 27, 16, 21, 3, 4, 15, 14, 20 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path1", "32S16-8,16,16-g13-path9", "64S29-8,16,16-g25-path16" ];
s`SolvableDBParents := [ Strings() | "128S131-16,32,32-g57-path51", "128S133-16,32,32-g57-path101", "128S133-16,32,32-g57-path102", "128S132-16,32,32-g57-path51", "128S133-16,32,32-g57-path103", "128S131-16,32,32-g57-path52", "128S132-16,32,32-g57-path52", "128S133-16,32,32-g57-path104", "128S69-8,16,16-g49-path51", "128S61-8,16,16-g49-path51", "128S54-8,16,16-g49-path26", "128S61-8,16,16-g49-path52", "128S106-8,16,16-g49-path343", "128S46-8,16,16-g49-path26", "128S69-8,16,16-g49-path52" ];
