...
s`SolvableDBName := "64S7-4,8,8-g17-path96";
s`SolvableDBFilename := "64S7-4,8,8-g17-path96.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S11-4,4,8-g7-path4", "64S7-4,8,8-g17-path96" ];
