...
s`SolvableDBName := "64S29-8,16,16-g25-path56";
s`SolvableDBFilename := "64S29-8,16,16-g25-path56.m";
...
\[ 2, 9, 10, 11, 12, 1, 13, 14, 22, 39, 40, 29, 28, 19, 41, 26, 42, 43, 44, 34, 45, 5, 36, 7, 46, 47, 3, 4, 6, 8, 25, 38, 48, 49, 27, 50, 51, 52, 54, 61, 56, 37, 35, 15, 57, 21, 63, 31, 16, 60, 58, 23, 59, 18, 20, 30, 33, 64, 17, 62, 24, 32, 55, 53 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S5-4,8,8-g9-path8", "64S29-8,16,16-g25-path56" ];
s`SolvableDBParents := [ Strings() | "128S133-16,32,32-g57-path165", "128S133-16,32,32-g57-path166", "128S131-16,32,32-g57-path83", "128S132-16,32,32-g57-path83", "128S131-16,32,32-g57-path84", "128S132-16,32,32-g57-path84", "128S133-16,32,32-g57-path167", "128S133-16,32,32-g57-path168", "128S54-8,16,16-g49-path42", "128S61-8,16,16-g49-path83", "128S69-8,16,16-g49-path83", "128S69-8,16,16-g49-path84", "128S61-8,16,16-g49-path84", "128S106-8,16,16-g49-path359", "128S46-8,16,16-g49-path42" ];
