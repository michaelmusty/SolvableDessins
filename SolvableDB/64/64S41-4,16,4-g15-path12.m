...
s`SolvableDBName := "64S41-4,16,4-g15-path12";
s`SolvableDBFilename := "64S41-4,16,4-g15-path12.m";
...
\[ 2, 5, 9, 10, 6, 1, 4, 11, 15, 19, 12, 22, 28, 29, 21, 30, 25, 31, 7, 23, 3, 8, 17, 18, 20, 16, 32, 37, 27, 34, 33, 14, 24, 26, 47, 45, 42, 48, 43, 44, 49, 13, 40, 39, 41, 50, 53, 46, 36, 38, 54, 63, 59, 62, 61, 60, 64, 51, 35, 55, 56, 58, 57, 52 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path7", "32S9-2,8,4-g3-path10", "64S41-4,16,4-g15-path12" ];
s`SolvableDBParents := [ Strings() | "128S92-4,16,8-g37-path67", "128S95-4,16,8-g37-path146", "128S65-4,16,8-g37-path5", "128S66-4,16,8-g37-path22", "128S118-4,16,4-g29-path406", "128S79-4,16,4-g29-path52", "128S80-4,16,4-g29-path132" ];
