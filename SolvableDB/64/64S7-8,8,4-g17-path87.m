...
s`SolvableDBName := "64S7-8,8,4-g17-path87";
s`SolvableDBFilename := "64S7-8,8,4-g17-path87.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 48, 50, 31, 25, 14, 10, 36, 38, 49, 40, 9, 21, 59, 55, 17, 11, 54, 19, 20, 22, 23, 33, 52, 42, 12, 13, 15, 16, 18, 26, 32, 34, 35, 37, 64, 53, 58, 47, 60, 61, 43, 41, 62, 46, 63, 39, 56, 57, 44, 45, 51 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path5", "32S11-4,8,4-g7-path16", "64S7-8,8,4-g17-path87" ];
s`SolvableDBParents := [ Strings() | "128S69-16,16,4-g41-path281", "128S69-16,16,4-g41-path282", "128S70-16,16,4-g41-path217", "128S70-16,16,4-g41-path218", "128S11-8,8,4-g33-path1266", "128S3-8,8,4-g33-path732", "128S4-8,8,4-g33-path282" ];
