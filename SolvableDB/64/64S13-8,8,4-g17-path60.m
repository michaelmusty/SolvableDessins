...
s`SolvableDBName := "64S13-8,8,4-g17-path60";
s`SolvableDBFilename := "64S13-8,8,4-g17-path60.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T12-4,8,2-g2-path1", "32S9-4,8,2-g3-path12", "64S13-8,8,4-g17-path60" ];
