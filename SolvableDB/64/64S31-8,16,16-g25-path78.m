...
s`SolvableDBName := "64S31-8,16,16-g25-path78";
s`SolvableDBFilename := "64S31-8,16,16-g25-path78.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T10-2,4,4-g1-path4", "32S5-4,8,8-g9-path6", "64S31-8,16,16-g25-path78" ];
s`SolvableDBChildren := [ Strings() | "32S5-4,8,8-g9-path6" ];
