...
s`SolvableDBName := "64S30-4,16,16-g21-path22";
s`SolvableDBFilename := "64S30-4,16,16-g21-path22.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S5-2,8,8-g5-path8", "64S30-4,16,16-g21-path22" ];
