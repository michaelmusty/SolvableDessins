...
s`SolvableDBName := "64S6-4,8,8-g17-path80";
s`SolvableDBFilename := "64S6-4,8,8-g17-path80.m";
...
\[ 6, 1, 21, 7, 2, 5, 19, 22, 3, 4, 8, 11, 16, 32, 9, 26, 23, 24, 10, 25, 15, 12, 20, 41, 17, 29, 30, 39, 13, 14, 18, 27, 28, 33, 38, 48, 42, 37, 34, 43, 31, 35, 49, 47, 40, 56, 36, 44, 45, 46, 50, 55, 63, 57, 54, 51, 52, 59, 64, 62, 58, 53, 60, 61 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path7", "32S9-2,4,8-g3-path10", "64S6-4,8,8-g17-path80" ];
s`SolvableDBParents := [ Strings() | "128S67-8,16,8-g45-path49", "128S67-8,16,8-g45-path50", "128S68-8,16,8-g45-path49", "128S68-8,16,8-g45-path50", "128S63-4,8,16-g37-path65", "128S61-8,16,16-g49-path333", "128S64-4,8,16-g37-path156", "128S61-8,16,16-g49-path334", "128S65-4,8,16-g37-path59", "128S62-8,16,16-g49-path269", "128S66-4,8,16-g37-path144", "128S62-8,16,16-g49-path270", "128S11-4,8,8-g33-path1171", "128S2-4,8,8-g33-path166", "128S3-4,8,8-g33-path637" ];
