...
s`SolvableDBName := "64S30-8,16,16-g25-path32";
s`SolvableDBFilename := "64S30-8,16,16-g25-path32.m";
...
\[ 6, 1, 26, 27, 22, 28, 24, 29, 2, 3, 4, 5, 7, 8, 42, 48, 58, 60, 14, 16, 46, 9, 50, 61, 30, 34, 13, 12, 56, 47, 63, 62, 53, 41, 40, 31, 10, 11, 15, 17, 18, 19, 20, 21, 23, 25, 32, 33, 35, 36, 59, 45, 54, 55, 43, 39, 49, 51, 57, 37, 38, 44, 64, 52 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T6-4,8,8-g5-path3", "32S5-4,8,8-g9-path20", "64S30-8,16,16-g25-path32" ];
s`SolvableDBParents := [ Strings() | "128S54-8,16,16-g49-path93", "128S62-8,16,16-g49-path29", "128S70-8,16,16-g49-path29", "128S62-8,16,16-g49-path30", "128S70-8,16,16-g49-path30", "128S46-8,16,16-g49-path93", "128S109-8,16,16-g49-path242" ];
