...
\[ 6, 1, 4, 20, 18, 21, 15, 2, 3, 5, 7, 16, 17, 11, 40, 22, 38, 39, 36, 34, 41, 35, 37, 8, 9, 10, 12, 13, 14, 19, 23, 31, 30, 56, 57, 53, 42, 52, 55, 51, 43, 54, 24, 25, 26, 27, 28, 29, 32, 33, 48, 64, 63, 61, 58, 44, 59, 45, 46, 47, 49, 50, 62, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T12-8,2,4-g2-path3", "32S9-8,2,4-g3-path13", "64S12-8,2,8-g9-path39" ];
s`SolvableDBParents := [ Strings() | "128S2-8,4,8-g33-path57", "128S28-8,4,8-g33-path24", "128S93-16,2,8-g21-path24", "128S92-16,4,8-g37-path24", "128S92-16,2,8-g21-path24", "128S94-16,4,8-g37-path24", "128S93-8,2,16-g21-path24", "128S92-8,4,16-g37-path24", "128S92-8,2,16-g21-path24", "128S94-8,4,16-g37-path24", "128S89-16,2,16-g25-path24", "128S91-16,4,16-g41-path24", "128S91-16,2,16-g25-path24", "128S90-16,4,16-g41-path24", "128S2-8,2,8-g17-path57" ];
