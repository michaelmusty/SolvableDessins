...
s`SolvableDBName := "64S12-8,2,8-g9-path39";
s`SolvableDBFilename := "64S12-8,2,8-g9-path39.m";
...
[ 36, 19, 27, 12, 15, 53, 10, 30, 46, 7, 26, 4, 32, 45, 5, 20, 31, 40, 2, 16, 63, 34, 38, 33, 59, 11, 3, 49, 58, 8, 17, 13, 24, 22, 56, 1, 52, 23, 51, 18, 62, 64, 50, 57, 14, 9, 61, 55, 28, 43, 39, 37, 6, 60, 48, 35, 44, 29, 25, 54, 47, 41, 21, 42 ],
[ 19, 30, 10, 5, 7, 36, 16, 33, 26, 11, 12, 13, 2, 27, 22, 17, 1, 15, 23, 18, 53, 38, 4, 50, 45, 14, 28, 8, 46, 31, 3, 9, 32, 39, 52, 37, 20, 6, 40, 35, 63, 34, 62, 58, 29, 47, 24, 59, 25, 49, 57, 21, 42, 56, 51, 55, 64, 48, 60, 43, 44, 61, 54, 41 ]
]
];
...
[ 25, 44, 21, 41, 47, 9, 57, 56, 6, 60, 35, 48, 39, 22, 59, 29, 55, 28, 54, 43, 3, 14, 50, 34, 1, 64, 51, 18, 16, 42, 62, 63, 37, 24, 11, 61, 33, 58, 13, 46, 4, 30, 20, 2, 52, 40, 5, 12, 53, 23, 27, 45, 49, 19, 17, 8, 7, 38, 15, 10, 36, 31, 32, 26 ],
[ 14, 29, 6, 21, 33, 11, 42, 48, 1, 50, 37, 25, 18, 23, 54, 9, 39, 30, 35, 41, 7, 3, 28, 51, 2, 62, 44, 5, 31, 22, 47, 60, 16, 43, 4, 57, 13, 55, 19, 61, 15, 17, 40, 8, 63, 56, 10, 32, 64, 12, 49, 58, 59, 38, 36, 24, 20, 53, 34, 26, 52, 27, 46, 45 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S9-8,2,4-g3-path3", "64S12-8,2,8-g9-path39" ];
s`SolvableDBChildren := [ Strings() | "32S9-8,2,4-g3-path3" ];
