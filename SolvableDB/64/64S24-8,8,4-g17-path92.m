...
s`SolvableDBName := "64S24-8,8,4-g17-path92";
s`SolvableDBFilename := "64S24-8,8,4-g17-path92.m";
...
\[ 58, 64, 42, 34, 31, 33, 60, 37, 63, 61, 59, 57, 62, 21, 43, 44, 41, 14, 27, 9, 36, 40, 13, 12, 17, 32, 56, 54, 10, 38, 50, 48, 52, 49, 39, 55, 53, 35, 51, 46, 4, 19, 30, 29, 18, 16, 15, 3, 7, 2, 47, 5, 11, 45, 28, 26, 20, 24, 23, 25, 22, 8, 1, 6 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S7-8,8,2-g5-path4", "64S24-8,8,4-g17-path92" ];
s`SolvableDBParents := [ Strings() | "128S15-8,8,8-g41-path1885", "128S41-8,8,8-g41-path262", "128S15-8,8,8-g41-path1886", "128S39-8,8,8-g41-path262", "128S31-8,8,8-g41-path1759", "128S24-8,8,8-g41-path1054", "128S31-8,8,8-g41-path1760", "128S22-8,8,8-g41-path814", "128S37-8,8,4-g33-path317", "128S12-8,8,4-g33-path386", "128S37-8,8,4-g33-path318", "128S28-8,8,4-g33-path602", "128S17-8,8,4-g33-path479", "128S27-8,8,4-g33-path394", "128S17-8,8,4-g33-path480" ];
s`SolvableDBChild := "32S7-8,8,2-g5-path4";
