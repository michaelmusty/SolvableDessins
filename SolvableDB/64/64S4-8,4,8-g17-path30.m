...
s`SolvableDBName := "64S4-8,4,8-g17-path30";
s`SolvableDBFilename := "64S4-8,4,8-g17-path30.m";
...
[ 16, 39, 49, 23, 3, 60, 5, 56, 58, 54, 10, 11, 64, 24, 53, 14, 48, 42, 45, 43, 6, 21, 26, 1, 33, 57, 9, 36, 38, 63, 62, 52, 61, 25, 13, 59, 28, 19, 18, 50, 27, 2, 47, 35, 29, 55, 51, 32, 7, 46, 20, 17, 31, 12, 40, 30, 4, 41, 37, 22, 34, 15, 8, 44 ],
...
\[ 6, 1, 26, 27, 23, 28, 4, 29, 2, 3, 5, 7, 8, 22, 47, 60, 44, 14, 53, 34, 37, 59, 9, 21, 46, 58, 42, 11, 62, 19, 20, 13, 55, 50, 63, 10, 12, 15, 16, 17, 18, 24, 25, 30, 31, 32, 33, 35, 57, 48, 61, 64, 51, 49, 52, 38, 41, 39, 54, 36, 40, 43, 45, 56 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S6-4,4,4-g5-path12", "64S4-8,4,8-g17-path30" ];
s`SolvableDBParents := [ Strings() | "128S53-16,8,16-g49-path67", "128S53-16,8,16-g49-path68", "128S46-16,8,16-g49-path191", "128S46-16,8,16-g49-path192", "128S52-16,8,16-g49-path67", "128S52-16,8,16-g49-path68", "128S47-16,8,16-g49-path159", "128S47-16,8,16-g49-path160", "128S12-8,4,8-g33-path512", "128S50-8,4,8-g33-path56", "128S51-8,4,8-g33-path123", "128S2-8,4,8-g33-path112", "128S4-8,4,8-g33-path235", "128S48-8,4,8-g33-path56", "128S49-8,4,8-g33-path123" ];
