...
s`SolvableDBName := "64S44-16,16,4-g21-path37";
s`SolvableDBFilename := "64S44-16,16,4-g21-path37.m";
...
\[ 48, 55, 29, 50, 26, 27, 59, 52, 35, 47, 33, 57, 10, 53, 11, 30, 64, 28, 43, 9, 49, 31, 21, 45, 62, 13, 58, 23, 56, 51, 16, 39, 18, 2, 5, 32, 44, 12, 40, 46, 24, 7, 63, 54, 22, 37, 6, 34, 3, 42, 19, 38, 61, 14, 20, 4, 41, 1, 15, 25, 17, 36, 8, 60 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,2-g3-path3", "32S12-8,8,4-g9-path1", "64S44-16,16,4-g21-path37" ];
s`SolvableDBParents := [ Strings() | "128S102-16,16,8-g49-path235", "128S153-32,32,4-g45-path33", "128S154-32,32,8-g53-path33", "128S153-32,32,4-g45-path34", "128S154-32,32,8-g53-path34", "128S99-16,16,8-g49-path235", "128S106-16,16,4-g41-path426" ];
