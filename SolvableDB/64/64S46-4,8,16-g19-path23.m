...
s`SolvableDBName := "64S46-4,8,16-g19-path23";
s`SolvableDBFilename := "64S46-4,8,16-g19-path23.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T12-4,2,8-g2-path1", "32S13-4,4,8-g7-path4", "64S46-4,8,16-g19-path23" ];
