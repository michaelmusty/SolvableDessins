...
s`SolvableDBName := "64S42-8,16,2-g11-path16";
s`SolvableDBFilename := "64S42-8,16,2-g11-path16.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S9-4,8,2-g3-path8", "64S42-8,16,2-g11-path16" ];
