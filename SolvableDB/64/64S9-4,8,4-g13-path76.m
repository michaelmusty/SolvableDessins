...
\[ 6, 1, 22, 21, 2, 5, 4, 23, 3, 7, 8, 16, 35, 9, 11, 37, 26, 50, 24, 47, 10, 14, 15, 17, 18, 19, 20, 51, 31, 12, 13, 25, 27, 28, 29, 43, 30, 40, 44, 54, 46, 34, 61, 41, 59, 39, 33, 49, 58, 32, 42, 45, 48, 56, 52, 38, 36, 53, 55, 63, 57, 60, 64, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path9", "32S11-2,8,4-g3-path6", "64S9-4,8,4-g13-path76" ];
s`SolvableDBParents := [ Strings() | "128S3-4,8,8-g33-path1139", "128S86-4,8,8-g33-path171", "128S4-4,8,8-g33-path533", "128S85-4,8,8-g33-path171", "128S84-4,8,4-g25-path98", "128S26-4,8,4-g25-path944", "128S83-4,8,4-g25-path98" ];
