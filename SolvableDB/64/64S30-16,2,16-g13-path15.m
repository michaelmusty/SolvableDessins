...
s`SolvableDBName := "64S30-16,2,16-g13-path15";
s`SolvableDBFilename := "64S30-16,2,16-g13-path15.m";
...
\[ 6, 1, 19, 21, 17, 22, 16, 2, 3, 4, 5, 7, 40, 45, 43, 15, 42, 49, 41, 50, 51, 52, 9, 39, 24, 8, 10, 11, 12, 13, 14, 18, 20, 23, 25, 27, 31, 37, 32, 33, 48, 47, 44, 61, 46, 60, 57, 64, 63, 58, 59, 62, 30, 28, 38, 36, 26, 29, 34, 35, 53, 54, 55, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,2,8-g3-path7", "32S5-8,2,8-g5-path14", "64S30-16,2,16-g13-path15" ];
s`SolvableDBParents := [ Strings() | "128S70-16,4,16-g41-path35", "128S54-16,4,16-g41-path96", "128S70-16,4,16-g41-path36", "128S109-16,4,16-g41-path245", "128S62-16,2,16-g25-path35", "128S46-16,2,16-g25-path57", "128S62-16,2,16-g25-path36" ];
