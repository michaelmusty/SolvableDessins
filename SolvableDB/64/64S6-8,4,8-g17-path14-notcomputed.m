...
s`SolvableDBName := "64S6-8,4,8-g17-path14-notcomputed";
s`SolvableDBFilename := "64S6-8,4,8-g17-path14-notcomputed.m";
...
\[ 49, 62, 50, 32, 29, 31, 48, 37, 56, 59, 47, 61, 54, 35, 64, 60, 16, 9, 53, 30, 12, 11, 25, 63, 55, 36, 34, 51, 42, 39, 45, 44, 52, 57, 43, 58, 46, 10, 3, 15, 24, 2, 13, 7, 5, 33, 18, 38, 22, 21, 40, 17, 41, 23, 14, 1, 19, 28, 4, 8, 20, 6, 27, 26 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T13-8,2,2-g0-path1-notcomputed", "32S9-8,2,4-g3-path5-notcomputed", "64S6-8,4,8-g17-path14-notcomputed" ];
