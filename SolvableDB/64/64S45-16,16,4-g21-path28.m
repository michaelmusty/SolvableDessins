...
s`SolvableDBName := "64S45-16,16,4-g21-path28";
s`SolvableDBFilename := "64S45-16,16,4-g21-path28.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T8-4,4,4-g3-path14", "32S12-8,8,4-g9-path32", "64S45-16,16,4-g21-path28" ];
