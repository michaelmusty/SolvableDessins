...
\[ 6, 1, 21, 22, 19, 23, 13, 2, 3, 4, 5, 7, 47, 20, 49, 46, 50, 51, 8, 52, 53, 12, 11, 35, 36, 9, 10, 14, 15, 16, 17, 18, 24, 25, 41, 39, 48, 44, 28, 63, 58, 64, 42, 37, 62, 26, 27, 55, 38, 60, 33, 34, 30, 40, 29, 43, 31, 32, 45, 54, 56, 61, 57, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path6", "32S6-4,4,2-g1-path7", "64S36-8,8,2-g9-path6" ];
s`SolvableDBParents := [ Strings() | "128S85-8,8,4-g33-path45", "128S56-8,8,4-g33-path23", "128S85-8,8,4-g33-path46", "128S126-8,8,4-g33-path207", "128S77-8,8,2-g17-path23", "128S50-8,8,2-g17-path12", "128S77-8,8,2-g17-path24" ];
