...
s`SolvableDBName := "64S34-4,4,4-g9-path7";
s`SolvableDBFilename := "64S34-4,4,4-g9-path7.m";
...
\[ 12, 35, 40, 7, 2, 5, 34, 37, 22, 47, 13, 9, 27, 51, 14, 63, 62, 10, 59, 16, 29, 1, 30, 11, 31, 18, 24, 15, 61, 56, 52, 58, 54, 36, 6, 4, 19, 57, 33, 32, 38, 25, 45, 21, 60, 17, 26, 46, 43, 41, 28, 42, 39, 53, 23, 55, 50, 3, 8, 49, 44, 48, 64, 20 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path4", "32S6-4,4,4-g5-path4", "64S34-4,4,4-g9-path7" ];
s`SolvableDBParents := [ Strings() | "128S140-8,4,4-g25-path11", "128S75-4,8,4-g25-path44", "128S138-8,8,4-g33-path21", "128S75-4,4,8-g25-path43", "128S138-8,4,8-g33-path22", "128S50-4,8,8-g33-path11", "128S142-8,8,8-g41-path32", "128S141-8,4,4-g25-path11", "128S84-4,8,4-g25-path88", "128S139-8,8,4-g33-path21", "128S84-4,4,8-g25-path87", "128S139-8,4,8-g33-path22", "128S57-4,8,8-g33-path22", "128S143-8,8,8-g41-path32", "128S125-4,4,4-g17-path683" ];
