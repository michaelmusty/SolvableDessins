...
s`SolvableDBName := "64S31-16,2,16-g13-path7";
s`SolvableDBFilename := "64S31-16,2,16-g13-path7.m";
...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 37, 43, 39, 41, 38, 32, 49, 50, 31, 40, 24, 8, 9, 10, 11, 12, 13, 14, 20, 23, 25, 42, 44, 45, 46, 36, 55, 61, 57, 62, 53, 63, 30, 47, 56, 60, 33, 28, 26, 27, 29, 34, 35, 48, 51, 52, 64, 59, 54, 58 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T6-8,2,8-g3-path4", "32S5-8,2,8-g5-path20", "64S31-16,2,16-g13-path7" ];
s`SolvableDBParents := [ Strings() | "128S69-16,4,16-g41-path189", "128S55-16,4,16-g41-path33", "128S111-16,4,16-g41-path487", "128S70-16,4,16-g41-path125", "128S62-16,2,16-g25-path79", "128S61-16,2,16-g25-path111", "128S47-16,2,16-g25-path33" ];
