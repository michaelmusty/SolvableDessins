...
s`SolvableDBName := "64S4-4,8,8-g17-path16";
s`SolvableDBFilename := "64S4-4,8,8-g17-path16.m";
...
\[ 22, 5, 52, 39, 6, 38, 4, 44, 12, 18, 24, 1, 11, 15, 28, 51, 63, 26, 14, 58, 31, 9, 54, 27, 29, 33, 13, 19, 21, 23, 25, 20, 10, 61, 47, 43, 7, 2, 37, 41, 8, 59, 3, 40, 57, 50, 62, 49, 46, 48, 45, 36, 55, 56, 42, 30, 16, 64, 53, 35, 17, 60, 34, 32 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T6-4,8,8-g5-path3", "32S5-4,8,8-g9-path20", "64S4-4,8,8-g17-path16" ];
s`SolvableDBParents := [ Strings() | "128S46-8,16,16-g49-path131", "128S46-8,16,16-g49-path132", "128S53-8,16,16-g49-path7", "128S53-8,16,16-g49-path8", "128S47-8,16,16-g49-path99", "128S47-8,16,16-g49-path100", "128S52-8,16,16-g49-path7", "128S52-8,16,16-g49-path8", "128S12-4,8,8-g33-path482", "128S50-4,8,8-g33-path26", "128S51-4,8,8-g33-path93", "128S2-4,8,8-g33-path82", "128S4-4,8,8-g33-path205", "128S48-4,8,8-g33-path26", "128S49-4,8,8-g33-path93" ];
