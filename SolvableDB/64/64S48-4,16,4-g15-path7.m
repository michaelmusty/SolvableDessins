...
\[ 19, 5, 27, 13, 6, 20, 4, 11, 12, 17, 21, 1, 14, 7, 45, 32, 24, 28, 9, 2, 25, 26, 34, 29, 8, 3, 22, 23, 10, 33, 37, 30, 16, 18, 61, 49, 43, 48, 44, 50, 31, 46, 41, 15, 39, 36, 53, 40, 42, 38, 52, 63, 59, 62, 60, 64, 47, 51, 57, 35, 55, 56, 58, 54 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path33", "32S14-4,8,4-g7-path14", "64S48-4,16,4-g15-path7" ];
s`SolvableDBParents := [ Strings() | "128S158-8,32,4-g39-path13", "128S158-4,32,8-g39-path13", "128S104-8,16,8-g45-path115", "128S158-8,32,4-g39-path14", "128S158-4,32,8-g39-path14", "128S104-8,16,8-g45-path116", "128S112-4,16,4-g29-path305" ];
