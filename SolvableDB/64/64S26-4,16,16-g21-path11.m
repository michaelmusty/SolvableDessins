...
s`SolvableDBName := "64S26-4,16,16-g21-path11";
s`SolvableDBFilename := "64S26-4,16,16-g21-path11.m";
...
\[ 6, 1, 15, 19, 21, 9, 4, 3, 2, 5, 7, 8, 30, 34, 12, 13, 29, 40, 11, 17, 26, 18, 14, 20, 16, 10, 22, 23, 24, 25, 46, 48, 31, 28, 32, 33, 45, 47, 37, 27, 38, 39, 41, 35, 42, 36, 43, 44, 55, 64, 49, 50, 51, 52, 53, 62, 63, 56, 57, 58, 59, 60, 61, 54 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T5-2,8,8-g3-path7", "32S16-4,16,16-g11-path6", "64S26-4,16,16-g21-path11" ];
s`SolvableDBParents := [ Strings() | "128S128-8,32,32-g53-path10", "128S129-4,32,32-g45-path10", "128S44-8,16,16-g49-path10", "128S128-4,32,32-g45-path10", "128S42-8,16,16-g49-path10", "128S129-8,32,32-g53-path10", "128S106-4,16,16-g41-path237" ];
