...
s`SolvableDBName := "64S25-4,8,8-g17-path157";
s`SolvableDBFilename := "64S25-4,8,8-g17-path157.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T8-4,4,4-g3-path8", "32S2-4,4,4-g5-path80", "64S25-4,8,8-g17-path157" ];
