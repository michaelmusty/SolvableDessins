...
s`SolvableDBName := "64S8-4,4,8-g13-path35";
s`SolvableDBFilename := "64S8-4,4,8-g13-path35.m";
...
\[ 6, 1, 26, 27, 23, 9, 4, 28, 2, 3, 5, 7, 8, 22, 44, 56, 42, 14, 17, 33, 57, 39, 36, 21, 58, 35, 12, 31, 19, 20, 13, 37, 43, 61, 10, 11, 15, 16, 18, 24, 25, 29, 30, 32, 34, 55, 45, 59, 62, 48, 46, 49, 50, 52, 64, 63, 40, 60, 53, 41, 47, 54, 38, 51 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S6-4,4,4-g5-path12", "64S8-4,4,8-g13-path35" ];
s`SolvableDBParents := [ Strings() | "128S81-8,4,16-g37-path55", "128S80-4,4,16-g29-path281", "128S3-8,4,8-g33-path960", "128S73-8,4,16-g37-path21", "128S72-4,4,16-g29-path121", "128S78-8,4,8-g33-path148", "128S79-4,4,16-g29-path123", "128S2-8,4,8-g33-path246", "128S82-8,4,16-g37-path128", "128S71-4,4,16-g29-path43", "128S77-8,4,8-g33-path65", "128S74-8,4,16-g37-path60", "128S75-4,4,8-g25-path87", "128S26-4,4,8-g25-path899", "128S76-4,4,8-g25-path209" ];
