...
s`SolvableDBName := "64S16-8,8,8-g21-path107";
s`SolvableDBFilename := "64S16-8,8,8-g21-path107.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T6-8,8,4-g5-path3", "32S12-8,8,4-g9-path22", "64S16-8,8,8-g21-path107" ];
