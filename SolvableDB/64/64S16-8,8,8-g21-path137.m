...
s`SolvableDBName := "64S16-8,8,8-g21-path137";
s`SolvableDBFilename := "64S16-8,8,8-g21-path137.m";
...
[ 13, 3, 54, 49, 37, 7, 56, 38, 10, 58, 16, 17, 55, 19, 9, 50, 33, 1, 31, 21, 11, 39, 57, 25, 26, 29, 23, 12, 59, 27, 32, 40, 43, 64, 36, 53, 41, 42, 44, 35, 18, 52, 2, 51, 5, 24, 48, 4, 30, 6, 34, 15, 14, 28, 45, 20, 47, 8, 60, 61, 46, 63, 22, 62 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T5-8,8,4-g5-path1", "32S12-8,8,4-g9-path8", "64S16-8,8,8-g21-path137" ];
