...
s`SolvableDBName := "64S51-32,32,2-g15-path2";
s`SolvableDBFilename := "64S51-32,32,2-g15-path2.m";
...
s`SolvableDBParents := [ Strings() | "128S153-32,32,4-g45-path12", "128S129-32,32,4-g45-path4", "128S131-32,32,2-g29-path7" ];
