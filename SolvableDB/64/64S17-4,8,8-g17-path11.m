...
s`SolvableDBName := "64S17-4,8,8-g17-path11";
s`SolvableDBFilename := "64S17-4,8,8-g17-path11.m";
...
\[ 12, 32, 17, 7, 2, 5, 27, 16, 20, 29, 13, 9, 24, 3, 18, 10, 25, 40, 4, 1, 26, 11, 28, 22, 14, 47, 19, 35, 8, 31, 33, 6, 34, 30, 36, 23, 15, 41, 42, 37, 51, 53, 21, 45, 49, 48, 43, 50, 62, 55, 52, 38, 54, 39, 46, 57, 60, 59, 61, 63, 64, 44, 56, 58 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T8-4,4,4-g3-path2", "32S12-4,8,8-g9-path37", "64S17-4,8,8-g17-path11" ];
s`SolvableDBParents := [ Strings() | "128S106-8,16,16-g49-path7", "128S108-4,16,16-g41-path7", "128S9-8,8,8-g41-path619", "128S111-4,16,16-g41-path13", "128S10-8,8,8-g41-path13", "128S110-8,16,16-g49-path13", "128S111-4,16,16-g41-path14", "128S10-8,8,8-g41-path14", "128S110-8,16,16-g49-path14", "128S109-8,16,16-g49-path7", "128S107-4,16,16-g41-path7", "128S7-8,8,8-g41-path7", "128S106-4,16,16-g41-path7", "128S5-8,8,8-g41-path7", "128S108-8,16,16-g49-path7", "128S111-8,16,16-g49-path13", "128S110-4,16,16-g41-path13", "128S15-8,8,8-g41-path13", "128S111-8,16,16-g49-path14", "128S110-4,16,16-g41-path14", "128S15-8,8,8-g41-path14", "128S109-4,16,16-g41-path7", "128S13-8,8,8-g41-path7", "128S107-8,16,16-g49-path7", "128S14-4,8,8-g33-path13", "128S14-4,8,8-g33-path14", "128S12-4,8,8-g33-path7", "128S8-4,8,8-g33-path7", "128S11-4,8,8-g33-path13", "128S11-4,8,8-g33-path14", "128S6-4,8,8-g33-path7" ];
