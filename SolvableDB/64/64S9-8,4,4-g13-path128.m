...
s`SolvableDBName := "64S9-8,4,4-g13-path128";
s`SolvableDBFilename := "64S9-8,4,4-g13-path128.m";
...
\[ 6, 1, 22, 23, 21, 24, 4, 25, 2, 3, 5, 7, 8, 20, 51, 50, 52, 49, 48, 41, 9, 37, 31, 11, 12, 19, 16, 42, 47, 10, 13, 14, 15, 17, 18, 26, 27, 28, 29, 33, 55, 36, 62, 60, 63, 44, 32, 58, 40, 30, 53, 61, 35, 45, 39, 43, 34, 38, 46, 54, 56, 57, 64, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S6-4,4,2-g1-path4", "64S9-8,4,4-g13-path128" ];
s`SolvableDBParents := [ Strings() | "128S3-8,8,4-g33-path1175", "128S4-8,8,4-g33-path569", "128S86-8,8,4-g33-path207", "128S85-8,8,4-g33-path207", "128S26-8,4,4-g25-path1021", "128S84-8,4,4-g25-path175", "128S83-8,4,4-g25-path175" ];
