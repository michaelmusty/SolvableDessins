...
s`SolvableDBName := "64S41-4,2,16-g7-path10";
s`SolvableDBFilename := "64S41-4,2,16-g7-path10.m";
...
\[ 11, 26, 25, 3, 2, 5, 20, 17, 21, 9, 8, 29, 12, 35, 36, 13, 1, 14, 10, 15, 19, 4, 40, 38, 22, 6, 23, 27, 16, 43, 18, 30, 41, 47, 31, 7, 32, 33, 34, 28, 24, 58, 37, 46, 55, 42, 49, 53, 39, 48, 56, 64, 54, 50, 51, 45, 52, 44, 62, 63, 57, 60, 59, 61 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path2", "32S9-4,2,8-g3-path17", "64S41-4,2,16-g7-path10" ];
s`SolvableDBParents := [ Strings() | "128S92-8,2,16-g21-path79", "128S80-4,4,16-g29-path126", "128S66-8,4,16-g37-path17", "128S65-8,2,16-g21-path17", "128S118-4,4,16-g29-path400", "128S95-8,4,16-g37-path141", "128S79-4,2,16-g13-path40" ];
