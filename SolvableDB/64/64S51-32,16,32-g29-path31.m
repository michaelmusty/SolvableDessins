...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 45, 47, 17, 35, 14, 21, 51, 22, 56, 50, 38, 53, 57, 19, 20, 23, 10, 44, 31, 9, 11, 12, 13, 18, 27, 28, 29, 30, 32, 36, 33, 34, 61, 40, 43, 46, 52, 64, 62, 63, 48, 54, 59, 39, 49, 55, 37, 41, 42, 58, 60 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,4,8-g5-path4", "32S16-16,8,16-g13-path14", "64S51-32,16,32-g29-path31" ];
s`SolvableDBParents := [ Strings() | "128S131-32,16,32-g57-path224", "128S153-32,16,32-g57-path224", "128S129-32,16,32-g57-path118" ];
