...
s`SolvableDBName := "64S4-8,2,8-g9-path26";
s`SolvableDBFilename := "64S4-8,2,8-g9-path26.m";
...
[ 55, 47, 60, 52, 63, 32, 49, 39, 46, 40, 16, 27, 64, 53, 56, 11, 58, 33, 59, 42, 51, 23, 22, 50, 31, 38, 12, 41, 62, 61, 25, 6, 18, 48, 57, 45, 43, 26, 8, 10, 28, 20, 37, 54, 36, 9, 2, 34, 7, 24, 21, 4, 14, 44, 1, 15, 35, 17, 19, 3, 30, 29, 5, 13 ],
[ 50, 18, 46, 60, 54, 57, 36, 14, 38, 45, 43, 55, 62, 56, 44, 32, 64, 34, 30, 33, 52, 37, 6, 21, 59, 58, 35, 47, 51, 49, 53, 1, 4, 63, 29, 17, 28, 27, 19, 22, 24, 39, 13, 26, 12, 11, 8, 61, 23, 25, 48, 15, 3, 16, 2, 40, 42, 41, 5, 7, 9, 31, 10, 20 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S6-4,2,4-g1-path11", "64S4-8,2,8-g9-path26" ];
