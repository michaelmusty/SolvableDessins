...
s`SolvableDBName := "64S17-4,8,8-g17-path180";
s`SolvableDBFilename := "64S17-4,8,8-g17-path180.m";
...
\[ 12, 40, 46, 7, 2, 5, 39, 43, 22, 34, 13, 9, 28, 19, 14, 20, 64, 10, 29, 62, 30, 1, 31, 11, 32, 33, 18, 24, 15, 25, 59, 21, 57, 27, 37, 63, 61, 54, 41, 6, 4, 47, 42, 23, 58, 38, 8, 52, 16, 53, 35, 50, 48, 3, 26, 60, 55, 56, 44, 45, 51, 49, 17, 36 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T6-4,8,8-g5-path2", "32S4-4,8,8-g9-path21", "64S17-4,8,8-g17-path180" ];
s`SolvableDBParents := [ Strings() | "128S106-8,16,16-g49-path92", "128S108-4,16,16-g41-path92", "128S9-8,8,8-g41-path704", "128S111-4,16,16-g41-path183", "128S10-8,8,8-g41-path183", "128S110-8,16,16-g49-path183", "128S111-4,16,16-g41-path184", "128S10-8,8,8-g41-path184", "128S110-8,16,16-g49-path184", "128S109-8,16,16-g49-path92", "128S107-4,16,16-g41-path92", "128S7-8,8,8-g41-path92", "128S106-4,16,16-g41-path92", "128S5-8,8,8-g41-path92", "128S108-8,16,16-g49-path92", "128S111-8,16,16-g49-path183", "128S110-4,16,16-g41-path183", "128S15-8,8,8-g41-path183", "128S111-8,16,16-g49-path184", "128S110-4,16,16-g41-path184", "128S15-8,8,8-g41-path184", "128S109-4,16,16-g41-path92", "128S13-8,8,8-g41-path92", "128S107-8,16,16-g49-path92", "128S14-4,8,8-g33-path183", "128S14-4,8,8-g33-path184", "128S12-4,8,8-g33-path92", "128S8-4,8,8-g33-path92", "128S11-4,8,8-g33-path183", "128S11-4,8,8-g33-path184", "128S6-4,8,8-g33-path92" ];
s`SolvableDBChild := "32S4-4,8,8-g9-path21";
