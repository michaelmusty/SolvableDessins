...
s`SolvableDBName := "64S10-4,8,8-g17-path6";
s`SolvableDBFilename := "64S10-4,8,8-g17-path6.m";
...
\[ 22, 5, 52, 39, 6, 38, 4, 45, 12, 18, 24, 1, 11, 15, 28, 57, 61, 26, 14, 60, 31, 9, 54, 27, 29, 33, 13, 19, 21, 23, 25, 20, 10, 63, 47, 44, 7, 2, 37, 41, 8, 32, 58, 3, 40, 50, 62, 49, 46, 48, 16, 36, 55, 56, 43, 30, 64, 53, 35, 42, 34, 59, 17, 51 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S11-4,4,8-g7-path1", "64S10-4,8,8-g17-path6" ];
s`SolvableDBParents := [ Strings() | "128S87-4,16,16-g41-path55", "128S88-4,16,16-g41-path121", "128S87-4,16,16-g41-path56", "128S88-4,16,16-g41-path122", "128S4-4,8,8-g33-path61", "128S2-4,8,8-g33-path28", "128S27-4,8,8-g33-path61" ];
