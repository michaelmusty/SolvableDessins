...
\[ 6, 1, 4, 21, 19, 22, 15, 2, 3, 5, 7, 16, 17, 18, 48, 41, 25, 49, 8, 40, 28, 10, 38, 39, 9, 11, 12, 13, 14, 20, 23, 24, 42, 43, 44, 45, 46, 63, 62, 26, 53, 32, 54, 55, 60, 56, 33, 30, 52, 61, 50, 35, 34, 27, 29, 31, 36, 37, 47, 51, 64, 59, 58, 57 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path1", "32S6-4,2,4-g1-path2", "64S8-8,2,4-g5-path18" ];
s`SolvableDBParents := [ Strings() | "128S76-8,4,4-g25-path106", "128S77-8,2,8-g17-path101", "128S3-8,4,8-g33-path996", "128S26-8,4,4-g25-path796", "128S2-8,2,8-g17-path282", "128S78-8,4,8-g33-path184", "128S79-16,2,4-g13-path58", "128S72-16,4,4-g29-path18", "128S73-16,2,8-g21-path18", "128S82-16,4,8-g37-path86", "128S71-16,2,4-g13-path18", "128S80-16,4,4-g29-path178", "128S81-16,2,8-g21-path52", "128S74-16,4,8-g37-path18", "128S75-8,2,4-g9-path40" ];
