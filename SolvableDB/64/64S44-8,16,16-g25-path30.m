...
s`SolvableDBName := "64S44-8,16,16-g25-path30";
s`SolvableDBFilename := "64S44-8,16,16-g25-path30.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T8-4,4,4-g3-path24", "32S12-4,8,8-g9-path34", "64S44-8,16,16-g25-path30" ];
