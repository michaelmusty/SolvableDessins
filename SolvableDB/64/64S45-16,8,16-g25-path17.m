...
s`SolvableDBName := "64S45-16,8,16-g25-path17";
s`SolvableDBFilename := "64S45-16,8,16-g25-path17.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T8-4,4,4-g3-path19", "32S12-8,4,8-g9-path27", "64S45-16,8,16-g25-path17" ];
