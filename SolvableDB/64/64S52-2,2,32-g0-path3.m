...
s`SolvableDBName := "64S52-2,2,32-g0-path3";
s`SolvableDBFilename := "64S52-2,2,32-g0-path3.m";
...
\[ 3, 4, 1, 2, 10, 9, 12, 11, 6, 5, 8, 7, 18, 17, 20, 19, 14, 13, 16, 15, 26, 25, 28, 27, 22, 21, 24, 23, 34, 33, 36, 35, 30, 29, 32, 31, 42, 41, 44, 43, 38, 37, 40, 39, 50, 49, 52, 51, 46, 45, 48, 47, 58, 57, 60, 59, 54, 53, 56, 55, 64, 63, 62, 61 ],
\[ 4, 3, 9, 11, 12, 1, 10, 2, 17, 18, 19, 20, 5, 6, 7, 8, 25, 26, 27, 28, 13, 14, 15, 16, 33, 34, 35, 36, 21, 22, 23, 24, 41, 42, 43, 44, 29, 30, 31, 32, 49, 50, 51, 52, 37, 38, 39, 40, 57, 58, 59, 60, 45, 46, 47, 48, 63, 64, 61, 62, 53, 54, 55, 56 ] >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path2", "32S18-2,2,16-g0-path3", "64S52-2,2,32-g0-path3" ];
s`SolvableDBParents := [ Strings() | "128S147-4,2,32-g15-path24", "128S147-2,4,32-g15-path24", "128S155-4,4,32-g31-path24", "128S161-2,2,64-g0-path1", "128S162-4,2,64-g16-path1", "128S162-2,4,64-g16-path1", "128S163-4,4,64-g32-path1" ];
