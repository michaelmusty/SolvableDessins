...
s`SolvableDBName := "64S4-8,4,8-g17-path23";
s`SolvableDBFilename := "64S4-8,4,8-g17-path23.m";
...
\[ 41, 61, 13, 18, 20, 16, 10, 64, 22, 38, 43, 28, 27, 57, 47, 2, 48, 36, 21, 37, 8, 46, 58, 3, 5, 7, 54, 55, 44, 40, 42, 29, 49, 35, 31, 50, 6, 4, 62, 19, 9, 51, 63, 14, 56, 12, 32, 52, 17, 26, 23, 53, 45, 11, 1, 33, 60, 59, 34, 15, 25, 30, 24, 39 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T6-8,4,8-g5-path1", "32S5-8,4,8-g9-path23", "64S4-8,4,8-g17-path23" ];
s`SolvableDBParents := [ Strings() | "128S53-16,8,16-g49-path19", "128S53-16,8,16-g49-path20", "128S46-16,8,16-g49-path143", "128S46-16,8,16-g49-path144", "128S52-16,8,16-g49-path19", "128S52-16,8,16-g49-path20", "128S47-16,8,16-g49-path111", "128S47-16,8,16-g49-path112", "128S12-8,4,8-g33-path488", "128S50-8,4,8-g33-path32", "128S51-8,4,8-g33-path99", "128S2-8,4,8-g33-path88", "128S4-8,4,8-g33-path211", "128S48-8,4,8-g33-path32", "128S49-8,4,8-g33-path99" ];
