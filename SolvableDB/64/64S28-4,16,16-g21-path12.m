...
s`SolvableDBName := "64S28-4,16,16-g21-path12";
s`SolvableDBFilename := "64S28-4,16,16-g21-path12.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T4-4,4,4-g3-path8", "32S4-4,8,8-g9-path14", "64S28-4,16,16-g21-path12" ];
