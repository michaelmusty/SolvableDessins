...
s`SolvableDBName := "64S28-16,16,4-g21-path17";
s`SolvableDBFilename := "64S28-16,16,4-g21-path17.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T6-8,8,2-g3-path2", "32S4-8,8,4-g9-path17", "64S28-16,16,4-g21-path17" ];
