...
s`SolvableDBName := "64S4-8,2,8-g9-path32";
s`SolvableDBFilename := "64S4-8,2,8-g9-path32.m";
...
[ 30, 54, 28, 12, 57, 14, 62, 45, 42, 50, 51, 4, 56, 6, 64, 21, 34, 22, 37, 46, 16, 18, 33, 40, 26, 25, 52, 3, 49, 1, 38, 53, 23, 17, 63, 39, 19, 31, 36, 24, 60, 9, 59, 47, 8, 20, 44, 58, 29, 10, 11, 27, 32, 2, 61, 13, 5, 48, 43, 41, 55, 7, 35, 15 ],
[ 40, 23, 42, 28, 47, 63, 8, 32, 25, 39, 19, 30, 49, 64, 2, 14, 56, 58, 55, 22, 12, 59, 53, 11, 37, 34, 5, 54, 16, 62, 6, 61, 27, 57, 7, 48, 60, 4, 43, 33, 10, 45, 15, 31, 52, 21, 36, 1, 18, 38, 17, 13, 41, 51, 44, 50, 46, 3, 35, 29, 20, 26, 24, 9 ]
]
];
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S6-4,2,4-g1-path7", "64S4-8,2,8-g9-path32" ];
