...
\[ 42, 63, 13, 18, 20, 16, 10, 25, 22, 34, 44, 29, 28, 47, 49, 2, 50, 38, 30, 39, 8, 48, 59, 3, 40, 5, 7, 51, 57, 45, 41, 43, 21, 4, 37, 52, 32, 62, 6, 64, 33, 9, 55, 53, 14, 60, 61, 12, 19, 54, 11, 17, 24, 56, 23, 46, 1, 35, 58, 36, 15, 27, 26, 31 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T10-4,2,4-g1-path5-notcomputed", "32S8-8,4,8-g9-path2-notcomputed", "64S24-8,4,8-g17-path7-notcomputed" ];
