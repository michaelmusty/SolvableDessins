...
s`SolvableDBName := "64S27-16,16,8-g25-path35";
s`SolvableDBFilename := "64S27-16,16,8-g25-path35.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 43, 45, 17, 49, 14, 21, 18, 22, 48, 32, 47, 44, 50, 19, 20, 23, 10, 42, 31, 9, 11, 12, 13, 27, 28, 29, 30, 55, 46, 57, 61, 62, 59, 60, 41, 63, 64, 38, 36, 33, 34, 35, 37, 39, 40, 51, 52, 56, 53, 58, 54 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T4-4,4,4-g3-path4", "32S3-8,8,4-g9-path1", "64S27-16,16,8-g25-path35" ];
s`SolvableDBParents := [ Strings() | "128S130-32,32,16-g57-path129", "128S130-32,32,16-g57-path130", "128S130-32,32,16-g57-path131", "128S130-32,32,16-g57-path132", "128S106-16,16,8-g49-path307", "128S44-16,16,8-g49-path170", "128S43-16,16,8-g49-path76" ];
