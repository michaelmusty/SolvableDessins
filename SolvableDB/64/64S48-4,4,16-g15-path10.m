...
s`SolvableDBName := "64S48-4,4,16-g15-path10";
s`SolvableDBFilename := "64S48-4,4,16-g15-path10.m";
...
\[ 6, 1, 24, 16, 18, 9, 4, 25, 2, 3, 5, 7, 8, 11, 33, 12, 13, 14, 23, 28, 26, 10, 21, 22, 17, 19, 20, 32, 31, 41, 15, 27, 29, 30, 42, 49, 39, 34, 35, 44, 38, 37, 40, 48, 47, 58, 36, 43, 45, 46, 57, 64, 50, 55, 51, 60, 54, 53, 56, 63, 62, 52, 59, 61 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path18", "32S14-4,4,8-g7-path17", "64S48-4,4,16-g15-path10" ];
s`SolvableDBParents := [ Strings() | "128S158-8,4,32-g39-path9", "128S158-4,8,32-g39-path9", "128S104-8,8,16-g45-path111", "128S158-8,4,32-g39-path10", "128S158-4,8,32-g39-path10", "128S104-8,8,16-g45-path112", "128S112-4,4,16-g29-path303" ];
