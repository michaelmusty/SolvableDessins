...
s`SolvableDBName := "64S15-8,8,8-g21-path43";
s`SolvableDBFilename := "64S15-8,8,8-g21-path43.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-2,8,8-g3-path6", "32S12-4,8,8-g9-path6", "64S15-8,8,8-g21-path43" ];
