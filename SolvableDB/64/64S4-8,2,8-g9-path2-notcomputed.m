...
s`SolvableDBName := "64S4-8,2,8-g9-path2-notcomputed";
s`SolvableDBFilename := "64S4-8,2,8-g9-path2-notcomputed.m";
...
\[ 47, 42, 51, 59, 52, 62, 20, 17, 21, 48, 22, 33, 43, 60, 61, 50, 57, 55, 64, 29, 34, 54, 4, 45, 14, 5, 41, 6, 40, 15, 49, 63, 58, 10, 31, 19, 18, 32, 46, 44, 56, 26, 53, 30, 35, 25, 8, 36, 38, 12, 23, 28, 16, 1, 39, 3, 11, 13, 27, 37, 7, 2, 24, 9 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,2,4-g1-path1-notcomputed", "8T2-4,2,4-g1-path2-notcomputed", "16T10-4,2,4-g1-path3-notcomputed", "32S5-8,2,8-g5-path1-notcomputed", "64S4-8,2,8-g9-path2-notcomputed" ];
s`SolvableDBChild := "32S5-8,2,8-g5-path1-notcomputed";
