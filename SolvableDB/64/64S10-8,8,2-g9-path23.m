...
s`SolvableDBName := "64S10-8,8,2-g9-path23";
s`SolvableDBFilename := "64S10-8,8,2-g9-path23.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 49, 48, 24, 20, 50, 47, 51, 45, 17, 44, 52, 53, 16, 18, 8, 9, 10, 11, 12, 13, 14, 15, 25, 60, 27, 54, 39, 30, 61, 32, 35, 34, 40, 63, 41, 42, 38, 31, 56, 55, 64, 57, 43, 37, 46, 26, 28, 29, 33, 36, 58, 62, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path3", "32S7-8,8,2-g5-path11", "64S10-8,8,2-g9-path23" ];
s`SolvableDBParents := [ Strings() | "128S4-8,8,4-g33-path28", "128S27-8,8,4-g33-path28", "128S87-16,16,2-g25-path55", "128S88-16,16,4-g41-path55", "128S87-16,16,2-g25-path56", "128S88-16,16,4-g41-path56", "128S2-8,8,2-g17-path28" ];
