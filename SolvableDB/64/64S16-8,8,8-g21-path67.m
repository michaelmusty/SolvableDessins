...
s`SolvableDBName := "64S16-8,8,8-g21-path67";
s`SolvableDBFilename := "64S16-8,8,8-g21-path67.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T8-4,4,4-g3-path19", "32S12-8,4,8-g9-path28", "64S16-8,8,8-g21-path67" ];
s`SolvableDBChildren := [ Strings() | "32S12-8,4,8-g9-path28" ];
