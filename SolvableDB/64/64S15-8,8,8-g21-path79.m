...
s`SolvableDBName := "64S15-8,8,8-g21-path79";
s`SolvableDBFilename := "64S15-8,8,8-g21-path79.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path6", "32S12-8,4,8-g9-path39", "64S15-8,8,8-g21-path79" ];
