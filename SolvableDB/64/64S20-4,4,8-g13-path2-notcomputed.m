...
\[ 11, 30, 12, 7, 2, 5, 10, 33, 18, 31, 9, 22, 51, 13, 36, 37, 8, 1, 24, 3, 25, 20, 14, 34, 35, 56, 29, 39, 59, 6, 4, 17, 32, 57, 47, 49, 52, 62, 40, 46, 38, 16, 60, 26, 27, 28, 21, 15, 48, 54, 23, 42, 41, 55, 64, 58, 19, 44, 45, 61, 63, 53, 43, 50 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T1-4,2,4-g1-path1-notcomputed", "8T2-4,2,4-g1-path2-notcomputed", "16T10-4,2,4-g1-path3-notcomputed", "32S11-4,2,8-g3-path1-notcomputed", "64S20-4,4,8-g13-path2-notcomputed" ];
