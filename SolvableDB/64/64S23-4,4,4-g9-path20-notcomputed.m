...
\[ 6, 1, 27, 28, 24, 9, 4, 29, 2, 3, 5, 7, 8, 23, 45, 53, 13, 60, 32, 64, 61, 30, 52, 36, 21, 56, 33, 12, 17, 19, 20, 22, 10, 55, 38, 11, 14, 15, 16, 18, 25, 26, 31, 34, 35, 40, 62, 54, 47, 42, 44, 37, 63, 59, 51, 50, 49, 48, 58, 46, 41, 57, 39, 43 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T4-2,4,2-g0-path2-notcomputed", "16T10-2,4,4-g1-path5-notcomputed", "32S6-4,4,4-g5-path3-notcomputed", "64S23-4,4,4-g9-path20-notcomputed" ];
