...
s`SolvableDBName := "64S31-16,16,4-g21-path14";
s`SolvableDBFilename := "64S31-16,16,4-g21-path14.m";
...
\[ 6, 1, 22, 23, 21, 24, 4, 25, 2, 3, 5, 7, 8, 49, 14, 42, 41, 43, 27, 36, 48, 47, 45, 50, 17, 19, 16, 20, 10, 35, 9, 11, 12, 13, 15, 18, 26, 28, 29, 30, 54, 63, 44, 60, 61, 53, 56, 46, 57, 59, 32, 40, 31, 33, 34, 37, 38, 39, 51, 52, 62, 55, 64, 58 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,2-g3-path7", "32S5-8,8,2-g5-path13", "64S31-16,16,4-g21-path14" ];
s`SolvableDBParents := [ Strings() | "128S55-16,16,4-g41-path77", "128S61-16,16,4-g41-path109", "128S70-16,16,4-g41-path169", "128S69-16,16,4-g41-path233", "128S62-16,16,4-g41-path77", "128S111-16,16,4-g41-path531", "128S47-16,16,4-g41-path31" ];
