...
s`SolvableDBName := "64S23-4,4,4-g9-path286";
s`SolvableDBFilename := "64S23-4,4,4-g9-path286.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S6-4,4,4-g5-path18", "64S23-4,4,4-g9-path286" ];
