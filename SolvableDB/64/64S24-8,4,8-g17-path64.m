...
s`SolvableDBName := "64S24-8,4,8-g17-path64";
s`SolvableDBFilename := "64S24-8,4,8-g17-path64.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path26", "32S2-4,4,4-g5-path67", "64S24-8,4,8-g17-path64" ];
