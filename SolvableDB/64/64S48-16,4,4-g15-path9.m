...
s`SolvableDBName := "64S48-16,4,4-g15-path9";
s`SolvableDBFilename := "64S48-16,4,4-g15-path9.m";
...
\[ 6, 1, 8, 24, 20, 25, 22, 26, 2, 3, 4, 5, 7, 29, 30, 14, 16, 21, 43, 41, 23, 19, 42, 39, 44, 45, 15, 11, 46, 40, 9, 10, 12, 13, 17, 18, 27, 28, 59, 58, 56, 57, 55, 60, 61, 62, 31, 32, 33, 34, 35, 36, 37, 38, 54, 47, 64, 63, 50, 49, 51, 48, 52, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T8-4,4,4-g3-path5", "32S14-8,4,4-g7-path9", "64S48-16,4,4-g15-path9" ];
s`SolvableDBParents := [ Strings() | "128S158-32,8,4-g39-path17", "128S158-32,4,8-g39-path17", "128S104-16,8,8-g45-path119", "128S158-32,8,4-g39-path18", "128S158-32,4,8-g39-path18", "128S104-16,8,8-g45-path120", "128S112-16,4,4-g29-path307" ];
