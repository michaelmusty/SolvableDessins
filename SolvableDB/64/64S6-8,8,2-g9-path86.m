...
s`SolvableDBName := "64S6-8,8,2-g9-path86";
s`SolvableDBFilename := "64S6-8,8,2-g9-path86.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 34, 12, 24, 20, 41, 40, 37, 39, 17, 38, 42, 43, 16, 18, 8, 9, 10, 11, 13, 14, 15, 25, 52, 31, 59, 57, 58, 55, 36, 60, 61, 44, 26, 27, 28, 29, 30, 32, 33, 35, 56, 50, 45, 62, 63, 64, 54, 49, 51, 47, 46, 48, 53 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T13-8,2,2-g0-path3", "32S9-8,4,2-g3-path17", "64S6-8,8,2-g9-path86" ];
s`SolvableDBParents := [ Strings() | "128S67-8,16,4-g37-path39", "128S68-8,16,4-g37-path39", "128S63-16,8,2-g21-path79", "128S61-16,16,4-g41-path201", "128S65-16,8,2-g21-path73", "128S62-16,16,4-g41-path169", "128S67-8,16,2-g21-path39", "128S11-8,8,4-g33-path1103", "128S68-8,16,2-g21-path39", "128S3-8,8,4-g33-path569", "128S61-16,16,2-g25-path201", "128S64-16,8,4-g37-path119", "128S62-16,16,2-g25-path169", "128S66-16,8,4-g37-path107", "128S2-8,8,2-g17-path200" ];
