...
s`SolvableDBName := "64S31-2,16,16-g13-path21";
s`SolvableDBFilename := "64S31-2,16,16-g13-path21.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 26, 27, 28, 29, 21, 22, 19, 23, 17, 30, 15, 16, 18, 25, 24, 11, 12, 13, 14, 20, 53, 54, 34, 33, 38, 52, 51, 35, 41, 46, 39, 43, 42, 49, 50, 40, 48, 47, 44, 45, 37, 36, 31, 32, 56, 55, 64, 62, 60, 59, 63, 58, 61, 57 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S5-2,8,8-g5-path8", "64S31-2,16,16-g13-path21" ];
s`SolvableDBParents := [ Strings() | "128S69-4,16,16-g41-path172", "128S55-4,16,16-g41-path16", "128S111-4,16,16-g41-path470", "128S70-4,16,16-g41-path108", "128S62-2,16,16-g25-path62", "128S61-2,16,16-g25-path94", "128S47-2,16,16-g25-path16" ];
