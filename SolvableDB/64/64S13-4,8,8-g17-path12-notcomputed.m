...
s`SolvableDBName := "64S13-4,8,8-g17-path12-notcomputed";
s`SolvableDBFilename := "64S13-4,8,8-g17-path12-notcomputed.m";
...
\[ 6, 1, 22, 7, 2, 5, 19, 23, 3, 4, 8, 11, 43, 34, 9, 33, 24, 25, 10, 26, 27, 15, 12, 20, 30, 17, 16, 18, 32, 28, 13, 14, 21, 29, 59, 46, 31, 50, 45, 44, 49, 48, 37, 39, 40, 42, 35, 36, 38, 41, 54, 64, 47, 63, 60, 61, 51, 62, 53, 56, 55, 52, 57, 58 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T4-2,4,2-g0-path2-notcomputed", "16T10-2,4,4-g1-path5-notcomputed", "32S9-2,8,4-g3-path3-notcomputed", "64S13-4,8,8-g17-path12-notcomputed" ];
s`SolvableDBParents := [ Strings() | "128S96-4,16,8-g37-path2-notcomputed", "128S95-4,16,8-g37-path3-notcomputed", "128S97-4,16,8-g37-path2-notcomputed", "128S95-4,16,8-g37-path4-notcomputed", "128S3-4,8,8-g33-path17-notcomputed", "128S28-4,8,8-g33-path6-notcomputed", "128S3-4,8,8-g33-path18-notcomputed" ];
