...
s`SolvableDBName := "64S45-8,16,16-g25-path36";
s`SolvableDBFilename := "64S45-8,16,16-g25-path36.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path32", "32S12-4,8,8-g9-path41", "64S45-8,16,16-g25-path36" ];
