...
s`SolvableDBName := "64S27-16,4,16-g21-path11";
s`SolvableDBFilename := "64S27-16,4,16-g21-path11.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,2,8-g3-path4", "32S17-16,4,16-g11-path4", "64S27-16,4,16-g21-path11" ];
