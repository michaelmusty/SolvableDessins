...
s`SolvableDBName := "64S18-4,4,8-g13-path17";
s`SolvableDBFilename := "64S18-4,4,8-g13-path17.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S2-4,4,4-g5-path24", "64S18-4,4,8-g13-path17" ];
