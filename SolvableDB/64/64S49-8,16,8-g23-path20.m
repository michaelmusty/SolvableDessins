...
s`SolvableDBName := "64S49-8,16,8-g23-path20";
s`SolvableDBFilename := "64S49-8,16,8-g23-path20.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T13-2,8,2-g0-path2", "32S14-4,8,4-g7-path2", "64S49-8,16,8-g23-path20" ];
