...
s`SolvableDBName := "64S14-8,4,8-g17-path28";
s`SolvableDBFilename := "64S14-8,4,8-g17-path28.m";
...
\[ 42, 63, 13, 18, 20, 16, 10, 25, 22, 34, 44, 29, 28, 47, 49, 2, 50, 38, 30, 39, 8, 48, 58, 3, 40, 5, 7, 51, 56, 45, 41, 43, 21, 4, 52, 37, 17, 62, 6, 64, 33, 9, 55, 53, 14, 57, 61, 12, 19, 54, 11, 32, 24, 59, 23, 1, 36, 60, 46, 35, 15, 27, 26, 31 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path2", "32S10-8,4,4-g7-path11", "64S14-8,4,8-g17-path28" ];
s`SolvableDBParents := [ Strings() | "128S98-16,4,16-g41-path109", "128S98-16,4,16-g41-path110", "128S98-16,4,16-g41-path111", "128S98-16,4,16-g41-path112", "128S4-8,4,8-g33-path121", "128S28-8,4,8-g33-path163", "128S4-8,4,8-g33-path122" ];
