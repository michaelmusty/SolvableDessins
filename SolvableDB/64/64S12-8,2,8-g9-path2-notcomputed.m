...
s`SolvableDBName := "64S12-8,2,8-g9-path2-notcomputed";
s`SolvableDBFilename := "64S12-8,2,8-g9-path2-notcomputed.m";
...
\[ 6, 1, 4, 20, 18, 21, 15, 2, 3, 5, 7, 16, 17, 11, 33, 22, 24, 8, 27, 26, 10, 34, 35, 9, 12, 13, 14, 19, 23, 29, 36, 37, 28, 32, 41, 40, 38, 25, 43, 51, 45, 52, 30, 31, 39, 42, 44, 46, 53, 54, 50, 56, 57, 47, 58, 60, 63, 48, 49, 55, 59, 64, 62, 61 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T10-4,2,4-g1-path5-notcomputed", "32S9-4,2,8-g3-path2-notcomputed", "64S12-8,2,8-g9-path2-notcomputed" ];
