...
s`SolvableDBName := "64S4-8,8,4-g17-path3-notcomputed";
s`SolvableDBFilename := "64S4-8,8,4-g17-path3-notcomputed.m";
...
\[ 44, 61, 31, 14, 30, 22, 64, 11, 21, 20, 38, 28, 27, 36, 7, 17, 42, 45, 40, 48, 49, 2, 39, 41, 16, 57, 8, 51, 4, 37, 33, 53, 43, 5, 46, 62, 6, 63, 13, 59, 60, 52, 24, 9, 50, 19, 58, 18, 12, 26, 1, 32, 56, 47, 3, 25, 10, 35, 54, 55, 34, 15, 23, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T2-4,4,2-g1-path1-notcomputed", "16T5-8,8,4-g5-path5-notcomputed", "32S5-8,8,4-g9-path4-notcomputed", "64S4-8,8,4-g17-path3-notcomputed" ];
