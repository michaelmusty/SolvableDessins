...
s`SolvableDBName := "64S17-8,8,4-g17-path20-notcomputed";
s`SolvableDBFilename := "64S17-8,8,4-g17-path20-notcomputed.m";
...
\[ 38, 56, 48, 40, 36, 9, 26, 59, 60, 57, 20, 45, 21, 23, 49, 51, 13, 34, 43, 24, 30, 31, 63, 39, 8, 28, 35, 12, 2, 41, 62, 5, 16, 50, 61, 46, 64, 29, 32, 55, 25, 53, 22, 47, 4, 11, 14, 54, 58, 44, 19, 37, 52, 10, 7, 6, 27, 42, 17, 1, 3, 33, 18, 15 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,1-g0-path1-notcomputed", "8T2-4,4,2-g1-path1-notcomputed", "16T10-4,4,2-g1-path3-notcomputed", "32S5-8,8,4-g9-path2-notcomputed", "64S17-8,8,4-g17-path20-notcomputed" ];
