...
s`SolvableDBName := "64S39-16,4,4-g15-path19";
s`SolvableDBFilename := "64S39-16,4,4-g15-path19.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T13-8,2,2-g0-path1", "32S9-8,2,4-g3-path15", "64S39-16,4,4-g15-path19" ];
