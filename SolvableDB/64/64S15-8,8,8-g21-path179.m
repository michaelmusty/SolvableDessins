...
s`SolvableDBName := "64S15-8,8,8-g21-path179";
s`SolvableDBFilename := "64S15-8,8,8-g21-path179.m";
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 15, 58, 47, 44, 34, 33, 56, 39, 60, 52, 9, 21, 59, 54, 43, 11, 17, 19, 20, 22, 23, 10, 46, 14, 36, 12, 13, 16, 18, 25, 26, 31, 32, 35, 37, 38, 51, 48, 53, 62, 41, 61, 64, 42, 63, 40, 55, 45, 57, 50, 49 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path33", "32S13-4,8,4-g7-path14", "64S15-8,8,8-g21-path179" ];
s`SolvableDBParents := [ Strings() | "128S100-8,16,8-g45-path133", "128S100-8,16,8-g45-path134", "128S99-16,8,16-g49-path133", "128S101-16,16,16-g53-path407", "128S99-16,8,16-g49-path134", "128S101-16,16,16-g53-path408", "128S9-8,8,8-g41-path204" ];
s`SolvableDBChild := "32S13-4,8,4-g7-path14";
