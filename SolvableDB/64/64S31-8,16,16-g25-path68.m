...
s`SolvableDBName := "64S31-8,16,16-g25-path68";
s`SolvableDBFilename := "64S31-8,16,16-g25-path68.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S5-4,8,8-g9-path3", "64S31-8,16,16-g25-path68" ];
