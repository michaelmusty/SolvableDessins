...
\[ 32, 29, 33, 13, 61, 20, 17, 7, 6, 35, 59, 28, 12, 49, 42, 51, 30, 40, 27, 2, 44, 10, 45, 55, 52, 25, 22, 8, 36, 4, 3, 9, 19, 15, 31, 1, 34, 24, 48, 37, 62, 23, 58, 43, 18, 56, 16, 64, 53, 39, 54, 60, 57, 46, 11, 41, 50, 26, 63, 21, 38, 47, 5, 14 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path3", "32S10-8,4,4-g7-path22", "64S13-8,8,4-g17-path27" ];
s`SolvableDBParents := [ Strings() | "128S96-8,16,4-g37-path3", "128S95-8,16,4-g37-path5", "128S95-8,16,4-g37-path6", "128S97-8,16,4-g37-path3", "128S3-8,8,4-g33-path139", "128S3-8,8,4-g33-path140", "128S28-8,8,4-g33-path49" ];
