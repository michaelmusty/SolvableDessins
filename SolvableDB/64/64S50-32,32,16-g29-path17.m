...
s`SolvableDBName := "64S50-32,32,16-g29-path17";
s`SolvableDBFilename := "64S50-32,32,16-g29-path17.m";
...
\[ 6, 1, 15, 19, 21, 24, 4, 3, 2, 5, 7, 8, 37, 39, 41, 13, 45, 46, 48, 17, 49, 18, 14, 52, 20, 16, 9, 10, 11, 12, 22, 23, 25, 26, 43, 60, 62, 35, 58, 36, 64, 38, 55, 27, 28, 30, 44, 32, 34, 47, 40, 51, 42, 29, 31, 33, 50, 53, 54, 56, 59, 57, 61, 63 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path3", "32S16-16,16,8-g13-path12", "64S50-32,32,16-g29-path17" ];
s`SolvableDBParents := [ Strings() | "128S159-64,64,32-g61-path45", "128S160-64,64,32-g61-path29", "128S159-64,64,32-g61-path46", "128S160-64,64,32-g61-path30", "128S131-32,32,16-g57-path171", "128S128-32,32,16-g57-path109", "128S153-32,32,16-g57-path171" ];
