...
s`SolvableDBName := "64S50-32,16,32-g29-path33";
s`SolvableDBFilename := "64S50-32,16,32-g29-path33.m";
...
\[ 57, 59, 63, 32, 34, 51, 55, 64, 44, 56, 35, 47, 46, 48, 61, 50, 10, 12, 23, 28, 26, 30, 53, 40, 37, 52, 17, 62, 38, 19, 54, 58, 13, 24, 18, 20, 43, 22, 42, 25, 60, 31, 2, 5, 8, 9, 14, 41, 16, 27, 33, 36, 15, 4, 45, 6, 49, 3, 21, 7, 11, 1, 29, 39 ]:
 Order := 32 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,4,8-g5-path3", "32S16-16,8,16-g13-path16", "64S50-32,16,32-g29-path33" ];
s`SolvableDBParents := [ Strings() | "128S160-64,32,64-g61-path13", "128S159-64,32,64-g61-path29", "128S159-64,32,64-g61-path30", "128S160-64,32,64-g61-path14", "128S153-32,16,32-g57-path163", "128S131-32,16,32-g57-path163", "128S128-32,16,32-g57-path101" ];
s`SolvableDBChild := "32S16-16,8,16-g13-path16";
