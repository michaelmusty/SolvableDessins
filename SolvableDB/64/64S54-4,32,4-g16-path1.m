...
I<[x]> := ideal< P | [
x[1]^17*x[2]^2 - x[1]^16*x[2]^2 - x[1]^16 - x[1]^15 - x[1]^14 - x[1]^13 - x[1]^12 - x[1]^11 - x[1]^10 - x[1]^9 - x[1]^8 - x[1]^7 - x[1]^6 - x[1]^5 - x[1]^4 - x[1]^3 + x[1]*x[2]^2 - x[1]^2 - x[2]^2 - x[1]
] >;
...
s`SolvableDBName := "64S54-4,32,4-g16-path1";
s`SolvableDBFilename := "64S54-4,32,4-g16-path1.m";
...
s`SolvableDBParents := [ Strings() | "128S148-4,32,4-g31-path9", "128S155-4,32,4-g31-path5", "128S148-4,32,4-g31-path10" ];
