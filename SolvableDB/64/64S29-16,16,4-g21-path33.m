...
s`SolvableDBName := "64S29-16,16,4-g21-path33";
s`SolvableDBFilename := "64S29-16,16,4-g21-path33.m";
...
\[ 6, 1, 22, 23, 20, 24, 8, 25, 2, 3, 4, 5, 7, 44, 14, 42, 49, 43, 10, 47, 36, 48, 17, 50, 45, 29, 16, 30, 27, 35, 9, 11, 12, 13, 15, 18, 19, 21, 26, 28, 62, 63, 61, 64, 41, 53, 46, 57, 55, 59, 33, 37, 31, 32, 34, 38, 39, 40, 51, 52, 58, 54, 60, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T6-8,8,2-g3-path1", "32S5-8,8,2-g5-path23", "64S29-16,16,4-g21-path33" ];
s`SolvableDBParents := [ Strings() | "128S131-32,32,8-g53-path13", "128S133-32,32,8-g53-path25", "128S133-32,32,8-g53-path26", "128S132-32,32,8-g53-path13", "128S131-32,32,8-g53-path14", "128S133-32,32,8-g53-path27", "128S133-32,32,8-g53-path28", "128S132-32,32,8-g53-path14", "128S69-16,16,4-g41-path91", "128S61-16,16,4-g41-path13", "128S54-16,16,4-g41-path46", "128S106-16,16,4-g41-path363", "128S61-16,16,4-g41-path14", "128S69-16,16,4-g41-path92", "128S46-16,16,4-g41-path7" ];
