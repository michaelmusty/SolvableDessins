...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 11, 53, 12, 55, 14, 33, 36, 59, 49, 42, 34, 21, 44, 25, 54, 58, 17, 19, 20, 22, 23, 10, 51, 38, 15, 9, 13, 16, 18, 26, 31, 32, 35, 37, 41, 43, 45, 52, 63, 60, 48, 61, 62, 40, 64, 46, 56, 57, 47, 50, 39 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T8-4,4,4-g3-path17", "32S15-8,8,8-g11-path58", "64S15-8,8,8-g21-path267" ];
s`SolvableDBParents := [ Strings() | "128S100-8,8,16-g45-path115", "128S100-8,8,16-g45-path116", "128S99-16,16,8-g49-path115", "128S101-16,16,16-g53-path385", "128S99-16,16,8-g49-path116", "128S101-16,16,16-g53-path386", "128S9-8,8,8-g41-path193" ];
