...
s`SolvableDBName := "64S10-8,2,8-g9-path2";
s`SolvableDBFilename := "64S10-8,2,8-g9-path2.m";
...
\[ 6, 1, 19, 21, 17, 22, 16, 2, 3, 4, 5, 7, 42, 46, 44, 50, 8, 51, 43, 52, 9, 11, 40, 41, 24, 10, 12, 13, 14, 15, 18, 20, 23, 25, 49, 55, 36, 31, 63, 62, 56, 27, 26, 45, 58, 47, 38, 61, 59, 28, 29, 30, 48, 39, 34, 37, 35, 32, 33, 53, 54, 57, 64, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S11-4,2,8-g3-path7", "64S10-8,2,8-g9-path2" ];
s`SolvableDBParents := [ Strings() | "128S88-16,4,16-g41-path59", "128S87-16,2,16-g25-path59", "128S27-8,4,8-g33-path30", "128S87-16,2,16-g25-path60", "128S4-8,4,8-g33-path30", "128S88-16,4,16-g41-path60", "128S2-8,2,8-g17-path30" ];
