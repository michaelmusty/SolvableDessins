...
s`SolvableDBName := "64S46-16,8,4-g19-path8";
s`SolvableDBFilename := "64S46-16,8,4-g19-path8.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path26", "32S13-8,4,4-g7-path12", "64S46-16,8,4-g19-path8" ];
