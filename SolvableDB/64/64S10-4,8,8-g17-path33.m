...
\[ 6, 1, 21, 7, 2, 5, 19, 22, 3, 4, 8, 11, 50, 33, 9, 26, 23, 24, 10, 25, 15, 12, 20, 47, 17, 36, 30, 45, 13, 14, 16, 18, 27, 28, 34, 31, 56, 58, 29, 41, 54, 52, 49, 43, 35, 51, 32, 44, 48, 39, 59, 38, 40, 53, 46, 61, 37, 42, 55, 62, 57, 64, 60, 63 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path3", "32S7-2,8,8-g5-path5", "64S10-4,8,8-g17-path33" ];
s`SolvableDBParents := [ Strings() | "128S87-4,16,16-g41-path51", "128S88-4,16,16-g41-path117", "128S87-4,16,16-g41-path52", "128S88-4,16,16-g41-path118", "128S4-4,8,8-g33-path59", "128S2-4,8,8-g33-path26", "128S27-4,8,8-g33-path59" ];
