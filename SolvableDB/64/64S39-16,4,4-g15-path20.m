...
s`SolvableDBName := "64S39-16,4,4-g15-path20";
s`SolvableDBFilename := "64S39-16,4,4-g15-path20.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T13-8,2,2-g0-path2", "32S9-8,2,4-g3-path16", "64S39-16,4,4-g15-path20" ];
