...
s`SolvableDBName := "64S4-4,8,8-g17-path3-notcomputed";
s`SolvableDBFilename := "64S4-4,8,8-g17-path3-notcomputed.m";
...
\[ 22, 5, 52, 39, 6, 38, 4, 44, 12, 18, 24, 1, 11, 15, 28, 51, 63, 26, 14, 58, 31, 9, 54, 27, 29, 33, 13, 19, 21, 23, 25, 20, 10, 61, 47, 43, 7, 2, 37, 41, 8, 59, 3, 40, 57, 50, 62, 49, 46, 48, 45, 36, 55, 56, 42, 30, 16, 64, 53, 35, 17, 60, 34, 32 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-2,4,4-g1-path4-notcomputed", "16T5-4,8,8-g5-path3-notcomputed", "32S5-4,8,8-g9-path5-notcomputed", "64S4-4,8,8-g17-path3-notcomputed" ];
