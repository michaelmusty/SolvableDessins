...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S11-8,4,2-g3-path10", "64S9-8,4,4-g13-path81" ];
s`SolvableDBChildren := [ Strings() | "32S11-8,4,2-g3-path10" ];
