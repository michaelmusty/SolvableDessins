...
x[1]^2*x[4]^2 - x[1]^2*x[2] - nu^2*x[4]^2 - nu^2*x[2],
x[2]*x[4]^2 - 1,
x[3]^2 - x[1]
] >;
...
s`SolvableDBName := "64S6-8,8,2-g9-path2";
s`SolvableDBFilename := "64S6-8,8,2-g9-path2.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 44, 49, 46, 50, 9, 47, 30, 48, 17, 42, 15, 41, 16, 18, 8, 10, 11, 12, 13, 14, 20, 24, 25, 43, 57, 29, 45, 58, 61, 52, 56, 31, 59, 51, 60, 40, 62, 36, 54, 37, 26, 27, 28, 32, 33, 34, 35, 38, 39, 63, 64, 55, 53 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path5", "32S11-8,4,2-g3-path3", "64S6-8,8,2-g9-path2" ];
s`SolvableDBParents := [ Strings() | "128S11-8,8,4-g33-path36", "128S3-8,8,4-g33-path42", "128S67-16,8,2-g21-path3", "128S67-16,8,4-g37-path3", "128S68-16,8,2-g21-path3", "128S68-16,8,4-g37-path3", "128S63-8,16,2-g21-path7", "128S64-8,16,4-g37-path11", "128S65-8,16,2-g21-path5", "128S66-8,16,4-g37-path7", "128S61-16,16,2-g25-path14", "128S61-16,16,4-g41-path14", "128S62-16,16,2-g25-path10", "128S62-16,16,4-g41-path10", "128S2-8,8,2-g17-path15" ];
