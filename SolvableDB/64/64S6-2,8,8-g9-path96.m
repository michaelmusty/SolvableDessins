...
s`SolvableDBName := "64S6-2,8,8-g9-path96";
s`SolvableDBFilename := "64S6-2,8,8-g9-path96.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 26, 27, 28, 29, 21, 22, 19, 23, 17, 30, 15, 16, 18, 25, 24, 11, 12, 13, 14, 20, 44, 45, 42, 46, 41, 47, 48, 40, 43, 38, 35, 33, 39, 31, 32, 34, 36, 37, 52, 62, 60, 49, 59, 63, 58, 64, 61, 55, 53, 51, 57, 50, 54, 56 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path2", "32S9-2,8,4-g3-path15", "64S6-2,8,8-g9-path96" ];
s`SolvableDBParents := [ Strings() | "128S67-4,8,16-g37-path11", "128S68-4,8,16-g37-path11", "128S63-2,16,8-g21-path51", "128S61-4,16,16-g41-path144", "128S65-2,16,8-g21-path45", "128S62-4,16,16-g41-path112", "128S67-2,8,16-g21-path11", "128S11-4,8,8-g33-path1046", "128S68-2,8,16-g21-path11", "128S3-4,8,8-g33-path512", "128S61-2,16,16-g25-path144", "128S64-4,16,8-g37-path91", "128S62-2,16,16-g25-path112", "128S66-4,16,8-g37-path79", "128S2-2,8,8-g17-path143" ];
