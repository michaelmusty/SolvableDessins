...
s`SolvableDBName := "64S36-2,8,8-g9-path2";
s`SolvableDBFilename := "64S36-2,8,8-g9-path2.m";
...
\[ 10, 5, 28, 6, 2, 4, 26, 16, 11, 1, 9, 13, 12, 33, 39, 8, 47, 21, 22, 23, 18, 19, 20, 51, 31, 7, 36, 3, 37, 32, 25, 30, 14, 35, 34, 27, 29, 58, 15, 54, 43, 59, 41, 49, 50, 52, 17, 53, 44, 45, 24, 46, 48, 40, 57, 60, 55, 38, 42, 56, 64, 63, 62, 61 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path3", "32S6-2,4,4-g1-path5", "64S36-2,8,8-g9-path2" ];
s`SolvableDBParents := [ Strings() | "128S85-4,8,8-g33-path51", "128S56-4,8,8-g33-path26", "128S85-4,8,8-g33-path52", "128S126-4,8,8-g33-path210", "128S77-2,8,8-g17-path29", "128S50-2,8,8-g17-path15", "128S77-2,8,8-g17-path30" ];
