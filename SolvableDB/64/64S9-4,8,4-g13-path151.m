...
s`SolvableDBName := "64S9-4,8,4-g13-path151";
s`SolvableDBFilename := "64S9-4,8,4-g13-path151.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S6-4,4,4-g5-path4", "64S9-4,8,4-g13-path151" ];
