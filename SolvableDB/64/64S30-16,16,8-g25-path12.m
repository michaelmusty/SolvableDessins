...
\[ 6, 1, 26, 27, 21, 28, 23, 29, 2, 3, 4, 5, 7, 8, 63, 35, 47, 44, 16, 31, 61, 34, 62, 55, 43, 60, 39, 30, 13, 36, 57, 59, 10, 9, 56, 51, 11, 12, 14, 15, 17, 18, 19, 20, 22, 24, 25, 32, 33, 42, 38, 41, 54, 52, 50, 48, 49, 53, 58, 46, 45, 64, 37, 40 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S5-8,8,4-g9-path10", "64S30-16,16,8-g25-path12" ];
s`SolvableDBParents := [ Strings() | "128S70-16,16,8-g49-path69", "128S62-16,16,8-g49-path69", "128S109-16,16,8-g49-path262", "128S62-16,16,8-g49-path70", "128S54-16,16,8-g49-path113", "128S46-16,16,8-g49-path113", "128S70-16,16,8-g49-path70" ];
