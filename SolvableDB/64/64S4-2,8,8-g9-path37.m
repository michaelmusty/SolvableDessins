...
s`SolvableDBName := "64S4-2,8,8-g9-path37";
s`SolvableDBFilename := "64S4-2,8,8-g9-path37.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 26, 27, 28, 29, 21, 22, 19, 23, 17, 30, 15, 16, 18, 31, 32, 11, 12, 13, 14, 20, 24, 25, 53, 54, 49, 52, 39, 55, 37, 46, 42, 41, 47, 48, 50, 40, 43, 44, 35, 45, 56, 36, 33, 34, 38, 51, 59, 61, 57, 64, 58, 63, 62, 60 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S7-2,8,8-g5-path1", "64S4-2,8,8-g9-path37" ];
s`SolvableDBParents := [ Strings() | "128S4-4,8,8-g33-path161", "128S49-4,8,8-g33-path49", "128S51-4,8,8-g33-path49", "128S12-4,8,8-g33-path438", "128S46-2,16,16-g25-path67", "128S47-4,16,16-g41-path51", "128S53-2,16,16-g25-path5", "128S52-4,16,16-g41-path5", "128S52-2,16,16-g25-path5", "128S53-4,16,16-g41-path5", "128S47-2,16,16-g25-path51", "128S46-4,16,16-g41-path67", "128S50-2,8,8-g17-path27", "128S48-2,8,8-g17-path27", "128S2-2,8,8-g17-path83" ];
