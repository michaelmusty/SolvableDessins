...
s`SolvableDBName := "64S27-16,4,16-g21-path20";
s`SolvableDBFilename := "64S27-16,4,16-g21-path20.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 23, 41, 17, 46, 14, 21, 45, 22, 49, 44, 42, 48, 50, 19, 20, 10, 38, 30, 9, 11, 12, 13, 18, 27, 28, 29, 31, 61, 63, 57, 47, 59, 43, 58, 64, 60, 62, 36, 34, 32, 33, 35, 37, 39, 40, 51, 52, 53, 54, 55, 56 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,1,8-g0-path1", "16T5-8,2,8-g3-path1", "32S3-8,4,8-g9-path17", "64S27-16,4,16-g21-path20" ];
s`SolvableDBParents := [ Strings() | "128S130-32,8,32-g53-path15", "128S130-32,4,32-g45-path15", "128S44-16,8,16-g49-path102", "128S130-32,8,32-g53-path16", "128S130-32,4,32-g45-path16", "128S43-16,8,16-g49-path8", "128S106-16,4,16-g41-path282" ];
