...
s`SolvableDBName := "64S7-8,8,4-g17-path45";
s`SolvableDBFilename := "64S7-8,8,4-g17-path45.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path4", "32S10-8,4,4-g7-path17", "64S7-8,8,4-g17-path45" ];
