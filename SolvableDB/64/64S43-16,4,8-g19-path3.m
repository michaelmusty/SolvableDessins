...
s`SolvableDBName := "64S43-16,4,8-g19-path3";
s`SolvableDBFilename := "64S43-16,4,8-g19-path3.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S9-8,2,4-g3-path11", "64S43-16,4,8-g19-path3" ];
s`SolvableDBChildren := [ Strings() | "32S9-8,2,4-g3-path11" ];
