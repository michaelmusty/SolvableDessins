...
\[ 6, 1, 4, 22, 18, 23, 20, 24, 2, 3, 5, 7, 8, 17, 19, 21, 43, 42, 29, 27, 14, 39, 44, 45, 30, 13, 46, 41, 40, 28, 9, 10, 11, 12, 15, 16, 25, 26, 59, 58, 57, 56, 55, 60, 61, 62, 31, 32, 33, 34, 35, 36, 37, 38, 54, 47, 63, 64, 50, 49, 52, 48, 51, 53 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T13-8,2,2-g0-path1", "32S9-8,2,4-g3-path16", "64S43-16,4,8-g19-path3" ];
s`SolvableDBParents := [ Strings() | "128S66-16,4,8-g37-path39", "128S94-16,4,8-g37-path71", "128S82-16,4,8-g37-path39", "128S96-16,4,8-g37-path71", "128S82-16,4,8-g37-path40", "128S119-16,4,8-g37-path203", "128S66-16,4,8-g37-path40" ];
