...
s`SolvableDBName := "64S44-8,16,16-g25-path13";
s`SolvableDBFilename := "64S44-8,16,16-g25-path13.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T6-2,8,8-g3-path2", "32S12-4,8,8-g9-path16", "64S44-8,16,16-g25-path13" ];
