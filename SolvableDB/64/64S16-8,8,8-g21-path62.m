...
s`SolvableDBName := "64S16-8,8,8-g21-path62";
s`SolvableDBFilename := "64S16-8,8,8-g21-path62.m";
...
\[ 6, 1, 23, 24, 20, 17, 4, 7, 2, 3, 5, 8, 36, 46, 35, 25, 41, 44, 47, 40, 18, 21, 19, 39, 14, 10, 9, 11, 12, 13, 15, 16, 22, 26, 42, 37, 60, 30, 51, 59, 49, 57, 56, 58, 31, 43, 53, 32, 27, 28, 29, 33, 34, 38, 45, 48, 64, 63, 62, 61, 54, 50, 52, 55 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T6-8,4,8-g5-path5", "32S12-8,4,8-g9-path22", "64S16-8,8,8-g21-path62" ];
s`SolvableDBParents := [ Strings() | "128S102-16,8,16-g49-path61", "128S102-16,8,16-g49-path62", "128S103-8,16,8-g45-path31", "128S105-16,16,16-g53-path197", "128S105-16,16,16-g53-path198", "128S104-8,16,8-g45-path31", "128S9-8,8,8-g41-path405" ];
