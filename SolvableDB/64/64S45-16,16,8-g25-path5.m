...
s`SolvableDBName := "64S45-16,16,8-g25-path5";
s`SolvableDBFilename := "64S45-16,16,8-g25-path5.m";
...
\[ 50, 57, 30, 52, 27, 28, 61, 54, 37, 49, 35, 59, 10, 48, 11, 31, 56, 29, 45, 9, 51, 32, 21, 46, 64, 47, 13, 60, 23, 58, 53, 16, 42, 55, 18, 2, 5, 24, 33, 25, 12, 26, 34, 7, 62, 22, 43, 63, 6, 36, 3, 44, 19, 41, 14, 40, 20, 4, 38, 1, 15, 8, 17, 39 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T8-4,4,4-g3-path13", "32S12-8,8,4-g9-path31", "64S45-16,16,8-g25-path5" ];
s`SolvableDBParents := [ Strings() | "128S108-16,16,8-g49-path232", "128S102-16,16,8-g49-path411", "128S99-16,16,8-g49-path411" ];
