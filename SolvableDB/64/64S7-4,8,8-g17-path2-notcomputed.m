...
s`SolvableDBName := "64S7-4,8,8-g17-path2-notcomputed";
s`SolvableDBFilename := "64S7-4,8,8-g17-path2-notcomputed.m";
...
\[ 22, 5, 54, 41, 6, 40, 4, 47, 12, 18, 24, 1, 11, 15, 29, 60, 63, 27, 14, 16, 32, 9, 56, 28, 30, 48, 34, 13, 19, 21, 23, 25, 26, 10, 37, 64, 50, 46, 7, 2, 39, 43, 8, 33, 59, 3, 42, 44, 53, 61, 52, 49, 51, 38, 57, 58, 45, 31, 55, 62, 35, 20, 36, 17 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-2,2,4-g0-path1-notcomputed", "16T14-4,4,8-g4-path1-notcomputed", "32S10-4,4,8-g7-path10-notcomputed", "64S7-4,8,8-g17-path2-notcomputed" ];
