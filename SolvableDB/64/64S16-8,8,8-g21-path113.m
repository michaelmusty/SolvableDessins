...
s`SolvableDBName := "64S16-8,8,8-g21-path113";
s`SolvableDBFilename := "64S16-8,8,8-g21-path113.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T8-4,4,4-g3-path12", "32S12-8,8,4-g9-path28", "64S16-8,8,8-g21-path113" ];
