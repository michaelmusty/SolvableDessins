...
s`SolvableDBName := "64S51-4,32,32-g23-path2";
s`SolvableDBFilename := "64S51-4,32,32-g23-path2.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T1-2,16,16-g4-path1", "32S16-2,16,16-g7-path2", "64S51-4,32,32-g23-path2" ];
