...
s`SolvableDBName := "64S23-4,4,4-g9-path50";
s`SolvableDBFilename := "64S23-4,4,4-g9-path50.m";
...
\[ 12, 38, 43, 7, 2, 5, 37, 41, 22, 33, 13, 9, 28, 19, 14, 58, 61, 10, 29, 60, 30, 1, 31, 11, 32, 16, 18, 24, 15, 25, 64, 21, 27, 57, 63, 53, 39, 6, 4, 44, 40, 56, 36, 8, 26, 50, 51, 52, 20, 48, 34, 46, 3, 59, 23, 54, 47, 45, 42, 62, 35, 49, 17, 55 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T8-4,4,4-g3-path5", "32S2-4,4,4-g5-path62", "64S23-4,4,4-g9-path50" ];
s`SolvableDBParents := [ Strings() | "128S123-8,4,4-g25-path61", "128S122-4,8,4-g25-path141", "128S14-8,8,4-g33-path519", "128S122-4,4,8-g25-path129", "128S14-8,4,8-g33-path525", "128S12-4,8,8-g33-path258", "128S124-8,8,8-g41-path209", "128S21-8,4,4-g25-path295", "128S16-4,8,4-g25-path439", "128S127-8,8,4-g33-path129", "128S16-4,4,8-g25-path433", "128S127-8,4,8-g33-path141", "128S126-4,8,8-g33-path61", "128S25-8,8,8-g41-path657", "128S29-8,4,4-g25-path237", "128S26-4,8,4-g25-path643", "128S127-8,8,4-g33-path130", "128S26-4,4,8-g25-path637", "128S127-8,4,8-g33-path142", "128S126-4,8,8-g33-path62", "128S30-8,8,8-g41-path723", "128S123-8,4,4-g25-path62", "128S122-4,8,4-g25-path142", "128S37-8,8,4-g33-path65", "128S122-4,4,8-g25-path130", "128S37-8,4,8-g33-path71", "128S38-4,8,8-g33-path31", "128S124-8,8,8-g41-path210", "128S125-4,4,4-g17-path209", "128S125-4,4,4-g17-path210", "128S36-4,4,4-g17-path105" ];
