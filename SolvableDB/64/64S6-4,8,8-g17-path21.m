...
s`SolvableDBName := "64S6-4,8,8-g17-path21";
s`SolvableDBFilename := "64S6-4,8,8-g17-path21.m";
...
\[ 6, 1, 26, 27, 23, 9, 4, 28, 2, 3, 5, 7, 8, 42, 43, 57, 13, 14, 31, 52, 58, 29, 36, 21, 59, 33, 12, 17, 19, 20, 22, 18, 10, 37, 54, 11, 15, 16, 24, 25, 30, 32, 34, 35, 64, 56, 61, 46, 48, 40, 45, 41, 44, 53, 60, 49, 63, 39, 50, 47, 55, 51, 38, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path9", "32S11-4,8,4-g7-path6", "64S6-4,8,8-g17-path21" ];
s`SolvableDBParents := [ Strings() | "128S67-8,16,8-g45-path7", "128S67-8,16,8-g45-path8", "128S68-8,16,8-g45-path7", "128S68-8,16,8-g45-path8", "128S63-4,8,16-g37-path44", "128S61-8,16,16-g49-path269", "128S64-4,8,16-g37-path135", "128S61-8,16,16-g49-path270", "128S65-4,8,16-g37-path38", "128S62-8,16,16-g49-path205", "128S66-4,8,16-g37-path123", "128S62-8,16,16-g49-path206", "128S11-4,8,8-g33-path1139", "128S2-4,8,8-g33-path134", "128S3-4,8,8-g33-path605" ];
