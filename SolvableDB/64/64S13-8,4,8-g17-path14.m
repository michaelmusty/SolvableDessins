...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 23, 37, 58, 13, 14, 61, 35, 39, 31, 57, 9, 21, 42, 34, 44, 11, 50, 19, 20, 22, 41, 53, 52, 36, 10, 12, 15, 16, 17, 18, 25, 26, 32, 33, 56, 64, 45, 48, 49, 60, 62, 59, 43, 51, 38, 47, 54, 55, 46, 40, 63 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T14-4,4,8-g4-path3", "32S10-4,4,8-g7-path31", "64S13-8,4,8-g17-path14" ];
s`SolvableDBParents := [ Strings() | "128S96-16,4,8-g37-path7", "128S95-16,4,8-g37-path13", "128S97-16,4,8-g37-path7", "128S95-16,4,8-g37-path14", "128S3-8,4,8-g33-path153", "128S28-8,4,8-g33-path56", "128S3-8,4,8-g33-path154" ];
