...
s`SolvableDBName := "64S13-8,4,8-g17-path14";
s`SolvableDBFilename := "64S13-8,4,8-g17-path14.m";
...
s`SolvableDBParents := [ Strings() | "128S96-16,4,8-g37-path3", "128S95-16,4,8-g37-path5", "128S97-16,4,8-g37-path3", "128S95-16,4,8-g37-path6", "128S3-8,4,8-g33-path23", "128S28-8,4,8-g33-path9", "128S3-8,4,8-g33-path24" ];
