...
s`SolvableDBName := "64S4-2,8,8-g9-path31";
s`SolvableDBFilename := "64S4-2,8,8-g9-path31.m";
...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 26, 27, 28, 29, 21, 22, 19, 23, 17, 30, 15, 16, 18, 31, 32, 11, 12, 13, 14, 20, 24, 25, 54, 42, 37, 55, 35, 46, 53, 51, 43, 34, 41, 48, 49, 38, 50, 44, 45, 47, 40, 56, 39, 33, 36, 52, 64, 59, 58, 61, 60, 63, 62, 57 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path4", "32S6-2,4,4-g1-path4", "64S4-2,8,8-g9-path31" ];
s`SolvableDBParents := [ Strings() | "128S4-4,8,8-g33-path194", "128S49-4,8,8-g33-path82", "128S51-4,8,8-g33-path82", "128S12-4,8,8-g33-path471", "128S46-2,16,16-g25-path100", "128S47-4,16,16-g41-path84", "128S53-2,16,16-g25-path38", "128S52-4,16,16-g41-path38", "128S52-2,16,16-g25-path38", "128S53-4,16,16-g41-path38", "128S47-2,16,16-g25-path84", "128S46-4,16,16-g41-path100", "128S50-2,8,8-g17-path60", "128S48-2,8,8-g17-path60", "128S2-2,8,8-g17-path116" ];
