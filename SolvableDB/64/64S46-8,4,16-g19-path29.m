...
s`SolvableDBName := "64S46-8,4,16-g19-path29";
s`SolvableDBFilename := "64S46-8,4,16-g19-path29.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T8-4,4,4-g3-path11", "32S13-4,4,8-g7-path7", "64S46-8,4,16-g19-path29" ];
