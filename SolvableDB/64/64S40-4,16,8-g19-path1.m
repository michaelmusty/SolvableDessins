...
s`SolvableDBName := "64S40-4,16,8-g19-path1";
s`SolvableDBFilename := "64S40-4,16,8-g19-path1.m";
...
\[ 2, 5, 9, 10, 6, 1, 4, 11, 15, 19, 12, 22, 29, 30, 21, 31, 25, 32, 7, 23, 3, 8, 17, 18, 20, 16, 33, 24, 37, 27, 34, 28, 14, 26, 47, 45, 42, 48, 44, 43, 49, 13, 39, 40, 41, 50, 53, 46, 36, 38, 54, 63, 59, 62, 61, 60, 64, 51, 35, 55, 56, 58, 57, 52 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path5", "32S9-2,8,4-g3-path2", "64S40-4,16,8-g19-path1" ];
s`SolvableDBParents := [ Strings() | "128S82-4,16,8-g37-path24", "128S92-4,16,8-g37-path52", "128S64-4,16,8-g37-path70", "128S63-4,16,8-g37-path30", "128S95-4,16,8-g37-path114", "128S81-4,16,8-g37-path7", "128S114-4,16,8-g37-path207" ];
