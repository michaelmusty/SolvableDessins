...
\[ 6, 1, 24, 25, 19, 26, 21, 3, 2, 4, 5, 7, 8, 16, 36, 17, 13, 38, 9, 34, 22, 27, 20, 30, 12, 11, 10, 44, 28, 14, 15, 18, 23, 29, 31, 32, 52, 40, 37, 35, 57, 41, 53, 46, 54, 33, 43, 45, 47, 49, 39, 42, 48, 50, 51, 64, 55, 63, 56, 58, 59, 61, 62, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T4-4,4,4-g3-path8", "32S3-4,8,8-g9-path12", "64S3-8,8,8-g21-path7" ];
s`SolvableDBParents := [ Strings() | "128S45-16,8,16-g49-path211", "128S45-16,8,16-g49-path212", "128S44-8,16,16-g49-path191", "128S44-8,16,16-g49-path192", "128S45-16,16,8-g49-path213", "128S45-16,16,8-g49-path214", "128S5-8,8,8-g41-path775" ];
