...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 43, 45, 17, 49, 14, 21, 18, 22, 48, 32, 47, 44, 50, 19, 20, 23, 10, 42, 31, 9, 11, 12, 13, 27, 28, 29, 30, 56, 46, 59, 62, 63, 57, 64, 41, 60, 53, 38, 36, 33, 34, 35, 37, 39, 40, 51, 52, 54, 55, 61, 58 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,1-g0-path1", "16T5-8,8,2-g3-path1", "32S3-8,8,4-g9-path4", "64S3-8,8,8-g21-path7" ];
s`SolvableDBParents := [ Strings() | "128S45-8,16,16-g49-path9", "128S45-8,16,16-g49-path10", "128S44-16,16,8-g49-path11", "128S45-16,8,16-g49-path9", "128S44-16,16,8-g49-path12", "128S45-16,8,16-g49-path10", "128S5-8,8,8-g41-path22" ];
