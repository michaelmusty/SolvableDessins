...
s`SolvableDBName := "64S15-8,8,8-g21-path40";
s`SolvableDBFilename := "64S15-8,8,8-g21-path40.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T8-4,4,4-g3-path5", "32S12-4,8,8-g9-path45", "64S15-8,8,8-g21-path40" ];
