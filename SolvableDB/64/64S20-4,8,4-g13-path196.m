...
s`SolvableDBName := "64S20-4,8,4-g13-path196";
s`SolvableDBFilename := "64S20-4,8,4-g13-path196.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path6", "32S2-4,4,4-g5-path78", "64S20-4,8,4-g13-path196" ];
s`SolvableDBChildren := [ Strings() | "32S2-4,4,4-g5-path78" ];
