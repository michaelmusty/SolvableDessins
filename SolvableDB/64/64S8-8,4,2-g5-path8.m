...
s`SolvableDBName := "64S8-8,4,2-g5-path8";
s`SolvableDBFilename := "64S8-8,4,2-g5-path8.m";
...
\[ 42, 47, 59, 64, 52, 63, 17, 19, 43, 40, 23, 22, 49, 37, 39, 41, 28, 45, 55, 48, 34, 56, 54, 3, 5, 46, 6, 4, 50, 38, 51, 16, 15, 9, 21, 60, 44, 14, 36, 53, 35, 8, 32, 20, 57, 62, 25, 58, 12, 61, 24, 27, 13, 1, 11, 10, 31, 30, 18, 29, 33, 7, 2, 26 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path7", "32S11-8,4,2-g3-path6", "64S8-8,4,2-g5-path8" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,2-g17-path287", "128S76-8,4,4-g25-path150", "128S78-8,8,4-g33-path189", "128S77-8,8,2-g17-path106", "128S26-8,4,4-g25-path840", "128S3-8,8,4-g33-path1001", "128S79-16,4,2-g13-path63", "128S81-16,8,2-g21-path57", "128S72-16,4,4-g29-path62", "128S74-16,8,4-g37-path23", "128S71-16,4,2-g13-path23", "128S73-16,8,2-g21-path23", "128S80-16,4,4-g29-path222", "128S82-16,8,4-g37-path91", "128S75-8,4,2-g9-path45" ];
