...
s`SolvableDBName := "64S7-4,8,8-g17-path197";
s`SolvableDBFilename := "64S7-4,8,8-g17-path197.m";
...
\[ 2, 9, 10, 7, 11, 1, 12, 13, 6, 34, 38, 28, 17, 18, 39, 40, 29, 41, 30, 31, 25, 32, 33, 5, 42, 43, 3, 4, 8, 22, 37, 19, 44, 27, 45, 46, 47, 24, 36, 64, 50, 48, 56, 49, 57, 15, 20, 21, 23, 14, 58, 59, 51, 52, 54, 61, 60, 63, 55, 35, 26, 16, 53, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-4,8,8-g5-path4", "32S5-4,8,8-g9-path16", "64S7-4,8,8-g17-path197" ];
s`SolvableDBParents := [ Strings() | "128S69-8,16,16-g49-path277", "128S70-8,16,16-g49-path213", "128S69-8,16,16-g49-path278", "128S70-8,16,16-g49-path214", "128S3-4,8,8-g33-path717", "128S11-4,8,8-g33-path1251", "128S4-4,8,8-g33-path267" ];
