...
s`SolvableDBName := "64S14-8,4,8-g17-path36";
s`SolvableDBFilename := "64S14-8,4,8-g17-path36.m";
...
\[ 59, 63, 56, 34, 31, 33, 58, 36, 62, 61, 57, 64, 48, 38, 30, 55, 26, 9, 49, 32, 60, 12, 11, 16, 41, 43, 10, 35, 37, 29, 47, 54, 52, 45, 40, 53, 50, 51, 46, 19, 28, 15, 8, 25, 7, 42, 2, 24, 44, 39, 13, 5, 21, 3, 14, 22, 18, 27, 23, 17, 4, 1, 6, 20 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path7", "32S7-8,2,8-g5-path9", "64S14-8,4,8-g17-path36" ];
s`SolvableDBParents := [ Strings() | "128S98-16,4,16-g41-path169", "128S98-16,4,16-g41-path170", "128S98-16,4,16-g41-path171", "128S98-16,4,16-g41-path172", "128S4-8,4,8-g33-path151", "128S28-8,4,8-g33-path178", "128S4-8,4,8-g33-path152" ];
s`SolvableDBChild := "32S7-8,2,8-g5-path9";
