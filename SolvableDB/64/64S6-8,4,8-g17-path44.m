...
s`SolvableDBName := "64S6-8,4,8-g17-path44";
s`SolvableDBFilename := "64S6-8,4,8-g17-path44.m";
...
\[ 20, 47, 38, 3, 43, 50, 45, 51, 22, 64, 10, 28, 27, 19, 63, 12, 62, 13, 21, 9, 15, 16, 17, 18, 1, 11, 26, 25, 30, 14, 59, 29, 23, 57, 49, 5, 58, 37, 6, 4, 46, 60, 39, 55, 40, 48, 36, 42, 44, 2, 41, 56, 8, 61, 54, 35, 31, 7, 33, 53, 52, 34, 32, 24 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S5-8,4,8-g9-path6", "64S6-8,4,8-g17-path44" ];
s`SolvableDBParents := [ Strings() | "128S67-16,8,8-g45-path23", "128S68-16,8,8-g45-path23", "128S68-16,8,8-g45-path24", "128S67-16,8,8-g45-path24", "128S63-8,4,16-g37-path52", "128S61-16,8,16-g49-path295", "128S66-8,4,16-g37-path131", "128S62-16,8,16-g49-path231", "128S65-8,4,16-g37-path46", "128S62-16,8,16-g49-path232", "128S64-8,4,16-g37-path143", "128S61-16,8,16-g49-path296", "128S3-8,4,8-g33-path618", "128S2-8,4,8-g33-path147", "128S11-8,4,8-g33-path1152" ];
