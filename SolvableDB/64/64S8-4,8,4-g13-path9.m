...
s`SolvableDBName := "64S8-4,8,4-g13-path9";
s`SolvableDBFilename := "64S8-4,8,4-g13-path9.m";
...
\[ 21, 5, 44, 38, 6, 37, 4, 62, 12, 18, 23, 1, 11, 15, 28, 54, 31, 26, 56, 10, 9, 33, 27, 57, 58, 20, 13, 63, 22, 24, 25, 30, 64, 60, 42, 7, 2, 36, 40, 8, 50, 3, 55, 35, 52, 59, 61, 45, 46, 47, 49, 53, 48, 43, 16, 34, 32, 17, 51, 19, 41, 39, 14, 29 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path7", "32S11-4,8,4-g7-path17", "64S8-4,8,4-g13-path9" ];
s`SolvableDBParents := [ Strings() | "128S81-8,16,4-g37-path73", "128S82-8,16,4-g37-path146", "128S73-8,16,4-g37-path39", "128S74-8,16,4-g37-path78", "128S79-4,16,4-g29-path158", "128S2-8,8,4-g33-path264", "128S80-4,16,4-g29-path316", "128S3-8,8,4-g33-path978", "128S71-4,16,4-g29-path78", "128S77-8,8,4-g33-path83", "128S72-4,16,4-g29-path156", "128S78-8,8,4-g33-path166", "128S26-4,8,4-g25-path934", "128S75-4,8,4-g25-path122", "128S76-4,8,4-g25-path244" ];
