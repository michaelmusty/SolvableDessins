...
phi := KX!((x[4]^16 + 32*x[4]^8 + 256)/(64*x[4]^8));
/* assign to object */
...
s`SolvableDBName := "64S6-4,8,8-g17-path2";
s`SolvableDBFilename := "64S6-4,8,8-g17-path2.m";
...
s`SolvableDBParents := [ Strings() | "128S67-8,16,8-g45-path3", "128S67-8,16,8-g45-path4", "128S68-8,16,8-g45-path3", "128S68-8,16,8-g45-path4", "128S63-4,8,16-g37-path6", "128S61-8,16,16-g49-path21", "128S64-4,8,16-g37-path13", "128S61-8,16,16-g49-path22", "128S65-4,8,16-g37-path4", "128S62-8,16,16-g49-path13", "128S66-4,8,16-g37-path9", "128S62-8,16,16-g49-path14", "128S11-4,8,8-g33-path39", "128S2-4,8,8-g33-path12", "128S3-4,8,8-g33-path45" ];
