...
x[1]^2*x[4]^2 - x[1]^2*x[3] - 2*x[1]*x[4]^2 - 2*x[1]*x[3] - x[4]^2 + x[3],
x[2]^2*x[4]^2 - 4*x[1]^2*x[3] - x[2]^2*x[3] - 4*x[1]*x[4]^2 - 4*x[1]*x[3] - 2*x[4]^2 + 2*x[3],
x[1]^3 - x[2]^2 - x[1],
x[3]*x[4]^2 - 1
] >;
...
s`SolvableDBLocalSanityCheckTiming := 1.620p15;
