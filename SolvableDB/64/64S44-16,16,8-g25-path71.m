...
s`SolvableDBName := "64S44-16,16,8-g25-path71";
s`SolvableDBFilename := "64S44-16,16,8-g25-path71.m";
...
\[ 54, 55, 15, 21, 37, 64, 31, 35, 20, 42, 27, 16, 18, 51, 39, 53, 5, 8, 3, 52, 19, 44, 61, 50, 4, 29, 46, 48, 58, 45, 30, 49, 7, 22, 41, 23, 40, 32, 60, 43, 28, 56, 38, 12, 14, 10, 34, 11, 6, 13, 25, 47, 63, 9, 36, 57, 24, 1, 17, 62, 59, 33, 26, 2 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path3", "32S17-16,16,8-g13-path8", "64S44-16,16,8-g25-path71" ];
s`SolvableDBParents := [ Strings() | "128S153-32,32,16-g57-path37", "128S154-32,32,16-g57-path37", "128S153-32,32,16-g57-path38", "128S154-32,32,16-g57-path38", "128S102-16,16,8-g49-path301", "128S106-16,16,8-g49-path414", "128S99-16,16,8-g49-path301" ];
