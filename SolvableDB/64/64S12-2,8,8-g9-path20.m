...
\[ 2, 1, 8, 6, 9, 4, 10, 3, 5, 7, 24, 25, 26, 22, 20, 21, 18, 17, 27, 15, 16, 14, 28, 11, 12, 13, 19, 23, 34, 43, 44, 33, 32, 29, 40, 41, 38, 37, 45, 35, 36, 46, 30, 31, 39, 42, 54, 58, 59, 51, 50, 56, 57, 47, 60, 52, 53, 48, 49, 55, 64, 63, 62, 61 ]:
 Order := 2 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T13-2,2,8-g0-path1", "32S9-2,4,8-g3-path16", "64S12-2,8,8-g9-path20" ];
s`SolvableDBParents := [ Strings() | "128S2-4,8,8-g33-path64", "128S28-4,8,8-g33-path31", "128S93-2,16,8-g21-path31", "128S92-4,16,8-g37-path31", "128S92-2,16,8-g21-path31", "128S94-4,16,8-g37-path31", "128S93-2,8,16-g21-path31", "128S92-4,8,16-g37-path31", "128S92-2,8,16-g21-path31", "128S94-4,8,16-g37-path31", "128S89-2,16,16-g25-path31", "128S91-4,16,16-g41-path31", "128S91-2,16,16-g25-path31", "128S90-4,16,16-g41-path31", "128S2-2,8,8-g17-path64" ];
