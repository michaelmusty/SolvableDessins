...
s`SolvableDBName := "64S13-8,4,8-g17-path83";
s`SolvableDBFilename := "64S13-8,4,8-g17-path83.m";
...
\[ 49, 62, 50, 34, 31, 33, 48, 36, 56, 61, 47, 59, 52, 38, 64, 60, 26, 9, 53, 32, 54, 12, 11, 16, 63, 55, 10, 35, 37, 51, 42, 46, 44, 39, 57, 45, 58, 43, 7, 25, 15, 2, 13, 5, 21, 3, 18, 27, 23, 22, 41, 24, 40, 17, 8, 1, 19, 30, 20, 14, 4, 6, 28, 29 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T12-8,2,4-g2-path2", "32S9-8,2,4-g3-path14", "64S13-8,4,8-g17-path83" ];
s`SolvableDBParents := [ Strings() | "128S96-16,4,8-g37-path40", "128S95-16,4,8-g37-path79", "128S97-16,4,8-g37-path40", "128S95-16,4,8-g37-path80", "128S3-8,4,8-g33-path291", "128S28-8,4,8-g33-path125", "128S3-8,4,8-g33-path292" ];
