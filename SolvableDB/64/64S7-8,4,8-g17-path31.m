...
s`SolvableDBName := "64S7-8,4,8-g17-path31";
s`SolvableDBFilename := "64S7-8,4,8-g17-path31.m";
...
[ 17, 30, 23, 29, 39, 44, 6, 40, 8, 14, 59, 1, 36, 33, 52, 56, 57, 19, 32, 43, 9, 62, 22, 13, 24, 63, 58, 11, 26, 15, 46, 28, 20, 18, 7, 3, 10, 2, 37, 27, 50, 31, 5, 55, 35, 4, 42, 12, 34, 61, 53, 51, 60, 64, 16, 45, 41, 54, 49, 38, 48, 25, 47, 21 ]
]
];
...
\[ 6, 1, 27, 28, 24, 29, 4, 30, 2, 3, 5, 7, 8, 23, 57, 47, 44, 14, 33, 62, 38, 54, 58, 9, 21, 59, 52, 43, 11, 17, 19, 20, 22, 10, 46, 40, 36, 12, 13, 15, 16, 18, 25, 26, 31, 32, 34, 35, 37, 56, 50, 41, 61, 53, 63, 42, 55, 51, 39, 48, 45, 64, 49, 60 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path2", "32S10-4,4,8-g7-path22", "64S7-8,4,8-g17-path31" ];
s`SolvableDBParents := [ Strings() | "128S69-16,4,16-g41-path407", "128S70-16,4,16-g41-path343", "128S69-16,4,16-g41-path408", "128S70-16,4,16-g41-path344", "128S3-8,4,8-g33-path819", "128S11-8,4,8-g33-path1353", "128S4-8,4,8-g33-path369" ];
