...
I<[x]> := ideal< P | [
x[1]^8 - 24*x[1]^4 + x[2]^2 + 16,
x[1]^4*x[3]^2 + 4*x[3]^2 - x[2],
x[2]^2*x[3]^4 + 128*x[3]^4 - 32*x[2]*x[3]^2 + x[2]^2,
x[1]^4*x[2] + x[2]^2*x[3]^2 + 128*x[3]^2 - 28*x[2]
] >;
...
phi := KX!(-256/x[2]^2*x[3]^2 + 2048/x[2]^3*x[3] + (x[2]^4 - 4096)/x[2]^4);
/* assign to object */
...
s`SolvableDBLocalSanityCheckTiming := 37.510p15;
...
s`SolvableDBParents := [ Strings() | "128S3-8,8,4-g33-path78", "128S86-8,8,4-g33-path14", "128S4-8,8,4-g33-path36", "128S85-8,8,4-g33-path14", "128S84-4,8,4-g25-path20", "128S26-4,8,4-g25-path48", "128S83-4,8,4-g25-path20" ];
