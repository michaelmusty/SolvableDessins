...
s`SolvableDBName := "64S8-4,8,4-g13-path76";
s`SolvableDBFilename := "64S8-4,8,4-g13-path76.m";
...
\[ 19, 5, 33, 23, 6, 29, 4, 22, 12, 16, 8, 1, 11, 45, 25, 21, 34, 10, 9, 32, 18, 13, 28, 3, 20, 24, 31, 7, 2, 37, 17, 15, 26, 27, 61, 49, 43, 50, 44, 46, 30, 48, 41, 14, 39, 38, 53, 36, 42, 40, 58, 64, 59, 51, 47, 63, 60, 62, 55, 35, 57, 54, 52, 56 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T13-2,8,2-g0-path1", "32S9-4,8,2-g3-path16", "64S8-4,8,4-g13-path76" ];
s`SolvableDBParents := [ Strings() | "128S81-8,16,4-g37-path65", "128S82-8,16,4-g37-path138", "128S73-8,16,4-g37-path31", "128S74-8,16,4-g37-path70", "128S79-4,16,4-g29-path146", "128S2-8,8,4-g33-path256", "128S80-4,16,4-g29-path304", "128S3-8,8,4-g33-path970", "128S71-4,16,4-g29-path66", "128S77-8,8,4-g33-path75", "128S72-4,16,4-g29-path144", "128S78-8,8,4-g33-path158", "128S26-4,8,4-g25-path922", "128S75-4,8,4-g25-path110", "128S76-4,8,4-g25-path232" ];
