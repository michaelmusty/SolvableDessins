...
\[ 6, 1, 24, 16, 18, 25, 4, 26, 2, 3, 5, 7, 8, 42, 44, 48, 49, 14, 23, 30, 43, 10, 21, 46, 50, 17, 19, 20, 11, 47, 35, 9, 12, 13, 15, 22, 27, 28, 29, 31, 61, 62, 63, 64, 53, 56, 45, 41, 54, 59, 38, 36, 32, 33, 34, 37, 39, 40, 51, 52, 55, 58, 60, 57 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed", "8T2-4,4,2-g1-path4-notcomputed", "16T5-8,8,2-g3-path3-notcomputed", "32S17-16,16,4-g11-path3-notcomputed", "64S29-16,16,4-g21-path3-notcomputed" ];
