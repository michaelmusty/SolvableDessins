...
s`SolvableDBName := "64S44-16,16,8-g25-path41";
s`SolvableDBFilename := "64S44-16,16,8-g25-path41.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path31", "32S12-8,8,4-g9-path46", "64S44-16,16,8-g25-path41" ];
