...
s`SolvableDBName := "64S36-8,8,2-g9-path7";
s`SolvableDBFilename := "64S36-8,8,2-g9-path7.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path3", "32S6-4,4,2-g1-path5", "64S36-8,8,2-g9-path7" ];
