...
\[ 6, 1, 21, 22, 19, 23, 13, 2, 3, 4, 5, 7, 47, 20, 49, 46, 50, 51, 8, 52, 53, 12, 11, 35, 36, 9, 10, 14, 15, 16, 17, 18, 24, 25, 41, 39, 48, 44, 28, 63, 58, 64, 42, 37, 62, 26, 27, 55, 38, 60, 33, 34, 30, 40, 29, 43, 31, 32, 45, 54, 56, 61, 57, 59 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path1", "32S6-4,4,2-g1-path1", "64S36-8,8,2-g9-path7" ];
s`SolvableDBParents := [ Strings() | "128S85-8,8,4-g33-path51", "128S56-8,8,4-g33-path26", "128S85-8,8,4-g33-path52", "128S126-8,8,4-g33-path210", "128S77-8,8,2-g17-path29", "128S50-8,8,2-g17-path15", "128S77-8,8,2-g17-path30" ];
