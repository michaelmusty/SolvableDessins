...
s`SolvableDBName := "64S8-8,4,2-g5-path32";
s`SolvableDBFilename := "64S8-8,4,2-g5-path32.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 18, 33, 24, 20, 42, 41, 43, 40, 17, 39, 44, 45, 16, 8, 9, 10, 11, 12, 13, 14, 15, 34, 38, 29, 31, 59, 56, 57, 55, 37, 60, 58, 61, 46, 25, 26, 27, 28, 30, 32, 35, 36, 47, 62, 63, 54, 64, 51, 53, 49, 48, 50, 52 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path2", "32S9-8,4,2-g3-path8", "64S8-8,4,2-g5-path32" ];
s`SolvableDBParents := [ Strings() | "128S2-8,8,2-g17-path288", "128S76-8,4,4-g25-path151", "128S78-8,8,4-g33-path190", "128S77-8,8,2-g17-path107", "128S26-8,4,4-g25-path841", "128S3-8,8,4-g33-path1002", "128S79-16,4,2-g13-path64", "128S81-16,8,2-g21-path58", "128S72-16,4,4-g29-path63", "128S74-16,8,4-g37-path24", "128S71-16,4,2-g13-path24", "128S73-16,8,2-g21-path24", "128S80-16,4,4-g29-path223", "128S82-16,8,4-g37-path92", "128S75-8,4,2-g9-path46" ];
