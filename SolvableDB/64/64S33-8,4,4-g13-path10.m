...
s`SolvableDBName := "64S33-8,4,4-g13-path10";
s`SolvableDBFilename := "64S33-8,4,4-g13-path10.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S6-4,2,4-g1-path8", "64S33-8,4,4-g13-path10" ];
