...
s`SolvableDBName := "64S16-8,8,8-g21-path278";
s`SolvableDBFilename := "64S16-8,8,8-g21-path278.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path29", "32S15-8,8,8-g11-path43", "64S16-8,8,8-g21-path278" ];
