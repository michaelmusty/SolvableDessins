...
s`SolvableDBName := "64S48-16,4,4-g15-path18";
s`SolvableDBFilename := "64S48-16,4,4-g15-path18.m";
...
\[ 51, 64, 54, 37, 53, 34, 52, 31, 56, 62, 60, 59, 48, 33, 47, 61, 12, 36, 30, 35, 50, 26, 15, 10, 63, 55, 16, 32, 9, 42, 46, 44, 39, 58, 45, 57, 43, 49, 13, 2, 11, 25, 7, 19, 3, 21, 18, 27, 23, 22, 41, 24, 40, 17, 20, 38, 1, 5, 8, 29, 4, 14, 6, 28 ]:
 Order := 16 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T13-8,2,2-g0-path2", "32S19-16,2,4-g4-path1", "64S48-16,4,4-g15-path18" ];
s`SolvableDBParents := [ Strings() | "128S158-32,8,4-g39-path43", "128S158-32,4,8-g39-path43", "128S104-16,8,8-g45-path145", "128S158-32,8,4-g39-path44", "128S158-32,4,8-g39-path44", "128S104-16,8,8-g45-path146", "128S112-16,4,4-g29-path320" ];
