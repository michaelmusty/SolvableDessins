...
s`SolvableDBName := "64S6-4,8,8-g17-path84";
s`SolvableDBFilename := "64S6-4,8,8-g17-path84.m";
...
\[ 6, 1, 21, 7, 2, 5, 19, 22, 3, 4, 8, 11, 16, 32, 9, 26, 23, 24, 10, 25, 15, 12, 20, 41, 17, 29, 30, 39, 13, 14, 18, 27, 28, 33, 38, 48, 42, 37, 34, 43, 31, 35, 49, 47, 40, 56, 36, 44, 45, 46, 50, 55, 63, 57, 54, 51, 52, 59, 64, 62, 58, 53, 60, 61 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S9-2,4,8-g3-path1", "64S6-4,8,8-g17-path84" ];
s`SolvableDBParents := [ Strings() | "128S67-8,16,8-g45-path47", "128S67-8,16,8-g45-path48", "128S68-8,16,8-g45-path47", "128S68-8,16,8-g45-path48", "128S63-4,8,16-g37-path64", "128S61-8,16,16-g49-path331", "128S64-4,8,16-g37-path155", "128S61-8,16,16-g49-path332", "128S65-4,8,16-g37-path58", "128S62-8,16,16-g49-path267", "128S66-4,8,16-g37-path143", "128S62-8,16,16-g49-path268", "128S11-4,8,8-g33-path1170", "128S2-4,8,8-g33-path165", "128S3-4,8,8-g33-path636" ];
