...
\[ 38, 50, 21, 41, 23, 9, 58, 44, 53, 25, 14, 16, 59, 24, 56, 4, 57, 5, 33, 63, 34, 26, 45, 40, 27, 19, 39, 12, 2, 17, 49, 64, 47, 10, 48, 42, 62, 29, 46, 18, 43, 60, 7, 61, 11, 3, 31, 51, 52, 6, 20, 22, 1, 15, 32, 36, 8, 28, 30, 37, 13, 54, 55, 35 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1-computed", "4T2-2,2,2-g0-path1-notcomputed", "8T4-4,2,2-g0-path1-notcomputed", "16T10-4,2,4-g1-path5-notcomputed", "32S8-8,4,8-g9-path2-notcomputed", "64S13-8,4,8-g17-path5-notcomputed" ];
s`SolvableDBChild := "32S8-8,4,8-g9-path2-notcomputed";
