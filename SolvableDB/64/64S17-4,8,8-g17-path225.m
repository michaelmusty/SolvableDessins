...
s`SolvableDBName := "64S17-4,8,8-g17-path225";
s`SolvableDBFilename := "64S17-4,8,8-g17-path225.m";
...
\[ 22, 5, 53, 41, 6, 40, 4, 46, 12, 18, 24, 1, 11, 15, 29, 52, 63, 27, 14, 16, 32, 9, 56, 28, 30, 58, 34, 13, 19, 21, 23, 25, 26, 10, 61, 64, 35, 45, 7, 2, 39, 43, 8, 60, 3, 42, 51, 50, 20, 47, 48, 49, 38, 31, 57, 54, 44, 59, 33, 55, 62, 37, 36, 17 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-4,8,8-g5-path3", "32S5-4,8,8-g9-path17", "64S17-4,8,8-g17-path225" ];
s`SolvableDBParents := [ Strings() | "128S106-8,16,16-g49-path97", "128S108-4,16,16-g41-path97", "128S9-8,8,8-g41-path709", "128S111-4,16,16-g41-path193", "128S10-8,8,8-g41-path193", "128S110-8,16,16-g49-path193", "128S111-4,16,16-g41-path194", "128S10-8,8,8-g41-path194", "128S110-8,16,16-g49-path194", "128S109-8,16,16-g49-path97", "128S107-4,16,16-g41-path97", "128S7-8,8,8-g41-path97", "128S106-4,16,16-g41-path97", "128S5-8,8,8-g41-path97", "128S108-8,16,16-g49-path97", "128S111-8,16,16-g49-path193", "128S110-4,16,16-g41-path193", "128S15-8,8,8-g41-path193", "128S111-8,16,16-g49-path194", "128S110-4,16,16-g41-path194", "128S15-8,8,8-g41-path194", "128S109-4,16,16-g41-path97", "128S13-8,8,8-g41-path97", "128S107-8,16,16-g49-path97", "128S14-4,8,8-g33-path193", "128S14-4,8,8-g33-path194", "128S12-4,8,8-g33-path97", "128S8-4,8,8-g33-path97", "128S11-4,8,8-g33-path193", "128S11-4,8,8-g33-path194", "128S6-4,8,8-g33-path97" ];
