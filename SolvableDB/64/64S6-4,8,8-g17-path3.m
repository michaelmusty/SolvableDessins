...
s`SolvableDBName := "64S6-4,8,8-g17-path3";
s`SolvableDBFilename := "64S6-4,8,8-g17-path3.m";
...
\[ 6, 1, 26, 27, 23, 9, 4, 28, 2, 3, 5, 7, 8, 50, 43, 52, 13, 63, 31, 44, 56, 29, 36, 21, 57, 33, 12, 17, 19, 20, 22, 18, 10, 38, 30, 11, 14, 15, 16, 24, 25, 32, 34, 35, 53, 61, 46, 47, 41, 51, 37, 60, 59, 64, 45, 40, 49, 54, 55, 39, 48, 58, 42, 62 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path9", "32S11-4,4,8-g7-path6", "64S6-4,8,8-g17-path3" ];
s`SolvableDBParents := [ Strings() | "128S67-8,8,16-g45-path57", "128S68-8,8,16-g45-path57", "128S68-8,8,16-g45-path58", "128S67-8,8,16-g45-path58", "128S63-4,16,8-g37-path69", "128S61-8,16,16-g49-path377", "128S66-4,16,8-g37-path148", "128S62-8,16,16-g49-path313", "128S65-4,16,8-g37-path63", "128S62-8,16,16-g49-path314", "128S64-4,16,8-g37-path160", "128S61-8,16,16-g49-path378", "128S3-4,8,8-g33-path659", "128S2-4,8,8-g33-path188", "128S11-4,8,8-g33-path1193" ];
