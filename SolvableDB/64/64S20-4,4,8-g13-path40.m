...
s`SolvableDBName := "64S20-4,4,8-g13-path40";
s`SolvableDBFilename := "64S20-4,4,8-g13-path40.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S11-4,4,8-g7-path5", "64S20-4,4,8-g13-path40" ];
