...
s`SolvableDBName := "64S6-8,8,2-g9-path87";
s`SolvableDBFilename := "64S6-8,8,2-g9-path87.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 34, 12, 24, 20, 41, 40, 37, 39, 17, 38, 42, 43, 16, 18, 8, 9, 10, 11, 13, 14, 15, 25, 52, 31, 59, 57, 58, 55, 36, 60, 61, 44, 26, 27, 28, 29, 30, 32, 33, 35, 56, 50, 45, 62, 63, 64, 54, 49, 51, 47, 46, 48, 53 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T13-8,2,2-g0-path1", "32S9-8,4,2-g3-path16", "64S6-8,8,2-g9-path87" ];
s`SolvableDBParents := [ Strings() | "128S67-8,16,4-g37-path49", "128S68-8,16,4-g37-path49", "128S63-16,8,2-g21-path89", "128S61-16,16,4-g41-path221", "128S65-16,8,2-g21-path83", "128S62-16,16,4-g41-path189", "128S67-8,16,2-g21-path49", "128S11-8,8,4-g33-path1123", "128S68-8,16,2-g21-path49", "128S3-8,8,4-g33-path589", "128S61-16,16,2-g25-path221", "128S64-16,8,4-g37-path129", "128S62-16,16,2-g25-path189", "128S66-16,8,4-g37-path117", "128S2-8,8,2-g17-path220" ];
