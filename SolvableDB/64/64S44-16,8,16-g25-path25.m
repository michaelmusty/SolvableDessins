...
s`SolvableDBName := "64S44-16,8,16-g25-path25";
s`SolvableDBFilename := "64S44-16,8,16-g25-path25.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T8-4,4,4-g3-path20", "32S12-8,4,8-g9-path30", "64S44-16,8,16-g25-path25" ];
