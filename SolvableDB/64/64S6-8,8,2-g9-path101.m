...
s`SolvableDBName := "64S6-8,8,2-g9-path101";
s`SolvableDBFilename := "64S6-8,8,2-g9-path101.m";
...
\[ 6, 1, 21, 22, 19, 23, 4, 2, 3, 5, 7, 34, 12, 24, 20, 41, 40, 37, 39, 17, 38, 42, 43, 16, 18, 8, 9, 10, 11, 13, 14, 15, 25, 52, 31, 59, 57, 58, 55, 36, 60, 61, 44, 26, 27, 28, 29, 30, 32, 33, 35, 56, 50, 45, 62, 63, 64, 54, 49, 51, 47, 46, 48, 53 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path1", "32S9-8,4,2-g3-path1", "64S6-8,8,2-g9-path101" ];
s`SolvableDBParents := [ Strings() | "128S67-8,16,4-g37-path28", "128S68-8,16,4-g37-path28", "128S63-16,8,2-g21-path68", "128S61-16,16,4-g41-path185", "128S65-16,8,2-g21-path62", "128S62-16,16,4-g41-path153", "128S67-8,16,2-g21-path28", "128S11-8,8,4-g33-path1087", "128S68-8,16,2-g21-path28", "128S3-8,8,4-g33-path553", "128S61-16,16,2-g25-path185", "128S64-16,8,4-g37-path108", "128S62-16,16,2-g25-path153", "128S66-16,8,4-g37-path96", "128S2-8,8,2-g17-path184" ];
