...
s`SolvableDBName := "64S49-16,8,8-g23-path34";
s`SolvableDBFilename := "64S49-16,8,8-g23-path34.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T8-4,4,4-g3-path22", "32S14-8,4,4-g7-path9", "64S49-16,8,8-g23-path34" ];
