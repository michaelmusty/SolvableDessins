...
s`SolvableDBName := "64S29-8,16,16-g25-path18";
s`SolvableDBFilename := "64S29-8,16,16-g25-path18.m";
...
\[ 6, 1, 24, 25, 15, 26, 4, 16, 2, 3, 5, 7, 8, 40, 45, 17, 56, 14, 21, 42, 22, 57, 50, 47, 53, 58, 19, 20, 23, 10, 43, 31, 9, 11, 12, 13, 18, 27, 28, 29, 30, 32, 46, 38, 64, 39, 55, 35, 44, 52, 36, 37, 60, 41, 54, 59, 49, 61, 51, 48, 33, 34, 62, 63 ]:
 Order := 8 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T1-8,16,16-g7-path2", "32S16-8,16,16-g13-path1", "64S29-8,16,16-g25-path18" ];
s`SolvableDBParents := [ Strings() | "128S133-16,32,32-g57-path145", "128S133-16,32,32-g57-path146", "128S131-16,32,32-g57-path73", "128S132-16,32,32-g57-path73", "128S131-16,32,32-g57-path74", "128S132-16,32,32-g57-path74", "128S133-16,32,32-g57-path147", "128S133-16,32,32-g57-path148", "128S54-8,16,16-g49-path37", "128S61-8,16,16-g49-path73", "128S69-8,16,16-g49-path73", "128S69-8,16,16-g49-path74", "128S61-8,16,16-g49-path74", "128S106-8,16,16-g49-path354", "128S46-8,16,16-g49-path37" ];
