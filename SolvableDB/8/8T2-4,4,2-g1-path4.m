...
s`SolvableDBBelyiMap := KX!((x1^4 + 2*x1^2 + 1)/(x1^4 - 2*x1^2 + 1));
...
s`SolvableDBParents := [ Strings() | "16T4-4,4,4-g3-path14", "16T8-4,4,4-g3-path14", "16T5-8,8,2-g3-path6", "16T5-8,8,4-g5-path5", "16T6-8,8,2-g3-path4", "16T6-8,8,4-g5-path4", "16T10-4,4,2-g1-path4" ];
