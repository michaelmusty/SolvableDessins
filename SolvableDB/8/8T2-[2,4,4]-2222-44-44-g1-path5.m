...
x0*x1 - x0 - 1/2*x2*x3^2 + 1/2*F.1*x2 + 1/2*F.1*x3^2 + 1/2,
x0*x2 + x0*x3^2 + 1/2*x2*x3^4 - F.1*x2*x3^2 - 1/2*x2 - 1/2*F.1*x3^4 - x3^2 + 1/2*F.1,
x0*x3^4 + 1/4*x2*x3^6 - 1/4*F.1*x2*x3^4 + 1/4*x2*x3^2 - 1/4*F.1*x2 - 1/4*F.1*x3^6 - 3/4*x3^4 + 3/4*F.1*x3^2 + 1/4,
x1*x3^2 - F.1*x1 + x2 + F.1,
x2^2 - x2*x3^2 + F.1*x2 + F.1*x3^2
] >;
