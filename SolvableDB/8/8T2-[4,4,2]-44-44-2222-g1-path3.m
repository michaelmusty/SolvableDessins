...
s`SolvableDBName := "8T2-[4,4,2]-44-44-2222-g1-path3";
s`SolvableDBFilename := "8T2-[4,4,2]-44-44-2222-g1-path3.m";
...
x0 - x1^2 - 1,
x1*x2^2 - x1 + nu2*x2^2 + nu2,
x1^2*x3^2 + x1^2 - x1*x2 - nu2*x1*x3^2 - nu2*x2 + 1
] >;
Append(~s`SolvableDBCurveIdealList, I3);
X3<x0, x1, x2, x3> := Curve(AA3, ideal< PX3 | [
x0 - x1^2 - 1,
x1*x2^2 - x1 + nu2*x2^2 + nu2,
x1*x3^2 + x1 + x2*x3^2 - nu2*x3^2,
x2^2*x3^2 - nu2*x2*x3^2 - nu2*x2 + 1
] >);
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-[1,2,2]-11-2-2-g0-path1", "4T2-[2,2,2]-22-22-22-g0-path1", "8T2-[4,4,2]-44-44-2222-g1-path3" ];
s`SolvableDBParents := [ Strings() | "16T6-[8,8,2]-8,8-8,8-2,2,2,2,2,2,2,2-g3-path3", "16T5-[8,8,2]-8,8-8,8-2,2,2,2,2,2,2,2-g3-path5", "16T4-[4,4,4]-4,4,4,4-4,4,4,4-4,4,4,4-g3-path13", "16T8-[4,4,4]-4,4,4,4-4,4,4,4-4,4,4,4-g3-path13", "16T5-[8,8,4]-8,8-8,8-4,4,4,4-g5-path4", "16T6-[8,8,4]-8,8-8,8-4,4,4,4-g5-path3", "16T10-[4,4,2]-4,4,4,4-4,4,4,4-2,2,2,2,2,2,2,2-g1-path3" ];
