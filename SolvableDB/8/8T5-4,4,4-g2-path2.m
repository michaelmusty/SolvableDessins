...
s`SolvableDBName := "8T5-4,4,4-g2-path2";
s`SolvableDBFilename := "8T5-4,4,4-g2-path2.m";
...
\[ 2, 5, 4, 7, 6, 1, 8, 3 ]:
 Order := 4 >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2" ];
s`SolvableDBParents := [ Strings() | "16T8-4,4,4-g3-path28", "16T8-4,4,4-g3-path29", "16T8-4,4,4-g3-path30" ];
