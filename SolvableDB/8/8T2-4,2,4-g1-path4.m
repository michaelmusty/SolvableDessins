...
s`SolvableDBBelyiMap := KX!(1/x3^4);
...
s`SolvableDBParents := [ Strings() | "16T4-4,4,4-g3-path9", "16T8-4,4,4-g3-path9", "16T5-8,2,8-g3-path6", "16T5-8,4,8-g5-path6", "16T6-8,2,8-g3-path4", "16T6-8,4,8-g5-path4", "16T10-4,2,4-g1-path4" ];
