...
s`SolvableDBName := "8T4-[2,2,4]-2222-2222-44-g0-path3";
s`SolvableDBFilename := "8T4-[2,2,4]-2222-2222-44-g0-path3.m";
...
x0*x1 - x0 - 1/2*x3^4 + 1/2,
x0*x3^4 + 1/4*x3^8 - 1/2*x3^4 + 1/4,
x1*x3^4 - x1 + x3^4 + 1,
x2 - x3^2
] >;
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-[2,2,1]-2-2-11-g0-path1", "4T2-[2,2,2]-22-22-22-g0-path3", "8T4-[2,2,4]-2222-2222-44-g0-path3" ];
s`SolvableDBParents := [ Strings() | "16T13-[2,2,8]-2,2,2,2,2,2,2,2-2,2,2,2,2,2,2,2-8,8-g0-path3", "16T10-[4,2,4]-4,4,4,4-2,2,2,2,2,2,2,2-4,4,4,4-g1-path8", "16T12-[4,2,8]-4,4,4,4-2,2,2,2,2,2,2,2-8,8-g2-path3", "16T12-[2,4,8]-2,2,2,2,2,2,2,2-4,4,4,4-8,8-g2-path3", "16T10-[2,4,4]-2,2,2,2,2,2,2,2-4,4,4,4-4,4,4,4-g1-path8", "16T14-[4,4,8]-4,4,4,4-4,4,4,4-8,8-g4-path3", "16T8-[4,4,4]-4,4,4,4-4,4,4,4-4,4,4,4-g3-path18" ];
