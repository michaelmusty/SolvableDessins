...
s`SolvableDBName := "8T4-[4,2,2]-44-2222-2222-g0-path3";
s`SolvableDBFilename := "8T4-[4,2,2]-44-2222-2222-g0-path3.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-[2,2,1]-2-2-11-g0-path1", "4T2-[2,2,2]-22-22-22-g0-path3", "8T4-[4,2,2]-44-2222-2222-g0-path3" ];
s`SolvableDBParents := [ Strings() | "16T13-[8,2,2]-8,8-2,2,2,2,2,2,2,2-2,2,2,2,2,2,2,2-g0-path3", "16T12-[8,2,4]-8,8-2,2,2,2,2,2,2,2-4,4,4,4-g2-path3", "16T10-[4,2,4]-4,4,4,4-2,2,2,2,2,2,2,2-4,4,4,4-g1-path11", "16T10-[4,4,2]-4,4,4,4-4,4,4,4-2,2,2,2,2,2,2,2-g1-path11", "16T12-[8,4,2]-8,8-4,4,4,4-2,2,2,2,2,2,2,2-g2-path3", "16T8-[4,4,4]-4,4,4,4-4,4,4,4-4,4,4,4-g3-path24", "16T14-[8,4,4]-8,8-4,4,4,4-4,4,4,4-g4-path3" ];
