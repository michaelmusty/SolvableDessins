...
\[ 6, 7, 8, 2, 4, 3, 5, 1 ],
\[ 7, 8, 4, 3, 6, 5, 1, 2 ] >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1-computed", "4T1-4,4,2-g1-path1-notcomputed", "8T2-4,4,2-g1-path2-notcomputed" ];
...
s`SolvableDBChild := "4T1-4,4,2-g1-path1-notcomputed";
