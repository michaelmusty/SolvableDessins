...
s`SolvableDBName := "8T4-[4,2,2]-44-2222-2222-g0-path1";
s`SolvableDBFilename := "8T4-[4,2,2]-44-2222-2222-g0-path1.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-[1,2,2]-11-2-2-g0-path1", "4T2-[2,2,2]-22-22-22-g0-path1", "8T4-[4,2,2]-44-2222-2222-g0-path1" ];
s`SolvableDBParents := [ Strings() | "16T13-[8,2,2]-8,8-2,2,2,2,2,2,2,2-2,2,2,2,2,2,2,2-g0-path1", "16T10-[4,2,4]-4,4,4,4-2,2,2,2,2,2,2,2-4,4,4,4-g1-path9", "16T12-[8,2,4]-8,8-2,2,2,2,2,2,2,2-4,4,4,4-g2-path1", "16T12-[8,4,2]-8,8-4,4,4,4-2,2,2,2,2,2,2,2-g2-path1", "16T10-[4,4,2]-4,4,4,4-4,4,4,4-2,2,2,2,2,2,2,2-g1-path9", "16T14-[8,4,4]-8,8-4,4,4,4-4,4,4,4-g4-path1", "16T8-[4,4,4]-4,4,4,4-4,4,4,4-4,4,4,4-g3-path22" ];
