...
s`SolvableDBName := "2T1-[1,2,2]-11-2-2-g0-path1";
s`SolvableDBFilename := "2T1-[1,2,2]-11-2-2-g0-path1.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-[1,2,2]-11-2-2-g0-path1" ];
s`SolvableDBParents := [ Strings() | "4T1-[1,4,4]-1111-4-4-g0-path1", "4T2-[2,2,2]-22-22-22-g0-path1", "4T1-[2,4,4]-22-4-4-g1-path1" ];
