...
s`SolvableDBName := "4T1-[4,4,1]-4-4-1111-g0-path1";
s`SolvableDBFilename := "4T1-[4,4,1]-4-4-1111-g0-path1.m";
...
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-[2,2,1]-2-2-11-g0-path1", "4T1-[4,4,1]-4-4-1111-g0-path1" ];
s`SolvableDBParents := [ Strings() | "8T1-[8,8,1]-8-8-11111111-g0-path1", "8T2-[4,4,2]-44-44-2222-g1-path1", "8T1-[8,8,2]-8-8-2222-g2-path1" ];
