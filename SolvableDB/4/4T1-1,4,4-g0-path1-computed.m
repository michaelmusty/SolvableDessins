...
s`SolvableDBName := "4T1-1,4,4-g0-path1-computed";
s`SolvableDBFilename := "4T1-1,4,4-g0-path1-computed.m";
...
s`SolvableDBParents := [ Strings() | "8T2-2,4,4-g1-path1-notcomputed", "8T1-2,8,8-g2-path1-notcomputed", "8T1-1,8,8-g0-path1-computed" ];
