...
s`SolvableDBParents := [ Strings() | "8T1-[8,4,8]-8-44-8-g3-path1" ];
s`SolvableDBParentsUnramified := [ Strings() | "8T2-[4,2,4]-44-2222-44-g1-path2", "8T2-[4,2,4]-44-2222-44-g1-path6" ];
