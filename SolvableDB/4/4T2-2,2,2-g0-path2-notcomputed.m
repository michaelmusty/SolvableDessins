...
s`SolvableDBName := "4T2-2,2,2-g0-path2-notcomputed";
s`SolvableDBFilename := "4T2-2,2,2-g0-path2-notcomputed.m";
...
\[ 3, 4, 1, 2 ],
\[ 4, 3, 2, 1 ] >;
s`SolvableDBPathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1-computed", "4T2-2,2,2-g0-path2-notcomputed" ];
